...
inline std::ostream& operator<<(std::ostream& os, GpuFenceHandleType value) {
  switch(value) {
    case GpuFenceHandleType::kEmpty:
      return os << "GpuFenceHandleType::kEmpty";
    case GpuFenceHandleType::kAndroidNativeFenceSync:
      return os << "GpuFenceHandleType::kAndroidNativeFenceSync";
    default:
      return os << "Unknown GpuFenceHandleType value: " << static_cast<int32_t>(value);
  }
}
...
struct Serializer<::gfx::mojom::GpuFenceHandleDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    decltype(CallWithContext(Traits::native_fd, input, custom_context)) in_native_fd = CallWithContext(Traits::native_fd, input, custom_context);
