...
struct Serializer<::gfx::mojom::CALayerParamsDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    (*output)->is_empty = CallWithContext(Traits::is_empty, input, custom_context);
    decltype(CallWithContext(Traits::content, input, custom_context)) in_content = CallWithContext(Traits::content, input, custom_context);
    ...
    decltype(CallWithContext(Traits::pixel_size, input, custom_context)) in_pixel_size = CallWithContext(Traits::pixel_size, input, custom_context);
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    switch (result->tag) {
      case ::gfx::mojom::CALayerContentDataView::Tag::CA_CONTEXT_ID: {
        decltype(CallWithContext(Traits::ca_context_id, input, custom_context))
            in_ca_context_id = CallWithContext(Traits::ca_context_id, input,
                                          custom_context);
        result->data.f_ca_context_id = in_ca_context_id;
        break;
      }
      case ::gfx::mojom::CALayerContentDataView::Tag::IO_SURFACE_MACH_PORT: {
        decltype(CallWithContext(Traits::io_surface_mach_port, input, custom_context))
            in_io_surface_mach_port = CallWithContext(Traits::io_surface_mach_port, input,
                                          custom_context);
