...
class  ScrollOffset {
 public:
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ScrollOffset::DataView, WTF::Vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::gfx::mojom::blink::ScrollOffset::DataView,
                                         ::gfx::mojom::blink::ScrollOffsetPtr> {
  static bool IsNull(const ::gfx::mojom::blink::ScrollOffsetPtr& input) { return !input; }
  static void SetToNull(::gfx::mojom::blink::ScrollOffsetPtr* output) { output->reset(); }

  static decltype(::gfx::mojom::blink::ScrollOffset::x) x(
      const ::gfx::mojom::blink::ScrollOffsetPtr& input) {
    return input->x;
  }

  static decltype(::gfx::mojom::blink::ScrollOffset::y) y(
      const ::gfx::mojom::blink::ScrollOffsetPtr& input) {
    return input->y;
  }

  static bool Read(::gfx::mojom::blink::ScrollOffset::DataView input, ::gfx::mojom::blink::ScrollOffsetPtr* output);
};
