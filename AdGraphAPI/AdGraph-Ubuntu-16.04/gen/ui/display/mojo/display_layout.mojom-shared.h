...
inline std::ostream& operator<<(std::ostream& os, Position value) {
  switch(value) {
    case Position::TOP:
...
inline std::ostream& operator<<(std::ostream& os, OffsetReference value) {
  switch(value) {
...
struct Serializer<::display::mojom::DisplayPlacementDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    (*output)->parent_display_id = CallWithContext(Traits::parent_display_id, input, custom_context);
    mojo::internal::Serialize<::display::mojom::Position>(
        CallWithContext(Traits::position, input, custom_context), &(*output)->position);
    (*output)->offset = CallWithContext(Traits::offset, input, custom_context);
    mojo::internal::Serialize<::display::mojom::OffsetReference>(
        CallWithContext(Traits::offset_reference, input, custom_context), &(*output)->offset_reference);
...
struct Serializer<::display::mojom::DisplayLayoutDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    void* custom_context = CustomContextHelper<Traits>::SetUp(input, context);
    (*output).Allocate(buffer);
    (*output)->default_unified = CallWithContext(Traits::default_unified, input, custom_context);
    (*output)->primary_display_id = CallWithContext(Traits::primary_display_id, input, custom_context);
    decltype(CallWithContext(Traits::placement_list, input, custom_context)) in_placement_list = CallWithContext(Traits::placement_list, input, custom_context);
