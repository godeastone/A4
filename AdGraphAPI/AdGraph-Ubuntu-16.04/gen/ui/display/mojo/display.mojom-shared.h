...
inline std::ostream& operator<<(std::ostream& os, AccelerometerSupport value) {
  switch(value) {
...
struct Serializer<::display::mojom::DisplayDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    mojo::internal::Serialize<::display::mojom::Rotation>(
        CallWithContext(Traits::rotation, input, custom_context), &(*output)->rotation);
    mojo::internal::Serialize<::display::mojom::TouchSupport>(
        CallWithContext(Traits::touch_support, input, custom_context), &(*output)->touch_support);
    mojo::internal::Serialize<::display::mojom::AccelerometerSupport>(
        CallWithContext(Traits::accelerometer_support, input, custom_context), &(*output)->accelerometer_support);
    ...
    (*output)->color_depth = CallWithContext(Traits::color_depth, input, custom_context);
    (*output)->depth_per_component = CallWithContext(Traits::depth_per_component, input, custom_context);
    (*output)->is_monochrome = CallWithContext(Traits::is_monochrome, input, custom_context);
