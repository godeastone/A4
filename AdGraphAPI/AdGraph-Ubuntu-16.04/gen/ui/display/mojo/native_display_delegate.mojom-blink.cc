...
#include "ui/display/mojo/native_display_delegate.mojom-blink.h"
...
bool NativeDisplayDelegate::Initialize(NativeDisplayObserverPtr observer, WTF::Vector<::display::mojom::blink::DisplaySnapshotPtr>* out_snapshots) {
  NOTREACHED();
  return false;
}
class NativeDisplayDelegate_Initialize_HandleSyncResponse
 ...
 public:
  NativeDisplayDelegate_Initialize_HandleSyncResponse(
      bool* result, WTF::Vector<::display::mojom::blink::DisplaySnapshotPtr>* out_snapshots)
 ...
 private:
  bool* result_;
  WTF::Vector<::display::mojom::blink::DisplaySnapshotPtr>* out_snapshots_;DISALLOW_COPY_AND_ASSIGN(NativeDisplayDelegate_Initialize_HandleSyncResponse);
};
...
bool NativeDisplayDelegateProxy::Initialize(
    NativeDisplayObserverPtr param_observer, WTF::Vector<::display::mojom::blink::DisplaySnapshotPtr>* out_param_snapshots) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NativeDisplayDelegateProxy::Configure(
    int64_t in_display_id, ::display::mojom::blink::DisplayModePtr in_mode, const ::blink::WebPoint& in_origin, ConfigureCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NativeDisplayDelegateProxy::SetHDCPState(
    int64_t in_display_id, ::display::mojom::blink::HDCPState in_state, SetHDCPStateCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NativeDisplayDelegateProxy::SetColorCorrection(
    int64_t in_display_id, WTF::Vector<::display::mojom::blink::GammaRampRGBEntryPtr> in_degamma_lut, WTF::Vector<::display::mojom::blink::GammaRampRGBEntryPtr> in_gamma_lut, const WTF::Vector<float>& in_correction_matrix) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class NativeDisplayDelegate_Initialize_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      WTF::Vector<::display::mojom::blink::DisplaySnapshotPtr> in_snapshots);
...
bool NativeDisplayDelegate_Initialize_ForwardToCallback::Accept(
  ...
  serialization_context.TakeHandlesFromMessage(message);
  bool success = true;
  WTF::Vector<::display::mojom::blink::DisplaySnapshotPtr> p_snapshots{};
...
class NativeDisplayDelegate_GetHDCPState_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      bool in_status, ::display::mojom::blink::HDCPState in_state);
...
bool NativeDisplayDelegate_GetHDCPState_ForwardToCallback::Accept(
  ...
  bool success = true;
  bool p_status{};
  ::display::mojom::blink::HDCPState p_state{};
...
bool NativeDisplayDelegateStubDispatch::Accept(
  ...
  TRACE_EVENT1("mojom", "(Impl)display::mojom::NativeDisplayDelegate::SetColorCorrection",
      ...
      WTF::Vector<::display::mojom::blink::GammaRampRGBEntryPtr> p_degamma_lut{};
      WTF::Vector<::display::mojom::blink::GammaRampRGBEntryPtr> p_gamma_lut{};
      WTF::Vector<float> p_correction_matrix{};
...
std::move(p_observer), std::move(callback));
  ...
  TRACE_EVENT1("mojom", "(Impl)display::mojom::NativeDisplayDelegate::Configure",
      ...
      bool success = true;
      int64_t p_display_id{};
      ::display::mojom::blink::DisplayModePtr p_mode{};
      ::blink::WebPoint p_origin{};
...
void NativeDisplayDelegateInterceptorForTesting::Configure(int64_t display_id, ::display::mojom::blink::DisplayModePtr mode, const ::blink::WebPoint& origin, ConfigureCallback callback) {
...
void NativeDisplayDelegateInterceptorForTesting::SetHDCPState(int64_t display_id, ::display::mojom::blink::HDCPState state, SetHDCPStateCallback callback) {
  GetForwardingInterface()->SetHDCPState(std::move(display_id), std::move(state), std::move(callback));
}
void NativeDisplayDelegateInterceptorForTesting::SetColorCorrection(int64_t display_id, WTF::Vector<::display::mojom::blink::GammaRampRGBEntryPtr> degamma_lut, WTF::Vector<::display::mojom::blink::GammaRampRGBEntryPtr> gamma_lut, const WTF::Vector<float>& correction_matrix) {
...
,
             WTF::Vector<::display::mojom::blink::DisplaySnapshotPtr> snapshots) {*out_snapshots = std::move(snapshots);
            loop->Quit();
          },
          &loop,
          out_snapshots));
  ...
  proxy_->GetHDCPState(std::move(display_id),
      base::BindOnce(
          [](base::RunLoop* loop,
             bool* out_status
,
             ::display::mojom::blink::HDCPState* out_state
,
             bool status,
             ::display::mojom::blink::HDCPState state) {*out_status = std::move(status);*out_state = std::move(state);
            loop->Quit();
          },
          &loop,
          out_status,
