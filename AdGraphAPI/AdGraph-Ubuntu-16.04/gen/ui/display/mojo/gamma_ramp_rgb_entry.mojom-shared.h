...
struct Serializer<::display::mojom::GammaRampRGBEntryDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    (*output)->r = CallWithContext(Traits::r, input, custom_context);
    (*output)->g = CallWithContext(Traits::g, input, custom_context);
    (*output)->b = CallWithContext(Traits::b, input, custom_context);
