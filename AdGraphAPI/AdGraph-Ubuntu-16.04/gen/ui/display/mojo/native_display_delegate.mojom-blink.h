...
#ifndef UI_DISPLAY_MOJO_NATIVE_DISPLAY_DELEGATE_MOJOM_BLINK_H_
#define UI_DISPLAY_MOJO_NATIVE_DISPLAY_DELEGATE_MOJOM_BLINK_H_
...
using RevocableNativeDisplayObserverPtr = ::blink::RevocableInterfacePtr<NativeDisplayObserver>;
...
using RevocableNativeDisplayDelegatePtr = ::blink::RevocableInterfacePtr<NativeDisplayDelegate>;
...
class  NativeDisplayDelegate
 ...
 public:
  ...
  virtual bool Initialize(NativeDisplayObserverPtr observer, WTF::Vector<::display::mojom::blink::DisplaySnapshotPtr>* out_snapshots);

  using InitializeCallback = base::OnceCallback<void(WTF::Vector<::display::mojom::blink::DisplaySnapshotPtr>)>;
  ...
  using GetDisplaysCallback = base::OnceCallback<void(WTF::Vector<::display::mojom::blink::DisplaySnapshotPtr>)>;
  virtual void GetDisplays(GetDisplaysCallback callback) = 0;


  using ConfigureCallback = base::OnceCallback<void(bool)>;
  virtual void Configure(int64_t display_id, ::display::mojom::blink::DisplayModePtr mode, const ::blink::WebPoint& origin, ConfigureCallback callback) = 0;


  using GetHDCPStateCallback = base::OnceCallback<void(bool, ::display::mojom::blink::HDCPState)>;
  ...
  virtual void SetHDCPState(int64_t display_id, ::display::mojom::blink::HDCPState state, SetHDCPStateCallback callback) = 0;

  virtual void SetColorCorrection(int64_t display_id, WTF::Vector<::display::mojom::blink::GammaRampRGBEntryPtr> degamma_lut, WTF::Vector<::display::mojom::blink::GammaRampRGBEntryPtr> gamma_lut, const WTF::Vector<float>& correction_matrix) = 0;
};
class  NativeDisplayDelegateInterceptorForTesting : public NativeDisplayDelegate {
  ...
  void Configure(int64_t display_id, ::display::mojom::blink::DisplayModePtr mode, const ::blink::WebPoint& origin, ConfigureCallback callback) override;
  void GetHDCPState(int64_t display_id, GetHDCPStateCallback callback) override;
  void SetHDCPState(int64_t display_id, ::display::mojom::blink::HDCPState state, SetHDCPStateCallback callback) override;
  void SetColorCorrection(int64_t display_id, WTF::Vector<::display::mojom::blink::GammaRampRGBEntryPtr> degamma_lut, WTF::Vector<::display::mojom::blink::GammaRampRGBEntryPtr> gamma_lut, const WTF::Vector<float>& correction_matrix) override;
};
class  NativeDisplayDelegateAsyncWaiter {
 public:
  ...
  void Initialize(
      NativeDisplayObserverPtr observer, WTF::Vector<::display::mojom::blink::DisplaySnapshotPtr>* out_snapshots);
  void TakeDisplayControl(
      bool* out_result);
  void RelinquishDisplayControl(
      bool* out_result);
  void GetDisplays(
      WTF::Vector<::display::mojom::blink::DisplaySnapshotPtr>* out_snapshots);
  void Configure(
      int64_t display_id, ::display::mojom::blink::DisplayModePtr mode, const ::blink::WebPoint& origin, bool* out_status);
  void GetHDCPState(
      int64_t display_id, bool* out_status, ::display::mojom::blink::HDCPState* out_state);
  void SetHDCPState(
      int64_t display_id, ::display::mojom::blink::HDCPState state, bool* out_status);
...
class  NativeDisplayDelegateProxy
 ...
 public:
  ...
  bool Initialize(NativeDisplayObserverPtr observer, WTF::Vector<::display::mojom::blink::DisplaySnapshotPtr>* out_snapshots) final;
  ...
  void Configure(int64_t display_id, ::display::mojom::blink::DisplayModePtr mode, const ::blink::WebPoint& origin, ConfigureCallback callback) final;
  void GetHDCPState(int64_t display_id, GetHDCPStateCallback callback) final;
  void SetHDCPState(int64_t display_id, ::display::mojom::blink::HDCPState state, SetHDCPStateCallback callback) final;
  void SetColorCorrection(int64_t display_id, WTF::Vector<::display::mojom::blink::GammaRampRGBEntryPtr> degamma_lut, WTF::Vector<::display::mojom::blink::GammaRampRGBEntryPtr> gamma_lut, const WTF::Vector<float>& correction_matrix) final;
...
#endif  // UI_DISPLAY_MOJO_NATIVE_DISPLAY_DELEGATE_MOJOM_BLINK_H_