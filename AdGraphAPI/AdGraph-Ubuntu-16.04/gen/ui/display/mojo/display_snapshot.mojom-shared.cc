...
bool DisplaySnapshot_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->display_name, 9, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->sys_path, 10, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->modes, 11, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->edid, 12, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->maximum_cursor_size, 19, validation_context)) {
    return false;
  }
