...
// static
bool ProfileImportObserver_OnFirefoxSearchEngineDataReceived_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ProfileImportObserver_OnFirefoxSearchEngineDataReceived_Params_Data* object = static_cast<const ProfileImportObserver_OnFirefoxSearchEngineDataReceived_Params_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->search_engine_data, 1, validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams search_engine_data_validate_params(
      0, false, new mojo::internal::ContainerValidateParams(0, false, nullptr));
  if (!mojo::internal::ValidateContainer(object->search_engine_data, validation_context,
                                         &search_engine_data_validate_params)) {
    return false;
  }
...
ProfileImportObserver_OnFirefoxSearchEngineDataReceived_Params_Data::ProfileImportObserver_OnFirefoxSearchEngineDataReceived_Params_Data()
    : header_({sizeof(*this), 0}) {}
...
// static
bool ProfileImportObserver_OnIE7PasswordReceived_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ProfileImportObserver_OnIE7PasswordReceived_Params_Data* object = static_cast<const ProfileImportObserver_OnIE7PasswordReceived_Params_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->importer_password_info, 1, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->importer_password_info, validation_context))
    return false;

  return true;
}

ProfileImportObserver_OnIE7PasswordReceived_Params_Data::ProfileImportObserver_OnIE7PasswordReceived_Params_Data()
    : header_({sizeof(*this), 0}) {}
