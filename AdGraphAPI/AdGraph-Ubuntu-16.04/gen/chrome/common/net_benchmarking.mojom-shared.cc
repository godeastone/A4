...
bool NetBenchmarking_CloseCurrentConnections_Params_Data::Validate(
  ...
  const NetBenchmarking_CloseCurrentConnections_Params_Data* object = static_cast<const NetBenchmarking_CloseCurrentConnections_Params_Data*>(data);
...
bool NetBenchmarking_CloseCurrentConnections_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NetBenchmarking_CloseCurrentConnections_ResponseParams_Data* object = static_cast<const NetBenchmarking_CloseCurrentConnections_ResponseParams_Data*>(data);
...
bool NetBenchmarking_ClearCache_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NetBenchmarking_ClearCache_Params_Data* object = static_cast<const NetBenchmarking_ClearCache_Params_Data*>(data);
...
bool NetBenchmarking_ClearCache_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NetBenchmarking_ClearCache_ResponseParams_Data* object = static_cast<const NetBenchmarking_ClearCache_ResponseParams_Data*>(data);
...
bool NetBenchmarking_ClearHostResolverCache_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NetBenchmarking_ClearHostResolverCache_Params_Data* object = static_cast<const NetBenchmarking_ClearHostResolverCache_Params_Data*>(data);
...
bool NetBenchmarking_ClearHostResolverCache_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NetBenchmarking_ClearHostResolverCache_ResponseParams_Data* object = static_cast<const NetBenchmarking_ClearHostResolverCache_ResponseParams_Data*>(data);
...
bool NetBenchmarking_ClearPredictorCache_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NetBenchmarking_ClearPredictorCache_Params_Data* object = static_cast<const NetBenchmarking_ClearPredictorCache_Params_Data*>(data);
...
bool NetBenchmarking_ClearPredictorCache_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NetBenchmarking_ClearPredictorCache_ResponseParams_Data* object = static_cast<const NetBenchmarking_ClearPredictorCache_ResponseParams_Data*>(data);
