...
std::unique_ptr<base::DictionaryValue> UrlWriteOptions::ToValue() const {
  ...
  if (this->image_hash.get()) {
    value->SetWithoutPathExpansion("imageHash", std::make_unique<base::Value>(*this->image_hash));

  }
  if (this->save_as_download.get()) {
    value->SetWithoutPathExpansion("saveAsDownload", std::make_unique<base::Value>(*this->save_as_download));
...
std::unique_ptr<base::DictionaryValue> ProgressInfo::ToValue() const {
  ...
  value->SetWithoutPathExpansion("stage", std::make_unique<base::Value>(image_writer_private::ToString(this->stage)));

  value->SetWithoutPathExpansion("percentComplete", std::make_unique<base::Value>(this->percent_complete));
...
std::unique_ptr<base::DictionaryValue> RemovableStorageDevice::ToValue() const {
  ...
  value->SetWithoutPathExpansion("storageUnitId", std::make_unique<base::Value>(this->storage_unit_id));

  value->SetWithoutPathExpansion("capacity", std::make_unique<base::Value>(this->capacity));

  value->SetWithoutPathExpansion("vendor", std::make_unique<base::Value>(this->vendor));

  value->SetWithoutPathExpansion("model", std::make_unique<base::Value>(this->model));

  value->SetWithoutPathExpansion("removable", std::make_unique<base::Value>(this->removable));
