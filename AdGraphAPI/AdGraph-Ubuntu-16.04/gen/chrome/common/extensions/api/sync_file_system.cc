...
std::unique_ptr<base::DictionaryValue> FileInfo::ToValue() const {
  ...
  value->SetWithoutPathExpansion("fileEntry", (this->file_entry).ToValue());

  value->SetWithoutPathExpansion("status", std::make_unique<base::Value>(sync_file_system::ToString(this->status)));

  if (this->action != SYNC_ACTION_NONE) {
    value->SetWithoutPathExpansion("action", std::make_unique<base::Value>(sync_file_system::ToString(this->action)));

  }
  if (this->direction != SYNC_DIRECTION_NONE) {
    value->SetWithoutPathExpansion("direction", std::make_unique<base::Value>(sync_file_system::ToString(this->direction)));
...
std::unique_ptr<base::DictionaryValue> StorageInfo::ToValue() const {
  ...
  value->SetWithoutPathExpansion("usageBytes", std::make_unique<base::Value>(this->usage_bytes));

  value->SetWithoutPathExpansion("quotaBytes", std::make_unique<base::Value>(this->quota_bytes));
...
std::unique_ptr<base::DictionaryValue> ServiceInfo::ToValue() const {
  ...
  value->SetWithoutPathExpansion("state", std::make_unique<base::Value>(sync_file_system::ToString(this->state)));
