...
#ifndef CHROME_COMMON_EXTENSIONS_API_AUTOMATION_H__
#define CHROME_COMMON_EXTENSIONS_API_AUTOMATION_H__
...
enum ActionType {
  ...
  ACTION_TYPE_LAST = ACTION_TYPE_SHOWCONTEXTMENU,
};
...
#endif  // CHROME_COMMON_EXTENSIONS_API_AUTOMATION_H__
