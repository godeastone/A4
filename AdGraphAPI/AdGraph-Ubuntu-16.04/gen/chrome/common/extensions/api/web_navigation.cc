...
std::unique_ptr<base::DictionaryValue> Results::Details::ToValue() const {
  ...
  value->SetWithoutPathExpansion("errorOccurred", std::make_unique<base::Value>(this->error_occurred));
...
std::unique_ptr<base::DictionaryValue> Results::DetailsType::ToValue() const {
  ...
  value->SetWithoutPathExpansion("processId", std::make_unique<base::Value>(this->process_id));
...
std::unique_ptr<base::DictionaryValue> Details::ToValue() const {
  ...
  value->SetWithoutPathExpansion("transitionType", std::make_unique<base::Value>(web_navigation::ToString(this->transition_type)));
  ...
  value->SetWithoutPathExpansion("transitionQualifiers", json_schema_compiler::util::CreateValueFromArray(transitionQualifiers_list));
  }
...
std::unique_ptr<base::DictionaryValue> Details::ToValue() const {
  ...
  value->SetWithoutPathExpansion("sourceTabId", std::make_unique<base::Value>(this->source_tab_id));

  value->SetWithoutPathExpansion("sourceProcessId", std::make_unique<base::Value>(this->source_process_id));

  value->SetWithoutPathExpansion("sourceFrameId", std::make_unique<base::Value>(this->source_frame_id));
...
std::unique_ptr<base::DictionaryValue> Details::ToValue() const {
  ...
  value->SetWithoutPathExpansion("replacedTabId", std::make_unique<base::Value>(this->replaced_tab_id));
