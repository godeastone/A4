...
std::unique_ptr<base::DictionaryValue> ExtensionActivity::Other::ToValue() const {
  ...
  if (this->prerender.get()) {
    value->SetWithoutPathExpansion("prerender", std::make_unique<base::Value>(*this->prerender));

  }
  if (this->dom_verb != EXTENSION_ACTIVITY_DOM_VERB_NONE) {
    value->SetWithoutPathExpansion("domVerb", std::make_unique<base::Value>(activity_log_private::ToString(this->dom_verb)));

  }
  if (this->web_request.get()) {
    value->SetWithoutPathExpansion("webRequest", std::make_unique<base::Value>(*this->web_request));

  }
  if (this->extra.get()) {
    value->SetWithoutPathExpansion("extra", std::make_unique<base::Value>(*this->extra));
...
std::unique_ptr<base::DictionaryValue> ExtensionActivity::ToValue() const {
  ...
  if (this->activity_id.get()) {
    value->SetWithoutPathExpansion("activityId", std::make_unique<base::Value>(*this->activity_id));
  ...
  value->SetWithoutPathExpansion("activityType", std::make_unique<base::Value>(activity_log_private::ToString(this->activity_type)));

  if (this->time.get()) {
    value->SetWithoutPathExpansion("time", std::make_unique<base::Value>(*this->time));

  }
  if (this->api_call.get()) {
    value->SetWithoutPathExpansion("apiCall", std::make_unique<base::Value>(*this->api_call));

  }
  if (this->args.get()) {
    value->SetWithoutPathExpansion("args", std::make_unique<base::Value>(*this->args));

  }
  if (this->count.get()) {
    value->SetWithoutPathExpansion("count", std::make_unique<base::Value>(*this->count));
  ...
  if (this->page_title.get()) {
    value->SetWithoutPathExpansion("pageTitle", std::make_unique<base::Value>(*this->page_title));

  }
  if (this->arg_url.get()) {
    value->SetWithoutPathExpansion("argUrl", std::make_unique<base::Value>(*this->arg_url));

  }
  if (this->other.get()) {
    value->SetWithoutPathExpansion("other", (this->other)->ToValue());
...
std::unique_ptr<base::DictionaryValue> Filter::ToValue() const {
  ...
  if (this->days_ago.get()) {
    value->SetWithoutPathExpansion("daysAgo", std::make_unique<base::Value>(*this->days_ago));
...
std::unique_ptr<base::DictionaryValue> ActivityResultSet::ToValue() const {
  ...
  value->SetWithoutPathExpansion("activities", json_schema_compiler::util::CreateValueFromArray(this->activities));
