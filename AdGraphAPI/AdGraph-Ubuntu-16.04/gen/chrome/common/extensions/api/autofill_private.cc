...
std::unique_ptr<base::DictionaryValue> AutofillMetadata::ToValue() const {
  ...
  value->SetWithoutPathExpansion("summaryLabel", std::make_unique<base::Value>(this->summary_label));

  if (this->summary_sublabel.get()) {
    value->SetWithoutPathExpansion("summarySublabel", std::make_unique<base::Value>(*this->summary_sublabel));

  }
  if (this->is_local.get()) {
    value->SetWithoutPathExpansion("isLocal", std::make_unique<base::Value>(*this->is_local));

  }
  if (this->is_cached.get()) {
    value->SetWithoutPathExpansion("isCached", std::make_unique<base::Value>(*this->is_cached));
...
std::unique_ptr<base::DictionaryValue> AddressEntry::ToValue() const {
  ...
  if (this->full_names.get()) {
    value->SetWithoutPathExpansion("fullNames", json_schema_compiler::util::CreateValueFromOptionalArray(this->full_names));

  }
  if (this->company_name.get()) {
    value->SetWithoutPathExpansion("companyName", std::make_unique<base::Value>(*this->company_name));

  }
  if (this->address_lines.get()) {
    value->SetWithoutPathExpansion("addressLines", std::make_unique<base::Value>(*this->address_lines));

  }
  if (this->address_level1.get()) {
    value->SetWithoutPathExpansion("addressLevel1", std::make_unique<base::Value>(*this->address_level1));

  }
  if (this->address_level2.get()) {
    value->SetWithoutPathExpansion("addressLevel2", std::make_unique<base::Value>(*this->address_level2));

  }
  if (this->address_level3.get()) {
    value->SetWithoutPathExpansion("addressLevel3", std::make_unique<base::Value>(*this->address_level3));

  }
  if (this->postal_code.get()) {
    value->SetWithoutPathExpansion("postalCode", std::make_unique<base::Value>(*this->postal_code));

  }
  if (this->sorting_code.get()) {
    value->SetWithoutPathExpansion("sortingCode", std::make_unique<base::Value>(*this->sorting_code));

  }
  if (this->country_code.get()) {
    value->SetWithoutPathExpansion("countryCode", std::make_unique<base::Value>(*this->country_code));

  }
  if (this->phone_numbers.get()) {
    value->SetWithoutPathExpansion("phoneNumbers", json_schema_compiler::util::CreateValueFromOptionalArray(this->phone_numbers));

  }
  if (this->email_addresses.get()) {
    value->SetWithoutPathExpansion("emailAddresses", json_schema_compiler::util::CreateValueFromOptionalArray(this->email_addresses));

  }
  if (this->language_code.get()) {
    value->SetWithoutPathExpansion("languageCode", std::make_unique<base::Value>(*this->language_code));

  }
  if (this->metadata.get()) {
    value->SetWithoutPathExpansion("metadata", (this->metadata)->ToValue());
...
std::unique_ptr<base::DictionaryValue> AddressComponent::ToValue() const {
  ...
  value->SetWithoutPathExpansion("field", std::make_unique<base::Value>(autofill_private::ToString(this->field)));

  value->SetWithoutPathExpansion("fieldName", std::make_unique<base::Value>(this->field_name));

  value->SetWithoutPathExpansion("isLongField", std::make_unique<base::Value>(this->is_long_field));

  if (this->placeholder.get()) {
    value->SetWithoutPathExpansion("placeholder", std::make_unique<base::Value>(*this->placeholder));
...
std::unique_ptr<base::DictionaryValue> AddressComponentRow::ToValue() const {
  ...
  value->SetWithoutPathExpansion("row", json_schema_compiler::util::CreateValueFromArray(this->row));
...
std::unique_ptr<base::DictionaryValue> AddressComponents::ToValue() const {
  ...
  value->SetWithoutPathExpansion("components", json_schema_compiler::util::CreateValueFromArray(this->components));
...
std::unique_ptr<base::DictionaryValue> CreditCardEntry::ToValue() const {
  ...
  if (this->card_number.get()) {
    value->SetWithoutPathExpansion("cardNumber", std::make_unique<base::Value>(*this->card_number));

  }
  if (this->expiration_month.get()) {
    value->SetWithoutPathExpansion("expirationMonth", std::make_unique<base::Value>(*this->expiration_month));

  }
  if (this->expiration_year.get()) {
    value->SetWithoutPathExpansion("expirationYear", std::make_unique<base::Value>(*this->expiration_year));
...
std::unique_ptr<base::DictionaryValue> ValidatePhoneParams::ToValue() const {
  ...
  value->SetWithoutPathExpansion("phoneNumbers", json_schema_compiler::util::CreateValueFromArray(this->phone_numbers));

  value->SetWithoutPathExpansion("indexOfNewNumber", std::make_unique<base::Value>(this->index_of_new_number));
...
namespace OnAddressListChanged {

const char kEventName[] = "autofillPrivate.onAddressListChanged";
...
namespace OnCreditCardListChanged {

const char kEventName[] = "autofillPrivate.onCreditCardListChanged";
