...
#ifndef CHROME_COMMON_EXTENSIONS_API_AUTOMATION_INTERNAL_H__
#define CHROME_COMMON_EXTENSIONS_API_AUTOMATION_INTERNAL_H__
...
#endif  // CHROME_COMMON_EXTENSIONS_API_AUTOMATION_INTERNAL_H__
