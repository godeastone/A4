...
std::unique_ptr<base::DictionaryValue> GalleryChangeDetails::ToValue() const {
  ...
  value->SetWithoutPathExpansion("type", std::make_unique<base::Value>(media_galleries::ToString(this->type)));

  value->SetWithoutPathExpansion("galleryId", std::make_unique<base::Value>(this->gallery_id));
...
std::unique_ptr<base::DictionaryValue> MediaFileSystemsDetails::ToValue() const {
  ...
  if (this->interactive != GET_MEDIA_FILE_SYSTEMS_INTERACTIVITY_NONE) {
    value->SetWithoutPathExpansion("interactive", std::make_unique<base::Value>(media_galleries::ToString(this->interactive)));
...
std::unique_ptr<base::DictionaryValue> MediaMetadataOptions::ToValue() const {
  ...
  if (this->metadata_type != GET_METADATA_TYPE_NONE) {
    value->SetWithoutPathExpansion("metadataType", std::make_unique<base::Value>(media_galleries::ToString(this->metadata_type)));
...
std::unique_ptr<base::DictionaryValue> MediaFileSystemMetadata::ToValue() const {
  ...
  if (this->device_id.get()) {
    value->SetWithoutPathExpansion("deviceId", std::make_unique<base::Value>(*this->device_id));

  }
  value->SetWithoutPathExpansion("isRemovable", std::make_unique<base::Value>(this->is_removable));

  value->SetWithoutPathExpansion("isMediaDevice", std::make_unique<base::Value>(this->is_media_device));

  value->SetWithoutPathExpansion("isAvailable", std::make_unique<base::Value>(this->is_available));
...
std::unique_ptr<base::DictionaryValue> StreamInfo::ToValue() const {
  ...
  value->SetWithoutPathExpansion("tags", (this->tags).ToValue());
...
std::unique_ptr<base::DictionaryValue> MediaMetadata::ToValue() const {
  ...
  if (this->duration.get()) {
    value->SetWithoutPathExpansion("duration", std::make_unique<base::Value>(*this->duration));
  ...
  if (this->album.get()) {
    value->SetWithoutPathExpansion("album", std::make_unique<base::Value>(*this->album));

  }
  if (this->artist.get()) {
    value->SetWithoutPathExpansion("artist", std::make_unique<base::Value>(*this->artist));

  }
  if (this->comment.get()) {
    value->SetWithoutPathExpansion("comment", std::make_unique<base::Value>(*this->comment));

  }
  if (this->copyright.get()) {
    value->SetWithoutPathExpansion("copyright", std::make_unique<base::Value>(*this->copyright));

  }
  if (this->disc.get()) {
    value->SetWithoutPathExpansion("disc", std::make_unique<base::Value>(*this->disc));

  }
  if (this->genre.get()) {
    value->SetWithoutPathExpansion("genre", std::make_unique<base::Value>(*this->genre));
  ...
  if (this->track.get()) {
    value->SetWithoutPathExpansion("track", std::make_unique<base::Value>(*this->track));

  }
  value->SetWithoutPathExpansion("rawTags", json_schema_compiler::util::CreateValueFromArray(this->raw_tags));

  value->SetWithoutPathExpansion("attachedImages", json_schema_compiler::util::CreateValueFromArray(this->attached_images));
...
std::unique_ptr<base::DictionaryValue> AddGalleryWatchResult::ToValue() const {
  ...
  value->SetWithoutPathExpansion("success", std::make_unique<base::Value>(this->success));
