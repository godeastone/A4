...
enum ControllerType {
  ...
  CONTROLLER_TYPE_CHILD_CUSTODIAN,
  CONTROLLER_TYPE_SUPERVISED_USER_CUSTODIAN,
  CONTROLLER_TYPE_LAST = CONTROLLER_TYPE_SUPERVISED_USER_CUSTODIAN,
};
...
struct ExtensionInfo {
  ...
  AccessModifier run_on_all_urls;
...
struct ExtensionConfigurationUpdate {
  ...
  std::unique_ptr<bool> run_on_all_urls;
...
enum EventType {
  ...
  EVENT_TYPE_LAST = EVENT_TYPE_COMMAND_REMOVED,
};
