...
std::unique_ptr<base::DictionaryValue> ItemInspectView::ToValue() const {
  ...
  value->SetWithoutPathExpansion("path", std::make_unique<base::Value>(this->path));

  value->SetWithoutPathExpansion("render_process_id", std::make_unique<base::Value>(this->render_process_id));

  value->SetWithoutPathExpansion("render_view_id", std::make_unique<base::Value>(this->render_view_id));

  value->SetWithoutPathExpansion("incognito", std::make_unique<base::Value>(this->incognito));

  value->SetWithoutPathExpansion("generatedBackgroundPage", std::make_unique<base::Value>(this->generated_background_page));
...
std::unique_ptr<base::DictionaryValue> InspectOptions::ToValue() const {
  ...
  value->SetWithoutPathExpansion("extension_id", std::make_unique<base::Value>(this->extension_id));

  value->SetWithoutPathExpansion("render_process_id", (this->render_process_id).ToValue());

  value->SetWithoutPathExpansion("render_view_id", (this->render_view_id).ToValue());
...
std::unique_ptr<base::DictionaryValue> AccessModifier::ToValue() const {
  ...
  value->SetWithoutPathExpansion("isActive", std::make_unique<base::Value>(this->is_active));
...
std::unique_ptr<base::DictionaryValue> StackFrame::ToValue() const {
  ...
  value->SetWithoutPathExpansion("lineNumber", std::make_unique<base::Value>(this->line_number));

  value->SetWithoutPathExpansion("columnNumber", std::make_unique<base::Value>(this->column_number));

  value->SetWithoutPathExpansion("url", std::make_unique<base::Value>(this->url));

  value->SetWithoutPathExpansion("functionName", std::make_unique<base::Value>(this->function_name));
...
std::unique_ptr<base::DictionaryValue> ManifestError::ToValue() const {
  ...
  value->SetWithoutPathExpansion("type", std::make_unique<base::Value>(developer_private::ToString(this->type)));

  value->SetWithoutPathExpansion("extensionId", std::make_unique<base::Value>(this->extension_id));

  value->SetWithoutPathExpansion("fromIncognito", std::make_unique<base::Value>(this->from_incognito));
  ...
  value->SetWithoutPathExpansion("manifestKey", std::make_unique<base::Value>(this->manifest_key));

  if (this->manifest_specific.get()) {
    value->SetWithoutPathExpansion("manifestSpecific", std::make_unique<base::Value>(*this->manifest_specific));
...
std::unique_ptr<base::DictionaryValue> RuntimeError::ToValue() const {
  ...
  value->SetWithoutPathExpansion("severity", std::make_unique<base::Value>(developer_private::ToString(this->severity)));

  value->SetWithoutPathExpansion("contextUrl", std::make_unique<base::Value>(this->context_url));

  value->SetWithoutPathExpansion("occurrences", std::make_unique<base::Value>(this->occurrences));

  value->SetWithoutPathExpansion("renderViewId", std::make_unique<base::Value>(this->render_view_id));

  value->SetWithoutPathExpansion("renderProcessId", std::make_unique<base::Value>(this->render_process_id));

  value->SetWithoutPathExpansion("canInspect", std::make_unique<base::Value>(this->can_inspect));

  value->SetWithoutPathExpansion("stackTrace", json_schema_compiler::util::CreateValueFromArray(this->stack_trace));
...
std::unique_ptr<base::DictionaryValue> DisableReasons::ToValue() const {
  ...
  value->SetWithoutPathExpansion("suspiciousInstall", std::make_unique<base::Value>(this->suspicious_install));

  value->SetWithoutPathExpansion("corruptInstall", std::make_unique<base::Value>(this->corrupt_install));

  value->SetWithoutPathExpansion("updateRequired", std::make_unique<base::Value>(this->update_required));
...
std::unique_ptr<base::DictionaryValue> OptionsPage::ToValue() const {
  ...
  value->SetWithoutPathExpansion("openInTab", std::make_unique<base::Value>(this->open_in_tab));
...
std::unique_ptr<base::DictionaryValue> HomePage::ToValue() const {
  ...
  value->SetWithoutPathExpansion("specified", std::make_unique<base::Value>(this->specified));
...
std::unique_ptr<base::DictionaryValue> ExtensionView::ToValue() const {
  ...
  value->SetWithoutPathExpansion("isIframe", std::make_unique<base::Value>(this->is_iframe));
...
const char* ToString(ControllerType enum_param) {
  switch (enum_param) {
    case CONTROLLER_TYPE_POLICY:
      return "POLICY";
    case CONTROLLER_TYPE_CHILD_CUSTODIAN:
      return "CHILD_CUSTODIAN";
    case CONTROLLER_TYPE_SUPERVISED_USER_CUSTODIAN:
      return "SUPERVISED_USER_CUSTODIAN";
...
ControllerType ParseControllerType(const std::string& enum_string) {
  ...
  if (enum_string == "CHILD_CUSTODIAN")
    return CONTROLLER_TYPE_CHILD_CUSTODIAN;
  if (enum_string == "SUPERVISED_USER_CUSTODIAN")
    return CONTROLLER_TYPE_SUPERVISED_USER_CUSTODIAN;
...
std::unique_ptr<base::DictionaryValue> Command::ToValue() const {
  ...
  value->SetWithoutPathExpansion("keybinding", std::make_unique<base::Value>(this->keybinding));

  value->SetWithoutPathExpansion("name", std::make_unique<base::Value>(this->name));

  value->SetWithoutPathExpansion("isActive", std::make_unique<base::Value>(this->is_active));

  value->SetWithoutPathExpansion("scope", std::make_unique<base::Value>(developer_private::ToString(this->scope)));

  value->SetWithoutPathExpansion("isExtensionAction", std::make_unique<base::Value>(this->is_extension_action));
...
std::unique_ptr<base::DictionaryValue> Permission::ToValue() const {
  ...
  value->SetWithoutPathExpansion("submessages", json_schema_compiler::util::CreateValueFromArray(this->submessages));
...
run_on_all_urls(std::move(rhs.run_on_all_urls)),
...
bool ExtensionInfo::Populate(
  ...
  const base::Value* run_on_all_urls_value = NULL;
  if (!dict->GetWithoutPathExpansion("runOnAllUrls", &run_on_all_urls_value)) {
    return false;
  }
  {
    const base::DictionaryValue* dictionary = NULL;
    if (!run_on_all_urls_value->GetAsDictionary(&dictionary)) {
      return false;
    }
    if (!AccessModifier::Populate(*dictionary, &out->run_on_all_urls)) {
      return false;
    }
  }
...
std::unique_ptr<base::DictionaryValue> ExtensionInfo::ToValue() const {
  ...
  if (this->blacklist_text.get()) {
    value->SetWithoutPathExpansion("blacklistText", std::make_unique<base::Value>(*this->blacklist_text));

  }
  value->SetWithoutPathExpansion("commands", json_schema_compiler::util::CreateValueFromArray(this->commands));

  if (this->controlled_info.get()) {
    value->SetWithoutPathExpansion("controlledInfo", (this->controlled_info)->ToValue());

  }
  value->SetWithoutPathExpansion("dependentExtensions", json_schema_compiler::util::CreateValueFromArray(this->dependent_extensions));

  value->SetWithoutPathExpansion("description", std::make_unique<base::Value>(this->description));

  value->SetWithoutPathExpansion("disableReasons", (this->disable_reasons).ToValue());

  value->SetWithoutPathExpansion("errorCollection", (this->error_collection).ToValue());

  value->SetWithoutPathExpansion("fileAccess", (this->file_access).ToValue());

  value->SetWithoutPathExpansion("homePage", (this->home_page).ToValue());

  value->SetWithoutPathExpansion("iconUrl", std::make_unique<base::Value>(this->icon_url));

  value->SetWithoutPathExpansion("id", std::make_unique<base::Value>(this->id));

  value->SetWithoutPathExpansion("incognitoAccess", (this->incognito_access).ToValue());

  value->SetWithoutPathExpansion("installWarnings", json_schema_compiler::util::CreateValueFromArray(this->install_warnings));

  if (this->launch_url.get()) {
    value->SetWithoutPathExpansion("launchUrl", std::make_unique<base::Value>(*this->launch_url));

  }
  value->SetWithoutPathExpansion("location", std::make_unique<base::Value>(developer_private::ToString(this->location)));

  if (this->location_text.get()) {
    value->SetWithoutPathExpansion("locationText", std::make_unique<base::Value>(*this->location_text));

  }
  value->SetWithoutPathExpansion("manifestErrors", json_schema_compiler::util::CreateValueFromArray(this->manifest_errors));

  value->SetWithoutPathExpansion("manifestHomePageUrl", std::make_unique<base::Value>(this->manifest_home_page_url));

  value->SetWithoutPathExpansion("mustRemainInstalled", std::make_unique<base::Value>(this->must_remain_installed));

  value->SetWithoutPathExpansion("name", std::make_unique<base::Value>(this->name));

  value->SetWithoutPathExpansion("offlineEnabled", std::make_unique<base::Value>(this->offline_enabled));

  if (this->options_page.get()) {
    value->SetWithoutPathExpansion("optionsPage", (this->options_page)->ToValue());
  ...
  value->SetWithoutPathExpansion("permissions", json_schema_compiler::util::CreateValueFromArray(this->permissions));

  if (this->prettified_path.get()) {
    value->SetWithoutPathExpansion("prettifiedPath", std::make_unique<base::Value>(*this->prettified_path));

  }
  value->SetWithoutPathExpansion("runOnAllUrls", (this->run_on_all_urls).ToValue());

  value->SetWithoutPathExpansion("runtimeErrors", json_schema_compiler::util::CreateValueFromArray(this->runtime_errors));

  value->SetWithoutPathExpansion("runtimeWarnings", json_schema_compiler::util::CreateValueFromArray(this->runtime_warnings));

  value->SetWithoutPathExpansion("state", std::make_unique<base::Value>(developer_private::ToString(this->state)));

  value->SetWithoutPathExpansion("type", std::make_unique<base::Value>(developer_private::ToString(this->type)));

  value->SetWithoutPathExpansion("updateUrl", std::make_unique<base::Value>(this->update_url));

  value->SetWithoutPathExpansion("userMayModify", std::make_unique<base::Value>(this->user_may_modify));

  value->SetWithoutPathExpansion("version", std::make_unique<base::Value>(this->version));

  value->SetWithoutPathExpansion("views", json_schema_compiler::util::CreateValueFromArray(this->views));

  value->SetWithoutPathExpansion("webStoreUrl", std::make_unique<base::Value>(this->web_store_url));
...
: app_info_dialog_enabled(rhs.app_info_dialog_enabled),
...
bool ProfileInfo::Populate(
  ...
  const base::DictionaryValue* dict = static_cast<const base::DictionaryValue*>(&value);
  const base::Value* app_info_dialog_enabled_value = NULL;
  if (!dict->GetWithoutPathExpansion("appInfoDialogEnabled", &app_info_dialog_enabled_value)) {
    return false;
  }
  {
    if (!app_info_dialog_enabled_value->GetAsBoolean(&out->app_info_dialog_enabled)) {
      return false;
    }
  }
...
std::unique_ptr<base::DictionaryValue> ProfileInfo::ToValue() const {
  ...
  value->SetWithoutPathExpansion("appInfoDialogEnabled", std::make_unique<base::Value>(this->app_info_dialog_enabled));

  value->SetWithoutPathExpansion("canLoadUnpacked", std::make_unique<base::Value>(this->can_load_unpacked));

  value->SetWithoutPathExpansion("inDeveloperMode", std::make_unique<base::Value>(this->in_developer_mode));

  value->SetWithoutPathExpansion("isDeveloperModeControlledByPolicy", std::make_unique<base::Value>(this->is_developer_mode_controlled_by_policy));

  value->SetWithoutPathExpansion("isIncognitoAvailable", std::make_unique<base::Value>(this->is_incognito_available));

  value->SetWithoutPathExpansion("isSupervised", std::make_unique<base::Value>(this->is_supervised));
...
std::unique_ptr<base::DictionaryValue> ItemInfo::ToValue() const {
  ...
  value->SetWithoutPathExpansion("may_disable", std::make_unique<base::Value>(this->may_disable));

  value->SetWithoutPathExpansion("enabled", std::make_unique<base::Value>(this->enabled));

  value->SetWithoutPathExpansion("isApp", std::make_unique<base::Value>(this->is_app));

  value->SetWithoutPathExpansion("type", std::make_unique<base::Value>(developer_private::ToString(this->type)));

  value->SetWithoutPathExpansion("allow_activity", std::make_unique<base::Value>(this->allow_activity));

  value->SetWithoutPathExpansion("allow_file_access", std::make_unique<base::Value>(this->allow_file_access));

  value->SetWithoutPathExpansion("wants_file_access", std::make_unique<base::Value>(this->wants_file_access));

  value->SetWithoutPathExpansion("incognito_enabled", std::make_unique<base::Value>(this->incognito_enabled));

  value->SetWithoutPathExpansion("is_unpacked", std::make_unique<base::Value>(this->is_unpacked));

  value->SetWithoutPathExpansion("allow_reload", std::make_unique<base::Value>(this->allow_reload));

  value->SetWithoutPathExpansion("terminated", std::make_unique<base::Value>(this->terminated));

  value->SetWithoutPathExpansion("allow_incognito", std::make_unique<base::Value>(this->allow_incognito));

  value->SetWithoutPathExpansion("icon_url", std::make_unique<base::Value>(this->icon_url));
  ...
  if (this->options_url.get()) {
    value->SetWithoutPathExpansion("options_url", std::make_unique<base::Value>(*this->options_url));

  }
  if (this->app_launch_url.get()) {
    value->SetWithoutPathExpansion("app_launch_url", std::make_unique<base::Value>(*this->app_launch_url));

  }
  if (this->homepage_url.get()) {
    value->SetWithoutPathExpansion("homepage_url", std::make_unique<base::Value>(*this->homepage_url));

  }
  if (this->update_url.get()) {
    value->SetWithoutPathExpansion("update_url", std::make_unique<base::Value>(*this->update_url));

  }
  value->SetWithoutPathExpansion("install_warnings", json_schema_compiler::util::CreateValueFromArray(this->install_warnings));

  value->SetWithoutPathExpansion("manifest_errors", json_schema_compiler::util::CreateValueFromArray(this->manifest_errors));

  value->SetWithoutPathExpansion("runtime_errors", json_schema_compiler::util::CreateValueFromArray(this->runtime_errors));

  value->SetWithoutPathExpansion("offline_enabled", std::make_unique<base::Value>(this->offline_enabled));
...
std::unique_ptr<base::DictionaryValue> GetExtensionsInfoOptions::ToValue() const {
  ...
  if (this->include_disabled.get()) {
    value->SetWithoutPathExpansion("includeDisabled", std::make_unique<base::Value>(*this->include_disabled));

  }
  if (this->include_terminated.get()) {
    value->SetWithoutPathExpansion("includeTerminated", std::make_unique<base::Value>(*this->include_terminated));
...
bool ExtensionConfigurationUpdate::Populate(
  ...
  if (dict->GetWithoutPathExpansion("runOnAllUrls", &run_on_all_urls_value)) {
    {
      bool temp;
      if (!run_on_all_urls_value->GetAsBoolean(&temp)) {
        out->run_on_all_urls.reset();
        return false;
      }
      else
        out->run_on_all_urls.reset(new bool(temp));
    }
  }
...
std::unique_ptr<base::DictionaryValue> ExtensionConfigurationUpdate::ToValue() const {
  ...
  if (this->file_access.get()) {
    value->SetWithoutPathExpansion("fileAccess", std::make_unique<base::Value>(*this->file_access));

  }
  if (this->incognito_access.get()) {
    value->SetWithoutPathExpansion("incognitoAccess", std::make_unique<base::Value>(*this->incognito_access));

  }
  if (this->error_collection.get()) {
    value->SetWithoutPathExpansion("errorCollection", std::make_unique<base::Value>(*this->error_collection));

  }
  if (this->run_on_all_urls.get()) {
    value->SetWithoutPathExpansion("runOnAllUrls", std::make_unique<base::Value>(*this->run_on_all_urls));
...
std::unique_ptr<base::DictionaryValue> ExtensionCommandUpdate::ToValue() const {
  ...
  value->SetWithoutPathExpansion("commandName", std::make_unique<base::Value>(this->command_name));
...
std::unique_ptr<base::DictionaryValue> ReloadOptions::ToValue() const {
  ...
  if (this->fail_quietly.get()) {
    value->SetWithoutPathExpansion("failQuietly", std::make_unique<base::Value>(*this->fail_quietly));

  }
  if (this->populate_error_for_unpacked.get()) {
    value->SetWithoutPathExpansion("populateErrorForUnpacked", std::make_unique<base::Value>(*this->populate_error_for_unpacked));
...
std::unique_ptr<base::DictionaryValue> LoadUnpackedOptions::ToValue() const {
  ...
  if (this->populate_error.get()) {
    value->SetWithoutPathExpansion("populateError", std::make_unique<base::Value>(*this->populate_error));

  }
  if (this->retry_guid.get()) {
    value->SetWithoutPathExpansion("retryGuid", std::make_unique<base::Value>(*this->retry_guid));

  }
  if (this->use_dragged_path.get()) {
    value->SetWithoutPathExpansion("useDraggedPath", std::make_unique<base::Value>(*this->use_dragged_path));
...
std::unique_ptr<base::DictionaryValue> PackDirectoryResponse::ToValue() const {
  ...
  value->SetWithoutPathExpansion("item_path", std::make_unique<base::Value>(this->item_path));

  value->SetWithoutPathExpansion("pem_path", std::make_unique<base::Value>(this->pem_path));

  value->SetWithoutPathExpansion("override_flags", std::make_unique<base::Value>(this->override_flags));

  value->SetWithoutPathExpansion("status", std::make_unique<base::Value>(developer_private::ToString(this->status)));
...
std::unique_ptr<base::DictionaryValue> EventData::ToValue() const {
  ...
  value->SetWithoutPathExpansion("event_type", std::make_unique<base::Value>(developer_private::ToString(this->event_type)));

  value->SetWithoutPathExpansion("item_id", std::make_unique<base::Value>(this->item_id));

  if (this->extension_info.get()) {
    value->SetWithoutPathExpansion("extensionInfo", (this->extension_info)->ToValue());
...
std::unique_ptr<base::DictionaryValue> ErrorFileSource::ToValue() const {
  ...
  value->SetWithoutPathExpansion("beforeHighlight", std::make_unique<base::Value>(this->before_highlight));

  value->SetWithoutPathExpansion("highlight", std::make_unique<base::Value>(this->highlight));

  value->SetWithoutPathExpansion("afterHighlight", std::make_unique<base::Value>(this->after_highlight));
...
std::unique_ptr<base::DictionaryValue> LoadError::ToValue() const {
  ...
  if (this->source.get()) {
    value->SetWithoutPathExpansion("source", (this->source)->ToValue());
...
std::unique_ptr<base::DictionaryValue> RequestFileSourceProperties::ToValue() const {
  ...
  value->SetWithoutPathExpansion("pathSuffix", std::make_unique<base::Value>(this->path_suffix));
...
std::unique_ptr<base::DictionaryValue> DeleteExtensionErrorsProperties::ToValue() const {
  ...
  if (this->error_ids.get()) {
    value->SetWithoutPathExpansion("errorIds", json_schema_compiler::util::CreateValueFromOptionalArray(this->error_ids));
