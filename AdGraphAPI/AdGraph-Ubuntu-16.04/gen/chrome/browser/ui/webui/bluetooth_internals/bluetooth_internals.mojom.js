...
(function() {
  ...
  BluetoothInternalsHandler_GetAdapter_Params.generate = function(generator_) {
    var generated = new BluetoothInternalsHandler_GetAdapter_Params;
    return generated;
  };

  BluetoothInternalsHandler_GetAdapter_Params.prototype.mutate = function(mutator_) {
    return this;
  };
  BluetoothInternalsHandler_GetAdapter_Params.prototype.getHandleDeps = function() {
    var handles = [];
    return handles;
  };

  BluetoothInternalsHandler_GetAdapter_Params.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  BluetoothInternalsHandler_GetAdapter_Params.prototype.setHandlesInternal_ = function(handles, idx) {
    return idx;
  };
  ...
  BluetoothInternalsHandler_GetAdapter_ResponseParams.generate = function(generator_) {
    var generated = new BluetoothInternalsHandler_GetAdapter_ResponseParams;
    generated.adapter = generator_.generateInterface("bluetooth.mojom.Adapter", true);
    return generated;
  };

  BluetoothInternalsHandler_GetAdapter_ResponseParams.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.adapter = mutator_.mutateInterface(this.adapter, "bluetooth.mojom.Adapter", true);
    }
    return this;
  };
  BluetoothInternalsHandler_GetAdapter_ResponseParams.prototype.getHandleDeps = function() {
    var handles = [];
    if (this.adapter !== null) {
      Array.prototype.push.apply(handles, ["bluetooth.mojom.AdapterPtr"]);
    }
    return handles;
  };

  BluetoothInternalsHandler_GetAdapter_ResponseParams.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  BluetoothInternalsHandler_GetAdapter_ResponseParams.prototype.setHandlesInternal_ = function(handles, idx) {
    this.adapter = handles[idx++];;
    return idx;
  };
  ...
  var kBluetoothInternalsHandler_GetAdapter_Name = 1261737117;
  ...
  var BluetoothInternalsHandler = {
    ...
    mojomId: 'chrome/browser/ui/webui/bluetooth_internals/bluetooth_internals.mojom',
    fuzzMethods: {
      getAdapter: {
        params: BluetoothInternalsHandler_GetAdapter_Params,
      },
    },
  };
