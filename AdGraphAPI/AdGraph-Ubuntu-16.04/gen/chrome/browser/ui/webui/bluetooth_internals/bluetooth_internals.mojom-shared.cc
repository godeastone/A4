...
bool BluetoothInternalsHandler_GetAdapter_Params_Data::Validate(
  ...
  const BluetoothInternalsHandler_GetAdapter_Params_Data* object = static_cast<const BluetoothInternalsHandler_GetAdapter_Params_Data*>(data);
...
bool BluetoothInternalsHandler_GetAdapter_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const BluetoothInternalsHandler_GetAdapter_ResponseParams_Data* object = static_cast<const BluetoothInternalsHandler_GetAdapter_ResponseParams_Data*>(data);
