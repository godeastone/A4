...
class HEADLESS_EXPORT DispatchMouseEventParams {
 public:
  ...
  ::headless::input::DispatchMouseEventButton GetButton() const { DCHECK(HasButton()); return button_.value(); }
  void SetButton(::headless::input::DispatchMouseEventButton value) { button_ = value; }
  ...
  public:
    ...
    DispatchMouseEventParamsBuilder<STATE>& SetButton(::headless::input::DispatchMouseEventButton value) {
 ...
 private:
  ...
  base::Optional<int> modifiers_;
  base::Optional<double> timestamp_;
  base::Optional<::headless::input::DispatchMouseEventButton> button_;
...
class HEADLESS_EXPORT EmulateTouchFromMouseEventParams {
 public:
  ...
  // Mouse button.
  ::headless::input::EmulateTouchFromMouseEventButton GetButton() const { return button_; }
  void SetButton(::headless::input::EmulateTouchFromMouseEventButton value) { button_ = value; }
  ...
  public:
    ...
    EmulateTouchFromMouseEventParamsBuilder<STATE | kButtonSet>& SetButton(::headless::input::EmulateTouchFromMouseEventButton value) {
 ...
 private:
  ...
  int x_;
  int y_;
  ::headless::input::EmulateTouchFromMouseEventButton button_;
  base::Optional<double> timestamp_;
  base::Optional<double> deltax_;
  base::Optional<double> deltay_;
  base::Optional<int> modifiers_;
