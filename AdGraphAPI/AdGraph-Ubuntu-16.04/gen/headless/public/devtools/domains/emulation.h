...
class HEADLESS_EXPORT ExperimentalObserver {
 public:
  ...
  virtual void OnVirtualTimeAdvanced(const VirtualTimeAdvancedParams& params) {}
  // Notification sent after the virtual time budget for the current VirtualTimePolicy has run out.
  virtual void OnVirtualTimeBudgetExpired(const VirtualTimeBudgetExpiredParams& params) {}
  // Notification sent after the virtual time has paused.
  virtual void OnVirtualTimePaused(const VirtualTimePausedParams& params) {}
};

class HEADLESS_EXPORT Observer : public ExperimentalObserver {
 public:
  virtual ~Observer() {}
  // Experimental: Notification sent after the virtual time has advanced.
  virtual void OnVirtualTimeAdvanced(const VirtualTimeAdvancedParams& params) final {}
  ...
  virtual void OnVirtualTimePaused(const VirtualTimePausedParams& params) final {}
};
...
class HEADLESS_EXPORT Domain {
 public:
  ...
  void SetEmulatedMedia(const std::string& media, base::OnceClosure callback = base::OnceClosure());
 ...
 protected:
  ...
  void DispatchVirtualTimeAdvancedEvent(const base::Value& params);
  void DispatchVirtualTimeBudgetExpiredEvent(const base::Value& params);
  void DispatchVirtualTimePausedEvent(const base::Value& params);
