...
void ExperimentalDomain::GetNodeForLocation(std::unique_ptr<GetNodeForLocationParams> params, base::OnceCallback<void(std::unique_ptr<GetNodeForLocationResult>)> callback) {
