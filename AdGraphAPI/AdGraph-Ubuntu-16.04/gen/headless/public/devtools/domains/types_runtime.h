...
class HEADLESS_EXPORT CustomPreview {
 public:
  ...
  void SetHasBody(bool value) { has_body_ = value; }

  std::string GetFormatterObjectId() const { return formatter_object_id_; }
  void SetFormatterObjectId(const std::string& value) { formatter_object_id_ = value; }

  std::string GetBindRemoteObjectFunctionId() const { return bind_remote_object_function_id_; }
  void SetBindRemoteObjectFunctionId(const std::string& value) { bind_remote_object_function_id_ = value; }

  bool HasConfigObjectId() const { return !!config_object_id_; }
  std::string GetConfigObjectId() const { DCHECK(HasConfigObjectId()); return config_object_id_.value(); }
  void SetConfigObjectId(const std::string& value) { config_object_id_ = value; }
  ...
  public:
    ...
    kHeaderSet = 1 << 1,
    kHasBodySet = 1 << 2,
    kFormatterObjectIdSet = 1 << 3,
    kBindRemoteObjectFunctionIdSet = 1 << 4,
      kAllRequiredFieldsSet = (kHeaderSet | kHasBodySet | kFormatterObjectIdSet | kBindRemoteObjectFunctionIdSet | 0)
    };
    ...
    CustomPreviewBuilder<STATE | kHasBodySet>& SetHasBody(bool value) {
      static_assert(!(STATE & kHasBodySet), "property hasBody should not have already been set");
      result_->SetHasBody(value);
      return CastState<kHasBodySet>();
    }

    CustomPreviewBuilder<STATE | kFormatterObjectIdSet>& SetFormatterObjectId(const std::string& value) {
      static_assert(!(STATE & kFormatterObjectIdSet), "property formatterObjectId should not have already been set");
      result_->SetFormatterObjectId(value);
      return CastState<kFormatterObjectIdSet>();
    }

    CustomPreviewBuilder<STATE | kBindRemoteObjectFunctionIdSet>& SetBindRemoteObjectFunctionId(const std::string& value) {
      static_assert(!(STATE & kBindRemoteObjectFunctionIdSet), "property bindRemoteObjectFunctionId should not have already been set");
      result_->SetBindRemoteObjectFunctionId(value);
      return CastState<kBindRemoteObjectFunctionIdSet>();
    }

    CustomPreviewBuilder<STATE>& SetConfigObjectId(const std::string& value) {
      result_->SetConfigObjectId(value);
      return *this;
    }
 ...
 private:
  ...
  std::string header_;
  bool has_body_;
  std::string formatter_object_id_;
  std::string bind_remote_object_function_id_;
  base::Optional<std::string> config_object_id_;
