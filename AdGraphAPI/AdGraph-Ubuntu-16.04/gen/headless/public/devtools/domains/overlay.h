...
class HEADLESS_EXPORT Domain {
 ...
 protected:
  ...
  static void HandleSetSuspendedResponse(base::OnceCallback<void(std::unique_ptr<SetSuspendedResult>)> callback, const base::Value& response);
...
class ExperimentalDomain : public Domain {
 public:
  ...
  void SetSuspended(std::unique_ptr<SetSuspendedParams> params, base::OnceCallback<void(std::unique_ptr<SetSuspendedResult>)> callback = base::OnceCallback<void(std::unique_ptr<SetSuspendedResult>)>());
