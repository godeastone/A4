...
class HEADLESS_EXPORT DataEntry {
 public:
  ...
  public:
    ...
    kResponseHeadersSet = 1 << 7,
      kAllRequiredFieldsSet = (kRequestURLSet | kRequestMethodSet | kRequestHeadersSet | kResponseTimeSet | kResponseStatusSet | kResponseStatusTextSet | kResponseHeadersSet | 0)
    };
...
class HEADLESS_EXPORT RequestCachedResponseParams {
 public:
  ...
  public:
    ...
    kCacheIdSet = 1 << 1,
    kRequestURLSet = 1 << 2,
      kAllRequiredFieldsSet = (kCacheIdSet | kRequestURLSet | 0)
    };
...
class HEADLESS_EXPORT RequestEntriesParams {
 public:
  ...
  public:
    ...
    kSkipCountSet = 1 << 2,
    kPageSizeSet = 1 << 3,
      kAllRequiredFieldsSet = (kCacheIdSet | kSkipCountSet | kPageSizeSet | 0)
    };
    ...
    RequestEntriesParamsBuilder<STATE | kSkipCountSet>& SetSkipCount(int value) {
    ...
    RequestEntriesParamsBuilder<STATE | kPageSizeSet>& SetPageSize(int value) {
...
class HEADLESS_EXPORT RequestEntriesResult {
 public:
  ...
  public:
    ...
    kHasMoreSet = 1 << 2,
      kAllRequiredFieldsSet = (kCacheDataEntriesSet | kHasMoreSet | 0)
    };
    ...
    RequestEntriesResultBuilder<STATE | kHasMoreSet>& SetHasMore(bool value) {
