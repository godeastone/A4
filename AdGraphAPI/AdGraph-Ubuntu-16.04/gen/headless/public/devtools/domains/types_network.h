...
class HEADLESS_EXPORT ResourceTiming {
 public:
  ...
  public:
    ...
    kPushStartSet = 1 << 14,
    kPushEndSet = 1 << 15,
    kReceiveHeadersEndSet = 1 << 16,
      kAllRequiredFieldsSet = (kRequestTimeSet | kProxyStartSet | kProxyEndSet | kDnsStartSet | kDnsEndSet | kConnectStartSet | kConnectEndSet | kSslStartSet | kSslEndSet | kWorkerStartSet | kWorkerReadySet | kSendStartSet | kSendEndSet | kPushStartSet | kPushEndSet | kReceiveHeadersEndSet | 0)
    };
...
class HEADLESS_EXPORT CachedResource {
 public:
  ...
  ::headless::page::ResourceType GetType() const { return type_; }
  void SetType(::headless::page::ResourceType value) { type_ = value; }
  ...
  public:
    ...
    CachedResourceBuilder<STATE | kTypeSet>& SetType(::headless::page::ResourceType value) {
 ...
 private:
  ...
  std::string url_;
  ::headless::page::ResourceType type_;
...
class HEADLESS_EXPORT Cookie {
 public:
  ...
  public:
    ...
    kSecureSet = 1 << 8,
    kSessionSet = 1 << 9,
      kAllRequiredFieldsSet = (kNameSet | kValueSet | kDomainSet | kPathSet | kExpiresSet | kSizeSet | kHttpOnlySet | kSecureSet | kSessionSet | 0)
    };
...
class HEADLESS_EXPORT RequestPattern {
 public:
  ...
  ::headless::page::ResourceType GetResourceType() const { DCHECK(HasResourceType()); return resource_type_.value(); }
  void SetResourceType(::headless::page::ResourceType value) { resource_type_ = value; }
  ...
  public:
    ...
    RequestPatternBuilder<STATE>& SetResourceType(::headless::page::ResourceType value) {
 ...
 private:
  ...
  base::Optional<::headless::page::ResourceType> resource_type_;
...
class HEADLESS_EXPORT SignedExchangeSignature {
 public:
  ...
  std::string GetCertUrl() const { return cert_url_; }
  ...
  public:
    ...
    kDateSet = 1 << 5,
    kExpiresSet = 1 << 6,
      kAllRequiredFieldsSet = (kLabelSet | kIntegritySet | kCertUrlSet | kValidityUrlSet | kDateSet | kExpiresSet | 0)
    };
    ...
    SignedExchangeSignatureBuilder<STATE | kCertUrlSet>& SetCertUrl(const std::string& value) {
      static_assert(!(STATE & kCertUrlSet), "property certUrl should not have already been set");
      result_->SetCertUrl(value);
      return CastState<kCertUrlSet>();
    }
...
class HEADLESS_EXPORT SignedExchangeHeader {
 public:
  ...
  public:
    ...
    kResponseCodeSet = 1 << 3,
    kResponseHeadersSet = 1 << 4,
    kSignaturesSet = 1 << 5,
      kAllRequiredFieldsSet = (kRequestUrlSet | kRequestMethodSet | kResponseCodeSet | kResponseHeadersSet | kSignaturesSet | 0)
    };
    ...
    SignedExchangeHeaderBuilder<STATE | kRequestMethodSet>& SetRequestMethod(const std::string& value) {
...
class HEADLESS_EXPORT SignedExchangeInfo {
 public:
  ...
  const std::vector<std::string>* GetErrors() const { DCHECK(HasErrors()); return &errors_.value(); }
  void SetErrors(std::vector<std::string> value) { errors_ = std::move(value); }
  ...
  public:
    ...
    SignedExchangeInfoBuilder<STATE>& SetErrors(std::vector<std::string> value) {
 ...
 private:
  ...
  base::Optional<std::unique_ptr<::headless::network::SecurityDetails>> security_details_;
  base::Optional<std::vector<std::string>> errors_;
...
class HEADLESS_EXPORT ContinueInterceptedRequestParams {
 ...
 private:
  ...
  base::Optional<std::string> raw_response_;
  base::Optional<std::string> url_;
...
class HEADLESS_EXPORT LoadingFailedParams {
 public:
  ...
  public:
    ...
    LoadingFailedParamsBuilder<STATE | kTypeSet>& SetType(::headless::page::ResourceType value) {
      static_assert(!(STATE & kTypeSet), "property type should not have already been set");
      result_->SetType(value);
      return CastState<kTypeSet>();
    }
...
class HEADLESS_EXPORT LoadingFinishedParams {
 public:
  ...
  bool HasBlockedCrossSiteDocument() const { return !!blocked_cross_site_document_; }
  bool GetBlockedCrossSiteDocument() const { DCHECK(HasBlockedCrossSiteDocument()); return blocked_cross_site_document_.value(); }
  void SetBlockedCrossSiteDocument(bool value) { blocked_cross_site_document_ = value; }
  ...
  public:
    ...
    LoadingFinishedParamsBuilder<STATE>& SetBlockedCrossSiteDocument(bool value) {
      result_->SetBlockedCrossSiteDocument(value);
      return *this;
    }
 ...
 private:
  ...
  double timestamp_;
  double encoded_data_length_;
  base::Optional<bool> blocked_cross_site_document_;
...
class HEADLESS_EXPORT RequestInterceptedParams {
 public:
  ...
  ::headless::page::ResourceType GetResourceType() const { return resource_type_; }
  void SetResourceType(::headless::page::ResourceType value) { resource_type_ = value; }
  ...
  public:
    ...
    RequestInterceptedParamsBuilder<STATE | kResourceTypeSet>& SetResourceType(::headless::page::ResourceType value) {
 ...
 private:
  ...
  ::headless::page::ResourceType resource_type_;
...
class HEADLESS_EXPORT RequestWillBeSentParams {
 public:
  ...
  ::headless::page::ResourceType GetType() const { DCHECK(HasType()); return type_.value(); }
  void SetType(::headless::page::ResourceType value) { type_ = value; }
  ...
  public:
    ...
    RequestWillBeSentParamsBuilder<STATE>& SetType(::headless::page::ResourceType value) {
      result_->SetType(value);
      return *this;
    }
 ...
 private:
  ...
  base::Optional<::headless::page::ResourceType> type_;
...
class HEADLESS_EXPORT ResponseReceivedParams {
 public:
  ...
  public:
    ...
    ResponseReceivedParamsBuilder<STATE | kTypeSet>& SetType(::headless::page::ResourceType value) {
      static_assert(!(STATE & kTypeSet), "property type should not have already been set");
      result_->SetType(value);
      return CastState<kTypeSet>();
    }
