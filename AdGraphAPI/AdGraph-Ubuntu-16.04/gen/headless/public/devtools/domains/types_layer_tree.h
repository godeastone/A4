...
class HEADLESS_EXPORT PictureTile {
 public:
  ...
  std::string GetPicture() const { return picture_; }
  void SetPicture(const std::string& value) { picture_ = value; }
  ...
  public:
    ...
    PictureTileBuilder<STATE | kPictureSet>& SetPicture(const std::string& value) {
 ...
 public:
  ...
  public:
    ...
    kCompositingReasonsSet = 1 << 1,
      kAllRequiredFieldsSet = (kCompositingReasonsSet | 0)
    };
