...
class HEADLESS_EXPORT CSSStyleSheetHeader {
 public:
  ...
  public:
    ...
    kStartColumnSet = 1 << 9,
    kLengthSet = 1 << 10,
      kAllRequiredFieldsSet = (kStyleSheetIdSet | kFrameIdSet | kSourceURLSet | kOriginSet | kTitleSet | kDisabledSet | kIsInlineSet | kStartLineSet | kStartColumnSet | kLengthSet | 0)
    };
...
class HEADLESS_EXPORT GetBackgroundColorsResult {
 public:
  ...
  bool HasComputedBodyFontSize() const { return !!computed_body_font_size_; }
  std::string GetComputedBodyFontSize() const { DCHECK(HasComputedBodyFontSize()); return computed_body_font_size_.value(); }
  void SetComputedBodyFontSize(const std::string& value) { computed_body_font_size_ = value; }
  ...
  public:
    ...
    GetBackgroundColorsResultBuilder<STATE>& SetComputedBodyFontSize(const std::string& value) {
      result_->SetComputedBodyFontSize(value);
      return *this;
    }
 ...
 private:
  ...
  base::Optional<std::string> computed_body_font_size_;
 ...
 public:
  ...
  public:
    enum {
      kNoFieldsSet = 0,
    kCoverageSet = 1 << 1,
      kAllRequiredFieldsSet = (kCoverageSet | 0)
    };
