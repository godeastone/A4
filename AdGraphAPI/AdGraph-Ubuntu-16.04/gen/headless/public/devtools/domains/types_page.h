...
class HEADLESS_EXPORT FrameResource {
 public:
  ...
  public:
    ...
    FrameResourceBuilder<STATE | kTypeSet>& SetType(::headless::page::ResourceType value) {
...
class HEADLESS_EXPORT RequestAppBannerParams {
 public:
  static std::unique_ptr<RequestAppBannerParams> Parse(const base::Value& value, ErrorReporter* errors);
  ~RequestAppBannerParams() { }

  std::unique_ptr<base::Value> Serialize() const;
  std::unique_ptr<RequestAppBannerParams> Clone() const;

  template<int STATE>
  class RequestAppBannerParamsBuilder {
  public:
    enum {
      kNoFieldsSet = 0,
      kAllRequiredFieldsSet = (0)
    ...
    std::unique_ptr<RequestAppBannerParams> Build() {
      static_assert(STATE == kAllRequiredFieldsSet, "all required fields should have been set");
      return std::move(result_);
    }

   private:
    friend class RequestAppBannerParams;
    RequestAppBannerParamsBuilder() : result_(new RequestAppBannerParams()) { }

    template<int STEP> RequestAppBannerParamsBuilder<STATE | STEP>& CastState() {
      return *reinterpret_cast<RequestAppBannerParamsBuilder<STATE | STEP>*>(this);
    }

    std::unique_ptr<RequestAppBannerParams> result_;
  };

  static RequestAppBannerParamsBuilder<0> Builder() {
    return RequestAppBannerParamsBuilder<0>();
  }
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(RequestAppBannerParams);
};


// Result for the RequestAppBanner command.
class HEADLESS_EXPORT RequestAppBannerResult {
 public:
  static std::unique_ptr<RequestAppBannerResult> Parse(const base::Value& value, ErrorReporter* errors);
  ~RequestAppBannerResult() { }

  std::unique_ptr<base::Value> Serialize() const;
  std::unique_ptr<RequestAppBannerResult> Clone() const;

  template<int STATE>
  class RequestAppBannerResultBuilder {
  public:
    enum {
      kNoFieldsSet = 0,
      kAllRequiredFieldsSet = (0)
    ...
    std::unique_ptr<RequestAppBannerResult> Build() {
      static_assert(STATE == kAllRequiredFieldsSet, "all required fields should have been set");
      return std::move(result_);
    }

   private:
    friend class RequestAppBannerResult;
    RequestAppBannerResultBuilder() : result_(new RequestAppBannerResult()) { }

    template<int STEP> RequestAppBannerResultBuilder<STATE | STEP>& CastState() {
      return *reinterpret_cast<RequestAppBannerResultBuilder<STATE | STEP>*>(this);
    }

    std::unique_ptr<RequestAppBannerResult> result_;
  };

  static RequestAppBannerResultBuilder<0> Builder() {
    return RequestAppBannerResultBuilder<0>();
  }
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(RequestAppBannerResult);
};
...
class HEADLESS_EXPORT FrameScheduledNavigationParams {
 public:
  ...
  ::headless::page::FrameScheduledNavigationReason GetReason() const { return reason_; }
  void SetReason(::headless::page::FrameScheduledNavigationReason value) { reason_ = value; }
  ...
  public:
    ...
    FrameScheduledNavigationParamsBuilder<STATE | kReasonSet>& SetReason(::headless::page::FrameScheduledNavigationReason value) {
 ...
 private:
  ...
  std::string frame_id_;
  double delay_;
  ::headless::page::FrameScheduledNavigationReason reason_;
  std::string url_;
