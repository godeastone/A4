...
void Domain::StartPreciseCoverage(base::OnceClosure callback) {
  std::unique_ptr<StartPreciseCoverageParams> params = StartPreciseCoverageParams::Builder()
      .Build();
  dispatcher_->SendMessage("Profiler.startPreciseCoverage", params->Serialize(), std::move(callback));
}
void Domain::StartPreciseCoverage(std::unique_ptr<StartPreciseCoverageParams> params, base::OnceClosure callback) {
  dispatcher_->SendMessage("Profiler.startPreciseCoverage", params->Serialize(), std::move(callback));
}
