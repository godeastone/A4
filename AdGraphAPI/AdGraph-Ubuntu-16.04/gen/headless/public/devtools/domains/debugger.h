...
class HEADLESS_EXPORT Domain {
 ...
 protected:
  ...
  static void HandleScheduleStepIntoAsyncResponse(base::OnceCallback<void(std::unique_ptr<ScheduleStepIntoAsyncResult>)> callback, const base::Value& response);
...
class ExperimentalDomain : public Domain {
 public:
  ...
  void ScheduleStepIntoAsync(std::unique_ptr<ScheduleStepIntoAsyncParams> params, base::OnceCallback<void(std::unique_ptr<ScheduleStepIntoAsyncResult>)> callback = base::OnceCallback<void(std::unique_ptr<ScheduleStepIntoAsyncResult>)>());
