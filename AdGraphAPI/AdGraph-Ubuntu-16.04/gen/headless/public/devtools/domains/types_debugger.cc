...
std::unique_ptr<ScheduleStepIntoAsyncParams> ScheduleStepIntoAsyncParams::Parse(const base::Value& value, ErrorReporter* errors) {
  errors->Push();
  errors->SetName("ScheduleStepIntoAsyncParams");
  if (!value.is_dict()) {
    errors->AddError("object expected");
    errors->Pop();
    return nullptr;
  ...
  std::unique_ptr<ScheduleStepIntoAsyncParams> result(new ScheduleStepIntoAsyncParams());
  errors->Push();
  errors->SetName("ScheduleStepIntoAsyncParams");
  errors->Pop();
  errors->Pop();
...
std::unique_ptr<base::Value> ScheduleStepIntoAsyncParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}

std::unique_ptr<ScheduleStepIntoAsyncParams> ScheduleStepIntoAsyncParams::Clone() const {
  ErrorReporter errors;
  std::unique_ptr<ScheduleStepIntoAsyncParams> result = Parse(*Serialize(), &errors);
  DCHECK(!errors.HasErrors());
  return result;
}


std::unique_ptr<ScheduleStepIntoAsyncResult> ScheduleStepIntoAsyncResult::Parse(const base::Value& value, ErrorReporter* errors) {
  errors->Push();
  errors->SetName("ScheduleStepIntoAsyncResult");
  if (!value.is_dict()) {
    errors->AddError("object expected");
    errors->Pop();
    return nullptr;
  ...
  std::unique_ptr<ScheduleStepIntoAsyncResult> result(new ScheduleStepIntoAsyncResult());
  errors->Push();
  errors->SetName("ScheduleStepIntoAsyncResult");
  errors->Pop();
  errors->Pop();
...
std::unique_ptr<base::Value> ScheduleStepIntoAsyncResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}

std::unique_ptr<ScheduleStepIntoAsyncResult> ScheduleStepIntoAsyncResult::Clone() const {
  ErrorReporter errors;
  std::unique_ptr<ScheduleStepIntoAsyncResult> result = Parse(*Serialize(), &errors);
  DCHECK(!errors.HasErrors());
  return result;
}
