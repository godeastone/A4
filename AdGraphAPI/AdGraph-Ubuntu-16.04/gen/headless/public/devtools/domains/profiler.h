...
class HEADLESS_EXPORT Domain {
 public:
  ...
  void StartPreciseCoverage(base::OnceClosure callback = base::OnceClosure());
  void StartPreciseCoverage(std::unique_ptr<StartPreciseCoverageParams> params, base::OnceClosure callback);
