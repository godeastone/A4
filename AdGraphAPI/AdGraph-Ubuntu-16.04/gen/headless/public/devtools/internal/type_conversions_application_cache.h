...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const application_cache::EnableParams& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const application_cache::EnableResult& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const application_cache::GetFramesWithManifestsParams& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const application_cache::ApplicationCacheStatusUpdatedParams& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const application_cache::NetworkStateUpdatedParams& value, T*) {
  return value.Serialize();
}
