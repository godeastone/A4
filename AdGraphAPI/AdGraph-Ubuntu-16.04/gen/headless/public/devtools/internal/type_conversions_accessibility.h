...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const accessibility::AXPropertyName& value, T*) {
  switch (value) {
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const accessibility::GetPartialAXTreeParams& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const accessibility::GetPartialAXTreeResult& value, T*) {
  return value.Serialize();
}
