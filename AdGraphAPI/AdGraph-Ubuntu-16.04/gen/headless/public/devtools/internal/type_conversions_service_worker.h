...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const service_worker::DeliverPushMessageResult& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const service_worker::DisableParams& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const service_worker::DisableResult& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const service_worker::DispatchSyncEventParams& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const service_worker::DispatchSyncEventResult& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const service_worker::EnableParams& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const service_worker::EnableResult& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const service_worker::InspectWorkerResult& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const service_worker::SetForceUpdateOnPageLoadResult& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const service_worker::SkipWaitingParams& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const service_worker::SkipWaitingResult& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const service_worker::StartWorkerResult& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const service_worker::StopAllWorkersParams& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const service_worker::StopAllWorkersResult& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const service_worker::StopWorkerResult& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const service_worker::UnregisterResult& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const service_worker::UpdateRegistrationResult& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const service_worker::WorkerErrorReportedParams& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const service_worker::WorkerRegistrationUpdatedParams& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const service_worker::WorkerVersionUpdatedParams& value, T*) {
  return value.Serialize();
}
