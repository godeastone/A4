...
bool DataSourceConfig_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->trace_config, 2, validation_context)) {
    return false;
  }
...
// static
bool ProducerClient_CreateDataSourceInstance_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ProducerClient_CreateDataSourceInstance_Params_Data* object = static_cast<const ProducerClient_CreateDataSourceInstance_Params_Data*>(data);
...
ProducerClient_CreateDataSourceInstance_Params_Data::ProducerClient_CreateDataSourceInstance_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool ProducerClient_TearDownDataSourceInstance_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ProducerClient_TearDownDataSourceInstance_Params_Data* object = static_cast<const ProducerClient_TearDownDataSourceInstance_Params_Data*>(data);
...
ProducerClient_TearDownDataSourceInstance_Params_Data::ProducerClient_TearDownDataSourceInstance_Params_Data()
    : header_({sizeof(*this), 0}) {}
...
bool PerfettoService_ConnectToProducerHost_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->producer_host, 2, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateHandleOrInterface(object->producer_host,
                                                 validation_context)) {
    return false;
  }
