...
using RevocableScreenOrientationPtr = ::blink::RevocableInterfacePtr<ScreenOrientation>;
...
using RevocableScreenOrientationListenerPtr = ::blink::RevocableInterfacePtr<ScreenOrientationListener>;
