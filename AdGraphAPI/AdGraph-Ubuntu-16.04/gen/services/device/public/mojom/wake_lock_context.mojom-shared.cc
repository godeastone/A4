...
// static
bool WakeLockContext_GetWakeLock_Params_Data::Validate(
    const void* data,
  ...
  const WakeLockContext_GetWakeLock_Params_Data* object = static_cast<const WakeLockContext_GetWakeLock_Params_Data*>(data);
