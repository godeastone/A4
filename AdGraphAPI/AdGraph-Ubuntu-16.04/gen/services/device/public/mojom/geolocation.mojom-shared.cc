...
bool Geolocation_SetHighAccuracy_Params_Data::Validate(
  ...
  const Geolocation_SetHighAccuracy_Params_Data* object = static_cast<const Geolocation_SetHighAccuracy_Params_Data*>(data);
...
bool Geolocation_QueryNextPosition_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const Geolocation_QueryNextPosition_Params_Data* object = static_cast<const Geolocation_QueryNextPosition_Params_Data*>(data);
...
bool Geolocation_QueryNextPosition_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const Geolocation_QueryNextPosition_ResponseParams_Data* object = static_cast<const Geolocation_QueryNextPosition_ResponseParams_Data*>(data);
