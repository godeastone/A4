...
bool GeolocationContext_BindGeolocation_Params_Data::Validate(
  ...
  const GeolocationContext_BindGeolocation_Params_Data* object = static_cast<const GeolocationContext_BindGeolocation_Params_Data*>(data);
...
bool GeolocationContext_SetOverride_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const GeolocationContext_SetOverride_Params_Data* object = static_cast<const GeolocationContext_SetOverride_Params_Data*>(data);
...
bool GeolocationContext_ClearOverride_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const GeolocationContext_ClearOverride_Params_Data* object = static_cast<const GeolocationContext_ClearOverride_Params_Data*>(data);
