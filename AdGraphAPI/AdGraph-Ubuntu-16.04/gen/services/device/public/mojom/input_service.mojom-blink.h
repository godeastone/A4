...
using RevocableInputDeviceManagerClientPtr = ::blink::RevocableInterfacePtr<InputDeviceManagerClient>;
...
using RevocableInputDeviceManagerPtr = ::blink::RevocableInterfacePtr<InputDeviceManager>;
