...
NFCMessage::NFCMessage(
    std::vector<NFCRecordPtr> data_in,
...
void NFCClientInterceptorForTesting::OnWatch(const std::vector<uint32_t>& watch_ids, NFCMessagePtr message) {
...
// static
bool StructTraits<::device::mojom::NFCRecord::DataView, ::device::mojom::NFCRecordPtr>::Read(
    ::device::mojom::NFCRecord::DataView input,
    ::device::mojom::NFCRecordPtr* output) {
  bool success = true;
  ::device::mojom::NFCRecordPtr result(::device::mojom::NFCRecord::New());
...
// static
bool StructTraits<::device::mojom::NFCMessage::DataView, ::device::mojom::NFCMessagePtr>::Read(
    ::device::mojom::NFCMessage::DataView input,
    ::device::mojom::NFCMessagePtr* output) {
  bool success = true;
  ::device::mojom::NFCMessagePtr result(::device::mojom::NFCMessage::New());
...
// static
bool StructTraits<::device::mojom::NFCRecordTypeFilter::DataView, ::device::mojom::NFCRecordTypeFilterPtr>::Read(
    ::device::mojom::NFCRecordTypeFilter::DataView input,
    ::device::mojom::NFCRecordTypeFilterPtr* output) {
  bool success = true;
  ::device::mojom::NFCRecordTypeFilterPtr result(::device::mojom::NFCRecordTypeFilter::New());
