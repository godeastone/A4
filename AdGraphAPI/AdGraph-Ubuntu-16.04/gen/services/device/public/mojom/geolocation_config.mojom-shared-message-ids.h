...
// The 228121161 value is based on sha256(salt + "GeolocationConfig1").
constexpr uint32_t kGeolocationConfig_IsHighAccuracyLocationBeingCaptured_Name = 228121161;
