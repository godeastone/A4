...
void FingerprintObserverProxy::OnAuthScanDone(
    uint32_t in_scan_result, const base::flat_map<std::string, std::vector<std::string>>& in_matches) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void FingerprintObserverInterceptorForTesting::OnAuthScanDone(uint32_t scan_result, const base::flat_map<std::string, std::vector<std::string>>& matches) {
