...
void TimeZoneMonitorProxy::AddClient(
  ...
  TRACE_EVENT0("mojom", "device::mojom::TimeZoneMonitor::AddClient");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)device::mojom::TimeZoneMonitor::AddClient",
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "device::mojom::TimeZoneMonitorClient::OnTimeZoneChange");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)device::mojom::TimeZoneMonitorClient::OnTimeZoneChange",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
