...
using RevocablePowerMonitorPtr = ::blink::RevocableInterfacePtr<PowerMonitor>;
...
using RevocablePowerMonitorClientPtr = ::blink::RevocableInterfacePtr<PowerMonitorClient>;
