...
void PowerMonitorProxy::AddClient(
  ...
  TRACE_EVENT0("mojom", "device::mojom::PowerMonitor::AddClient");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)device::mojom::PowerMonitor::AddClient",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            ...
            "PowerMonitor::AddClient deserializer");
        return false;
      }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "device::mojom::PowerMonitorClient::PowerStateChange");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "device::mojom::PowerMonitorClient::Suspend");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "device::mojom::PowerMonitorClient::Resume");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)device::mojom::PowerMonitorClient::PowerStateChange",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)device::mojom::PowerMonitorClient::Suspend",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)device::mojom::PowerMonitorClient::Resume",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
