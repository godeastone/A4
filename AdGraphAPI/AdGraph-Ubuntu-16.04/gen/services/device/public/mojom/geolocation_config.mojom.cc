...
void GeolocationConfigProxy::IsHighAccuracyLocationBeingCaptured(
  ...
  TRACE_EVENT0("mojom", "device::mojom::GeolocationConfig::IsHighAccuracyLocationBeingCaptured");
#endif
...
bool GeolocationConfig_IsHighAccuracyLocationBeingCaptured_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "device::mojom::GeolocationConfig::IsHighAccuracyLocationBeingCapturedCallback",
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        ...
        "GeolocationConfig::IsHighAccuracyLocationBeingCaptured response deserializer");
    return false;
  }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)device::mojom::GeolocationConfig::IsHighAccuracyLocationBeingCapturedCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)device::mojom::GeolocationConfig::IsHighAccuracyLocationBeingCaptured",
               "message", message->name());
#endif
      break;
    }
  ...
  TRACE_EVENT1("mojom", "(Impl)device::mojom::GeolocationConfig::IsHighAccuracyLocationBeingCaptured",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "GeolocationConfig::IsHighAccuracyLocationBeingCaptured deserializer");
        return false;
      }
      GeolocationConfig::IsHighAccuracyLocationBeingCapturedCallback callback =
