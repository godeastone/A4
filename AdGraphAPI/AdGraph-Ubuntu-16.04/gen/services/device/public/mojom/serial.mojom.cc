...
class SerialDeviceEnumerator_GetDevices_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      std::vector<SerialDeviceInfoPtr> in_devices);
...
bool SerialDeviceEnumerator_GetDevices_ForwardToCallback::Accept(
  ...
  bool success = true;
  std::vector<SerialDeviceInfoPtr> p_devices{};
  ...
  proxy_->GetDevices(
      base::BindOnce(
          [](base::RunLoop* loop,
             std::vector<SerialDeviceInfoPtr>* out_devices
,
             std::vector<SerialDeviceInfoPtr> devices) {*out_devices = std::move(devices);
            loop->Quit();
          },
          &loop,
          out_devices));
...
void SerialIoHandlerProxy::Open(
    const std::string& in_port, SerialConnectionOptionsPtr in_options, OpenCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class SerialIoHandler_Read_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      const std::vector<uint8_t>& in_data, SerialReceiveError in_error);
...
void SerialIoHandlerInterceptorForTesting::Open(const std::string& port, SerialConnectionOptionsPtr options, OpenCallback callback) {
...
void SerialIoHandlerInterceptorForTesting::Write(const std::vector<uint8_t>& data, WriteCallback callback) {
...
// static
bool StructTraits<::device::mojom::SerialDeviceInfo::DataView, ::device::mojom::SerialDeviceInfoPtr>::Read(
    ::device::mojom::SerialDeviceInfo::DataView input,
    ::device::mojom::SerialDeviceInfoPtr* output) {
  bool success = true;
  ::device::mojom::SerialDeviceInfoPtr result(::device::mojom::SerialDeviceInfo::New());
...
// static
bool StructTraits<::device::mojom::SerialDeviceControlSignals::DataView, ::device::mojom::SerialDeviceControlSignalsPtr>::Read(
    ::device::mojom::SerialDeviceControlSignals::DataView input,
    ::device::mojom::SerialDeviceControlSignalsPtr* output) {
  bool success = true;
  ::device::mojom::SerialDeviceControlSignalsPtr result(::device::mojom::SerialDeviceControlSignals::New());
