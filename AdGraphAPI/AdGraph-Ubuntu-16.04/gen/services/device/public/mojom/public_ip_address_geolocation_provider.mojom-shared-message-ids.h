...
// The 859859403 value is based on sha256(salt + "PublicIpAddressGeolocationProvider1").
constexpr uint32_t kPublicIpAddressGeolocationProvider_CreateGeolocation_Name = 859859403;
