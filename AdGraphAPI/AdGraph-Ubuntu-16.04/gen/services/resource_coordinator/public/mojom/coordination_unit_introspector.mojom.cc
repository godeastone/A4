...
PageInfo::PageInfo(
    ...
    bool is_visible_in,
    base::TimeDelta time_since_last_navigation_in,
    base::TimeDelta time_since_last_visibility_change_in)
...
ProcessInfo::ProcessInfo(
    ...
    std::vector<PageInfoPtr> page_infos_in,
    base::Optional<base::Time> launch_time_in)
    : pid(std::move(pid_in)),
...
class CoordinationUnitIntrospector_GetProcessToURLMap_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      std::vector<ProcessInfoPtr> in_process_infos);
...
bool CoordinationUnitIntrospector_GetProcessToURLMap_ForwardToCallback::Accept(
  ...
  bool success = true;
  std::vector<ProcessInfoPtr> p_process_infos{};
  ...
  proxy_->GetProcessToURLMap(
      base::BindOnce(
          [](base::RunLoop* loop,
             std::vector<ProcessInfoPtr>* out_process_infos
,
             std::vector<ProcessInfoPtr> process_infos) {*out_process_infos = std::move(process_infos);
            loop->Quit();
          },
          &loop,
          out_process_infos));
...
// static
bool StructTraits<::resource_coordinator::mojom::PageInfo::DataView, ::resource_coordinator::mojom::PageInfoPtr>::Read(
    ::resource_coordinator::mojom::PageInfo::DataView input,
    ::resource_coordinator::mojom::PageInfoPtr* output) {
  bool success = true;
  ::resource_coordinator::mojom::PageInfoPtr result(::resource_coordinator::mojom::PageInfo::New());
...
// static
bool StructTraits<::resource_coordinator::mojom::ProcessInfo::DataView, ::resource_coordinator::mojom::ProcessInfoPtr>::Read(
    ::resource_coordinator::mojom::ProcessInfo::DataView input,
    ::resource_coordinator::mojom::ProcessInfoPtr* output) {
  bool success = true;
  ::resource_coordinator::mojom::ProcessInfoPtr result(::resource_coordinator::mojom::ProcessInfo::New());
