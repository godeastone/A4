...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM) ClientProcess
 ...
 public:
  ...
  virtual void EnableHeapProfiling(base::trace_event::HeapProfilingMode mode, EnableHeapProfilingCallback callback) = 0;
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM) ClientProcessInterceptorForTesting : public ClientProcess {
  ...
  void EnableHeapProfiling(base::trace_event::HeapProfilingMode mode, EnableHeapProfilingCallback callback) override;
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM) ClientProcessProxy
 ...
 public:
  ...
  void EnableHeapProfiling(base::trace_event::HeapProfilingMode mode, EnableHeapProfilingCallback callback) final;
