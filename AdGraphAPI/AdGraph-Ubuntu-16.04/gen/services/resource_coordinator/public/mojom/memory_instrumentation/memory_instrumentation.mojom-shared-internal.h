...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_SHARED) ClientProcess_EnableHeapProfiling_Params_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(ClientProcess_EnableHeapProfiling_Params_Data));
      new (data()) ClientProcess_EnableHeapProfiling_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    ClientProcess_EnableHeapProfiling_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<ClientProcess_EnableHeapProfiling_Params_Data>(index_);
    }
    ClientProcess_EnableHeapProfiling_Params_Data* operator->() { return data(); }
 ...
 private:
  ClientProcess_EnableHeapProfiling_Params_Data();
  ~ClientProcess_EnableHeapProfiling_Params_Data() = delete;
};
static_assert(sizeof(ClientProcess_EnableHeapProfiling_Params_Data) == 16,
              "Bad sizeof(ClientProcess_EnableHeapProfiling_Params_Data)");
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_SHARED) ClientProcess_EnableHeapProfiling_ResponseParams_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(ClientProcess_EnableHeapProfiling_ResponseParams_Data));
      new (data()) ClientProcess_EnableHeapProfiling_ResponseParams_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    ClientProcess_EnableHeapProfiling_ResponseParams_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<ClientProcess_EnableHeapProfiling_ResponseParams_Data>(index_);
    }
    ClientProcess_EnableHeapProfiling_ResponseParams_Data* operator->() { return data(); }
 ...
 private:
  ClientProcess_EnableHeapProfiling_ResponseParams_Data();
  ~ClientProcess_EnableHeapProfiling_ResponseParams_Data() = delete;
};
static_assert(sizeof(ClientProcess_EnableHeapProfiling_ResponseParams_Data) == 16,
              "Bad sizeof(ClientProcess_EnableHeapProfiling_ResponseParams_Data)");
