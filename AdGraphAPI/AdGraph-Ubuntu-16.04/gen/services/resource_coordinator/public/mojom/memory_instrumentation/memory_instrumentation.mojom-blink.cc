...
void ClientProcessProxy::EnableHeapProfiling(
    HeapProfilingMode in_mode, EnableHeapProfilingCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ClientProcessInterceptorForTesting::EnableHeapProfiling(HeapProfilingMode mode, EnableHeapProfilingCallback callback) {
