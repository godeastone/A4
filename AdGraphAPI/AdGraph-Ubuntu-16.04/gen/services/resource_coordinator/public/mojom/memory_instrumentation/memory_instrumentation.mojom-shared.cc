...
// static
bool ClientProcess_EnableHeapProfiling_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ClientProcess_EnableHeapProfiling_Params_Data* object = static_cast<const ClientProcess_EnableHeapProfiling_Params_Data*>(data);
  ...
  if (!::memory_instrumentation::mojom::internal::HeapProfilingMode_Data
...
ClientProcess_EnableHeapProfiling_Params_Data::ClientProcess_EnableHeapProfiling_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool ClientProcess_EnableHeapProfiling_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ClientProcess_EnableHeapProfiling_ResponseParams_Data* object = static_cast<const ClientProcess_EnableHeapProfiling_ResponseParams_Data*>(data);
...
ClientProcess_EnableHeapProfiling_ResponseParams_Data::ClientProcess_EnableHeapProfiling_ResponseParams_Data()
    : header_({sizeof(*this), 0}) {}
