...
#ifndef SERVICES_RESOURCE_COORDINATOR_PUBLIC_MOJOM_COORDINATION_UNIT_INTROSPECTOR_MOJOM_BLINK_H_
#define SERVICES_RESOURCE_COORDINATOR_PUBLIC_MOJOM_COORDINATION_UNIT_INTROSPECTOR_MOJOM_BLINK_H_
...
using RevocableCoordinationUnitIntrospectorPtr = ::blink::RevocableInterfacePtr<CoordinationUnitIntrospector>;
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_BLINK) CoordinationUnitIntrospector
 ...
 public:
  ...
  using GetProcessToURLMapCallback = base::OnceCallback<void(WTF::Vector<ProcessInfoPtr>)>;
  virtual void GetProcessToURLMap(GetProcessToURLMapCallback callback) = 0;
};
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_BLINK) CoordinationUnitIntrospectorInterceptorForTesting : public CoordinationUnitIntrospector {
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_BLINK) CoordinationUnitIntrospectorAsyncWaiter {
 public:
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_BLINK) CoordinationUnitIntrospectorProxy
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_BLINK) CoordinationUnitIntrospectorStubDispatch {
 public:
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_BLINK) CoordinationUnitIntrospectorRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_BLINK) CoordinationUnitIntrospectorResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_BLINK) PageInfo {
 public:
  ...
  PageInfo(
      ...
      bool is_visible,
      WTF::TimeDelta time_since_last_navigation,
      WTF::TimeDelta time_since_last_visibility_change);
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        PageInfo::DataView, WTF::Vector<uint8_t>>(input);
  }
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_BLINK) ProcessInfo {
 public:
  ...
  ProcessInfo(
      ...
      WTF::Vector<PageInfoPtr> page_infos,
      base::Optional<WTF::Time> launch_time);
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ProcessInfo::DataView, WTF::Vector<uint8_t>>(input);
  }
...
template <>
struct COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_BLINK) StructTraits<::resource_coordinator::mojom::blink::PageInfo::DataView,
                                         ::resource_coordinator::mojom::blink::PageInfoPtr> {
  static bool IsNull(const ::resource_coordinator::mojom::blink::PageInfoPtr& input) { return !input; }
  static void SetToNull(::resource_coordinator::mojom::blink::PageInfoPtr* output) { output->reset(); }

  static decltype(::resource_coordinator::mojom::blink::PageInfo::ukm_source_id) ukm_source_id(
      const ::resource_coordinator::mojom::blink::PageInfoPtr& input) {
    return input->ukm_source_id;
  }

  static decltype(::resource_coordinator::mojom::blink::PageInfo::is_visible) is_visible(
      const ::resource_coordinator::mojom::blink::PageInfoPtr& input) {
    return input->is_visible;
  }

  static const decltype(::resource_coordinator::mojom::blink::PageInfo::time_since_last_navigation)& time_since_last_navigation(
      const ::resource_coordinator::mojom::blink::PageInfoPtr& input) {
    return input->time_since_last_navigation;
  }

  static const decltype(::resource_coordinator::mojom::blink::PageInfo::time_since_last_visibility_change)& time_since_last_visibility_change(
      const ::resource_coordinator::mojom::blink::PageInfoPtr& input) {
    return input->time_since_last_visibility_change;
  }

  static bool Read(::resource_coordinator::mojom::blink::PageInfo::DataView input, ::resource_coordinator::mojom::blink::PageInfoPtr* output);
};


template <>
struct COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_BLINK) StructTraits<::resource_coordinator::mojom::blink::ProcessInfo::DataView,
                                         ::resource_coordinator::mojom::blink::ProcessInfoPtr> {
  static bool IsNull(const ::resource_coordinator::mojom::blink::ProcessInfoPtr& input) { return !input; }
  static void SetToNull(::resource_coordinator::mojom::blink::ProcessInfoPtr* output) { output->reset(); }

  static const decltype(::resource_coordinator::mojom::blink::ProcessInfo::pid)& pid(
      const ::resource_coordinator::mojom::blink::ProcessInfoPtr& input) {
    return input->pid;
  }

  static const decltype(::resource_coordinator::mojom::blink::ProcessInfo::page_infos)& page_infos(
      const ::resource_coordinator::mojom::blink::ProcessInfoPtr& input) {
    return input->page_infos;
  }

  static const decltype(::resource_coordinator::mojom::blink::ProcessInfo::launch_time)& launch_time(
      const ::resource_coordinator::mojom::blink::ProcessInfoPtr& input) {
    return input->launch_time;
  }

  static bool Read(::resource_coordinator::mojom::blink::ProcessInfo::DataView input, ::resource_coordinator::mojom::blink::ProcessInfoPtr* output);
};

}  // namespace mojo

#endif  // SERVICES_RESOURCE_COORDINATOR_PUBLIC_MOJOM_COORDINATION_UNIT_INTROSPECTOR_MOJOM_BLINK_H_