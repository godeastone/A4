...
#include "services/resource_coordinator/public/mojom/coordination_unit_provider.mojom-blink.h"
...
void CoordinationUnitProviderProxy::CreateFrameCoordinationUnit(
    ::resource_coordinator::mojom::blink::FrameCoordinationUnitRequest in_request, ::resource_coordinator::mojom::blink::CoordinationUnitIDPtr in_id) {
...
void CoordinationUnitProviderProxy::CreatePageCoordinationUnit(
    ::resource_coordinator::mojom::blink::PageCoordinationUnitRequest in_request, ::resource_coordinator::mojom::blink::CoordinationUnitIDPtr in_id) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void CoordinationUnitProviderProxy::CreateProcessCoordinationUnit(
    ::resource_coordinator::mojom::blink::ProcessCoordinationUnitRequest in_request, ::resource_coordinator::mojom::blink::CoordinationUnitIDPtr in_id) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void CoordinationUnitProviderProxy::GetSystemCoordinationUnit(
    ::resource_coordinator::mojom::blink::SystemCoordinationUnitRequest in_request) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool CoordinationUnitProviderStubDispatch::Accept(
  ...
  TRACE_EVENT1("mojom", "(Impl)resource_coordinator::mojom::CoordinationUnitProvider::CreateFrameCoordinationUnit",
      ...
      bool success = true;
      ::resource_coordinator::mojom::blink::FrameCoordinationUnitRequest p_request{};
      ::resource_coordinator::mojom::blink::CoordinationUnitIDPtr p_id{};
...
std::move(p_id));
  ...
  TRACE_EVENT1("mojom", "(Impl)resource_coordinator::mojom::CoordinationUnitProvider::CreatePageCoordinationUnit",
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::resource_coordinator::mojom::blink::PageCoordinationUnitRequest p_request{};
      ::resource_coordinator::mojom::blink::CoordinationUnitIDPtr p_id{};
...
std::move(p_id));
  ...
  TRACE_EVENT1("mojom", "(Impl)resource_coordinator::mojom::CoordinationUnitProvider::CreateProcessCoordinationUnit",
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::resource_coordinator::mojom::blink::ProcessCoordinationUnitRequest p_request{};
      ::resource_coordinator::mojom::blink::CoordinationUnitIDPtr p_id{};
...
std::move(p_id));
  ...
  TRACE_EVENT1("mojom", "(Impl)resource_coordinator::mojom::CoordinationUnitProvider::GetSystemCoordinationUnit",
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::resource_coordinator::mojom::blink::SystemCoordinationUnitRequest p_request{};
...
void CoordinationUnitProviderInterceptorForTesting::CreateFrameCoordinationUnit(::resource_coordinator::mojom::blink::FrameCoordinationUnitRequest request, ::resource_coordinator::mojom::blink::CoordinationUnitIDPtr id) {
  GetForwardingInterface()->CreateFrameCoordinationUnit(std::move(request), std::move(id));
}
void CoordinationUnitProviderInterceptorForTesting::CreatePageCoordinationUnit(::resource_coordinator::mojom::blink::PageCoordinationUnitRequest request, ::resource_coordinator::mojom::blink::CoordinationUnitIDPtr id) {
  GetForwardingInterface()->CreatePageCoordinationUnit(std::move(request), std::move(id));
}
void CoordinationUnitProviderInterceptorForTesting::CreateProcessCoordinationUnit(::resource_coordinator::mojom::blink::ProcessCoordinationUnitRequest request, ::resource_coordinator::mojom::blink::CoordinationUnitIDPtr id) {
  GetForwardingInterface()->CreateProcessCoordinationUnit(std::move(request), std::move(id));
}
void CoordinationUnitProviderInterceptorForTesting::GetSystemCoordinationUnit(::resource_coordinator::mojom::blink::SystemCoordinationUnitRequest request) {
