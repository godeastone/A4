...
CoordinationUnitID::CoordinationUnitID(
    ::resource_coordinator::CoordinationUnitType type_in,
    int64_t id_in)
...
ProcessResourceMeasurementBatch::ProcessResourceMeasurementBatch(
    base::TimeTicks batch_started_time_in,
    base::TimeTicks batch_ended_time_in,
    std::vector<ProcessResourceMeasurementPtr> measurements_in)
...
void FrameCoordinationUnitProxy::AddChildFrame(
    const ::resource_coordinator::CoordinationUnitID& in_cu_id) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class FrameCoordinationUnit_GetID_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      const ::resource_coordinator::CoordinationUnitID& in_id);
...
std::move(p_request));
  ...
  TRACE_EVENT1("mojom", "(Impl)resource_coordinator::mojom::FrameCoordinationUnit::AddChildFrame",
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::resource_coordinator::CoordinationUnitID p_cu_id{};
...
void FrameCoordinationUnitInterceptorForTesting::AddChildFrame(const ::resource_coordinator::CoordinationUnitID& cu_id) {
  GetForwardingInterface()->AddChildFrame(std::move(cu_id));
}
void FrameCoordinationUnitInterceptorForTesting::RemoveChildFrame(const ::resource_coordinator::CoordinationUnitID& cu_id) {
...
void FrameCoordinationUnitInterceptorForTesting::SetLifecycleState(::resource_coordinator::mojom::LifecycleState state) {
  ...
  proxy_->GetID(
      base::BindOnce(
          [](base::RunLoop* loop,
             ::resource_coordinator::CoordinationUnitID* out_id
,
             const ::resource_coordinator::CoordinationUnitID& id) {*out_id = std::move(id);
            loop->Quit();
          },
          &loop,
          out_id));
...
void PageCoordinationUnitInterceptorForTesting::AddFrame(const ::resource_coordinator::CoordinationUnitID& cu_id) {
  GetForwardingInterface()->AddFrame(std::move(cu_id));
}
void PageCoordinationUnitInterceptorForTesting::RemoveFrame(const ::resource_coordinator::CoordinationUnitID& cu_id) {
...
void ProcessCoordinationUnitInterceptorForTesting::AddFrame(const ::resource_coordinator::CoordinationUnitID& cu_id) {
  GetForwardingInterface()->AddFrame(std::move(cu_id));
}
void ProcessCoordinationUnitInterceptorForTesting::RemoveFrame(const ::resource_coordinator::CoordinationUnitID& cu_id) {
  GetForwardingInterface()->RemoveFrame(std::move(cu_id));
}
...
void ProcessCoordinationUnitInterceptorForTesting::SetLaunchTime(base::Time launch_time) {
...
// static
bool StructTraits<::resource_coordinator::mojom::CoordinationUnitID::DataView, ::resource_coordinator::mojom::CoordinationUnitIDPtr>::Read(
    ::resource_coordinator::mojom::CoordinationUnitID::DataView input,
    ::resource_coordinator::mojom::CoordinationUnitIDPtr* output) {
  bool success = true;
  ::resource_coordinator::mojom::CoordinationUnitIDPtr result(::resource_coordinator::mojom::CoordinationUnitID::New());
...
// static
bool StructTraits<::resource_coordinator::mojom::ProcessResourceMeasurement::DataView, ::resource_coordinator::mojom::ProcessResourceMeasurementPtr>::Read(
    ::resource_coordinator::mojom::ProcessResourceMeasurement::DataView input,
    ::resource_coordinator::mojom::ProcessResourceMeasurementPtr* output) {
  bool success = true;
  ::resource_coordinator::mojom::ProcessResourceMeasurementPtr result(::resource_coordinator::mojom::ProcessResourceMeasurement::New());
...
// static
bool StructTraits<::resource_coordinator::mojom::ProcessResourceMeasurementBatch::DataView, ::resource_coordinator::mojom::ProcessResourceMeasurementBatchPtr>::Read(
    ::resource_coordinator::mojom::ProcessResourceMeasurementBatch::DataView input,
    ::resource_coordinator::mojom::ProcessResourceMeasurementBatchPtr* output) {
  bool success = true;
  ::resource_coordinator::mojom::ProcessResourceMeasurementBatchPtr result(::resource_coordinator::mojom::ProcessResourceMeasurementBatch::New());
