...
void TextDetectionProxy::Detect(
  ...
  TRACE_EVENT0("mojom", "shape_detection::mojom::TextDetection::Detect");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)shape_detection::mojom::TextDetection::DetectCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)shape_detection::mojom::TextDetection::Detect",
               "message", message->name());
#endif
      break;
    }
