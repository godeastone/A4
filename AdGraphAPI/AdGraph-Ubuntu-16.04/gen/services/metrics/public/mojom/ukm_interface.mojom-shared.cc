...
bool UkmEntry_Data::Validate(
  ...
  const UkmEntry_Data* object = static_cast<const UkmEntry_Data*>(data);
...
bool UkmRecorderInterface_AddEntry_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const UkmRecorderInterface_AddEntry_Params_Data* object = static_cast<const UkmRecorderInterface_AddEntry_Params_Data*>(data);
...
bool UkmRecorderInterface_UpdateSourceURL_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const UkmRecorderInterface_UpdateSourceURL_Params_Data* object = static_cast<const UkmRecorderInterface_UpdateSourceURL_Params_Data*>(data);
