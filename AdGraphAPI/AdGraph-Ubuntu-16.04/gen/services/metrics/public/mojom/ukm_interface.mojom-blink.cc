...
void UkmRecorderInterfaceProxy::AddEntry(
  ...
  TRACE_EVENT0("mojom", "ukm::mojom::UkmRecorderInterface::AddEntry");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "ukm::mojom::UkmRecorderInterface::UpdateSourceURL");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)ukm::mojom::UkmRecorderInterface::AddEntry",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            ...
            "UkmRecorderInterface::AddEntry deserializer");
        return false;
      }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)ukm::mojom::UkmRecorderInterface::UpdateSourceURL",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "UkmRecorderInterface::UpdateSourceURL deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
