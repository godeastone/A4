...
(function() {
  ...
  UkmEntry.generate = function(generator_) {
    var generated = new UkmEntry;
    generated.sourceId = generator_.generateInt64();
    generated.eventHash = generator_.generateUint64();
    generated.metrics = generator_.generateMap(
      function() {
  ...
  UkmEntry.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.sourceId = mutator_.mutateInt64(this.sourceId);
    }
    if (mutator_.chooseMutateField()) {
      this.eventHash = mutator_.mutateUint64(this.eventHash);
    }
    if (mutator_.chooseMutateField()) {
      this.metrics = mutator_.mutateMap(this.metrics,
        function(val) {
  ...
  UkmEntry.prototype.getHandleDeps = function() {
    var handles = [];
    return handles;
  };

  UkmEntry.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  UkmEntry.prototype.setHandlesInternal_ = function(handles, idx) {
    return idx;
  };
  ...
  UkmRecorderInterface_AddEntry_Params.generate = function(generator_) {
    var generated = new UkmRecorderInterface_AddEntry_Params;
    generated.entry = generator_.generateStruct(ukm.mojom.UkmEntry, false);
    return generated;
  };

  UkmRecorderInterface_AddEntry_Params.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.entry = mutator_.mutateStruct(ukm.mojom.UkmEntry, false);
    }
    return this;
  };
  UkmRecorderInterface_AddEntry_Params.prototype.getHandleDeps = function() {
    var handles = [];
    return handles;
  };

  UkmRecorderInterface_AddEntry_Params.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  UkmRecorderInterface_AddEntry_Params.prototype.setHandlesInternal_ = function(handles, idx) {
    return idx;
  };
  ...
  UkmRecorderInterface_UpdateSourceURL_Params.generate = function(generator_) {
    var generated = new UkmRecorderInterface_UpdateSourceURL_Params;
    generated.sourceId = generator_.generateInt64();
    generated.url = generator_.generateString(false);
    return generated;
  };

  UkmRecorderInterface_UpdateSourceURL_Params.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.sourceId = mutator_.mutateInt64(this.sourceId);
    }
    if (mutator_.chooseMutateField()) {
  ...
  UkmRecorderInterface_UpdateSourceURL_Params.prototype.getHandleDeps = function() {
    var handles = [];
    return handles;
  };

  UkmRecorderInterface_UpdateSourceURL_Params.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  UkmRecorderInterface_UpdateSourceURL_Params.prototype.setHandlesInternal_ = function(handles, idx) {
    return idx;
  };
  ...
  var kUkmRecorderInterface_AddEntry_Name = 1603797573;
  var kUkmRecorderInterface_UpdateSourceURL_Name = 1133429930;
  ...
  var UkmRecorderInterface = {
    ...
    mojomId: 'services/metrics/public/mojom/ukm_interface.mojom',
    fuzzMethods: {
      addEntry: {
        params: UkmRecorderInterface_AddEntry_Params,
      },
      updateSourceURL: {
        params: UkmRecorderInterface_UpdateSourceURL_Params,
      },
    },
  };
