...
// static
bool Device_OnReceiverReportingUtilization_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const Device_OnReceiverReportingUtilization_Params_Data* object = static_cast<const Device_OnReceiverReportingUtilization_Params_Data*>(data);
...
Device_OnReceiverReportingUtilization_Params_Data::Device_OnReceiverReportingUtilization_Params_Data()
    : header_({sizeof(*this), 0}) {}
...
bool Device_RequestRefreshFrame_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const Device_RequestRefreshFrame_Params_Data* object = static_cast<const Device_RequestRefreshFrame_Params_Data*>(data);
