...
bool AccountInfo_Data::Validate(
  ...
  const AccountInfo_Data* object = static_cast<const AccountInfo_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->gaia, 2, validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams gaia_validate_params(
      0, false, nullptr);
  if (!mojo::internal::ValidateContainer(object->gaia, validation_context,
                                         &gaia_validate_params)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->full_name, 4, validation_context)) {
    return false;
  }
  ...
  const mojo::internal::ContainerValidateParams given_name_validate_params(
      0, false, nullptr);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->hosted_domain, 6, validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams hosted_domain_validate_params(
      0, false, nullptr);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->locale, 7, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->picture_url, 8, validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams picture_url_validate_params(
      0, false, nullptr);
  if (!mojo::internal::ValidateContainer(object->picture_url, validation_context,
                                         &picture_url_validate_params)) {
    return false;
  }
