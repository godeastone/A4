...
bool XmlParser_Parse_Params_Data::Validate(
  ...
  const XmlParser_Parse_Params_Data* object = static_cast<const XmlParser_Parse_Params_Data*>(data);
  ...
  const mojo::internal::ContainerValidateParams xml_validate_params(
      0, false, nullptr);
...
bool XmlParser_Parse_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const XmlParser_Parse_ResponseParams_Data* object = static_cast<const XmlParser_Parse_ResponseParams_Data*>(data);
