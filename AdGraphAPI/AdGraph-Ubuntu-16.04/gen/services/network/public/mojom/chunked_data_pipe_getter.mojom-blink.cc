...
bool ChunkedDataPipeGetter_GetSize_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        ...
        "ChunkedDataPipeGetter::GetSize response deserializer");
    return false;
  }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)network::mojom::ChunkedDataPipeGetter::GetSize",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)network::mojom::ChunkedDataPipeGetter::StartReading",
               "message", message->name());
#endif
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "ChunkedDataPipeGetter::StartReading deserializer");
        return false;
      }
  ...
  TRACE_EVENT1("mojom", "(Impl)network::mojom::ChunkedDataPipeGetter::GetSize",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "ChunkedDataPipeGetter::GetSize deserializer");
        return false;
      }
      ChunkedDataPipeGetter::GetSizeCallback callback =
