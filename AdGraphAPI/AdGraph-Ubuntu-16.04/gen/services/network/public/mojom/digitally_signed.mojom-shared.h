...
inline std::ostream& operator<<(std::ostream& os, HashAlgorithm value) {
  switch(value) {
...
inline std::ostream& operator<<(std::ostream& os, SignatureAlgorithm value) {
  switch(value) {
...
struct Serializer<::network::mojom::DigitallySignedDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    mojo::internal::Serialize<::network::mojom::HashAlgorithm>(
        CallWithContext(Traits::hash_algorithm, input, custom_context), &(*output)->hash_algorithm);
    mojo::internal::Serialize<::network::mojom::SignatureAlgorithm>(
        CallWithContext(Traits::signature_algorithm, input, custom_context), &(*output)->signature_algorithm);
