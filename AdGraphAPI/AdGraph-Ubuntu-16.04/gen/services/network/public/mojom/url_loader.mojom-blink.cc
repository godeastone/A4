...
class URLLoaderProxy_FollowRedirect_Message
 ...
 public:
  ...
  explicit URLLoaderProxy_FollowRedirect_Message(
      ...
      , ::network::mojom::blink::HttpRequestHeadersPtr param_modified_request_headers
  )
 ...
 private:
  ...
  ::network::mojom::blink::HttpRequestHeadersPtr param_modified_request_headers_;
...
void URLLoaderProxy::FollowRedirect(
    ::network::mojom::blink::HttpRequestHeadersPtr in_modified_request_headers) {
...
class URLLoaderProxy_SetPriority_Message
 ...
 public:
  ...
  explicit URLLoaderProxy_SetPriority_Message(
      uint32_t message_flags
      , RequestPriority param_priority
  ...
  static mojo::Message Build(
      ...
      bool expects_response,
      bool is_sync,
      RequestPriority param_priority, int32_t param_intra_priority_value) {
 ...
 private:
  ...
  RequestPriority param_priority_;
...
bool URLLoaderStubDispatch::Accept(
  ...
  TRACE_EVENT1("mojom", "(Impl)network::mojom::URLLoader::FollowRedirect",
      ...
      bool success = true;
      ::network::mojom::blink::HttpRequestHeadersPtr p_modified_request_headers{};
...
void URLLoaderInterceptorForTesting::FollowRedirect(::network::mojom::blink::HttpRequestHeadersPtr modified_request_headers) {
...
class URLLoaderClientProxy_OnReceiveResponse_Message
 ...
 public:
  ...
  static mojo::Message Build(
      ...
      bool expects_response,
      bool is_sync,
      URLResponseHeadPtr param_head, DownloadedTempFilePtr param_downloaded_file) {
 ...
 private:
  ...
  URLResponseHeadPtr param_head_;
...
void URLLoaderClientProxy::OnReceiveResponse(
    URLResponseHeadPtr in_head, DownloadedTempFilePtr in_downloaded_file) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class URLLoaderClientProxy_OnReceiveRedirect_Message
 ...
 public:
  ...
  explicit URLLoaderClientProxy_OnReceiveRedirect_Message(
      uint32_t message_flags
      , URLRequestRedirectInfoPtr param_redirect_info
      , URLResponseHeadPtr param_head
  )
      : mojo::internal::UnserializedMessageContext(
          &kMessageTag,
  ...
  static mojo::Message Build(
      ...
      bool expects_response,
      bool is_sync,
      URLRequestRedirectInfoPtr param_redirect_info, URLResponseHeadPtr param_head) {
 ...
 private:
  ...
  URLRequestRedirectInfoPtr param_redirect_info_;
  URLResponseHeadPtr param_head_;
...
class URLLoaderClientProxy_OnComplete_Message
 ...
 public:
  ...
  explicit URLLoaderClientProxy_OnComplete_Message(
      uint32_t message_flags
      , URLLoaderCompletionStatusPtr param_status
  )
      : mojo::internal::UnserializedMessageContext(
          &kMessageTag,
 ...
 private:
  ...
  URLLoaderCompletionStatusPtr param_status_;
...
void URLLoaderClientInterceptorForTesting::OnReceiveResponse(URLResponseHeadPtr head, DownloadedTempFilePtr downloaded_file) {
...
void URLLoaderClientInterceptorForTesting::OnReceiveCachedMetadata(const WTF::Vector<uint8_t>& data) {
