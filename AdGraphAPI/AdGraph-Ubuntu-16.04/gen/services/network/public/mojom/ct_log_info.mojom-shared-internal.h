...
class  CTLogInfo_Data {
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      ...
      index_ = serialization_buffer_->Allocate(sizeof(CTLogInfo_Data));
      new (data()) CTLogInfo_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    CTLogInfo_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<CTLogInfo_Data>(index_);
    }
    CTLogInfo_Data* operator->() { return data(); }
  ...
  mojo::internal::Pointer<mojo::internal::String_Data> dns_api_endpoint;

 private:
  CTLogInfo_Data();
  ~CTLogInfo_Data() = delete;
};
static_assert(sizeof(CTLogInfo_Data) == 32,
...
struct CTLogInfo_UnserializedMessageContext
 ...
 private:
  ...
  void Serialize(mojo::internal::SerializationContext* context,
    ...
    CTLogInfo_Data::BufferWriter writer;
