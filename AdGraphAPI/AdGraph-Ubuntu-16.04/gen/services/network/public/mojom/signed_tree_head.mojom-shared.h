...
inline std::ostream& operator<<(std::ostream& os, SignedTreeHeadVersion value) {
  switch(value) {
...
struct Serializer<::network::mojom::SignedTreeHeadDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    mojo::internal::Serialize<::network::mojom::SignedTreeHeadVersion>(
        CallWithContext(Traits::version, input, custom_context), &(*output)->version);
    ...
    (*output)->tree_size = CallWithContext(Traits::tree_size, input, custom_context);
    decltype(CallWithContext(Traits::sha256_root_hash, input, custom_context)) in_sha256_root_hash = CallWithContext(Traits::sha256_root_hash, input, custom_context);
    ...
    decltype(CallWithContext(Traits::log_id, input, custom_context)) in_log_id = CallWithContext(Traits::log_id, input, custom_context);
