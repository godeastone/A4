...
class NetworkServiceTestProxy_AddRules_Message
 ...
 private:
  ...
  WTF::Vector<RulePtr> param_rules_;
...
class NetworkServiceTestProxy_SimulateNetworkChange_Message
 ...
 public:
  ...
  explicit NetworkServiceTestProxy_SimulateNetworkChange_Message(
      uint32_t message_flags
      , ::network::mojom::blink::ConnectionType param_type
  )
      : mojo::internal::UnserializedMessageContext(
          &kMessageTag,
 ...
 private:
  ...
  ::network::mojom::blink::ConnectionType param_type_;
...
class NetworkServiceTestProxy_MockCertVerifierAddResultForCertAndHost_Message
 ...
 public:
  ...
  explicit NetworkServiceTestProxy_MockCertVerifierAddResultForCertAndHost_Message(
      uint32_t message_flags
      , ::network::mojom::blink::X509CertificatePtr param_cert
      , const WTF::String& param_host_pattern
      , ::network::mojom::blink::CertVerifyResultPtr param_verify_result
      , int32_t param_rv
  )
      : mojo::internal::UnserializedMessageContext(
          &kMessageTag,
 ...
 private:
  ...
  ::network::mojom::blink::X509CertificatePtr param_cert_;
  WTF::String param_host_pattern_;
  ::network::mojom::blink::CertVerifyResultPtr param_verify_result_;
  int32_t param_rv_;
