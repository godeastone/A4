...
void WebSocketProxy::AddChannelRequest(
    const GURL& in_url, const std::vector<std::string>& in_requested_protocols, const GURL& in_first_party_for_cookies, const std::string& in_user_agent_override, WebSocketClientPtr in_client) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void WebSocketInterceptorForTesting::AddChannelRequest(const GURL& url, const std::vector<std::string>& requested_protocols, const GURL& first_party_for_cookies, const std::string& user_agent_override, WebSocketClientPtr client) {
