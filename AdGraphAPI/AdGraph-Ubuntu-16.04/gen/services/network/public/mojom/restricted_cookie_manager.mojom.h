...
class  RestrictedCookieManager
 ...
 public:
  ...
  virtual void AddChangeListener(const GURL& url, const GURL& site_for_cookies, ::network::mojom::CookieChangeListenerPtr listener) = 0;
};
class  RestrictedCookieManagerInterceptorForTesting : public RestrictedCookieManager {
  ...
  void AddChangeListener(const GURL& url, const GURL& site_for_cookies, ::network::mojom::CookieChangeListenerPtr listener) override;
};
...
class  RestrictedCookieManagerProxy
 ...
 public:
  ...
  void AddChangeListener(const GURL& url, const GURL& site_for_cookies, ::network::mojom::CookieChangeListenerPtr listener) final;
