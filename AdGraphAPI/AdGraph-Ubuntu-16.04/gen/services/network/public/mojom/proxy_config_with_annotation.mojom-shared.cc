...
bool ProxyConfigWithAnnotation_Data::Validate(
  ...
  const ProxyConfigWithAnnotation_Data* object = static_cast<const ProxyConfigWithAnnotation_Data*>(data);
...
bool ProxyConfigClient_OnProxyConfigUpdated_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ProxyConfigClient_OnProxyConfigUpdated_Params_Data* object = static_cast<const ProxyConfigClient_OnProxyConfigUpdated_Params_Data*>(data);
...
bool ProxyConfigPollerClient_OnLazyProxyConfigPoll_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ProxyConfigPollerClient_OnLazyProxyConfigPoll_Params_Data* object = static_cast<const ProxyConfigPollerClient_OnLazyProxyConfigPoll_Params_Data*>(data);
