...
class SSLPrivateKeyProxy_Sign_Message
 ...
 public:
  ...
  explicit SSLPrivateKeyProxy_Sign_Message(
      ...
      , const WTF::Vector<uint8_t>& param_input
  )
  ...
  static mojo::Message Build(
      ...
      bool is_sync,
      uint16_t param_algorithm, const WTF::Vector<uint8_t>& param_input) {
 ...
 private:
  ...
  WTF::Vector<uint8_t> param_input_;
...
class SSLPrivateKey_Sign_Response_Message
 ...
 public:
  ...
  explicit SSLPrivateKey_Sign_Response_Message(
      ...
      , const WTF::Vector<uint8_t>& param_signature
  )
      : mojo::internal::UnserializedMessageContext(
          &kMessageTag,
          internal::kSSLPrivateKey_Sign_Name,
  ...
  static mojo::Message Build(
      bool serialize,
      bool is_sync,
      int32_t param_net_error, const WTF::Vector<uint8_t>& param_signature) {
 ...
 private:
  ...
  WTF::Vector<uint8_t> param_signature_;
...
class AuthChallengeResponderProxy_OnAuthCredentials_Message
 ...
 public:
  ...
  explicit AuthChallengeResponderProxy_OnAuthCredentials_Message(
      uint32_t message_flags
      , ::network::mojom::blink::AuthCredentialsPtr param_credentials
  )
      : mojo::internal::UnserializedMessageContext(
          &kMessageTag,
 ...
 private:
  ...
  ::network::mojom::blink::AuthCredentialsPtr param_credentials_;
...
void NetworkServiceClientProxy::OnAuthRequired(
    uint32_t in_process_id, uint32_t in_routing_id, uint32_t in_request_id, const ::blink::KURL& in_url, const ::blink::KURL& in_site_for_cookies, bool in_first_auth_attempt, ::network::mojom::blink::AuthChallengeInfoPtr in_auth_info, int32_t in_resource_type, AuthChallengeResponderPtr in_auth_challenge_responder) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  ...
  params->resource_type = in_resource_type;
...
class NetworkServiceClientProxy_OnCertificateRequested_Message
 ...
 public:
  ...
  explicit NetworkServiceClientProxy_OnCertificateRequested_Message(
      ...
      , ::network::mojom::blink::SSLCertRequestInfoPtr param_cert_info
  )
      : mojo::internal::UnserializedMessageContext(
          &kMessageTag,
  ...
  static mojo::Message Build(
      ...
      bool expects_response,
      bool is_sync,
      uint32_t param_process_id, uint32_t param_routing_id, uint32_t param_request_id, ::network::mojom::blink::SSLCertRequestInfoPtr param_cert_info) {
 ...
 private:
  ...
  ::network::mojom::blink::SSLCertRequestInfoPtr param_cert_info_;
...
void NetworkServiceClientProxy::OnCertificateRequested(
    uint32_t in_process_id, uint32_t in_routing_id, uint32_t in_request_id, ::network::mojom::blink::SSLCertRequestInfoPtr in_cert_info, OnCertificateRequestedCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkServiceClientProxy::OnSSLCertificateError(
    uint32_t in_process_id, uint32_t in_routing_id, uint32_t in_request_id, int32_t in_resource_type, const ::blink::KURL& in_url, ::network::mojom::blink::SSLInfoPtr in_ssl_info, bool in_fatal, OnSSLCertificateErrorCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class NetworkServiceClient_OnCertificateRequested_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::network::mojom::blink::X509CertificatePtr in_x509_certificate, const WTF::Vector<uint16_t>& in_algorithm_preferences, SSLPrivateKeyPtr in_ssl_private_key, bool in_cancel_certificate_selection);
...
class NetworkServiceClient_OnCertificateRequested_Response_Message
 ...
 public:
  ...
  explicit NetworkServiceClient_OnCertificateRequested_Response_Message(
      uint32_t message_flags
      , ::network::mojom::blink::X509CertificatePtr param_x509_certificate
      , const WTF::Vector<uint16_t>& param_algorithm_preferences
  ...
  static mojo::Message Build(
      bool serialize,
      bool is_sync,
      ::network::mojom::blink::X509CertificatePtr param_x509_certificate, const WTF::Vector<uint16_t>& param_algorithm_preferences, SSLPrivateKeyPtr param_ssl_private_key, bool param_cancel_certificate_selection) {
 ...
 private:
  ...
  ::network::mojom::blink::X509CertificatePtr param_x509_certificate_;
  WTF::Vector<uint16_t> param_algorithm_preferences_;
...
void NetworkServiceClientInterceptorForTesting::OnAuthRequired(uint32_t process_id, uint32_t routing_id, uint32_t request_id, const ::blink::KURL& url, const ::blink::KURL& site_for_cookies, bool first_auth_attempt, ::network::mojom::blink::AuthChallengeInfoPtr auth_info, int32_t resource_type, AuthChallengeResponderPtr auth_challenge_responder) {
...
void NetworkServiceClientInterceptorForTesting::OnCertificateRequested(uint32_t process_id, uint32_t routing_id, uint32_t request_id, ::network::mojom::blink::SSLCertRequestInfoPtr cert_info, OnCertificateRequestedCallback callback) {
...
void NetworkServiceClientInterceptorForTesting::OnSSLCertificateError(uint32_t process_id, uint32_t routing_id, uint32_t request_id, int32_t resource_type, const ::blink::KURL& url, ::network::mojom::blink::SSLInfoPtr ssl_info, bool fatal, OnSSLCertificateErrorCallback callback) {
...
class NetworkServiceProxy_GetNetworkChangeManager_Message
 ...
 public:
  ...
  explicit NetworkServiceProxy_GetNetworkChangeManager_Message(
      uint32_t message_flags
      , ::network::mojom::blink::NetworkChangeManagerRequest param_network_change_manager
  )
      : mojo::internal::UnserializedMessageContext(
          &kMessageTag,
 ...
 private:
  ...
  ::network::mojom::blink::NetworkChangeManagerRequest param_network_change_manager_;
...
class NetworkServiceProxy_UpdateSignedTreeHead_Message
 ...
 public:
  ...
  explicit NetworkServiceProxy_UpdateSignedTreeHead_Message(
      uint32_t message_flags
      , ::network::mojom::blink::SignedTreeHeadPtr param_signed_tree_head
  )
      : mojo::internal::UnserializedMessageContext(
          &kMessageTag,
 ...
 private:
  ...
  ::network::mojom::blink::SignedTreeHeadPtr param_signed_tree_head_;
...
class NetworkService_GetTotalNetworkUsages_Response_Message
 ...
 public:
  ...
  explicit NetworkService_GetTotalNetworkUsages_Response_Message(
      uint32_t message_flags
      , WTF::Vector<::network::mojom::blink::NetworkUsagePtr> param_total_network_usages
  )
      : mojo::internal::UnserializedMessageContext(
          &kMessageTag,
          internal::kNetworkService_GetTotalNetworkUsages_Name,
 ...
 private:
  ...
  WTF::Vector<::network::mojom::blink::NetworkUsagePtr> param_total_network_usages_;
