...
using RevocableWebSocketClientPtr = ::blink::RevocableInterfacePtr<WebSocketClient>;
...
using RevocableWebSocketPtr = ::blink::RevocableInterfacePtr<WebSocket>;
...
class BLINK_PLATFORM_EXPORT WebSocket
 ...
 public:
  ...
  virtual void AddChannelRequest(const ::blink::KURL& url, const WTF::Vector<WTF::String>& requested_protocols, const ::blink::KURL& first_party_for_cookies, const WTF::String& user_agent_override, WebSocketClientPtr client) = 0;
...
class BLINK_PLATFORM_EXPORT WebSocketInterceptorForTesting : public WebSocket {
  ...
  void AddChannelRequest(const ::blink::KURL& url, const WTF::Vector<WTF::String>& requested_protocols, const ::blink::KURL& first_party_for_cookies, const WTF::String& user_agent_override, WebSocketClientPtr client) override;
...
class BLINK_PLATFORM_EXPORT WebSocketProxy
 ...
 public:
  ...
  void AddChannelRequest(const ::blink::KURL& url, const WTF::Vector<WTF::String>& requested_protocols, const ::blink::KURL& first_party_for_cookies, const WTF::String& user_agent_override, WebSocketClientPtr client) final;
