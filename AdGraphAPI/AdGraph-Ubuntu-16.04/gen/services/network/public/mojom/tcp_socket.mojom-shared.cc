...
// static
bool TCPConnectedSocket_GetLocalAddress_Params_Data::Validate(
    const void* data,
  ...
  const TCPConnectedSocket_GetLocalAddress_Params_Data* object = static_cast<const TCPConnectedSocket_GetLocalAddress_Params_Data*>(data);
...
TCPConnectedSocket_GetLocalAddress_Params_Data::TCPConnectedSocket_GetLocalAddress_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool TCPConnectedSocket_GetLocalAddress_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const TCPConnectedSocket_GetLocalAddress_ResponseParams_Data* object = static_cast<const TCPConnectedSocket_GetLocalAddress_ResponseParams_Data*>(data);
...
TCPConnectedSocket_GetLocalAddress_ResponseParams_Data::TCPConnectedSocket_GetLocalAddress_ResponseParams_Data()
    : header_({sizeof(*this), 0}) {}
...
// static
bool TCPServerSocket_GetLocalAddress_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const TCPServerSocket_GetLocalAddress_Params_Data* object = static_cast<const TCPServerSocket_GetLocalAddress_Params_Data*>(data);
...
TCPServerSocket_GetLocalAddress_Params_Data::TCPServerSocket_GetLocalAddress_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool TCPServerSocket_GetLocalAddress_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const TCPServerSocket_GetLocalAddress_ResponseParams_Data* object = static_cast<const TCPServerSocket_GetLocalAddress_ResponseParams_Data*>(data);
...
TCPServerSocket_GetLocalAddress_ResponseParams_Data::TCPServerSocket_GetLocalAddress_ResponseParams_Data()
    : header_({sizeof(*this), 0}) {}
