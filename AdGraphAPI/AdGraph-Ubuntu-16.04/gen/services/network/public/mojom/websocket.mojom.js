...
(function() {
  ...
  WebSocketHandshakeRequest.prototype.mutate = function(mutator_) {
    ...
    if (mutator_.chooseMutateField()) {
      this.headers = mutator_.mutateArray(this.headers, function(val) {
        return mutator_.mutateStruct(network.mojom.HttpHeader, false);
      });
    }
    if (mutator_.chooseMutateField()) {
  ...
  WebSocketClient_OnStartOpeningHandshake_Params.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.request = mutator_.mutateStruct(network.mojom.WebSocketHandshakeRequest, false);
    }
    return this;
  };
  ...
  WebSocketClient_OnFinishOpeningHandshake_Params.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.response = mutator_.mutateStruct(network.mojom.WebSocketHandshakeResponse, false);
    }
    return this;
  };
  ...
  WebSocket_AddChannelRequest_Params.generate = function(generator_) {
    ...
    generated.userAgentOverride = generator_.generateString(false);
  ...
  WebSocket_AddChannelRequest_Params.prototype.mutate = function(mutator_) {
    ...
    if (mutator_.chooseMutateField()) {
      this.userAgentOverride = mutator_.mutateString(this.userAgentOverride, false);
    }
    if (mutator_.chooseMutateField()) {
  ...
  WebSocket_AddChannelRequest_Params.validate = function(messageValidator, offset) {
    ...
    // validate WebSocket_AddChannelRequest_Params.userAgentOverride
  ...
  var kWebSocketClient_OnFailChannel_Name = 573270214;
  var kWebSocketClient_OnStartOpeningHandshake_Name = 1009229181;
  var kWebSocketClient_OnFinishOpeningHandshake_Name = 575754037;
  var kWebSocketClient_OnAddChannelResponse_Name = 891818547;
  var kWebSocketClient_OnDataFrame_Name = 111695481;
  var kWebSocketClient_OnFlowControl_Name = 1987608225;
  var kWebSocketClient_OnDropChannel_Name = 1952864819;
  var kWebSocketClient_OnClosingHandshake_Name = 599567602;
  ...
  var kWebSocket_AddChannelRequest_Name = 828944462;
  var kWebSocket_SendFrame_Name = 654008999;
  var kWebSocket_SendFlowControl_Name = 1860865345;
  var kWebSocket_StartClosingHandshake_Name = 1177708263;
  ...
  WebSocketProxy.prototype.addChannelRequest = function(url, requestedProtocols, firstPartyForCookies, userAgentOverride, client) {
    ...
    params_.userAgentOverride = userAgentOverride;
  ...
  WebSocketStub.prototype.addChannelRequest = function(url, requestedProtocols, firstPartyForCookies, userAgentOverride, client) {
    return this.delegate_ && this.delegate_.addChannelRequest && this.delegate_.addChannelRequest(url, requestedProtocols, firstPartyForCookies, userAgentOverride, client);
  }
  ...
  WebSocketStub.prototype.accept = function(message) {
    ...
    case kWebSocket_AddChannelRequest_Name:
      ...
      this.addChannelRequest(params.url, params.requestedProtocols, params.firstPartyForCookies, params.userAgentOverride, params.client);
      return true;
