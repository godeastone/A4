...
using RevocableRestrictedCookieManagerPtr = ::blink::RevocableInterfacePtr<RestrictedCookieManager>;
...
class BLINK_PLATFORM_EXPORT RestrictedCookieManager
 ...
 public:
  ...
  using GetAllForUrlCallback = base::OnceCallback<void(WTF::Vector<::network::mojom::blink::CanonicalCookiePtr>)>;
  ...
  virtual void SetCanonicalCookie(::network::mojom::blink::CanonicalCookiePtr cookie, const ::blink::KURL& url, const ::blink::KURL& site_for_cookies, SetCanonicalCookieCallback callback) = 0;

  virtual void AddChangeListener(const ::blink::KURL& url, const ::blink::KURL& site_for_cookies, ::network::mojom::blink::CookieChangeListenerPtr listener) = 0;
};
class BLINK_PLATFORM_EXPORT RestrictedCookieManagerInterceptorForTesting : public RestrictedCookieManager {
  ...
  void SetCanonicalCookie(::network::mojom::blink::CanonicalCookiePtr cookie, const ::blink::KURL& url, const ::blink::KURL& site_for_cookies, SetCanonicalCookieCallback callback) override;
  void AddChangeListener(const ::blink::KURL& url, const ::blink::KURL& site_for_cookies, ::network::mojom::blink::CookieChangeListenerPtr listener) override;
};
class BLINK_PLATFORM_EXPORT RestrictedCookieManagerAsyncWaiter {
 public:
  ...
  void GetAllForUrl(
      const ::blink::KURL& url, const ::blink::KURL& site_for_cookies, CookieManagerGetOptionsPtr options, WTF::Vector<::network::mojom::blink::CanonicalCookiePtr>* out_cookies);
  void SetCanonicalCookie(
      ::network::mojom::blink::CanonicalCookiePtr cookie, const ::blink::KURL& url, const ::blink::KURL& site_for_cookies, bool* out_success);
...
class BLINK_PLATFORM_EXPORT RestrictedCookieManagerProxy
 ...
 public:
  ...
  void SetCanonicalCookie(::network::mojom::blink::CanonicalCookiePtr cookie, const ::blink::KURL& url, const ::blink::KURL& site_for_cookies, SetCanonicalCookieCallback callback) final;
  void AddChangeListener(const ::blink::KURL& url, const ::blink::KURL& site_for_cookies, ::network::mojom::blink::CookieChangeListenerPtr listener) final;
