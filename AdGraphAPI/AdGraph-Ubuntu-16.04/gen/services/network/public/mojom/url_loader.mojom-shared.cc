...
bool URLLoader_FollowRedirect_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidateStruct(object->modified_request_headers, validation_context))
    return false;
...
URLLoaderClient_OnDataDownloaded_Params_Data::URLLoaderClient_OnDataDownloaded_Params_Data()
    : header_({sizeof(*this), 0}) {}
