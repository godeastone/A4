...
class TCPConnectedSocketProxy_UpgradeToTLS_Message
 ...
 public:
  ...
  explicit TCPConnectedSocketProxy_UpgradeToTLS_Message(
      uint32_t message_flags
      , const net::HostPortPair& param_host_port_pair
      , const net::MutableNetworkTrafficAnnotationTag& param_traffic_annotation
      , ::network::mojom::TLSClientSocketRequest param_request
  ...
  static mojo::Message Build(
      ...
      bool expects_response,
      bool is_sync,
      const net::HostPortPair& param_host_port_pair, const net::MutableNetworkTrafficAnnotationTag& param_traffic_annotation, ::network::mojom::TLSClientSocketRequest param_request, SocketObserverPtr param_observer) {
 ...
 private:
  ...
  net::HostPortPair param_host_port_pair_;
  net::MutableNetworkTrafficAnnotationTag param_traffic_annotation_;
  ::network::mojom::TLSClientSocketRequest param_request_;
...
void TCPConnectedSocketProxy::UpgradeToTLS(
    const net::HostPortPair& in_host_port_pair, const net::MutableNetworkTrafficAnnotationTag& in_traffic_annotation, ::network::mojom::TLSClientSocketRequest in_request, SocketObserverPtr in_observer, UpgradeToTLSCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class TCPConnectedSocket_GetLocalAddress_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      int32_t in_net_error, const base::Optional<net::IPEndPoint>& in_local_addr);
...
class TCPConnectedSocket_GetLocalAddress_Response_Message
 ...
 public:
  ...
  static mojo::Message Build(
      bool serialize,
      bool is_sync,
      int32_t param_net_error, const base::Optional<net::IPEndPoint>& param_local_addr) {
...
void TCPConnectedSocketInterceptorForTesting::UpgradeToTLS(const net::HostPortPair& host_port_pair, const net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::network::mojom::TLSClientSocketRequest request, SocketObserverPtr observer, UpgradeToTLSCallback callback) {
...
,
             int32_t net_error,
             const base::Optional<net::IPEndPoint>& local_addr) {*out_net_error = std::move(net_error);*out_local_addr = std::move(local_addr);
            loop->Quit();
          },
          &loop,
          out_net_error,
...
class TCPServerSocket_Accept_Response_Message
 ...
 public:
  ...
  explicit TCPServerSocket_Accept_Response_Message(
      uint32_t message_flags
      , int32_t param_net_error
      , const base::Optional<net::IPEndPoint>& param_remote_addr
  ...
  static mojo::Message Build(
      bool serialize,
      bool is_sync,
      int32_t param_net_error, const base::Optional<net::IPEndPoint>& param_remote_addr, TCPConnectedSocketPtr param_connected_socket, mojo::ScopedDataPipeConsumerHandle param_send_stream, mojo::ScopedDataPipeProducerHandle param_receive_stream) {
 ...
 private:
  ...
  int32_t param_net_error_;
  base::Optional<net::IPEndPoint> param_remote_addr_;
  ...
  proxy_->Accept(std::move(observer),
      base::BindOnce(
          [](base::RunLoop* loop,
             int32_t* out_net_error
,
             base::Optional<net::IPEndPoint>* out_remote_addr
,
