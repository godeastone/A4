...
CookieOptions::CookieOptions()
    : exclude_httponly(true),
      cookie_same_site_filter(mojo::internal::ConvertEnumValue<CookieSameSiteFilter, net::CookieOptions::SameSiteCookieMode>(CookieSameSiteFilter::DO_NOT_INCLUDE)),
      update_access_time(true),
      server_time() {}

CookieOptions::CookieOptions(
    bool exclude_httponly_in,
    net::CookieOptions::SameSiteCookieMode cookie_same_site_filter_in,
...
CanonicalCookie::CanonicalCookie(
    ...
    base::Optional<base::Time> creation_in,
    base::Optional<base::Time> expiry_in,
    base::Optional<base::Time> last_access_in,
    bool secure_in,
    bool httponly_in,
...
class CookieChangeListenerProxy_OnCookieChange_Message
 ...
 public:
  ...
  static mojo::Message Build(
      ...
      bool is_sync,
      const net::CanonicalCookie& param_cookie, CookieChangeCause param_cause) {
...
class CookieManagerProxy_GetCookieList_Message
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  explicit CookieManagerProxy_GetCookieList_Message(
      uint32_t message_flags
      , const GURL& param_url
      , const net::CookieOptions& param_cookie_options
  )
      : mojo::internal::UnserializedMessageContext(
          &kMessageTag,
      ...
      , param_cookie_options_(std::move(param_cookie_options)){}
  ~CookieManagerProxy_GetCookieList_Message() override = default;

  static mojo::Message Build(
      bool serialize,
      bool expects_response,
      bool is_sync,
      const GURL& param_url, const net::CookieOptions& param_cookie_options) {
  ...
  const uint32_t kFlags =
    ...
    if (!serialize) {
      return mojo::Message(std::make_unique<CookieManagerProxy_GetCookieList_Message>(
          kFlags
          , std::move(param_url)
          , std::move(param_cookie_options)
          ));
    }
  ...
  mojo::internal::Serialize<::network::mojom::CookieOptionsDataView>(
      param_cookie_options, buffer, &cookie_options_writer, &serialization_context);
  ...
  void Dispatch(CookieManager* impl, CookieManager::GetCookieListCallback callback) {
    impl->GetCookieList(
        std::move(param_url_),
        std::move(param_cookie_options_), std::move(callback));
  }
 ...
 private:
  ...
  typename decltype(params->cookie_options)::BaseType::BufferWriter
      cookie_options_writer;
  mojo::internal::Serialize<::network::mojom::CookieOptionsDataView>(
      param_cookie_options_, buffer, &cookie_options_writer, serialization_context);
  params->cookie_options.Set(
      cookie_options_writer.is_null() ? nullptr : cookie_options_writer.data());
  MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
      params->cookie_options.is_null(),
  ...
  GURL param_url_;
  net::CookieOptions param_cookie_options_;

  DISALLOW_COPY_AND_ASSIGN(CookieManagerProxy_GetCookieList_Message);
};

const mojo::internal::UnserializedMessageContext::Tag
CookieManagerProxy_GetCookieList_Message::kMessageTag = {};
...
void CookieManagerProxy::GetCookieList(
  ...
  const bool kIsSync = false;
  const bool kSerialize = receiver_->PrefersSerializedMessages();
  auto message = CookieManagerProxy_GetCookieList_Message::Build(
      kSerialize, kExpectsResponse, kIsSync, std::move(in_url), std::move(in_cookie_options));
  std::unique_ptr<mojo::MessageReceiver> responder(
...
class CookieManagerProxy_SetCanonicalCookie_Message
 ...
 public:
  ...
  static mojo::Message Build(
      ...
      bool expects_response,
      bool is_sync,
      const net::CanonicalCookie& param_cookie, bool param_secure_source, bool param_modify_http_only) {
...
void CookieManagerProxy::SetCanonicalCookie(
    const net::CanonicalCookie& in_cookie, bool in_secure_source, bool in_modify_http_only, SetCanonicalCookieCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class CookieManagerProxy_DeleteCookies_Message
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  explicit CookieManagerProxy_DeleteCookies_Message(
      uint32_t message_flags
      , CookieDeletionFilterPtr param_filter
  )
      : mojo::internal::UnserializedMessageContext(
          &kMessageTag,
  ...
  ~CookieManagerProxy_DeleteCookies_Message() override = default;
  ...
  const uint32_t kFlags =
    ...
    if (!serialize) {
      return mojo::Message(std::make_unique<CookieManagerProxy_DeleteCookies_Message>(
          kFlags
  ...
  void Dispatch(CookieManager* impl, CookieManager::DeleteCookiesCallback callback) {
    impl->DeleteCookies(
 ...
 private:
  ...
  CookieDeletionFilterPtr param_filter_;

  DISALLOW_COPY_AND_ASSIGN(CookieManagerProxy_DeleteCookies_Message);
};

const mojo::internal::UnserializedMessageContext::Tag
CookieManagerProxy_DeleteCookies_Message::kMessageTag = {};
...
void CookieManagerProxy::DeleteCookies(
  ...
  const bool kIsSync = false;
  const bool kSerialize = receiver_->PrefersSerializedMessages();
  auto message = CookieManagerProxy_DeleteCookies_Message::Build(
...
class CookieManagerProxy_AddCookieChangeListener_Message
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  explicit CookieManagerProxy_AddCookieChangeListener_Message(
      uint32_t message_flags
      , const GURL& param_url
      , const std::string& param_name
      , CookieChangeListenerPtr param_listener
  )
      : mojo::internal::UnserializedMessageContext(
          &kMessageTag,
  ...
  ~CookieManagerProxy_AddCookieChangeListener_Message() override = default;

  static mojo::Message Build(
      bool serialize,
      bool expects_response,
      bool is_sync,
      const GURL& param_url, const std::string& param_name, CookieChangeListenerPtr param_listener) {
  ...
  const uint32_t kFlags =
    ...
    if (!serialize) {
      return mojo::Message(std::make_unique<CookieManagerProxy_AddCookieChangeListener_Message>(
          kFlags
          , std::move(param_url)
          , std::move(param_name)
  ...
  void Dispatch(CookieManager* impl) {
    impl->AddCookieChangeListener(
        ...
        CookieChangeListenerPtr(std::move(param_listener_)));
  }
 ...
 private:
  ...
  CookieChangeListenerPtrInfo param_listener_;

  DISALLOW_COPY_AND_ASSIGN(CookieManagerProxy_AddCookieChangeListener_Message);
};

const mojo::internal::UnserializedMessageContext::Tag
CookieManagerProxy_AddCookieChangeListener_Message::kMessageTag = {};
...
void CookieManagerProxy::AddCookieChangeListener(
  ...
  const bool kIsSync = false;
  const bool kSerialize = receiver_->PrefersSerializedMessages();
  auto message = CookieManagerProxy_AddCookieChangeListener_Message::Build(
      kSerialize, kExpectsResponse, kIsSync, std::move(in_url), std::move(in_name), std::move(in_listener));
  // This return value may be ignored as false implies the Connector has
  // encountered an error, which will be visible through other means.
  ignore_result(receiver_->Accept(&message));
}
...
class CookieManager_GetCookieList_Response_Message
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  explicit CookieManager_GetCookieList_Response_Message(
      uint32_t message_flags
      , const std::vector<net::CanonicalCookie>& param_cookies
  )
      : mojo::internal::UnserializedMessageContext(
          ...
          message_flags)
      , param_cookies_(std::move(param_cookies)){}
  ~CookieManager_GetCookieList_Response_Message() override = default;
  ...
  const uint32_t kFlags = mojo::Message::kFlagIsResponse |
    ...
    if (!serialize) {
      return mojo::Message(std::make_unique<CookieManager_GetCookieList_Response_Message>(
          kFlags
          , std::move(param_cookies)
          ));
    }
  ...
  MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
      params->cookies.is_null(),
      mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
      "null cookies in CookieManager.GetCookieList response");
  message.AttachHandlesFromSerializationContext(
      &serialization_context);
    return message;
  }
  ...
  void Dispatch(CookieManager::GetCookieListCallback* callback) {
    std::move(*callback).Run(
        std::move(param_cookies_));
  }
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(CookieManager_GetCookieList_Response_Message);
};

const mojo::internal::UnserializedMessageContext::Tag
CookieManager_GetCookieList_Response_Message::kMessageTag = {};
...
bool CookieManager_GetCookieList_ForwardToCallback::Accept(
  ...
  if (!message->is_serialized()) {
    auto context =
        message->TakeUnserializedContext<CookieManager_GetCookieList_Response_Message>();
    if (!context) {
      // The Message was not of the expected type. It may be a valid message
      // which was build using a different variant of these bindings. Force
      // serialization before dispatch in this case.
...
void CookieManager_GetCookieList_ProxyToResponder::Run(
    const std::vector<net::CanonicalCookie>& in_cookies) {
  const bool kSerialize = responder_->PrefersSerializedMessages();
  auto message = CookieManager_GetCookieList_Response_Message::Build(kSerialize, is_sync_, std::move(in_cookies));
...
class CookieManager_DeleteCookies_Response_Message
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  explicit CookieManager_DeleteCookies_Response_Message(
      uint32_t message_flags
      , uint32_t param_num_deleted
  )
      : mojo::internal::UnserializedMessageContext(
          &kMessageTag,
          internal::kCookieManager_DeleteCookies_Name,
          message_flags)
      , param_num_deleted_(std::move(param_num_deleted)){}
  ~CookieManager_DeleteCookies_Response_Message() override = default;
  ...
  const uint32_t kFlags = mojo::Message::kFlagIsResponse |
    ...
    if (!serialize) {
      return mojo::Message(std::make_unique<CookieManager_DeleteCookies_Response_Message>(
          kFlags
          , std::move(param_num_deleted)
          ));
    }
  ...
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  params->num_deleted = param_num_deleted;
  message.AttachHandlesFromSerializationContext(
      &serialization_context);
    return message;
  }
  ...
  void Dispatch(CookieManager::DeleteCookiesCallback* callback) {
    std::move(*callback).Run(
        std::move(param_num_deleted_));
  }
 ...
 private:
  ...
  void Serialize(mojo::internal::SerializationContext* serialization_context,
    ...
    ::network::mojom::internal::CookieManager_DeleteCookies_ResponseParams_Data::BufferWriter
        params;
    params.Allocate(buffer);
  params->num_deleted = param_num_deleted_;
  }
  uint32_t param_num_deleted_;

  DISALLOW_COPY_AND_ASSIGN(CookieManager_DeleteCookies_Response_Message);
};

const mojo::internal::UnserializedMessageContext::Tag
CookieManager_DeleteCookies_Response_Message::kMessageTag = {};
...
bool CookieManager_DeleteCookies_ForwardToCallback::Accept(
  ...
  if (!message->is_serialized()) {
    auto context =
        message->TakeUnserializedContext<CookieManager_DeleteCookies_Response_Message>();
    if (!context) {
      // The Message was not of the expected type. It may be a valid message
      // which was build using a different variant of these bindings. Force
      // serialization before dispatch in this case.
...
void CookieManager_DeleteCookies_ProxyToResponder::Run(
    uint32_t in_num_deleted) {
  const bool kSerialize = responder_->PrefersSerializedMessages();
  auto message = CookieManager_DeleteCookies_Response_Message::Build(kSerialize, is_sync_, std::move(in_num_deleted));
...
bool CookieManagerStubDispatch::Accept(
  ...
  TRACE_EVENT1("mojom", "(Impl)network::mojom::CookieManager::AddCookieChangeListener",
      ...
      if (!message->is_serialized()) {
        auto context = message->TakeUnserializedContext<
            CookieManagerProxy_AddCookieChangeListener_Message>();
        if (!context) {
          // The Message was not of the expected type. It may be a valid message
          // which was serialized using a different variant of these bindings.
          // Force serialization before dispatch in this case.
...
bool CookieManagerStubDispatch::AcceptWithResponder(
  ...
  TRACE_EVENT1("mojom", "(Impl)network::mojom::CookieManager::GetCookieList",
      ...
      if (!message->is_serialized()) {
        auto context = message->TakeUnserializedContext<
            CookieManagerProxy_GetCookieList_Message>();
        if (!context) {
          // The Message was not of the expected type. It may be a valid message
          // which was built using a different variant of these bindings. Force
          // serialization before dispatch in this case.
...
std::move(p_modify_http_only), std::move(callback));
  ...
  TRACE_EVENT1("mojom", "(Impl)network::mojom::CookieManager::DeleteCookies",
      ...
      if (!message->is_serialized()) {
        auto context = message->TakeUnserializedContext<
            CookieManagerProxy_DeleteCookies_Message>();
        if (!context) {
          // The Message was not of the expected type. It may be a valid message
          // which was built using a different variant of these bindings. Force
          // serialization before dispatch in this case.
...
void CookieManagerInterceptorForTesting::SetCanonicalCookie(const net::CanonicalCookie& cookie, bool secure_source, bool modify_http_only, SetCanonicalCookieCallback callback) {
