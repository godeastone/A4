...
// static
bool NetworkServiceClient_OnAuthRequired_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NetworkServiceClient_OnAuthRequired_Params_Data* object = static_cast<const NetworkServiceClient_OnAuthRequired_Params_Data*>(data);
...
NetworkServiceClient_OnAuthRequired_Params_Data::NetworkServiceClient_OnAuthRequired_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool NetworkServiceClient_OnCertificateRequested_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NetworkServiceClient_OnCertificateRequested_Params_Data* object = static_cast<const NetworkServiceClient_OnCertificateRequested_Params_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->cert_info, 4, validation_context)) {
    return false;
  }
...
NetworkServiceClient_OnCertificateRequested_Params_Data::NetworkServiceClient_OnCertificateRequested_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool NetworkServiceClient_OnCertificateRequested_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NetworkServiceClient_OnCertificateRequested_ResponseParams_Data* object = static_cast<const NetworkServiceClient_OnCertificateRequested_ResponseParams_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->algorithm_preferences, 2, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->ssl_private_key, 3, validation_context)) {
    return false;
  }
...
NetworkServiceClient_OnCertificateRequested_ResponseParams_Data::NetworkServiceClient_OnCertificateRequested_ResponseParams_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool NetworkServiceClient_OnSSLCertificateError_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NetworkServiceClient_OnSSLCertificateError_Params_Data* object = static_cast<const NetworkServiceClient_OnSSLCertificateError_Params_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->ssl_info, 6, validation_context)) {
    return false;
  }
...
NetworkServiceClient_OnSSLCertificateError_Params_Data::NetworkServiceClient_OnSSLCertificateError_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool NetworkServiceClient_OnSSLCertificateError_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NetworkServiceClient_OnSSLCertificateError_ResponseParams_Data* object = static_cast<const NetworkServiceClient_OnSSLCertificateError_ResponseParams_Data*>(data);
...
NetworkServiceClient_OnSSLCertificateError_ResponseParams_Data::NetworkServiceClient_OnSSLCertificateError_ResponseParams_Data()
    : header_({sizeof(*this), 0}) {}
...
// static
bool NetworkService_UpdateSignedTreeHead_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NetworkService_UpdateSignedTreeHead_Params_Data* object = static_cast<const NetworkService_UpdateSignedTreeHead_Params_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->signed_tree_head, 1, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->signed_tree_head, validation_context))
    return false;

  return true;
}

NetworkService_UpdateSignedTreeHead_Params_Data::NetworkService_UpdateSignedTreeHead_Params_Data()
    : header_({sizeof(*this), 0}) {}
