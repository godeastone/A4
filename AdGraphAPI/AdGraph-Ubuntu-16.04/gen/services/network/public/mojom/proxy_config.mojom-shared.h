...
inline std::ostream& operator<<(std::ostream& os, ProxyRulesType value) {
  switch(value) {
...
struct Serializer<::network::mojom::ProxyBypassRulesDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    decltype(CallWithContext(Traits::rules, input, custom_context)) in_rules = CallWithContext(Traits::rules, input, custom_context);
...
struct Serializer<::network::mojom::ProxyListDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    void* custom_context = CustomContextHelper<Traits>::SetUp(input, context);
    (*output).Allocate(buffer);
    decltype(CallWithContext(Traits::proxies, input, custom_context)) in_proxies = CallWithContext(Traits::proxies, input, custom_context);
...
struct Serializer<::network::mojom::ProxyRulesDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    void* custom_context = CustomContextHelper<Traits>::SetUp(input, context);
    (*output).Allocate(buffer);
    decltype(CallWithContext(Traits::bypass_rules, input, custom_context)) in_bypass_rules = CallWithContext(Traits::bypass_rules, input, custom_context);
    ...
    (*output)->reverse_bypass = CallWithContext(Traits::reverse_bypass, input, custom_context);
    mojo::internal::Serialize<::network::mojom::ProxyRulesType>(
        CallWithContext(Traits::type, input, custom_context), &(*output)->type);
    decltype(CallWithContext(Traits::single_proxies, input, custom_context)) in_single_proxies = CallWithContext(Traits::single_proxies, input, custom_context);
    ...
    decltype(CallWithContext(Traits::proxies_for_http, input, custom_context)) in_proxies_for_http = CallWithContext(Traits::proxies_for_http, input, custom_context);
    ...
    decltype(CallWithContext(Traits::proxies_for_https, input, custom_context)) in_proxies_for_https = CallWithContext(Traits::proxies_for_https, input, custom_context);
    ...
    decltype(CallWithContext(Traits::proxies_for_ftp, input, custom_context)) in_proxies_for_ftp = CallWithContext(Traits::proxies_for_ftp, input, custom_context);
    ...
    decltype(CallWithContext(Traits::fallback_proxies, input, custom_context)) in_fallback_proxies = CallWithContext(Traits::fallback_proxies, input, custom_context);
...
struct Serializer<::network::mojom::ProxyConfigDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    void* custom_context = CustomContextHelper<Traits>::SetUp(input, context);
    (*output).Allocate(buffer);
    (*output)->auto_detect = CallWithContext(Traits::auto_detect, input, custom_context);
    decltype(CallWithContext(Traits::pac_url, input, custom_context)) in_pac_url = CallWithContext(Traits::pac_url, input, custom_context);
    ...
    (*output)->pac_mandatory = CallWithContext(Traits::pac_mandatory, input, custom_context);
    decltype(CallWithContext(Traits::proxy_rules, input, custom_context)) in_proxy_rules = CallWithContext(Traits::proxy_rules, input, custom_context);
