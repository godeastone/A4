...
(function() {
  ...
  URLLoader_FollowRedirect_Params.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.modifiedRequestHeaders = mutator_.mutateStruct(network.mojom.HttpRequestHeaders, true);
    }
    return this;
  };
  ...
  URLLoader_FollowRedirect_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, http_request_headers$.HttpRequestHeaders, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  URLLoader_FollowRedirect_Params.encodedSize = codec.kStructHeaderSize + 8;
  ...
  URLLoaderClient_OnReceiveResponse_Params.prototype.initDefaults_ = function() {
    this.head = null;
    this.downloadedFile = new DownloadedTempFilePtr();
  };
  ...
  URLLoaderClient_OnReceiveResponse_Params.generate = function(generator_) {
    ...
    generated.downloadedFile = generator_.generateInterface("network.mojom.DownloadedTempFile", true);
    return generated;
  };
  ...
  URLLoaderClient_OnReceiveResponse_Params.prototype.mutate = function(mutator_) {
    ...
    if (mutator_.chooseMutateField()) {
      this.downloadedFile = mutator_.mutateInterface(this.downloadedFile, "network.mojom.DownloadedTempFile", true);
    }
    return this;
  };
  URLLoaderClient_OnReceiveResponse_Params.prototype.getHandleDeps = function() {
    ...
    if (this.downloadedFile !== null) {
      Array.prototype.push.apply(handles, ["network.mojom.DownloadedTempFilePtr"]);
    }
    return handles;
  };
  ...
  URLLoaderClient_OnReceiveResponse_Params.prototype.setHandlesInternal_ = function(handles, idx) {
    this.downloadedFile = handles[idx++];;
    return idx;
  };
  ...
  URLLoaderClient_OnReceiveResponse_Params.validate = function(messageValidator, offset) {
    ...
    // validate URLLoaderClient_OnReceiveResponse_Params.downloadedFile
  ...
  URLLoaderClient_OnReceiveResponse_Params.encodedSize = codec.kStructHeaderSize + 16;
  ...
  URLLoaderClient_OnReceiveResponse_Params.decode = function(decoder) {
    ...
    val.downloadedFile = decoder.decodeStruct(new codec.NullableInterface(DownloadedTempFilePtr));
    return val;
  };
  ...
  URLLoaderClient_OnReceiveResponse_Params.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(new codec.NullableInterface(DownloadedTempFilePtr), val.downloadedFile);
  };
  ...
  URLLoaderClient_OnReceiveRedirect_Params.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.redirectInfo = mutator_.mutateStruct(network.mojom.URLRequestRedirectInfo, false);
    }
    if (mutator_.chooseMutateField()) {
      this.head = mutator_.mutateStruct(network.mojom.URLResponseHead, false);
    }
  ...
  function URLLoaderClient_OnDataDownloaded_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  URLLoaderClient_OnDataDownloaded_Params.prototype.initDefaults_ = function() {
    this.dataLength = 0;
    this.encodedLength = 0;
  };
  URLLoaderClient_OnDataDownloaded_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  };
  URLLoaderClient_OnDataDownloaded_Params.generate = function(generator_) {
    var generated = new URLLoaderClient_OnDataDownloaded_Params;
    generated.dataLength = generator_.generateInt64();
    generated.encodedLength = generator_.generateInt64();
    return generated;
  };

  URLLoaderClient_OnDataDownloaded_Params.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.dataLength = mutator_.mutateInt64(this.dataLength);
    }
    if (mutator_.chooseMutateField()) {
      this.encodedLength = mutator_.mutateInt64(this.encodedLength);
    }
    return this;
  };
  URLLoaderClient_OnDataDownloaded_Params.prototype.getHandleDeps = function() {
    var handles = [];
    return handles;
  };

  URLLoaderClient_OnDataDownloaded_Params.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  URLLoaderClient_OnDataDownloaded_Params.prototype.setHandlesInternal_ = function(handles, idx) {
    return idx;
  };

  URLLoaderClient_OnDataDownloaded_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  URLLoaderClient_OnDataDownloaded_Params.encodedSize = codec.kStructHeaderSize + 16;

  URLLoaderClient_OnDataDownloaded_Params.decode = function(decoder) {
    var packed;
    var val = new URLLoaderClient_OnDataDownloaded_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.dataLength = decoder.decodeStruct(codec.Int64);
    val.encodedLength = decoder.decodeStruct(codec.Int64);
    return val;
  };

  URLLoaderClient_OnDataDownloaded_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(URLLoaderClient_OnDataDownloaded_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.Int64, val.dataLength);
    encoder.encodeStruct(codec.Int64, val.encodedLength);
  };
  ...
  URLLoaderClient_OnComplete_Params.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.status = mutator_.mutateStruct(network.mojom.URLLoaderCompletionStatus, false);
    }
    return this;
  };
  ...
  var kURLLoader_FollowRedirect_Name = 1379385407;
  var kURLLoader_ProceedWithResponse_Name = 939457447;
  var kURLLoader_SetPriority_Name = 1531148955;
  var kURLLoader_PauseReadingBodyFromNet_Name = 4194407;
  var kURLLoader_ResumeReadingBodyFromNet_Name = 249817084;
  ...
  URLLoaderProxy.prototype.followRedirect = function(modifiedRequestHeaders) {
  ...
  URLLoaderStub.prototype.followRedirect = function(modifiedRequestHeaders) {
    return this.delegate_ && this.delegate_.followRedirect && this.delegate_.followRedirect(modifiedRequestHeaders);
  }
  ...
  URLLoaderStub.prototype.accept = function(message) {
    ...
    case kURLLoader_FollowRedirect_Name:
      ...
      this.followRedirect(params.modifiedRequestHeaders);
      return true;
  ...
  function DownloadedTempFilePtr(handleOrPtrInfo) {
    this.ptr = new bindings.InterfacePtrController(DownloadedTempFile,
                                                   handleOrPtrInfo);
  }

  function DownloadedTempFileAssociatedPtr(associatedInterfacePtrInfo) {
    this.ptr = new associatedBindings.AssociatedInterfacePtrController(
        DownloadedTempFile, associatedInterfacePtrInfo);
  }

  DownloadedTempFileAssociatedPtr.prototype =
      Object.create(DownloadedTempFilePtr.prototype);
  DownloadedTempFileAssociatedPtr.prototype.constructor =
      DownloadedTempFileAssociatedPtr;

  function DownloadedTempFileProxy(receiver) {
    this.receiver_ = receiver;
  }

  function DownloadedTempFileStub(delegate) {
    this.delegate_ = delegate;
  }

  DownloadedTempFileStub.prototype.accept = function(message) {
    var reader = new codec.MessageReader(message);
    switch (reader.messageName) {
    default:
      return false;
  ...
  DownloadedTempFileStub.prototype.acceptWithResponder =
      function(message, responder) {
    var reader = new codec.MessageReader(message);
    switch (reader.messageName) {
    default:
  ...
  function validateDownloadedTempFileRequest(messageValidator) {
    return validator.validationError.NONE;
  }

  function validateDownloadedTempFileResponse(messageValidator) {
    return validator.validationError.NONE;
  }

  var DownloadedTempFile = {
    name: 'network.mojom.DownloadedTempFile',
    kVersion: 0,
    ptrClass: DownloadedTempFilePtr,
    proxyClass: DownloadedTempFileProxy,
    stubClass: DownloadedTempFileStub,
    validateRequest: validateDownloadedTempFileRequest,
    validateResponse: null,
    mojomId: 'services/network/public/mojom/url_loader.mojom',
    fuzzMethods: {
    },
  };
  DownloadedTempFileStub.prototype.validator = validateDownloadedTempFileRequest;
  DownloadedTempFileProxy.prototype.validator = null;
  var kURLLoaderClient_OnReceiveResponse_Name = 1868204169;
  var kURLLoaderClient_OnReceiveRedirect_Name = 1049644969;
  var kURLLoaderClient_OnDataDownloaded_Name = 961154844;
  var kURLLoaderClient_OnUploadProgress_Name = 975734339;
  var kURLLoaderClient_OnReceiveCachedMetadata_Name = 1968344360;
  var kURLLoaderClient_OnTransferSizeUpdated_Name = 1307994468;
  var kURLLoaderClient_OnStartLoadingResponseBody_Name = 1996793266;
  var kURLLoaderClient_OnComplete_Name = 1998033001;
  ...
  URLLoaderClientProxy.prototype.onReceiveResponse = function(head, downloadedFile) {
    var params_ = new URLLoaderClient_OnReceiveResponse_Params();
    params_.head = head;
    params_.downloadedFile = downloadedFile;
    var builder = new codec.MessageV0Builder(
  ...
  URLLoaderClientPtr.prototype.onDataDownloaded = function() {
    return URLLoaderClientProxy.prototype.onDataDownloaded
        .apply(this.ptr.getProxy(), arguments);
  };

  URLLoaderClientProxy.prototype.onDataDownloaded = function(dataLength, encodedLength) {
    var params_ = new URLLoaderClient_OnDataDownloaded_Params();
    params_.dataLength = dataLength;
    params_.encodedLength = encodedLength;
    var builder = new codec.MessageV0Builder(
        kURLLoaderClient_OnDataDownloaded_Name,
        codec.align(URLLoaderClient_OnDataDownloaded_Params.encodedSize));
    builder.encodeStruct(URLLoaderClient_OnDataDownloaded_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  URLLoaderClientStub.prototype.onReceiveResponse = function(head, downloadedFile) {
    return this.delegate_ && this.delegate_.onReceiveResponse && this.delegate_.onReceiveResponse(head, downloadedFile);
  }
  ...
  URLLoaderClientStub.prototype.onDataDownloaded = function(dataLength, encodedLength) {
    return this.delegate_ && this.delegate_.onDataDownloaded && this.delegate_.onDataDownloaded(dataLength, encodedLength);
  }
  ...
  URLLoaderClientStub.prototype.accept = function(message) {
    ...
    case kURLLoaderClient_OnReceiveResponse_Name:
      ...
      this.onReceiveResponse(params.head, params.downloadedFile);
      return true;
    case kURLLoaderClient_OnReceiveRedirect_Name:
      ...
      return true;
    case kURLLoaderClient_OnDataDownloaded_Name:
      var params = reader.decodeStruct(URLLoaderClient_OnDataDownloaded_Params);
      this.onDataDownloaded(params.dataLength, params.encodedLength);
      return true;
  ...
  function validateURLLoaderClientRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kURLLoaderClient_OnDataDownloaded_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = URLLoaderClient_OnDataDownloaded_Params;
      break;
      case kURLLoaderClient_OnUploadProgress_Name:
  ...
  var URLLoaderClient = {
    ...
    fuzzMethods: {
      ...
      onDataDownloaded: {
        params: URLLoaderClient_OnDataDownloaded_Params,
      },
      onUploadProgress: {
  ...
  exports.DownloadedTempFile = DownloadedTempFile;
  exports.DownloadedTempFilePtr = DownloadedTempFilePtr;
  exports.DownloadedTempFileAssociatedPtr = DownloadedTempFileAssociatedPtr;
