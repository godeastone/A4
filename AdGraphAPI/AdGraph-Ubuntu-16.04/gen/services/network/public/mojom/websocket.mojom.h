...
class  WebSocket
 ...
 public:
  ...
  virtual void AddChannelRequest(const GURL& url, const std::vector<std::string>& requested_protocols, const GURL& first_party_for_cookies, const std::string& user_agent_override, WebSocketClientPtr client) = 0;
...
class  WebSocketInterceptorForTesting : public WebSocket {
  ...
  void AddChannelRequest(const GURL& url, const std::vector<std::string>& requested_protocols, const GURL& first_party_for_cookies, const std::string& user_agent_override, WebSocketClientPtr client) override;
...
class  WebSocketProxy
 ...
 public:
  ...
  void AddChannelRequest(const GURL& url, const std::vector<std::string>& requested_protocols, const GURL& first_party_for_cookies, const std::string& user_agent_override, WebSocketClientPtr client) final;
