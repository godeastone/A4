...
class URLLoaderFactoryProxy_CreateLoaderAndStart_Message
 ...
 public:
  ...
  explicit URLLoaderFactoryProxy_CreateLoaderAndStart_Message(
      ...
      , ::network::mojom::URLLoaderRequest param_loader
      , int32_t param_routing_id
      , int32_t param_request_id
      , uint32_t param_options
      , const network::ResourceRequest& param_request
      , ::network::mojom::URLLoaderClientPtr param_client
  ...
  static mojo::Message Build(
      ...
      bool is_sync,
      ::network::mojom::URLLoaderRequest param_loader, int32_t param_routing_id, int32_t param_request_id, uint32_t param_options, const network::ResourceRequest& param_request, ::network::mojom::URLLoaderClientPtr param_client, const net::MutableNetworkTrafficAnnotationTag& param_traffic_annotation) {
  ...
  void Dispatch(URLLoaderFactory* impl) {
    impl->CreateLoaderAndStart(
        ...
        ::network::mojom::URLLoaderClientPtr(std::move(param_client_)),
 ...
 private:
  ...
  ::network::mojom::URLLoaderRequest param_loader_;
  int32_t param_routing_id_;
  int32_t param_request_id_;
  uint32_t param_options_;
  network::ResourceRequest param_request_;
  ::network::mojom::URLLoaderClientPtrInfo param_client_;
...
void URLLoaderFactoryProxy::CreateLoaderAndStart(
    ::network::mojom::URLLoaderRequest in_loader, int32_t in_routing_id, int32_t in_request_id, uint32_t in_options, const network::ResourceRequest& in_request, ::network::mojom::URLLoaderClientPtr in_client, const net::MutableNetworkTrafficAnnotationTag& in_traffic_annotation) {
...
bool URLLoaderFactoryStubDispatch::Accept(
  ...
  TRACE_EVENT1("mojom", "(Impl)network::mojom::URLLoaderFactory::CreateLoaderAndStart",
      ...
      bool success = true;
      ::network::mojom::URLLoaderRequest p_loader{};
      int32_t p_routing_id{};
      int32_t p_request_id{};
      uint32_t p_options{};
      network::ResourceRequest p_request{};
      ::network::mojom::URLLoaderClientPtr p_client{};
