...
bool Rule_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->host_pattern, 1, validation_context)) {
    return false;
  }
...
// static
bool NetworkServiceTest_SetShouldRequireCT_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NetworkServiceTest_SetShouldRequireCT_Params_Data* object = static_cast<const NetworkServiceTest_SetShouldRequireCT_Params_Data*>(data);
  ...
  if (!::network::mojom::internal::NetworkServiceTest_ShouldRequireCT_Data
...
NetworkServiceTest_SetShouldRequireCT_Params_Data::NetworkServiceTest_SetShouldRequireCT_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool NetworkServiceTest_SetShouldRequireCT_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NetworkServiceTest_SetShouldRequireCT_ResponseParams_Data* object = static_cast<const NetworkServiceTest_SetShouldRequireCT_ResponseParams_Data*>(data);
...
NetworkServiceTest_SetShouldRequireCT_ResponseParams_Data::NetworkServiceTest_SetShouldRequireCT_ResponseParams_Data()
    : header_({sizeof(*this), 0}) {}
