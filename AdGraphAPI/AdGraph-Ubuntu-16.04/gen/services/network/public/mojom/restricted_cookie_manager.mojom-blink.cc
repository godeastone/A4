...
void RestrictedCookieManagerProxy::SetCanonicalCookie(
    ::network::mojom::blink::CanonicalCookiePtr in_cookie, const ::blink::KURL& in_url, const ::blink::KURL& in_site_for_cookies, SetCanonicalCookieCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void RestrictedCookieManagerProxy::AddChangeListener(
    const ::blink::KURL& in_url, const ::blink::KURL& in_site_for_cookies, ::network::mojom::blink::CookieChangeListenerPtr in_listener) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class RestrictedCookieManager_GetAllForUrl_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      WTF::Vector<::network::mojom::blink::CanonicalCookiePtr> in_cookies);
...
bool RestrictedCookieManager_GetAllForUrl_ForwardToCallback::Accept(
  ...
  bool success = true;
  WTF::Vector<::network::mojom::blink::CanonicalCookiePtr> p_cookies{};
...
std::move(p_options), std::move(callback));
  ...
  TRACE_EVENT1("mojom", "(Impl)network::mojom::RestrictedCookieManager::SetCanonicalCookie",
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::network::mojom::blink::CanonicalCookiePtr p_cookie{};
      ::blink::KURL p_url{};
      ::blink::KURL p_site_for_cookies{};
...
void RestrictedCookieManagerInterceptorForTesting::SetCanonicalCookie(::network::mojom::blink::CanonicalCookiePtr cookie, const ::blink::KURL& url, const ::blink::KURL& site_for_cookies, SetCanonicalCookieCallback callback) {
  GetForwardingInterface()->SetCanonicalCookie(std::move(cookie), std::move(url), std::move(site_for_cookies), std::move(callback));
}
void RestrictedCookieManagerInterceptorForTesting::AddChangeListener(const ::blink::KURL& url, const ::blink::KURL& site_for_cookies, ::network::mojom::blink::CookieChangeListenerPtr listener) {
...
void RestrictedCookieManagerAsyncWaiter::GetAllForUrl(
  ...
  proxy_->GetAllForUrl(std::move(url),std::move(site_for_cookies),std::move(options),
      base::BindOnce(
          [](base::RunLoop* loop,
             WTF::Vector<::network::mojom::blink::CanonicalCookiePtr>* out_cookies
,
             WTF::Vector<::network::mojom::blink::CanonicalCookiePtr> cookies) {*out_cookies = std::move(cookies);
            loop->Quit();
          },
          &loop,
          out_cookies));
