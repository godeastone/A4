...
bool ChunkedDataPipeGetter_GetSize_Params_Data::Validate(
  ...
  const ChunkedDataPipeGetter_GetSize_Params_Data* object = static_cast<const ChunkedDataPipeGetter_GetSize_Params_Data*>(data);
...
bool ChunkedDataPipeGetter_GetSize_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ChunkedDataPipeGetter_GetSize_ResponseParams_Data* object = static_cast<const ChunkedDataPipeGetter_GetSize_ResponseParams_Data*>(data);
...
bool ChunkedDataPipeGetter_StartReading_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ChunkedDataPipeGetter_StartReading_Params_Data* object = static_cast<const ChunkedDataPipeGetter_StartReading_Params_Data*>(data);
