...
bool FrameSinkVideoConsumer_OnFrameCaptured_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->info, 3, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->update_rect, 4, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->content_rect, 5, validation_context)) {
    return false;
  }
...
// static
bool FrameSinkVideoConsumer_OnTargetLost_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const FrameSinkVideoConsumer_OnTargetLost_Params_Data* object = static_cast<const FrameSinkVideoConsumer_OnTargetLost_Params_Data*>(data);
...
FrameSinkVideoConsumer_OnTargetLost_Params_Data::FrameSinkVideoConsumer_OnTargetLost_Params_Data()
    : header_({sizeof(*this), 0}) {}
