...
bool CompositorFrameSink::SubmitCompositorFrameSync(const viz::LocalSurfaceId& local_surface_id, viz::CompositorFrame frame, ::viz::mojom::blink::HitTestRegionListPtr hit_test_region_list, uint64_t submit_time, WTF::Vector<viz::ReturnedResource>* out_resources) {
  NOTREACHED();
  return false;
}
...
void CompositorFrameSinkProxy::SetNeedsBeginFrame(
  ...
  TRACE_EVENT0("mojom", "viz::mojom::CompositorFrameSink::SetNeedsBeginFrame");
#endif
...
void CompositorFrameSinkProxy::SubmitCompositorFrame(
    const viz::LocalSurfaceId& in_local_surface_id, viz::CompositorFrame in_frame, ::viz::mojom::blink::HitTestRegionListPtr in_hit_test_region_list, uint64_t in_submit_time) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "viz::mojom::CompositorFrameSink::SubmitCompositorFrame");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
bool CompositorFrameSinkProxy::SubmitCompositorFrameSync(
    const viz::LocalSurfaceId& param_local_surface_id, viz::CompositorFrame param_frame, ::viz::mojom::blink::HitTestRegionListPtr param_hit_test_region_list, uint64_t param_submit_time, WTF::Vector<viz::ReturnedResource>* out_param_resources) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "viz::mojom::CompositorFrameSink::SubmitCompositorFrameSync");
#endif
...
void CompositorFrameSinkProxy::SubmitCompositorFrameSync(
    const viz::LocalSurfaceId& in_local_surface_id, viz::CompositorFrame in_frame, ::viz::mojom::blink::HitTestRegionListPtr in_hit_test_region_list, uint64_t in_submit_time, SubmitCompositorFrameSyncCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "viz::mojom::CompositorFrameSink::SubmitCompositorFrameSync");
#endif
  const bool kExpectsResponse = true;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "viz::mojom::CompositorFrameSink::DidNotProduceFrame");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
void CompositorFrameSinkProxy::DidAllocateSharedBitmap(
    mojo::ScopedSharedBufferHandle in_buffer, ::gpu::mojom::blink::MailboxPtr in_id) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "viz::mojom::CompositorFrameSink::DidAllocateSharedBitmap");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
void CompositorFrameSinkProxy::DidDeleteSharedBitmap(
    ::gpu::mojom::blink::MailboxPtr in_id) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "viz::mojom::CompositorFrameSink::DidDeleteSharedBitmap");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
bool CompositorFrameSink_SubmitCompositorFrameSync_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        ...
        "CompositorFrameSink::SubmitCompositorFrameSync response deserializer");
    return false;
  }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)viz::mojom::CompositorFrameSink::SubmitCompositorFrameSyncCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)viz::mojom::CompositorFrameSink::SetNeedsBeginFrame",
               "message", message->name());
#endif
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "CompositorFrameSink::SetNeedsBeginFrame deserializer");
        return false;
      }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)viz::mojom::CompositorFrameSink::SetWantsAnimateOnlyBeginFrames",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "CompositorFrameSink::SetWantsAnimateOnlyBeginFrames deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)viz::mojom::CompositorFrameSink::SubmitCompositorFrame",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      ::viz::mojom::blink::HitTestRegionListPtr p_hit_test_region_list{};
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "CompositorFrameSink::SubmitCompositorFrame deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)viz::mojom::CompositorFrameSink::SubmitCompositorFrameSync",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)viz::mojom::CompositorFrameSink::DidNotProduceFrame",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "CompositorFrameSink::DidNotProduceFrame deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)viz::mojom::CompositorFrameSink::DidAllocateSharedBitmap",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      ::gpu::mojom::blink::MailboxPtr p_id{};
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "CompositorFrameSink::DidAllocateSharedBitmap deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)viz::mojom::CompositorFrameSink::DidDeleteSharedBitmap",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "CompositorFrameSink::DidDeleteSharedBitmap deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
  ...
  TRACE_EVENT1("mojom", "(Impl)viz::mojom::CompositorFrameSink::SubmitCompositorFrameSync",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "CompositorFrameSink::SubmitCompositorFrameSync deserializer");
        return false;
      }
      CompositorFrameSink::SubmitCompositorFrameSyncCallback callback =
...
void CompositorFrameSinkClientProxy::DidReceiveCompositorFrameAck(
    const WTF::Vector<viz::ReturnedResource>& in_resources) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "viz::mojom::CompositorFrameSinkClient::DidReceiveCompositorFrameAck");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
void CompositorFrameSinkClientProxy::DidPresentCompositorFrame(
    uint32_t in_presentation_token, ::mojo_base::mojom::blink::TimeTicksPtr in_time, WTF::TimeDelta in_refresh, uint32_t in_flags) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "viz::mojom::CompositorFrameSinkClient::DidPresentCompositorFrame");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
  ...
  mojo::Message message(
      internal::kCompositorFrameSinkClient_DidPresentCompositorFrame_Name, kFlags, 0, 0, nullptr);
  auto* buffer = message.payload_buffer();
  ::viz::mojom::internal::CompositorFrameSinkClient_DidPresentCompositorFrame_Params_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  params->presentation_token = in_presentation_token;
  ...
  MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
      params->time.is_null(),
      mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
      "null time in CompositorFrameSinkClient.DidPresentCompositorFrame request");
  typename decltype(params->refresh)::BaseType::BufferWriter
      refresh_writer;
  mojo::internal::Serialize<::mojo_base::mojom::TimeDeltaDataView>(
      in_refresh, buffer, &refresh_writer, &serialization_context);
  params->refresh.Set(
      refresh_writer.is_null() ? nullptr : refresh_writer.data());
  MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
      params->refresh.is_null(),
      mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
      "null refresh in CompositorFrameSinkClient.DidPresentCompositorFrame request");
...
void CompositorFrameSinkClientProxy::DidDiscardCompositorFrame(
    uint32_t in_presentation_token) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "viz::mojom::CompositorFrameSinkClient::DidDiscardCompositorFrame");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
  ...
  mojo::Message message(
      internal::kCompositorFrameSinkClient_DidDiscardCompositorFrame_Name, kFlags, 0, 0, nullptr);
  auto* buffer = message.payload_buffer();
  ::viz::mojom::internal::CompositorFrameSinkClient_DidDiscardCompositorFrame_Params_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  params->presentation_token = in_presentation_token;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "viz::mojom::CompositorFrameSinkClient::OnBeginFrame");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
void CompositorFrameSinkClientProxy::OnBeginFramePausedChanged(
    bool in_paused) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "viz::mojom::CompositorFrameSinkClient::OnBeginFramePausedChanged");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
void CompositorFrameSinkClientProxy::ReclaimResources(
    const WTF::Vector<viz::ReturnedResource>& in_resources) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "viz::mojom::CompositorFrameSinkClient::ReclaimResources");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)viz::mojom::CompositorFrameSinkClient::DidReceiveCompositorFrameAck",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "CompositorFrameSinkClient::DidReceiveCompositorFrameAck deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
std::move(p_resources));
    ...
    case internal::kCompositorFrameSinkClient_DidPresentCompositorFrame_Name: {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)viz::mojom::CompositorFrameSinkClient::DidPresentCompositorFrame",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);

      DCHECK(message->is_serialized());
      internal::CompositorFrameSinkClient_DidPresentCompositorFrame_Params_Data* params =
          reinterpret_cast<internal::CompositorFrameSinkClient_DidPresentCompositorFrame_Params_Data*>(
              message->mutable_payload());
      
      mojo::internal::SerializationContext serialization_context;
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      uint32_t p_presentation_token{};
      ::mojo_base::mojom::blink::TimeTicksPtr p_time{};
      WTF::TimeDelta p_refresh{};
      uint32_t p_flags{};
      CompositorFrameSinkClient_DidPresentCompositorFrame_ParamsDataView input_data_view(params, &serialization_context);
      
      p_presentation_token = input_data_view.presentation_token();
      if (!input_data_view.ReadTime(&p_time))
        success = false;
      if (!input_data_view.ReadRefresh(&p_refresh))
        success = false;
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "CompositorFrameSinkClient::DidPresentCompositorFrame deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
      impl->DidPresentCompositorFrame(
...
std::move(p_flags));
    ...
    case internal::kCompositorFrameSinkClient_DidDiscardCompositorFrame_Name: {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)viz::mojom::CompositorFrameSinkClient::DidDiscardCompositorFrame",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);

      DCHECK(message->is_serialized());
      internal::CompositorFrameSinkClient_DidDiscardCompositorFrame_Params_Data* params =
          reinterpret_cast<internal::CompositorFrameSinkClient_DidDiscardCompositorFrame_Params_Data*>(
              message->mutable_payload());
      ...
      bool success = true;
      uint32_t p_presentation_token{};
      CompositorFrameSinkClient_DidDiscardCompositorFrame_ParamsDataView input_data_view(params, &serialization_context);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "CompositorFrameSinkClient::DidDiscardCompositorFrame deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
      impl->DidDiscardCompositorFrame(
std::move(p_presentation_token));
      return true;
    }
    case internal::kCompositorFrameSinkClient_OnBeginFrame_Name: {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)viz::mojom::CompositorFrameSinkClient::OnBeginFrame",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "CompositorFrameSinkClient::OnBeginFrame deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)viz::mojom::CompositorFrameSinkClient::OnBeginFramePausedChanged",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "CompositorFrameSinkClient::OnBeginFramePausedChanged deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)viz::mojom::CompositorFrameSinkClient::ReclaimResources",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "CompositorFrameSinkClient::ReclaimResources deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
bool CompositorFrameSinkClientRequestValidator::Accept(mojo::Message* message) {
  ...
  switch (message->header()->name) {
    ...
    case internal::kCompositorFrameSinkClient_DidPresentCompositorFrame_Name: {
      ...
      if (!mojo::internal::ValidateMessagePayload<
               internal::CompositorFrameSinkClient_DidPresentCompositorFrame_Params_Data>(
                  message, &validation_context)) {
        return false;
      }
      return true;
    ...
    case internal::kCompositorFrameSinkClient_DidDiscardCompositorFrame_Name: {
      ...
      if (!mojo::internal::ValidateMessagePayload<
               internal::CompositorFrameSinkClient_DidDiscardCompositorFrame_Params_Data>(
                  message, &validation_context)) {
        return false;
      }
      return true;
...
void CompositorFrameSinkClientInterceptorForTesting::DidPresentCompositorFrame(uint32_t presentation_token, ::mojo_base::mojom::blink::TimeTicksPtr time, WTF::TimeDelta refresh, uint32_t flags) {
  GetForwardingInterface()->DidPresentCompositorFrame(std::move(presentation_token), std::move(time), std::move(refresh), std::move(flags));
}
void CompositorFrameSinkClientInterceptorForTesting::DidDiscardCompositorFrame(uint32_t presentation_token) {
  GetForwardingInterface()->DidDiscardCompositorFrame(std::move(presentation_token));
}
void CompositorFrameSinkClientInterceptorForTesting::OnBeginFrame(const viz::BeginFrameArgs& args) {
  GetForwardingInterface()->OnBeginFrame(std::move(args));
}
