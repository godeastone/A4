...
bool StreamVideoQuadState_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->matrix, 3, validation_context)) {
    return false;
  }
...
bool SurfaceQuadState_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->primary_surface_id, 1, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->primary_surface_id, validation_context))
    return false;

  if (!mojo::internal::ValidateStruct(object->fallback_surface_id, validation_context))
    return false;
