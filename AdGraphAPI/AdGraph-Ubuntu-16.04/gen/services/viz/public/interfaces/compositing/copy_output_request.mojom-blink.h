...
#ifndef SERVICES_VIZ_PUBLIC_INTERFACES_COMPOSITING_COPY_OUTPUT_REQUEST_MOJOM_BLINK_H_
#define SERVICES_VIZ_PUBLIC_INTERFACES_COMPOSITING_COPY_OUTPUT_REQUEST_MOJOM_BLINK_H_
...
using RevocableCopyOutputResultSenderPtr = ::blink::RevocableInterfacePtr<CopyOutputResultSender>;
...
class  CopyOutputRequest {
 public:
  ...
  CopyOutputRequest(
      ...
      ::gfx::mojom::blink::Vector2dPtr scale_from,
      ::gfx::mojom::blink::Vector2dPtr scale_to,
      ::mojo_base::mojom::blink::UnguessableTokenPtr source,
      const base::Optional<::blink::WebRect>& area,
      const base::Optional<::blink::WebRect>& result_selection,
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CopyOutputRequest::DataView, WTF::Vector<uint8_t>>(input);
  }
  ...
  ::gfx::mojom::blink::Vector2dPtr scale_to;
  ::mojo_base::mojom::blink::UnguessableTokenPtr source;
  base::Optional<::blink::WebRect> area;
  base::Optional<::blink::WebRect> result_selection;
  CopyOutputResultSenderPtrInfo result_sender;
...
template <>
struct  StructTraits<::viz::mojom::blink::CopyOutputRequest::DataView,
...
#endif  // SERVICES_VIZ_PUBLIC_INTERFACES_COMPOSITING_COPY_OUTPUT_REQUEST_MOJOM_BLINK_H_