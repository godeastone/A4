...
CopyOutputRequest::CopyOutputRequest(
    ...
    ::mojo_base::mojom::blink::UnguessableTokenPtr source_in,
...
void CopyOutputResultSenderProxy::SendResult(
  ...
  TRACE_EVENT0("mojom", "viz::mojom::CopyOutputResultSender::SendResult");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)viz::mojom::CopyOutputResultSender::SendResult",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            ...
            "CopyOutputResultSender::SendResult deserializer");
        return false;
      }
