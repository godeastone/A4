...
struct  StructTraits<::viz::mojom::StreamVideoQuadState::DataView,
  ...
  static const decltype(::viz::mojom::StreamVideoQuadState::matrix)& matrix(
      const ::viz::mojom::StreamVideoQuadStatePtr& input) {
    return input->matrix;
  }
...
struct  StructTraits<::viz::mojom::SurfaceQuadState::DataView,
  ...
  static const decltype(::viz::mojom::SurfaceQuadState::primary_surface_id)& primary_surface_id(
      const ::viz::mojom::SurfaceQuadStatePtr& input) {
    return input->primary_surface_id;
  }

  static const decltype(::viz::mojom::SurfaceQuadState::fallback_surface_id)& fallback_surface_id(
      const ::viz::mojom::SurfaceQuadStatePtr& input) {
...
struct  StructTraits<::viz::mojom::TileQuadState::DataView,
  ...
  static decltype(::viz::mojom::TileQuadState::swizzle_contents) swizzle_contents(
      const ::viz::mojom::TileQuadStatePtr& input) {
...
struct  StructTraits<::viz::mojom::YUVVideoQuadState::DataView,
  ...
  static decltype(::viz::mojom::YUVVideoQuadState::require_overlay) require_overlay(
      const ::viz::mojom::YUVVideoQuadStatePtr& input) {
    return input->require_overlay;
  }

  static decltype(::viz::mojom::YUVVideoQuadState::is_protected_video) is_protected_video(
      const ::viz::mojom::YUVVideoQuadStatePtr& input) {
