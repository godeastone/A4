...
#ifndef SERVICES_VIZ_PUBLIC_INTERFACES_COMPOSITING_RENDER_PASS_MOJOM_H_
#define SERVICES_VIZ_PUBLIC_INTERFACES_COMPOSITING_RENDER_PASS_MOJOM_H_
...
bool RenderPass::Equals(const T& other_struct) const {
  ...
  if (!mojo::Equals(this->filters, other_struct.filters))
    return false;
  if (!mojo::Equals(this->background_filters, other_struct.background_filters))
    return false;
...
template <>
struct  StructTraits<::viz::mojom::RenderPass::DataView,
                                         ::viz::mojom::RenderPassPtr> {
  static bool IsNull(const ::viz::mojom::RenderPassPtr& input) { return !input; }
  static void SetToNull(::viz::mojom::RenderPassPtr* output) { output->reset(); }

  static decltype(::viz::mojom::RenderPass::id) id(
      const ::viz::mojom::RenderPassPtr& input) {
    return input->id;
  }

  static const decltype(::viz::mojom::RenderPass::output_rect)& output_rect(
      const ::viz::mojom::RenderPassPtr& input) {
    return input->output_rect;
  }

  static const decltype(::viz::mojom::RenderPass::damage_rect)& damage_rect(
      const ::viz::mojom::RenderPassPtr& input) {
    return input->damage_rect;
  }

  static const decltype(::viz::mojom::RenderPass::transform_to_root_target)& transform_to_root_target(
      const ::viz::mojom::RenderPassPtr& input) {
    return input->transform_to_root_target;
  }

  static const decltype(::viz::mojom::RenderPass::filters)& filters(
      const ::viz::mojom::RenderPassPtr& input) {
    return input->filters;
  }

  static const decltype(::viz::mojom::RenderPass::background_filters)& background_filters(
      const ::viz::mojom::RenderPassPtr& input) {
    return input->background_filters;
  }

  static const decltype(::viz::mojom::RenderPass::color_space)& color_space(
      const ::viz::mojom::RenderPassPtr& input) {
    return input->color_space;
  }

  static decltype(::viz::mojom::RenderPass::has_transparent_background) has_transparent_background(
      const ::viz::mojom::RenderPassPtr& input) {
    return input->has_transparent_background;
  }

  static decltype(::viz::mojom::RenderPass::cache_render_pass) cache_render_pass(
      const ::viz::mojom::RenderPassPtr& input) {
    return input->cache_render_pass;
  }

  static decltype(::viz::mojom::RenderPass::has_damage_from_contributing_content) has_damage_from_contributing_content(
      const ::viz::mojom::RenderPassPtr& input) {
    return input->has_damage_from_contributing_content;
  }

  static decltype(::viz::mojom::RenderPass::generate_mipmap) generate_mipmap(
      const ::viz::mojom::RenderPassPtr& input) {
    return input->generate_mipmap;
  }

  static  decltype(::viz::mojom::RenderPass::copy_requests)& copy_requests(
       ::viz::mojom::RenderPassPtr& input) {
    return input->copy_requests;
  }

  static const decltype(::viz::mojom::RenderPass::quad_list)& quad_list(
      const ::viz::mojom::RenderPassPtr& input) {
    return input->quad_list;
  }

  static bool Read(::viz::mojom::RenderPass::DataView input, ::viz::mojom::RenderPassPtr* output);
};

}  // namespace mojo

#endif  // SERVICES_VIZ_PUBLIC_INTERFACES_COMPOSITING_RENDER_PASS_MOJOM_H_