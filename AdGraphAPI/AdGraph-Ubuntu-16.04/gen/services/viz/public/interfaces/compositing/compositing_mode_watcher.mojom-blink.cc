...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)viz::mojom::CompositingModeWatcher::CompositingModeFallbackToSoftware",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            ...
            "CompositingModeWatcher::CompositingModeFallbackToSoftware deserializer");
        return false;
      }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "viz::mojom::CompositingModeReporter::AddCompositingModeWatcher");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)viz::mojom::CompositingModeReporter::AddCompositingModeWatcher",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "CompositingModeReporter::AddCompositingModeWatcher deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
