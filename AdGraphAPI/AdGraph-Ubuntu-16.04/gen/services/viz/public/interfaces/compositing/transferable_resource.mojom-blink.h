...
class  TransferableResource {
 public:
  ...
  TransferableResource(
      ...
      ::gfx::mojom::blink::BufferFormat buffer_format,
      uint32_t filter,
...
bool TransferableResource::Equals(const T& other_struct) const {
  ...
  if (!mojo::Equals(this->format, other_struct.format))
    return false;
  if (!mojo::Equals(this->buffer_format, other_struct.buffer_format))
    return false;
...
struct  StructTraits<::viz::mojom::blink::TransferableResource::DataView,
  ...
  static decltype(::viz::mojom::blink::TransferableResource::buffer_format) buffer_format(
      const ::viz::mojom::blink::TransferableResourcePtr& input) {
    return input->buffer_format;
  }
