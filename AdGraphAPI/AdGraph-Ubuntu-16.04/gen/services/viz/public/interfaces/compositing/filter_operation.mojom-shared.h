...
struct Serializer<::viz::mojom::FilterOperationDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    (*output)->amount = CallWithContext(Traits::amount, input, custom_context);
    (*output)->outer_threshold = CallWithContext(Traits::outer_threshold, input, custom_context);
    ...
    (*output)->drop_shadow_color = CallWithContext(Traits::drop_shadow_color, input, custom_context);
    ...
    (*output)->zoom_inset = CallWithContext(Traits::zoom_inset, input, custom_context);
    mojo::internal::Serialize<::skia::mojom::BlurTileMode>(
        CallWithContext(Traits::blur_tile_mode, input, custom_context), &(*output)->blur_tile_mode);
    decltype(CallWithContext(Traits::shape, input, custom_context)) in_shape = CallWithContext(Traits::shape, input, custom_context);
