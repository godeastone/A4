...
struct Serializer<::viz::mojom::FrameDeadlineDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    decltype(CallWithContext(Traits::frame_start_time, input, custom_context)) in_frame_start_time = CallWithContext(Traits::frame_start_time, input, custom_context);
    ...
    (*output)->deadline_in_frames = CallWithContext(Traits::deadline_in_frames, input, custom_context);
    decltype(CallWithContext(Traits::frame_interval, input, custom_context)) in_frame_interval = CallWithContext(Traits::frame_interval, input, custom_context);
    ...
    (*output)->use_default_lower_bound_deadline = CallWithContext(Traits::use_default_lower_bound_deadline, input, custom_context);
