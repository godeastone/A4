...
void CompositorFrameSinkClientProxy::DidPresentCompositorFrame(
    uint32_t in_presentation_token, base::TimeTicks in_time, base::TimeDelta in_refresh, uint32_t in_flags) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void CompositorFrameSinkClientInterceptorForTesting::DidPresentCompositorFrame(uint32_t presentation_token, base::TimeTicks time, base::TimeDelta refresh, uint32_t flags) {
