...
// static
bool CompositorFrameSinkClient_DidPresentCompositorFrame_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const CompositorFrameSinkClient_DidPresentCompositorFrame_Params_Data* object = static_cast<const CompositorFrameSinkClient_DidPresentCompositorFrame_Params_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->time, 2, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->refresh, 3, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->refresh, validation_context))
    return false;

  return true;
}

CompositorFrameSinkClient_DidPresentCompositorFrame_Params_Data::CompositorFrameSinkClient_DidPresentCompositorFrame_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool CompositorFrameSinkClient_DidDiscardCompositorFrame_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const CompositorFrameSinkClient_DidDiscardCompositorFrame_Params_Data* object = static_cast<const CompositorFrameSinkClient_DidDiscardCompositorFrame_Params_Data*>(data);
...
CompositorFrameSinkClient_DidDiscardCompositorFrame_Params_Data::CompositorFrameSinkClient_DidDiscardCompositorFrame_Params_Data()
    : header_({sizeof(*this), 0}) {}
