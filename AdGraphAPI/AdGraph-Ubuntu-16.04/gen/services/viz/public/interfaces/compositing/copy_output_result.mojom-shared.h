...
inline std::ostream& operator<<(std::ostream& os, CopyOutputResultFormat value) {
  switch(value) {
...
struct Serializer<::viz::mojom::CopyOutputResultDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    decltype(CallWithContext(Traits::releaser, input, custom_context)) in_releaser = CallWithContext(Traits::releaser, input, custom_context);
