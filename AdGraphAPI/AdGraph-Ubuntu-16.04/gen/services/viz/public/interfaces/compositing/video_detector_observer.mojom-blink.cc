...
#include "services/viz/public/interfaces/compositing/video_detector_observer.mojom-blink.h"
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)viz::mojom::VideoDetectorObserver::OnVideoActivityStarted",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            ...
            "VideoDetectorObserver::OnVideoActivityStarted deserializer");
        return false;
      }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)viz::mojom::VideoDetectorObserver::OnVideoActivityEnded",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "VideoDetectorObserver::OnVideoActivityEnded deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
