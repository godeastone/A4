...
#ifndef SERVICES_VIZ_PUBLIC_INTERFACES_COMPOSITING_COMPOSITOR_FRAME_METADATA_MOJOM_H_
#define SERVICES_VIZ_PUBLIC_INTERFACES_COMPOSITING_COMPOSITOR_FRAME_METADATA_MOJOM_H_
...
class  CompositorFrameMetadata {
 public:
  ...
  CompositorFrameMetadata(
      ...
      const std::vector<viz::SurfaceId>& activation_dependencies,
...
bool CompositorFrameMetadata::Equals(const T& other_struct) const {
  ...
  if (!mojo::Equals(this->frame_token, other_struct.frame_token))
    return false;
  if (!mojo::Equals(this->presentation_token, other_struct.presentation_token))
    return false;
  return true;
}
...
struct  StructTraits<::viz::mojom::CompositorFrameMetadata::DataView,
  ...
  static const decltype(::viz::mojom::CompositorFrameMetadata::root_layer_size)& root_layer_size(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
  ...
  static decltype(::viz::mojom::CompositorFrameMetadata::max_page_scale_factor) max_page_scale_factor(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
    return input->max_page_scale_factor;
  }

  static decltype(::viz::mojom::CompositorFrameMetadata::root_overflow_y_hidden) root_overflow_y_hidden(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
  ...
  static decltype(::viz::mojom::CompositorFrameMetadata::top_controls_height) top_controls_height(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
    return input->top_controls_height;
  }

  static decltype(::viz::mojom::CompositorFrameMetadata::top_controls_shown_ratio) top_controls_shown_ratio(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
    return input->top_controls_shown_ratio;
  }

  static decltype(::viz::mojom::CompositorFrameMetadata::bottom_controls_height) bottom_controls_height(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
    return input->bottom_controls_height;
  }

  static decltype(::viz::mojom::CompositorFrameMetadata::bottom_controls_shown_ratio) bottom_controls_shown_ratio(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
  ...
  static const decltype(::viz::mojom::CompositorFrameMetadata::selection)& selection(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
  ...
  static decltype(::viz::mojom::CompositorFrameMetadata::content_source_id) content_source_id(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
  ...
  static decltype(::viz::mojom::CompositorFrameMetadata::presentation_token) presentation_token(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
    return input->presentation_token;
  }
...
#endif  // SERVICES_VIZ_PUBLIC_INTERFACES_COMPOSITING_COMPOSITOR_FRAME_METADATA_MOJOM_H_