...
class  SurfaceQuadState {
 public:
  ...
  base::Optional<viz::SurfaceId> fallback_surface_id;
  uint32_t default_background_color;
  bool stretch_content_to_fill_bounds;
...
SurfaceQuadStatePtr SurfaceQuadState::Clone() const {
  return New(
      mojo::Clone(primary_surface_id),
      mojo::Clone(fallback_surface_id),
...
bool SurfaceQuadState::Equals(const T& other_struct) const {
  if (!mojo::Equals(this->primary_surface_id, other_struct.primary_surface_id))
    return false;
  if (!mojo::Equals(this->fallback_surface_id, other_struct.fallback_surface_id))
    return false;
...
bool TileQuadState::Equals(const T& other_struct) const {
  ...
  if (!mojo::Equals(this->texture_size, other_struct.texture_size))
    return false;
  if (!mojo::Equals(this->swizzle_contents, other_struct.swizzle_contents))
    return false;
...
YUVVideoQuadStatePtr YUVVideoQuadState::Clone() const {
  return New(
      ...
      mojo::Clone(require_overlay),
      mojo::Clone(is_protected_video)
  );
}
...
bool YUVVideoQuadState::Equals(const T& other_struct) const {
  ...
  if (!mojo::Equals(this->video_color_space, other_struct.video_color_space))
    return false;
  if (!mojo::Equals(this->require_overlay, other_struct.require_overlay))
    return false;
  if (!mojo::Equals(this->is_protected_video, other_struct.is_protected_video))
    return false;
  return true;
}
template <typename StructPtrType>
...
struct  StructTraits<::viz::mojom::blink::StreamVideoQuadState::DataView,
  ...
  static const decltype(::viz::mojom::blink::StreamVideoQuadState::matrix)& matrix(
      const ::viz::mojom::blink::StreamVideoQuadStatePtr& input) {
    return input->matrix;
  }
...
struct  StructTraits<::viz::mojom::blink::SurfaceQuadState::DataView,
  ...
  static const decltype(::viz::mojom::blink::SurfaceQuadState::primary_surface_id)& primary_surface_id(
      const ::viz::mojom::blink::SurfaceQuadStatePtr& input) {
    return input->primary_surface_id;
  }

  static const decltype(::viz::mojom::blink::SurfaceQuadState::fallback_surface_id)& fallback_surface_id(
      const ::viz::mojom::blink::SurfaceQuadStatePtr& input) {
    return input->fallback_surface_id;
  }
...
struct  StructTraits<::viz::mojom::blink::TileQuadState::DataView,
  ...
  static decltype(::viz::mojom::blink::TileQuadState::swizzle_contents) swizzle_contents(
      const ::viz::mojom::blink::TileQuadStatePtr& input) {
...
struct  StructTraits<::viz::mojom::blink::YUVVideoQuadState::DataView,
  ...
  static decltype(::viz::mojom::blink::YUVVideoQuadState::require_overlay) require_overlay(
      const ::viz::mojom::blink::YUVVideoQuadStatePtr& input) {
    return input->require_overlay;
  }

  static decltype(::viz::mojom::blink::YUVVideoQuadState::is_protected_video) is_protected_video(
      const ::viz::mojom::blink::YUVVideoQuadStatePtr& input) {
    return input->is_protected_video;
  }
