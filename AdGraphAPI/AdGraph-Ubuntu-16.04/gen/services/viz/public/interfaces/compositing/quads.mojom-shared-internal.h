...
class  SurfaceQuadState_Data {
 public:
  ...
  mojo::internal::StructHeader header_;
  mojo::internal::Pointer<::viz::mojom::internal::SurfaceId_Data> primary_surface_id;
  mojo::internal::Pointer<::viz::mojom::internal::SurfaceId_Data> fallback_surface_id;
...
class  YUVVideoQuadState_Data {
 public:
  ...
  uint8_t require_overlay : 1;
  uint8_t is_protected_video : 1;
  uint8_t pad12_[3];
