...
struct Serializer<::viz::mojom::BeginFrameArgsDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    (*output)->sequence_number = CallWithContext(Traits::sequence_number, input, custom_context);
    mojo::internal::Serialize<::viz::mojom::BeginFrameArgsType>(
        CallWithContext(Traits::type, input, custom_context), &(*output)->type);
    (*output)->on_critical_path = CallWithContext(Traits::on_critical_path, input, custom_context);
    (*output)->animate_only = CallWithContext(Traits::animate_only, input, custom_context);
...
struct Serializer<::viz::mojom::BeginFrameAckDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    (*output)->source_id = CallWithContext(Traits::source_id, input, custom_context);
    (*output)->sequence_number = CallWithContext(Traits::sequence_number, input, custom_context);
    (*output)->has_damage = CallWithContext(Traits::has_damage, input, custom_context);
    CustomContextHelper<Traits>::TearDown(input, custom_context);
  }
