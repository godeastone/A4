...
class  CompositorFrameMetadata {
 public:
  ...
  CompositorFrameMetadata(
      ...
      ::viz::mojom::blink::SelectionPtr selection,
      WTF::Vector<::ui::mojom::blink::LatencyInfoPtr> latency_info,
      const WTF::Vector<viz::SurfaceId>& referenced_surfaces,
  ...
  ::viz::mojom::blink::SelectionPtr selection;
  WTF::Vector<::ui::mojom::blink::LatencyInfoPtr> latency_info;
  WTF::Vector<viz::SurfaceId> referenced_surfaces;
  ::viz::mojom::blink::FrameDeadlinePtr deadline;
...
struct  StructTraits<::viz::mojom::blink::CompositorFrameMetadata::DataView,
  ...
  static const decltype(::viz::mojom::blink::CompositorFrameMetadata::root_layer_size)& root_layer_size(
      const ::viz::mojom::blink::CompositorFrameMetadataPtr& input) {
  ...
  static decltype(::viz::mojom::blink::CompositorFrameMetadata::max_page_scale_factor) max_page_scale_factor(
      const ::viz::mojom::blink::CompositorFrameMetadataPtr& input) {
    return input->max_page_scale_factor;
  }

  static decltype(::viz::mojom::blink::CompositorFrameMetadata::root_overflow_y_hidden) root_overflow_y_hidden(
      const ::viz::mojom::blink::CompositorFrameMetadataPtr& input) {
  ...
  static decltype(::viz::mojom::blink::CompositorFrameMetadata::bottom_controls_height) bottom_controls_height(
      const ::viz::mojom::blink::CompositorFrameMetadataPtr& input) {
    return input->bottom_controls_height;
  }

  static decltype(::viz::mojom::blink::CompositorFrameMetadata::bottom_controls_shown_ratio) bottom_controls_shown_ratio(
      const ::viz::mojom::blink::CompositorFrameMetadataPtr& input) {
  ...
  static const decltype(::viz::mojom::blink::CompositorFrameMetadata::selection)& selection(
      const ::viz::mojom::blink::CompositorFrameMetadataPtr& input) {
  ...
  static decltype(::viz::mojom::blink::CompositorFrameMetadata::presentation_token) presentation_token(
      const ::viz::mojom::blink::CompositorFrameMetadataPtr& input) {
