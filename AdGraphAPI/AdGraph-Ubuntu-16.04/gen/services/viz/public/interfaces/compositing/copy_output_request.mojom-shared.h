...
struct Serializer<::viz::mojom::CopyOutputRequestDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    mojo::internal::Serialize<::viz::mojom::CopyOutputResultFormat>(
        CallWithContext(Traits::result_format, input, custom_context), &(*output)->result_format);
    decltype(CallWithContext(Traits::scale_from, input, custom_context)) in_scale_from = CallWithContext(Traits::scale_from, input, custom_context);
    ...
    decltype(CallWithContext(Traits::scale_to, input, custom_context)) in_scale_to = CallWithContext(Traits::scale_to, input, custom_context);
    ...
    decltype(CallWithContext(Traits::result_selection, input, custom_context)) in_result_selection = CallWithContext(Traits::result_selection, input, custom_context);
    ...
    decltype(CallWithContext(Traits::result_sender, input, custom_context)) in_result_sender = CallWithContext(Traits::result_sender, input, custom_context);
