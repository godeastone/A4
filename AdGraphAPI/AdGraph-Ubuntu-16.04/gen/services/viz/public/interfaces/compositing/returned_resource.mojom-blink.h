...
#ifndef SERVICES_VIZ_PUBLIC_INTERFACES_COMPOSITING_RETURNED_RESOURCE_MOJOM_BLINK_H_
#define SERVICES_VIZ_PUBLIC_INTERFACES_COMPOSITING_RETURNED_RESOURCE_MOJOM_BLINK_H_
...
template <>
struct  StructTraits<::viz::mojom::blink::ReturnedResource::DataView,
  ...
  static decltype(::viz::mojom::blink::ReturnedResource::id) id(
...
#endif  // SERVICES_VIZ_PUBLIC_INTERFACES_COMPOSITING_RETURNED_RESOURCE_MOJOM_BLINK_H_