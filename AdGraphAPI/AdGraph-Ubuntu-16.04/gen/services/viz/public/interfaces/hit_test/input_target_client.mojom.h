...
#ifndef SERVICES_VIZ_PUBLIC_INTERFACES_HIT_TEST_INPUT_TARGET_CLIENT_MOJOM_H_
#define SERVICES_VIZ_PUBLIC_INTERFACES_HIT_TEST_INPUT_TARGET_CLIENT_MOJOM_H_
...
class  InputTargetClient
 ...
 public:
  ...
  virtual void FrameSinkIdAt(const gfx::Point& point, FrameSinkIdAtCallback callback) = 0;
};
class  InputTargetClientInterceptorForTesting : public InputTargetClient {
  virtual InputTargetClient* GetForwardingInterface() = 0;
  void FrameSinkIdAt(const gfx::Point& point, FrameSinkIdAtCallback callback) override;
};
class  InputTargetClientAsyncWaiter {
 public:
  ...
  void FrameSinkIdAt(
      const gfx::Point& point, viz::FrameSinkId* out_id);
...
class  InputTargetClientProxy
 ...
 public:
  ...
  void FrameSinkIdAt(const gfx::Point& point, FrameSinkIdAtCallback callback) final;
...
#endif  // SERVICES_VIZ_PUBLIC_INTERFACES_HIT_TEST_INPUT_TARGET_CLIENT_MOJOM_H_