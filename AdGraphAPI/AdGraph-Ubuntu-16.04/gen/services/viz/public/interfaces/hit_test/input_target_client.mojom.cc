...
void InputTargetClientProxy::FrameSinkIdAt(
    const gfx::Point& in_point, FrameSinkIdAtCallback callback) {
...
void InputTargetClientInterceptorForTesting::FrameSinkIdAt(const gfx::Point& point, FrameSinkIdAtCallback callback) {
