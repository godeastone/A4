...
namespace mojom {
namespace blink {
COMPONENT_EXPORT(SERVICE_MANAGER_MOJOM_CONSTANTS_BLINK) extern const char kServiceName[];
COMPONENT_EXPORT(SERVICE_MANAGER_MOJOM_CONSTANTS_BLINK) extern const char kRootUserID[];
COMPONENT_EXPORT(SERVICE_MANAGER_MOJOM_CONSTANTS_BLINK) extern const char kInheritUserID[];
 ...
 public:
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        Constants_UnusedStruct_Internal::DataView, WTF::Vector<uint8_t>>(input);
  }
...
struct COMPONENT_EXPORT(SERVICE_MANAGER_MOJOM_CONSTANTS_BLINK) StructTraits<::service_manager::mojom::blink::Constants_UnusedStruct_Internal::DataView,
  ...
  static bool IsNull(const ::service_manager::mojom::blink::Constants_UnusedStruct_InternalPtr& input) { return !input; }
  static void SetToNull(::service_manager::mojom::blink::Constants_UnusedStruct_InternalPtr* output) { output->reset(); }

  static bool Read(::service_manager::mojom::blink::Constants_UnusedStruct_Internal::DataView input, ::service_manager::mojom::blink::Constants_UnusedStruct_InternalPtr* output);
};
