...
void ServiceFactoryProxy::CreateService(
    ::service_manager::mojom::ServiceRequest in_service, const std::string& in_name, ::service_manager::mojom::PIDReceiverPtr in_pid_receiver) {
...
bool ServiceFactoryStubDispatch::Accept(
  ...
  TRACE_EVENT1("mojom", "(Impl)service_manager::mojom::ServiceFactory::CreateService",
      ...
      std::string p_name{};
      ::service_manager::mojom::PIDReceiverPtr p_pid_receiver{};
...
void ServiceFactoryInterceptorForTesting::CreateService(::service_manager::mojom::ServiceRequest service, const std::string& name, ::service_manager::mojom::PIDReceiverPtr pid_receiver) {
