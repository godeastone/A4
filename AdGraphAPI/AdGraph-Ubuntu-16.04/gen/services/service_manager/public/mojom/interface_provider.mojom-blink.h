...
using RevocableInterfaceProviderPtr = ::blink::RevocableInterfacePtr<InterfaceProvider>;
...
class COMPONENT_EXPORT(SERVICE_MANAGER_MOJOM_BLINK) InterfaceProvider
...
class COMPONENT_EXPORT(SERVICE_MANAGER_MOJOM_BLINK) InterfaceProviderProxy
