...
Identity::Identity(
    ...
    const std::string& user_id_in,
    const std::string& instance_in)
...
void ConnectorProxy::BindInterface(
    const ::service_manager::Identity& in_target, const std::string& in_interface_name, mojo::ScopedMessagePipeHandle in_interface_pipe, BindInterfaceCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ConnectorProxy::QueryService(
    const ::service_manager::Identity& in_target, QueryServiceCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ConnectorProxy::StartService(
    const ::service_manager::Identity& in_target, StartServiceCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ConnectorProxy::StartServiceWithProcess(
    const ::service_manager::Identity& in_target, mojo::ScopedMessagePipeHandle in_service, PIDReceiverRequest in_pid_receiver_request, StartServiceWithProcessCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class Connector_BindInterface_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ConnectResult in_result, const ::service_manager::Identity& in_user_id);
...
bool Connector_BindInterface_ForwardToCallback::Accept(
  ...
  ::service_manager::Identity p_user_id{};
...
class Connector_QueryService_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ConnectResult in_result, const std::string& in_sandbox_type);
...
class Connector_StartService_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ConnectResult in_result, const ::service_manager::Identity& in_identity);
...
void ConnectorInterceptorForTesting::BindInterface(const ::service_manager::Identity& target, const std::string& interface_name, mojo::ScopedMessagePipeHandle interface_pipe, BindInterfaceCallback callback) {
  GetForwardingInterface()->BindInterface(std::move(target), std::move(interface_name), std::move(interface_pipe), std::move(callback));
}
void ConnectorInterceptorForTesting::QueryService(const ::service_manager::Identity& target, QueryServiceCallback callback) {
  GetForwardingInterface()->QueryService(std::move(target), std::move(callback));
}
void ConnectorInterceptorForTesting::StartService(const ::service_manager::Identity& target, StartServiceCallback callback) {
  GetForwardingInterface()->StartService(std::move(target), std::move(callback));
}
void ConnectorInterceptorForTesting::StartServiceWithProcess(const ::service_manager::Identity& target, mojo::ScopedMessagePipeHandle service, PIDReceiverRequest pid_receiver_request, StartServiceWithProcessCallback callback) {
...
void ConnectorAsyncWaiter::BindInterface(
    const ::service_manager::Identity& target, const std::string& interface_name, mojo::ScopedMessagePipeHandle interface_pipe, ConnectResult* out_result, ::service_manager::Identity* out_user_id) {
  base::RunLoop loop;
...
,
             ::service_manager::Identity* out_user_id
,
             ConnectResult result,
             const ::service_manager::Identity& user_id) {*out_result = std::move(result);*out_user_id = std::move(user_id);
            loop->Quit();
          },
          &loop,
          out_result,
...
void ConnectorAsyncWaiter::QueryService(
    const ::service_manager::Identity& target, ConnectResult* out_result, std::string* out_sandbox_type) {
  base::RunLoop loop;
  proxy_->QueryService(std::move(target),
      base::BindOnce(
          [](base::RunLoop* loop,
             ConnectResult* out_result
,
             std::string* out_sandbox_type
,
             ConnectResult result,
             const std::string& sandbox_type) {*out_result = std::move(result);*out_sandbox_type = std::move(sandbox_type);
            loop->Quit();
          },
          &loop,
          out_result,
...
void ConnectorAsyncWaiter::StartService(
    const ::service_manager::Identity& target, ConnectResult* out_result, ::service_manager::Identity* out_identity) {
  base::RunLoop loop;
  proxy_->StartService(std::move(target),
      base::BindOnce(
          [](base::RunLoop* loop,
             ConnectResult* out_result
,
             ::service_manager::Identity* out_identity
,
             ConnectResult result,
             const ::service_manager::Identity& identity) {*out_result = std::move(result);*out_identity = std::move(identity);
            loop->Quit();
          },
          &loop,
          out_result,
...
void ConnectorAsyncWaiter::StartServiceWithProcess(
    const ::service_manager::Identity& target, mojo::ScopedMessagePipeHandle service, PIDReceiverRequest pid_receiver_request, ConnectResult* out_result, ::service_manager::Identity* out_identity) {
  base::RunLoop loop;
