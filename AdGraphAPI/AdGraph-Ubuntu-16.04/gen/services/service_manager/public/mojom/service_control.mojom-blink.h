...
using RevocableServiceControlPtr = ::blink::RevocableInterfacePtr<ServiceControl>;
...
class COMPONENT_EXPORT(SERVICE_MANAGER_MOJOM_BLINK) ServiceControl
...
class COMPONENT_EXPORT(SERVICE_MANAGER_MOJOM_BLINK) ServiceControlProxy
