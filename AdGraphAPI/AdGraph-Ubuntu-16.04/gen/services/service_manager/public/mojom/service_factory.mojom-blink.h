...
#ifndef SERVICES_SERVICE_MANAGER_PUBLIC_MOJOM_SERVICE_FACTORY_MOJOM_BLINK_H_
#define SERVICES_SERVICE_MANAGER_PUBLIC_MOJOM_SERVICE_FACTORY_MOJOM_BLINK_H_
...
using RevocableServiceFactoryPtr = ::blink::RevocableInterfacePtr<ServiceFactory>;
...
class COMPONENT_EXPORT(SERVICE_MANAGER_MOJOM_BLINK) ServiceFactory
 ...
 public:
  ...
  virtual void CreateService(::service_manager::mojom::blink::ServiceRequest service, const WTF::String& name, ::service_manager::mojom::blink::PIDReceiverPtr pid_receiver) = 0;
};
class COMPONENT_EXPORT(SERVICE_MANAGER_MOJOM_BLINK) ServiceFactoryInterceptorForTesting : public ServiceFactory {
  virtual ServiceFactory* GetForwardingInterface() = 0;
  void CreateService(::service_manager::mojom::blink::ServiceRequest service, const WTF::String& name, ::service_manager::mojom::blink::PIDReceiverPtr pid_receiver) override;
};
class COMPONENT_EXPORT(SERVICE_MANAGER_MOJOM_BLINK) ServiceFactoryAsyncWaiter {
 public:
...
class COMPONENT_EXPORT(SERVICE_MANAGER_MOJOM_BLINK) ServiceFactoryProxy
    : public ServiceFactory {
 public:
  explicit ServiceFactoryProxy(mojo::MessageReceiverWithResponder* receiver);
  void CreateService(::service_manager::mojom::blink::ServiceRequest service, const WTF::String& name, ::service_manager::mojom::blink::PIDReceiverPtr pid_receiver) final;

 private:
  mojo::MessageReceiverWithResponder* receiver_;
};
class COMPONENT_EXPORT(SERVICE_MANAGER_MOJOM_BLINK) ServiceFactoryStubDispatch {
 public:
...
class COMPONENT_EXPORT(SERVICE_MANAGER_MOJOM_BLINK) ServiceFactoryRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
#endif  // SERVICES_SERVICE_MANAGER_PUBLIC_MOJOM_SERVICE_FACTORY_MOJOM_BLINK_H_