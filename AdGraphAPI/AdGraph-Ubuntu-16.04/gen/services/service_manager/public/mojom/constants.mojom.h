...
COMPONENT_EXPORT(SERVICE_MANAGER_MOJOM_CONSTANTS) extern const char kRootUserID[];
COMPONENT_EXPORT(SERVICE_MANAGER_MOJOM_CONSTANTS) extern const char kInheritUserID[];
