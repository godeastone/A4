...
using ClipboardPtrDataView =
    mojo::InterfacePtrDataView<ClipboardInterfaceBase>;
using ClipboardRequestDataView =
    mojo::InterfaceRequestDataView<ClipboardInterfaceBase>;
using ClipboardAssociatedPtrInfoDataView =
    mojo::AssociatedInterfacePtrInfoDataView<ClipboardInterfaceBase>;
using ClipboardAssociatedRequestDataView =
    mojo::AssociatedInterfaceRequestDataView<ClipboardInterfaceBase>;
