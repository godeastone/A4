...
class Gpu_CreateJpegDecodeAccelerator_ParamsDataView {
 public:
  Gpu_CreateJpegDecodeAccelerator_ParamsDataView() {}

  Gpu_CreateJpegDecodeAccelerator_ParamsDataView(
      internal::Gpu_CreateJpegDecodeAccelerator_Params_Data* data,
      mojo::internal::SerializationContext* context)
      : data_(data), context_(context) {}
 ...
 private:
  internal::Gpu_CreateJpegDecodeAccelerator_Params_Data* data_ = nullptr;
  mojo::internal::SerializationContext* context_ = nullptr;
};
