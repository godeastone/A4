...
using WindowServerTestPtrDataView =
    mojo::InterfacePtrDataView<WindowServerTestInterfaceBase>;
using WindowServerTestRequestDataView =
    mojo::InterfaceRequestDataView<WindowServerTestInterfaceBase>;
using WindowServerTestAssociatedPtrInfoDataView =
    mojo::AssociatedInterfacePtrInfoDataView<WindowServerTestInterfaceBase>;
using WindowServerTestAssociatedRequestDataView =
    mojo::AssociatedInterfaceRequestDataView<WindowServerTestInterfaceBase>;
