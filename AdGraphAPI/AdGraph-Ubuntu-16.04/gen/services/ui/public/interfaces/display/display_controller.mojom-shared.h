...
using DisplayControllerPtrDataView =
    mojo::InterfacePtrDataView<DisplayControllerInterfaceBase>;
using DisplayControllerRequestDataView =
    mojo::InterfaceRequestDataView<DisplayControllerInterfaceBase>;
using DisplayControllerAssociatedPtrInfoDataView =
    mojo::AssociatedInterfacePtrInfoDataView<DisplayControllerInterfaceBase>;
using DisplayControllerAssociatedRequestDataView =
    mojo::AssociatedInterfaceRequestDataView<DisplayControllerInterfaceBase>;
...
class DisplayController_TakeDisplayControl_ParamsDataView {
 public:
  DisplayController_TakeDisplayControl_ParamsDataView() {}

  DisplayController_TakeDisplayControl_ParamsDataView(
      internal::DisplayController_TakeDisplayControl_Params_Data* data,
      mojo::internal::SerializationContext* context)
      : data_(data) {}

  bool is_null() const { return !data_; }
 private:
  internal::DisplayController_TakeDisplayControl_Params_Data* data_ = nullptr;
};

class DisplayController_TakeDisplayControl_ResponseParamsDataView {
 public:
  DisplayController_TakeDisplayControl_ResponseParamsDataView() {}

  DisplayController_TakeDisplayControl_ResponseParamsDataView(
      internal::DisplayController_TakeDisplayControl_ResponseParams_Data* data,
      mojo::internal::SerializationContext* context)
      : data_(data) {}
 ...
 private:
  internal::DisplayController_TakeDisplayControl_ResponseParams_Data* data_ = nullptr;
};

class DisplayController_RelinquishDisplayControl_ParamsDataView {
 public:
  DisplayController_RelinquishDisplayControl_ParamsDataView() {}

  DisplayController_RelinquishDisplayControl_ParamsDataView(
      internal::DisplayController_RelinquishDisplayControl_Params_Data* data,
      mojo::internal::SerializationContext* context)
      : data_(data) {}

  bool is_null() const { return !data_; }
 private:
  internal::DisplayController_RelinquishDisplayControl_Params_Data* data_ = nullptr;
};

class DisplayController_RelinquishDisplayControl_ResponseParamsDataView {
 public:
  DisplayController_RelinquishDisplayControl_ResponseParamsDataView() {}

  DisplayController_RelinquishDisplayControl_ResponseParamsDataView(
      internal::DisplayController_RelinquishDisplayControl_ResponseParams_Data* data,
      mojo::internal::SerializationContext* context)
      : data_(data) {}
 ...
 private:
  internal::DisplayController_RelinquishDisplayControl_ResponseParams_Data* data_ = nullptr;
};
