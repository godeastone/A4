...
using WindowManagerWindowTreeFactoryPtrDataView =
    mojo::InterfacePtrDataView<WindowManagerWindowTreeFactoryInterfaceBase>;
using WindowManagerWindowTreeFactoryRequestDataView =
    mojo::InterfaceRequestDataView<WindowManagerWindowTreeFactoryInterfaceBase>;
using WindowManagerWindowTreeFactoryAssociatedPtrInfoDataView =
    mojo::AssociatedInterfacePtrInfoDataView<WindowManagerWindowTreeFactoryInterfaceBase>;
using WindowManagerWindowTreeFactoryAssociatedRequestDataView =
    mojo::AssociatedInterfaceRequestDataView<WindowManagerWindowTreeFactoryInterfaceBase>;
class WindowManagerWindowTreeFactory_CreateWindowTree_ParamsDataView {
 public:
  ...
  bool automatically_create_display_roots() const {
    return data_->automatically_create_display_roots;
  }
 private:
