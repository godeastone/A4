...
#include "services/ui/public/interfaces/user_activity_monitor.mojom-shared-message-ids.h"
namespace ui {
namespace mojom {
...
void UserActivityObserverProxy::OnUserActivity(
  ...
  TRACE_EVENT0("mojom", "ui::mojom::UserActivityObserver::OnUserActivity");
#endif
  ...
  ::ui::mojom::internal::UserActivityObserver_OnUserActivity_Params_Data::BufferWriter
      params;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)ui::mojom::UserActivityObserver::OnUserActivity",
...
void UserIdleObserverProxy::OnUserIdleStateChanged(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "ui::mojom::UserIdleObserver::OnUserIdleStateChanged");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
  ...
  auto* buffer = message.payload_buffer();
  ::ui::mojom::internal::UserIdleObserver_OnUserIdleStateChanged_Params_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)ui::mojom::UserIdleObserver::OnUserIdleStateChanged",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
...
void UserActivityMonitorProxy::AddUserActivityObserver(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "ui::mojom::UserActivityMonitor::AddUserActivityObserver");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
  ...
  auto* buffer = message.payload_buffer();
  ::ui::mojom::internal::UserActivityMonitor_AddUserActivityObserver_Params_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
...
void UserActivityMonitorProxy::AddUserIdleObserver(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "ui::mojom::UserActivityMonitor::AddUserIdleObserver");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
  ...
  auto* buffer = message.payload_buffer();
  ::ui::mojom::internal::UserActivityMonitor_AddUserIdleObserver_Params_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)ui::mojom::UserActivityMonitor::AddUserActivityObserver",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)ui::mojom::UserActivityMonitor::AddUserIdleObserver",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
