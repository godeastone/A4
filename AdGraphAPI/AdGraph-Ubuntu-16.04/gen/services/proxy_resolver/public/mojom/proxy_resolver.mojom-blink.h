...
#include "net/interfaces/host_resolver_service.mojom-blink.h"
...
using RevocableProxyResolverPtr = ::blink::RevocableInterfacePtr<ProxyResolver>;
...
using RevocableProxyResolverRequestClientPtr = ::blink::RevocableInterfacePtr<ProxyResolverRequestClient>;
...
using RevocableProxyResolverFactoryPtr = ::blink::RevocableInterfacePtr<ProxyResolverFactory>;
...
using RevocableProxyResolverFactoryRequestClientPtr = ::blink::RevocableInterfacePtr<ProxyResolverFactoryRequestClient>;
...
class BLINK_PLATFORM_EXPORT ProxyResolverRequestClient
 ...
 public:
  ...
  virtual void ResolveDns(::net::interfaces::blink::HostResolverRequestInfoPtr request_info, ::net::interfaces::blink::HostResolverRequestClientPtr client) = 0;
};
class BLINK_PLATFORM_EXPORT ProxyResolverRequestClientInterceptorForTesting : public ProxyResolverRequestClient {
  ...
  void ResolveDns(::net::interfaces::blink::HostResolverRequestInfoPtr request_info, ::net::interfaces::blink::HostResolverRequestClientPtr client) override;
};
...
class BLINK_PLATFORM_EXPORT ProxyResolverRequestClientProxy
 ...
 public:
  ...
  void ResolveDns(::net::interfaces::blink::HostResolverRequestInfoPtr request_info, ::net::interfaces::blink::HostResolverRequestClientPtr client) final;
