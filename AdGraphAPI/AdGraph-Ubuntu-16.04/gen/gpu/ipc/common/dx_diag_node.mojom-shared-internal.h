  ...
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      ...
      index_ = serialization_buffer_->Allocate(sizeof(DxDiagNode_Data));
      new (data()) DxDiagNode_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    DxDiagNode_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<DxDiagNode_Data>(index_);
    }
    DxDiagNode_Data* operator->() { return data(); }
...
struct DxDiagNode_UnserializedMessageContext
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  DxDiagNode_UnserializedMessageContext(
 ...
 private:
  ...
  void Serialize(mojo::internal::SerializationContext* context,
    ...
    DxDiagNode_Data::BufferWriter writer;
...
const mojo::internal::UnserializedMessageContext::Tag
    DxDiagNode_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
