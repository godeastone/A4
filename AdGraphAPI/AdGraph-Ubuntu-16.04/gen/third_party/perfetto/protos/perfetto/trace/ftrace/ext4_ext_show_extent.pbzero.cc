...
static const ::protozero::ProtoFieldDescriptor kFields_Ext4ExtShowExtentFtraceEvent[] = {
...
const ::protozero::ProtoFieldDescriptor* Ext4ExtShowExtentFtraceEvent::GetFieldDescriptor(uint32_t field_id) {
  switch (field_id) {
    case kDevFieldNumber:
      return &kFields_Ext4ExtShowExtentFtraceEvent[0];
    case kInoFieldNumber:
      return &kFields_Ext4ExtShowExtentFtraceEvent[1];
    case kPblkFieldNumber:
      return &kFields_Ext4ExtShowExtentFtraceEvent[2];
    case kLblkFieldNumber:
      return &kFields_Ext4ExtShowExtentFtraceEvent[3];
    case kLenFieldNumber:
      return &kFields_Ext4ExtShowExtentFtraceEvent[4];
    default:
