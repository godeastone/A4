...
static const ::protozero::ProtoFieldDescriptor kFields_F2fsEvictInodeFtraceEvent[] = {
...
const ::protozero::ProtoFieldDescriptor* F2fsEvictInodeFtraceEvent::GetFieldDescriptor(uint32_t field_id) {
  switch (field_id) {
    case kDevFieldNumber:
      return &kFields_F2fsEvictInodeFtraceEvent[0];
    case kInoFieldNumber:
      return &kFields_F2fsEvictInodeFtraceEvent[1];
    case kPinoFieldNumber:
      return &kFields_F2fsEvictInodeFtraceEvent[2];
    case kModeFieldNumber:
      return &kFields_F2fsEvictInodeFtraceEvent[3];
    case kSizeFieldNumber:
      return &kFields_F2fsEvictInodeFtraceEvent[4];
    case kNlinkFieldNumber:
      return &kFields_F2fsEvictInodeFtraceEvent[5];
    case kBlocksFieldNumber:
      return &kFields_F2fsEvictInodeFtraceEvent[6];
    case kAdviseFieldNumber:
      return &kFields_F2fsEvictInodeFtraceEvent[7];
    default:
