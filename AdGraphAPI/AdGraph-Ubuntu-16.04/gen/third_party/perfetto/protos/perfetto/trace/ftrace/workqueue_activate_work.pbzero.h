...
#ifndef PERFETTO_PROTOS_PERFETTO_TRACE_FTRACE_WORKQUEUE_ACTIVATE_WORK_PROTO_H_
#define PERFETTO_PROTOS_PERFETTO_TRACE_FTRACE_WORKQUEUE_ACTIVATE_WORK_PROTO_H_
