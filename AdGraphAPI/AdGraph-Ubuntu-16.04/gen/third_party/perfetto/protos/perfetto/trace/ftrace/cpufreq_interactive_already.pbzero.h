...
#ifndef PERFETTO_PROTOS_PERFETTO_TRACE_FTRACE_CPUFREQ_INTERACTIVE_ALREADY_PROTO_H_
#define PERFETTO_PROTOS_PERFETTO_TRACE_FTRACE_CPUFREQ_INTERACTIVE_ALREADY_PROTO_H_
...
class CpufreqInteractiveAlreadyFtraceEvent : public ::protozero::Message {
 public:
  enum : int32_t {
    kCpuIdFieldNumber = 1,
    kLoadFieldNumber = 2,
