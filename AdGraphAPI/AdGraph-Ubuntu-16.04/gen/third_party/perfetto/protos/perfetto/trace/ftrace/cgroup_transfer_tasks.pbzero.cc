...
static const ::protozero::ProtoFieldDescriptor kFields_CgroupTransferTasksFtraceEvent[] = {
...
const ::protozero::ProtoFieldDescriptor* CgroupTransferTasksFtraceEvent::GetFieldDescriptor(uint32_t field_id) {
  switch (field_id) {
    case kDstRootFieldNumber:
      return &kFields_CgroupTransferTasksFtraceEvent[0];
    case kDstIdFieldNumber:
      return &kFields_CgroupTransferTasksFtraceEvent[1];
    case kPidFieldNumber:
      return &kFields_CgroupTransferTasksFtraceEvent[2];
    case kCommFieldNumber:
      return &kFields_CgroupTransferTasksFtraceEvent[3];
    case kCnameFieldNumber:
      return &kFields_CgroupTransferTasksFtraceEvent[4];
    default:
