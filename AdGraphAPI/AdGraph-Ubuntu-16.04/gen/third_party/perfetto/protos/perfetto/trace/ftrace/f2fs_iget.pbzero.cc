...
static const ::protozero::ProtoFieldDescriptor kFields_F2fsIgetFtraceEvent[] = {
...
const ::protozero::ProtoFieldDescriptor* F2fsIgetFtraceEvent::GetFieldDescriptor(uint32_t field_id) {
  switch (field_id) {
    case kDevFieldNumber:
      return &kFields_F2fsIgetFtraceEvent[0];
    case kInoFieldNumber:
      return &kFields_F2fsIgetFtraceEvent[1];
    case kPinoFieldNumber:
      return &kFields_F2fsIgetFtraceEvent[2];
    case kModeFieldNumber:
      return &kFields_F2fsIgetFtraceEvent[3];
    case kSizeFieldNumber:
      return &kFields_F2fsIgetFtraceEvent[4];
    case kNlinkFieldNumber:
      return &kFields_F2fsIgetFtraceEvent[5];
    case kBlocksFieldNumber:
      return &kFields_F2fsIgetFtraceEvent[6];
    case kAdviseFieldNumber:
      return &kFields_F2fsIgetFtraceEvent[7];
    default:
