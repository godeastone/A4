...
static const ::protozero::ProtoFieldDescriptor kFields_MmFilemapAddToPageCacheFtraceEvent[] = {
...
const ::protozero::ProtoFieldDescriptor* MmFilemapAddToPageCacheFtraceEvent::GetFieldDescriptor(uint32_t field_id) {
  switch (field_id) {
    case kPfnFieldNumber:
      return &kFields_MmFilemapAddToPageCacheFtraceEvent[0];
    case kIInoFieldNumber:
      return &kFields_MmFilemapAddToPageCacheFtraceEvent[1];
    case kIndexFieldNumber:
      return &kFields_MmFilemapAddToPageCacheFtraceEvent[2];
    case kSDevFieldNumber:
      return &kFields_MmFilemapAddToPageCacheFtraceEvent[3];
    case kPageFieldNumber:
      return &kFields_MmFilemapAddToPageCacheFtraceEvent[4];
    default:
