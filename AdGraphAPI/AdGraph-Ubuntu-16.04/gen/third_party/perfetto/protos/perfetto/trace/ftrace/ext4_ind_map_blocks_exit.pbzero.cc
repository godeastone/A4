...
static const ::protozero::ProtoFieldDescriptor kFields_Ext4IndMapBlocksExitFtraceEvent[] = {
...
const ::protozero::ProtoFieldDescriptor* Ext4IndMapBlocksExitFtraceEvent::GetFieldDescriptor(uint32_t field_id) {
  switch (field_id) {
    case kDevFieldNumber:
      return &kFields_Ext4IndMapBlocksExitFtraceEvent[0];
    case kInoFieldNumber:
      return &kFields_Ext4IndMapBlocksExitFtraceEvent[1];
    case kFlagsFieldNumber:
      return &kFields_Ext4IndMapBlocksExitFtraceEvent[2];
    case kPblkFieldNumber:
      return &kFields_Ext4IndMapBlocksExitFtraceEvent[3];
    case kLblkFieldNumber:
      return &kFields_Ext4IndMapBlocksExitFtraceEvent[4];
    case kLenFieldNumber:
      return &kFields_Ext4IndMapBlocksExitFtraceEvent[5];
    case kMflagsFieldNumber:
      return &kFields_Ext4IndMapBlocksExitFtraceEvent[6];
    case kRetFieldNumber:
      return &kFields_Ext4IndMapBlocksExitFtraceEvent[7];
    default:
