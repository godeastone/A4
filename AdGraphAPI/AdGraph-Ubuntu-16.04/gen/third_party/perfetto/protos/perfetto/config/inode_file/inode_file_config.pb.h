...
class InodeFileConfig_MountPointMappingEntry : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:perfetto.protos.InodeFileConfig.MountPointMappingEntry) */ {
 public:
  ...
  inline InodeFileConfig_MountPointMappingEntry* New() const PROTOBUF_FINAL { return New(NULL); }

  InodeFileConfig_MountPointMappingEntry* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
...
class InodeFileConfig : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:perfetto.protos.InodeFileConfig) */ {
 public:
  ...
  inline InodeFileConfig* New() const PROTOBUF_FINAL { return New(NULL); }

  InodeFileConfig* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
