...
#ifndef PROTOBUF_ukm_2fsource_2eproto__INCLUDED
#define PROTOBUF_ukm_2fsource_2eproto__INCLUDED
...
const Source_UrlScheme Source_UrlScheme_UrlScheme_MAX = Source_UrlScheme_CHROME_EXTENSION;
...
class Source_UrlInfo : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:ukm.Source.UrlInfo) */ {
 public:
  ...
  inline Source_UrlInfo* New() const PROTOBUF_FINAL { return New(NULL); }

  Source_UrlInfo* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
...
template <> struct is_proto_enum< ::ukm::Source_UrlScheme> : ::google::protobuf::internal::true_type {};
...
#endif  // PROTOBUF_ukm_2fsource_2eproto__INCLUDED
