...
class PerfDataProto_PerfBuildID : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:metrics.PerfDataProto.PerfBuildID) */ {
 public:
  ...
  #if LANG_CXX11
  void set_build_hash(::std::string&& value);
  #endif
 ...
 private:
  ...
  void set_has_pid();
  void clear_has_pid();
  void set_has_build_hash();
  void clear_has_build_hash();
  void set_has_filename_md5_prefix();
  void clear_has_filename_md5_prefix();
...
#if LANG_CXX11
inline void PerfDataProto_PerfBuildID::set_build_hash(::std::string&& value) {
  set_has_build_hash();
