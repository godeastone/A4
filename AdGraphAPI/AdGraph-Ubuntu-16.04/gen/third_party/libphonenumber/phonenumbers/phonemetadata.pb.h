...
class PhoneNumberDesc : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:i18n.phonenumbers.PhoneNumberDesc) */ {
 public:
  ...
  #if LANG_CXX11
  void set_possible_number_pattern(::std::string&& value);
  #endif
 ...
 private:
  ...
  void set_has_possible_number_pattern();
  void clear_has_possible_number_pattern();
...
#if LANG_CXX11
inline void PhoneNumberDesc::set_possible_number_pattern(::std::string&& value) {
  set_has_possible_number_pattern();
