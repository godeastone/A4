...
PerformanceMarkOptions::PerformanceMarkOptions(const PerformanceMarkOptions&) = default;

PerformanceMarkOptions& PerformanceMarkOptions::operator=(const PerformanceMarkOptions&) = default;
