...
// clang-format off
#ifndef PerformanceMeasureOptions_h
#define PerformanceMeasureOptions_h
...
class CORE_EXPORT PerformanceMeasureOptions : public IDLDictionaryBase {
 ...
 public:
  ...
  PerformanceMeasureOptions(const PerformanceMeasureOptions&);
  PerformanceMeasureOptions& operator=(const PerformanceMeasureOptions&);
...
#endif  // PerformanceMeasureOptions_h
