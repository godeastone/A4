...
PerformanceMeasureOptions::PerformanceMeasureOptions(const PerformanceMeasureOptions&) = default;

PerformanceMeasureOptions& PerformanceMeasureOptions::operator=(const PerformanceMeasureOptions&) = default;
