...
// clang-format off
#ifndef PerformanceMarkOptions_h
#define PerformanceMarkOptions_h
...
class CORE_EXPORT PerformanceMarkOptions : public IDLDictionaryBase {
 ...
 public:
  ...
  PerformanceMarkOptions(const PerformanceMarkOptions&);
  PerformanceMarkOptions& operator=(const PerformanceMarkOptions&);
...
#endif  // PerformanceMarkOptions_h
