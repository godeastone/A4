...
public:
    ...
    virtual DispatchResponse getEncodedResponse(const String& in_requestId, const String& in_encoding, Maybe<double> in_quality, Maybe<bool> in_sizeOnly, Maybe<String>* out_body, int* out_originalSize, int* out_encodedSize) = 0;
