...
// clang-format off
#ifndef MojoReadMessageResult_h
#define MojoReadMessageResult_h
...
class CORE_EXPORT MojoReadMessageResult : public IDLDictionaryBase {
 ...
 public:
  ...
  MojoReadMessageResult(const MojoReadMessageResult&);
  MojoReadMessageResult& operator=(const MojoReadMessageResult&);
