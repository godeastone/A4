...
// clang-format off
#ifndef MojoCreateDataPipeOptions_h
#define MojoCreateDataPipeOptions_h
...
class CORE_EXPORT MojoCreateDataPipeOptions : public IDLDictionaryBase {
 ...
 public:
  ...
  MojoCreateDataPipeOptions(const MojoCreateDataPipeOptions&);
  MojoCreateDataPipeOptions& operator=(const MojoCreateDataPipeOptions&);
...
#endif  // MojoCreateDataPipeOptions_h
