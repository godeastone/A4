...
// clang-format off
#ifndef MojoReadDataOptions_h
#define MojoReadDataOptions_h
...
class CORE_EXPORT MojoReadDataOptions : public IDLDictionaryBase {
 ...
 public:
  ...
  MojoReadDataOptions(const MojoReadDataOptions&);
  MojoReadDataOptions& operator=(const MojoReadDataOptions&);
