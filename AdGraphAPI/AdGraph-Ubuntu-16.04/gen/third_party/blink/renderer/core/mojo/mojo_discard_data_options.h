...
// clang-format off
#ifndef MojoDiscardDataOptions_h
#define MojoDiscardDataOptions_h
...
class CORE_EXPORT MojoDiscardDataOptions : public IDLDictionaryBase {
 ...
 public:
  ...
  MojoDiscardDataOptions(const MojoDiscardDataOptions&);
  MojoDiscardDataOptions& operator=(const MojoDiscardDataOptions&);
...
#endif  // MojoDiscardDataOptions_h
