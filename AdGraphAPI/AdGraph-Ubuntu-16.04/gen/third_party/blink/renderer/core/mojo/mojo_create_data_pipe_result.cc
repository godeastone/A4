...
MojoCreateDataPipeResult::MojoCreateDataPipeResult(const MojoCreateDataPipeResult&) = default;

MojoCreateDataPipeResult& MojoCreateDataPipeResult::operator=(const MojoCreateDataPipeResult&) = default;
