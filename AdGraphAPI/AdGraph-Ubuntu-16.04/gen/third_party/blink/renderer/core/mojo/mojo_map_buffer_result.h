...
// clang-format off
#ifndef MojoMapBufferResult_h
#define MojoMapBufferResult_h
...
class CORE_EXPORT MojoMapBufferResult : public IDLDictionaryBase {
 ...
 public:
  ...
  MojoMapBufferResult(const MojoMapBufferResult&);
  MojoMapBufferResult& operator=(const MojoMapBufferResult&);
