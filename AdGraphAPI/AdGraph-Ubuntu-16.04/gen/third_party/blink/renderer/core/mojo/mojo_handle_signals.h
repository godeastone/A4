...
// clang-format off
#ifndef MojoHandleSignals_h
#define MojoHandleSignals_h
...
class CORE_EXPORT MojoHandleSignals : public IDLDictionaryBase {
 ...
 public:
  ...
  MojoHandleSignals(const MojoHandleSignals&);
  MojoHandleSignals& operator=(const MojoHandleSignals&);
