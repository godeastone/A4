...
MojoReadMessageResult::MojoReadMessageResult(const MojoReadMessageResult&) = default;

MojoReadMessageResult& MojoReadMessageResult::operator=(const MojoReadMessageResult&) = default;
