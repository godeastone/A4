...
// clang-format off
#ifndef MojoCreateDataPipeResult_h
#define MojoCreateDataPipeResult_h
...
class CORE_EXPORT MojoCreateDataPipeResult : public IDLDictionaryBase {
 ...
 public:
  ...
  MojoCreateDataPipeResult(const MojoCreateDataPipeResult&);
  MojoCreateDataPipeResult& operator=(const MojoCreateDataPipeResult&);
...
#endif  // MojoCreateDataPipeResult_h
