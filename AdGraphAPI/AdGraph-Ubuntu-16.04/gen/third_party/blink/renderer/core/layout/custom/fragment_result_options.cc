...
FragmentResultOptions::FragmentResultOptions(const FragmentResultOptions&) = default;

FragmentResultOptions& FragmentResultOptions::operator=(const FragmentResultOptions&) = default;
