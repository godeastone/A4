...
// clang-format off
#ifndef ComputedEffectTiming_h
#define ComputedEffectTiming_h
...
class CORE_EXPORT ComputedEffectTiming : public EffectTiming {
 ...
 public:
  ...
  ComputedEffectTiming(const ComputedEffectTiming&);
  ComputedEffectTiming& operator=(const ComputedEffectTiming&);
