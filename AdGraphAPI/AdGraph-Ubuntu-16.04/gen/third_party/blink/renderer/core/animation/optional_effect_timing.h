...
// clang-format off
#ifndef OptionalEffectTiming_h
#define OptionalEffectTiming_h
...
class CORE_EXPORT OptionalEffectTiming : public IDLDictionaryBase {
 ...
 public:
  ...
  OptionalEffectTiming(const OptionalEffectTiming&);
  OptionalEffectTiming& operator=(const OptionalEffectTiming&);
