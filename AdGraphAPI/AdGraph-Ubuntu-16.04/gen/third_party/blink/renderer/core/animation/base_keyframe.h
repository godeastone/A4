...
class CORE_EXPORT BaseKeyframe : public IDLDictionaryBase {
 ...
 public:
  ...
  BaseKeyframe(const BaseKeyframe&);
  BaseKeyframe& operator=(const BaseKeyframe&);
  ...
  inline void setCompositeToNull();
...
void BaseKeyframe::setCompositeToNull() {
  composite_ = String();
}
