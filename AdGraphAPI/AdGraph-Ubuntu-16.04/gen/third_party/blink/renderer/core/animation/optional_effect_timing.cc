...
OptionalEffectTiming::OptionalEffectTiming(const OptionalEffectTiming&) = default;

OptionalEffectTiming& OptionalEffectTiming::operator=(const OptionalEffectTiming&) = default;
