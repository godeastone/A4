...
// clang-format off
#ifndef KeyframeAnimationOptions_h
#define KeyframeAnimationOptions_h
...
class CORE_EXPORT KeyframeAnimationOptions : public KeyframeEffectOptions {
 ...
 public:
  ...
  KeyframeAnimationOptions(const KeyframeAnimationOptions&);
  KeyframeAnimationOptions& operator=(const KeyframeAnimationOptions&);
...
#endif  // KeyframeAnimationOptions_h
