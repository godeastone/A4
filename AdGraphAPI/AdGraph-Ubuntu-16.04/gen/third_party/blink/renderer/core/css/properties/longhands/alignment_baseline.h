...
class AlignmentBaseline final : public Longhand {
 public:
  constexpr AlignmentBaseline() : Longhand() {}
  const char* GetPropertyName() const override { return "alignment-baseline\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("alignment-baseline\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("alignmentBaseline\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyAlignmentBaseline; }
  ...
  void ApplyValue(StyleResolverState& state, const CSSValue& value) const override {
    state.Style()->AccessSVGStyle().SetAlignmentBaseline(ToCSSIdentifierValue(value).ConvertTo<blink::EAlignmentBaseline>());
  }
};
