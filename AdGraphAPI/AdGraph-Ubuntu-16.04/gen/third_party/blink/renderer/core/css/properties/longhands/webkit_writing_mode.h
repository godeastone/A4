...
class WebkitWritingMode final : public Longhand {
 public:
  constexpr WebkitWritingMode() : Longhand() {}
  const char* GetPropertyName() const override { return "-webkit-writing-mode\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("-webkit-writing-mode\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("webkitWritingMode\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyWebkitWritingMode; }
