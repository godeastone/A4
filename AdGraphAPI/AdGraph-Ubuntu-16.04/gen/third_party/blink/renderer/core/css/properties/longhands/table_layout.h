...
class TableLayout final : public Longhand {
 public:
  constexpr TableLayout() : Longhand() {}
  const char* GetPropertyName() const override { return "table-layout\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("table-layout\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("tableLayout\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyTableLayout; }
  ...
  void ApplyValue(StyleResolverState& state, const CSSValue& value) const override {
    state.Style()->SetTableLayout(ToCSSIdentifierValue(value).ConvertTo<blink::ETableLayout>());
  }
};
