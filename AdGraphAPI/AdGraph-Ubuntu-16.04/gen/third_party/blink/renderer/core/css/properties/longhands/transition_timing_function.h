...
class TransitionTimingFunction final : public Longhand {
 public:
  constexpr TransitionTimingFunction() : Longhand() {}
  const char* GetPropertyName() const override { return "transition-timing-function\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("transition-timing-function\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("transitionTimingFunction\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyTransitionTimingFunction; }
