...
class TextAlign final : public Longhand {
 public:
  constexpr TextAlign() : Longhand() {}
  const char* GetPropertyName() const override { return "text-align\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("text-align\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("textAlign\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyTextAlign; }
