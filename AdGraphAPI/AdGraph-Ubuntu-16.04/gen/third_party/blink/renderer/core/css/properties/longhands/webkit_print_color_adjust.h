...
class WebkitPrintColorAdjust final : public Longhand {
 public:
  constexpr WebkitPrintColorAdjust() : Longhand() {}
  const char* GetPropertyName() const override { return "-webkit-print-color-adjust\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("-webkit-print-color-adjust\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("webkitPrintColorAdjust\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyWebkitPrintColorAdjust; }
  ...
  void ApplyValue(StyleResolverState& state, const CSSValue& value) const override {
    state.Style()->SetPrintColorAdjust(ToCSSIdentifierValue(value).ConvertTo<blink::EPrintColorAdjust>());
    state.Style()->SetPrintColorAdjustIsInherited(false);
  }
};
