...
class ColorInterpolation final : public Longhand {
 public:
  constexpr ColorInterpolation() : Longhand() {}
  const char* GetPropertyName() const override { return "color-interpolation\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("color-interpolation\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("colorInterpolation\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyColorInterpolation; }
  ...
  void ApplyValue(StyleResolverState& state, const CSSValue& value) const override {
    state.Style()->AccessSVGStyle().SetColorInterpolation(ToCSSIdentifierValue(value).ConvertTo<blink::EColorInterpolation>());
  }
};
