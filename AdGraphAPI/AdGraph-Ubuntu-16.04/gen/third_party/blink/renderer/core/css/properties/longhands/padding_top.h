...
class PaddingTop final : public Longhand {
 public:
  constexpr PaddingTop() : Longhand() {}
  const char* GetPropertyName() const override { return "padding-top\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("padding-top\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("paddingTop\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyPaddingTop; }
