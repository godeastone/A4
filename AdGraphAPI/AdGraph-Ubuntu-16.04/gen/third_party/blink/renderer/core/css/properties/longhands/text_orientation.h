...
class TextOrientation final : public Longhand {
 public:
  constexpr TextOrientation() : Longhand() {}
  const char* GetPropertyName() const override { return "text-orientation\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("text-orientation\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("textOrientation\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyTextOrientation; }
