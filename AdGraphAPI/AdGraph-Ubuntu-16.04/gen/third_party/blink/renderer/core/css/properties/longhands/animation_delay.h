...
class AnimationDelay final : public Longhand {
 public:
  constexpr AnimationDelay() : Longhand() {}
  const char* GetPropertyName() const override { return "animation-delay\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("animation-delay\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("animationDelay\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyAnimationDelay; }
