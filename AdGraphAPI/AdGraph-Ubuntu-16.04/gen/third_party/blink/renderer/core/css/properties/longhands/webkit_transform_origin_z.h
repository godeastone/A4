...
class WebkitTransformOriginZ final : public Longhand {
 public:
  constexpr WebkitTransformOriginZ() : Longhand() {}
  const char* GetPropertyName() const override { return "-webkit-transform-origin-z\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("-webkit-transform-origin-z\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("webkitTransformOriginZ\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyWebkitTransformOriginZ; }
