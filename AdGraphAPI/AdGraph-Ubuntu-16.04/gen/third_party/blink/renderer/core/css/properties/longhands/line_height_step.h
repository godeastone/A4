...
class LineHeightStep final : public Longhand {
 public:
  constexpr LineHeightStep() : Longhand() {}
  bool IsEnabled() const override {
    return RuntimeEnabledFeatures::CSSSnapSizeEnabled();
  }
  const char* GetPropertyName() const override { return "line-height-step\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("line-height-step\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("lineHeightStep\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyLineHeightStep; }
