...
class FontSize final : public Longhand {
 public:
  constexpr FontSize() : Longhand() {}
  const char* GetPropertyName() const override { return "font-size\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("font-size\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("fontSize\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyFontSize; }
