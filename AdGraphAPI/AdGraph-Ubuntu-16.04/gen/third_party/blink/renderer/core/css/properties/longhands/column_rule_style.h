...
class ColumnRuleStyle final : public Longhand {
 public:
  constexpr ColumnRuleStyle() : Longhand() {}
  const char* GetPropertyName() const override { return "column-rule-style\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("column-rule-style\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("columnRuleStyle\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyColumnRuleStyle; }
  ...
  void ApplyValue(StyleResolverState& state, const CSSValue& value) const override {
    state.Style()->SetColumnRuleStyle(ToCSSIdentifierValue(value).ConvertTo<blink::EBorderStyle>());
  }
};
