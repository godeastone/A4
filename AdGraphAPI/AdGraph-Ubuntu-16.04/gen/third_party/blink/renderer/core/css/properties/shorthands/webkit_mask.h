...
class WebkitMask final : public Shorthand {
 public:
  constexpr WebkitMask() : Shorthand() {}
  const char* GetPropertyName() const override { return "-webkit-mask\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("-webkit-mask\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("webkitMask\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyWebkitMask; }
