...
class Transform final : public Longhand {
 public:
  constexpr Transform() : Longhand() {}
  const char* GetPropertyName() const override { return "transform\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("transform\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("transform\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyTransform; }
