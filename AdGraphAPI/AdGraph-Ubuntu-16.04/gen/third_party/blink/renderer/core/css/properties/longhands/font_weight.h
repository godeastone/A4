...
class FontWeight final : public Longhand {
 public:
  constexpr FontWeight() : Longhand() {}
  const char* GetPropertyName() const override { return "font-weight\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("font-weight\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("fontWeight\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyFontWeight; }
