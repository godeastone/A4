...
class WebkitBorderHorizontalSpacing final : public Longhand {
 public:
  constexpr WebkitBorderHorizontalSpacing() : Longhand() {}
  const char* GetPropertyName() const override { return "-webkit-border-horizontal-spacing\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("-webkit-border-horizontal-spacing\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("webkitBorderHorizontalSpacing\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyWebkitBorderHorizontalSpacing; }
