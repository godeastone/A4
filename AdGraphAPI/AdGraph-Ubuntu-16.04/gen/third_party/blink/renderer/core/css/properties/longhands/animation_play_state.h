...
class AnimationPlayState final : public Longhand {
 public:
  constexpr AnimationPlayState() : Longhand() {}
  const char* GetPropertyName() const override { return "animation-play-state\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("animation-play-state\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("animationPlayState\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyAnimationPlayState; }
