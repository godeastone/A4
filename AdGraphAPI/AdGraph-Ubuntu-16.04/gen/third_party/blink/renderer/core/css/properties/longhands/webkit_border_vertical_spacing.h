...
class WebkitBorderVerticalSpacing final : public Longhand {
 public:
  constexpr WebkitBorderVerticalSpacing() : Longhand() {}
  const char* GetPropertyName() const override { return "-webkit-border-vertical-spacing\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("-webkit-border-vertical-spacing\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("webkitBorderVerticalSpacing\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyWebkitBorderVerticalSpacing; }
