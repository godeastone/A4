...
class OutlineWidth final : public Longhand {
 public:
  constexpr OutlineWidth() : Longhand() {}
  const char* GetPropertyName() const override { return "outline-width\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("outline-width\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("outlineWidth\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyOutlineWidth; }
