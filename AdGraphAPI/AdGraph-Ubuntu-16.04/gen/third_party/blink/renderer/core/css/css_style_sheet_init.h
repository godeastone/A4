...
// clang-format off
#ifndef CSSStyleSheetInit_h
#define CSSStyleSheetInit_h
...
class CORE_EXPORT CSSStyleSheetInit : public IDLDictionaryBase {
 ...
 public:
  ...
  CSSStyleSheetInit(const CSSStyleSheetInit&);
  CSSStyleSheetInit& operator=(const CSSStyleSheetInit&);
