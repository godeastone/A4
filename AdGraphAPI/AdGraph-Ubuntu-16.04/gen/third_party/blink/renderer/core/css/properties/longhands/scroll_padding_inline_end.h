...
class ScrollPaddingInlineEnd final : public Longhand {
 public:
  constexpr ScrollPaddingInlineEnd() : Longhand() {}
  bool IsEnabled() const override {
    return RuntimeEnabledFeatures::CSSScrollSnapPointsEnabled();
  }
  const char* GetPropertyName() const override { return "scroll-padding-inline-end\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("scroll-padding-inline-end\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("scrollPaddingInlineEnd\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyScrollPaddingInlineEnd; }
