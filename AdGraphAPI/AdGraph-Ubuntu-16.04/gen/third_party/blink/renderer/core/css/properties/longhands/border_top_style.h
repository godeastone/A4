...
class BorderTopStyle final : public Longhand {
 public:
  constexpr BorderTopStyle() : Longhand() {}
  const char* GetPropertyName() const override { return "border-top-style\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("border-top-style\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("borderTopStyle\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyBorderTopStyle; }
  ...
  void ApplyValue(StyleResolverState& state, const CSSValue& value) const override {
    state.Style()->SetBorderTopStyle(ToCSSIdentifierValue(value).ConvertTo<blink::EBorderStyle>());
  }
};
