...
class BorderBottomStyle final : public Longhand {
 public:
  constexpr BorderBottomStyle() : Longhand() {}
  const char* GetPropertyName() const override { return "border-bottom-style\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("border-bottom-style\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("borderBottomStyle\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyBorderBottomStyle; }
  ...
  void ApplyValue(StyleResolverState& state, const CSSValue& value) const override {
    state.Style()->SetBorderBottomStyle(ToCSSIdentifierValue(value).ConvertTo<blink::EBorderStyle>());
  }
};
