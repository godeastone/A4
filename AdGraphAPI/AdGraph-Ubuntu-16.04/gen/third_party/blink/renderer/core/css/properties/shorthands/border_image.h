...
class BorderImage final : public Shorthand {
 public:
  constexpr BorderImage() : Shorthand() {}
  const char* GetPropertyName() const override { return "border-image\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("border-image\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("borderImage\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyBorderImage; }
