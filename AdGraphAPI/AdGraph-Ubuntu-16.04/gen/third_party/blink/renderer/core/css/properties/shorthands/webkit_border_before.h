...
class WebkitBorderBefore final : public Shorthand {
 public:
  constexpr WebkitBorderBefore() : Shorthand() {}
  const char* GetPropertyName() const override { return "-webkit-border-before\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("-webkit-border-before\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("webkitBorderBefore\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyWebkitBorderBefore; }
