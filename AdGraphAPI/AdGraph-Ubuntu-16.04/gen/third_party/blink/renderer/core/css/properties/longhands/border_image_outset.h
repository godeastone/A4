...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_IMAGE_OUTSET_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_IMAGE_OUTSET_H_
...
// Implements the 'border-image-outset' CSS property
// See src/third_party/WebKit/Source/core/css/properties/README.md
class BorderImageOutset final : public Longhand {
 public:
  constexpr BorderImageOutset() : Longhand() {}
  const char* GetPropertyName() const override { return "border-image-outset\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("border-image-outset\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("borderImageOutset\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyBorderImageOutset; }
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_IMAGE_OUTSET_H_
