...
class ScrollSnapAlign final : public Longhand {
 public:
  constexpr ScrollSnapAlign() : Longhand() {}
  bool IsEnabled() const override {
    return RuntimeEnabledFeatures::CSSScrollSnapPointsEnabled();
  }
  const char* GetPropertyName() const override { return "scroll-snap-align\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("scroll-snap-align\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("scrollSnapAlign\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyScrollSnapAlign; }
