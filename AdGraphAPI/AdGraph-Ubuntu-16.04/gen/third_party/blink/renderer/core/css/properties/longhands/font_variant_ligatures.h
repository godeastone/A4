...
class FontVariantLigatures final : public Longhand {
 public:
  constexpr FontVariantLigatures() : Longhand() {}
  const char* GetPropertyName() const override { return "font-variant-ligatures\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("font-variant-ligatures\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("fontVariantLigatures\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyFontVariantLigatures; }
