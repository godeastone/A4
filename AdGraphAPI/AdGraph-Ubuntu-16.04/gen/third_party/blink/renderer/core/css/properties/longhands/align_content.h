...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_ALIGN_CONTENT_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_ALIGN_CONTENT_H_
...
class AlignContent final : public Longhand {
 public:
  constexpr AlignContent() : Longhand() {}
  ...
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("alignContent\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyAlignContent; }
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_ALIGN_CONTENT_H_
