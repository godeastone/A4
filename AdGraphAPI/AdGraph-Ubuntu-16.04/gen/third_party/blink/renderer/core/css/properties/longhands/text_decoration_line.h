...
class TextDecorationLine final : public Longhand {
 public:
  constexpr TextDecorationLine() : Longhand() {}
  const char* GetPropertyName() const override { return "text-decoration-line\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("text-decoration-line\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("textDecorationLine\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyTextDecorationLine; }
