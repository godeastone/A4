...
class WebkitBorderAfterStyle final : public Longhand {
 public:
  constexpr WebkitBorderAfterStyle() : Longhand() {}
  const char* GetPropertyName() const override { return "-webkit-border-after-style\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("-webkit-border-after-style\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("webkitBorderAfterStyle\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyWebkitBorderAfterStyle; }
