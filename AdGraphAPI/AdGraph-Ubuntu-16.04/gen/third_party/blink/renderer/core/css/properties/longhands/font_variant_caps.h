...
class FontVariantCaps final : public Longhand {
 public:
  constexpr FontVariantCaps() : Longhand() {}
  const char* GetPropertyName() const override { return "font-variant-caps\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("font-variant-caps\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("fontVariantCaps\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyFontVariantCaps; }
