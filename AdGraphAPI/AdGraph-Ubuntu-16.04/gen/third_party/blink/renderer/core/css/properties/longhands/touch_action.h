...
class TouchAction final : public Longhand {
 public:
  constexpr TouchAction() : Longhand() {}
  const char* GetPropertyName() const override { return "touch-action\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("touch-action\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("touchAction\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyTouchAction; }
