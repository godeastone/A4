...
class Orientation final : public Longhand {
 public:
  constexpr Orientation() : Longhand() {}
  const char* GetPropertyName() const override { return "orientation\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("orientation\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("orientation\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyOrientation; }
