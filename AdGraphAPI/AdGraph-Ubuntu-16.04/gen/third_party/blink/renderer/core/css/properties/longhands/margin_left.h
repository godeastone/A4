...
class MarginLeft final : public Longhand {
 public:
  constexpr MarginLeft() : Longhand() {}
  const char* GetPropertyName() const override { return "margin-left\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("margin-left\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("marginLeft\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyMarginLeft; }
