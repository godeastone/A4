...
class FontDisplay final : public Longhand {
 public:
  constexpr FontDisplay() : Longhand() {}
  const char* GetPropertyName() const override { return "font-display\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("font-display\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("fontDisplay\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyFontDisplay; }
