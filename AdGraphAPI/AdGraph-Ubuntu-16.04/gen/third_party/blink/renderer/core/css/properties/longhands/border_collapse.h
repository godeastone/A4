...
class BorderCollapse final : public Longhand {
 public:
  constexpr BorderCollapse() : Longhand() {}
  const char* GetPropertyName() const override { return "border-collapse\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("border-collapse\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("borderCollapse\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyBorderCollapse; }
  ...
  void ApplyValue(StyleResolverState& state, const CSSValue& value) const override {
    state.Style()->SetBorderCollapse(ToCSSIdentifierValue(value).ConvertTo<blink::EBorderCollapse>());
    state.Style()->SetBorderCollapseIsInherited(false);
  }
};
