...
// clang-format off
#ifndef CSSMatrixComponentOptions_h
#define CSSMatrixComponentOptions_h
...
class CORE_EXPORT CSSMatrixComponentOptions : public IDLDictionaryBase {
 ...
 public:
  ...
  CSSMatrixComponentOptions(const CSSMatrixComponentOptions&);
  CSSMatrixComponentOptions& operator=(const CSSMatrixComponentOptions&);
...
#endif  // CSSMatrixComponentOptions_h
