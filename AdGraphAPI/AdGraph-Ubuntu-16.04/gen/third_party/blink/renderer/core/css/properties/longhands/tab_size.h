...
class TabSize final : public Longhand {
 public:
  constexpr TabSize() : Longhand() {}
  const char* GetPropertyName() const override { return "tab-size\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("tab-size\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("tabSize\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyTabSize; }
