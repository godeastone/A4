...
class WebkitPerspectiveOriginX final : public Longhand {
 public:
  constexpr WebkitPerspectiveOriginX() : Longhand() {}
  const char* GetPropertyName() const override { return "-webkit-perspective-origin-x\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("-webkit-perspective-origin-x\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("webkitPerspectiveOriginX\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyWebkitPerspectiveOriginX; }
