...
class ColorInterpolationFilters final : public Longhand {
 public:
  constexpr ColorInterpolationFilters() : Longhand() {}
  const char* GetPropertyName() const override { return "color-interpolation-filters\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("color-interpolation-filters\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("colorInterpolationFilters\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyColorInterpolationFilters; }
  ...
  void ApplyValue(StyleResolverState& state, const CSSValue& value) const override {
    state.Style()->AccessSVGStyle().SetColorInterpolationFilters(ToCSSIdentifierValue(value).ConvertTo<blink::EColorInterpolation>());
  }
};
