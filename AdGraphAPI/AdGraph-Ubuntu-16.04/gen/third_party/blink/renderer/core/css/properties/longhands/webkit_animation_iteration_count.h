...
class WebkitAnimationIterationCount final : public CSSUnresolvedProperty {
 public:
  ...
  const char* GetPropertyName() const override { return "-webkit-animation-iteration-count\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("-webkit-animation-iteration-count\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("webkitAnimationIterationCount\0");
  }
};
