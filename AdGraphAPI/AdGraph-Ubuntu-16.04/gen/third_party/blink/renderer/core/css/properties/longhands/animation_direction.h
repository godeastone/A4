...
class AnimationDirection final : public Longhand {
 public:
  constexpr AnimationDirection() : Longhand() {}
  const char* GetPropertyName() const override { return "animation-direction\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("animation-direction\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("animationDirection\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyAnimationDirection; }
