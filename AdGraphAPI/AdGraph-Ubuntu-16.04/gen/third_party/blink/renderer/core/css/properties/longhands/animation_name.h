...
class AnimationName final : public Longhand {
 public:
  constexpr AnimationName() : Longhand() {}
  const char* GetPropertyName() const override { return "animation-name\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("animation-name\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("animationName\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyAnimationName; }
