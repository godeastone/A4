...
class FontVariantEastAsian final : public Longhand {
 public:
  constexpr FontVariantEastAsian() : Longhand() {}
  const char* GetPropertyName() const override { return "font-variant-east-asian\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("font-variant-east-asian\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("fontVariantEastAsian\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyFontVariantEastAsian; }
