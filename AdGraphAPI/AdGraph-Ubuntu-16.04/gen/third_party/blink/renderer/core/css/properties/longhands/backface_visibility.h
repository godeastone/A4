...
class BackfaceVisibility final : public Longhand {
 public:
  constexpr BackfaceVisibility() : Longhand() {}
  const char* GetPropertyName() const override { return "backface-visibility\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("backface-visibility\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("backfaceVisibility\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyBackfaceVisibility; }
  ...
  void ApplyValue(StyleResolverState& state, const CSSValue& value) const override {
    state.Style()->SetBackfaceVisibility(ToCSSIdentifierValue(value).ConvertTo<blink::EBackfaceVisibility>());
  }
};
