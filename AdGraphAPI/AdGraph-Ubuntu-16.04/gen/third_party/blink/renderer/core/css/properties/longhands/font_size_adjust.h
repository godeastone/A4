...
class FontSizeAdjust final : public Longhand {
 public:
  constexpr FontSizeAdjust() : Longhand() {}
  bool IsEnabled() const override {
    return RuntimeEnabledFeatures::CSSFontSizeAdjustEnabled();
  }
  const char* GetPropertyName() const override { return "font-size-adjust\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("font-size-adjust\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("fontSizeAdjust\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyFontSizeAdjust; }
