...
class StopOpacity final : public Longhand {
 public:
  constexpr StopOpacity() : Longhand() {}
  const char* GetPropertyName() const override { return "stop-opacity\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("stop-opacity\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("stopOpacity\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyStopOpacity; }
