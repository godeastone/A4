...
class WebkitMarginBeforeCollapse final : public Longhand {
 public:
  constexpr WebkitMarginBeforeCollapse() : Longhand() {}
  const char* GetPropertyName() const override { return "-webkit-margin-before-collapse\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("-webkit-margin-before-collapse\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("webkitMarginBeforeCollapse\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyWebkitMarginBeforeCollapse; }
