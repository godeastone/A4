...
class WebkitMaskBoxImage final : public Shorthand {
 public:
  constexpr WebkitMaskBoxImage() : Shorthand() {}
  const char* GetPropertyName() const override { return "-webkit-mask-box-image\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("-webkit-mask-box-image\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("webkitMaskBoxImage\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyWebkitMaskBoxImage; }
