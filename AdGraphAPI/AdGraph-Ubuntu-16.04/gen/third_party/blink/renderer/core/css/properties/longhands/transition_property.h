...
class TransitionProperty final : public Longhand {
 public:
  constexpr TransitionProperty() : Longhand() {}
  const char* GetPropertyName() const override { return "transition-property\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("transition-property\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("transitionProperty\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyTransitionProperty; }
