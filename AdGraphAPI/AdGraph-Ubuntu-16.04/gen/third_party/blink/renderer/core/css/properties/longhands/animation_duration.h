...
class AnimationDuration final : public Longhand {
 public:
  constexpr AnimationDuration() : Longhand() {}
  const char* GetPropertyName() const override { return "animation-duration\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("animation-duration\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("animationDuration\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyAnimationDuration; }
