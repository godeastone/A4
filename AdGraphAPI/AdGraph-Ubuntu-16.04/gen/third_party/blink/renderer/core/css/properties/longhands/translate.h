...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_TRANSLATE_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_TRANSLATE_H_
...
// Implements the 'translate' CSS property
// See src/third_party/WebKit/Source/core/css/properties/README.md
class Translate final : public Longhand {
 public:
  constexpr Translate() : Longhand() {}
  bool IsEnabled() const override {
    return RuntimeEnabledFeatures::CSSIndependentTransformPropertiesEnabled();
  }
  const char* GetPropertyName() const override { return "translate\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("translate\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("translate\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyTranslate; }
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_TRANSLATE_H_
