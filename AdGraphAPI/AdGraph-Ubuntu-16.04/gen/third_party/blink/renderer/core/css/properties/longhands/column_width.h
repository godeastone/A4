...
class ColumnWidth final : public Longhand {
 public:
  constexpr ColumnWidth() : Longhand() {}
  const char* GetPropertyName() const override { return "column-width\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("column-width\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("columnWidth\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyColumnWidth; }
