...
class Cx final : public Longhand {
 public:
  constexpr Cx() : Longhand() {}
  const char* GetPropertyName() const override { return "cx\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("cx\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("cx\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyCx; }
