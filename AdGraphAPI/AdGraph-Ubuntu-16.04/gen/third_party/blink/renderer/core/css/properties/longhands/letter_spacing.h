...
class LetterSpacing final : public Longhand {
 public:
  constexpr LetterSpacing() : Longhand() {}
  const char* GetPropertyName() const override { return "letter-spacing\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("letter-spacing\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("letterSpacing\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyLetterSpacing; }
