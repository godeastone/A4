...
class TextShadow final : public Longhand {
 public:
  constexpr TextShadow() : Longhand() {}
  const char* GetPropertyName() const override { return "text-shadow\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("text-shadow\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("textShadow\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyTextShadow; }
