...
class PaddingRight final : public Longhand {
 public:
  constexpr PaddingRight() : Longhand() {}
  const char* GetPropertyName() const override { return "padding-right\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("padding-right\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("paddingRight\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyPaddingRight; }
