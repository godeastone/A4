...
class TextCombineUpright final : public Longhand {
 public:
  constexpr TextCombineUpright() : Longhand() {}
  const char* GetPropertyName() const override { return "text-combine-upright\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("text-combine-upright\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("textCombineUpright\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyTextCombineUpright; }
