...
class WebkitLogicalWidth final : public Longhand {
 public:
  constexpr WebkitLogicalWidth() : Longhand() {}
  const char* GetPropertyName() const override { return "-webkit-logical-width\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("-webkit-logical-width\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("webkitLogicalWidth\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyWebkitLogicalWidth; }
