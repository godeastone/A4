...
class ScrollPaddingTop final : public Longhand {
 public:
  constexpr ScrollPaddingTop() : Longhand() {}
  bool IsEnabled() const override {
    return RuntimeEnabledFeatures::CSSScrollSnapPointsEnabled();
  }
  const char* GetPropertyName() const override { return "scroll-padding-top\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("scroll-padding-top\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("scrollPaddingTop\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyScrollPaddingTop; }
