...
class FontVariationSettings final : public Longhand {
 public:
  constexpr FontVariationSettings() : Longhand() {}
  const char* GetPropertyName() const override { return "font-variation-settings\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("font-variation-settings\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("fontVariationSettings\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyFontVariationSettings; }
