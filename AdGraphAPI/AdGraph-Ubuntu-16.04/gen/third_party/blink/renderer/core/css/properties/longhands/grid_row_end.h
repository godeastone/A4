...
class GridRowEnd final : public Longhand {
 public:
  constexpr GridRowEnd() : Longhand() {}
  const char* GetPropertyName() const override { return "grid-row-end\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("grid-row-end\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("gridRowEnd\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyGridRowEnd; }
