...
class PageBreakInside final : public Shorthand {
 public:
  constexpr PageBreakInside() : Shorthand() {}
  const char* GetPropertyName() const override { return "page-break-inside\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("page-break-inside\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("pageBreakInside\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyPageBreakInside; }
