...
class WebkitBorderEnd final : public Shorthand {
 public:
  constexpr WebkitBorderEnd() : Shorthand() {}
  const char* GetPropertyName() const override { return "-webkit-border-end\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("-webkit-border-end\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("webkitBorderEnd\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyWebkitBorderEnd; }
