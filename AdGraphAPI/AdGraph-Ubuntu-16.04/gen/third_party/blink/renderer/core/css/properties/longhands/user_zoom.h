...
class UserZoom final : public Longhand {
 public:
  constexpr UserZoom() : Longhand() {}
  const char* GetPropertyName() const override { return "user-zoom\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("user-zoom\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("userZoom\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyUserZoom; }
