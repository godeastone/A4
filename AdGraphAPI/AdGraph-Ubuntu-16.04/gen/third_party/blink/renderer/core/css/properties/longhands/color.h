...
class Color final : public Longhand {
 public:
  constexpr Color() : Longhand() {}
  const char* GetPropertyName() const override { return "color\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("color\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("color\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyColor; }
