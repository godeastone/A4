...
class GridAutoRows final : public Longhand {
 public:
  constexpr GridAutoRows() : Longhand() {}
  const char* GetPropertyName() const override { return "grid-auto-rows\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("grid-auto-rows\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("gridAutoRows\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyGridAutoRows; }
