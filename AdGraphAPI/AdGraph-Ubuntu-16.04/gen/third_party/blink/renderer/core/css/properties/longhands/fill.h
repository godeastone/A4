...
class Fill final : public Longhand {
 public:
  constexpr Fill() : Longhand() {}
  const char* GetPropertyName() const override { return "fill\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("fill\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("fill\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyFill; }
