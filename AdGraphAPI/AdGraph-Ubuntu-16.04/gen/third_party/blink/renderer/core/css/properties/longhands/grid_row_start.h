...
class GridRowStart final : public Longhand {
 public:
  constexpr GridRowStart() : Longhand() {}
  const char* GetPropertyName() const override { return "grid-row-start\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("grid-row-start\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("gridRowStart\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyGridRowStart; }
