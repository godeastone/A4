...
class ColumnRuleWidth final : public Longhand {
 public:
  constexpr ColumnRuleWidth() : Longhand() {}
  const char* GetPropertyName() const override { return "column-rule-width\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("column-rule-width\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("columnRuleWidth\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyColumnRuleWidth; }
