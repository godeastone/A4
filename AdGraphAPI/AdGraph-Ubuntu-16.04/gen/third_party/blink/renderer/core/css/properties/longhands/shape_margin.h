...
class ShapeMargin final : public Longhand {
 public:
  constexpr ShapeMargin() : Longhand() {}
  const char* GetPropertyName() const override { return "shape-margin\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("shape-margin\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("shapeMargin\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyShapeMargin; }
