...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_IMAGE_WIDTH_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_IMAGE_WIDTH_H_
...
// Implements the 'border-image-width' CSS property
// See src/third_party/WebKit/Source/core/css/properties/README.md
class BorderImageWidth final : public Longhand {
 public:
  constexpr BorderImageWidth() : Longhand() {}
  const char* GetPropertyName() const override { return "border-image-width\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("border-image-width\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("borderImageWidth\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyBorderImageWidth; }
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_CSS_PROPERTIES_LONGHAND_BORDER_IMAGE_WIDTH_H_
