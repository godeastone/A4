...
class WillChange final : public Longhand {
 public:
  constexpr WillChange() : Longhand() {}
  const char* GetPropertyName() const override { return "will-change\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("will-change\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("willChange\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyWillChange; }
