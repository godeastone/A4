...
class BackdropFilter final : public Longhand {
 public:
  constexpr BackdropFilter() : Longhand() {}
  bool IsEnabled() const override {
    return RuntimeEnabledFeatures::CSSBackdropFilterEnabled();
  }
  const char* GetPropertyName() const override { return "backdrop-filter\0"; }
  const WTF::AtomicString& GetPropertyNameAtomicString() const override {
    static const WTF::AtomicString& name = WTF::AtomicString("backdrop-filter\0");
    return name;
  }
  const WTF::String GetJSPropertyName() const override {
    return WTF::String("backdropFilter\0");
  }
  CSSPropertyID PropertyID() const override { return CSSPropertyBackdropFilter; }
