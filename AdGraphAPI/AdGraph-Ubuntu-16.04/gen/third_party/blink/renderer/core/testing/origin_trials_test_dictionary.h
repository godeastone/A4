...
// clang-format off
#ifndef OriginTrialsTestDictionary_h
#define OriginTrialsTestDictionary_h
...
class OriginTrialsTestDictionary : public IDLDictionaryBase {
 ...
 public:
  ...
  OriginTrialsTestDictionary(const OriginTrialsTestDictionary&);
  OriginTrialsTestDictionary& operator=(const OriginTrialsTestDictionary&);
...
#endif  // OriginTrialsTestDictionary_h
