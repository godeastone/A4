...
// clang-format off
#ifndef GamepadEffectParameters_h
#define GamepadEffectParameters_h
...
class MODULES_EXPORT GamepadEffectParameters : public IDLDictionaryBase {
 ...
 public:
  ...
  GamepadEffectParameters(const GamepadEffectParameters&);
  GamepadEffectParameters& operator=(const GamepadEffectParameters&);
...
#endif  // GamepadEffectParameters_h
