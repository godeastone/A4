...
BackgroundFetchEventInit::BackgroundFetchEventInit(const BackgroundFetchEventInit&) = default;

BackgroundFetchEventInit& BackgroundFetchEventInit::operator=(const BackgroundFetchEventInit&) = default;
