...
// clang-format off
#ifndef DeviceOrientationEventInit_h
#define DeviceOrientationEventInit_h
...
class MODULES_EXPORT DeviceOrientationEventInit : public EventInit {
 ...
 public:
  ...
  DeviceOrientationEventInit(const DeviceOrientationEventInit&);
  DeviceOrientationEventInit& operator=(const DeviceOrientationEventInit&);
...
#endif  // DeviceOrientationEventInit_h
