...
// clang-format off
#ifndef RTCDataChannelInit_h
#define RTCDataChannelInit_h
...
class MODULES_EXPORT RTCDataChannelInit : public IDLDictionaryBase {
 ...
 public:
  ...
  RTCDataChannelInit(const RTCDataChannelInit&);
  RTCDataChannelInit& operator=(const RTCDataChannelInit&);
