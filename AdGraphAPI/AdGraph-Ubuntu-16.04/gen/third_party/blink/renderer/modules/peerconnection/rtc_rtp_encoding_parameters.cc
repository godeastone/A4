...
RTCRtpEncodingParameters::RTCRtpEncodingParameters(const RTCRtpEncodingParameters&) = default;

RTCRtpEncodingParameters& RTCRtpEncodingParameters::operator=(const RTCRtpEncodingParameters&) = default;
