...
// clang-format off
#ifndef RTCDtlsFingerprint_h
#define RTCDtlsFingerprint_h
...
class MODULES_EXPORT RTCDtlsFingerprint : public IDLDictionaryBase {
 ...
 public:
  ...
  RTCDtlsFingerprint(const RTCDtlsFingerprint&);
  RTCDtlsFingerprint& operator=(const RTCDtlsFingerprint&);
