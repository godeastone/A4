...
// clang-format off
#ifndef ExtendableCookieChangeEventInit_h
#define ExtendableCookieChangeEventInit_h
...
class MODULES_EXPORT ExtendableCookieChangeEventInit : public ExtendableEventInit {
 ...
 public:
  ...
  ExtendableCookieChangeEventInit(const ExtendableCookieChangeEventInit&);
  ExtendableCookieChangeEventInit& operator=(const ExtendableCookieChangeEventInit&);
...
#endif  // ExtendableCookieChangeEventInit_h
