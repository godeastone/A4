...
// clang-format off
#ifndef BluetoothLEScanFilterInit_h
#define BluetoothLEScanFilterInit_h
...
class MODULES_EXPORT BluetoothLEScanFilterInit : public IDLDictionaryBase {
 ...
 public:
  ...
  BluetoothLEScanFilterInit(const BluetoothLEScanFilterInit&);
  BluetoothLEScanFilterInit& operator=(const BluetoothLEScanFilterInit&);
...
#endif  // BluetoothLEScanFilterInit_h
