...
BluetoothLEScanFilterInit::BluetoothLEScanFilterInit(const BluetoothLEScanFilterInit&) = default;

BluetoothLEScanFilterInit& BluetoothLEScanFilterInit::operator=(const BluetoothLEScanFilterInit&) = default;
