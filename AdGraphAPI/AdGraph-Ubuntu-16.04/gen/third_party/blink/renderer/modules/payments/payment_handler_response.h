...
// clang-format off
#ifndef PaymentHandlerResponse_h
#define PaymentHandlerResponse_h
...
class MODULES_EXPORT PaymentHandlerResponse : public IDLDictionaryBase {
 ...
 public:
  ...
  PaymentHandlerResponse(const PaymentHandlerResponse&);
  PaymentHandlerResponse& operator=(const PaymentHandlerResponse&);
...
#endif  // PaymentHandlerResponse_h
