...
class MODULES_EXPORT AndroidPayMethodData : public IDLDictionaryBase {
 ...
 public:
  ...
  bool hasPaymentMethodTokenizationParameters() const { return has_payment_method_tokenization_parameters_; }
  const AndroidPayTokenization& paymentMethodTokenizationParameters() const {
    DCHECK(has_payment_method_tokenization_parameters_);
 ...
 private:
  ...
  bool has_payment_method_tokenization_parameters_ = false;
  ...
  AndroidPayTokenization payment_method_tokenization_parameters_;
