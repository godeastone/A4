...
// clang-format off
#ifndef PaymentInstrument_h
#define PaymentInstrument_h
...
class MODULES_EXPORT PaymentInstrument : public IDLDictionaryBase {
 ...
 public:
  ...
  PaymentInstrument(const PaymentInstrument&);
  PaymentInstrument& operator=(const PaymentInstrument&);
  ...
  const HeapVector<ImageObject>& icons() const {
    DCHECK(has_icons_);
    return icons_;
  }
  void setIcons(const HeapVector<ImageObject>&);
