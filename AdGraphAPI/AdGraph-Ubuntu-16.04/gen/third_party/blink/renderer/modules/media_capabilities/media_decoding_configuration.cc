...
MediaDecodingConfiguration::MediaDecodingConfiguration(const MediaDecodingConfiguration&) = default;

MediaDecodingConfiguration& MediaDecodingConfiguration::operator=(const MediaDecodingConfiguration&) = default;
