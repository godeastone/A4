...
// clang-format off
#ifndef MediaEncodingConfiguration_h
#define MediaEncodingConfiguration_h
...
class MODULES_EXPORT MediaEncodingConfiguration : public MediaConfiguration {
 ...
 public:
  ...
  MediaEncodingConfiguration(const MediaEncodingConfiguration&);
  MediaEncodingConfiguration& operator=(const MediaEncodingConfiguration&);
...
#endif  // MediaEncodingConfiguration_h
