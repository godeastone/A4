...
// clang-format off
#ifndef XRWebGLLayerInit_h
#define XRWebGLLayerInit_h
...
class MODULES_EXPORT XRWebGLLayerInit : public IDLDictionaryBase {
 ...
 public:
  ...
  XRWebGLLayerInit(const XRWebGLLayerInit&);
  XRWebGLLayerInit& operator=(const XRWebGLLayerInit&);
