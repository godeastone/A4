...
// clang-format off
#ifndef CollectedClientData_h
#define CollectedClientData_h
...
class MODULES_EXPORT CollectedClientData : public IDLDictionaryBase {
 ...
 public:
  ...
  CollectedClientData(const CollectedClientData&);
  CollectedClientData& operator=(const CollectedClientData&);
