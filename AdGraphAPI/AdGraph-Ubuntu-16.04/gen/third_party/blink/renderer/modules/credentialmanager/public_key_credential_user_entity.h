...
// clang-format off
#ifndef PublicKeyCredentialUserEntity_h
#define PublicKeyCredentialUserEntity_h
...
class MODULES_EXPORT PublicKeyCredentialUserEntity : public PublicKeyCredentialEntity {
 ...
 public:
  ...
  PublicKeyCredentialUserEntity(const PublicKeyCredentialUserEntity&);
  PublicKeyCredentialUserEntity& operator=(const PublicKeyCredentialUserEntity&);
...
#endif  // PublicKeyCredentialUserEntity_h
