...
CableAuthenticationData::CableAuthenticationData(const CableAuthenticationData&) = default;

CableAuthenticationData& CableAuthenticationData::operator=(const CableAuthenticationData&) = default;
