...
// clang-format off
#ifndef PublicKeyCredentialParameters_h
#define PublicKeyCredentialParameters_h
...
class MODULES_EXPORT PublicKeyCredentialParameters : public IDLDictionaryBase {
 ...
 public:
  ...
  PublicKeyCredentialParameters(const PublicKeyCredentialParameters&);
  PublicKeyCredentialParameters& operator=(const PublicKeyCredentialParameters&);
...
#endif  // PublicKeyCredentialParameters_h
