...
// clang-format off
#ifndef FederatedCredentialInit_h
#define FederatedCredentialInit_h
...
class MODULES_EXPORT FederatedCredentialInit : public CredentialData {
 ...
 public:
  ...
  FederatedCredentialInit(const FederatedCredentialInit&);
  FederatedCredentialInit& operator=(const FederatedCredentialInit&);
...
#endif  // FederatedCredentialInit_h
