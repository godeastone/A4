...
// clang-format off
#ifndef PublicKeyCredentialRpEntity_h
#define PublicKeyCredentialRpEntity_h
...
class MODULES_EXPORT PublicKeyCredentialRpEntity : public PublicKeyCredentialEntity {
 ...
 public:
  ...
  PublicKeyCredentialRpEntity(const PublicKeyCredentialRpEntity&);
  PublicKeyCredentialRpEntity& operator=(const PublicKeyCredentialRpEntity&);
...
#endif  // PublicKeyCredentialRpEntity_h
