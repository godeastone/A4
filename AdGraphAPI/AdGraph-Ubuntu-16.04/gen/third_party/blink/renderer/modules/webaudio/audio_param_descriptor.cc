...
AudioParamDescriptor::AudioParamDescriptor(const AudioParamDescriptor&) = default;

AudioParamDescriptor& AudioParamDescriptor::operator=(const AudioParamDescriptor&) = default;
