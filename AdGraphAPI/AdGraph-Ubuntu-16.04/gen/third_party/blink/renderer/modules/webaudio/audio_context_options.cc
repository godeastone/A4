...
AudioContextOptions::AudioContextOptions(const AudioContextOptions&) = default;

AudioContextOptions& AudioContextOptions::operator=(const AudioContextOptions&) = default;
