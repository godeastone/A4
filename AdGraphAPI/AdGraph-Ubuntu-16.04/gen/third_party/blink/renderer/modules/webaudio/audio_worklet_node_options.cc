...
AudioWorkletNodeOptions::AudioWorkletNodeOptions(const AudioWorkletNodeOptions&) = default;

AudioWorkletNodeOptions& AudioWorkletNodeOptions::operator=(const AudioWorkletNodeOptions&) = default;
