...
// clang-format off
#ifndef OfflineAudioContextOptions_h
#define OfflineAudioContextOptions_h
...
class MODULES_EXPORT OfflineAudioContextOptions : public IDLDictionaryBase {
 ...
 public:
  ...
  OfflineAudioContextOptions(const OfflineAudioContextOptions&);
  OfflineAudioContextOptions& operator=(const OfflineAudioContextOptions&);
...
#endif  // OfflineAudioContextOptions_h
