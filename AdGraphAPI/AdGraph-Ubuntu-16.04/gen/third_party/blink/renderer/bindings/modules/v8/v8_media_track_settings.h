...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, MediaTrackSettings& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<MediaTrackSettings> : public NativeValueTraitsBase<MediaTrackSettings> {
  MODULES_EXPORT static MediaTrackSettings NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
