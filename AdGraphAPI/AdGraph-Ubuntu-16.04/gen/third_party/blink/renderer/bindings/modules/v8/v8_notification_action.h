...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, NotificationAction& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<NotificationAction> : public NativeValueTraitsBase<NotificationAction> {
  MODULES_EXPORT static NotificationAction NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
