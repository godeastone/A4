...
static const v8::Eternal<v8::Name>* eternalV8BeforeInstallPromptEventInitKeys(v8::Isolate* isolate) {
...
void V8BeforeInstallPromptEventInit::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, BeforeInstallPromptEventInit& impl, ExceptionState& exceptionState) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8BeforeInstallPromptEventInitKeys(isolate);
  v8::TryCatch block(isolate);
  v8::Local<v8::Context> context = isolate->GetCurrentContext();
  v8::Local<v8::Value> platformsValue;
  if (!v8Object->Get(context, keys[0].Get(isolate)).ToLocal(&platformsValue)) {
  ...
  if (platformsValue.IsEmpty() || platformsValue->IsUndefined()) {
    ...
    Vector<String> platformsCppValue = NativeValueTraits<IDLSequence<IDLString>>::NativeValue(isolate, platformsValue, exceptionState);
    if (exceptionState.HadException())
      return;
    impl.setPlatforms(platformsCppValue);
  }
}
...
bool toV8BeforeInstallPromptEventInit(const BeforeInstallPromptEventInit& impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  v8::Local<v8::Context> context = isolate->GetCurrentContext();
  v8::Local<v8::Value> platformsValue;
  bool platformsHasValueOrDefault = false;
  if (impl.hasPlatforms()) {
    platformsValue = ToV8(impl.platforms(), creationContext, isolate);
    platformsHasValueOrDefault = true;
  }
  if (platformsHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[0].Get(isolate), platformsValue))) {
    return false;
  }
