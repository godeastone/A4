...
template <>
struct NativeValueTraits<WebGLShaderPrecisionFormat> : public NativeValueTraitsBase<WebGLShaderPrecisionFormat> {
  MODULES_EXPORT static WebGLShaderPrecisionFormat* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static WebGLShaderPrecisionFormat* NullValue() { return nullptr; }
};
