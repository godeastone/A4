...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, SpeechRecognitionErrorInit& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<SpeechRecognitionErrorInit> : public NativeValueTraitsBase<SpeechRecognitionErrorInit> {
  MODULES_EXPORT static SpeechRecognitionErrorInit NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
