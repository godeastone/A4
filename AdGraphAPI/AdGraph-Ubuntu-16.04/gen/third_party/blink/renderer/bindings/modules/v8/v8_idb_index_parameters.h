...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, IDBIndexParameters& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<IDBIndexParameters> : public NativeValueTraitsBase<IDBIndexParameters> {
  MODULES_EXPORT static IDBIndexParameters NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
