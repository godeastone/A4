...
template <>
struct NativeValueTraits<Credential> : public NativeValueTraitsBase<Credential> {
  MODULES_EXPORT static Credential* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static Credential* NullValue() { return nullptr; }
};
