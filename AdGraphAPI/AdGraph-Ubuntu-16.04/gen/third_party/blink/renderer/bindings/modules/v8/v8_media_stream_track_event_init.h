...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, MediaStreamTrackEventInit& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<MediaStreamTrackEventInit> : public NativeValueTraitsBase<MediaStreamTrackEventInit> {
  MODULES_EXPORT static MediaStreamTrackEventInit NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
