...
template <>
struct NativeValueTraits<USBIsochronousOutTransferPacket> : public NativeValueTraitsBase<USBIsochronousOutTransferPacket> {
  MODULES_EXPORT static USBIsochronousOutTransferPacket* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static USBIsochronousOutTransferPacket* NullValue() { return nullptr; }
};
