...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, PushSubscriptionOptionsInit& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<PushSubscriptionOptionsInit> : public NativeValueTraitsBase<PushSubscriptionOptionsInit> {
  MODULES_EXPORT static PushSubscriptionOptionsInit NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
