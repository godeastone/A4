...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, CacheQueryOptions& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<CacheQueryOptions> : public NativeValueTraitsBase<CacheQueryOptions> {
  MODULES_EXPORT static CacheQueryOptions NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
