...
template <>
struct NativeValueTraits<OffscreenCanvasRenderingContext2D> : public NativeValueTraitsBase<OffscreenCanvasRenderingContext2D> {
  MODULES_EXPORT static OffscreenCanvasRenderingContext2D* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static OffscreenCanvasRenderingContext2D* NullValue() { return nullptr; }
};
