...
v8::Maybe<void> V8NavigatorUserMediaErrorCallback::Invoke(ScriptWrappable* callback_this_value, DOMExceptionOrOverconstrainedError error) {
  ...
  v8::Local<v8::Value> v8_error = ToV8(error, argument_creation_context, GetIsolate());
  v8::Local<v8::Value> argv[] = { v8_error };
...
void V8NavigatorUserMediaErrorCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, DOMExceptionOrOverconstrainedError error) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      Invoke(callback_this_value, error);
  // An exception if any is killed with the v8::TryCatch above.
  ALLOW_UNUSED_LOCAL(maybe_result);
}

MODULES_TEMPLATE_EXPORT
v8::Maybe<void> V8PersistentCallbackFunction<V8NavigatorUserMediaErrorCallback>::Invoke(ScriptWrappable* callback_this_value, DOMExceptionOrOverconstrainedError error) {
  return Proxy()->Invoke(
      callback_this_value, error);
}

MODULES_TEMPLATE_EXPORT
void V8PersistentCallbackFunction<V8NavigatorUserMediaErrorCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, DOMExceptionOrOverconstrainedError error) {
