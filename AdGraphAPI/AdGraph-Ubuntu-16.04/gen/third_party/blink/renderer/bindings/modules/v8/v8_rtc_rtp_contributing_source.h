...
// clang-format off
#ifndef V8RTCRtpContributingSource_h
#define V8RTCRtpContributingSource_h
...
class V8RTCRtpContributingSource {
  STATIC_ONLY(V8RTCRtpContributingSource);
 public:
  MODULES_EXPORT static bool hasInstance(v8::Local<v8::Value>, v8::Isolate*);
  static v8::Local<v8::Object> findInstanceInPrototypeChain(v8::Local<v8::Value>, v8::Isolate*);
  MODULES_EXPORT static v8::Local<v8::FunctionTemplate> domTemplate(v8::Isolate*, const DOMWrapperWorld&);
  static RTCRtpContributingSource* ToImpl(v8::Local<v8::Object> object) {
    return ToScriptWrappable(object)->ToImpl<RTCRtpContributingSource>();
  }
  MODULES_EXPORT static RTCRtpContributingSource* ToImplWithTypeCheck(v8::Isolate*, v8::Local<v8::Value>);
...
struct NativeValueTraits<RTCRtpContributingSource> : public NativeValueTraitsBase<RTCRtpContributingSource> {
  ...
  MODULES_EXPORT static RTCRtpContributingSource* NullValue() { return nullptr; }
};
...
#endif  // V8RTCRtpContributingSource_h
