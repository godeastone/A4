...
class V8MediaEncryptedEvent {
 ...
 public:
  ...
  MODULES_EXPORT static void initDataTypeAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void initDataAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
...
template <>
struct NativeValueTraits<MediaEncryptedEvent> : public NativeValueTraitsBase<MediaEncryptedEvent> {
  MODULES_EXPORT static MediaEncryptedEvent* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static MediaEncryptedEvent* NullValue() { return nullptr; }
};
