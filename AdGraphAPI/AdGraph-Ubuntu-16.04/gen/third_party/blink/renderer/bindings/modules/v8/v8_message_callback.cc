...
v8::Maybe<void> V8MessageCallback::Invoke(ScriptWrappable* callback_this_value, const NFCMessage& message) {
  ...
  v8::Local<v8::Value> v8_message = ToV8(message, argument_creation_context, GetIsolate());
  v8::Local<v8::Value> argv[] = { v8_message };
...
void V8MessageCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, const NFCMessage& message) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      Invoke(callback_this_value, message);
  // An exception if any is killed with the v8::TryCatch above.
  ALLOW_UNUSED_LOCAL(maybe_result);
}

MODULES_TEMPLATE_EXPORT
v8::Maybe<void> V8PersistentCallbackFunction<V8MessageCallback>::Invoke(ScriptWrappable* callback_this_value, const NFCMessage& message) {
  return Proxy()->Invoke(
      callback_this_value, message);
}

MODULES_TEMPLATE_EXPORT
void V8PersistentCallbackFunction<V8MessageCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, const NFCMessage& message) {
