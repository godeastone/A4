...
#endif
const WrapperTypeInfo V8IDBObservation::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& IDBObservation::wrapper_type_info_ = V8IDBObservation::wrapperTypeInfo;
...
static const V8DOMConfiguration::AccessorConfiguration V8IDBObservationAccessors[] = {
    { "type", V8IDBObservation::typeAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "key", V8IDBObservation::keyAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "value", V8IDBObservation::valueAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
};
...
static void installV8IDBObservationTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8IDBObservation::wrapperTypeInfo.interface_name, v8::Local<v8::FunctionTemplate>(), V8IDBObservation::internalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8IDBObservationAccessors, arraysize(V8IDBObservationAccessors));
...
IDBObservation* NativeValueTraits<IDBObservation>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  IDBObservation* nativeValue = V8IDBObservation::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
