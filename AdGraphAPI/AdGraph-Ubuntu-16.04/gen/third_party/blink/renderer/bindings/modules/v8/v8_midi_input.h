...
class V8MIDIInput {
 ...
 public:
  ...
  MODULES_EXPORT static void onmidimessageAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void onmidimessageAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
...
template <>
struct NativeValueTraits<MIDIInput> : public NativeValueTraitsBase<MIDIInput> {
  MODULES_EXPORT static MIDIInput* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static MIDIInput* NullValue() { return nullptr; }
};
