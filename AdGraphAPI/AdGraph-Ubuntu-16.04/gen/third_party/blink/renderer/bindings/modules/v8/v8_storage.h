...
template <>
struct NativeValueTraits<Storage> : public NativeValueTraitsBase<Storage> {
  MODULES_EXPORT static Storage* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static Storage* NullValue() { return nullptr; }
};
