...
v8::Maybe<void> V8SQLStatementCallback::handleEvent(ScriptWrappable* callback_this_value, SQLTransaction* transaction, SQLResultSet* resultSet) {
  ...
  v8::Local<v8::Value> transactionHandle = ToV8(transaction, argument_creation_context, GetIsolate());
  v8::Local<v8::Value> resultSetHandle = ToV8(resultSet, argument_creation_context, GetIsolate());
...
void V8SQLStatementCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, SQLTransaction* transaction, SQLResultSet* resultSet) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      handleEvent(callback_this_value, transaction, resultSet);
  // An exception if any is killed with the v8::TryCatch above.
  ALLOW_UNUSED_LOCAL(maybe_result);
}

MODULES_EXTERN_TEMPLATE_EXPORT
v8::Maybe<void> V8PersistentCallbackInterface<V8SQLStatementCallback>::handleEvent(ScriptWrappable* callback_this_value, SQLTransaction* transaction, SQLResultSet* resultSet) {
  return Proxy()->handleEvent(
      callback_this_value, transaction, resultSet);
}

MODULES_EXTERN_TEMPLATE_EXPORT
void V8PersistentCallbackInterface<V8SQLStatementCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, SQLTransaction* transaction, SQLResultSet* resultSet) {
