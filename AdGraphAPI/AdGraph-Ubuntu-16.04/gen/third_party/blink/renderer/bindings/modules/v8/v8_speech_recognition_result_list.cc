...
const WrapperTypeInfo& SpeechRecognitionResultList::wrapper_type_info_ = V8SpeechRecognitionResultList::wrapperTypeInfo;
...
static void itemMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "SpeechRecognitionResultList", "item");
...
void V8SpeechRecognitionResultList::indexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  SpeechRecognitionResultListV8Internal::indexedPropertyDescriptor(index, info);
}

void V8SpeechRecognitionResultList::indexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8Value, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
static const V8DOMConfiguration::AccessorConfiguration V8SpeechRecognitionResultListAccessors[] = {
    { "length", V8SpeechRecognitionResultList::lengthAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
};
...
static void installV8SpeechRecognitionResultListTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8SpeechRecognitionResultList::wrapperTypeInfo.interface_name, v8::Local<v8::FunctionTemplate>(), V8SpeechRecognitionResultList::internalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8SpeechRecognitionResultListAccessors, arraysize(V8SpeechRecognitionResultListAccessors));
  V8DOMConfiguration::InstallMethods(
      isolate, world, instanceTemplate, prototypeTemplate, interfaceTemplate,
      signature, V8SpeechRecognitionResultListMethods, arraysize(V8SpeechRecognitionResultListMethods));
...
SpeechRecognitionResultList* NativeValueTraits<SpeechRecognitionResultList>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  SpeechRecognitionResultList* nativeValue = V8SpeechRecognitionResultList::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
