...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, AudioBufferOptions& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<AudioBufferOptions> : public NativeValueTraitsBase<AudioBufferOptions> {
  MODULES_EXPORT static AudioBufferOptions NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
