...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, StereoPannerOptions& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<StereoPannerOptions> : public NativeValueTraitsBase<StereoPannerOptions> {
  MODULES_EXPORT static StereoPannerOptions NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
