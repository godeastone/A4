...
class MODULES_EXPORT V8FileCallback final : public CallbackInterfaceBase {
 public:
  static V8FileCallback* Create(v8::Local<v8::Object> callback_object) {
    return new V8FileCallback(callback_object);
  }
  ...
  v8::Maybe<void> handleEvent(ScriptWrappable* callback_this_value, File* file) WARN_UNUSED_RESULT;
  ...
  void InvokeAndReportException(ScriptWrappable* callback_this_value, File* file);
...
template <>
class MODULES_TEMPLATE_CLASS_EXPORT V8PersistentCallbackInterface<V8FileCallback> final : public V8PersistentCallbackInterfaceBase {
