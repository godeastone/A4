...
template <>
struct NativeValueTraits<WebGLActiveInfo> : public NativeValueTraitsBase<WebGLActiveInfo> {
  MODULES_EXPORT static WebGLActiveInfo* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static WebGLActiveInfo* NullValue() { return nullptr; }
};
