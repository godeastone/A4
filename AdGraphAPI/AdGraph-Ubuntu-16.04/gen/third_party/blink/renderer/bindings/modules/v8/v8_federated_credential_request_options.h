...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, FederatedCredentialRequestOptions& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<FederatedCredentialRequestOptions> : public NativeValueTraitsBase<FederatedCredentialRequestOptions> {
  MODULES_EXPORT static FederatedCredentialRequestOptions NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
