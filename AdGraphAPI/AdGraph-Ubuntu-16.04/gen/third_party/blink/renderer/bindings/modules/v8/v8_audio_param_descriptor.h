...
// clang-format off
#ifndef V8AudioParamDescriptor_h
#define V8AudioParamDescriptor_h
...
class V8AudioParamDescriptor {
 public:
  MODULES_EXPORT static void ToImpl(v8::Isolate*, v8::Local<v8::Value>, AudioParamDescriptor&, ExceptionState&);
};
...
#endif  // V8AudioParamDescriptor_h
