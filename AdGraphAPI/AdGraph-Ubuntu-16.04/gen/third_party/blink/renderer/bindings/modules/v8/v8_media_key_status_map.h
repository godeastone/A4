...
template <>
struct NativeValueTraits<MediaKeyStatusMap> : public NativeValueTraitsBase<MediaKeyStatusMap> {
  MODULES_EXPORT static MediaKeyStatusMap* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static MediaKeyStatusMap* NullValue() { return nullptr; }
};
