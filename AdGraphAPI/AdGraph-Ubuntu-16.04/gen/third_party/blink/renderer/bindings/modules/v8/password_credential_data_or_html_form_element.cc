...
const PasswordCredentialData& PasswordCredentialDataOrHTMLFormElement::GetAsPasswordCredentialData() const {
  DCHECK(IsPasswordCredentialData());
  return password_credential_data_;
}

void PasswordCredentialDataOrHTMLFormElement::SetPasswordCredentialData(const PasswordCredentialData& value) {
  DCHECK(IsNull());
  password_credential_data_ = value;
  type_ = SpecificType::kPasswordCredentialData;
}

PasswordCredentialDataOrHTMLFormElement PasswordCredentialDataOrHTMLFormElement::FromPasswordCredentialData(const PasswordCredentialData& value) {
  PasswordCredentialDataOrHTMLFormElement container;
...
void V8PasswordCredentialDataOrHTMLFormElement::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, PasswordCredentialDataOrHTMLFormElement& impl, UnionTypeConversionMode conversionMode, ExceptionState& exceptionState) {
  if (v8Value.IsEmpty())
    return;
  ...
  if (IsUndefinedOrNull(v8Value)) {
    PasswordCredentialData cppValue;
    V8PasswordCredentialData::ToImpl(isolate, v8Value, cppValue, exceptionState);
    if (exceptionState.HadException())
      return;
    impl.SetPasswordCredentialData(cppValue);
    return;
  }

  if (V8HTMLFormElement::hasInstance(v8Value, isolate)) {
    HTMLFormElement* cppValue = V8HTMLFormElement::ToImpl(v8::Local<v8::Object>::Cast(v8Value));
    impl.SetHTMLFormElement(cppValue);
    return;
  }
  ...
  exceptionState.ThrowTypeError("The provided value is not of type '(PasswordCredentialData or HTMLFormElement)'");
}
...
PasswordCredentialDataOrHTMLFormElement NativeValueTraits<PasswordCredentialDataOrHTMLFormElement>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  PasswordCredentialDataOrHTMLFormElement impl;
  V8PasswordCredentialDataOrHTMLFormElement::ToImpl(isolate, value, impl, UnionTypeConversionMode::kNotNullable, exceptionState);
  return impl;
}
