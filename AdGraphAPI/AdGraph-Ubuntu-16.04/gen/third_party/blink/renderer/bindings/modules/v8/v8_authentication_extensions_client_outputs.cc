...
void V8AuthenticationExtensionsClientOutputs::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, AuthenticationExtensionsClientOutputs& impl, ExceptionState& exceptionState) {
  ...
  if (appidValue.IsEmpty() || appidValue->IsUndefined()) {
    ...
    bool appidCppValue = NativeValueTraits<IDLBoolean>::NativeValue(isolate, appidValue, exceptionState);
...
bool toV8AuthenticationExtensionsClientOutputs(const AuthenticationExtensionsClientOutputs& impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (impl.hasAppid()) {
    appidValue = v8::Boolean::New(isolate, impl.appid());
...
AuthenticationExtensionsClientOutputs NativeValueTraits<AuthenticationExtensionsClientOutputs>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  AuthenticationExtensionsClientOutputs impl;
  V8AuthenticationExtensionsClientOutputs::ToImpl(isolate, value, impl, exceptionState);
  return impl;
}
