...
// clang-format off
#ifndef V8AuthenticationExtensionsClientInputs_h
#define V8AuthenticationExtensionsClientInputs_h
...
class V8AuthenticationExtensionsClientInputs {
 public:
  MODULES_EXPORT static void ToImpl(v8::Isolate*, v8::Local<v8::Value>, AuthenticationExtensionsClientInputs&, ExceptionState&);
};
...
#endif  // V8AuthenticationExtensionsClientInputs_h
