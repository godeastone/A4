...
#endif
const WrapperTypeInfo V8FileEntrySync::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& FileEntrySync::wrapper_type_info_ = V8FileEntrySync::wrapperTypeInfo;
...
static void fileMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "FileEntrySync", "file");
...
static void createWriterMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "FileEntrySync", "createWriter");
...
static void installV8FileEntrySyncTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8FileEntrySync::wrapperTypeInfo.interface_name, V8EntrySync::domTemplate(isolate, world), V8FileEntrySync::internalFieldCount);
  ...
  V8DOMConfiguration::InstallMethods(
      ...
      signature, V8FileEntrySyncMethods, arraysize(V8FileEntrySyncMethods));
...
FileEntrySync* NativeValueTraits<FileEntrySync>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  FileEntrySync* nativeValue = V8FileEntrySync::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
