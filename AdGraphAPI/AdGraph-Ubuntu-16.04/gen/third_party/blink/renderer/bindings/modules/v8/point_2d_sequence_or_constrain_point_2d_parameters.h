...
// clang-format off
#ifndef Point2DSequenceOrConstrainPoint2DParameters_h
#define Point2DSequenceOrConstrainPoint2DParameters_h
...
class MODULES_EXPORT Point2DSequenceOrConstrainPoint2DParameters final {
 ...
 public:
  ...
  const ConstrainPoint2DParameters& GetAsConstrainPoint2DParameters() const;
  void SetConstrainPoint2DParameters(const ConstrainPoint2DParameters&);
  static Point2DSequenceOrConstrainPoint2DParameters FromConstrainPoint2DParameters(const ConstrainPoint2DParameters&);

  bool IsPoint2DSequence() const { return type_ == SpecificType::kPoint2DSequence; }
  const HeapVector<Point2D>& GetAsPoint2DSequence() const;
  void SetPoint2DSequence(const HeapVector<Point2D>&);
  static Point2DSequenceOrConstrainPoint2DParameters FromPoint2DSequence(const HeapVector<Point2D>&);
 ...
 private:
  ...
  ConstrainPoint2DParameters constrain_point_2d_parameters_;
  HeapVector<Point2D> point_2d_sequence_;
...
#endif  // Point2DSequenceOrConstrainPoint2DParameters_h
