...
v8::Maybe<void> V8FileWriterCallback::handleEvent(ScriptWrappable* callback_this_value, FileWriter* fileWriter) {
  ...
  v8::Local<v8::Value> fileWriterHandle = ToV8(fileWriter, argument_creation_context, GetIsolate());
...
void V8FileWriterCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, FileWriter* fileWriter) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      handleEvent(callback_this_value, fileWriter);
  // An exception if any is killed with the v8::TryCatch above.
  ALLOW_UNUSED_LOCAL(maybe_result);
}

MODULES_EXTERN_TEMPLATE_EXPORT
v8::Maybe<void> V8PersistentCallbackInterface<V8FileWriterCallback>::handleEvent(ScriptWrappable* callback_this_value, FileWriter* fileWriter) {
  return Proxy()->handleEvent(
      callback_this_value, fileWriter);
}

MODULES_EXTERN_TEMPLATE_EXPORT
void V8PersistentCallbackInterface<V8FileWriterCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, FileWriter* fileWriter) {
