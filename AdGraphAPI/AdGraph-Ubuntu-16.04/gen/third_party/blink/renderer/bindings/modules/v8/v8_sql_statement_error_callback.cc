...
v8::Maybe<bool> V8SQLStatementErrorCallback::handleEvent(ScriptWrappable* callback_this_value, SQLTransaction* transaction, SQLError* error) {
...
v8::Maybe<bool> V8PersistentCallbackInterface<V8SQLStatementErrorCallback>::handleEvent(ScriptWrappable* callback_this_value, SQLTransaction* transaction, SQLError* error) {
  return Proxy()->handleEvent(
      callback_this_value, transaction, error);
}
