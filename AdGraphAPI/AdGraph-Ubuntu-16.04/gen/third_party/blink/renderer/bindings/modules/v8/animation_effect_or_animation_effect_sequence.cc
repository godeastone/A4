...
void V8AnimationEffectOrAnimationEffectSequence::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, AnimationEffectOrAnimationEffectSequence& impl, UnionTypeConversionMode conversionMode, ExceptionState& exceptionState) {
  if (v8Value.IsEmpty())
    return;
  ...
  if (V8AnimationEffect::hasInstance(v8Value, isolate)) {
    AnimationEffect* cppValue = V8AnimationEffect::ToImpl(v8::Local<v8::Object>::Cast(v8Value));
    impl.SetAnimationEffect(cppValue);
    return;
  }

  if (HasCallableIteratorSymbol(isolate, v8Value, exceptionState)) {
    HeapVector<Member<AnimationEffect>> cppValue = NativeValueTraits<IDLSequence<AnimationEffect>>::NativeValue(isolate, v8Value, exceptionState);
    if (exceptionState.HadException())
      return;
    impl.SetAnimationEffectSequence(cppValue);
    return;
  }

  exceptionState.ThrowTypeError("The provided value is not of type '(AnimationEffect or sequence<AnimationEffect>)'");
}
...
AnimationEffectOrAnimationEffectSequence NativeValueTraits<AnimationEffectOrAnimationEffectSequence>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  AnimationEffectOrAnimationEffectSequence impl;
  V8AnimationEffectOrAnimationEffectSequence::ToImpl(isolate, value, impl, UnionTypeConversionMode::kNotNullable, exceptionState);
  return impl;
}
