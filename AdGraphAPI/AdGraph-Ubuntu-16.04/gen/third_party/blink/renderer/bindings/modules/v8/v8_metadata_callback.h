...
class MODULES_EXPORT V8MetadataCallback final : public CallbackInterfaceBase {
 public:
  static V8MetadataCallback* Create(v8::Local<v8::Object> callback_object) {
    return new V8MetadataCallback(callback_object);
  }
  ...
  v8::Maybe<void> handleEvent(ScriptWrappable* callback_this_value, Metadata* metadata) WARN_UNUSED_RESULT;
  ...
  void InvokeAndReportException(ScriptWrappable* callback_this_value, Metadata* metadata);
...
template <>
class MODULES_TEMPLATE_CLASS_EXPORT V8PersistentCallbackInterface<V8MetadataCallback> final : public V8PersistentCallbackInterfaceBase {
  using V8CallbackInterface = V8MetadataCallback;
...
// V8MetadataCallback is designed to be used with wrapper-tracing.
...
Persistent<V8MetadataCallback> WrapPersistent(V8MetadataCallback*) = delete;
