...
// clang-format off
#ifndef RequestOrUSVStringOrRequestOrUSVStringSequence_h
#define RequestOrUSVStringOrRequestOrUSVStringSequence_h
...
#endif  // RequestOrUSVStringOrRequestOrUSVStringSequence_h
