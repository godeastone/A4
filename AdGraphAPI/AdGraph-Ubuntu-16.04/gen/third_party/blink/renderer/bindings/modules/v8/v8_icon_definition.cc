...
static const v8::Eternal<v8::Name>* eternalV8IconDefinitionKeys(v8::Isolate* isolate) {
...
void V8IconDefinition::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, IconDefinition& impl, ExceptionState& exceptionState) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8IconDefinitionKeys(isolate);
  ...
  if (srcValue.IsEmpty() || srcValue->IsUndefined()) {
    ...
    V8StringResource<> srcCppValue = srcValue;
    if (!srcCppValue.Prepare(exceptionState))
      return;
...
v8::Local<v8::Value> IconDefinition::ToV8Impl(v8::Local<v8::Object> creationContext, v8::Isolate* isolate) const {
  v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
  if (!toV8IconDefinition(*this, v8Object, creationContext, isolate))
    return v8::Undefined(isolate);
  return v8Object;
}

bool toV8IconDefinition(const IconDefinition& impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  const v8::Eternal<v8::Name>* keys = eternalV8IconDefinitionKeys(isolate);
  v8::Local<v8::Context> context = isolate->GetCurrentContext();
  v8::Local<v8::Value> sizesValue;
...
IconDefinition NativeValueTraits<IconDefinition>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  IconDefinition impl;
  V8IconDefinition::ToImpl(isolate, value, impl, exceptionState);
  return impl;
}
