...
template <>
struct NativeValueTraits<EXTColorBufferFloat> : public NativeValueTraitsBase<EXTColorBufferFloat> {
  MODULES_EXPORT static EXTColorBufferFloat* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static EXTColorBufferFloat* NullValue() { return nullptr; }
};
