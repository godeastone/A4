...
#endif
const WrapperTypeInfo V8RTCDataChannelEvent::wrapperTypeInfo = {
    gin::kEmbedderBlink,
    V8RTCDataChannelEvent::domTemplate,
    nullptr,
    "RTCDataChannelEvent",
...
const WrapperTypeInfo& RTCDataChannelEvent::wrapper_type_info_ = V8RTCDataChannelEvent::wrapperTypeInfo;
...
static void channelAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  V8PrivateProperty::GetSymbol(
      info.GetIsolate(), "KeepAlive#RTCDataChannelEvent#channel")
      .Set(holder, v8Value);
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_RTCDataChannelEvent_ConstructorCallback");

  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kConstructionContext, "RTCDataChannelEvent");
...
void V8RTCDataChannelEvent::channelAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
...
void V8RTCDataChannelEvent::isTrustedAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_RTCDataChannelEvent_isTrusted_Getter");

  RTCDataChannelEventV8Internal::isTrustedAttributeGetter(info);
}

static const V8DOMConfiguration::AccessorConfiguration V8RTCDataChannelEventAccessors[] = {
    { "channel", V8RTCDataChannelEvent::channelAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "isTrusted", V8RTCDataChannelEvent::isTrustedAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::DontDelete | v8::ReadOnly), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
};
...
static void installV8RTCDataChannelEventTemplate(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
    v8::Local<v8::FunctionTemplate> interfaceTemplate) {
  // Initialize the interface object's template.
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8RTCDataChannelEvent::wrapperTypeInfo.interface_name, V8Event::domTemplate(isolate, world), V8RTCDataChannelEvent::internalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8RTCDataChannelEventAccessors, arraysize(V8RTCDataChannelEventAccessors));

  // Custom signature

  V8RTCDataChannelEvent::InstallRuntimeEnabledFeaturesOnTemplate(
      isolate, world, interfaceTemplate);
}

void V8RTCDataChannelEvent::InstallRuntimeEnabledFeaturesOnTemplate(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
...
RTCDataChannelEvent* NativeValueTraits<RTCDataChannelEvent>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  RTCDataChannelEvent* nativeValue = V8RTCDataChannelEvent::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
