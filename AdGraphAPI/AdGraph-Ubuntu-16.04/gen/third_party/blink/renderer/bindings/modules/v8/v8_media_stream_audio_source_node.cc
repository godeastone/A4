...
#endif
const WrapperTypeInfo V8MediaStreamAudioSourceNode::wrapperTypeInfo = {
    gin::kEmbedderBlink,
    V8MediaStreamAudioSourceNode::domTemplate,
    nullptr,
...
const WrapperTypeInfo& MediaStreamAudioSourceNode::wrapper_type_info_ = V8MediaStreamAudioSourceNode::wrapperTypeInfo;
...
static void mediaStreamAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  V8PrivateProperty::GetSymbol(
      info.GetIsolate(), "KeepAlive#MediaStreamAudioSourceNode#mediaStream")
      .Set(holder, v8Value);
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaStreamAudioSourceNode_ConstructorCallback");

  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kConstructionContext, "MediaStreamAudioSourceNode");
...
void V8MediaStreamAudioSourceNode::mediaStreamAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
...
static const V8DOMConfiguration::AccessorConfiguration V8MediaStreamAudioSourceNodeAccessors[] = {
    { "mediaStream", V8MediaStreamAudioSourceNode::mediaStreamAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
};
...
void V8MediaStreamAudioSourceNode::constructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  UseCounter::Count(CurrentExecutionContext(info.GetIsolate()), WebFeature::kV8MediaStreamAudioSourceNode_Constructor);
...
static void installV8MediaStreamAudioSourceNodeTemplate(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
    v8::Local<v8::FunctionTemplate> interfaceTemplate) {
  // Initialize the interface object's template.
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8MediaStreamAudioSourceNode::wrapperTypeInfo.interface_name, V8AudioNode::domTemplate(isolate, world), V8MediaStreamAudioSourceNode::internalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8MediaStreamAudioSourceNodeAccessors, arraysize(V8MediaStreamAudioSourceNodeAccessors));

  // Custom signature

  V8MediaStreamAudioSourceNode::InstallRuntimeEnabledFeaturesOnTemplate(
      isolate, world, interfaceTemplate);
}

void V8MediaStreamAudioSourceNode::InstallRuntimeEnabledFeaturesOnTemplate(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
...
MediaStreamAudioSourceNode* NativeValueTraits<MediaStreamAudioSourceNode>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  MediaStreamAudioSourceNode* nativeValue = V8MediaStreamAudioSourceNode::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
