...
#endif
const WrapperTypeInfo V8TextDecoder::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& TextDecoder::wrapper_type_info_ = V8TextDecoder::wrapperTypeInfo;
...
static void decodeMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "TextDecoder", "decode");
  ...
  V8ArrayBufferOrArrayBufferView::ToImpl(info.GetIsolate(), info[0], input, UnionTypeConversionMode::kNotNullable, exceptionState);
  if (exceptionState.HadException())
    return;
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kConstructionContext, "TextDecoder");
...
void V8TextDecoder::decodeMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  UseCounter::Count(CurrentExecutionContext(info.GetIsolate()), WebFeature::kTextDecoderDecode);
  TextDecoderV8Internal::decodeMethod(info);
}

static const V8DOMConfiguration::AccessorConfiguration V8TextDecoderAccessors[] = {
    { "encoding", V8TextDecoder::encodingAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "fatal", V8TextDecoder::fatalAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "ignoreBOM", V8TextDecoder::ignoreBOMAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
};
...
void V8TextDecoder::constructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  UseCounter::Count(CurrentExecutionContext(info.GetIsolate()), WebFeature::kTextDecoderConstructor);
...
static void installV8TextDecoderTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8TextDecoder::wrapperTypeInfo.interface_name, v8::Local<v8::FunctionTemplate>(), V8TextDecoder::internalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8TextDecoderAccessors, arraysize(V8TextDecoderAccessors));
  V8DOMConfiguration::InstallMethods(
      isolate, world, instanceTemplate, prototypeTemplate, interfaceTemplate,
      signature, V8TextDecoderMethods, arraysize(V8TextDecoderMethods));
...
TextDecoder* NativeValueTraits<TextDecoder>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  TextDecoder* nativeValue = V8TextDecoder::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
