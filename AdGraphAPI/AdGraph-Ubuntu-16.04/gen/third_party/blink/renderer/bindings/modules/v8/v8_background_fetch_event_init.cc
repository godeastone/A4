...
void V8BackgroundFetchEventInit::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, BackgroundFetchEventInit& impl, ExceptionState& exceptionState) {
  if (IsUndefinedOrNull(v8Value)) {
    exceptionState.ThrowTypeError("Missing required member(s): id.");
    return;
  }
  if (!v8Value->IsObject()) {
...
BackgroundFetchEventInit NativeValueTraits<BackgroundFetchEventInit>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  BackgroundFetchEventInit impl;
  V8BackgroundFetchEventInit::ToImpl(isolate, value, impl, exceptionState);
  return impl;
}
