...
v8::Maybe<void> V8StorageErrorCallback::Invoke(ScriptWrappable* callback_this_value, DOMError* error) {
...
void V8StorageErrorCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, DOMError* error) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8StorageErrorCallback>::Invoke(ScriptWrappable* callback_this_value, DOMError* error) {
  return Proxy()->Invoke(
      callback_this_value, error);
}

MODULES_TEMPLATE_EXPORT
void V8PersistentCallbackFunction<V8StorageErrorCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, DOMError* error) {
