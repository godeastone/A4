...
// clang-format off
#ifndef PasswordCredentialDataOrHTMLFormElement_h
#define PasswordCredentialDataOrHTMLFormElement_h
...
class MODULES_EXPORT PasswordCredentialDataOrHTMLFormElement final {
 ...
 public:
  ...
  const PasswordCredentialData& GetAsPasswordCredentialData() const;
  void SetPasswordCredentialData(const PasswordCredentialData&);
  static PasswordCredentialDataOrHTMLFormElement FromPasswordCredentialData(const PasswordCredentialData&);
 ...
 private:
  ...
  PasswordCredentialData password_credential_data_;
...
#endif  // PasswordCredentialDataOrHTMLFormElement_h
