...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, FaceDetectorOptions& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<FaceDetectorOptions> : public NativeValueTraitsBase<FaceDetectorOptions> {
  MODULES_EXPORT static FaceDetectorOptions NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
