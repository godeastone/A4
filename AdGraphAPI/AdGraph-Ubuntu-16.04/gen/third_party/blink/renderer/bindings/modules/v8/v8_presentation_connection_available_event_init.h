...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, PresentationConnectionAvailableEventInit& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<PresentationConnectionAvailableEventInit> : public NativeValueTraitsBase<PresentationConnectionAvailableEventInit> {
  MODULES_EXPORT static PresentationConnectionAvailableEventInit NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
