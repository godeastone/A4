...
const WrapperTypeInfo& IDBVersionChangeEvent::wrapper_type_info_ = V8IDBVersionChangeEvent::wrapperTypeInfo;
...
static void newVersionAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  uint64_t cppValue(impl->newVersion(isNull));
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kConstructionContext, "IDBVersionChangeEvent");
...
void V8IDBVersionChangeEvent::isTrustedAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  IDBVersionChangeEventV8Internal::isTrustedAttributeGetter(info);
}

static const V8DOMConfiguration::AccessorConfiguration V8IDBVersionChangeEventAccessors[] = {
    { "oldVersion", V8IDBVersionChangeEvent::oldVersionAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "newVersion", V8IDBVersionChangeEvent::newVersionAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "dataLoss", V8IDBVersionChangeEvent::dataLossAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "dataLossMessage", V8IDBVersionChangeEvent::dataLossMessageAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "isTrusted", V8IDBVersionChangeEvent::isTrustedAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::DontDelete | v8::ReadOnly), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
};
...
static void installV8IDBVersionChangeEventTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8IDBVersionChangeEvent::wrapperTypeInfo.interface_name, V8Event::domTemplate(isolate, world), V8IDBVersionChangeEvent::internalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8IDBVersionChangeEventAccessors, arraysize(V8IDBVersionChangeEventAccessors));
...
IDBVersionChangeEvent* NativeValueTraits<IDBVersionChangeEvent>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  IDBVersionChangeEvent* nativeValue = V8IDBVersionChangeEvent::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
