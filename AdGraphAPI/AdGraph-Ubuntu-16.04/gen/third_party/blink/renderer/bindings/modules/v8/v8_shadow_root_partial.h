...
// clang-format off
#ifndef V8ShadowRootPartial_h
#define V8ShadowRootPartial_h
...
class V8ShadowRootPartial {
  STATIC_ONLY(V8ShadowRootPartial);
 public:
 ...
 private:
  static void installV8ShadowRootTemplate(v8::Isolate*, const DOMWrapperWorld&, v8::Local<v8::FunctionTemplate> interfaceTemplate);
};

}  // namespace blink

#endif  // V8ShadowRootPartial_h
