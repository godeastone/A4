...
#endif
const WrapperTypeInfo V8USBIsochronousInTransferPacket::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& USBIsochronousInTransferPacket::wrapper_type_info_ = V8USBIsochronousInTransferPacket::wrapperTypeInfo;
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kConstructionContext, "USBIsochronousInTransferPacket");
  ...
  if (UNLIKELY(numArgsPassed <= 1)) {
    ...
    wrapper = impl->AssociateWithWrapper(info.GetIsolate(), &V8USBIsochronousInTransferPacket::wrapperTypeInfo, wrapper);
...
static const V8DOMConfiguration::AccessorConfiguration V8USBIsochronousInTransferPacketAccessors[] = {
    { "status", V8USBIsochronousInTransferPacket::statusAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "data", V8USBIsochronousInTransferPacket::dataAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
};

void V8USBIsochronousInTransferPacket::constructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_USBIsochronousInTransferPacket_Constructor");

  if (!info.IsConstructCall()) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::ConstructorNotCallableAsFunction("USBIsochronousInTransferPacket"));
    return;
  }
  ...
  USBIsochronousInTransferPacketV8Internal::constructor(info);
}
...
static void installV8USBIsochronousInTransferPacketTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8USBIsochronousInTransferPacket::wrapperTypeInfo.interface_name, v8::Local<v8::FunctionTemplate>(), V8USBIsochronousInTransferPacket::internalFieldCount);
  interfaceTemplate->SetCallHandler(V8USBIsochronousInTransferPacket::constructorCallback);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8USBIsochronousInTransferPacketAccessors, arraysize(V8USBIsochronousInTransferPacketAccessors));
...
USBIsochronousInTransferPacket* NativeValueTraits<USBIsochronousInTransferPacket>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  USBIsochronousInTransferPacket* nativeValue = V8USBIsochronousInTransferPacket::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
