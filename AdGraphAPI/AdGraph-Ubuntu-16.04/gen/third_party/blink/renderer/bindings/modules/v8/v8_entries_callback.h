...
class MODULES_EXPORT V8EntriesCallback final : public CallbackInterfaceBase {
 public:
  static V8EntriesCallback* Create(v8::Local<v8::Object> callback_object) {
    return new V8EntriesCallback(callback_object);
  }
  ...
  v8::Maybe<void> handleEvent(ScriptWrappable* callback_this_value, const HeapVector<Member<Entry>>& entries) WARN_UNUSED_RESULT;
  ...
  void InvokeAndReportException(ScriptWrappable* callback_this_value, const HeapVector<Member<Entry>>& entries);
...
template <>
class MODULES_TEMPLATE_CLASS_EXPORT V8PersistentCallbackInterface<V8EntriesCallback> final : public V8PersistentCallbackInterfaceBase {
