...
class V8CanvasCaptureMediaStreamTrack {
 ...
 public:
  ...
  MODULES_EXPORT static void requestFrameMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
...
template <>
struct NativeValueTraits<CanvasCaptureMediaStreamTrack> : public NativeValueTraitsBase<CanvasCaptureMediaStreamTrack> {
  MODULES_EXPORT static CanvasCaptureMediaStreamTrack* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static CanvasCaptureMediaStreamTrack* NullValue() { return nullptr; }
};
