...
class V8Path2D {
 ...
 public:
  ...
  MODULES_EXPORT static void addPathMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
...
template <>
struct NativeValueTraits<Path2D> : public NativeValueTraitsBase<Path2D> {
  MODULES_EXPORT static Path2D* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static Path2D* NullValue() { return nullptr; }
};
