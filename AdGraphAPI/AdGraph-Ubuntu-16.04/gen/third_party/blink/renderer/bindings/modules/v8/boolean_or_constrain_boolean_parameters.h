...
class MODULES_EXPORT BooleanOrConstrainBooleanParameters final {
 ...
 public:
  ...
  bool IsConstrainBooleanParameters() const { return type_ == SpecificType::kConstrainBooleanParameters; }
 ...
 private:
  enum class SpecificType {
    kNone,
    kBoolean,
    kConstrainBooleanParameters,
  };
  SpecificType type_;

  bool boolean_;
  ConstrainBooleanParameters constrain_boolean_parameters_;
...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, BooleanOrConstrainBooleanParameters& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<BooleanOrConstrainBooleanParameters> : public NativeValueTraitsBase<BooleanOrConstrainBooleanParameters> {
  MODULES_EXPORT static BooleanOrConstrainBooleanParameters NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static BooleanOrConstrainBooleanParameters NullValue() { return BooleanOrConstrainBooleanParameters(); }
};

template <>
struct V8TypeOf<BooleanOrConstrainBooleanParameters> {
  typedef V8BooleanOrConstrainBooleanParameters Type;
};
