...
template <>
struct NativeValueTraits<FaceDetector> : public NativeValueTraitsBase<FaceDetector> {
  MODULES_EXPORT static FaceDetector* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static FaceDetector* NullValue() { return nullptr; }
};
