...
#endif
const WrapperTypeInfo V8RTCIceCandidate::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& RTCIceCandidate::wrapper_type_info_ = V8RTCIceCandidate::wrapperTypeInfo;
...
static void sdpMLineIndexAttributeSetter(v8::Local<v8::Value> v8Value, const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exceptionState(isolate, ExceptionState::kSetterContext, "RTCIceCandidate", "sdpMLineIndex");
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kConstructionContext, "RTCIceCandidate");
...
void V8RTCIceCandidate::candidateAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_RTCIceCandidate_candidate_Setter");
...
void V8RTCIceCandidate::sdpMidAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_RTCIceCandidate_sdpMid_Setter");
...
void V8RTCIceCandidate::sdpMLineIndexAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_RTCIceCandidate_sdpMLineIndex_Setter");
...
static const V8DOMConfiguration::AccessorConfiguration V8RTCIceCandidateAccessors[] = {
    { "candidate", V8RTCIceCandidate::candidateAttributeGetterCallback, V8RTCIceCandidate::candidateAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "sdpMid", V8RTCIceCandidate::sdpMidAttributeGetterCallback, V8RTCIceCandidate::sdpMidAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "sdpMLineIndex", V8RTCIceCandidate::sdpMLineIndexAttributeGetterCallback, V8RTCIceCandidate::sdpMLineIndexAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
};
...
static void installV8RTCIceCandidateTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8RTCIceCandidate::wrapperTypeInfo.interface_name, v8::Local<v8::FunctionTemplate>(), V8RTCIceCandidate::internalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8RTCIceCandidateAccessors, arraysize(V8RTCIceCandidateAccessors));
  V8DOMConfiguration::InstallMethods(
      isolate, world, instanceTemplate, prototypeTemplate, interfaceTemplate,
      signature, V8RTCIceCandidateMethods, arraysize(V8RTCIceCandidateMethods));
...
RTCIceCandidate* NativeValueTraits<RTCIceCandidate>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  RTCIceCandidate* nativeValue = V8RTCIceCandidate::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
