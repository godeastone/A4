...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, MIDIOptions& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<MIDIOptions> : public NativeValueTraitsBase<MIDIOptions> {
  MODULES_EXPORT static MIDIOptions NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
