...
template <>
struct NativeValueTraits<TrackDefaultList> : public NativeValueTraitsBase<TrackDefaultList> {
  MODULES_EXPORT static TrackDefaultList* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static TrackDefaultList* NullValue() { return nullptr; }
};
