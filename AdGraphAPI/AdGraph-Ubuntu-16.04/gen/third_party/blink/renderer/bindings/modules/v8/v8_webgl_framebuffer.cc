...
#endif
const WrapperTypeInfo V8WebGLFramebuffer::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& WebGLFramebuffer::wrapper_type_info_ = V8WebGLFramebuffer::wrapperTypeInfo;
...
static void installV8WebGLFramebufferTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8WebGLFramebuffer::wrapperTypeInfo.interface_name, v8::Local<v8::FunctionTemplate>(), V8WebGLFramebuffer::internalFieldCount);
...
WebGLFramebuffer* NativeValueTraits<WebGLFramebuffer>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  WebGLFramebuffer* nativeValue = V8WebGLFramebuffer::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
