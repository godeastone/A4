...
v8::Maybe<void> V8PositionErrorCallback::Invoke(ScriptWrappable* callback_this_value, PositionError* positionError) {
  ...
  v8::Local<v8::Value> v8_positionError = ToV8(positionError, argument_creation_context, GetIsolate());
  v8::Local<v8::Value> argv[] = { v8_positionError };
...
void V8PositionErrorCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, PositionError* positionError) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      Invoke(callback_this_value, positionError);
  // An exception if any is killed with the v8::TryCatch above.
  ALLOW_UNUSED_LOCAL(maybe_result);
}

MODULES_TEMPLATE_EXPORT
v8::Maybe<void> V8PersistentCallbackFunction<V8PositionErrorCallback>::Invoke(ScriptWrappable* callback_this_value, PositionError* positionError) {
  return Proxy()->Invoke(
      callback_this_value, positionError);
}

MODULES_TEMPLATE_EXPORT
void V8PersistentCallbackFunction<V8PositionErrorCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, PositionError* positionError) {
