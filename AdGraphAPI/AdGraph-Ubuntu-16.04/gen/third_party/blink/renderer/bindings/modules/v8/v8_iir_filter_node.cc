...
#endif
const WrapperTypeInfo V8IIRFilterNode::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& IIRFilterNode::wrapper_type_info_ = V8IIRFilterNode::wrapperTypeInfo;
...
static void getFrequencyResponseMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "IIRFilterNode", "getFrequencyResponse");
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kConstructionContext, "IIRFilterNode");
...
static const V8DOMConfiguration::MethodConfiguration V8IIRFilterNodeMethods[] = {
...
void V8IIRFilterNode::constructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  UseCounter::Count(CurrentExecutionContext(info.GetIsolate()), WebFeature::kV8IIRFilterNode_Constructor);
...
static void installV8IIRFilterNodeTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8IIRFilterNode::wrapperTypeInfo.interface_name, V8AudioNode::domTemplate(isolate, world), V8IIRFilterNode::internalFieldCount);
  ...
  V8DOMConfiguration::InstallMethods(
      ...
      signature, V8IIRFilterNodeMethods, arraysize(V8IIRFilterNodeMethods));
...
IIRFilterNode* NativeValueTraits<IIRFilterNode>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  IIRFilterNode* nativeValue = V8IIRFilterNode::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
