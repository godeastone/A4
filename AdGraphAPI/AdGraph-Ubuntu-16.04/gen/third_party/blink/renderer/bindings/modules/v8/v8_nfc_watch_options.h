...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, NFCWatchOptions& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<NFCWatchOptions> : public NativeValueTraitsBase<NFCWatchOptions> {
  MODULES_EXPORT static NFCWatchOptions NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
