...
template <>
struct NativeValueTraits<SpeechRecognitionResultList> : public NativeValueTraitsBase<SpeechRecognitionResultList> {
  MODULES_EXPORT static SpeechRecognitionResultList* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static SpeechRecognitionResultList* NullValue() { return nullptr; }
};
