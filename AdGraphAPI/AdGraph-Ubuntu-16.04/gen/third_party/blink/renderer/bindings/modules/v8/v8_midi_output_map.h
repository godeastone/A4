...
template <>
struct NativeValueTraits<MIDIOutputMap> : public NativeValueTraitsBase<MIDIOutputMap> {
  MODULES_EXPORT static MIDIOutputMap* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static MIDIOutputMap* NullValue() { return nullptr; }
};
