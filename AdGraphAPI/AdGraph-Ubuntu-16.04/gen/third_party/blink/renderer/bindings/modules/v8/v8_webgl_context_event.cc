...
#endif
const WrapperTypeInfo V8WebGLContextEvent::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& WebGLContextEvent::wrapper_type_info_ = V8WebGLContextEvent::wrapperTypeInfo;
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kConstructionContext, "WebGLContextEvent");
...
void V8WebGLContextEvent::isTrustedAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  WebGLContextEventV8Internal::isTrustedAttributeGetter(info);
}

static const V8DOMConfiguration::AccessorConfiguration V8WebGLContextEventAccessors[] = {
    { "statusMessage", V8WebGLContextEvent::statusMessageAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "isTrusted", V8WebGLContextEvent::isTrustedAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::DontDelete | v8::ReadOnly), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
};
...
static void installV8WebGLContextEventTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8WebGLContextEvent::wrapperTypeInfo.interface_name, V8Event::domTemplate(isolate, world), V8WebGLContextEvent::internalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8WebGLContextEventAccessors, arraysize(V8WebGLContextEventAccessors));
...
WebGLContextEvent* NativeValueTraits<WebGLContextEvent>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  WebGLContextEvent* nativeValue = V8WebGLContextEvent::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
