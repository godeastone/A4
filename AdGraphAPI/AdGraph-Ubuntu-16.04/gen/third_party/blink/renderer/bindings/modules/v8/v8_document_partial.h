...
// clang-format off
#ifndef V8DocumentPartial_h
#define V8DocumentPartial_h
...
class V8DocumentPartial {
 ...
 private:
  ...
  static void installV8DocumentTemplate(v8::Isolate*, const DOMWrapperWorld&, v8::Local<v8::FunctionTemplate> interfaceTemplate);
};

}  // namespace blink

#endif  // V8DocumentPartial_h
