...
const WrapperTypeInfo& DirectoryEntry::wrapper_type_info_ = V8DirectoryEntry::wrapperTypeInfo;
...
static void getFileMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "DirectoryEntry", "getFile");
...
static void getDirectoryMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "DirectoryEntry", "getDirectory");
...
static void installV8DirectoryEntryTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8DirectoryEntry::wrapperTypeInfo.interface_name, V8Entry::domTemplate(isolate, world), V8DirectoryEntry::internalFieldCount);
  ...
  V8DOMConfiguration::InstallMethods(
      ...
      signature, V8DirectoryEntryMethods, arraysize(V8DirectoryEntryMethods));
...
DirectoryEntry* NativeValueTraits<DirectoryEntry>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  DirectoryEntry* nativeValue = V8DirectoryEntry::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
