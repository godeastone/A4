...
class V8PluginArray {
 ...
 public:
  ...
  MODULES_EXPORT static void refreshMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
...
template <>
struct NativeValueTraits<DOMPluginArray> : public NativeValueTraitsBase<DOMPluginArray> {
  MODULES_EXPORT static DOMPluginArray* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static DOMPluginArray* NullValue() { return nullptr; }
};
