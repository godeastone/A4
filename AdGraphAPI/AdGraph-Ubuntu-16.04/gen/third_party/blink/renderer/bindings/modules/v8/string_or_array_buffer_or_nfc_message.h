...
class MODULES_EXPORT StringOrArrayBufferOrNFCMessage final {
 ...
 public:
  ...
  bool IsNFCMessage() const { return type_ == SpecificType::kNFCMessage; }
  ...
  static StringOrArrayBufferOrNFCMessage FromString(const String&);
...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, StringOrArrayBufferOrNFCMessage& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<StringOrArrayBufferOrNFCMessage> : public NativeValueTraitsBase<StringOrArrayBufferOrNFCMessage> {
  MODULES_EXPORT static StringOrArrayBufferOrNFCMessage NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static StringOrArrayBufferOrNFCMessage NullValue() { return StringOrArrayBufferOrNFCMessage(); }
};

template <>
struct V8TypeOf<StringOrArrayBufferOrNFCMessage> {
  typedef V8StringOrArrayBufferOrNFCMessage Type;
};
