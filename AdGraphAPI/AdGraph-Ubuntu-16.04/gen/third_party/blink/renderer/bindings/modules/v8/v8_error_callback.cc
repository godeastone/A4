...
v8::Maybe<void> V8ErrorCallback::handleEvent(ScriptWrappable* callback_this_value, DOMException* error) {
...
void V8ErrorCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, DOMException* error) {
...
v8::Maybe<void> V8PersistentCallbackInterface<V8ErrorCallback>::handleEvent(ScriptWrappable* callback_this_value, DOMException* error) {
  return Proxy()->handleEvent(
      callback_this_value, error);
}

MODULES_EXTERN_TEMPLATE_EXPORT
void V8PersistentCallbackInterface<V8ErrorCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, DOMException* error) {
