...
#endif
const WrapperTypeInfo V8BluetoothRemoteGATTService::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& BluetoothRemoteGATTService::wrapper_type_info_ = V8BluetoothRemoteGATTService::wrapperTypeInfo;
...
static void getCharacteristicMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "BluetoothRemoteGATTService", "getCharacteristic");
  ...
  V8StringOrUnsignedLong::ToImpl(info.GetIsolate(), info[0], characteristic, UnionTypeConversionMode::kNotNullable, exceptionState);
...
static void getCharacteristicsMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "BluetoothRemoteGATTService", "getCharacteristics");
  ExceptionToRejectPromiseScope rejectPromiseScope(info, exceptionState);
...
void V8BluetoothRemoteGATTService::getCharacteristicMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  UseCounter::Count(CurrentExecutionContext(info.GetIsolate()), WebFeature::kWebBluetoothRemoteServiceGetCharacteristic);
...
void V8BluetoothRemoteGATTService::getCharacteristicsMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  UseCounter::Count(CurrentExecutionContext(info.GetIsolate()), WebFeature::kWebBluetoothRemoteServiceGetCharacteristics);
  BluetoothRemoteGATTServiceV8Internal::getCharacteristicsMethod(info);
}

static const V8DOMConfiguration::AccessorConfiguration V8BluetoothRemoteGATTServiceAccessors[] = {
    { "device", V8BluetoothRemoteGATTService::deviceAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "uuid", V8BluetoothRemoteGATTService::uuidAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "isPrimary", V8BluetoothRemoteGATTService::isPrimaryAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
};

static const V8DOMConfiguration::MethodConfiguration V8BluetoothRemoteGATTServiceMethods[] = {
...
static void installV8BluetoothRemoteGATTServiceTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8BluetoothRemoteGATTService::wrapperTypeInfo.interface_name, v8::Local<v8::FunctionTemplate>(), V8BluetoothRemoteGATTService::internalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8BluetoothRemoteGATTServiceAccessors, arraysize(V8BluetoothRemoteGATTServiceAccessors));
  V8DOMConfiguration::InstallMethods(
      isolate, world, instanceTemplate, prototypeTemplate, interfaceTemplate,
      signature, V8BluetoothRemoteGATTServiceMethods, arraysize(V8BluetoothRemoteGATTServiceMethods));
...
BluetoothRemoteGATTService* NativeValueTraits<BluetoothRemoteGATTService>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  BluetoothRemoteGATTService* nativeValue = V8BluetoothRemoteGATTService::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
