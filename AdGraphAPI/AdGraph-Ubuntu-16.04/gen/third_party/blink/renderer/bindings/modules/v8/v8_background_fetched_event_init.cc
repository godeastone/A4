...
static const v8::Eternal<v8::Name>* eternalV8BackgroundFetchedEventInitKeys(v8::Isolate* isolate) {
...
void V8BackgroundFetchedEventInit::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, BackgroundFetchedEventInit& impl, ExceptionState& exceptionState) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8BackgroundFetchedEventInitKeys(isolate);
...
v8::Local<v8::Value> BackgroundFetchedEventInit::ToV8Impl(v8::Local<v8::Object> creationContext, v8::Isolate* isolate) const {
  v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
  if (!toV8BackgroundFetchedEventInit(*this, v8Object, creationContext, isolate))
    return v8::Undefined(isolate);
  return v8Object;
}

bool toV8BackgroundFetchedEventInit(const BackgroundFetchedEventInit& impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
...
BackgroundFetchedEventInit NativeValueTraits<BackgroundFetchedEventInit>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  BackgroundFetchedEventInit impl;
  V8BackgroundFetchedEventInit::ToImpl(isolate, value, impl, exceptionState);
  return impl;
}
