...
#ifndef V8DecodeErrorCallback_h
#define V8DecodeErrorCallback_h
...
class MODULES_EXPORT V8DecodeErrorCallback final : public CallbackFunctionBase {
 public:
  static V8DecodeErrorCallback* Create(v8::Local<v8::Function> callback_function) {
    return new V8DecodeErrorCallback(callback_function);
  }
...
template <>
class MODULES_TEMPLATE_CLASS_EXPORT V8PersistentCallbackFunction<V8DecodeErrorCallback> final : public V8PersistentCallbackFunctionBase {
