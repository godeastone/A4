...
// clang-format off
#ifndef V8XRInputSource_h
#define V8XRInputSource_h
...
class V8XRInputSource {
 ...
 public:
  ...
  MODULES_EXPORT static void pointerOriginAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
