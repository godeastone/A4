...
v8::Maybe<void> V8RTCStatsCallback::Invoke(ScriptWrappable* callback_this_value, RTCStatsResponse* response) {
  ...
  v8::Local<v8::Value> v8_response = ToV8(response, argument_creation_context, GetIsolate());
  v8::Local<v8::Value> argv[] = { v8_response };
...
void V8RTCStatsCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, RTCStatsResponse* response) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      Invoke(callback_this_value, response);
  // An exception if any is killed with the v8::TryCatch above.
  ALLOW_UNUSED_LOCAL(maybe_result);
}

MODULES_TEMPLATE_EXPORT
v8::Maybe<void> V8PersistentCallbackFunction<V8RTCStatsCallback>::Invoke(ScriptWrappable* callback_this_value, RTCStatsResponse* response) {
  return Proxy()->Invoke(
      callback_this_value, response);
}

MODULES_TEMPLATE_EXPORT
void V8PersistentCallbackFunction<V8RTCStatsCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, RTCStatsResponse* response) {
