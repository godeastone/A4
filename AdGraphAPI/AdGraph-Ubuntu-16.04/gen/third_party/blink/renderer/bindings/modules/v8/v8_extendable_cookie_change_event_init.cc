...
void V8ExtendableCookieChangeEventInit::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, ExtendableCookieChangeEventInit& impl, ExceptionState& exceptionState) {
...
ExtendableCookieChangeEventInit NativeValueTraits<ExtendableCookieChangeEventInit>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  ExtendableCookieChangeEventInit impl;
  V8ExtendableCookieChangeEventInit::ToImpl(isolate, value, impl, exceptionState);
  return impl;
}
