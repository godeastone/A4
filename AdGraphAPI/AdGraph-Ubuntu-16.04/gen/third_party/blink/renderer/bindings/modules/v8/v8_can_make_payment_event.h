...
// clang-format off
#ifndef V8CanMakePaymentEvent_h
#define V8CanMakePaymentEvent_h
...
class V8CanMakePaymentEvent {
  STATIC_ONLY(V8CanMakePaymentEvent);
 public:
  MODULES_EXPORT static bool hasInstance(v8::Local<v8::Value>, v8::Isolate*);
  static v8::Local<v8::Object> findInstanceInPrototypeChain(v8::Local<v8::Value>, v8::Isolate*);
  MODULES_EXPORT static v8::Local<v8::FunctionTemplate> domTemplate(v8::Isolate*, const DOMWrapperWorld&);
  static CanMakePaymentEvent* ToImpl(v8::Local<v8::Object> object) {
    return ToScriptWrappable(object)->ToImpl<CanMakePaymentEvent>();
  }
  MODULES_EXPORT static CanMakePaymentEvent* ToImplWithTypeCheck(v8::Isolate*, v8::Local<v8::Value>);
...
template <>
struct NativeValueTraits<CanMakePaymentEvent> : public NativeValueTraitsBase<CanMakePaymentEvent> {
  MODULES_EXPORT static CanMakePaymentEvent* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static CanMakePaymentEvent* NullValue() { return nullptr; }
};

template <>
struct V8TypeOf<CanMakePaymentEvent> {
  typedef V8CanMakePaymentEvent Type;
};

}  // namespace blink

#endif  // V8CanMakePaymentEvent_h
