...
class MODULES_EXPORT BooleanOrMediaTrackConstraints final {
 ...
 public:
  ...
  bool IsMediaTrackConstraints() const { return type_ == SpecificType::kMediaTrackConstraints; }
 ...
 private:
  ...
  bool boolean_;
  MediaTrackConstraints media_track_constraints_;
...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, BooleanOrMediaTrackConstraints& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<BooleanOrMediaTrackConstraints> : public NativeValueTraitsBase<BooleanOrMediaTrackConstraints> {
  MODULES_EXPORT static BooleanOrMediaTrackConstraints NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static BooleanOrMediaTrackConstraints NullValue() { return BooleanOrMediaTrackConstraints(); }
};

template <>
struct V8TypeOf<BooleanOrMediaTrackConstraints> {
  typedef V8BooleanOrMediaTrackConstraints Type;
};
