...
const WrapperTypeInfo& SpeechGrammar::wrapper_type_info_ = V8SpeechGrammar::wrapperTypeInfo;
...
static void srcAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  V8SetReturnValueString(info, impl->src(scriptState), info.GetIsolate());
}
...
static void srcAttributeSetter(v8::Local<v8::Value> v8Value, const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  impl->setSrc(scriptState, cppValue);
}
...
static void weightAttributeSetter(v8::Local<v8::Value> v8Value, const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exceptionState(isolate, ExceptionState::kSetterContext, "SpeechGrammar", "weight");
...
void V8SpeechGrammar::srcAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
...
void V8SpeechGrammar::weightAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
...
static const V8DOMConfiguration::AccessorConfiguration V8SpeechGrammarAccessors[] = {
    { "src", V8SpeechGrammar::srcAttributeGetterCallback, V8SpeechGrammar::srcAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
...
static void installV8SpeechGrammarTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8SpeechGrammar::wrapperTypeInfo.interface_name, v8::Local<v8::FunctionTemplate>(), V8SpeechGrammar::internalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8SpeechGrammarAccessors, arraysize(V8SpeechGrammarAccessors));
...
SpeechGrammar* NativeValueTraits<SpeechGrammar>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  SpeechGrammar* nativeValue = V8SpeechGrammar::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
