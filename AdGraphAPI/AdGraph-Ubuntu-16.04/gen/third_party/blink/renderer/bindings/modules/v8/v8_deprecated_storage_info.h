...
template <>
struct NativeValueTraits<DeprecatedStorageInfo> : public NativeValueTraitsBase<DeprecatedStorageInfo> {
  MODULES_EXPORT static DeprecatedStorageInfo* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static DeprecatedStorageInfo* NullValue() { return nullptr; }
};
