...
// clang-format off
#ifndef V8MediaDecodingConfiguration_h
#define V8MediaDecodingConfiguration_h
...
class V8MediaDecodingConfiguration {
 public:
  MODULES_EXPORT static void ToImpl(v8::Isolate*, v8::Local<v8::Value>, MediaDecodingConfiguration&, ExceptionState&);
};
...
#endif  // V8MediaDecodingConfiguration_h
