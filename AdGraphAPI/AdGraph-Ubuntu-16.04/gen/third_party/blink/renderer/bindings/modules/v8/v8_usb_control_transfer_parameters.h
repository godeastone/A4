...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, USBControlTransferParameters& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<USBControlTransferParameters> : public NativeValueTraitsBase<USBControlTransferParameters> {
  MODULES_EXPORT static USBControlTransferParameters NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
