...
#endif
const WrapperTypeInfo V8PaymentRequestEvent::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& PaymentRequestEvent::wrapper_type_info_ = V8PaymentRequestEvent::wrapperTypeInfo;
...
static void totalAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  V8SetReturnValue(info, impl->total(scriptState).V8Value());
}
...
static void openWindowMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "PaymentRequestEvent", "openWindow");
...
static void respondWithMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "PaymentRequestEvent", "respondWith");
  ...
  impl->respondWith(scriptState, response, exceptionState);
  if (exceptionState.HadException()) {
    return;
  }
}
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kConstructionContext, "PaymentRequestEvent");
  ...
  V8PaymentRequestEventInit::ToImpl(info.GetIsolate(), info[1], eventInitDict, exceptionState);
  if (exceptionState.HadException())
    return;

  PaymentRequestEvent* impl = PaymentRequestEvent::Create(type, eventInitDict);
  v8::Local<v8::Object> wrapper = info.Holder();
  wrapper = impl->AssociateWithWrapper(info.GetIsolate(), &V8PaymentRequestEvent::wrapperTypeInfo, wrapper);
...
void V8PaymentRequestEvent::topOriginAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  PaymentRequestEventV8Internal::topOriginAttributeGetter(info);
}
...
void V8PaymentRequestEvent::paymentRequestOriginAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  PaymentRequestEventV8Internal::paymentRequestOriginAttributeGetter(info);
}
...
void V8PaymentRequestEvent::paymentRequestIdAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  PaymentRequestEventV8Internal::paymentRequestIdAttributeGetter(info);
}
...
void V8PaymentRequestEvent::methodDataAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  PaymentRequestEventV8Internal::methodDataAttributeGetter(info);
}
...
void V8PaymentRequestEvent::totalAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  PaymentRequestEventV8Internal::totalAttributeGetter(info);
}
...
void V8PaymentRequestEvent::modifiersAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  PaymentRequestEventV8Internal::modifiersAttributeGetter(info);
}
...
void V8PaymentRequestEvent::instrumentKeyAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  PaymentRequestEventV8Internal::instrumentKeyAttributeGetter(info);
}
...
void V8PaymentRequestEvent::isTrustedAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  PaymentRequestEventV8Internal::isTrustedAttributeGetter(info);
}
...
void V8PaymentRequestEvent::openWindowMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  PaymentRequestEventV8Internal::openWindowMethod(info);
}
...
static const V8DOMConfiguration::AccessorConfiguration V8PaymentRequestEventAccessors[] = {
    { "topOrigin", V8PaymentRequestEvent::topOriginAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    ...
    { "paymentRequestId", V8PaymentRequestEvent::paymentRequestIdAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "methodData", V8PaymentRequestEvent::methodDataAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "total", V8PaymentRequestEvent::totalAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "modifiers", V8PaymentRequestEvent::modifiersAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "instrumentKey", V8PaymentRequestEvent::instrumentKeyAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "isTrusted", V8PaymentRequestEvent::isTrustedAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::DontDelete | v8::ReadOnly), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
};

static const V8DOMConfiguration::MethodConfiguration V8PaymentRequestEventMethods[] = {
...
void V8PaymentRequestEvent::constructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_PaymentRequestEvent_Constructor");

  if (!info.IsConstructCall()) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::ConstructorNotCallableAsFunction("PaymentRequestEvent"));
    return;
  }
  ...
  PaymentRequestEventV8Internal::constructor(info);
}
...
static void installV8PaymentRequestEventTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8PaymentRequestEvent::wrapperTypeInfo.interface_name, V8ExtendableEvent::domTemplate(isolate, world), V8PaymentRequestEvent::internalFieldCount);
  interfaceTemplate->SetCallHandler(V8PaymentRequestEvent::constructorCallback);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8PaymentRequestEventAccessors, arraysize(V8PaymentRequestEventAccessors));
  V8DOMConfiguration::InstallMethods(
      isolate, world, instanceTemplate, prototypeTemplate, interfaceTemplate,
      signature, V8PaymentRequestEventMethods, arraysize(V8PaymentRequestEventMethods));
...
PaymentRequestEvent* NativeValueTraits<PaymentRequestEvent>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  PaymentRequestEvent* nativeValue = V8PaymentRequestEvent::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
