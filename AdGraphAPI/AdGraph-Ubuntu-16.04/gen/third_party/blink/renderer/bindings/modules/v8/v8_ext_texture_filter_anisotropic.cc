...
#endif
const WrapperTypeInfo V8EXTTextureFilterAnisotropic::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& EXTTextureFilterAnisotropic::wrapper_type_info_ = V8EXTTextureFilterAnisotropic::wrapperTypeInfo;
...
static void installV8EXTTextureFilterAnisotropicTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8EXTTextureFilterAnisotropic::wrapperTypeInfo.interface_name, v8::Local<v8::FunctionTemplate>(), V8EXTTextureFilterAnisotropic::internalFieldCount);
  ...
  static constexpr V8DOMConfiguration::ConstantConfiguration V8EXTTextureFilterAnisotropicConstants[] = {
  ...
  V8DOMConfiguration::InstallConstants(
      ...
      V8EXTTextureFilterAnisotropicConstants, arraysize(V8EXTTextureFilterAnisotropicConstants));
...
EXTTextureFilterAnisotropic* NativeValueTraits<EXTTextureFilterAnisotropic>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  EXTTextureFilterAnisotropic* nativeValue = V8EXTTextureFilterAnisotropic::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
