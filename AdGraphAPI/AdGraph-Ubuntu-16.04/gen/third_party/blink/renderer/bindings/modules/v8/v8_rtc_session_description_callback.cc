...
v8::Maybe<void> V8RTCSessionDescriptionCallback::Invoke(ScriptWrappable* callback_this_value, RTCSessionDescription* description) {
  ...
  v8::Local<v8::Value> v8_description = ToV8(description, argument_creation_context, GetIsolate());
  v8::Local<v8::Value> argv[] = { v8_description };
...
void V8RTCSessionDescriptionCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, RTCSessionDescription* description) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      Invoke(callback_this_value, description);
  // An exception if any is killed with the v8::TryCatch above.
  ALLOW_UNUSED_LOCAL(maybe_result);
}

MODULES_TEMPLATE_EXPORT
v8::Maybe<void> V8PersistentCallbackFunction<V8RTCSessionDescriptionCallback>::Invoke(ScriptWrappable* callback_this_value, RTCSessionDescription* description) {
  return Proxy()->Invoke(
      callback_this_value, description);
}

MODULES_TEMPLATE_EXPORT
void V8PersistentCallbackFunction<V8RTCSessionDescriptionCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, RTCSessionDescription* description) {
