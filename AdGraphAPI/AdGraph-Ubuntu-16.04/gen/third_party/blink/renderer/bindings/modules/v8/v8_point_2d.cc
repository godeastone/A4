...
static const v8::Eternal<v8::Name>* eternalV8Point2DKeys(v8::Isolate* isolate) {
...
void V8Point2D::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, Point2D& impl, ExceptionState& exceptionState) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8Point2DKeys(isolate);
  ...
  if (xValue.IsEmpty() || xValue->IsUndefined()) {
    ...
    float xCppValue = NativeValueTraits<IDLFloat>::NativeValue(isolate, xValue, exceptionState);
  ...
  if (yValue.IsEmpty() || yValue->IsUndefined()) {
    ...
    float yCppValue = NativeValueTraits<IDLFloat>::NativeValue(isolate, yValue, exceptionState);
    if (exceptionState.HadException())
      return;
    impl.setY(yCppValue);
  }
