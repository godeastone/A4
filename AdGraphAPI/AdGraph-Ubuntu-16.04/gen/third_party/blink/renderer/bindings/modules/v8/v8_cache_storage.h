...
template <>
struct NativeValueTraits<CacheStorage> : public NativeValueTraitsBase<CacheStorage> {
  MODULES_EXPORT static CacheStorage* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static CacheStorage* NullValue() { return nullptr; }
};
