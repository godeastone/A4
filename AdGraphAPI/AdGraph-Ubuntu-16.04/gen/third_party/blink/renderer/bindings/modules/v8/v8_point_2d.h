...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, Point2D& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<Point2D> : public NativeValueTraitsBase<Point2D> {
  MODULES_EXPORT static Point2D NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
