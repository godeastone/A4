...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, USBDeviceRequestOptions& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<USBDeviceRequestOptions> : public NativeValueTraitsBase<USBDeviceRequestOptions> {
  MODULES_EXPORT static USBDeviceRequestOptions NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
