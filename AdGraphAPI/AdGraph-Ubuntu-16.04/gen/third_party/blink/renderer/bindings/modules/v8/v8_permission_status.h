...
template <>
struct NativeValueTraits<PermissionStatus> : public NativeValueTraitsBase<PermissionStatus> {
  MODULES_EXPORT static PermissionStatus* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static PermissionStatus* NullValue() { return nullptr; }
};
