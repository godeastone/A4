...
class MODULES_EXPORT ArrayBufferOrArrayBufferViewOrUSVString final {
 ...
 public:
  ...
  static ArrayBufferOrArrayBufferViewOrUSVString FromArrayBufferView(NotShared<DOMArrayBufferView>);
  ...
  static ArrayBufferOrArrayBufferViewOrUSVString FromUSVString(const String&);
...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, ArrayBufferOrArrayBufferViewOrUSVString& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<ArrayBufferOrArrayBufferViewOrUSVString> : public NativeValueTraitsBase<ArrayBufferOrArrayBufferViewOrUSVString> {
  MODULES_EXPORT static ArrayBufferOrArrayBufferViewOrUSVString NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static ArrayBufferOrArrayBufferViewOrUSVString NullValue() { return ArrayBufferOrArrayBufferViewOrUSVString(); }
};

template <>
struct V8TypeOf<ArrayBufferOrArrayBufferViewOrUSVString> {
  typedef V8ArrayBufferOrArrayBufferViewOrUSVString Type;
};
