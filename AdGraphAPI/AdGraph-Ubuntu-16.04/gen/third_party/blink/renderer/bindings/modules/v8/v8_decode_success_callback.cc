...
v8::Maybe<void> V8DecodeSuccessCallback::Invoke(ScriptWrappable* callback_this_value, AudioBuffer* decodedData) {
  ...
  v8::Local<v8::Value> v8_decodedData = ToV8(decodedData, argument_creation_context, GetIsolate());
  v8::Local<v8::Value> argv[] = { v8_decodedData };
...
void V8DecodeSuccessCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, AudioBuffer* decodedData) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      Invoke(callback_this_value, decodedData);
  // An exception if any is killed with the v8::TryCatch above.
  ALLOW_UNUSED_LOCAL(maybe_result);
}

MODULES_TEMPLATE_EXPORT
v8::Maybe<void> V8PersistentCallbackFunction<V8DecodeSuccessCallback>::Invoke(ScriptWrappable* callback_this_value, AudioBuffer* decodedData) {
  return Proxy()->Invoke(
      callback_this_value, decodedData);
}

MODULES_TEMPLATE_EXPORT
void V8PersistentCallbackFunction<V8DecodeSuccessCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, AudioBuffer* decodedData) {
