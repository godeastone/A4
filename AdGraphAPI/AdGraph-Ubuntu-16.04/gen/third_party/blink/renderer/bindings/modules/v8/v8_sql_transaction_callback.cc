...
v8::Maybe<void> V8SQLTransactionCallback::handleEvent(ScriptWrappable* callback_this_value, SQLTransaction* transaction) {
...
void V8SQLTransactionCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, SQLTransaction* transaction) {
...
v8::Maybe<void> V8PersistentCallbackInterface<V8SQLTransactionCallback>::handleEvent(ScriptWrappable* callback_this_value, SQLTransaction* transaction) {
  return Proxy()->handleEvent(
      callback_this_value, transaction);
}

MODULES_EXTERN_TEMPLATE_EXPORT
void V8PersistentCallbackInterface<V8SQLTransactionCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, SQLTransaction* transaction) {
