...
const WrapperTypeInfo& WebGLActiveInfo::wrapper_type_info_ = V8WebGLActiveInfo::wrapperTypeInfo;
...
static const V8DOMConfiguration::AccessorConfiguration V8WebGLActiveInfoAccessors[] = {
    { "size", V8WebGLActiveInfo::sizeAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "type", V8WebGLActiveInfo::typeAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "name", V8WebGLActiveInfo::nameAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
};
...
static void installV8WebGLActiveInfoTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8WebGLActiveInfo::wrapperTypeInfo.interface_name, v8::Local<v8::FunctionTemplate>(), V8WebGLActiveInfo::internalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8WebGLActiveInfoAccessors, arraysize(V8WebGLActiveInfoAccessors));
...
WebGLActiveInfo* NativeValueTraits<WebGLActiveInfo>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  WebGLActiveInfo* nativeValue = V8WebGLActiveInfo::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
