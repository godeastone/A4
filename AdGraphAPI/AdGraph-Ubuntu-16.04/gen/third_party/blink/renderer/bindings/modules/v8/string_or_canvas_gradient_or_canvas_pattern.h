...
class MODULES_EXPORT StringOrCanvasGradientOrCanvasPattern final {
 ...
 public:
  ...
  bool IsCanvasGradient() const { return type_ == SpecificType::kCanvasGradient; }
  ...
  bool IsCanvasPattern() const { return type_ == SpecificType::kCanvasPattern; }
  ...
  static StringOrCanvasGradientOrCanvasPattern FromString(const String&);
 ...
 private:
  ...
  Member<CanvasGradient> canvas_gradient_;
  Member<CanvasPattern> canvas_pattern_;
  String string_;
...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, StringOrCanvasGradientOrCanvasPattern& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<StringOrCanvasGradientOrCanvasPattern> : public NativeValueTraitsBase<StringOrCanvasGradientOrCanvasPattern> {
  MODULES_EXPORT static StringOrCanvasGradientOrCanvasPattern NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static StringOrCanvasGradientOrCanvasPattern NullValue() { return StringOrCanvasGradientOrCanvasPattern(); }
};

template <>
struct V8TypeOf<StringOrCanvasGradientOrCanvasPattern> {
  typedef V8StringOrCanvasGradientOrCanvasPattern Type;
};
