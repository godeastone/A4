...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, RTCPeerConnectionIceEventInit& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<RTCPeerConnectionIceEventInit> : public NativeValueTraitsBase<RTCPeerConnectionIceEventInit> {
  MODULES_EXPORT static RTCPeerConnectionIceEventInit NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
