...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, WebGLContextEventInit& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<WebGLContextEventInit> : public NativeValueTraitsBase<WebGLContextEventInit> {
  MODULES_EXPORT static WebGLContextEventInit NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
