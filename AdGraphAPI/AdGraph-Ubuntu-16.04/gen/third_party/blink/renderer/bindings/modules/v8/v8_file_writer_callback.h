...
class MODULES_EXPORT V8FileWriterCallback final : public CallbackInterfaceBase {
 public:
  static V8FileWriterCallback* Create(v8::Local<v8::Object> callback_object) {
    return new V8FileWriterCallback(callback_object);
  }
  ...
  v8::Maybe<void> handleEvent(ScriptWrappable* callback_this_value, FileWriter* fileWriter) WARN_UNUSED_RESULT;
  ...
  void InvokeAndReportException(ScriptWrappable* callback_this_value, FileWriter* fileWriter);
...
template <>
class MODULES_TEMPLATE_CLASS_EXPORT V8PersistentCallbackInterface<V8FileWriterCallback> final : public V8PersistentCallbackInterfaceBase {
  using V8CallbackInterface = V8FileWriterCallback;
...
// V8FileWriterCallback is designed to be used with wrapper-tracing.
...
Persistent<V8FileWriterCallback> WrapPersistent(V8FileWriterCallback*) = delete;
