...
// clang-format off
#ifndef V8LockOptions_h
#define V8LockOptions_h
...
class V8LockOptions {
 public:
  MODULES_EXPORT static void ToImpl(v8::Isolate*, v8::Local<v8::Value>, LockOptions&, ExceptionState&);
};
