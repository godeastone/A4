...
class V8HTMLIFrameElementPartial {
 ...
 public:
  ...
  // Callback functions
  static void allowPaymentRequestAttributeGetterCallback(    const v8::FunctionCallbackInfo<v8::Value>& info);
  static void allowPaymentRequestAttributeSetterCallback(    const v8::FunctionCallbackInfo<v8::Value>& info);
