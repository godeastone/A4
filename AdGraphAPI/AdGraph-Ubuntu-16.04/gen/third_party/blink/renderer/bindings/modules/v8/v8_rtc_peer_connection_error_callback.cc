...
v8::Maybe<void> V8RTCPeerConnectionErrorCallback::Invoke(ScriptWrappable* callback_this_value, DOMException* error) {
...
void V8RTCPeerConnectionErrorCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, DOMException* error) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8RTCPeerConnectionErrorCallback>::Invoke(ScriptWrappable* callback_this_value, DOMException* error) {
  return Proxy()->Invoke(
      callback_this_value, error);
}

MODULES_TEMPLATE_EXPORT
void V8PersistentCallbackFunction<V8RTCPeerConnectionErrorCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, DOMException* error) {
