...
static const v8::Eternal<v8::Name>* eternalV8PasswordCredentialDataKeys(v8::Isolate* isolate) {
...
void V8PasswordCredentialData::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, PasswordCredentialData& impl, ExceptionState& exceptionState) {
  if (IsUndefinedOrNull(v8Value)) {
    exceptionState.ThrowTypeError("Missing required member(s): password.");
    return;
  }
  if (!v8Value->IsObject()) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8PasswordCredentialDataKeys(isolate);
  ...
  if (passwordValue.IsEmpty() || passwordValue->IsUndefined()) {
    exceptionState.ThrowTypeError("required member password is undefined.");
    return;
  } else {
    V8StringResource<> passwordCppValue = NativeValueTraits<IDLUSVString>::NativeValue(isolate, passwordValue, exceptionState);
    if (exceptionState.HadException())
      return;
...
bool toV8PasswordCredentialData(const PasswordCredentialData& impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (impl.hasPassword()) {
    passwordValue = V8String(isolate, impl.password());
