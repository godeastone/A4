...
v8::Maybe<void> V8NavigatorUserMediaSuccessCallback::Invoke(ScriptWrappable* callback_this_value, MediaStream* stream) {
  ...
  v8::Local<v8::Value> v8_stream = ToV8(stream, argument_creation_context, GetIsolate());
  v8::Local<v8::Value> argv[] = { v8_stream };
...
void V8NavigatorUserMediaSuccessCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, MediaStream* stream) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      Invoke(callback_this_value, stream);
  // An exception if any is killed with the v8::TryCatch above.
  ALLOW_UNUSED_LOCAL(maybe_result);
}

MODULES_TEMPLATE_EXPORT
v8::Maybe<void> V8PersistentCallbackFunction<V8NavigatorUserMediaSuccessCallback>::Invoke(ScriptWrappable* callback_this_value, MediaStream* stream) {
  return Proxy()->Invoke(
      callback_this_value, stream);
}

MODULES_TEMPLATE_EXPORT
void V8PersistentCallbackFunction<V8NavigatorUserMediaSuccessCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, MediaStream* stream) {
