...
v8::Maybe<ScriptValue> V8LockGrantedCallback::Invoke(ScriptWrappable* callback_this_value, Lock* lock) {
  ...
  v8::Local<v8::Value> v8_lock = ToV8(lock, argument_creation_context, GetIsolate());
  v8::Local<v8::Value> argv[] = { v8_lock };
...
v8::Maybe<ScriptValue> V8PersistentCallbackFunction<V8LockGrantedCallback>::Invoke(ScriptWrappable* callback_this_value, Lock* lock) {
  return Proxy()->Invoke(
      callback_this_value, lock);
}
