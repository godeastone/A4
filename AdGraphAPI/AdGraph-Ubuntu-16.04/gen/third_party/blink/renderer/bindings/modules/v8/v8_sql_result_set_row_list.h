...
template <>
struct NativeValueTraits<SQLResultSetRowList> : public NativeValueTraitsBase<SQLResultSetRowList> {
  MODULES_EXPORT static SQLResultSetRowList* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static SQLResultSetRowList* NullValue() { return nullptr; }
};
