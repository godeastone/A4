...
class V8BluetoothUUID {
 ...
 public:
  ...
  MODULES_EXPORT static void getServiceMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  MODULES_EXPORT static void canonicalUUIDMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
...
template <>
struct NativeValueTraits<BluetoothUUID> : public NativeValueTraitsBase<BluetoothUUID> {
  MODULES_EXPORT static BluetoothUUID* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static BluetoothUUID* NullValue() { return nullptr; }
};
