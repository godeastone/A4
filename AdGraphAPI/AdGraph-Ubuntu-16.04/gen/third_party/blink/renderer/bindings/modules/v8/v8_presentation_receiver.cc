...
#endif
const WrapperTypeInfo V8PresentationReceiver::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& PresentationReceiver::wrapper_type_info_ = V8PresentationReceiver::wrapperTypeInfo;
...
static void connectionListAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kGetterContext, "PresentationReceiver", "connectionList");
...
static const V8DOMConfiguration::AccessorConfiguration V8PresentationReceiverAccessors[] = {
    { "connectionList", V8PresentationReceiver::connectionListAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kDoNotCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
};
...
static void installV8PresentationReceiverTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8PresentationReceiver::wrapperTypeInfo.interface_name, v8::Local<v8::FunctionTemplate>(), V8PresentationReceiver::internalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8PresentationReceiverAccessors, arraysize(V8PresentationReceiverAccessors));
...
PresentationReceiver* NativeValueTraits<PresentationReceiver>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  PresentationReceiver* nativeValue = V8PresentationReceiver::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
