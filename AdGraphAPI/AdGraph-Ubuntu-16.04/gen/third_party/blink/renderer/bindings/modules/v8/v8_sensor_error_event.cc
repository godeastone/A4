...
#endif
const WrapperTypeInfo V8SensorErrorEvent::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& SensorErrorEvent::wrapper_type_info_ = V8SensorErrorEvent::wrapperTypeInfo;
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kConstructionContext, "SensorErrorEvent");
...
void V8SensorErrorEvent::isTrustedAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  SensorErrorEventV8Internal::isTrustedAttributeGetter(info);
}
...
static void installV8SensorErrorEventTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8SensorErrorEvent::wrapperTypeInfo.interface_name, V8Event::domTemplate(isolate, world), V8SensorErrorEvent::internalFieldCount);
...
SensorErrorEvent* NativeValueTraits<SensorErrorEvent>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  SensorErrorEvent* nativeValue = V8SensorErrorEvent::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
...
void V8SensorErrorEvent::InstallConditionalFeatures(
  ...
  if (!instanceObject.IsEmpty()) {
    if (isSecureContext) {
      static const V8DOMConfiguration::AccessorConfiguration accessor_configurations[] = {
          { "isTrusted", V8SensorErrorEvent::isTrustedAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::DontDelete | v8::ReadOnly), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
      };
  ...
  if (!prototypeObject.IsEmpty() || !interfaceObject.IsEmpty()) {
    if (isSecureContext) {
      static const V8DOMConfiguration::AccessorConfiguration accessor_configurations[] = {
          { "error", V8SensorErrorEvent::errorAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
      };
      V8DOMConfiguration::InstallAccessors(
          isolate, world, instanceObject, prototypeObject, interfaceObject,
          signature, accessor_configurations,
