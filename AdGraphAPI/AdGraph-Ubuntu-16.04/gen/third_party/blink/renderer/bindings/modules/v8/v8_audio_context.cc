...
#endif
const WrapperTypeInfo V8AudioContext::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& AudioContext::wrapper_type_info_ = V8AudioContext::wrapperTypeInfo;
...
static void suspendMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "AudioContext", "suspend");
...
static void closeMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "AudioContext", "close");
  ExceptionToRejectPromiseScope rejectPromiseScope(info, exceptionState);
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kConstructionContext, "AudioContext");

  AudioContextOptions contextOptions;
  if (!info[0]->IsNullOrUndefined() && !info[0]->IsObject()) {
    exceptionState.ThrowTypeError("parameter 1 ('contextOptions') is not an object.");
    return;
  }
  V8AudioContextOptions::ToImpl(info.GetIsolate(), info[0], contextOptions, exceptionState);
  if (exceptionState.HadException())
    return;

  Document& document = *ToDocument(ToExecutionContext(
      info.NewTarget().As<v8::Object>()->CreationContext()));
  AudioContext* impl = AudioContext::Create(document, contextOptions, exceptionState);
  if (exceptionState.HadException()) {
    return;
  }
...
void V8AudioContext::baseLatencyAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  AudioContextV8Internal::baseLatencyAttributeGetter(info);
}
...
void V8AudioContext::suspendMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  UseCounter::Count(CurrentExecutionContext(info.GetIsolate()), WebFeature::kAudioContextSuspend);
...
void V8AudioContext::closeMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  UseCounter::Count(CurrentExecutionContext(info.GetIsolate()), WebFeature::kAudioContextClose);
...
void V8AudioContext::getOutputTimestampMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  UseCounter::Count(CurrentExecutionContext(info.GetIsolate()), WebFeature::kAudioContextGetOutputTimestamp);
...
static const V8DOMConfiguration::AccessorConfiguration V8AudioContextAccessors[] = {
    { "baseLatency", V8AudioContext::baseLatencyAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
};
...
void V8AudioContext::constructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  UseCounter::Count(CurrentExecutionContext(info.GetIsolate()), WebFeature::kV8AudioContext_Constructor);
...
static void installV8AudioContextTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8AudioContext::wrapperTypeInfo.interface_name, V8BaseAudioContext::domTemplate(isolate, world), V8AudioContext::internalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8AudioContextAccessors, arraysize(V8AudioContextAccessors));
  V8DOMConfiguration::InstallMethods(
      isolate, world, instanceTemplate, prototypeTemplate, interfaceTemplate,
      signature, V8AudioContextMethods, arraysize(V8AudioContextMethods));
...
AudioContext* NativeValueTraits<AudioContext>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  AudioContext* nativeValue = V8AudioContext::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
