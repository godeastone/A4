...
class V8EventSource {
 ...
 public:
  ...
  MODULES_EXPORT static void withCredentialsAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
...
template <>
struct NativeValueTraits<EventSource> : public NativeValueTraitsBase<EventSource> {
  MODULES_EXPORT static EventSource* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static EventSource* NullValue() { return nullptr; }
};
