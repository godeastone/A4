...
template <>
struct NativeValueTraits<Gyroscope> : public NativeValueTraitsBase<Gyroscope> {
  MODULES_EXPORT static Gyroscope* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static Gyroscope* NullValue() { return nullptr; }
};
