...
#endif
const WrapperTypeInfo V8PaymentRequestUpdateEvent::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& PaymentRequestUpdateEvent::wrapper_type_info_ = V8PaymentRequestUpdateEvent::wrapperTypeInfo;
...
static void updateWithMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "PaymentRequestUpdateEvent", "updateWith");
  ...
  ScriptPromise detailsPromise;
  detailsPromise = ScriptPromise::Cast(ScriptState::Current(info.GetIsolate()), info[0]);
  if (!detailsPromise.IsUndefinedOrNull() && !detailsPromise.IsObject()) {
    exceptionState.ThrowTypeError("parameter 1 ('detailsPromise') is not an object.");
    return;
  }

  impl->updateWith(scriptState, detailsPromise, exceptionState);
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kConstructionContext, "PaymentRequestUpdateEvent");
  ...
  PaymentRequestUpdateEvent* impl = PaymentRequestUpdateEvent::Create(executionContext, type, eventInitDict);
...
void V8PaymentRequestUpdateEvent::isTrustedAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  PaymentRequestUpdateEventV8Internal::isTrustedAttributeGetter(info);
}
...
static const V8DOMConfiguration::AccessorConfiguration V8PaymentRequestUpdateEventAccessors[] = {
    { "isTrusted", V8PaymentRequestUpdateEvent::isTrustedAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::DontDelete | v8::ReadOnly), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
};

static const V8DOMConfiguration::MethodConfiguration V8PaymentRequestUpdateEventMethods[] = {
...
static void installV8PaymentRequestUpdateEventTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8PaymentRequestUpdateEvent::wrapperTypeInfo.interface_name, V8Event::domTemplate(isolate, world), V8PaymentRequestUpdateEvent::internalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8PaymentRequestUpdateEventAccessors, arraysize(V8PaymentRequestUpdateEventAccessors));
  V8DOMConfiguration::InstallMethods(
      isolate, world, instanceTemplate, prototypeTemplate, interfaceTemplate,
      signature, V8PaymentRequestUpdateEventMethods, arraysize(V8PaymentRequestUpdateEventMethods));
...
PaymentRequestUpdateEvent* NativeValueTraits<PaymentRequestUpdateEvent>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  PaymentRequestUpdateEvent* nativeValue = V8PaymentRequestUpdateEvent::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
