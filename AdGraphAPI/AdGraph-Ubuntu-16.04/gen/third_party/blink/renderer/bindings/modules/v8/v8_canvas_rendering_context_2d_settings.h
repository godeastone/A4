...
// clang-format off
#ifndef V8CanvasRenderingContext2DSettings_h
#define V8CanvasRenderingContext2DSettings_h
...
class V8CanvasRenderingContext2DSettings {
 public:
  MODULES_EXPORT static void ToImpl(v8::Isolate*, v8::Local<v8::Value>, CanvasRenderingContext2DSettings&, ExceptionState&);
};
...
#endif  // V8CanvasRenderingContext2DSettings_h
