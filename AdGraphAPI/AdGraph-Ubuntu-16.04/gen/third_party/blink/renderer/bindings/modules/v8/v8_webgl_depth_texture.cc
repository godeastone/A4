...
#endif
const WrapperTypeInfo V8WebGLDepthTexture::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& WebGLDepthTexture::wrapper_type_info_ = V8WebGLDepthTexture::wrapperTypeInfo;
...
static void installV8WebGLDepthTextureTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8WebGLDepthTexture::wrapperTypeInfo.interface_name, v8::Local<v8::FunctionTemplate>(), V8WebGLDepthTexture::internalFieldCount);
  ...
  static constexpr V8DOMConfiguration::ConstantConfiguration V8WebGLDepthTextureConstants[] = {
      {"UNSIGNED_INT_24_8_WEBGL", V8DOMConfiguration::kConstantTypeUnsignedLong, static_cast<int>(0x84FA)},
  };
  V8DOMConfiguration::InstallConstants(
      isolate, interfaceTemplate, prototypeTemplate,
      V8WebGLDepthTextureConstants, arraysize(V8WebGLDepthTextureConstants));
...
WebGLDepthTexture* NativeValueTraits<WebGLDepthTexture>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  WebGLDepthTexture* nativeValue = V8WebGLDepthTexture::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
