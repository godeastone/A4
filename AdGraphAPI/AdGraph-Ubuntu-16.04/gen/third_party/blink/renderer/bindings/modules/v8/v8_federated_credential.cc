...
#endif
const WrapperTypeInfo V8FederatedCredential::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& FederatedCredential::wrapper_type_info_ = V8FederatedCredential::wrapperTypeInfo;
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kConstructionContext, "FederatedCredential");
  ...
  V8FederatedCredentialInit::ToImpl(info.GetIsolate(), info[0], data, exceptionState);
...
void V8FederatedCredential::nameAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  FederatedCredentialV8Internal::nameAttributeGetter(info);
}
...
void V8FederatedCredential::iconURLAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  FederatedCredentialV8Internal::iconURLAttributeGetter(info);
}
...
static void installV8FederatedCredentialTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8FederatedCredential::wrapperTypeInfo.interface_name, V8Credential::domTemplate(isolate, world), V8FederatedCredential::internalFieldCount);
...
FederatedCredential* NativeValueTraits<FederatedCredential>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  FederatedCredential* nativeValue = V8FederatedCredential::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
  ...
  if (!prototypeObject.IsEmpty() || !interfaceObject.IsEmpty()) {
    if (isSecureContext) {
      static const V8DOMConfiguration::AccessorConfiguration accessor_configurations[] = {
          { "iconURL", V8FederatedCredential::iconURLAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
          { "name", V8FederatedCredential::nameAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
          { "protocol", V8FederatedCredential::protocolAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
          { "provider", V8FederatedCredential::providerAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
      };
