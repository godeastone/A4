...
class MODULES_EXPORT V8NavigatorUserMediaErrorCallback final : public CallbackFunctionBase {
 public:
  static V8NavigatorUserMediaErrorCallback* Create(v8::Local<v8::Function> callback_function) {
    return new V8NavigatorUserMediaErrorCallback(callback_function);
  }
  ...
  v8::Maybe<void> Invoke(ScriptWrappable* callback_this_value, DOMExceptionOrOverconstrainedError error) WARN_UNUSED_RESULT;

  // Performs "invoke", and then reports an exception, if any, to the global
  // error handler such as DevTools' console.
  void InvokeAndReportException(ScriptWrappable* callback_this_value, DOMExceptionOrOverconstrainedError error);
...
template <>
class MODULES_TEMPLATE_CLASS_EXPORT V8PersistentCallbackFunction<V8NavigatorUserMediaErrorCallback> final : public V8PersistentCallbackFunctionBase {
