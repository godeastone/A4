...
#endif
const WrapperTypeInfo V8WebGLTexture::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& WebGLTexture::wrapper_type_info_ = V8WebGLTexture::wrapperTypeInfo;
...
void V8WebGLTexture::lastUploadedVideoWidthAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  WebGLTextureV8Internal::lastUploadedVideoWidthAttributeGetter(info);
}
...
void V8WebGLTexture::lastUploadedVideoHeightAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  WebGLTextureV8Internal::lastUploadedVideoHeightAttributeGetter(info);
}
...
void V8WebGLTexture::lastUploadedVideoTimestampAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  WebGLTextureV8Internal::lastUploadedVideoTimestampAttributeGetter(info);
}
...
void V8WebGLTexture::lastUploadedVideoFrameWasSkippedAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  WebGLTextureV8Internal::lastUploadedVideoFrameWasSkippedAttributeGetter(info);
}
...
static void installV8WebGLTextureTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8WebGLTexture::wrapperTypeInfo.interface_name, v8::Local<v8::FunctionTemplate>(), V8WebGLTexture::internalFieldCount);
...
void V8WebGLTexture::InstallRuntimeEnabledFeaturesOnTemplate(
  ...
  if (RuntimeEnabledFeatures::ExtraWebGLVideoTextureMetadataEnabled()) {
    static const V8DOMConfiguration::AccessorConfiguration accessor_configurations[] = {
        ...
        { "lastUploadedVideoWidth", V8WebGLTexture::lastUploadedVideoWidthAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    };
...
WebGLTexture* NativeValueTraits<WebGLTexture>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  WebGLTexture* nativeValue = V8WebGLTexture::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
