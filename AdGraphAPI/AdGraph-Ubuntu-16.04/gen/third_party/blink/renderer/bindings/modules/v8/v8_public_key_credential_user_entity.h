...
// clang-format off
#ifndef V8PublicKeyCredentialUserEntity_h
#define V8PublicKeyCredentialUserEntity_h
...
class V8PublicKeyCredentialUserEntity {
 public:
  MODULES_EXPORT static void ToImpl(v8::Isolate*, v8::Local<v8::Value>, PublicKeyCredentialUserEntity&, ExceptionState&);
};
...
#endif  // V8PublicKeyCredentialUserEntity_h
