...
template <>
struct NativeValueTraits<Entry> : public NativeValueTraitsBase<Entry> {
  MODULES_EXPORT static Entry* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static Entry* NullValue() { return nullptr; }
};
