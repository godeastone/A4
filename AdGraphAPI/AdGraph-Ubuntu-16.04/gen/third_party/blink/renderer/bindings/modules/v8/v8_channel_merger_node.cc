...
#endif
const WrapperTypeInfo V8ChannelMergerNode::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& ChannelMergerNode::wrapper_type_info_ = V8ChannelMergerNode::wrapperTypeInfo;
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kConstructionContext, "ChannelMergerNode");
...
void V8ChannelMergerNode::constructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  UseCounter::Count(CurrentExecutionContext(info.GetIsolate()), WebFeature::kV8ChannelMergerNode_Constructor);
...
static void installV8ChannelMergerNodeTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8ChannelMergerNode::wrapperTypeInfo.interface_name, V8AudioNode::domTemplate(isolate, world), V8ChannelMergerNode::internalFieldCount);
...
ChannelMergerNode* NativeValueTraits<ChannelMergerNode>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  ChannelMergerNode* nativeValue = V8ChannelMergerNode::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
