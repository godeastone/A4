...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, RTCOfferOptions& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<RTCOfferOptions> : public NativeValueTraitsBase<RTCOfferOptions> {
  MODULES_EXPORT static RTCOfferOptions NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
