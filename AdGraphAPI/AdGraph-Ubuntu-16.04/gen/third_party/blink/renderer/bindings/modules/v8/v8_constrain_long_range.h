...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, ConstrainLongRange& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<ConstrainLongRange> : public NativeValueTraitsBase<ConstrainLongRange> {
  MODULES_EXPORT static ConstrainLongRange NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
