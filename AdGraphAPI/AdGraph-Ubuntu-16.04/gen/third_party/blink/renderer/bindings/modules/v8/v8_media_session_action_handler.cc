...
v8::Maybe<void> V8MediaSessionActionHandler::Invoke(ScriptWrappable* callback_this_value) {
...
void V8MediaSessionActionHandler::InvokeAndReportException(ScriptWrappable* callback_this_value) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8MediaSessionActionHandler>::Invoke(ScriptWrappable* callback_this_value) {
  return Proxy()->Invoke(
      callback_this_value);
}

MODULES_TEMPLATE_EXPORT
void V8PersistentCallbackFunction<V8MediaSessionActionHandler>::InvokeAndReportException(ScriptWrappable* callback_this_value) {
