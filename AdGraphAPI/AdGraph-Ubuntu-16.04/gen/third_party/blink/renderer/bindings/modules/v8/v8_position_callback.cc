...
v8::Maybe<void> V8PositionCallback::Invoke(ScriptWrappable* callback_this_value, Geoposition* position) {
  ...
  v8::Local<v8::Value> v8_position = ToV8(position, argument_creation_context, GetIsolate());
  v8::Local<v8::Value> argv[] = { v8_position };
...
void V8PositionCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, Geoposition* position) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      Invoke(callback_this_value, position);
  // An exception if any is killed with the v8::TryCatch above.
  ALLOW_UNUSED_LOCAL(maybe_result);
}

MODULES_TEMPLATE_EXPORT
v8::Maybe<void> V8PersistentCallbackFunction<V8PositionCallback>::Invoke(ScriptWrappable* callback_this_value, Geoposition* position) {
  return Proxy()->Invoke(
      callback_this_value, position);
}

MODULES_TEMPLATE_EXPORT
void V8PersistentCallbackFunction<V8PositionCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, Geoposition* position) {
