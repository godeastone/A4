...
class MODULES_EXPORT V8SQLTransactionCallback final : public CallbackInterfaceBase {
 public:
  static V8SQLTransactionCallback* Create(v8::Local<v8::Object> callback_object) {
    return new V8SQLTransactionCallback(callback_object);
  }
  ...
  v8::Maybe<void> handleEvent(ScriptWrappable* callback_this_value, SQLTransaction* transaction) WARN_UNUSED_RESULT;
  ...
  void InvokeAndReportException(ScriptWrappable* callback_this_value, SQLTransaction* transaction);
...
template <>
class MODULES_TEMPLATE_CLASS_EXPORT V8PersistentCallbackInterface<V8SQLTransactionCallback> final : public V8PersistentCallbackInterfaceBase {
