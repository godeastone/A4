...
class MODULES_EXPORT ArrayBufferOrArrayBufferViewOrDictionary final {
 ...
 public:
  ...
  static ArrayBufferOrArrayBufferViewOrDictionary FromArrayBufferView(NotShared<DOMArrayBufferView>);
...
struct NativeValueTraits<ArrayBufferOrArrayBufferViewOrDictionary> : public NativeValueTraitsBase<ArrayBufferOrArrayBufferViewOrDictionary> {
  ...
  MODULES_EXPORT static ArrayBufferOrArrayBufferViewOrDictionary NullValue() { return ArrayBufferOrArrayBufferViewOrDictionary(); }
};
