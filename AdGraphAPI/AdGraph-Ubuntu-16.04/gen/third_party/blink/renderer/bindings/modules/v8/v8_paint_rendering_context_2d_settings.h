...
// clang-format off
#ifndef V8PaintRenderingContext2DSettings_h
#define V8PaintRenderingContext2DSettings_h
...
class V8PaintRenderingContext2DSettings {
 public:
  MODULES_EXPORT static void ToImpl(v8::Isolate*, v8::Local<v8::Value>, PaintRenderingContext2DSettings&, ExceptionState&);
};
...
#endif  // V8PaintRenderingContext2DSettings_h
