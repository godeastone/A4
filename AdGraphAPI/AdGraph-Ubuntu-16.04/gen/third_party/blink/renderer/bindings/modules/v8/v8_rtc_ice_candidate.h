...
class V8RTCIceCandidate {
 ...
 public:
  ...
  MODULES_EXPORT static void candidateAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void sdpMidAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void sdpMidAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void sdpMLineIndexAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void sdpMLineIndexAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
