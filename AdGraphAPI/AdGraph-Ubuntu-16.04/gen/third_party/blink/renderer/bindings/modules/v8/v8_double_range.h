...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, DoubleRange& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<DoubleRange> : public NativeValueTraitsBase<DoubleRange> {
  MODULES_EXPORT static DoubleRange NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
