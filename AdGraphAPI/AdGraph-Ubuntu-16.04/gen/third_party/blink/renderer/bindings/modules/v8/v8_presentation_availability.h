...
template <>
struct NativeValueTraits<PresentationAvailability> : public NativeValueTraitsBase<PresentationAvailability> {
  MODULES_EXPORT static PresentationAvailability* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static PresentationAvailability* NullValue() { return nullptr; }
};
