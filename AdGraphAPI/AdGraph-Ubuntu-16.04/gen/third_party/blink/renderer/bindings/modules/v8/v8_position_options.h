...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, PositionOptions& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<PositionOptions> : public NativeValueTraitsBase<PositionOptions> {
  MODULES_EXPORT static PositionOptions NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
