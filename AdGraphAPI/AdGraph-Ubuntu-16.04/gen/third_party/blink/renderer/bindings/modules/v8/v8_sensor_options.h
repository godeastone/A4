...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, SensorOptions& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<SensorOptions> : public NativeValueTraitsBase<SensorOptions> {
  MODULES_EXPORT static SensorOptions NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
