...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, PhotoSettings& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<PhotoSettings> : public NativeValueTraitsBase<PhotoSettings> {
  MODULES_EXPORT static PhotoSettings NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
