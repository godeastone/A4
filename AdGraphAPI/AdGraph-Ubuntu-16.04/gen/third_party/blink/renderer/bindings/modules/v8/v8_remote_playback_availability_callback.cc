...
v8::Maybe<void> V8RemotePlaybackAvailabilityCallback::Invoke(ScriptWrappable* callback_this_value, bool available) {
  ...
  v8::Local<v8::Value> v8_available = v8::Boolean::New(GetIsolate(), available);
  v8::Local<v8::Value> argv[] = { v8_available };
...
void V8RemotePlaybackAvailabilityCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, bool available) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      Invoke(callback_this_value, available);
  // An exception if any is killed with the v8::TryCatch above.
  ALLOW_UNUSED_LOCAL(maybe_result);
}

MODULES_TEMPLATE_EXPORT
v8::Maybe<void> V8PersistentCallbackFunction<V8RemotePlaybackAvailabilityCallback>::Invoke(ScriptWrappable* callback_this_value, bool available) {
  return Proxy()->Invoke(
      callback_this_value, available);
}

MODULES_TEMPLATE_EXPORT
void V8PersistentCallbackFunction<V8RemotePlaybackAvailabilityCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, bool available) {
