...
#endif
const WrapperTypeInfo V8WebGLTransformFeedback::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& WebGLTransformFeedback::wrapper_type_info_ = V8WebGLTransformFeedback::wrapperTypeInfo;
...
static void installV8WebGLTransformFeedbackTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8WebGLTransformFeedback::wrapperTypeInfo.interface_name, v8::Local<v8::FunctionTemplate>(), V8WebGLTransformFeedback::internalFieldCount);
...
WebGLTransformFeedback* NativeValueTraits<WebGLTransformFeedback>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  WebGLTransformFeedback* nativeValue = V8WebGLTransformFeedback::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
