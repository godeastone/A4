...
#endif
const WrapperTypeInfo V8PushManager::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& PushManager::wrapper_type_info_ = V8PushManager::wrapperTypeInfo;
...
static void subscribeMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "PushManager", "subscribe");
...
static void getSubscriptionMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "PushManager", "getSubscription");
  ExceptionToRejectPromiseScope rejectPromiseScope(info, exceptionState);
...
static void permissionStateMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "PushManager", "permissionState");
  ExceptionToRejectPromiseScope rejectPromiseScope(info, exceptionState);
...
void V8PushManager::supportedContentEncodingsAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  PushManagerV8Internal::supportedContentEncodingsAttributeGetter(info);
}
...
static const V8DOMConfiguration::AccessorConfiguration V8PushManagerAccessors[] = {
...
static void installV8PushManagerTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8PushManager::wrapperTypeInfo.interface_name, v8::Local<v8::FunctionTemplate>(), V8PushManager::internalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8PushManagerAccessors, arraysize(V8PushManagerAccessors));
  V8DOMConfiguration::InstallMethods(
      isolate, world, instanceTemplate, prototypeTemplate, interfaceTemplate,
      signature, V8PushManagerMethods, arraysize(V8PushManagerMethods));
...
PushManager* NativeValueTraits<PushManager>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  PushManager* nativeValue = V8PushManager::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
