...
#endif
const WrapperTypeInfo V8USBInterface::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& USBInterface::wrapper_type_info_ = V8USBInterface::wrapperTypeInfo;
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kConstructionContext, "USBInterface");
  ...
  interfaceNumber = NativeValueTraits<IDLOctet>::NativeValue(info.GetIsolate(), info[1], exceptionState, kNormalConversion);
...
static const V8DOMConfiguration::AccessorConfiguration V8USBInterfaceAccessors[] = {
    { "interfaceNumber", V8USBInterface::interfaceNumberAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "alternate", V8USBInterface::alternateAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "alternates", V8USBInterface::alternatesAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "claimed", V8USBInterface::claimedAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
};
...
static void installV8USBInterfaceTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8USBInterface::wrapperTypeInfo.interface_name, v8::Local<v8::FunctionTemplate>(), V8USBInterface::internalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8USBInterfaceAccessors, arraysize(V8USBInterfaceAccessors));
...
USBInterface* NativeValueTraits<USBInterface>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  USBInterface* nativeValue = V8USBInterface::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
