...
class V8FetchEvent {
 ...
 public:
  ...
  MODULES_EXPORT static void clientIdAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void isReloadAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void preloadResponseAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
...
template <>
struct NativeValueTraits<FetchEvent> : public NativeValueTraitsBase<FetchEvent> {
  MODULES_EXPORT static FetchEvent* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static FetchEvent* NullValue() { return nullptr; }
};
