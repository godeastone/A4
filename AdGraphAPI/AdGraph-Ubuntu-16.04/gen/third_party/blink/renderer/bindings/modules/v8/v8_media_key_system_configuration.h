...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, MediaKeySystemConfiguration& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<MediaKeySystemConfiguration> : public NativeValueTraitsBase<MediaKeySystemConfiguration> {
  MODULES_EXPORT static MediaKeySystemConfiguration NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
