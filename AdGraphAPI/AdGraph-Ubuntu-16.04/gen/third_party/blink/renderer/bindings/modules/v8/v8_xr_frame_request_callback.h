...
#ifndef V8XRFrameRequestCallback_h
#define V8XRFrameRequestCallback_h
...
class MODULES_EXPORT V8XRFrameRequestCallback final : public CallbackFunctionBase {
 public:
  static V8XRFrameRequestCallback* Create(v8::Local<v8::Function> callback_function) {
    return new V8XRFrameRequestCallback(callback_function);
  }
  ...
  v8::Maybe<void> Invoke(ScriptWrappable* callback_this_value, double time, XRPresentationFrame* frame) WARN_UNUSED_RESULT;

  // Performs "invoke", and then reports an exception, if any, to the global
  // error handler such as DevTools' console.
  void InvokeAndReportException(ScriptWrappable* callback_this_value, double time, XRPresentationFrame* frame);
...
template <>
class MODULES_TEMPLATE_CLASS_EXPORT V8PersistentCallbackFunction<V8XRFrameRequestCallback> final : public V8PersistentCallbackFunctionBase {
...
#endif  // V8XRFrameRequestCallback_h
