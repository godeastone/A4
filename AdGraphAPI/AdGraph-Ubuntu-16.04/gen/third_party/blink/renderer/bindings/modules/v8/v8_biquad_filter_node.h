...
class V8BiquadFilterNode {
 ...
 public:
  ...
  MODULES_EXPORT static void QAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void gainAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);

  MODULES_EXPORT static void getFrequencyResponseMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
...
template <>
struct NativeValueTraits<BiquadFilterNode> : public NativeValueTraitsBase<BiquadFilterNode> {
  MODULES_EXPORT static BiquadFilterNode* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static BiquadFilterNode* NullValue() { return nullptr; }
};
