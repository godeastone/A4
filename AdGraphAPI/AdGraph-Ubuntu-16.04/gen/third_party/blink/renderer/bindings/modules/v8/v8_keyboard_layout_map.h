...
// clang-format off
#ifndef V8KeyboardLayoutMap_h
#define V8KeyboardLayoutMap_h
...
class V8KeyboardLayoutMap {
  STATIC_ONLY(V8KeyboardLayoutMap);
 public:
  MODULES_EXPORT static bool hasInstance(v8::Local<v8::Value>, v8::Isolate*);
  static v8::Local<v8::Object> findInstanceInPrototypeChain(v8::Local<v8::Value>, v8::Isolate*);
  MODULES_EXPORT static v8::Local<v8::FunctionTemplate> domTemplate(v8::Isolate*, const DOMWrapperWorld&);
  static KeyboardLayoutMap* ToImpl(v8::Local<v8::Object> object) {
    return ToScriptWrappable(object)->ToImpl<KeyboardLayoutMap>();
  }
  MODULES_EXPORT static KeyboardLayoutMap* ToImplWithTypeCheck(v8::Isolate*, v8::Local<v8::Value>);
...
template <>
struct NativeValueTraits<KeyboardLayoutMap> : public NativeValueTraitsBase<KeyboardLayoutMap> {
  MODULES_EXPORT static KeyboardLayoutMap* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static KeyboardLayoutMap* NullValue() { return nullptr; }
};

template <>
struct V8TypeOf<KeyboardLayoutMap> {
  typedef V8KeyboardLayoutMap Type;
};

}  // namespace blink

#endif  // V8KeyboardLayoutMap_h
