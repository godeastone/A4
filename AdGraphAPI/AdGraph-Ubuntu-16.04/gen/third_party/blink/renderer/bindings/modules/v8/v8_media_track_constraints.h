...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, MediaTrackConstraints& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<MediaTrackConstraints> : public NativeValueTraitsBase<MediaTrackConstraints> {
  MODULES_EXPORT static MediaTrackConstraints NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
