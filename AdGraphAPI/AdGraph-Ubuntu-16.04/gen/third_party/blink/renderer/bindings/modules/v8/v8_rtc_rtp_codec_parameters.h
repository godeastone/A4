...
// clang-format off
#ifndef V8RTCRtpCodecParameters_h
#define V8RTCRtpCodecParameters_h
...
class V8RTCRtpCodecParameters {
 public:
  MODULES_EXPORT static void ToImpl(v8::Isolate*, v8::Local<v8::Value>, RTCRtpCodecParameters&, ExceptionState&);
};
...
#endif  // V8RTCRtpCodecParameters_h
