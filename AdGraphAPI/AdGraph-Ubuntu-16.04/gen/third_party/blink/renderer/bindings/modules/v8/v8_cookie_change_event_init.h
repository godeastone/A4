...
// clang-format off
#ifndef V8CookieChangeEventInit_h
#define V8CookieChangeEventInit_h
...
class V8CookieChangeEventInit {
 public:
  MODULES_EXPORT static void ToImpl(v8::Isolate*, v8::Local<v8::Value>, CookieChangeEventInit&, ExceptionState&);
};
...
#endif  // V8CookieChangeEventInit_h
