...
class V8PresentationConnection {
 ...
 public:
  ...
  MODULES_EXPORT static void onterminateAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  MODULES_EXPORT static void onterminateAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  MODULES_EXPORT static void terminateMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
...
template <>
struct NativeValueTraits<PresentationConnection> : public NativeValueTraitsBase<PresentationConnection> {
  MODULES_EXPORT static PresentationConnection* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  MODULES_EXPORT static PresentationConnection* NullValue() { return nullptr; }
};
