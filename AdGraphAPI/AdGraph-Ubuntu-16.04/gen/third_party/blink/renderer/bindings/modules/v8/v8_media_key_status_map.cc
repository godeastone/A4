...
#endif
const WrapperTypeInfo V8MediaKeyStatusMap::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& MediaKeyStatusMap::wrapper_type_info_ = V8MediaKeyStatusMap::wrapperTypeInfo;
...
static void hasMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "MediaKeyStatusMap", "has");
  ...
  V8ArrayBufferOrArrayBufferView::ToImpl(info.GetIsolate(), info[0], keyId, UnionTypeConversionMode::kNotNullable, exceptionState);
...
static void getMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "MediaKeyStatusMap", "get");
...
static void keysMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "MediaKeyStatusMap", "keys");
...
static void valuesMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "MediaKeyStatusMap", "values");
...
static void forEachMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "MediaKeyStatusMap", "forEach");
...
static void iteratorMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "MediaKeyStatusMap", "iterator");
...
static void installV8MediaKeyStatusMapTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8MediaKeyStatusMap::wrapperTypeInfo.interface_name, v8::Local<v8::FunctionTemplate>(), V8MediaKeyStatusMap::internalFieldCount);
...
MediaKeyStatusMap* NativeValueTraits<MediaKeyStatusMap>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  MediaKeyStatusMap* nativeValue = V8MediaKeyStatusMap::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
  ...
  if (!prototypeObject.IsEmpty() || !interfaceObject.IsEmpty()) {
    if (isSecureContext) {
      static const V8DOMConfiguration::AccessorConfiguration accessor_configurations[] = {
          { "size", V8MediaKeyStatusMap::sizeAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
      };
