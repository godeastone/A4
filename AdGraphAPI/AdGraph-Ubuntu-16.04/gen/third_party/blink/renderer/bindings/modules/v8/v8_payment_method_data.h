...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, PaymentMethodData& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<PaymentMethodData> : public NativeValueTraitsBase<PaymentMethodData> {
  MODULES_EXPORT static PaymentMethodData NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
