...
// clang-format off
#ifndef V8CSSNumericArray_h
#define V8CSSNumericArray_h
...
class V8CSSNumericArray {
  STATIC_ONLY(V8CSSNumericArray);
 public:
  CORE_EXPORT static bool hasInstance(v8::Local<v8::Value>, v8::Isolate*);
  static v8::Local<v8::Object> findInstanceInPrototypeChain(v8::Local<v8::Value>, v8::Isolate*);
  CORE_EXPORT static v8::Local<v8::FunctionTemplate> domTemplate(v8::Isolate*, const DOMWrapperWorld&);
  static CSSNumericArray* ToImpl(v8::Local<v8::Object> object) {
    return ToScriptWrappable(object)->ToImpl<CSSNumericArray>();
  }
  CORE_EXPORT static CSSNumericArray* ToImplWithTypeCheck(v8::Isolate*, v8::Local<v8::Value>);
...
template <>
struct NativeValueTraits<CSSNumericArray> : public NativeValueTraitsBase<CSSNumericArray> {
  CORE_EXPORT static CSSNumericArray* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static CSSNumericArray* NullValue() { return nullptr; }
};

template <>
struct V8TypeOf<CSSNumericArray> {
  typedef V8CSSNumericArray Type;
};

}  // namespace blink

#endif  // V8CSSNumericArray_h
