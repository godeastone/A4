...
#endif
const WrapperTypeInfo V8HTMLTitleElement::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& HTMLTitleElement::wrapper_type_info_ = V8HTMLTitleElement::wrapperTypeInfo;
...
void V8HTMLTitleElement::textAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
...
void V8HTMLTitleElement::constructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLTitleElement_Constructor");

  if (!info.IsConstructCall()) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::ConstructorNotCallableAsFunction("HTMLTitleElement"));
    return;
  }
  ...
  V8HTMLConstructor::HtmlConstructor(info, V8HTMLTitleElement::wrapperTypeInfo, HTMLElementType::kHTMLTitleElement);
}
...
static void installV8HTMLTitleElementTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8HTMLTitleElement::wrapperTypeInfo.interface_name, V8HTMLElement::domTemplate(isolate, world), V8HTMLTitleElement::internalFieldCount);
  interfaceTemplate->SetCallHandler(V8HTMLTitleElement::constructorCallback);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8HTMLTitleElementAccessors, arraysize(V8HTMLTitleElementAccessors));
...
HTMLTitleElement* NativeValueTraits<HTMLTitleElement>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  HTMLTitleElement* nativeValue = V8HTMLTitleElement::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
