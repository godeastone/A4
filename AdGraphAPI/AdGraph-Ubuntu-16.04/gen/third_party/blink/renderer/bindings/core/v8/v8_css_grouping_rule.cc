...
#endif
const WrapperTypeInfo V8CSSGroupingRule::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& CSSGroupingRule::wrapper_type_info_ = V8CSSGroupingRule::wrapperTypeInfo;
...
static void insertRuleMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "CSSGroupingRule", "insertRule");
  ...
  uint32_t result = impl->insertRule(executionContext, rule, index, exceptionState);
  if (exceptionState.HadException()) {
    return;
  }
...
static void deleteRuleMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "CSSGroupingRule", "deleteRule");
...
static const V8DOMConfiguration::AccessorConfiguration V8CSSGroupingRuleAccessors[] = {
    { "cssRules", V8CSSGroupingRule::cssRulesAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
};
...
static void installV8CSSGroupingRuleTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8CSSGroupingRule::wrapperTypeInfo.interface_name, V8CSSRule::domTemplate(isolate, world), V8CSSGroupingRule::internalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8CSSGroupingRuleAccessors, arraysize(V8CSSGroupingRuleAccessors));
  V8DOMConfiguration::InstallMethods(
      isolate, world, instanceTemplate, prototypeTemplate, interfaceTemplate,
      signature, V8CSSGroupingRuleMethods, arraysize(V8CSSGroupingRuleMethods));
...
CSSGroupingRule* NativeValueTraits<CSSGroupingRule>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  CSSGroupingRule* nativeValue = V8CSSGroupingRule::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
