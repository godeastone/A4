...
template <>
struct NativeValueTraits<SVGNumberListTearOff> : public NativeValueTraitsBase<SVGNumberListTearOff> {
  CORE_EXPORT static SVGNumberListTearOff* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static SVGNumberListTearOff* NullValue() { return nullptr; }
};
