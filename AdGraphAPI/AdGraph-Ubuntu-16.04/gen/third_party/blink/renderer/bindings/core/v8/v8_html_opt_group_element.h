...
template <>
struct NativeValueTraits<HTMLOptGroupElement> : public NativeValueTraitsBase<HTMLOptGroupElement> {
  CORE_EXPORT static HTMLOptGroupElement* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static HTMLOptGroupElement* NullValue() { return nullptr; }
};
