...
template <>
struct NativeValueTraits<NodeList> : public NativeValueTraitsBase<NodeList> {
  CORE_EXPORT static NodeList* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static NodeList* NullValue() { return nullptr; }
};
