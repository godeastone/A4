...
const WrapperTypeInfo& External::wrapper_type_info_ = V8External::wrapperTypeInfo;
...
static const V8DOMConfiguration::MethodConfiguration V8ExternalMethods[] = {
...
static void installV8ExternalTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8External::wrapperTypeInfo.interface_name, v8::Local<v8::FunctionTemplate>(), V8External::internalFieldCount);
  ...
  V8DOMConfiguration::InstallMethods(
      ...
      signature, V8ExternalMethods, arraysize(V8ExternalMethods));
...
External* NativeValueTraits<External>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  External* nativeValue = V8External::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
