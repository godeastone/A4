...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, WheelEventInit& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<WheelEventInit> : public NativeValueTraitsBase<WheelEventInit> {
  CORE_EXPORT static WheelEventInit NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
