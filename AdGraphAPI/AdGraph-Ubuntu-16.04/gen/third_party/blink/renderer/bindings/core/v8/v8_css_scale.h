...
template <>
struct NativeValueTraits<CSSScale> : public NativeValueTraitsBase<CSSScale> {
  CORE_EXPORT static CSSScale* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static CSSScale* NullValue() { return nullptr; }
};
