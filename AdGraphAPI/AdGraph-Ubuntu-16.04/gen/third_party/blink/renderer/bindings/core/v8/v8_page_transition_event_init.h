...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, PageTransitionEventInit& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<PageTransitionEventInit> : public NativeValueTraitsBase<PageTransitionEventInit> {
  CORE_EXPORT static PageTransitionEventInit NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
