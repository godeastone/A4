...
template <>
struct NativeValueTraits<SVGImageElement> : public NativeValueTraitsBase<SVGImageElement> {
  CORE_EXPORT static SVGImageElement* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static SVGImageElement* NullValue() { return nullptr; }
};
