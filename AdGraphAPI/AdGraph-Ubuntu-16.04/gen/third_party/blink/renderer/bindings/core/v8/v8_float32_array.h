...
template <>
struct NativeValueTraits<DOMFloat32Array> : public NativeValueTraitsBase<DOMFloat32Array> {
  CORE_EXPORT static DOMFloat32Array* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static DOMFloat32Array* NullValue() { return nullptr; }
};
