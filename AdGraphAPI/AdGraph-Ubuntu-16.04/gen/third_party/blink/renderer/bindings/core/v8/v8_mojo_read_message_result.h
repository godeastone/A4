...
// clang-format off
#ifndef V8MojoReadMessageResult_h
#define V8MojoReadMessageResult_h
...
class V8MojoReadMessageResult {
 public:
  CORE_EXPORT static void ToImpl(v8::Isolate*, v8::Local<v8::Value>, MojoReadMessageResult&, ExceptionState&);
};
...
#endif  // V8MojoReadMessageResult_h
