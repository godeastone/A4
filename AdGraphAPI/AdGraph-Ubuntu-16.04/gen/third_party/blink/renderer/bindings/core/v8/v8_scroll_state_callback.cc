...
v8::Maybe<void> V8ScrollStateCallback::Invoke(ScriptWrappable* callback_this_value, ScrollState* scrollState) {
  ...
  v8::Local<v8::Value> v8_scrollState = ToV8(scrollState, argument_creation_context, GetIsolate());
  v8::Local<v8::Value> argv[] = { v8_scrollState };
...
void V8ScrollStateCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, ScrollState* scrollState) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      Invoke(callback_this_value, scrollState);
  // An exception if any is killed with the v8::TryCatch above.
  ALLOW_UNUSED_LOCAL(maybe_result);
}

CORE_TEMPLATE_EXPORT
v8::Maybe<void> V8PersistentCallbackFunction<V8ScrollStateCallback>::Invoke(ScriptWrappable* callback_this_value, ScrollState* scrollState) {
  return Proxy()->Invoke(
      callback_this_value, scrollState);
}

CORE_TEMPLATE_EXPORT
void V8PersistentCallbackFunction<V8ScrollStateCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, ScrollState* scrollState) {
