...
class CORE_EXPORT DoubleOrInternalEnum final {
 ...
 public:
  ...
  static DoubleOrInternalEnum FromInternalEnum(const String&);
...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, DoubleOrInternalEnum& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<DoubleOrInternalEnum> : public NativeValueTraitsBase<DoubleOrInternalEnum> {
  CORE_EXPORT static DoubleOrInternalEnum NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static DoubleOrInternalEnum NullValue() { return DoubleOrInternalEnum(); }
};

template <>
struct V8TypeOf<DoubleOrInternalEnum> {
  typedef V8DoubleOrInternalEnum Type;
};
