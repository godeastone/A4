...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, EventListenerOptions& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<EventListenerOptions> : public NativeValueTraitsBase<EventListenerOptions> {
  CORE_EXPORT static EventListenerOptions NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
