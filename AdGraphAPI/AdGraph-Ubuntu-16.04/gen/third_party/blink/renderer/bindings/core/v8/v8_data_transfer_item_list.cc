...
#endif
const WrapperTypeInfo V8DataTransferItemList::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& DataTransferItemList::wrapper_type_info_ = V8DataTransferItemList::wrapperTypeInfo;
...
static void add1Method(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "DataTransferItemList", "add");
...
static void removeMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "DataTransferItemList", "remove");
...
void V8DataTransferItemList::indexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  DataTransferItemListV8Internal::indexedPropertyDescriptor(index, info);
}

void V8DataTransferItemList::indexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8Value, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
static const V8DOMConfiguration::AccessorConfiguration V8DataTransferItemListAccessors[] = {
    { "length", V8DataTransferItemList::lengthAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
};
...
static void installV8DataTransferItemListTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8DataTransferItemList::wrapperTypeInfo.interface_name, v8::Local<v8::FunctionTemplate>(), V8DataTransferItemList::internalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8DataTransferItemListAccessors, arraysize(V8DataTransferItemListAccessors));
  V8DOMConfiguration::InstallMethods(
      isolate, world, instanceTemplate, prototypeTemplate, interfaceTemplate,
      signature, V8DataTransferItemListMethods, arraysize(V8DataTransferItemListMethods));
...
DataTransferItemList* NativeValueTraits<DataTransferItemList>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  DataTransferItemList* nativeValue = V8DataTransferItemList::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
