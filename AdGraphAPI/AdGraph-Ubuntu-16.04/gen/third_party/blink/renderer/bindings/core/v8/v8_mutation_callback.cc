...
v8::Maybe<void> V8MutationCallback::Invoke(ScriptWrappable* callback_this_value, const HeapVector<Member<MutationRecord>>& mutations, MutationObserver* observer) {
  ...
  v8::Local<v8::Value> v8_mutations = ToV8(mutations, argument_creation_context, GetIsolate());
  v8::Local<v8::Value> v8_observer = ToV8(observer, argument_creation_context, GetIsolate());
  v8::Local<v8::Value> argv[] = { v8_mutations, v8_observer };
...
void V8MutationCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, const HeapVector<Member<MutationRecord>>& mutations, MutationObserver* observer) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      Invoke(callback_this_value, mutations, observer);
  // An exception if any is killed with the v8::TryCatch above.
  ALLOW_UNUSED_LOCAL(maybe_result);
}

CORE_TEMPLATE_EXPORT
v8::Maybe<void> V8PersistentCallbackFunction<V8MutationCallback>::Invoke(ScriptWrappable* callback_this_value, const HeapVector<Member<MutationRecord>>& mutations, MutationObserver* observer) {
  return Proxy()->Invoke(
      callback_this_value, mutations, observer);
}

CORE_TEMPLATE_EXPORT
void V8PersistentCallbackFunction<V8MutationCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, const HeapVector<Member<MutationRecord>>& mutations, MutationObserver* observer) {
