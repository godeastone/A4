...
template <>
struct NativeValueTraits<MessagePort> : public NativeValueTraitsBase<MessagePort> {
  CORE_EXPORT static MessagePort* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static MessagePort* NullValue() { return nullptr; }
};
