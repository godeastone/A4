...
v8::Maybe<void> V8IntersectionObserverCallback::Invoke(ScriptWrappable* callback_this_value, const HeapVector<Member<IntersectionObserverEntry>>& entries, IntersectionObserver* observer) {
  ...
  v8::Local<v8::Value> v8_entries = ToV8(entries, argument_creation_context, GetIsolate());
  v8::Local<v8::Value> v8_observer = ToV8(observer, argument_creation_context, GetIsolate());
  v8::Local<v8::Value> argv[] = { v8_entries, v8_observer };
...
void V8IntersectionObserverCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, const HeapVector<Member<IntersectionObserverEntry>>& entries, IntersectionObserver* observer) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      Invoke(callback_this_value, entries, observer);
  // An exception if any is killed with the v8::TryCatch above.
  ALLOW_UNUSED_LOCAL(maybe_result);
}

CORE_TEMPLATE_EXPORT
v8::Maybe<void> V8PersistentCallbackFunction<V8IntersectionObserverCallback>::Invoke(ScriptWrappable* callback_this_value, const HeapVector<Member<IntersectionObserverEntry>>& entries, IntersectionObserver* observer) {
  return Proxy()->Invoke(
      callback_this_value, entries, observer);
}

CORE_TEMPLATE_EXPORT
void V8PersistentCallbackFunction<V8IntersectionObserverCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, const HeapVector<Member<IntersectionObserverEntry>>& entries, IntersectionObserver* observer) {
