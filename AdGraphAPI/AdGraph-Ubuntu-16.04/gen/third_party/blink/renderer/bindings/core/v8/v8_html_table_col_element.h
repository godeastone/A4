...
class V8HTMLTableColElement {
 ...
 public:
  ...
  CORE_EXPORT static void spanAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void spanAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
...
template <>
struct NativeValueTraits<HTMLTableColElement> : public NativeValueTraitsBase<HTMLTableColElement> {
  CORE_EXPORT static HTMLTableColElement* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static HTMLTableColElement* NullValue() { return nullptr; }
};
