...
v8::Maybe<void> V8PerformanceObserverCallback::Invoke(ScriptWrappable* callback_this_value, PerformanceObserverEntryList* entries, PerformanceObserver* observer) {
...
void V8PerformanceObserverCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, PerformanceObserverEntryList* entries, PerformanceObserver* observer) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8PerformanceObserverCallback>::Invoke(ScriptWrappable* callback_this_value, PerformanceObserverEntryList* entries, PerformanceObserver* observer) {
  return Proxy()->Invoke(
      callback_this_value, entries, observer);
}

CORE_TEMPLATE_EXPORT
void V8PersistentCallbackFunction<V8PerformanceObserverCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, PerformanceObserverEntryList* entries, PerformanceObserver* observer) {
