...
template <>
struct NativeValueTraits<SVGStyleElement> : public NativeValueTraitsBase<SVGStyleElement> {
  CORE_EXPORT static SVGStyleElement* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static SVGStyleElement* NullValue() { return nullptr; }
};
