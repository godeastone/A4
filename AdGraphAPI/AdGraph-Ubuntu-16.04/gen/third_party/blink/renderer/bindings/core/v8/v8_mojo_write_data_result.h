...
// clang-format off
#ifndef V8MojoWriteDataResult_h
#define V8MojoWriteDataResult_h
...
class V8MojoWriteDataResult {
 public:
  CORE_EXPORT static void ToImpl(v8::Isolate*, v8::Local<v8::Value>, MojoWriteDataResult&, ExceptionState&);
};
