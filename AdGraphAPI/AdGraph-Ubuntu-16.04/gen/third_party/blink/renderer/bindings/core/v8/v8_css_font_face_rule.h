...
template <>
struct NativeValueTraits<CSSFontFaceRule> : public NativeValueTraitsBase<CSSFontFaceRule> {
  CORE_EXPORT static CSSFontFaceRule* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static CSSFontFaceRule* NullValue() { return nullptr; }
};
