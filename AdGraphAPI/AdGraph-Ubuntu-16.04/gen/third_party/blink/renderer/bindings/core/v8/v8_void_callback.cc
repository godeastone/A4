...
v8::Maybe<void> V8VoidCallback::handleEvent(ScriptWrappable* callback_this_value) {
...
void V8VoidCallback::InvokeAndReportException(ScriptWrappable* callback_this_value) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      handleEvent(callback_this_value);
  // An exception if any is killed with the v8::TryCatch above.
  ALLOW_UNUSED_LOCAL(maybe_result);
}

CORE_EXTERN_TEMPLATE_EXPORT
v8::Maybe<void> V8PersistentCallbackInterface<V8VoidCallback>::handleEvent(ScriptWrappable* callback_this_value) {
  return Proxy()->handleEvent(
      callback_this_value);
}

CORE_EXTERN_TEMPLATE_EXPORT
void V8PersistentCallbackInterface<V8VoidCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value) {
