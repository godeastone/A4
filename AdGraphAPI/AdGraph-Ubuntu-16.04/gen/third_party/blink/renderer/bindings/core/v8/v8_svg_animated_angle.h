...
template <>
struct NativeValueTraits<SVGAnimatedAngle> : public NativeValueTraitsBase<SVGAnimatedAngle> {
  CORE_EXPORT static SVGAnimatedAngle* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static SVGAnimatedAngle* NullValue() { return nullptr; }
};
