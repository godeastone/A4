...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, ApplicationCacheErrorEventInit& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<ApplicationCacheErrorEventInit> : public NativeValueTraitsBase<ApplicationCacheErrorEventInit> {
  CORE_EXPORT static ApplicationCacheErrorEventInit NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
