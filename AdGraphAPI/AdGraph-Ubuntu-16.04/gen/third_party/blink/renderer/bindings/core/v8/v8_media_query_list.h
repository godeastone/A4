...
class V8MediaQueryList {
 ...
 public:
  ...
  CORE_EXPORT static void addListenerMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void removeListenerMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
...
template <>
struct NativeValueTraits<MediaQueryList> : public NativeValueTraitsBase<MediaQueryList> {
  CORE_EXPORT static MediaQueryList* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static MediaQueryList* NullValue() { return nullptr; }
};
