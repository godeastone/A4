...
template <>
struct NativeValueTraits<DOMException> : public NativeValueTraitsBase<DOMException> {
  CORE_EXPORT static DOMException* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static DOMException* NullValue() { return nullptr; }
};
