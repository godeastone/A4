...
#endif
const WrapperTypeInfo V8SVGAnimatedNumberList::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& SVGAnimatedNumberList::wrapper_type_info_ = V8SVGAnimatedNumberList::wrapperTypeInfo;
...
static const V8DOMConfiguration::AccessorConfiguration V8SVGAnimatedNumberListAccessors[] = {
    { "baseVal", V8SVGAnimatedNumberList::baseValAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "animVal", V8SVGAnimatedNumberList::animValAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
};
...
static void installV8SVGAnimatedNumberListTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8SVGAnimatedNumberList::wrapperTypeInfo.interface_name, v8::Local<v8::FunctionTemplate>(), V8SVGAnimatedNumberList::internalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8SVGAnimatedNumberListAccessors, arraysize(V8SVGAnimatedNumberListAccessors));
...
SVGAnimatedNumberList* NativeValueTraits<SVGAnimatedNumberList>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  SVGAnimatedNumberList* nativeValue = V8SVGAnimatedNumberList::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
