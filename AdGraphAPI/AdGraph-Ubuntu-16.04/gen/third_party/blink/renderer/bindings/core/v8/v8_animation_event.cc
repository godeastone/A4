...
#endif
const WrapperTypeInfo V8AnimationEvent::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& AnimationEvent::wrapper_type_info_ = V8AnimationEvent::wrapperTypeInfo;
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kConstructionContext, "AnimationEvent");
...
void V8AnimationEvent::pseudoElementAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  AnimationEventV8Internal::pseudoElementAttributeGetter(info);
}
...
static const V8DOMConfiguration::AccessorConfiguration V8AnimationEventAccessors[] = {
    { "animationName", V8AnimationEvent::animationNameAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "elapsedTime", V8AnimationEvent::elapsedTimeAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "pseudoElement", V8AnimationEvent::pseudoElementAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "isTrusted", V8AnimationEvent::isTrustedAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::DontDelete | v8::ReadOnly), V8DOMConfiguration::kOnInstance, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
};
...
static void installV8AnimationEventTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8AnimationEvent::wrapperTypeInfo.interface_name, V8Event::domTemplate(isolate, world), V8AnimationEvent::internalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8AnimationEventAccessors, arraysize(V8AnimationEventAccessors));
...
AnimationEvent* NativeValueTraits<AnimationEvent>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  AnimationEvent* nativeValue = V8AnimationEvent::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
