...
template <>
struct NativeValueTraits<SVGStringListTearOff> : public NativeValueTraitsBase<SVGStringListTearOff> {
  CORE_EXPORT static SVGStringListTearOff* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static SVGStringListTearOff* NullValue() { return nullptr; }
};
