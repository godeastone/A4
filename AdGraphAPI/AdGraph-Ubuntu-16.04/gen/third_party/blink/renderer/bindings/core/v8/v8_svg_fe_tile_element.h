...
template <>
struct NativeValueTraits<SVGFETileElement> : public NativeValueTraitsBase<SVGFETileElement> {
  CORE_EXPORT static SVGFETileElement* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static SVGFETileElement* NullValue() { return nullptr; }
};
