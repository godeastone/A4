...
class CORE_EXPORT EventListenerOptionsOrBoolean final {
 ...
 public:
  ...
  bool IsEventListenerOptions() const { return type_ == SpecificType::kEventListenerOptions; }
 ...
 private:
  ...
  bool boolean_;
  EventListenerOptions event_listener_options_;
...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, EventListenerOptionsOrBoolean& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<EventListenerOptionsOrBoolean> : public NativeValueTraitsBase<EventListenerOptionsOrBoolean> {
  CORE_EXPORT static EventListenerOptionsOrBoolean NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static EventListenerOptionsOrBoolean NullValue() { return EventListenerOptionsOrBoolean(); }
};

template <>
struct V8TypeOf<EventListenerOptionsOrBoolean> {
  typedef V8EventListenerOptionsOrBoolean Type;
};
