...
#endif
const WrapperTypeInfo V8PerformancePaintTiming::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& PerformancePaintTiming::wrapper_type_info_ = V8PerformancePaintTiming::wrapperTypeInfo;
...
static void installV8PerformancePaintTimingTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8PerformancePaintTiming::wrapperTypeInfo.interface_name, V8PerformanceEntry::domTemplate(isolate, world), V8PerformancePaintTiming::internalFieldCount);
...
PerformancePaintTiming* NativeValueTraits<PerformancePaintTiming>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  PerformancePaintTiming* nativeValue = V8PerformancePaintTiming::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
