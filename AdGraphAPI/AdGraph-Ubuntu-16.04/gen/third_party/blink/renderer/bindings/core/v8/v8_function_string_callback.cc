...
v8::Maybe<void> V8FunctionStringCallback::Invoke(ScriptWrappable* callback_this_value, const String& data) {
  ...
  v8::Local<v8::Value> v8_data = V8String(GetIsolate(), data);
  v8::Local<v8::Value> argv[] = { v8_data };
...
void V8FunctionStringCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, const String& data) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      Invoke(callback_this_value, data);
  // An exception if any is killed with the v8::TryCatch above.
  ALLOW_UNUSED_LOCAL(maybe_result);
}

CORE_TEMPLATE_EXPORT
v8::Maybe<void> V8PersistentCallbackFunction<V8FunctionStringCallback>::Invoke(ScriptWrappable* callback_this_value, const String& data) {
  return Proxy()->Invoke(
      callback_this_value, data);
}

CORE_TEMPLATE_EXPORT
void V8PersistentCallbackFunction<V8FunctionStringCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, const String& data) {
