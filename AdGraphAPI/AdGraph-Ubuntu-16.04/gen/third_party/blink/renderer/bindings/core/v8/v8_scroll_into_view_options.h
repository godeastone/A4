...
// clang-format off
#ifndef V8ScrollIntoViewOptions_h
#define V8ScrollIntoViewOptions_h
...
class V8ScrollIntoViewOptions {
 public:
  CORE_EXPORT static void ToImpl(v8::Isolate*, v8::Local<v8::Value>, ScrollIntoViewOptions&, ExceptionState&);
};
...
#endif  // V8ScrollIntoViewOptions_h
