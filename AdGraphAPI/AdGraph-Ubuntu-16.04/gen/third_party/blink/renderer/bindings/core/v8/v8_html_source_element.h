...
template <>
struct NativeValueTraits<HTMLSourceElement> : public NativeValueTraitsBase<HTMLSourceElement> {
  CORE_EXPORT static HTMLSourceElement* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static HTMLSourceElement* NullValue() { return nullptr; }
};
