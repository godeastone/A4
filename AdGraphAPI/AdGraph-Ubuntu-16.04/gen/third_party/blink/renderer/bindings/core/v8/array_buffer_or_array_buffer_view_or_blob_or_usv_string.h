...
class CORE_EXPORT ArrayBufferOrArrayBufferViewOrBlobOrUSVString final {
 ...
 public:
  ...
  static ArrayBufferOrArrayBufferViewOrBlobOrUSVString FromArrayBufferView(NotShared<DOMArrayBufferView>);
  ...
  static ArrayBufferOrArrayBufferViewOrBlobOrUSVString FromUSVString(const String&);
...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, ArrayBufferOrArrayBufferViewOrBlobOrUSVString& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<ArrayBufferOrArrayBufferViewOrBlobOrUSVString> : public NativeValueTraitsBase<ArrayBufferOrArrayBufferViewOrBlobOrUSVString> {
  CORE_EXPORT static ArrayBufferOrArrayBufferViewOrBlobOrUSVString NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static ArrayBufferOrArrayBufferViewOrBlobOrUSVString NullValue() { return ArrayBufferOrArrayBufferViewOrBlobOrUSVString(); }
};

template <>
struct V8TypeOf<ArrayBufferOrArrayBufferViewOrBlobOrUSVString> {
  typedef V8ArrayBufferOrArrayBufferViewOrBlobOrUSVString Type;
};
