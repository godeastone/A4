...
v8::Maybe<void> V8MojoWatchCallback::Invoke(ScriptWrappable* callback_this_value, uint32_t result) {
  ...
  v8::Local<v8::Value> v8_result = v8::Integer::NewFromUnsigned(GetIsolate(), result);
  v8::Local<v8::Value> argv[] = { v8_result };
...
void V8MojoWatchCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, uint32_t result) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      Invoke(callback_this_value, result);
  // An exception if any is killed with the v8::TryCatch above.
  ALLOW_UNUSED_LOCAL(maybe_result);
}

CORE_TEMPLATE_EXPORT
v8::Maybe<void> V8PersistentCallbackFunction<V8MojoWatchCallback>::Invoke(ScriptWrappable* callback_this_value, uint32_t result) {
  return Proxy()->Invoke(
      callback_this_value, result);
}

CORE_TEMPLATE_EXPORT
void V8PersistentCallbackFunction<V8MojoWatchCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, uint32_t result) {
