...
#endif
const WrapperTypeInfo V8SVGMetadataElement::wrapperTypeInfo = {
    gin::kEmbedderBlink,
    V8SVGMetadataElement::domTemplate,
    nullptr,
    "SVGMetadataElement",
...
const WrapperTypeInfo& SVGMetadataElement::wrapper_type_info_ = V8SVGMetadataElement::wrapperTypeInfo;
...
static void installV8SVGMetadataElementTemplate(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
    v8::Local<v8::FunctionTemplate> interfaceTemplate) {
  // Initialize the interface object's template.
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8SVGMetadataElement::wrapperTypeInfo.interface_name, V8SVGElement::domTemplate(isolate, world), V8SVGMetadataElement::internalFieldCount);
  ...
  V8SVGMetadataElement::InstallRuntimeEnabledFeaturesOnTemplate(
      isolate, world, interfaceTemplate);
}

void V8SVGMetadataElement::InstallRuntimeEnabledFeaturesOnTemplate(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
...
SVGMetadataElement* NativeValueTraits<SVGMetadataElement>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  SVGMetadataElement* nativeValue = V8SVGMetadataElement::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
