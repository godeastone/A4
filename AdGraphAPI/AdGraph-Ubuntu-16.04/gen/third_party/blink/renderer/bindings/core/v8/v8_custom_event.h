...
class V8CustomEvent {
 ...
 public:
  ...
  CORE_EXPORT static void initCustomEventMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
...
template <>
struct NativeValueTraits<CustomEvent> : public NativeValueTraitsBase<CustomEvent> {
  CORE_EXPORT static CustomEvent* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static CustomEvent* NullValue() { return nullptr; }
};
