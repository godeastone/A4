...
class V8StyleSheet {
 ...
 public:
  ...
  CORE_EXPORT static void ownerNodeAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void parentStyleSheetAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
...
template <>
struct NativeValueTraits<StyleSheet> : public NativeValueTraitsBase<StyleSheet> {
  CORE_EXPORT static StyleSheet* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static StyleSheet* NullValue() { return nullptr; }
};
