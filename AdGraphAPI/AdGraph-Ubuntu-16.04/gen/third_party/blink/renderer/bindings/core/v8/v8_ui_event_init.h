...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, UIEventInit& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<UIEventInit> : public NativeValueTraitsBase<UIEventInit> {
  CORE_EXPORT static UIEventInit NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
