...
template <>
struct NativeValueTraits<SVGRectTearOff> : public NativeValueTraitsBase<SVGRectTearOff> {
  CORE_EXPORT static SVGRectTearOff* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static SVGRectTearOff* NullValue() { return nullptr; }
};
