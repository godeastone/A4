...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, PerformanceObserverInit& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<PerformanceObserverInit> : public NativeValueTraitsBase<PerformanceObserverInit> {
  CORE_EXPORT static PerformanceObserverInit NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
