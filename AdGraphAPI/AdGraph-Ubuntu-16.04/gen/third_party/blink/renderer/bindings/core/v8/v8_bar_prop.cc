...
#endif
const WrapperTypeInfo V8BarProp::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& BarProp::wrapper_type_info_ = V8BarProp::wrapperTypeInfo;
...
static const V8DOMConfiguration::AccessorConfiguration V8BarPropAccessors[] = {
    { "visible", V8BarProp::visibleAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
};
...
static void installV8BarPropTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8BarProp::wrapperTypeInfo.interface_name, v8::Local<v8::FunctionTemplate>(), V8BarProp::internalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8BarPropAccessors, arraysize(V8BarPropAccessors));
...
BarProp* NativeValueTraits<BarProp>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  BarProp* nativeValue = V8BarProp::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
