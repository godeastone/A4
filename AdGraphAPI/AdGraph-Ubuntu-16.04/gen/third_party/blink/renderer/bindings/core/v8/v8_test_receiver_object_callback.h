...
#ifndef V8TestReceiverObjectCallback_h
#define V8TestReceiverObjectCallback_h
...
class V8TestReceiverObjectCallback final : public CallbackFunctionBase {
 public:
  static V8TestReceiverObjectCallback* Create(v8::Local<v8::Function> callback_function) {
    return new V8TestReceiverObjectCallback(callback_function);
  }
...
#endif  // V8TestReceiverObjectCallback_h
