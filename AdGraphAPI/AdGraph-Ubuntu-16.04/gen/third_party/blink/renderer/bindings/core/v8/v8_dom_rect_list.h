...
// clang-format off
#ifndef V8DOMRectList_h
#define V8DOMRectList_h
...
class V8DOMRectList {
  STATIC_ONLY(V8DOMRectList);
 public:
  CORE_EXPORT static bool hasInstance(v8::Local<v8::Value>, v8::Isolate*);
  static v8::Local<v8::Object> findInstanceInPrototypeChain(v8::Local<v8::Value>, v8::Isolate*);
  CORE_EXPORT static v8::Local<v8::FunctionTemplate> domTemplate(v8::Isolate*, const DOMWrapperWorld&);
  static DOMRectList* ToImpl(v8::Local<v8::Object> object) {
    return ToScriptWrappable(object)->ToImpl<DOMRectList>();
  }
  CORE_EXPORT static DOMRectList* ToImplWithTypeCheck(v8::Isolate*, v8::Local<v8::Value>);
...
template <>
struct NativeValueTraits<DOMRectList> : public NativeValueTraitsBase<DOMRectList> {
  CORE_EXPORT static DOMRectList* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static DOMRectList* NullValue() { return nullptr; }
};

template <>
struct V8TypeOf<DOMRectList> {
  typedef V8DOMRectList Type;
};

}  // namespace blink

#endif  // V8DOMRectList_h
