...
class CORE_EXPORT V8VoidCallback final : public CallbackInterfaceBase {
 public:
  static V8VoidCallback* Create(v8::Local<v8::Object> callback_object) {
    return new V8VoidCallback(callback_object);
  }
  ...
  v8::Maybe<void> handleEvent(ScriptWrappable* callback_this_value) WARN_UNUSED_RESULT;
...
template <>
class CORE_TEMPLATE_CLASS_EXPORT V8PersistentCallbackInterface<V8VoidCallback> final : public V8PersistentCallbackInterfaceBase {
