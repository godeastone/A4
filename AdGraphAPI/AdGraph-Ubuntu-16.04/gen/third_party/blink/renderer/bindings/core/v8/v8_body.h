...
class V8Body {
 ...
 public:
  ...
  CORE_EXPORT static Body* ToImplWithTypeCheck(v8::Isolate*, v8::Local<v8::Value>);
...
template <>
struct NativeValueTraits<Body> : public NativeValueTraitsBase<Body> {
  CORE_EXPORT static Body* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static Body* NullValue() { return nullptr; }
};
