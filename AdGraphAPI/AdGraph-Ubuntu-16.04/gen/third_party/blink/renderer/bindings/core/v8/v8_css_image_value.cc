...
#endif
const WrapperTypeInfo V8CSSImageValue::wrapperTypeInfo = {
    gin::kEmbedderBlink,
    V8CSSImageValue::domTemplate,
    nullptr,
    "CSSImageValue",
...
const WrapperTypeInfo& CSSStyleImageValue::wrapper_type_info_ = V8CSSImageValue::wrapperTypeInfo;
...
static void installV8CSSImageValueTemplate(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
    v8::Local<v8::FunctionTemplate> interfaceTemplate) {
  // Initialize the interface object's template.
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8CSSImageValue::wrapperTypeInfo.interface_name, V8CSSStyleValue::domTemplate(isolate, world), V8CSSImageValue::internalFieldCount);
  ...
  V8CSSImageValue::InstallRuntimeEnabledFeaturesOnTemplate(
      isolate, world, interfaceTemplate);
}

void V8CSSImageValue::InstallRuntimeEnabledFeaturesOnTemplate(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
...
CSSStyleImageValue* NativeValueTraits<CSSStyleImageValue>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  CSSStyleImageValue* nativeValue = V8CSSImageValue::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
