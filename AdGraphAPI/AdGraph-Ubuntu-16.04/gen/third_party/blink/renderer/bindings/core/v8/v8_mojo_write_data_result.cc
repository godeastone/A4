...
static const v8::Eternal<v8::Name>* eternalV8MojoWriteDataResultKeys(v8::Isolate* isolate) {
...
void V8MojoWriteDataResult::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, MojoWriteDataResult& impl, ExceptionState& exceptionState) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8MojoWriteDataResultKeys(isolate);
...
v8::Local<v8::Value> MojoWriteDataResult::ToV8Impl(v8::Local<v8::Object> creationContext, v8::Isolate* isolate) const {
  v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
  if (!toV8MojoWriteDataResult(*this, v8Object, creationContext, isolate))
    return v8::Undefined(isolate);
  return v8Object;
}

bool toV8MojoWriteDataResult(const MojoWriteDataResult& impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  const v8::Eternal<v8::Name>* keys = eternalV8MojoWriteDataResultKeys(isolate);
  v8::Local<v8::Context> context = isolate->GetCurrentContext();
  v8::Local<v8::Value> numBytesValue;
...
MojoWriteDataResult NativeValueTraits<MojoWriteDataResult>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  MojoWriteDataResult impl;
  V8MojoWriteDataResult::ToImpl(isolate, value, impl, exceptionState);
  return impl;
}
