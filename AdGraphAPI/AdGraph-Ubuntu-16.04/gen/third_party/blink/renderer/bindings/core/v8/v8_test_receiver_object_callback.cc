...
v8::Maybe<void> V8TestReceiverObjectCallback::Invoke(ScriptWrappable* callback_this_value) {
...
void V8TestReceiverObjectCallback::InvokeAndReportException(ScriptWrappable* callback_this_value) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8TestReceiverObjectCallback>::Invoke(ScriptWrappable* callback_this_value) {
  return Proxy()->Invoke(
      callback_this_value);
}

void V8PersistentCallbackFunction<V8TestReceiverObjectCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value) {
