...
template <>
struct NativeValueTraits<FormData> : public NativeValueTraitsBase<FormData> {
  CORE_EXPORT static FormData* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static FormData* NullValue() { return nullptr; }
};
