...
template <>
struct NativeValueTraits<TouchList> : public NativeValueTraitsBase<TouchList> {
  CORE_EXPORT static TouchList* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static TouchList* NullValue() { return nullptr; }
};
