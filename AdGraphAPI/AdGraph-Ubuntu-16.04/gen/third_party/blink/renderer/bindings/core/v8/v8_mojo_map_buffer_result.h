...
// clang-format off
#ifndef V8MojoMapBufferResult_h
#define V8MojoMapBufferResult_h
...
class V8MojoMapBufferResult {
 public:
  CORE_EXPORT static void ToImpl(v8::Isolate*, v8::Local<v8::Value>, MojoMapBufferResult&, ExceptionState&);
};
