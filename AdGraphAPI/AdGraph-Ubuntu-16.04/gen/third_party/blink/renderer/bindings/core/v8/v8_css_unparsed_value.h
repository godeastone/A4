...
template <>
struct NativeValueTraits<CSSUnparsedValue> : public NativeValueTraitsBase<CSSUnparsedValue> {
  CORE_EXPORT static CSSUnparsedValue* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static CSSUnparsedValue* NullValue() { return nullptr; }
};
