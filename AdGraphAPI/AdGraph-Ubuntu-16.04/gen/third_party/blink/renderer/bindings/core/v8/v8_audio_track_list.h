...
template <>
struct NativeValueTraits<AudioTrackList> : public NativeValueTraitsBase<AudioTrackList> {
  CORE_EXPORT static AudioTrackList* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static AudioTrackList* NullValue() { return nullptr; }
};
