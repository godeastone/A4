...
class V8TestCallback final : public CallbackFunctionBase {
 public:
  static V8TestCallback* Create(v8::Local<v8::Function> callback_function) {
    return new V8TestCallback(callback_function);
  }
  ...
  v8::Maybe<String> Invoke(ScriptWrappable* callback_this_value, const String& message1, const String& message2) WARN_UNUSED_RESULT;
