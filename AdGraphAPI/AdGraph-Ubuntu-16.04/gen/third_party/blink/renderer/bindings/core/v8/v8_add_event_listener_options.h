...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, AddEventListenerOptions& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<AddEventListenerOptions> : public NativeValueTraitsBase<AddEventListenerOptions> {
  CORE_EXPORT static AddEventListenerOptions NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
