...
class V8WorkerInternals {
 ...
 public:
  ...
  static void countFeatureMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void countDeprecationMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void collectGarbageMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
...
template <>
struct NativeValueTraits<WorkerInternals> : public NativeValueTraitsBase<WorkerInternals> {
  static WorkerInternals* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  static WorkerInternals* NullValue() { return nullptr; }
};
