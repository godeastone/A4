...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, InternalDictionaryDerived& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<InternalDictionaryDerived> : public NativeValueTraitsBase<InternalDictionaryDerived> {
