...
const WrapperTypeInfo& DOMArrayBufferView::wrapper_type_info_ = V8ArrayBufferView::wrapperTypeInfo;
...
DOMArrayBufferView* NativeValueTraits<DOMArrayBufferView>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  DOMArrayBufferView* nativeValue = V8ArrayBufferView::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
