...
// clang-format off
#ifndef V8AccessibleNodeList_h
#define V8AccessibleNodeList_h
...
class V8AccessibleNodeList {
  STATIC_ONLY(V8AccessibleNodeList);
 public:
  CORE_EXPORT static bool hasInstance(v8::Local<v8::Value>, v8::Isolate*);
  static v8::Local<v8::Object> findInstanceInPrototypeChain(v8::Local<v8::Value>, v8::Isolate*);
  CORE_EXPORT static v8::Local<v8::FunctionTemplate> domTemplate(v8::Isolate*, const DOMWrapperWorld&);
  static AccessibleNodeList* ToImpl(v8::Local<v8::Object> object) {
    return ToScriptWrappable(object)->ToImpl<AccessibleNodeList>();
  }
  CORE_EXPORT static AccessibleNodeList* ToImplWithTypeCheck(v8::Isolate*, v8::Local<v8::Value>);
...
template <>
struct NativeValueTraits<AccessibleNodeList> : public NativeValueTraitsBase<AccessibleNodeList> {
  CORE_EXPORT static AccessibleNodeList* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static AccessibleNodeList* NullValue() { return nullptr; }
};

template <>
struct V8TypeOf<AccessibleNodeList> {
  typedef V8AccessibleNodeList Type;
};

}  // namespace blink

#endif  // V8AccessibleNodeList_h
