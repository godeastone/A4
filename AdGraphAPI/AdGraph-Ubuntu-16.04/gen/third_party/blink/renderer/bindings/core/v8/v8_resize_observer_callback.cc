...
v8::Maybe<void> V8ResizeObserverCallback::Invoke(ScriptWrappable* callback_this_value, const HeapVector<Member<ResizeObserverEntry>>& entries, ResizeObserver* observer) {
...
void V8ResizeObserverCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, const HeapVector<Member<ResizeObserverEntry>>& entries, ResizeObserver* observer) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8ResizeObserverCallback>::Invoke(ScriptWrappable* callback_this_value, const HeapVector<Member<ResizeObserverEntry>>& entries, ResizeObserver* observer) {
  return Proxy()->Invoke(
      callback_this_value, entries, observer);
}

CORE_TEMPLATE_EXPORT
void V8PersistentCallbackFunction<V8ResizeObserverCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, const HeapVector<Member<ResizeObserverEntry>>& entries, ResizeObserver* observer) {
