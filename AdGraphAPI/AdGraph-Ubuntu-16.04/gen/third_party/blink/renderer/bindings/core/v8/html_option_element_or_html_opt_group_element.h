...
class CORE_EXPORT HTMLOptionElementOrHTMLOptGroupElement final {
 ...
 public:
  ...
  bool IsHTMLOptGroupElement() const { return type_ == SpecificType::kHTMLOptGroupElement; }
  ...
  bool IsHTMLOptionElement() const { return type_ == SpecificType::kHTMLOptionElement; }
 ...
 private:
  ...
  Member<HTMLOptGroupElement> html_opt_group_element_;
  Member<HTMLOptionElement> html_option_element_;
...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, HTMLOptionElementOrHTMLOptGroupElement& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<HTMLOptionElementOrHTMLOptGroupElement> : public NativeValueTraitsBase<HTMLOptionElementOrHTMLOptGroupElement> {
  CORE_EXPORT static HTMLOptionElementOrHTMLOptGroupElement NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static HTMLOptionElementOrHTMLOptGroupElement NullValue() { return HTMLOptionElementOrHTMLOptGroupElement(); }
};

template <>
struct V8TypeOf<HTMLOptionElementOrHTMLOptGroupElement> {
  typedef V8HTMLOptionElementOrHTMLOptGroupElement Type;
};
