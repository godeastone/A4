...
template <>
struct NativeValueTraits<PerformanceMeasure> : public NativeValueTraitsBase<PerformanceMeasure> {
  CORE_EXPORT static PerformanceMeasure* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static PerformanceMeasure* NullValue() { return nullptr; }
};
