...
template <>
struct NativeValueTraits<HTMLCollection> : public NativeValueTraitsBase<HTMLCollection> {
  CORE_EXPORT static HTMLCollection* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static HTMLCollection* NullValue() { return nullptr; }
};
