...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, ElementRegistrationOptions& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<ElementRegistrationOptions> : public NativeValueTraitsBase<ElementRegistrationOptions> {
  CORE_EXPORT static ElementRegistrationOptions NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
