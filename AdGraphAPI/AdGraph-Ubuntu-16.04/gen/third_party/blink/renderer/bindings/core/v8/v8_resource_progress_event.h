...
template <>
struct NativeValueTraits<ResourceProgressEvent> : public NativeValueTraitsBase<ResourceProgressEvent> {
  CORE_EXPORT static ResourceProgressEvent* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static ResourceProgressEvent* NullValue() { return nullptr; }
};
