...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, MediaQueryListEventInit& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<MediaQueryListEventInit> : public NativeValueTraitsBase<MediaQueryListEventInit> {
  CORE_EXPORT static MediaQueryListEventInit NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
