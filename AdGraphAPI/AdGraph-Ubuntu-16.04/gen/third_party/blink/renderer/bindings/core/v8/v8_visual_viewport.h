...
class V8VisualViewport {
 ...
 public:
  ...
  CORE_EXPORT static void pageLeftAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void pageTopAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
...
template <>
struct NativeValueTraits<DOMVisualViewport> : public NativeValueTraitsBase<DOMVisualViewport> {
  CORE_EXPORT static DOMVisualViewport* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static DOMVisualViewport* NullValue() { return nullptr; }
};
