...
template <>
struct NativeValueTraits<SVGSetElement> : public NativeValueTraitsBase<SVGSetElement> {
  CORE_EXPORT static SVGSetElement* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static SVGSetElement* NullValue() { return nullptr; }
};
