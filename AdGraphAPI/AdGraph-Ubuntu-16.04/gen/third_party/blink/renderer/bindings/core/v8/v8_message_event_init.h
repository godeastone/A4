...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, MessageEventInit& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<MessageEventInit> : public NativeValueTraitsBase<MessageEventInit> {
  CORE_EXPORT static MessageEventInit NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
