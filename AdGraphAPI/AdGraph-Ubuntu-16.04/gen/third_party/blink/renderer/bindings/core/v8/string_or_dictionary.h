...
class CORE_EXPORT StringOrDictionary final {
 ...
 public:
  ...
  static StringOrDictionary FromString(const String&);
...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, StringOrDictionary& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<StringOrDictionary> : public NativeValueTraitsBase<StringOrDictionary> {
  CORE_EXPORT static StringOrDictionary NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static StringOrDictionary NullValue() { return StringOrDictionary(); }
};

template <>
struct V8TypeOf<StringOrDictionary> {
  typedef V8StringOrDictionary Type;
};
