...
class V8SVGFEMorphologyElement {
 ...
 public:
  ...
  // Callback functions
  CORE_EXPORT static void SVG_MORPHOLOGY_OPERATOR_UNKNOWNConstantGetterCallback(v8::Local<v8::Name>, const v8::PropertyCallbackInfo<v8::Value>&);
  CORE_EXPORT static void SVG_MORPHOLOGY_OPERATOR_ERODEConstantGetterCallback(v8::Local<v8::Name>, const v8::PropertyCallbackInfo<v8::Value>&);
  CORE_EXPORT static void SVG_MORPHOLOGY_OPERATOR_DILATEConstantGetterCallback(v8::Local<v8::Name>, const v8::PropertyCallbackInfo<v8::Value>&);
...
template <>
struct NativeValueTraits<SVGFEMorphologyElement> : public NativeValueTraitsBase<SVGFEMorphologyElement> {
  CORE_EXPORT static SVGFEMorphologyElement* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static SVGFEMorphologyElement* NullValue() { return nullptr; }
};
