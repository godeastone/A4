...
template <>
struct NativeValueTraits<SVGFEOffsetElement> : public NativeValueTraitsBase<SVGFEOffsetElement> {
  CORE_EXPORT static SVGFEOffsetElement* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static SVGFEOffsetElement* NullValue() { return nullptr; }
};
