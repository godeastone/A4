...
template <>
struct NativeValueTraits<StyleSheetList> : public NativeValueTraitsBase<StyleSheetList> {
  CORE_EXPORT static StyleSheetList* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static StyleSheetList* NullValue() { return nullptr; }
};
