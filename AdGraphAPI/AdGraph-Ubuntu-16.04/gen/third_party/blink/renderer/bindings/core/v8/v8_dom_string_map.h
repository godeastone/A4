...
template <>
struct NativeValueTraits<DOMStringMap> : public NativeValueTraitsBase<DOMStringMap> {
  CORE_EXPORT static DOMStringMap* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static DOMStringMap* NullValue() { return nullptr; }
};
