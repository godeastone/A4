...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, DOMMatrixInit& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<DOMMatrixInit> : public NativeValueTraitsBase<DOMMatrixInit> {
  CORE_EXPORT static DOMMatrixInit NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
