...
class V8SVGTransformList {
 ...
 public:
  ...
  CORE_EXPORT static void consolidateMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
...
template <>
struct NativeValueTraits<SVGTransformListTearOff> : public NativeValueTraitsBase<SVGTransformListTearOff> {
  CORE_EXPORT static SVGTransformListTearOff* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static SVGTransformListTearOff* NullValue() { return nullptr; }
};
