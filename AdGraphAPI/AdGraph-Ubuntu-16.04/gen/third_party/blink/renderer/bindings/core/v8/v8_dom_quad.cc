...
#endif
const WrapperTypeInfo V8DOMQuad::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& DOMQuad::wrapper_type_info_ = V8DOMQuad::wrapperTypeInfo;
...
static void fromRectMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "DOMQuad", "fromRect");
...
static void fromQuadMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "DOMQuad", "fromQuad");
  ...
  V8DOMQuadInit::ToImpl(info.GetIsolate(), info[0], other, exceptionState);
  if (exceptionState.HadException())
    return;
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kConstructionContext, "DOMQuad");
...
void V8DOMQuad::fromQuadMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  DOMQuadV8Internal::fromQuadMethod(info);
}
...
void V8DOMQuad::getBoundsMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  DOMQuadV8Internal::getBoundsMethod(info);
}
...
static const V8DOMConfiguration::AccessorConfiguration V8DOMQuadAccessors[] = {
    { "p1", V8DOMQuad::p1AttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "p2", V8DOMQuad::p2AttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "p3", V8DOMQuad::p3AttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
    { "p4", V8DOMQuad::p4AttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
};

static const V8DOMConfiguration::MethodConfiguration V8DOMQuadMethods[] = {
...
static void installV8DOMQuadTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8DOMQuad::wrapperTypeInfo.interface_name, v8::Local<v8::FunctionTemplate>(), V8DOMQuad::internalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8DOMQuadAccessors, arraysize(V8DOMQuadAccessors));
  V8DOMConfiguration::InstallMethods(
      isolate, world, instanceTemplate, prototypeTemplate, interfaceTemplate,
      signature, V8DOMQuadMethods, arraysize(V8DOMQuadMethods));
...
DOMQuad* NativeValueTraits<DOMQuad>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  DOMQuad* nativeValue = V8DOMQuad::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
