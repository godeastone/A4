...
v8::Maybe<void> V8ReportingObserverCallback::Invoke(ScriptWrappable* callback_this_value, const HeapVector<Member<Report>>& reports, ReportingObserver* observer) {
  ...
  v8::Local<v8::Value> v8_reports = ToV8(reports, argument_creation_context, GetIsolate());
  v8::Local<v8::Value> v8_observer = ToV8(observer, argument_creation_context, GetIsolate());
  v8::Local<v8::Value> argv[] = { v8_reports, v8_observer };
...
void V8ReportingObserverCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, const HeapVector<Member<Report>>& reports, ReportingObserver* observer) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      Invoke(callback_this_value, reports, observer);
  // An exception if any is killed with the v8::TryCatch above.
  ALLOW_UNUSED_LOCAL(maybe_result);
}

CORE_TEMPLATE_EXPORT
v8::Maybe<void> V8PersistentCallbackFunction<V8ReportingObserverCallback>::Invoke(ScriptWrappable* callback_this_value, const HeapVector<Member<Report>>& reports, ReportingObserver* observer) {
  return Proxy()->Invoke(
      callback_this_value, reports, observer);
}

CORE_TEMPLATE_EXPORT
void V8PersistentCallbackFunction<V8ReportingObserverCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, const HeapVector<Member<Report>>& reports, ReportingObserver* observer) {
