...
template <>
struct NativeValueTraits<HTMLStyleElement> : public NativeValueTraitsBase<HTMLStyleElement> {
  CORE_EXPORT static HTMLStyleElement* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static HTMLStyleElement* NullValue() { return nullptr; }
};
