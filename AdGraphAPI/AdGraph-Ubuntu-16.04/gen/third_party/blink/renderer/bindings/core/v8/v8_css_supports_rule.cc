...
#endif
const WrapperTypeInfo V8CSSSupportsRule::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& CSSSupportsRule::wrapper_type_info_ = V8CSSSupportsRule::wrapperTypeInfo;
...
static void installV8CSSSupportsRuleTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8CSSSupportsRule::wrapperTypeInfo.interface_name, V8CSSConditionRule::domTemplate(isolate, world), V8CSSSupportsRule::internalFieldCount);
...
CSSSupportsRule* NativeValueTraits<CSSSupportsRule>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  CSSSupportsRule* nativeValue = V8CSSSupportsRule::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
