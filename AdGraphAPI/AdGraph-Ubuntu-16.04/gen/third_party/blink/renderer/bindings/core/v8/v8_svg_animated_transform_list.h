...
template <>
struct NativeValueTraits<SVGAnimatedTransformList> : public NativeValueTraitsBase<SVGAnimatedTransformList> {
  CORE_EXPORT static SVGAnimatedTransformList* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static SVGAnimatedTransformList* NullValue() { return nullptr; }
};
