...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, ScrollStateInit& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<ScrollStateInit> : public NativeValueTraitsBase<ScrollStateInit> {
  CORE_EXPORT static ScrollStateInit NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
