...
template <>
struct NativeValueTraits<DOMUint8Array> : public NativeValueTraitsBase<DOMUint8Array> {
  CORE_EXPORT static DOMUint8Array* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static DOMUint8Array* NullValue() { return nullptr; }
};
