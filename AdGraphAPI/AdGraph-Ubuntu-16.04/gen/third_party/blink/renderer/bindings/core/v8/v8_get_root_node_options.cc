...
static const v8::Eternal<v8::Name>* eternalV8GetRootNodeOptionsKeys(v8::Isolate* isolate) {
...
void V8GetRootNodeOptions::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, GetRootNodeOptions& impl, ExceptionState& exceptionState) {
  ...
  const v8::Eternal<v8::Name>* keys = eternalV8GetRootNodeOptionsKeys(isolate);
  v8::TryCatch block(isolate);
  v8::Local<v8::Context> context = isolate->GetCurrentContext();
  v8::Local<v8::Value> composedValue;
  if (!v8Object->Get(context, keys[0].Get(isolate)).ToLocal(&composedValue)) {
...
bool toV8GetRootNodeOptions(const GetRootNodeOptions& impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (composedHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[0].Get(isolate), composedValue))) {
    return false;
  }
