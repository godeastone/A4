...
class V8InspectorOverlayHost {
 ...
 public:
  ...
  CORE_EXPORT static void resumeMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void stepOverMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
