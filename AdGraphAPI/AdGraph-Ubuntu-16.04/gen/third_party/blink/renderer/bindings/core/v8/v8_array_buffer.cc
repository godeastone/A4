...
const WrapperTypeInfo& DOMArrayBuffer::wrapper_type_info_ = V8ArrayBuffer::wrapperTypeInfo;
...
DOMArrayBuffer* NativeValueTraits<DOMArrayBuffer>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  DOMArrayBuffer* nativeValue = V8ArrayBuffer::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
