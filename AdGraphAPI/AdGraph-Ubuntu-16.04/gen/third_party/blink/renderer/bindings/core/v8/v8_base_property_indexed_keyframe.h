...
// clang-format off
#ifndef V8BasePropertyIndexedKeyframe_h
#define V8BasePropertyIndexedKeyframe_h
...
class V8BasePropertyIndexedKeyframe {
 public:
  CORE_EXPORT static void ToImpl(v8::Isolate*, v8::Local<v8::Value>, BasePropertyIndexedKeyframe&, ExceptionState&);
};
...
#endif  // V8BasePropertyIndexedKeyframe_h
