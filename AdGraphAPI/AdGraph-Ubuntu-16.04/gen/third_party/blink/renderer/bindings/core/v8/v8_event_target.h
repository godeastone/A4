...
class V8EventTarget {
 ...
 public:
  ...
  CORE_EXPORT static void addEventListenerMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void removeEventListenerMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void dispatchEventMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
...
template <>
struct NativeValueTraits<EventTarget> : public NativeValueTraitsBase<EventTarget> {
  CORE_EXPORT static EventTarget* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static EventTarget* NullValue() { return nullptr; }
};
