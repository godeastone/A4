...
#endif
const WrapperTypeInfo V8Float64Array::wrapperTypeInfo = {
    gin::kEmbedderBlink,
    nullptr,
    nullptr,
    "Float64Array",
...
DOMFloat64Array* NativeValueTraits<DOMFloat64Array>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  DOMFloat64Array* nativeValue = V8Float64Array::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
