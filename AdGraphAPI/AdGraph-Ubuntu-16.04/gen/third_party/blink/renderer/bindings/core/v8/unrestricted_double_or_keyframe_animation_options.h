...
// clang-format off
#ifndef UnrestrictedDoubleOrKeyframeAnimationOptions_h
#define UnrestrictedDoubleOrKeyframeAnimationOptions_h
...
class CORE_EXPORT UnrestrictedDoubleOrKeyframeAnimationOptions final {
 ...
 public:
  ...
  const KeyframeAnimationOptions& GetAsKeyframeAnimationOptions() const;
  void SetKeyframeAnimationOptions(const KeyframeAnimationOptions&);
  static UnrestrictedDoubleOrKeyframeAnimationOptions FromKeyframeAnimationOptions(const KeyframeAnimationOptions&);
 ...
 private:
  ...
  KeyframeAnimationOptions keyframe_animation_options_;
...
#endif  // UnrestrictedDoubleOrKeyframeAnimationOptions_h
