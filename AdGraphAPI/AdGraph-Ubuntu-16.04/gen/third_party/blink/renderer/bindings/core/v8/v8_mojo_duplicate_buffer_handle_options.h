...
// clang-format off
#ifndef V8MojoDuplicateBufferHandleOptions_h
#define V8MojoDuplicateBufferHandleOptions_h
...
class V8MojoDuplicateBufferHandleOptions {
 public:
  CORE_EXPORT static void ToImpl(v8::Isolate*, v8::Local<v8::Value>, MojoDuplicateBufferHandleOptions&, ExceptionState&);
};
...
#endif  // V8MojoDuplicateBufferHandleOptions_h
