...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, ScrollToOptions& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<ScrollToOptions> : public NativeValueTraitsBase<ScrollToOptions> {
  CORE_EXPORT static ScrollToOptions NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
