...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, TransitionEventInit& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<TransitionEventInit> : public NativeValueTraitsBase<TransitionEventInit> {
  CORE_EXPORT static TransitionEventInit NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
