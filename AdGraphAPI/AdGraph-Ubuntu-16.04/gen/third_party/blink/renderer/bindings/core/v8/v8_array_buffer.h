...
template <>
struct NativeValueTraits<DOMArrayBuffer> : public NativeValueTraitsBase<DOMArrayBuffer> {
  CORE_EXPORT static DOMArrayBuffer* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static DOMArrayBuffer* NullValue() { return nullptr; }
};
