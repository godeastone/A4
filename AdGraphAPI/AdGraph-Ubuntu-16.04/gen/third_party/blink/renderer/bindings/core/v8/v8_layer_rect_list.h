...
template <>
struct NativeValueTraits<LayerRectList> : public NativeValueTraitsBase<LayerRectList> {
  static LayerRectList* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  static LayerRectList* NullValue() { return nullptr; }
};
