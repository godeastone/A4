...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, PropertyDescriptor& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<PropertyDescriptor> : public NativeValueTraitsBase<PropertyDescriptor> {
  CORE_EXPORT static PropertyDescriptor NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
