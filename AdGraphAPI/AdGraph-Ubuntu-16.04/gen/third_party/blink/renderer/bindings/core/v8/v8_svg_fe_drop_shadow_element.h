...
template <>
struct NativeValueTraits<SVGFEDropShadowElement> : public NativeValueTraitsBase<SVGFEDropShadowElement> {
  CORE_EXPORT static SVGFEDropShadowElement* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static SVGFEDropShadowElement* NullValue() { return nullptr; }
};
