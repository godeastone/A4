...
// clang-format off
#ifndef ScrollIntoViewOptionsOrBoolean_h
#define ScrollIntoViewOptionsOrBoolean_h
...
class CORE_EXPORT ScrollIntoViewOptionsOrBoolean final {
 ...
 public:
  ...
  const ScrollIntoViewOptions& GetAsScrollIntoViewOptions() const;
  void SetScrollIntoViewOptions(const ScrollIntoViewOptions&);
  static ScrollIntoViewOptionsOrBoolean FromScrollIntoViewOptions(const ScrollIntoViewOptions&);
 ...
 private:
  ...
  bool boolean_;
  ScrollIntoViewOptions scroll_into_view_options_;
...
#endif  // ScrollIntoViewOptionsOrBoolean_h
