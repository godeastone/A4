...
class V8GCObservation {
 ...
 public:
  ...
  static void wasCollectedAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
...
template <>
struct NativeValueTraits<GCObservation> : public NativeValueTraitsBase<GCObservation> {
  static GCObservation* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  static GCObservation* NullValue() { return nullptr; }
};
