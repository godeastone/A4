...
template <>
struct NativeValueTraits<SVGAnimateElement> : public NativeValueTraitsBase<SVGAnimateElement> {
  CORE_EXPORT static SVGAnimateElement* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static SVGAnimateElement* NullValue() { return nullptr; }
};
