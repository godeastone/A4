...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, BlobPropertyBag& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<BlobPropertyBag> : public NativeValueTraitsBase<BlobPropertyBag> {
  CORE_EXPORT static BlobPropertyBag NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
