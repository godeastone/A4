...
template <>
struct NativeValueTraits<SVGSwitchElement> : public NativeValueTraitsBase<SVGSwitchElement> {
  CORE_EXPORT static SVGSwitchElement* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static SVGSwitchElement* NullValue() { return nullptr; }
};
