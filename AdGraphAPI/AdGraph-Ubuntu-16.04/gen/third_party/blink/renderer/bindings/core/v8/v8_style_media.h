...
class V8StyleMedia {
 ...
 public:
  ...
  CORE_EXPORT static void matchMediumMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
...
template <>
struct NativeValueTraits<StyleMedia> : public NativeValueTraitsBase<StyleMedia> {
  CORE_EXPORT static StyleMedia* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static StyleMedia* NullValue() { return nullptr; }
};
