...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, ErrorEventInit& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<ErrorEventInit> : public NativeValueTraitsBase<ErrorEventInit> {
  CORE_EXPORT static ErrorEventInit NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
