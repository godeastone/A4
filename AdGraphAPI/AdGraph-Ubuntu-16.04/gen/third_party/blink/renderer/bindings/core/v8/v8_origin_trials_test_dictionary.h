...
// clang-format off
#ifndef V8OriginTrialsTestDictionary_h
#define V8OriginTrialsTestDictionary_h
...
class V8OriginTrialsTestDictionary {
 public:
  static void ToImpl(v8::Isolate*, v8::Local<v8::Value>, OriginTrialsTestDictionary&, ExceptionState&);
};
...
#endif  // V8OriginTrialsTestDictionary_h
