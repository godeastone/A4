...
template <>
struct NativeValueTraits<SVGAnimatedLengthList> : public NativeValueTraitsBase<SVGAnimatedLengthList> {
  CORE_EXPORT static SVGAnimatedLengthList* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static SVGAnimatedLengthList* NullValue() { return nullptr; }
};
