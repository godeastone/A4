...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, AssignedNodesOptions& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<AssignedNodesOptions> : public NativeValueTraitsBase<AssignedNodesOptions> {
  CORE_EXPORT static AssignedNodesOptions NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
