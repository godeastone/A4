...
#endif
const WrapperTypeInfo V8HTMLBRElement::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& HTMLBRElement::wrapper_type_info_ = V8HTMLBRElement::wrapperTypeInfo;
...
void V8HTMLBRElement::clearAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
...
static const V8DOMConfiguration::AccessorConfiguration V8HTMLBRElementAccessors[] = {
    { "clear", V8HTMLBRElement::clearAttributeGetterCallback, V8HTMLBRElement::clearAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
};

void V8HTMLBRElement::constructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLBRElement_Constructor");

  if (!info.IsConstructCall()) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::ConstructorNotCallableAsFunction("HTMLBRElement"));
    return;
  }
  ...
  V8HTMLConstructor::HtmlConstructor(info, V8HTMLBRElement::wrapperTypeInfo, HTMLElementType::kHTMLBRElement);
}
...
static void installV8HTMLBRElementTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8HTMLBRElement::wrapperTypeInfo.interface_name, V8HTMLElement::domTemplate(isolate, world), V8HTMLBRElement::internalFieldCount);
  interfaceTemplate->SetCallHandler(V8HTMLBRElement::constructorCallback);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8HTMLBRElementAccessors, arraysize(V8HTMLBRElementAccessors));
...
HTMLBRElement* NativeValueTraits<HTMLBRElement>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  HTMLBRElement* nativeValue = V8HTMLBRElement::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
