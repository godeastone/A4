...
template <>
struct NativeValueTraits<DataTransferItemList> : public NativeValueTraitsBase<DataTransferItemList> {
  CORE_EXPORT static DataTransferItemList* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static DataTransferItemList* NullValue() { return nullptr; }
};
