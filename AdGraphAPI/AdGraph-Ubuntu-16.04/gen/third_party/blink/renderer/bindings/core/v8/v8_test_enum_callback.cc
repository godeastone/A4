...
v8::Maybe<void> V8TestEnumCallback::Invoke(ScriptWrappable* callback_this_value, const String& arg) {
...
#if DCHECK_IS_ON()
  {
    ...
    ExceptionState exception_state(GetIsolate(),
                                   ...
                                   "TestEnumCallback",
                                   "invoke");
    if (!IsValidEnum(arg, valid_arg_values, arraysize(valid_arg_values), "InternalEnum", exception_state)) {
      NOTREACHED();
      return v8::Nothing<void>();
    }
  }
...
void V8TestEnumCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, const String& arg) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8TestEnumCallback>::Invoke(ScriptWrappable* callback_this_value, const String& arg) {
  return Proxy()->Invoke(
      callback_this_value, arg);
}

void V8PersistentCallbackFunction<V8TestEnumCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, const String& arg) {
