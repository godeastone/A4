...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, EventInit& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<EventInit> : public NativeValueTraitsBase<EventInit> {
  CORE_EXPORT static EventInit NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
