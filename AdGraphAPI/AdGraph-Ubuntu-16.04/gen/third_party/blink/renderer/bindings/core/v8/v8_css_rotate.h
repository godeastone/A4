...
// clang-format off
#ifndef V8CSSRotate_h
#define V8CSSRotate_h
...
class V8CSSRotate {
  STATIC_ONLY(V8CSSRotate);
 public:
  CORE_EXPORT static bool hasInstance(v8::Local<v8::Value>, v8::Isolate*);
  static v8::Local<v8::Object> findInstanceInPrototypeChain(v8::Local<v8::Value>, v8::Isolate*);
  CORE_EXPORT static v8::Local<v8::FunctionTemplate> domTemplate(v8::Isolate*, const DOMWrapperWorld&);
  static CSSRotate* ToImpl(v8::Local<v8::Object> object) {
    return ToScriptWrappable(object)->ToImpl<CSSRotate>();
  }
  CORE_EXPORT static CSSRotate* ToImplWithTypeCheck(v8::Isolate*, v8::Local<v8::Value>);
  ...
  CORE_EXPORT static void angleAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
...
template <>
struct NativeValueTraits<CSSRotate> : public NativeValueTraitsBase<CSSRotate> {
  CORE_EXPORT static CSSRotate* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static CSSRotate* NullValue() { return nullptr; }
};

template <>
struct V8TypeOf<CSSRotate> {
  typedef V8CSSRotate Type;
};
