...
template <>
struct NativeValueTraits<DOMInt8Array> : public NativeValueTraitsBase<DOMInt8Array> {
  CORE_EXPORT static DOMInt8Array* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static DOMInt8Array* NullValue() { return nullptr; }
};
