...
template <>
struct NativeValueTraits<SVGLineElement> : public NativeValueTraitsBase<SVGLineElement> {
  CORE_EXPORT static SVGLineElement* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static SVGLineElement* NullValue() { return nullptr; }
};
