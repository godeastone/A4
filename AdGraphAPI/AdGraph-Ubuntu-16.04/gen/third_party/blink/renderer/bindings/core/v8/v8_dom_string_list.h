...
template <>
struct NativeValueTraits<DOMStringList> : public NativeValueTraitsBase<DOMStringList> {
  CORE_EXPORT static DOMStringList* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static DOMStringList* NullValue() { return nullptr; }
};
