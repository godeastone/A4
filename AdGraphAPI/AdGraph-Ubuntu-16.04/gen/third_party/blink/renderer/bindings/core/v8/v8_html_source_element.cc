...
#endif
const WrapperTypeInfo V8HTMLSourceElement::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& HTMLSourceElement::wrapper_type_info_ = V8HTMLSourceElement::wrapperTypeInfo;
...
static void srcAttributeSetter(v8::Local<v8::Value> v8Value, const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exceptionState(isolate, ExceptionState::kSetterContext, "HTMLSourceElement", "src");
...
static void srcsetAttributeSetter(v8::Local<v8::Value> v8Value, const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exceptionState(isolate, ExceptionState::kSetterContext, "HTMLSourceElement", "srcset");
...
void V8HTMLSourceElement::srcAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
...
void V8HTMLSourceElement::typeAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
...
void V8HTMLSourceElement::srcsetAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
...
void V8HTMLSourceElement::sizesAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
...
void V8HTMLSourceElement::mediaAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
...
void V8HTMLSourceElement::constructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLSourceElement_Constructor");

  if (!info.IsConstructCall()) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::ConstructorNotCallableAsFunction("HTMLSourceElement"));
    return;
  }
  ...
  V8HTMLConstructor::HtmlConstructor(info, V8HTMLSourceElement::wrapperTypeInfo, HTMLElementType::kHTMLSourceElement);
}
...
static void installV8HTMLSourceElementTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8HTMLSourceElement::wrapperTypeInfo.interface_name, V8HTMLElement::domTemplate(isolate, world), V8HTMLSourceElement::internalFieldCount);
  interfaceTemplate->SetCallHandler(V8HTMLSourceElement::constructorCallback);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8HTMLSourceElementAccessors, arraysize(V8HTMLSourceElementAccessors));
...
HTMLSourceElement* NativeValueTraits<HTMLSourceElement>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  HTMLSourceElement* nativeValue = V8HTMLSourceElement::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
