...
// clang-format off
#ifndef V8EffectTiming_h
#define V8EffectTiming_h
...
class V8EffectTiming {
 public:
  CORE_EXPORT static void ToImpl(v8::Isolate*, v8::Local<v8::Value>, EffectTiming&, ExceptionState&);
};
