...
template <>
struct NativeValueTraits<SVGLengthListTearOff> : public NativeValueTraitsBase<SVGLengthListTearOff> {
  CORE_EXPORT static SVGLengthListTearOff* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static SVGLengthListTearOff* NullValue() { return nullptr; }
};
