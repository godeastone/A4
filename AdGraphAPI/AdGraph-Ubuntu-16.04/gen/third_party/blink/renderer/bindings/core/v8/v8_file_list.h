...
template <>
struct NativeValueTraits<FileList> : public NativeValueTraitsBase<FileList> {
  CORE_EXPORT static FileList* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static FileList* NullValue() { return nullptr; }
};
