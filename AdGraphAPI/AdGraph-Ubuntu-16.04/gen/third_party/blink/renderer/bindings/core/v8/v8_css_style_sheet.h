...
class V8CSSStyleSheet {
 ...
 public:
  ...
  CORE_EXPORT static void ownerRuleAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  CORE_EXPORT static void insertRuleMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void deleteRuleMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void addRuleMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void removeRuleMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
...
template <>
struct NativeValueTraits<CSSStyleSheet> : public NativeValueTraitsBase<CSSStyleSheet> {
  CORE_EXPORT static CSSStyleSheet* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static CSSStyleSheet* NullValue() { return nullptr; }
};
