...
const WrapperTypeInfo V8HTMLParagraphElement::wrapperTypeInfo = {
    gin::kEmbedderBlink,
    V8HTMLParagraphElement::domTemplate,
    nullptr,
...
const WrapperTypeInfo& HTMLParagraphElement::wrapper_type_info_ = V8HTMLParagraphElement::wrapperTypeInfo;
...
void V8HTMLParagraphElement::alignAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
...
void V8HTMLParagraphElement::alignAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
...
static const V8DOMConfiguration::AccessorConfiguration V8HTMLParagraphElementAccessors[] = {
    { "align", V8HTMLParagraphElement::alignAttributeGetterCallback, V8HTMLParagraphElement::alignAttributeSetterCallback, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
};
...
static void installV8HTMLParagraphElementTemplate(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
    v8::Local<v8::FunctionTemplate> interfaceTemplate) {
  // Initialize the interface object's template.
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8HTMLParagraphElement::wrapperTypeInfo.interface_name, V8HTMLElement::domTemplate(isolate, world), V8HTMLParagraphElement::internalFieldCount);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8HTMLParagraphElementAccessors, arraysize(V8HTMLParagraphElementAccessors));

  // Custom signature

  V8HTMLParagraphElement::InstallRuntimeEnabledFeaturesOnTemplate(
      isolate, world, interfaceTemplate);
}

void V8HTMLParagraphElement::InstallRuntimeEnabledFeaturesOnTemplate(
    v8::Isolate* isolate,
    const DOMWrapperWorld& world,
...
HTMLParagraphElement* NativeValueTraits<HTMLParagraphElement>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  HTMLParagraphElement* nativeValue = V8HTMLParagraphElement::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
