...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, DOMPointInit& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<DOMPointInit> : public NativeValueTraitsBase<DOMPointInit> {
  CORE_EXPORT static DOMPointInit NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
