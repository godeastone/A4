...
v8::Maybe<void> V8VoidFunction::Invoke(ScriptWrappable* callback_this_value) {
...
void V8VoidFunction::InvokeAndReportException(ScriptWrappable* callback_this_value) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8VoidFunction>::Invoke(ScriptWrappable* callback_this_value) {
  return Proxy()->Invoke(
      callback_this_value);
}

CORE_TEMPLATE_EXPORT
void V8PersistentCallbackFunction<V8VoidFunction>::InvokeAndReportException(ScriptWrappable* callback_this_value) {
