...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, InputEventInit& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<InputEventInit> : public NativeValueTraitsBase<InputEventInit> {
  CORE_EXPORT static InputEventInit NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
