...
template <>
struct NativeValueTraits<TextTrackList> : public NativeValueTraitsBase<TextTrackList> {
  CORE_EXPORT static TextTrackList* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static TextTrackList* NullValue() { return nullptr; }
};
