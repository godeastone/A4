...
template <>
struct NativeValueTraits<CSSMediaRule> : public NativeValueTraitsBase<CSSMediaRule> {
  CORE_EXPORT static CSSMediaRule* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static CSSMediaRule* NullValue() { return nullptr; }
};
