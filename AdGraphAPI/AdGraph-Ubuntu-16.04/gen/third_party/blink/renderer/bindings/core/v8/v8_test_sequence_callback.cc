...
v8::Maybe<Vector<String>> V8TestSequenceCallback::Invoke(ScriptWrappable* callback_this_value, const Vector<int32_t>& numbers) {
  ...
  v8::Local<v8::Value> v8_numbers = ToV8(numbers, argument_creation_context, GetIsolate());
  v8::Local<v8::Value> argv[] = { v8_numbers };
...
v8::Maybe<Vector<String>> V8PersistentCallbackFunction<V8TestSequenceCallback>::Invoke(ScriptWrappable* callback_this_value, const Vector<int32_t>& numbers) {
  return Proxy()->Invoke(
      callback_this_value, numbers);
}
