...
void V8KeyframeAnimationOptions::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, KeyframeAnimationOptions& impl, ExceptionState& exceptionState) {
...
KeyframeAnimationOptions NativeValueTraits<KeyframeAnimationOptions>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  KeyframeAnimationOptions impl;
  V8KeyframeAnimationOptions::ToImpl(isolate, value, impl, exceptionState);
  return impl;
}
