...
// clang-format off
#ifndef V8MojoCreateMessagePipeResult_h
#define V8MojoCreateMessagePipeResult_h
...
class V8MojoCreateMessagePipeResult {
 public:
  CORE_EXPORT static void ToImpl(v8::Isolate*, v8::Local<v8::Value>, MojoCreateMessagePipeResult&, ExceptionState&);
};
...
#endif  // V8MojoCreateMessagePipeResult_h
