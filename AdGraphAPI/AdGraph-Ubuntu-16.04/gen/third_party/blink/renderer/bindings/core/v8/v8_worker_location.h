...
template <>
struct NativeValueTraits<WorkerLocation> : public NativeValueTraitsBase<WorkerLocation> {
  CORE_EXPORT static WorkerLocation* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static WorkerLocation* NullValue() { return nullptr; }
};
