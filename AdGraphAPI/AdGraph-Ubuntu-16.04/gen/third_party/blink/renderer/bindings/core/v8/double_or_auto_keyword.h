...
class CORE_EXPORT DoubleOrAutoKeyword final {
 ...
 public:
  ...
  bool IsAutoKeyword() const { return type_ == SpecificType::kAutoKeyword; }
  const String& GetAsAutoKeyword() const;
  void SetAutoKeyword(const String&);
  static DoubleOrAutoKeyword FromAutoKeyword(const String&);
...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, DoubleOrAutoKeyword& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<DoubleOrAutoKeyword> : public NativeValueTraitsBase<DoubleOrAutoKeyword> {
  CORE_EXPORT static DoubleOrAutoKeyword NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
  CORE_EXPORT static DoubleOrAutoKeyword NullValue() { return DoubleOrAutoKeyword(); }
};

template <>
struct V8TypeOf<DoubleOrAutoKeyword> {
  typedef V8DoubleOrAutoKeyword Type;
};
