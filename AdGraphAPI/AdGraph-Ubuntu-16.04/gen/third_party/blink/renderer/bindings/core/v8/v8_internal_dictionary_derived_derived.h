...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, InternalDictionaryDerivedDerived& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<InternalDictionaryDerivedDerived> : public NativeValueTraitsBase<InternalDictionaryDerivedDerived> {
