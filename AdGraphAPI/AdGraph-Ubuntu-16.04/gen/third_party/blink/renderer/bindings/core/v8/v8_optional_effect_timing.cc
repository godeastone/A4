...
void V8OptionalEffectTiming::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, OptionalEffectTiming& impl, ExceptionState& exceptionState) {
...
OptionalEffectTiming NativeValueTraits<OptionalEffectTiming>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  OptionalEffectTiming impl;
  V8OptionalEffectTiming::ToImpl(isolate, value, impl, exceptionState);
  return impl;
}
