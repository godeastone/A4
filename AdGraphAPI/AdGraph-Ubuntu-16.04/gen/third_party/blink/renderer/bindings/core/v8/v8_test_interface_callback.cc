...
v8::Maybe<void> V8TestInterfaceCallback::Invoke(ScriptWrappable* callback_this_value, HTMLDivElement* divElement) {
...
void V8TestInterfaceCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, HTMLDivElement* divElement) {
...
v8::Maybe<void> V8PersistentCallbackFunction<V8TestInterfaceCallback>::Invoke(ScriptWrappable* callback_this_value, HTMLDivElement* divElement) {
  return Proxy()->Invoke(
      callback_this_value, divElement);
}

void V8PersistentCallbackFunction<V8TestInterfaceCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, HTMLDivElement* divElement) {
