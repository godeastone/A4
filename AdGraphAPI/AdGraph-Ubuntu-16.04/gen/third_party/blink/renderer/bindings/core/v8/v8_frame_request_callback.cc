...
v8::Maybe<void> V8FrameRequestCallback::Invoke(ScriptWrappable* callback_this_value, double highResTime) {
  ...
  v8::Local<v8::Value> v8_highResTime = v8::Number::New(GetIsolate(), highResTime);
  v8::Local<v8::Value> argv[] = { v8_highResTime };
...
void V8FrameRequestCallback::InvokeAndReportException(ScriptWrappable* callback_this_value, double highResTime) {
  v8::TryCatch try_catch(GetIsolate());
  try_catch.SetVerbose(true);

  v8::Maybe<void> maybe_result =
      Invoke(callback_this_value, highResTime);
  // An exception if any is killed with the v8::TryCatch above.
  ALLOW_UNUSED_LOCAL(maybe_result);
}

CORE_TEMPLATE_EXPORT
v8::Maybe<void> V8PersistentCallbackFunction<V8FrameRequestCallback>::Invoke(ScriptWrappable* callback_this_value, double highResTime) {
  return Proxy()->Invoke(
      callback_this_value, highResTime);
}

CORE_TEMPLATE_EXPORT
void V8PersistentCallbackFunction<V8FrameRequestCallback>::InvokeAndReportException(ScriptWrappable* callback_this_value, double highResTime) {
