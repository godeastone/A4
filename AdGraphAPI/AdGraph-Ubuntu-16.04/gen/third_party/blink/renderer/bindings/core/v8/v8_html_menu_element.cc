...
#endif
const WrapperTypeInfo V8HTMLMenuElement::wrapperTypeInfo = {
    gin::kEmbedderBlink,
...
const WrapperTypeInfo& HTMLMenuElement::wrapper_type_info_ = V8HTMLMenuElement::wrapperTypeInfo;
...
static void compactAttributeSetter(v8::Local<v8::Value> v8Value, const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  ExceptionState exceptionState(isolate, ExceptionState::kSetterContext, "HTMLMenuElement", "compact");
...
void V8HTMLMenuElement::compactAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
...
void V8HTMLMenuElement::constructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLMenuElement_Constructor");

  if (!info.IsConstructCall()) {
    V8ThrowException::ThrowTypeError(info.GetIsolate(), ExceptionMessages::ConstructorNotCallableAsFunction("HTMLMenuElement"));
    return;
  }
  ...
  V8HTMLConstructor::HtmlConstructor(info, V8HTMLMenuElement::wrapperTypeInfo, HTMLElementType::kHTMLMenuElement);
}
...
static void installV8HTMLMenuElementTemplate(
  ...
  V8DOMConfiguration::InitializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8HTMLMenuElement::wrapperTypeInfo.interface_name, V8HTMLElement::domTemplate(isolate, world), V8HTMLMenuElement::internalFieldCount);
  interfaceTemplate->SetCallHandler(V8HTMLMenuElement::constructorCallback);
  ...
  V8DOMConfiguration::InstallAccessors(
      ...
      signature, V8HTMLMenuElementAccessors, arraysize(V8HTMLMenuElementAccessors));
...
HTMLMenuElement* NativeValueTraits<HTMLMenuElement>::NativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  HTMLMenuElement* nativeValue = V8HTMLMenuElement::ToImplWithTypeCheck(isolate, value);
  if (!nativeValue) {
