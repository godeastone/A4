...
template <class CallbackInfo>
inline void V8SetReturnValue(const CallbackInfo& callbackInfo, FilePropertyBag& impl, v8::Local<v8::Object> creationContext) {
  V8SetReturnValue(callbackInfo, ToV8(impl, creationContext, callbackInfo.GetIsolate()));
}

template <>
struct NativeValueTraits<FilePropertyBag> : public NativeValueTraitsBase<FilePropertyBag> {
  CORE_EXPORT static FilePropertyBag NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
