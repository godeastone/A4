...
#ifndef THIRD_PARTY_BLINK_PUBLIC_WEB_REMOTE_OBJECTS_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_WEB_REMOTE_OBJECTS_MOJOM_BLINK_H_
...
#include "third_party/blink/public/web/remote_objects.mojom-shared.h"
...
using RevocableRemoteObjectPtr = ::blink::RevocableInterfacePtr<RemoteObject>;
...
class BLINK_PLATFORM_EXPORT RemoteObject
...
class BLINK_PLATFORM_EXPORT RemoteObjectInterceptorForTesting : public RemoteObject {
...
class BLINK_PLATFORM_EXPORT RemoteObjectAsyncWaiter {
 public:
...
class BLINK_PLATFORM_EXPORT RemoteObjectProxy
    : public RemoteObject {
 public:
...
class BLINK_PLATFORM_EXPORT RemoteObjectStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT RemoteObjectRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class BLINK_PLATFORM_EXPORT RemoteObjectResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
class BLINK_PLATFORM_EXPORT RemoteInvocationArgument {
 public:
...
class BLINK_PLATFORM_EXPORT RemoteInvocationResultValue {
 public:
...
class BLINK_PLATFORM_EXPORT RemoteInvocationResult {
 public:
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::RemoteInvocationResult::DataView,
...
template <>
struct BLINK_PLATFORM_EXPORT UnionTraits<::blink::mojom::blink::RemoteInvocationArgument::DataView,
...
template <>
struct BLINK_PLATFORM_EXPORT UnionTraits<::blink::mojom::blink::RemoteInvocationResultValue::DataView,
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_WEB_REMOTE_OBJECTS_MOJOM_BLINK_H_