...
void DevToolsAgentProxy::AttachDevToolsSession(
    DevToolsSessionHostAssociatedPtrInfo in_host, DevToolsSessionAssociatedRequest in_session, DevToolsSessionRequest in_io_session, const WTF::String& in_reattach_state) {
...
void DevToolsAgentInterceptorForTesting::AttachDevToolsSession(DevToolsSessionHostAssociatedPtrInfo host, DevToolsSessionAssociatedRequest session, DevToolsSessionRequest io_session, const WTF::String& reattach_state) {
...
void DevToolsSessionProxy::DispatchProtocolCommand(
    int32_t in_call_id, const WTF::String& in_method, const WTF::String& in_message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void DevToolsSessionInterceptorForTesting::DispatchProtocolCommand(int32_t call_id, const WTF::String& method, const WTF::String& message) {
...
void DevToolsSessionHostProxy::DispatchProtocolResponse(
    const WTF::String& in_message, int32_t in_call_id, const WTF::String& in_state) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void DevToolsSessionHostProxy::DispatchProtocolNotification(
    const WTF::String& in_message, const WTF::String& in_state) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void DevToolsSessionHostInterceptorForTesting::DispatchProtocolResponse(const WTF::String& message, int32_t call_id, const WTF::String& state) {
  GetForwardingInterface()->DispatchProtocolResponse(std::move(message), std::move(call_id), std::move(state));
}
void DevToolsSessionHostInterceptorForTesting::DispatchProtocolNotification(const WTF::String& message, const WTF::String& state) {
