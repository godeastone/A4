...
#include "third_party/blink/public/web/devtools_frontend.mojom-shared-message-ids.h"
namespace blink {
namespace mojom {
...
void DevToolsFrontendProxy::SetupDevToolsFrontend(
    const std::string& in_api_script, DevToolsFrontendHostAssociatedPtrInfo in_host) {
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::DevToolsFrontend::SetupDevToolsFrontend",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            ...
            "DevToolsFrontend::SetupDevToolsFrontend deserializer");
        return false;
      }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::DevToolsFrontend::SetupDevToolsExtensionAPI",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "DevToolsFrontend::SetupDevToolsExtensionAPI deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::DevToolsFrontendHost::DispatchEmbedderMessage",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "DevToolsFrontendHost::DispatchEmbedderMessage deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
