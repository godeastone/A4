...
#ifndef THIRD_PARTY_BLINK_PUBLIC_WEB_DEVTOOLS_FRONTEND_MOJOM_H_
#define THIRD_PARTY_BLINK_PUBLIC_WEB_DEVTOOLS_FRONTEND_MOJOM_H_
...
class CONTENT_EXPORT DevToolsFrontend
 ...
 public:
  ...
  virtual void SetupDevToolsFrontend(const std::string& api_script, DevToolsFrontendHostAssociatedPtrInfo host) = 0;

  virtual void SetupDevToolsExtensionAPI(const std::string& extension_api) = 0;
};
class CONTENT_EXPORT DevToolsFrontendInterceptorForTesting : public DevToolsFrontend {
...
class CONTENT_EXPORT DevToolsFrontendAsyncWaiter {
 public:
...
class CONTENT_EXPORT DevToolsFrontendHost
...
class CONTENT_EXPORT DevToolsFrontendHostInterceptorForTesting : public DevToolsFrontendHost {
  virtual DevToolsFrontendHost* GetForwardingInterface() = 0;
  void DispatchEmbedderMessage(const std::string& message) override;
};
class CONTENT_EXPORT DevToolsFrontendHostAsyncWaiter {
 public:
...
class CONTENT_EXPORT DevToolsFrontendProxy
    : public DevToolsFrontend {
 public:
  explicit DevToolsFrontendProxy(mojo::MessageReceiverWithResponder* receiver);
  void SetupDevToolsFrontend(const std::string& api_script, DevToolsFrontendHostAssociatedPtrInfo host) final;
...
class CONTENT_EXPORT DevToolsFrontendHostProxy
...
class CONTENT_EXPORT DevToolsFrontendStubDispatch {
 public:
...
class CONTENT_EXPORT DevToolsFrontendHostStubDispatch {
 public:
...
class CONTENT_EXPORT DevToolsFrontendRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class CONTENT_EXPORT DevToolsFrontendHostRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_WEB_DEVTOOLS_FRONTEND_MOJOM_H_