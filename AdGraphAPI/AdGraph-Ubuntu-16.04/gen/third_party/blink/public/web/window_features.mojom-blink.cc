...
#include "third_party/blink/public/web/window_features.mojom-blink.h"
...
#include "third_party/blink/public/web/window_features.mojom-shared-message-ids.h"
...
size_t WindowFeatures::Hash(size_t seed) const {
  ...
  seed = mojo::internal::WTFHash(seed, this->has_x);
  seed = mojo::internal::WTFHash(seed, this->y);
  seed = mojo::internal::WTFHash(seed, this->has_y);
  ...
  seed = mojo::internal::WTFHash(seed, this->menu_bar_visible);
  seed = mojo::internal::WTFHash(seed, this->status_bar_visible);
  seed = mojo::internal::WTFHash(seed, this->tool_bar_visible);
  seed = mojo::internal::WTFHash(seed, this->scrollbars_visible);
  return seed;
}
