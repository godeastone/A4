...
bool WorkerContentSettingsProxy::AllowIndexedDB(const WTF::String& name, bool* out_result) {
  NOTREACHED();
  return false;
}
...
bool WorkerContentSettingsProxyProxy::AllowIndexedDB(
    const WTF::String& param_name, bool* out_param_result) {
...
void WorkerContentSettingsProxyProxy::AllowIndexedDB(
    const WTF::String& in_name, AllowIndexedDBCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::WorkerContentSettingsProxy::AllowIndexedDB");
#endif
  const bool kExpectsResponse = true;
...
void WorkerContentSettingsProxyInterceptorForTesting::AllowIndexedDB(const WTF::String& name, AllowIndexedDBCallback callback) {
