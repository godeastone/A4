...
#ifndef THIRD_PARTY_BLINK_PUBLIC_WEB_REMOTE_OBJECTS_MOJOM_H_
#define THIRD_PARTY_BLINK_PUBLIC_WEB_REMOTE_OBJECTS_MOJOM_H_
...
class CONTENT_EXPORT RemoteObject
...
class CONTENT_EXPORT RemoteObjectInterceptorForTesting : public RemoteObject {
...
class CONTENT_EXPORT RemoteObjectAsyncWaiter {
 public:
...
class CONTENT_EXPORT RemoteObjectProxy
    : public RemoteObject {
 public:
...
class CONTENT_EXPORT RemoteObjectStubDispatch {
 public:
...
class CONTENT_EXPORT RemoteObjectRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class CONTENT_EXPORT RemoteObjectResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
class CONTENT_EXPORT RemoteInvocationArgument {
 public:
...
class CONTENT_EXPORT RemoteInvocationResultValue {
 public:
...
class CONTENT_EXPORT RemoteInvocationResult {
 public:
...
template <>
struct CONTENT_EXPORT StructTraits<::blink::mojom::RemoteInvocationResult::DataView,
...
template <>
struct CONTENT_EXPORT UnionTraits<::blink::mojom::RemoteInvocationArgument::DataView,
...
template <>
struct CONTENT_EXPORT UnionTraits<::blink::mojom::RemoteInvocationResultValue::DataView,
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_WEB_REMOTE_OBJECTS_MOJOM_H_