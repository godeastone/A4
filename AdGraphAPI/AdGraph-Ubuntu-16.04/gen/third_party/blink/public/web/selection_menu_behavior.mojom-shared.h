...
#ifndef THIRD_PARTY_BLINK_PUBLIC_WEB_SELECTION_MENU_BEHAVIOR_MOJOM_SHARED_H_
#define THIRD_PARTY_BLINK_PUBLIC_WEB_SELECTION_MENU_BEHAVIOR_MOJOM_SHARED_H_
...
inline std::ostream& operator<<(std::ostream& os, SelectionMenuBehavior value) {
  switch(value) {
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_WEB_SELECTION_MENU_BEHAVIOR_MOJOM_SHARED_H_
