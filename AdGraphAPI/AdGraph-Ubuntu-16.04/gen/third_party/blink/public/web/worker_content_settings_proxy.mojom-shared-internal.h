...
#ifndef THIRD_PARTY_BLINK_PUBLIC_WEB_WORKER_CONTENT_SETTINGS_PROXY_MOJOM_SHARED_INTERNAL_H_
#define THIRD_PARTY_BLINK_PUBLIC_WEB_WORKER_CONTENT_SETTINGS_PROXY_MOJOM_SHARED_INTERNAL_H_
...
#pragma pack(push, 1)
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) WorkerContentSettingsProxy_AllowIndexedDB_Params_Data {
 public:
  class BufferWriter {
   public:
...
static_assert(sizeof(WorkerContentSettingsProxy_AllowIndexedDB_Params_Data) == 16,
              "Bad sizeof(WorkerContentSettingsProxy_AllowIndexedDB_Params_Data)");
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) WorkerContentSettingsProxy_AllowIndexedDB_ResponseParams_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
...
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) WorkerContentSettingsProxy_RequestFileSystemAccessSync_Params_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
...
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) WorkerContentSettingsProxy_RequestFileSystemAccessSync_ResponseParams_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_WEB_WORKER_CONTENT_SETTINGS_PROXY_MOJOM_SHARED_INTERNAL_H_