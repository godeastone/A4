...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_INPUT_HOST_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_INPUT_HOST_MOJOM_BLINK_H_
...
#include "third_party/blink/public/platform/input_host.mojom-shared.h"
...
using RevocableTextSuggestionHostPtr = ::blink::RevocableInterfacePtr<TextSuggestionHost>;
...
class BLINK_PLATFORM_EXPORT TextSuggestionHost
...
class BLINK_PLATFORM_EXPORT TextSuggestionHostInterceptorForTesting : public TextSuggestionHost {
...
class BLINK_PLATFORM_EXPORT TextSuggestionHostAsyncWaiter {
 public:
...
class BLINK_PLATFORM_EXPORT TextSuggestionHostProxy
...
class BLINK_PLATFORM_EXPORT TextSuggestionHostStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT TextSuggestionHostRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};


class BLINK_PLATFORM_EXPORT SpellCheckSuggestion {
 public:
...
class BLINK_PLATFORM_EXPORT TextSuggestion {
 public:
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::SpellCheckSuggestion::DataView,
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::TextSuggestion::DataView,
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_INPUT_HOST_MOJOM_BLINK_H_