...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_SITE_ENGAGEMENT_MOJOM_SHARED_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_SITE_ENGAGEMENT_MOJOM_SHARED_H_
...
#include "third_party/blink/public/platform/site_engagement.mojom-shared-internal.h"
...
using EngagementClientPtrDataView =
    mojo::InterfacePtrDataView<EngagementClientInterfaceBase>;
using EngagementClientRequestDataView =
    mojo::InterfaceRequestDataView<EngagementClientInterfaceBase>;
using EngagementClientAssociatedPtrInfoDataView =
    mojo::AssociatedInterfacePtrInfoDataView<EngagementClientInterfaceBase>;
using EngagementClientAssociatedRequestDataView =
    mojo::AssociatedInterfaceRequestDataView<EngagementClientInterfaceBase>;
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_SITE_ENGAGEMENT_MOJOM_SHARED_H_
