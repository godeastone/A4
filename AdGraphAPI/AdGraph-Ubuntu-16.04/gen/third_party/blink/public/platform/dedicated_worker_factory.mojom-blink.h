...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_DEDICATED_WORKER_FACTORY_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_DEDICATED_WORKER_FACTORY_MOJOM_BLINK_H_
...
namespace mojom {
namespace blink {
BLINK_PLATFORM_EXPORT extern const char kNavigation_DedicatedWorkerSpec[];
class DedicatedWorkerFactory;
using DedicatedWorkerFactoryPtr = mojo::InterfacePtr<DedicatedWorkerFactory>;
using RevocableDedicatedWorkerFactoryPtr = ::blink::RevocableInterfacePtr<DedicatedWorkerFactory>;
...
class BLINK_PLATFORM_EXPORT DedicatedWorkerFactory
 ...
 public:
  ...
  virtual void CreateDedicatedWorker(const scoped_refptr<const ::blink::SecurityOrigin>& origin, ::service_manager::mojom::blink::InterfaceProviderRequest worker_interface_provider) = 0;
};
class BLINK_PLATFORM_EXPORT DedicatedWorkerFactoryInterceptorForTesting : public DedicatedWorkerFactory {
  virtual DedicatedWorkerFactory* GetForwardingInterface() = 0;
  void CreateDedicatedWorker(const scoped_refptr<const ::blink::SecurityOrigin>& origin, ::service_manager::mojom::blink::InterfaceProviderRequest worker_interface_provider) override;
};
class BLINK_PLATFORM_EXPORT DedicatedWorkerFactoryAsyncWaiter {
 public:
...
class BLINK_PLATFORM_EXPORT DedicatedWorkerFactoryProxy
    : public DedicatedWorkerFactory {
 public:
  explicit DedicatedWorkerFactoryProxy(mojo::MessageReceiverWithResponder* receiver);
  void CreateDedicatedWorker(const scoped_refptr<const ::blink::SecurityOrigin>& origin, ::service_manager::mojom::blink::InterfaceProviderRequest worker_interface_provider) final;

 private:
  mojo::MessageReceiverWithResponder* receiver_;
};
class BLINK_PLATFORM_EXPORT DedicatedWorkerFactoryStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT DedicatedWorkerFactoryRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_DEDICATED_WORKER_FACTORY_MOJOM_BLINK_H_