...
bool ReportingServiceProxy_QueueInterventionReport_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->source_file, 3, validation_context)) {
    return false;
  }
...
bool ReportingServiceProxy_QueueDeprecationReport_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->anticipatedRemoval, 3, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->source_file, 5, validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams source_file_validate_params(
      0, false, nullptr);
...
bool ReportingServiceProxy_QueueCspViolationReport_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->document_uri, 3, validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams document_uri_validate_params(
      0, false, nullptr);
  if (!mojo::internal::ValidateContainer(object->document_uri, validation_context,
                                         &document_uri_validate_params)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->violated_directive, 5, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->disposition, 8, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->blocked_uri, 9, validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams blocked_uri_validate_params(
      0, false, nullptr);
  if (!mojo::internal::ValidateContainer(object->blocked_uri, validation_context,
                                         &blocked_uri_validate_params)) {
    return false;
  }

  if (!mojo::internal::ValidatePointerNonNullable(
          object->source_file, 12, validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams source_file_validate_params(
      0, false, nullptr);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->script_sample, 14, validation_context)) {
    return false;
  }
