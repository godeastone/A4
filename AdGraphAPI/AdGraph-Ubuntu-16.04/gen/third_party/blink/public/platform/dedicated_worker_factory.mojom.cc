...
void DedicatedWorkerFactoryInterceptorForTesting::CreateDedicatedWorker(const url::Origin& origin, ::service_manager::mojom::InterfaceProviderRequest worker_interface_provider) {
