...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_OOM_INTERVENTION_MOJOM_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_OOM_INTERVENTION_MOJOM_H_
...
class CONTENT_EXPORT OomInterventionHost
...
class CONTENT_EXPORT OomInterventionHostInterceptorForTesting : public OomInterventionHost {
  virtual OomInterventionHost* GetForwardingInterface() = 0;
  void OnHighMemoryUsage(bool intervention_triggered) override;
};
class CONTENT_EXPORT OomInterventionHostAsyncWaiter {
 public:
...
class CONTENT_EXPORT OomIntervention
...
class CONTENT_EXPORT OomInterventionInterceptorForTesting : public OomIntervention {
...
class CONTENT_EXPORT OomInterventionAsyncWaiter {
 public:
...
class CONTENT_EXPORT OomInterventionHostProxy
...
class CONTENT_EXPORT OomInterventionProxy
...
class CONTENT_EXPORT OomInterventionHostStubDispatch {
 public:
...
class CONTENT_EXPORT OomInterventionStubDispatch {
 public:
...
class CONTENT_EXPORT OomInterventionHostRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class CONTENT_EXPORT OomInterventionRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_OOM_INTERVENTION_MOJOM_H_