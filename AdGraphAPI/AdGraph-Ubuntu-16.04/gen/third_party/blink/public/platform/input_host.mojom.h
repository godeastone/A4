...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_INPUT_HOST_MOJOM_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_INPUT_HOST_MOJOM_H_
...
class CONTENT_EXPORT TextSuggestionHost
...
class CONTENT_EXPORT TextSuggestionHostInterceptorForTesting : public TextSuggestionHost {
...
class CONTENT_EXPORT TextSuggestionHostAsyncWaiter {
 public:
...
class CONTENT_EXPORT TextSuggestionHostProxy
...
class CONTENT_EXPORT TextSuggestionHostStubDispatch {
 public:
...
class CONTENT_EXPORT TextSuggestionHostRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};


class CONTENT_EXPORT SpellCheckSuggestion {
 public:
...
class CONTENT_EXPORT TextSuggestion {
 public:
...
template <>
struct CONTENT_EXPORT StructTraits<::blink::mojom::SpellCheckSuggestion::DataView,
...
template <>
struct CONTENT_EXPORT StructTraits<::blink::mojom::TextSuggestion::DataView,
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_INPUT_HOST_MOJOM_H_