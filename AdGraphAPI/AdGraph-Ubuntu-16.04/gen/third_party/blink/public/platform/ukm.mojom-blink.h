...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_UKM_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_UKM_MOJOM_BLINK_H_
...
using RevocableUkmSourceIdFrameHostPtr = ::blink::RevocableInterfacePtr<UkmSourceIdFrameHost>;
...
class BLINK_PLATFORM_EXPORT UkmSourceIdFrameHost
...
class BLINK_PLATFORM_EXPORT UkmSourceIdFrameHostInterceptorForTesting : public UkmSourceIdFrameHost {
  virtual UkmSourceIdFrameHost* GetForwardingInterface() = 0;
  void SetDocumentSourceId(int64_t source_id) override;
};
class BLINK_PLATFORM_EXPORT UkmSourceIdFrameHostAsyncWaiter {
 public:
...
class BLINK_PLATFORM_EXPORT UkmSourceIdFrameHostProxy
...
class BLINK_PLATFORM_EXPORT UkmSourceIdFrameHostStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT UkmSourceIdFrameHostRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_UKM_MOJOM_BLINK_H_