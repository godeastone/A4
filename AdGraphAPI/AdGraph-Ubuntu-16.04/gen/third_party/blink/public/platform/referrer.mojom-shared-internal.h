...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_REFERRER_MOJOM_SHARED_INTERNAL_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_REFERRER_MOJOM_SHARED_INTERNAL_H_
...
#pragma pack(push, 1)
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) Referrer_Data {
 public:
  class BufferWriter {
   public:
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_REFERRER_MOJOM_SHARED_INTERNAL_H_