...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_AUTOPLAY_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_AUTOPLAY_MOJOM_BLINK_H_
...
using RevocableAutoplayConfigurationClientPtr = ::blink::RevocableInterfacePtr<AutoplayConfigurationClient>;
...
class BLINK_PLATFORM_EXPORT AutoplayConfigurationClient
...
class BLINK_PLATFORM_EXPORT AutoplayConfigurationClientInterceptorForTesting : public AutoplayConfigurationClient {
...
class BLINK_PLATFORM_EXPORT AutoplayConfigurationClientAsyncWaiter {
 public:
...
class BLINK_PLATFORM_EXPORT AutoplayConfigurationClientProxy
...
class BLINK_PLATFORM_EXPORT AutoplayConfigurationClientStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT AutoplayConfigurationClientRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_AUTOPLAY_MOJOM_BLINK_H_