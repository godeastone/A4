...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MEDIA_DOWNLOAD_IN_PRODUCT_HELP_MOJOM_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MEDIA_DOWNLOAD_IN_PRODUCT_HELP_MOJOM_H_
...
class CONTENT_EXPORT MediaDownloadInProductHelp
 ...
 public:
  ...
  virtual void ShowInProductHelpWidget(const gfx::Rect& button_rect) = 0;
};
class CONTENT_EXPORT MediaDownloadInProductHelpInterceptorForTesting : public MediaDownloadInProductHelp {
  virtual MediaDownloadInProductHelp* GetForwardingInterface() = 0;
  void ShowInProductHelpWidget(const gfx::Rect& button_rect) override;
};
class CONTENT_EXPORT MediaDownloadInProductHelpAsyncWaiter {
 public:
...
class CONTENT_EXPORT MediaDownloadInProductHelpProxy
    : public MediaDownloadInProductHelp {
 public:
  explicit MediaDownloadInProductHelpProxy(mojo::MessageReceiverWithResponder* receiver);
  void ShowInProductHelpWidget(const gfx::Rect& button_rect) final;

 private:
  mojo::MessageReceiverWithResponder* receiver_;
};
class CONTENT_EXPORT MediaDownloadInProductHelpStubDispatch {
 public:
...
class CONTENT_EXPORT MediaDownloadInProductHelpRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MEDIA_DOWNLOAD_IN_PRODUCT_HELP_MOJOM_H_