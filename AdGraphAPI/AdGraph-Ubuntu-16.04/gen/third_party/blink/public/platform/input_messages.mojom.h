...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_INPUT_MESSAGES_MOJOM_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_INPUT_MESSAGES_MOJOM_H_
...
class CONTENT_EXPORT TextSuggestionBackend
...
class CONTENT_EXPORT TextSuggestionBackendInterceptorForTesting : public TextSuggestionBackend {
...
class CONTENT_EXPORT TextSuggestionBackendAsyncWaiter {
 public:
...
class CONTENT_EXPORT TextSuggestionBackendProxy
...
class CONTENT_EXPORT TextSuggestionBackendStubDispatch {
 public:
...
class CONTENT_EXPORT TextSuggestionBackendRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_INPUT_MESSAGES_MOJOM_H_