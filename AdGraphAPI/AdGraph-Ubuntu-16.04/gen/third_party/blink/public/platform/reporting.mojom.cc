...
void ReportingServiceProxyProxy::QueueInterventionReport(
    const GURL& in_url, const std::string& in_message, const std::string& in_source_file, int32_t in_line_number, int32_t in_column_number) {
...
void ReportingServiceProxyProxy::QueueDeprecationReport(
    const GURL& in_url, const std::string& in_id, base::Time in_anticipatedRemoval, const std::string& in_message, const std::string& in_source_file, int32_t in_line_number, int32_t in_column_number) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ReportingServiceProxyProxy::QueueCspViolationReport(
    const GURL& in_url, const std::string& in_group, const std::string& in_document_uri, const std::string& in_referrer, const std::string& in_violated_directive, const std::string& in_effective_directive, const std::string& in_original_policy, const std::string& in_disposition, const std::string& in_blocked_uri, int32_t in_line_number, int32_t in_column_number, const std::string& in_source_file, int32_t in_status_code, const std::string& in_script_sample) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
std::move(p_column_number));
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::ReportingServiceProxy::QueueDeprecationReport",
      ...
      GURL p_url{};
      std::string p_id{};
      base::Time p_anticipatedRemoval{};
      std::string p_message{};
      std::string p_source_file{};
      int32_t p_line_number{};
      int32_t p_column_number{};
...
void ReportingServiceProxyInterceptorForTesting::QueueInterventionReport(const GURL& url, const std::string& message, const std::string& source_file, int32_t line_number, int32_t column_number) {
...
void ReportingServiceProxyInterceptorForTesting::QueueDeprecationReport(const GURL& url, const std::string& id, base::Time anticipatedRemoval, const std::string& message, const std::string& source_file, int32_t line_number, int32_t column_number) {
...
void ReportingServiceProxyInterceptorForTesting::QueueCspViolationReport(const GURL& url, const std::string& group, const std::string& document_uri, const std::string& referrer, const std::string& violated_directive, const std::string& effective_directive, const std::string& original_policy, const std::string& disposition, const std::string& blocked_uri, int32_t line_number, int32_t column_number, const std::string& source_file, int32_t status_code, const std::string& script_sample) {
