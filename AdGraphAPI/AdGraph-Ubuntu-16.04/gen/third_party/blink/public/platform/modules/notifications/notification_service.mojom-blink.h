...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_NOTIFICATIONS_NOTIFICATION_SERVICE_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_NOTIFICATIONS_NOTIFICATION_SERVICE_MOJOM_BLINK_H_
...
using RevocableNonPersistentNotificationListenerPtr = ::blink::RevocableInterfacePtr<NonPersistentNotificationListener>;
...
using RevocableNotificationServicePtr = ::blink::RevocableInterfacePtr<NotificationService>;
...
class BLINK_PLATFORM_EXPORT NonPersistentNotificationListener
...
class BLINK_PLATFORM_EXPORT NonPersistentNotificationListenerInterceptorForTesting : public NonPersistentNotificationListener {
  virtual NonPersistentNotificationListener* GetForwardingInterface() = 0;
  void OnShow() override;
  void OnClick() override;
  void OnClose(OnCloseCallback callback) override;
};
class BLINK_PLATFORM_EXPORT NonPersistentNotificationListenerAsyncWaiter {
 public:
...
class BLINK_PLATFORM_EXPORT NotificationService
 ...
 public:
  ...
  virtual void DisplayNonPersistentNotification(const WTF::String& token, const ::blink::WebNotificationData& notification_data, const ::blink::WebNotificationResources& notification_resources, NonPersistentNotificationListenerPtr event_listener) = 0;
  ...
  virtual void DisplayPersistentNotification(int64_t service_worker_registration_id, const ::blink::WebNotificationData& notification_data, const ::blink::WebNotificationResources& notification_resources, DisplayPersistentNotificationCallback callback) = 0;

  virtual void ClosePersistentNotification(const WTF::String& notification_id) = 0;


  using GetNotificationsCallback = base::OnceCallback<void(const WTF::Vector<WTF::String>&, const WTF::Vector<::blink::WebNotificationData>&)>;
  virtual void GetNotifications(int64_t service_worker_registration_id, const WTF::String& filter_tag, GetNotificationsCallback callback) = 0;
};
class BLINK_PLATFORM_EXPORT NotificationServiceInterceptorForTesting : public NotificationService {
  ...
  void DisplayNonPersistentNotification(const WTF::String& token, const ::blink::WebNotificationData& notification_data, const ::blink::WebNotificationResources& notification_resources, NonPersistentNotificationListenerPtr event_listener) override;
  void CloseNonPersistentNotification(const WTF::String& token) override;
  void DisplayPersistentNotification(int64_t service_worker_registration_id, const ::blink::WebNotificationData& notification_data, const ::blink::WebNotificationResources& notification_resources, DisplayPersistentNotificationCallback callback) override;
  void ClosePersistentNotification(const WTF::String& notification_id) override;
  void GetNotifications(int64_t service_worker_registration_id, const WTF::String& filter_tag, GetNotificationsCallback callback) override;
};
class BLINK_PLATFORM_EXPORT NotificationServiceAsyncWaiter {
 public:
  ...
  void DisplayPersistentNotification(
      int64_t service_worker_registration_id, const ::blink::WebNotificationData& notification_data, const ::blink::WebNotificationResources& notification_resources, PersistentNotificationError* out_error);
  void GetNotifications(
      int64_t service_worker_registration_id, const WTF::String& filter_tag, WTF::Vector<WTF::String>* out_notification_ids, WTF::Vector<::blink::WebNotificationData>* out_notification_datas);
...
class BLINK_PLATFORM_EXPORT NonPersistentNotificationListenerProxy
...
class BLINK_PLATFORM_EXPORT NotificationServiceProxy
 ...
 public:
  ...
  void DisplayNonPersistentNotification(const WTF::String& token, const ::blink::WebNotificationData& notification_data, const ::blink::WebNotificationResources& notification_resources, NonPersistentNotificationListenerPtr event_listener) final;
  void CloseNonPersistentNotification(const WTF::String& token) final;
  void DisplayPersistentNotification(int64_t service_worker_registration_id, const ::blink::WebNotificationData& notification_data, const ::blink::WebNotificationResources& notification_resources, DisplayPersistentNotificationCallback callback) final;
  void ClosePersistentNotification(const WTF::String& notification_id) final;
  void GetNotifications(int64_t service_worker_registration_id, const WTF::String& filter_tag, GetNotificationsCallback callback) final;

 private:
  mojo::MessageReceiverWithResponder* receiver_;
};
class BLINK_PLATFORM_EXPORT NonPersistentNotificationListenerStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT NonPersistentNotificationListenerRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class BLINK_PLATFORM_EXPORT NotificationServiceRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class BLINK_PLATFORM_EXPORT NonPersistentNotificationListenerResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class BLINK_PLATFORM_EXPORT NotificationServiceResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_NOTIFICATIONS_NOTIFICATION_SERVICE_MOJOM_BLINK_H_