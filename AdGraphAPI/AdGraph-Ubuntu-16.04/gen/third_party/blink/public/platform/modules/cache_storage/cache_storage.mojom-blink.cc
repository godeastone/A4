...
BatchOperation::BatchOperation(
    ...
    const ::blink::WebServiceWorkerRequest& request_in,
...
void CacheKeysResult::set_keys(
  ...
  if (tag_ == Tag::KEYS) {
    *(data_.keys) = std::move(keys);
    ...
    DestroyActive();
    tag_ = Tag::KEYS;
    data_.keys = new WTF::Vector<::blink::WebServiceWorkerRequest>(
        std::move(keys));
  }
}
...
void CacheStorageCacheProxy::Match(
    const ::blink::WebServiceWorkerRequest& in_request, QueryParamsPtr in_query_params, MatchCallback callback) {
...
void CacheStorageCacheProxy::MatchAll(
    const base::Optional<::blink::WebServiceWorkerRequest>& in_request, QueryParamsPtr in_query_params, MatchAllCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void CacheStorageCacheProxy::Keys(
    const base::Optional<::blink::WebServiceWorkerRequest>& in_request, QueryParamsPtr in_query_params, KeysCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void CacheStorageCacheProxy::Batch(
    WTF::Vector<BatchOperationPtr> in_batch_operations, BatchCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool CacheStorageCacheStubDispatch::AcceptWithResponder(
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::CacheStorageCache::Match",
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::blink::WebServiceWorkerRequest p_request{};
...
std::move(p_query_params), std::move(callback));
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::CacheStorageCache::MatchAll",
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      base::Optional<::blink::WebServiceWorkerRequest> p_request{};
      QueryParamsPtr p_query_params{};
...
void CacheStorageCacheInterceptorForTesting::Match(const ::blink::WebServiceWorkerRequest& request, QueryParamsPtr query_params, MatchCallback callback) {
  GetForwardingInterface()->Match(std::move(request), std::move(query_params), std::move(callback));
}
void CacheStorageCacheInterceptorForTesting::MatchAll(const base::Optional<::blink::WebServiceWorkerRequest>& request, QueryParamsPtr query_params, MatchAllCallback callback) {
  GetForwardingInterface()->MatchAll(std::move(request), std::move(query_params), std::move(callback));
}
void CacheStorageCacheInterceptorForTesting::Keys(const base::Optional<::blink::WebServiceWorkerRequest>& request, QueryParamsPtr query_params, KeysCallback callback) {
  GetForwardingInterface()->Keys(std::move(request), std::move(query_params), std::move(callback));
}
void CacheStorageCacheInterceptorForTesting::Batch(WTF::Vector<BatchOperationPtr> batch_operations, BatchCallback callback) {
...
void CacheStorageProxy::Has(
    const WTF::String& in_cache_name, HasCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void CacheStorageProxy::Delete(
    const WTF::String& in_cache_name, DeleteCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void CacheStorageProxy::Match(
    const ::blink::WebServiceWorkerRequest& in_request, QueryParamsPtr in_match_params, MatchCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void CacheStorageProxy::Open(
    const WTF::String& in_cache_name, OpenCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void CacheStorageInterceptorForTesting::Has(const WTF::String& cache_name, HasCallback callback) {
  GetForwardingInterface()->Has(std::move(cache_name), std::move(callback));
}
void CacheStorageInterceptorForTesting::Delete(const WTF::String& cache_name, DeleteCallback callback) {
...
void CacheStorageInterceptorForTesting::Match(const ::blink::WebServiceWorkerRequest& request, QueryParamsPtr match_params, MatchCallback callback) {
  GetForwardingInterface()->Match(std::move(request), std::move(match_params), std::move(callback));
}
void CacheStorageInterceptorForTesting::Open(const WTF::String& cache_name, OpenCallback callback) {
...
// static
bool StructTraits<::blink::mojom::blink::QueryParams::DataView, ::blink::mojom::blink::QueryParamsPtr>::Read(
    ::blink::mojom::blink::QueryParams::DataView input,
    ::blink::mojom::blink::QueryParamsPtr* output) {
  bool success = true;
  ::blink::mojom::blink::QueryParamsPtr result(::blink::mojom::blink::QueryParams::New());
  ...
  switch (input.tag()) {
    ...
    case Tag::CACHE: {
      *output = UnionType::NewCache(
          input.TakeCache<::blink::mojom::blink::CacheStorageCacheAssociatedPtrInfo>());
      break;
    }
    default:
      return false;
...
bool UnionTraits<::blink::mojom::blink::CacheKeysResult::DataView, ::blink::mojom::blink::CacheKeysResultPtr>::Read(
  ...
  switch (input.tag()) {
    ...
    case Tag::KEYS: {
      WTF::Vector<::blink::WebServiceWorkerRequest> result_keys;
