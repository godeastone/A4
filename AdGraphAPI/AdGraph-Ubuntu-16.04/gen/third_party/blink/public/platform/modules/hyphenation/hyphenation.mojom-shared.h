...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_HYPHENATION_HYPHENATION_MOJOM_SHARED_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_HYPHENATION_HYPHENATION_MOJOM_SHARED_H_
...
#include "third_party/blink/public/platform/modules/hyphenation/hyphenation.mojom-shared-internal.h"
...
using HyphenationPtrDataView =
    mojo::InterfacePtrDataView<HyphenationInterfaceBase>;
using HyphenationRequestDataView =
    mojo::InterfaceRequestDataView<HyphenationInterfaceBase>;
using HyphenationAssociatedPtrInfoDataView =
    mojo::AssociatedInterfacePtrInfoDataView<HyphenationInterfaceBase>;
using HyphenationAssociatedRequestDataView =
    mojo::AssociatedInterfaceRequestDataView<HyphenationInterfaceBase>;
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_HYPHENATION_HYPHENATION_MOJOM_SHARED_H_
