...
#include "third_party/blink/public/platform/modules/document_metadata/copyless_paste.mojom-shared-message-ids.h"
...
WebPage::WebPage(
    ...
    std::vector<EntityPtr> entities_in)
    : url(std::move(url_in)),
...
void CopylessPasteProxy::GetEntities(
  ...
  TRACE_EVENT0("mojom", "blink::mojom::document_metadata::CopylessPaste::GetEntities");
#endif
...
bool CopylessPaste_GetEntities_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "blink::mojom::document_metadata::CopylessPaste::GetEntitiesCallback",
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        ...
        "CopylessPaste::GetEntities response deserializer");
    return false;
  }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::document_metadata::CopylessPaste::GetEntitiesCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::document_metadata::CopylessPaste::GetEntities",
               "message", message->name());
#endif
      break;
    }
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::document_metadata::CopylessPaste::GetEntities",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "CopylessPaste::GetEntities deserializer");
        return false;
      }
      CopylessPaste::GetEntitiesCallback callback =
...
// static
bool StructTraits<::blink::mojom::document_metadata::Property::DataView, ::blink::mojom::document_metadata::PropertyPtr>::Read(
    ::blink::mojom::document_metadata::Property::DataView input,
    ::blink::mojom::document_metadata::PropertyPtr* output) {
  bool success = true;
  ::blink::mojom::document_metadata::PropertyPtr result(::blink::mojom::document_metadata::Property::New());
...
// static
bool StructTraits<::blink::mojom::document_metadata::Entity::DataView, ::blink::mojom::document_metadata::EntityPtr>::Read(
    ::blink::mojom::document_metadata::Entity::DataView input,
    ::blink::mojom::document_metadata::EntityPtr* output) {
  bool success = true;
  ::blink::mojom::document_metadata::EntityPtr result(::blink::mojom::document_metadata::Entity::New());
...
// static
bool StructTraits<::blink::mojom::document_metadata::WebPage::DataView, ::blink::mojom::document_metadata::WebPagePtr>::Read(
    ::blink::mojom::document_metadata::WebPage::DataView input,
    ::blink::mojom::document_metadata::WebPagePtr* output) {
  bool success = true;
  ::blink::mojom::document_metadata::WebPagePtr result(::blink::mojom::document_metadata::WebPage::New());
...
// static
bool UnionTraits<::blink::mojom::document_metadata::Values::DataView, ::blink::mojom::document_metadata::ValuesPtr>::Read(
    ::blink::mojom::document_metadata::Values::DataView input,
    ::blink::mojom::document_metadata::ValuesPtr* output) {
  using UnionType = ::blink::mojom::document_metadata::Values;
  ...
  switch (input.tag()) {
    ...
    case Tag::ENTITY_VALUES: {
      std::vector<::blink::mojom::document_metadata::EntityPtr> result_entity_values;
