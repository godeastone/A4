...
#include "third_party/blink/public/platform/modules/mediastream/media_devices.mojom-shared-message-ids.h"
...
size_t MediaDeviceInfo::Hash(size_t seed) const {
  seed = mojo::internal::WTFHash(seed, this->device_id);
  seed = mojo::internal::WTFHash(seed, this->label);
  seed = mojo::internal::WTFHash(seed, this->group_id);
  return seed;
}
...
VideoInputDeviceCapabilities::VideoInputDeviceCapabilities(
    const WTF::String& device_id_in,
    const WTF::String& group_id_in,
    WTF::Vector<::media::mojom::blink::VideoCaptureFormatPtr> formats_in,
...
AudioInputDeviceCapabilities::AudioInputDeviceCapabilities(
    const WTF::String& device_id_in,
    ::media::mojom::blink::AudioParametersPtr parameters_in)
    : device_id(std::move(device_id_in)),
...
void MediaDevicesDispatcherHostProxy::EnumerateDevices(
    bool in_request_audio_input, bool in_request_video_input, bool in_request_audio_output, bool in_request_video_input_capabilities, EnumerateDevicesCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::MediaDevicesDispatcherHost::EnumerateDevices");
#endif
...
void MediaDevicesDispatcherHostProxy::GetAllVideoInputDeviceFormats(
    const WTF::String& in_device_id, GetAllVideoInputDeviceFormatsCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::MediaDevicesDispatcherHost::GetAllVideoInputDeviceFormats");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
void MediaDevicesDispatcherHostProxy::GetAvailableVideoInputDeviceFormats(
    const WTF::String& in_device_id, GetAvailableVideoInputDeviceFormatsCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::MediaDevicesDispatcherHost::GetAvailableVideoInputDeviceFormats");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::MediaDevicesDispatcherHost::AddMediaDevicesListener");
#endif
...
class MediaDevicesDispatcherHost_EnumerateDevices_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      WTF::Vector<WTF::Vector<MediaDeviceInfoPtr>> in_enumeration, WTF::Vector<VideoInputDeviceCapabilitiesPtr> in_video_input_device_capabilities);
...
bool MediaDevicesDispatcherHost_EnumerateDevices_ForwardToCallback::Accept(
  ...
  bool success = true;
  WTF::Vector<WTF::Vector<MediaDeviceInfoPtr>> p_enumeration{};
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::MediaDevicesDispatcherHost::EnumerateDevicesCallback",
               "message", message.name());
#endif
...
bool MediaDevicesDispatcherHost_GetVideoInputCapabilities_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "MediaDevicesDispatcherHost::GetVideoInputCapabilities response deserializer");
    return false;
  }
  if (!callback_.is_null())
    std::move(callback_).Run(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::MediaDevicesDispatcherHost::GetVideoInputCapabilitiesCallback",
               "message", message.name());
#endif
  message.set_request_id(request_id_);
  ignore_result(responder_->Accept(&message));
...
class MediaDevicesDispatcherHost_GetAllVideoInputDeviceFormats_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      WTF::Vector<::media::mojom::blink::VideoCaptureFormatPtr> in_formats);
...
bool MediaDevicesDispatcherHost_GetAllVideoInputDeviceFormats_ForwardToCallback::Accept(
  ...
  serialization_context.TakeHandlesFromMessage(message);
  bool success = true;
  WTF::Vector<::media::mojom::blink::VideoCaptureFormatPtr> p_formats{};
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "MediaDevicesDispatcherHost::GetAllVideoInputDeviceFormats response deserializer");
    return false;
  }
  if (!callback_.is_null())
    std::move(callback_).Run(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::MediaDevicesDispatcherHost::GetAllVideoInputDeviceFormatsCallback",
               "message", message.name());
#endif
  message.set_request_id(request_id_);
  ignore_result(responder_->Accept(&message));
...
bool MediaDevicesDispatcherHost_GetAvailableVideoInputDeviceFormats_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "MediaDevicesDispatcherHost::GetAvailableVideoInputDeviceFormats response deserializer");
    return false;
  }
  if (!callback_.is_null())
    std::move(callback_).Run(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::MediaDevicesDispatcherHost::GetAvailableVideoInputDeviceFormatsCallback",
               "message", message.name());
#endif
  message.set_request_id(request_id_);
  ignore_result(responder_->Accept(&message));
...
bool MediaDevicesDispatcherHost_GetAudioInputCapabilities_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "MediaDevicesDispatcherHost::GetAudioInputCapabilities response deserializer");
    return false;
  }
  if (!callback_.is_null())
    std::move(callback_).Run(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::MediaDevicesDispatcherHost::GetAudioInputCapabilitiesCallback",
               "message", message.name());
#endif
  message.set_request_id(request_id_);
  ignore_result(responder_->Accept(&message));
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::MediaDevicesDispatcherHost::EnumerateDevices",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::MediaDevicesDispatcherHost::GetVideoInputCapabilities",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::MediaDevicesDispatcherHost::GetAllVideoInputDeviceFormats",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::MediaDevicesDispatcherHost::GetAvailableVideoInputDeviceFormats",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::MediaDevicesDispatcherHost::GetAudioInputCapabilities",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::MediaDevicesDispatcherHost::AddMediaDevicesListener",
               "message", message->name());
#endif
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "MediaDevicesDispatcherHost::AddMediaDevicesListener deserializer");
        return false;
      }
...
std::move(p_request_video_input_capabilities), std::move(callback));
      return true;
    }
    case internal::kMediaDevicesDispatcherHost_GetVideoInputCapabilities_Name: {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::MediaDevicesDispatcherHost::GetVideoInputCapabilities",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "MediaDevicesDispatcherHost::GetVideoInputCapabilities deserializer");
        return false;
      }
      MediaDevicesDispatcherHost::GetVideoInputCapabilitiesCallback callback =
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::MediaDevicesDispatcherHost::GetAllVideoInputDeviceFormats",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "MediaDevicesDispatcherHost::GetAllVideoInputDeviceFormats deserializer");
        return false;
      }
      MediaDevicesDispatcherHost::GetAllVideoInputDeviceFormatsCallback callback =
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::MediaDevicesDispatcherHost::GetAvailableVideoInputDeviceFormats",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "MediaDevicesDispatcherHost::GetAvailableVideoInputDeviceFormats deserializer");
        return false;
      }
      MediaDevicesDispatcherHost::GetAvailableVideoInputDeviceFormatsCallback callback =
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::MediaDevicesDispatcherHost::GetAudioInputCapabilities",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "MediaDevicesDispatcherHost::GetAudioInputCapabilities deserializer");
        return false;
      }
      MediaDevicesDispatcherHost::GetAudioInputCapabilitiesCallback callback =
...
void MediaDevicesDispatcherHostInterceptorForTesting::EnumerateDevices(bool request_audio_input, bool request_video_input, bool request_audio_output, bool request_video_input_capabilities, EnumerateDevicesCallback callback) {
  GetForwardingInterface()->EnumerateDevices(std::move(request_audio_input), std::move(request_video_input), std::move(request_audio_output), std::move(request_video_input_capabilities), std::move(callback));
}
...
,
             ...
             WTF::Vector<VideoInputDeviceCapabilitiesPtr> video_input_device_capabilities) {*out_enumeration = std::move(enumeration);*out_video_input_device_capabilities = std::move(video_input_device_capabilities);
            loop->Quit();
          },
          &loop,
          out_enumeration,
...
void MediaDevicesListenerProxy::OnDevicesChanged(
    MediaDeviceType in_type, WTF::Vector<MediaDeviceInfoPtr> in_device_infos) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::MediaDevicesListener::OnDevicesChanged");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::MediaDevicesListener::OnDevicesChanged",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      WTF::Vector<MediaDeviceInfoPtr> p_device_infos{};
...
bool StructTraits<::blink::mojom::blink::MediaDeviceInfo::DataView, ::blink::mojom::blink::MediaDeviceInfoPtr>::Read(
    ::blink::mojom::blink::MediaDeviceInfo::DataView input,
    ::blink::mojom::blink::MediaDeviceInfoPtr* output) {
  bool success = true;
...
bool StructTraits<::blink::mojom::blink::VideoInputDeviceCapabilities::DataView, ::blink::mojom::blink::VideoInputDeviceCapabilitiesPtr>::Read(
    ::blink::mojom::blink::VideoInputDeviceCapabilities::DataView input,
    ::blink::mojom::blink::VideoInputDeviceCapabilitiesPtr* output) {
  bool success = true;
...
bool StructTraits<::blink::mojom::blink::AudioInputDeviceCapabilities::DataView, ::blink::mojom::blink::AudioInputDeviceCapabilitiesPtr>::Read(
    ::blink::mojom::blink::AudioInputDeviceCapabilities::DataView input,
    ::blink::mojom::blink::AudioInputDeviceCapabilitiesPtr* output) {
  bool success = true;
