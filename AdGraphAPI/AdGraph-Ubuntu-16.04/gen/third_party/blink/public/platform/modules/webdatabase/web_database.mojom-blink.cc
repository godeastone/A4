...
#include "third_party/blink/public/platform/modules/webdatabase/web_database.mojom-shared-message-ids.h"
...
void WebDatabaseProxy::UpdateSize(
  ...
  TRACE_EVENT0("mojom", "blink::mojom::WebDatabase::UpdateSize");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::WebDatabase::CloseImmediately");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WebDatabase::UpdateSize",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            ...
            "WebDatabase::UpdateSize deserializer");
        return false;
      }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WebDatabase::CloseImmediately",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "WebDatabase::CloseImmediately deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::WebDatabaseHost::OpenFile");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::WebDatabaseHost::DeleteFile");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = true;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::WebDatabaseHost::GetFileAttributes");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = true;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::WebDatabaseHost::GetFileSize");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = true;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::WebDatabaseHost::SetFileSize");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = true;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::WebDatabaseHost::GetSpaceAvailable");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = true;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::WebDatabaseHost::Opened");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::WebDatabaseHost::Modified");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
void WebDatabaseHostProxy::Closed(
    const scoped_refptr<const ::blink::SecurityOrigin>& in_origin, const WTF::String& in_database_name) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::WebDatabaseHost::Closed");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::WebDatabaseHost::HandleSqliteError");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
bool WebDatabaseHost_OpenFile_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "WebDatabaseHost::OpenFile response deserializer");
    return false;
  }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WebDatabaseHost::OpenFileCallback",
               "message", message.name());
#endif
...
bool WebDatabaseHost_DeleteFile_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "WebDatabaseHost::DeleteFile response deserializer");
    return false;
  }
  if (!callback_.is_null())
    std::move(callback_).Run(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WebDatabaseHost::DeleteFileCallback",
               "message", message.name());
#endif
  message.set_request_id(request_id_);
  ignore_result(responder_->Accept(&message));
...
bool WebDatabaseHost_GetFileAttributes_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "WebDatabaseHost::GetFileAttributes response deserializer");
    return false;
  }
  if (!callback_.is_null())
    std::move(callback_).Run(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WebDatabaseHost::GetFileAttributesCallback",
               "message", message.name());
#endif
  message.set_request_id(request_id_);
  ignore_result(responder_->Accept(&message));
...
bool WebDatabaseHost_GetFileSize_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "WebDatabaseHost::GetFileSize response deserializer");
    return false;
  }
  if (!callback_.is_null())
    std::move(callback_).Run(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WebDatabaseHost::GetFileSizeCallback",
               "message", message.name());
#endif
  message.set_request_id(request_id_);
  ignore_result(responder_->Accept(&message));
...
bool WebDatabaseHost_SetFileSize_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "WebDatabaseHost::SetFileSize response deserializer");
    return false;
  }
  if (!callback_.is_null())
    std::move(callback_).Run(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WebDatabaseHost::SetFileSizeCallback",
               "message", message.name());
#endif
  message.set_request_id(request_id_);
  ignore_result(responder_->Accept(&message));
...
bool WebDatabaseHost_GetSpaceAvailable_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "WebDatabaseHost::GetSpaceAvailable response deserializer");
    return false;
  }
  if (!callback_.is_null())
    std::move(callback_).Run(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WebDatabaseHost::GetSpaceAvailableCallback",
               "message", message.name());
#endif
  message.set_request_id(request_id_);
  ignore_result(responder_->Accept(&message));
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WebDatabaseHost::OpenFile",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WebDatabaseHost::DeleteFile",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WebDatabaseHost::GetFileAttributes",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WebDatabaseHost::GetFileSize",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WebDatabaseHost::SetFileSize",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WebDatabaseHost::GetSpaceAvailable",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WebDatabaseHost::Opened",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "WebDatabaseHost::Opened deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WebDatabaseHost::Modified",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "WebDatabaseHost::Modified deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WebDatabaseHost::Closed",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "WebDatabaseHost::Closed deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WebDatabaseHost::HandleSqliteError",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "WebDatabaseHost::HandleSqliteError deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WebDatabaseHost::OpenFile",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "WebDatabaseHost::OpenFile deserializer");
        return false;
      }
      WebDatabaseHost::OpenFileCallback callback =
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WebDatabaseHost::DeleteFile",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "WebDatabaseHost::DeleteFile deserializer");
        return false;
      }
      WebDatabaseHost::DeleteFileCallback callback =
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WebDatabaseHost::GetFileAttributes",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "WebDatabaseHost::GetFileAttributes deserializer");
        return false;
      }
      WebDatabaseHost::GetFileAttributesCallback callback =
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WebDatabaseHost::GetFileSize",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "WebDatabaseHost::GetFileSize deserializer");
        return false;
      }
      WebDatabaseHost::GetFileSizeCallback callback =
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WebDatabaseHost::SetFileSize",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "WebDatabaseHost::SetFileSize deserializer");
        return false;
      }
      WebDatabaseHost::SetFileSizeCallback callback =
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::WebDatabaseHost::GetSpaceAvailable",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "WebDatabaseHost::GetSpaceAvailable deserializer");
        return false;
      }
      WebDatabaseHost::GetSpaceAvailableCallback callback =
