...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_NOTIFICATIONS_NOTIFICATION_MOJOM_SHARED_INTERNAL_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_NOTIFICATIONS_NOTIFICATION_MOJOM_SHARED_INTERNAL_H_
...
#pragma pack(push, 1)
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) NotificationAction_Data {
 public:
  class BufferWriter {
   public:
...
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) NotificationData_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
...
static_assert(sizeof(NotificationData_Data) == 104,
...
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) NotificationResources_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_NOTIFICATIONS_NOTIFICATION_MOJOM_SHARED_INTERNAL_H_