...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_WEBAUTH_VIRTUAL_AUTHENTICATOR_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_WEBAUTH_VIRTUAL_AUTHENTICATOR_MOJOM_BLINK_H_
...
namespace WTF {
struct webauth_test_mojom_internal_ClientToAuthenticatorProtocol_DataHashFn {
  static unsigned GetHash(const ::webauth::test::mojom::ClientToAuthenticatorProtocol& value) {
    using utype = std::underlying_type<::webauth::test::mojom::ClientToAuthenticatorProtocol>::type;
    return DefaultHash<utype>::Hash().GetHash(static_cast<utype>(value));
  }
  static bool Equal(const ::webauth::test::mojom::ClientToAuthenticatorProtocol& left, const ::webauth::test::mojom::ClientToAuthenticatorProtocol& right) {
    return left == right;
  }
...
template <>
struct DefaultHash<::webauth::test::mojom::ClientToAuthenticatorProtocol> {
  using Hash = webauth_test_mojom_internal_ClientToAuthenticatorProtocol_DataHashFn;
};

template <>
struct HashTraits<::webauth::test::mojom::ClientToAuthenticatorProtocol>
    : public GenericHashTraits<::webauth::test::mojom::ClientToAuthenticatorProtocol> {
  static_assert(true,
                "-1000000 is a reserved enum value");
  static_assert(true,
                "-1000001 is a reserved enum value");
  static const bool hasIsEmptyValueFunction = true;
  static bool IsEmptyValue(const ::webauth::test::mojom::ClientToAuthenticatorProtocol& value) {
    return value == static_cast<::webauth::test::mojom::ClientToAuthenticatorProtocol>(-1000000);
  }
  static void ConstructDeletedValue(::webauth::test::mojom::ClientToAuthenticatorProtocol& slot, bool) {
    slot = static_cast<::webauth::test::mojom::ClientToAuthenticatorProtocol>(-1000001);
  }
  static bool IsDeletedValue(const ::webauth::test::mojom::ClientToAuthenticatorProtocol& value) {
    return value == static_cast<::webauth::test::mojom::ClientToAuthenticatorProtocol>(-1000001);
  }
};
}  // namespace WTF
...
using RevocableVirtualAuthenticatorPtr = ::blink::RevocableInterfacePtr<VirtualAuthenticator>;
...
using RevocableVirtualAuthenticatorManagerPtr = ::blink::RevocableInterfacePtr<VirtualAuthenticatorManager>;
...
class BLINK_PLATFORM_EXPORT VirtualAuthenticator
...
class BLINK_PLATFORM_EXPORT VirtualAuthenticatorInterceptorForTesting : public VirtualAuthenticator {
...
class BLINK_PLATFORM_EXPORT VirtualAuthenticatorAsyncWaiter {
 public:
...
class BLINK_PLATFORM_EXPORT VirtualAuthenticatorManager
...
class BLINK_PLATFORM_EXPORT VirtualAuthenticatorManagerInterceptorForTesting : public VirtualAuthenticatorManager {
...
class BLINK_PLATFORM_EXPORT VirtualAuthenticatorManagerAsyncWaiter {
 public:
...
class BLINK_PLATFORM_EXPORT VirtualAuthenticatorProxy
...
class BLINK_PLATFORM_EXPORT VirtualAuthenticatorManagerProxy
...
class BLINK_PLATFORM_EXPORT VirtualAuthenticatorStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT VirtualAuthenticatorManagerStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT VirtualAuthenticatorRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class BLINK_PLATFORM_EXPORT VirtualAuthenticatorManagerRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class BLINK_PLATFORM_EXPORT VirtualAuthenticatorResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class BLINK_PLATFORM_EXPORT VirtualAuthenticatorManagerResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
class BLINK_PLATFORM_EXPORT VirtualAuthenticatorOptions {
 public:
  ...
  VirtualAuthenticatorOptions(
      ...
      ::webauth::mojom::blink::AuthenticatorTransport transport,
      ::webauth::mojom::blink::AuthenticatorAttachment attachment,
...
class BLINK_PLATFORM_EXPORT RegisteredKey {
 public:
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::webauth::test::mojom::blink::VirtualAuthenticatorOptions::DataView,
                                         ::webauth::test::mojom::blink::VirtualAuthenticatorOptionsPtr> {
  static bool IsNull(const ::webauth::test::mojom::blink::VirtualAuthenticatorOptionsPtr& input) { return !input; }
  static void SetToNull(::webauth::test::mojom::blink::VirtualAuthenticatorOptionsPtr* output) { output->reset(); }

  static decltype(::webauth::test::mojom::blink::VirtualAuthenticatorOptions::protocol) protocol(
      const ::webauth::test::mojom::blink::VirtualAuthenticatorOptionsPtr& input) {
    return input->protocol;
  }

  static decltype(::webauth::test::mojom::blink::VirtualAuthenticatorOptions::transport) transport(
      const ::webauth::test::mojom::blink::VirtualAuthenticatorOptionsPtr& input) {
    return input->transport;
  }

  static decltype(::webauth::test::mojom::blink::VirtualAuthenticatorOptions::attachment) attachment(
      const ::webauth::test::mojom::blink::VirtualAuthenticatorOptionsPtr& input) {
    return input->attachment;
  }

  static decltype(::webauth::test::mojom::blink::VirtualAuthenticatorOptions::has_resident_key) has_resident_key(
      const ::webauth::test::mojom::blink::VirtualAuthenticatorOptionsPtr& input) {
    return input->has_resident_key;
  }

  static decltype(::webauth::test::mojom::blink::VirtualAuthenticatorOptions::has_user_verification) has_user_verification(
      const ::webauth::test::mojom::blink::VirtualAuthenticatorOptionsPtr& input) {
    return input->has_user_verification;
  }

  static bool Read(::webauth::test::mojom::blink::VirtualAuthenticatorOptions::DataView input, ::webauth::test::mojom::blink::VirtualAuthenticatorOptionsPtr* output);
};


template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::webauth::test::mojom::blink::RegisteredKey::DataView,
                                         ::webauth::test::mojom::blink::RegisteredKeyPtr> {
  static bool IsNull(const ::webauth::test::mojom::blink::RegisteredKeyPtr& input) { return !input; }
  static void SetToNull(::webauth::test::mojom::blink::RegisteredKeyPtr* output) { output->reset(); }

  static const decltype(::webauth::test::mojom::blink::RegisteredKey::key_handle)& key_handle(
      const ::webauth::test::mojom::blink::RegisteredKeyPtr& input) {
    return input->key_handle;
  }

  static const decltype(::webauth::test::mojom::blink::RegisteredKey::application_parameter)& application_parameter(
      const ::webauth::test::mojom::blink::RegisteredKeyPtr& input) {
    return input->application_parameter;
  }

  static const decltype(::webauth::test::mojom::blink::RegisteredKey::private_key)& private_key(
      const ::webauth::test::mojom::blink::RegisteredKeyPtr& input) {
    return input->private_key;
  }

  static decltype(::webauth::test::mojom::blink::RegisteredKey::counter) counter(
      const ::webauth::test::mojom::blink::RegisteredKeyPtr& input) {
    return input->counter;
  }

  static bool Read(::webauth::test::mojom::blink::RegisteredKey::DataView input, ::webauth::test::mojom::blink::RegisteredKeyPtr* output);
};

}  // namespace mojo

#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_WEBAUTH_VIRTUAL_AUTHENTICATOR_MOJOM_BLINK_H_