...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_FETCH_FETCH_API_RESPONSE_MOJOM_SHARED_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_FETCH_FETCH_API_RESPONSE_MOJOM_SHARED_H_
...
struct Serializer<::blink::mojom::FetchAPIResponseDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    decltype(CallWithContext(Traits::url_list, input, custom_context)) in_url_list = CallWithContext(Traits::url_list, input, custom_context);
    ...
    mojo::internal::Serialize<::network::mojom::FetchResponseType>(
        CallWithContext(Traits::response_type, input, custom_context), &(*output)->response_type);
    ...
    decltype(CallWithContext(Traits::response_time, input, custom_context)) in_response_time = CallWithContext(Traits::response_time, input, custom_context);
    ...
    decltype(CallWithContext(Traits::cache_storage_cache_name, input, custom_context)) in_cache_storage_cache_name = CallWithContext(Traits::cache_storage_cache_name, input, custom_context);
    ...
    decltype(CallWithContext(Traits::cors_exposed_header_names, input, custom_context)) in_cors_exposed_header_names = CallWithContext(Traits::cors_exposed_header_names, input, custom_context);
    ...
    (*output)->is_in_cache_storage = CallWithContext(Traits::is_in_cache_storage, input, custom_context);
    decltype(CallWithContext(Traits::side_data_blob, input, custom_context)) in_side_data_blob = CallWithContext(Traits::side_data_blob, input, custom_context);
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_FETCH_FETCH_API_RESPONSE_MOJOM_SHARED_H_
