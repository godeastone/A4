...
bool VirtualAuthenticatorOptions_Data::Validate(
  ...
  const VirtualAuthenticatorOptions_Data* object = static_cast<const VirtualAuthenticatorOptions_Data*>(data);
  ...
  if (!::webauth::test::mojom::internal::ClientToAuthenticatorProtocol_Data
        ::Validate(object->protocol, validation_context))
    return false;


  if (!::webauth::mojom::internal::AuthenticatorTransport_Data
        ::Validate(object->transport, validation_context))
    return false;


  if (!::webauth::mojom::internal::AuthenticatorAttachment_Data
...
bool RegisteredKey_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const RegisteredKey_Data* object = static_cast<const RegisteredKey_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->application_parameter, 2, validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams application_parameter_validate_params(
      0, false, nullptr);
  if (!mojo::internal::ValidateContainer(object->application_parameter, validation_context,
                                         &application_parameter_validate_params)) {
    return false;
  }
...
bool VirtualAuthenticator_GetUniqueId_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VirtualAuthenticator_GetUniqueId_Params_Data* object = static_cast<const VirtualAuthenticator_GetUniqueId_Params_Data*>(data);
...
bool VirtualAuthenticator_GetUniqueId_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VirtualAuthenticator_GetUniqueId_ResponseParams_Data* object = static_cast<const VirtualAuthenticator_GetUniqueId_ResponseParams_Data*>(data);
...
bool VirtualAuthenticator_AddRegistration_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VirtualAuthenticator_AddRegistration_Params_Data* object = static_cast<const VirtualAuthenticator_AddRegistration_Params_Data*>(data);
...
bool VirtualAuthenticator_AddRegistration_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VirtualAuthenticator_AddRegistration_ResponseParams_Data* object = static_cast<const VirtualAuthenticator_AddRegistration_ResponseParams_Data*>(data);
...
bool VirtualAuthenticator_GetRegistrations_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VirtualAuthenticator_GetRegistrations_Params_Data* object = static_cast<const VirtualAuthenticator_GetRegistrations_Params_Data*>(data);
...
bool VirtualAuthenticator_GetRegistrations_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VirtualAuthenticator_GetRegistrations_ResponseParams_Data* object = static_cast<const VirtualAuthenticator_GetRegistrations_ResponseParams_Data*>(data);
...
bool VirtualAuthenticator_ClearRegistrations_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VirtualAuthenticator_ClearRegistrations_Params_Data* object = static_cast<const VirtualAuthenticator_ClearRegistrations_Params_Data*>(data);
...
bool VirtualAuthenticator_ClearRegistrations_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VirtualAuthenticator_ClearRegistrations_ResponseParams_Data* object = static_cast<const VirtualAuthenticator_ClearRegistrations_ResponseParams_Data*>(data);
...
// static
bool VirtualAuthenticator_SetUserPresence_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VirtualAuthenticator_SetUserPresence_Params_Data* object = static_cast<const VirtualAuthenticator_SetUserPresence_Params_Data*>(data);
...
VirtualAuthenticator_SetUserPresence_Params_Data::VirtualAuthenticator_SetUserPresence_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool VirtualAuthenticator_SetUserPresence_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VirtualAuthenticator_SetUserPresence_ResponseParams_Data* object = static_cast<const VirtualAuthenticator_SetUserPresence_ResponseParams_Data*>(data);
...
VirtualAuthenticator_SetUserPresence_ResponseParams_Data::VirtualAuthenticator_SetUserPresence_ResponseParams_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool VirtualAuthenticator_GetUserPresence_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VirtualAuthenticator_GetUserPresence_Params_Data* object = static_cast<const VirtualAuthenticator_GetUserPresence_Params_Data*>(data);
...
VirtualAuthenticator_GetUserPresence_Params_Data::VirtualAuthenticator_GetUserPresence_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool VirtualAuthenticator_GetUserPresence_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VirtualAuthenticator_GetUserPresence_ResponseParams_Data* object = static_cast<const VirtualAuthenticator_GetUserPresence_ResponseParams_Data*>(data);
...
VirtualAuthenticator_GetUserPresence_ResponseParams_Data::VirtualAuthenticator_GetUserPresence_ResponseParams_Data()
    : header_({sizeof(*this), 0}) {}
...
bool VirtualAuthenticatorManager_CreateAuthenticator_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VirtualAuthenticatorManager_CreateAuthenticator_Params_Data* object = static_cast<const VirtualAuthenticatorManager_CreateAuthenticator_Params_Data*>(data);
...
bool VirtualAuthenticatorManager_CreateAuthenticator_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VirtualAuthenticatorManager_CreateAuthenticator_ResponseParams_Data* object = static_cast<const VirtualAuthenticatorManager_CreateAuthenticator_ResponseParams_Data*>(data);
...
bool VirtualAuthenticatorManager_GetAuthenticators_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VirtualAuthenticatorManager_GetAuthenticators_Params_Data* object = static_cast<const VirtualAuthenticatorManager_GetAuthenticators_Params_Data*>(data);
...
bool VirtualAuthenticatorManager_GetAuthenticators_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VirtualAuthenticatorManager_GetAuthenticators_ResponseParams_Data* object = static_cast<const VirtualAuthenticatorManager_GetAuthenticators_ResponseParams_Data*>(data);
...
bool VirtualAuthenticatorManager_RemoveAuthenticator_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VirtualAuthenticatorManager_RemoveAuthenticator_Params_Data* object = static_cast<const VirtualAuthenticatorManager_RemoveAuthenticator_Params_Data*>(data);
...
bool VirtualAuthenticatorManager_RemoveAuthenticator_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VirtualAuthenticatorManager_RemoveAuthenticator_ResponseParams_Data* object = static_cast<const VirtualAuthenticatorManager_RemoveAuthenticator_ResponseParams_Data*>(data);
...
bool VirtualAuthenticatorManager_ClearAuthenticators_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VirtualAuthenticatorManager_ClearAuthenticators_Params_Data* object = static_cast<const VirtualAuthenticatorManager_ClearAuthenticators_Params_Data*>(data);
...
bool VirtualAuthenticatorManager_ClearAuthenticators_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VirtualAuthenticatorManager_ClearAuthenticators_ResponseParams_Data* object = static_cast<const VirtualAuthenticatorManager_ClearAuthenticators_ResponseParams_Data*>(data);
