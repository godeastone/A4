...
void GeolocationServiceProxy::CreateGeolocation(
    ::device::mojom::GeolocationRequest in_request, bool in_user_gesture) {
...
void GeolocationServiceInterceptorForTesting::CreateGeolocation(::device::mojom::GeolocationRequest request, bool user_gesture) {
