...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_FETCH_FETCH_API_RESPONSE_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_FETCH_FETCH_API_RESPONSE_MOJOM_BLINK_H_
...
class BLINK_PLATFORM_EXPORT FetchAPIResponse {
 public:
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::FetchAPIResponse::DataView,
  ...
  static decltype(::blink::mojom::blink::FetchAPIResponse::is_in_cache_storage) is_in_cache_storage(
      const ::blink::mojom::blink::FetchAPIResponsePtr& input) {
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_FETCH_FETCH_API_RESPONSE_MOJOM_BLINK_H_