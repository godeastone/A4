...
PaymentInstrument::PaymentInstrument(
    ...
    const std::vector<::blink::Manifest::Icon>& icons_in,
...
void PaymentHandlerResponseCallbackProxy::OnResponseForAbortPayment(
    bool in_payment_aborted, base::Time in_dispatch_event_time) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void PaymentHandlerResponseCallbackProxy::OnResponseForCanMakePayment(
    bool in_can_make_payment, base::Time in_dispatch_event_time) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void PaymentHandlerResponseCallbackProxy::OnResponseForPaymentRequest(
    PaymentHandlerResponsePtr in_response, base::Time in_dispatch_event_time) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void PaymentHandlerResponseCallbackInterceptorForTesting::OnResponseForAbortPayment(bool payment_aborted, base::Time dispatch_event_time) {
  GetForwardingInterface()->OnResponseForAbortPayment(std::move(payment_aborted), std::move(dispatch_event_time));
}
void PaymentHandlerResponseCallbackInterceptorForTesting::OnResponseForCanMakePayment(bool can_make_payment, base::Time dispatch_event_time) {
  GetForwardingInterface()->OnResponseForCanMakePayment(std::move(can_make_payment), std::move(dispatch_event_time));
}
void PaymentHandlerResponseCallbackInterceptorForTesting::OnResponseForPaymentRequest(PaymentHandlerResponsePtr response, base::Time dispatch_event_time) {
