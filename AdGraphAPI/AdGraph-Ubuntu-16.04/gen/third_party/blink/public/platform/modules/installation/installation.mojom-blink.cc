...
#include "third_party/blink/public/platform/modules/installation/installation.mojom-shared-message-ids.h"
...
void InstallationServiceProxy::OnInstall(
  ...
  TRACE_EVENT0("mojom", "blink::mojom::InstallationService::OnInstall");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::InstallationService::OnInstall",
...
InstallationServiceAsyncWaiter::InstallationServiceAsyncWaiter(
    InstallationService* proxy) : proxy_(proxy) {}
