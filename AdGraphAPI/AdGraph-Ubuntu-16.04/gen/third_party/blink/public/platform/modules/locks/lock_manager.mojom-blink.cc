...
void LockManagerProxy::RequestLock(
    const WTF::String& in_name, LockMode in_mode, LockManager::WaitMode in_wait, LockRequestPtr in_request) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void LockManagerInterceptorForTesting::RequestLock(const WTF::String& name, LockMode mode, LockManager::WaitMode wait, LockRequestPtr request) {
