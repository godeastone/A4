...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_NOTIFICATIONS_NOTIFICATION_MOJOM_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_NOTIFICATIONS_NOTIFICATION_MOJOM_H_
...
class CONTENT_EXPORT NotificationData {
 public:
  ...
  NotificationData(
      const base::string16& title,
      content::PlatformNotificationData::Direction direction,
      ...
      const base::Optional<std::vector<int8_t>>& data,
  ...
  bool silent;
  bool require_interaction;
  base::Optional<std::vector<int8_t>> data;
  base::Optional<std::vector<NotificationActionPtr>> actions;
...
class CONTENT_EXPORT NotificationResources {
 public:
...
template <>
struct CONTENT_EXPORT StructTraits<::blink::mojom::NotificationData::DataView,
...
template <>
struct CONTENT_EXPORT StructTraits<::blink::mojom::NotificationResources::DataView,
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_NOTIFICATIONS_NOTIFICATION_MOJOM_H_