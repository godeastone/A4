...
#include "third_party/blink/public/platform/modules/geolocation/geolocation_service.mojom-shared-message-ids.h"
...
void GeolocationServiceProxy::CreateGeolocation(
    ::device::mojom::blink::GeolocationRequest in_request, bool in_user_gesture) {
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::GeolocationService::CreateGeolocation",
      ...
      internal::GeolocationService_CreateGeolocation_Params_Data* params =
          reinterpret_cast<internal::GeolocationService_CreateGeolocation_Params_Data*>(
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            ...
            "GeolocationService::CreateGeolocation deserializer");
        return false;
      }
...
void GeolocationServiceInterceptorForTesting::CreateGeolocation(::device::mojom::blink::GeolocationRequest request, bool user_gesture) {
  GetForwardingInterface()->CreateGeolocation(std::move(request), std::move(user_gesture));
}
