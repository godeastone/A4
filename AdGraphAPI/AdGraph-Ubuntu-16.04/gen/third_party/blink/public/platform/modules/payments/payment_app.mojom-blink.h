...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_PAYMENTS_PAYMENT_APP_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_PAYMENTS_PAYMENT_APP_MOJOM_BLINK_H_
...
using RevocablePaymentManagerPtr = ::blink::RevocableInterfacePtr<PaymentManager>;
...
using RevocablePaymentHandlerResponseCallbackPtr = ::blink::RevocableInterfacePtr<PaymentHandlerResponseCallback>;
...
class BLINK_PLATFORM_EXPORT PaymentManager
...
class BLINK_PLATFORM_EXPORT PaymentManagerInterceptorForTesting : public PaymentManager {
...
class BLINK_PLATFORM_EXPORT PaymentManagerAsyncWaiter {
 public:
...
class BLINK_PLATFORM_EXPORT PaymentHandlerResponseCallback
 ...
 public:
  ...
  virtual void OnResponseForAbortPayment(bool payment_aborted, WTF::Time dispatch_event_time) = 0;

  virtual void OnResponseForCanMakePayment(bool can_make_payment, WTF::Time dispatch_event_time) = 0;

  virtual void OnResponseForPaymentRequest(PaymentHandlerResponsePtr response, WTF::Time dispatch_event_time) = 0;
};
class BLINK_PLATFORM_EXPORT PaymentHandlerResponseCallbackInterceptorForTesting : public PaymentHandlerResponseCallback {
  virtual PaymentHandlerResponseCallback* GetForwardingInterface() = 0;
  void OnResponseForAbortPayment(bool payment_aborted, WTF::Time dispatch_event_time) override;
  void OnResponseForCanMakePayment(bool can_make_payment, WTF::Time dispatch_event_time) override;
  void OnResponseForPaymentRequest(PaymentHandlerResponsePtr response, WTF::Time dispatch_event_time) override;
};
class BLINK_PLATFORM_EXPORT PaymentHandlerResponseCallbackAsyncWaiter {
 public:
...
class BLINK_PLATFORM_EXPORT PaymentManagerProxy
...
class BLINK_PLATFORM_EXPORT PaymentHandlerResponseCallbackProxy
 ...
 public:
  ...
  void OnResponseForAbortPayment(bool payment_aborted, WTF::Time dispatch_event_time) final;
  void OnResponseForCanMakePayment(bool can_make_payment, WTF::Time dispatch_event_time) final;
  void OnResponseForPaymentRequest(PaymentHandlerResponsePtr response, WTF::Time dispatch_event_time) final;

 private:
  mojo::MessageReceiverWithResponder* receiver_;
};
class BLINK_PLATFORM_EXPORT PaymentManagerStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT PaymentHandlerResponseCallbackStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT PaymentManagerRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class BLINK_PLATFORM_EXPORT PaymentHandlerResponseCallbackRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class BLINK_PLATFORM_EXPORT PaymentManagerResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
class BLINK_PLATFORM_EXPORT PaymentHandlerResponse {
 public:
...
class BLINK_PLATFORM_EXPORT PaymentInstrument {
 public:
  ...
  PaymentInstrument(
      ...
      WTF::Vector<::blink::mojom::blink::ManifestIconPtr> icons,
...
class BLINK_PLATFORM_EXPORT CanMakePaymentEventData {
 public:
...
class BLINK_PLATFORM_EXPORT PaymentRequestEventData {
 public:
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::payments::mojom::blink::PaymentInstrument::DataView,
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::payments::mojom::blink::CanMakePaymentEventData::DataView,
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::payments::mojom::blink::PaymentRequestEventData::DataView,
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::payments::mojom::blink::PaymentHandlerResponse::DataView,
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_PAYMENTS_PAYMENT_APP_MOJOM_BLINK_H_