...
#include "third_party/blink/public/platform/modules/mediasession/media_session.mojom-shared-message-ids.h"
...
MediaMetadata::MediaMetadata(
    ...
    const std::vector<content::MediaMetadata::MediaImage>& artwork_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::MediaSessionClient::DidReceiveAction",
...
void MediaSessionClientInterceptorForTesting::DidReceiveAction(MediaSessionAction action) {
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::MediaSessionService::SetClient",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::MediaSessionService::SetPlaybackState",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::MediaSessionService::SetMetadata",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::MediaSessionService::EnableAction",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::MediaSessionService::DisableAction",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
...
void MediaSessionServiceInterceptorForTesting::SetMetadata(const base::Optional<content::MediaMetadata>& metadata) {
  GetForwardingInterface()->SetMetadata(std::move(metadata));
}
void MediaSessionServiceInterceptorForTesting::EnableAction(MediaSessionAction action) {
  GetForwardingInterface()->EnableAction(std::move(action));
}
void MediaSessionServiceInterceptorForTesting::DisableAction(MediaSessionAction action) {
