...
#include "third_party/blink/public/platform/modules/keyboard_lock/keyboard_lock.mojom-shared-message-ids.h"
namespace blink {
namespace mojom {
...
void KeyboardLockServiceProxy::RequestKeyboardLock(
  ...
  TRACE_EVENT0("mojom", "blink::mojom::KeyboardLockService::RequestKeyboardLock");
#endif
...
bool KeyboardLockService_RequestKeyboardLock_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        ...
        "KeyboardLockService::RequestKeyboardLock response deserializer");
    return false;
  }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::KeyboardLockService::RequestKeyboardLockCallback",
               "message", message.name());
#endif
...
bool KeyboardLockService_GetKeyboardLayoutMap_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "KeyboardLockService::GetKeyboardLayoutMap response deserializer");
    return false;
  }
  if (!callback_.is_null())
    std::move(callback_).Run(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::KeyboardLockService::GetKeyboardLayoutMapCallback",
               "message", message.name());
#endif
  message.set_request_id(request_id_);
  ignore_result(responder_->Accept(&message));
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::KeyboardLockService::RequestKeyboardLock",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::KeyboardLockService::CancelKeyboardLock",
               "message", message->name());
#endif
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "KeyboardLockService::CancelKeyboardLock deserializer");
        return false;
      }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::KeyboardLockService::GetKeyboardLayoutMap",
               "message", message->name());
#endif
      break;
    }
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::KeyboardLockService::RequestKeyboardLock",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "KeyboardLockService::RequestKeyboardLock deserializer");
        return false;
      }
      KeyboardLockService::RequestKeyboardLockCallback callback =
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::KeyboardLockService::GetKeyboardLayoutMap",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "KeyboardLockService::GetKeyboardLayoutMap deserializer");
        return false;
      }
      KeyboardLockService::GetKeyboardLayoutMapCallback callback =
