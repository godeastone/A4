...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_WEBDATABASE_WEB_DATABASE_MOJOM_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_WEBDATABASE_WEB_DATABASE_MOJOM_H_
...
class CONTENT_EXPORT WebDatabase
...
class CONTENT_EXPORT WebDatabaseInterceptorForTesting : public WebDatabase {
...
class CONTENT_EXPORT WebDatabaseAsyncWaiter {
 public:
...
class CONTENT_EXPORT WebDatabaseHost
...
class CONTENT_EXPORT WebDatabaseHostInterceptorForTesting : public WebDatabaseHost {
...
class CONTENT_EXPORT WebDatabaseHostAsyncWaiter {
 public:
...
class CONTENT_EXPORT WebDatabaseProxy
    : public WebDatabase {
 public:
...
class CONTENT_EXPORT WebDatabaseHostProxy
...
class CONTENT_EXPORT WebDatabaseStubDispatch {
 public:
...
class CONTENT_EXPORT WebDatabaseHostStubDispatch {
 public:
...
class CONTENT_EXPORT WebDatabaseRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class CONTENT_EXPORT WebDatabaseHostRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class CONTENT_EXPORT WebDatabaseHostResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_WEBDATABASE_WEB_DATABASE_MOJOM_H_