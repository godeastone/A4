...
void NotificationServiceProxy::DisplayNonPersistentNotification(
    const WTF::String& in_token, const ::blink::WebNotificationData& in_notification_data, const ::blink::WebNotificationResources& in_notification_resources, NonPersistentNotificationListenerPtr in_event_listener) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NotificationServiceProxy::DisplayPersistentNotification(
    int64_t in_service_worker_registration_id, const ::blink::WebNotificationData& in_notification_data, const ::blink::WebNotificationResources& in_notification_resources, DisplayPersistentNotificationCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NotificationServiceProxy::GetNotifications(
    int64_t in_service_worker_registration_id, const WTF::String& in_filter_tag, GetNotificationsCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class NotificationService_GetNotifications_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      const WTF::Vector<WTF::String>& in_notification_ids, const WTF::Vector<::blink::WebNotificationData>& in_notification_datas);
...
bool NotificationService_GetNotifications_ForwardToCallback::Accept(
  ...
  WTF::Vector<::blink::WebNotificationData> p_notification_datas{};
...
bool NotificationServiceStubDispatch::Accept(
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::NotificationService::DisplayNonPersistentNotification",
      ...
      bool success = true;
      WTF::String p_token{};
      ::blink::WebNotificationData p_notification_data{};
      ::blink::WebNotificationResources p_notification_resources{};
...
void NotificationServiceInterceptorForTesting::DisplayNonPersistentNotification(const WTF::String& token, const ::blink::WebNotificationData& notification_data, const ::blink::WebNotificationResources& notification_resources, NonPersistentNotificationListenerPtr event_listener) {
...
void NotificationServiceInterceptorForTesting::DisplayPersistentNotification(int64_t service_worker_registration_id, const ::blink::WebNotificationData& notification_data, const ::blink::WebNotificationResources& notification_resources, DisplayPersistentNotificationCallback callback) {
...
void NotificationServiceInterceptorForTesting::GetNotifications(int64_t service_worker_registration_id, const WTF::String& filter_tag, GetNotificationsCallback callback) {
...
,
             WTF::Vector<::blink::WebNotificationData>* out_notification_datas
,
             const WTF::Vector<WTF::String>& notification_ids,
             const WTF::Vector<::blink::WebNotificationData>& notification_datas) {*out_notification_ids = std::move(notification_ids);*out_notification_datas = std::move(notification_datas);
            loop->Quit();
          },
          &loop,
