...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_KEYBOARD_LOCK_KEYBOARD_LOCK_MOJOM_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_KEYBOARD_LOCK_KEYBOARD_LOCK_MOJOM_H_
...
class CONTENT_EXPORT KeyboardLockService
...
class CONTENT_EXPORT KeyboardLockServiceInterceptorForTesting : public KeyboardLockService {
...
class CONTENT_EXPORT KeyboardLockServiceAsyncWaiter {
 public:
...
class CONTENT_EXPORT KeyboardLockServiceProxy
...
class CONTENT_EXPORT KeyboardLockServiceStubDispatch {
 public:
...
class CONTENT_EXPORT KeyboardLockServiceRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class CONTENT_EXPORT KeyboardLockServiceResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
class CONTENT_EXPORT GetKeyboardLayoutMapResult {
 public:
...
template <>
struct CONTENT_EXPORT StructTraits<::blink::mojom::GetKeyboardLayoutMapResult::DataView,
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_KEYBOARD_LOCK_KEYBOARD_LOCK_MOJOM_H_