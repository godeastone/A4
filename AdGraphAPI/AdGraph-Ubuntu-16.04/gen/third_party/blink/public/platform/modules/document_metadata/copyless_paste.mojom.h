...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_DOCUMENT_METADATA_COPYLESS_PASTE_MOJOM_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_DOCUMENT_METADATA_COPYLESS_PASTE_MOJOM_H_
...
class CONTENT_EXPORT CopylessPaste
...
class CONTENT_EXPORT CopylessPasteInterceptorForTesting : public CopylessPaste {
  virtual CopylessPaste* GetForwardingInterface() = 0;
  void GetEntities(GetEntitiesCallback callback) override;
};
class CONTENT_EXPORT CopylessPasteAsyncWaiter {
 public:
...
class CONTENT_EXPORT CopylessPasteProxy
...
class CONTENT_EXPORT CopylessPasteStubDispatch {
 public:
...
class CONTENT_EXPORT CopylessPasteRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class CONTENT_EXPORT CopylessPasteResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
template <>
struct CONTENT_EXPORT StructTraits<::blink::mojom::document_metadata::Property::DataView,
...
template <>
struct CONTENT_EXPORT StructTraits<::blink::mojom::document_metadata::Entity::DataView,
...
template <>
struct CONTENT_EXPORT StructTraits<::blink::mojom::document_metadata::WebPage::DataView,
...
template <>
struct CONTENT_EXPORT UnionTraits<::blink::mojom::document_metadata::Values::DataView,
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_DOCUMENT_METADATA_COPYLESS_PASTE_MOJOM_H_