...
#include "third_party/blink/public/platform/modules/broadcastchannel/broadcast_channel.mojom-shared-message-ids.h"
...
void BroadcastChannelClientProxy::OnMessage(
  ...
  TRACE_EVENT0("mojom", "blink::mojom::BroadcastChannelClient::OnMessage");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::BroadcastChannelClient::OnMessage",
...
void BroadcastChannelProviderProxy::ConnectToChannel(
    const scoped_refptr<const ::blink::SecurityOrigin>& in_origin, const WTF::String& in_name, BroadcastChannelClientAssociatedPtrInfo in_receiver, BroadcastChannelClientAssociatedRequest in_sender) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::BroadcastChannelProvider::ConnectToChannel");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::BroadcastChannelProvider::ConnectToChannel",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
