...
#include "third_party/blink/public/platform/modules/hyphenation/hyphenation.mojom-shared-message-ids.h"
...
bool HyphenationProxy::OpenDictionary(
  ...
  TRACE_EVENT0("mojom", "blink::mojom::Hyphenation::OpenDictionary");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::Hyphenation::OpenDictionaryCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::Hyphenation::OpenDictionary",
               "message", message->name());
#endif
      break;
    }
