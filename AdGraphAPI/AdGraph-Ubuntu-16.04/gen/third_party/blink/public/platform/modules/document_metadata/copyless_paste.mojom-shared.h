...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_DOCUMENT_METADATA_COPYLESS_PASTE_MOJOM_SHARED_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_DOCUMENT_METADATA_COPYLESS_PASTE_MOJOM_SHARED_H_
...
#include "third_party/blink/public/platform/modules/document_metadata/copyless_paste.mojom-shared-internal.h"
...
struct Serializer<::blink::mojom::document_metadata::WebPageDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    decltype(CallWithContext(Traits::entities, input, custom_context)) in_entities = CallWithContext(Traits::entities, input, custom_context);
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    switch (result->tag) {
      case ::blink::mojom::document_metadata::ValuesDataView::Tag::BOOL_VALUES: {
        decltype(CallWithContext(Traits::bool_values, input, custom_context))
            in_bool_values = CallWithContext(Traits::bool_values, input,
                                          custom_context);
      ...
      case ::blink::mojom::document_metadata::ValuesDataView::Tag::LONG_VALUES: {
        decltype(CallWithContext(Traits::long_values, input, custom_context))
            in_long_values = CallWithContext(Traits::long_values, input,
                                          custom_context);
      ...
      case ::blink::mojom::document_metadata::ValuesDataView::Tag::STRING_VALUES: {
        decltype(CallWithContext(Traits::string_values, input, custom_context))
            in_string_values = CallWithContext(Traits::string_values, input,
                                          custom_context);
      ...
      case ::blink::mojom::document_metadata::ValuesDataView::Tag::ENTITY_VALUES: {
        decltype(CallWithContext(Traits::entity_values, input, custom_context))
            in_entity_values = CallWithContext(Traits::entity_values, input,
                                          custom_context);
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_DOCUMENT_METADATA_COPYLESS_PASTE_MOJOM_SHARED_H_
