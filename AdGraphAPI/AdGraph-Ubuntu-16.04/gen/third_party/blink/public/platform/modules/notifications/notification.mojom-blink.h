...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_NOTIFICATIONS_NOTIFICATION_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_NOTIFICATIONS_NOTIFICATION_MOJOM_BLINK_H_
...
class BLINK_PLATFORM_EXPORT NotificationData {
 public:
  ...
  NotificationData(
      ...
      const base::Optional<WTF::Vector<int8_t>>& data,
  ...
  bool silent;
  bool require_interaction;
  base::Optional<WTF::Vector<int8_t>> data;
  base::Optional<WTF::Vector<NotificationActionPtr>> actions;
...
class BLINK_PLATFORM_EXPORT NotificationResources {
 public:
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::NotificationData::DataView,
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::NotificationResources::DataView,
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_NOTIFICATIONS_NOTIFICATION_MOJOM_BLINK_H_