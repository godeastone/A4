...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_BUDGET_SERVICE_BUDGET_SERVICE_MOJOM_SHARED_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_BUDGET_SERVICE_BUDGET_SERVICE_MOJOM_SHARED_H_
...
#include "third_party/blink/public/platform/modules/budget_service/budget_service.mojom-shared-internal.h"
...
using BudgetServicePtrDataView =
    mojo::InterfacePtrDataView<BudgetServiceInterfaceBase>;
using BudgetServiceRequestDataView =
    mojo::InterfaceRequestDataView<BudgetServiceInterfaceBase>;
using BudgetServiceAssociatedPtrInfoDataView =
    mojo::AssociatedInterfacePtrInfoDataView<BudgetServiceInterfaceBase>;
using BudgetServiceAssociatedRequestDataView =
    mojo::AssociatedInterfaceRequestDataView<BudgetServiceInterfaceBase>;
class BudgetStateDataView {
 public:
  BudgetStateDataView() {}
...
struct Serializer<::blink::mojom::BudgetStateDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
                        Buffer* buffer,
                        ::blink::mojom::internal::BudgetState_Data::BufferWriter* output,
                        SerializationContext* context) {
    if (CallIsNullIfExists<Traits>(input))
      return;
    void* custom_context = CustomContextHelper<Traits>::SetUp(input, context);
    (*output).Allocate(buffer);
    (*output)->budget_at = CallWithContext(Traits::budget_at, input, custom_context);
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_BUDGET_SERVICE_BUDGET_SERVICE_MOJOM_SHARED_H_
