...
// static
bool StructTraits<::password_manager::mojom::blink::CredentialInfo::DataView, ::password_manager::mojom::blink::CredentialInfoPtr>::Read(
    ::password_manager::mojom::blink::CredentialInfo::DataView input,
    ::password_manager::mojom::blink::CredentialInfoPtr* output) {
  bool success = true;
  ::password_manager::mojom::blink::CredentialInfoPtr result(::password_manager::mojom::blink::CredentialInfo::New());
