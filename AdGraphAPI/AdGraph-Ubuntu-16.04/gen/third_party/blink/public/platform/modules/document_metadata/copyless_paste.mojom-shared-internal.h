...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_DOCUMENT_METADATA_COPYLESS_PASTE_MOJOM_SHARED_INTERNAL_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_DOCUMENT_METADATA_COPYLESS_PASTE_MOJOM_SHARED_INTERNAL_H_
...
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) Values_Data {
 public:
...
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) Property_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
...
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) Entity_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
...
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) WebPage_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
...
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) CopylessPaste_GetEntities_Params_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
...
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) CopylessPaste_GetEntities_ResponseParams_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_DOCUMENT_METADATA_COPYLESS_PASTE_MOJOM_SHARED_INTERNAL_H_