...
void ShareServiceProxy::Share(
    const WTF::String& in_title, const WTF::String& in_text, const ::blink::KURL& in_url, ShareCallback callback) {
...
void ShareServiceInterceptorForTesting::Share(const WTF::String& title, const WTF::String& text, const ::blink::KURL& url, ShareCallback callback) {
