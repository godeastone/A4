...
size_t IconDefinition::Hash(size_t seed) const {
  seed = mojo::internal::WTFHash(seed, this->src);
  seed = mojo::internal::WTFHash(seed, this->sizes);
...
BackgroundFetchOptions::BackgroundFetchOptions(
    WTF::Vector<IconDefinitionPtr> icons_in,
...
size_t BackgroundFetchRegistration::Hash(size_t seed) const {
  seed = mojo::internal::WTFHash(seed, this->developer_id);
  seed = mojo::internal::WTFHash(seed, this->unique_id);
...
void BackgroundFetchServiceProxy::Fetch(
    int64_t in_service_worker_registration_id, const WTF::String& in_developer_id, const WTF::Vector<::blink::WebServiceWorkerRequest>& in_requests, BackgroundFetchOptionsPtr in_options, const SkBitmap& in_icon, FetchCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void BackgroundFetchServiceProxy::UpdateUI(
    int64_t in_service_worker_registration_id, const WTF::String& in_developer_id, const WTF::String& in_unique_id, const WTF::String& in_title, UpdateUICallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void BackgroundFetchServiceProxy::Abort(
    int64_t in_service_worker_registration_id, const WTF::String& in_developer_id, const WTF::String& in_unique_id, AbortCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void BackgroundFetchServiceProxy::AddRegistrationObserver(
    const WTF::String& in_unique_id, BackgroundFetchRegistrationObserverPtr in_observer) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class BackgroundFetchService_GetIconDisplaySize_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      const ::blink::WebSize& in_icon_size_pixels);
...
bool BackgroundFetchService_GetIconDisplaySize_ForwardToCallback::Accept(
  ...
  serialization_context.TakeHandlesFromMessage(message);
  bool success = true;
  ::blink::WebSize p_icon_size_pixels{};
...
bool BackgroundFetchServiceStubDispatch::AcceptWithResponder(
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::BackgroundFetchService::Fetch",
      ...
      WTF::Vector<::blink::WebServiceWorkerRequest> p_requests{};
...
void BackgroundFetchServiceInterceptorForTesting::Fetch(int64_t service_worker_registration_id, const WTF::String& developer_id, const WTF::Vector<::blink::WebServiceWorkerRequest>& requests, BackgroundFetchOptionsPtr options, const SkBitmap& icon, FetchCallback callback) {
...
void BackgroundFetchServiceInterceptorForTesting::UpdateUI(int64_t service_worker_registration_id, const WTF::String& developer_id, const WTF::String& unique_id, const WTF::String& title, UpdateUICallback callback) {
...
void BackgroundFetchServiceInterceptorForTesting::Abort(int64_t service_worker_registration_id, const WTF::String& developer_id, const WTF::String& unique_id, AbortCallback callback) {
...
void BackgroundFetchServiceInterceptorForTesting::AddRegistrationObserver(const WTF::String& unique_id, BackgroundFetchRegistrationObserverPtr observer) {
...
// static
bool StructTraits<::blink::mojom::blink::IconDefinition::DataView, ::blink::mojom::blink::IconDefinitionPtr>::Read(
    ::blink::mojom::blink::IconDefinition::DataView input,
    ::blink::mojom::blink::IconDefinitionPtr* output) {
  bool success = true;
  ::blink::mojom::blink::IconDefinitionPtr result(::blink::mojom::blink::IconDefinition::New());
