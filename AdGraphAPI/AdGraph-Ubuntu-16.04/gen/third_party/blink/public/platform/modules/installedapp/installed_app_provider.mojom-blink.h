...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_INSTALLEDAPP_INSTALLED_APP_PROVIDER_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_INSTALLEDAPP_INSTALLED_APP_PROVIDER_MOJOM_BLINK_H_
...
using RevocableInstalledAppProviderPtr = ::blink::RevocableInterfacePtr<InstalledAppProvider>;
...
class BLINK_PLATFORM_EXPORT InstalledAppProvider
...
class BLINK_PLATFORM_EXPORT InstalledAppProviderInterceptorForTesting : public InstalledAppProvider {
...
class BLINK_PLATFORM_EXPORT InstalledAppProviderAsyncWaiter {
 public:
...
class BLINK_PLATFORM_EXPORT InstalledAppProviderProxy
...
class BLINK_PLATFORM_EXPORT InstalledAppProviderStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT InstalledAppProviderRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class BLINK_PLATFORM_EXPORT InstalledAppProviderResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_INSTALLEDAPP_INSTALLED_APP_PROVIDER_MOJOM_BLINK_H_