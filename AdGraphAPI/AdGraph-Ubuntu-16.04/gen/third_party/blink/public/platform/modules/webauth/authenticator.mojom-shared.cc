...
bool PublicKeyCredentialParameters_Data::Validate(
  ...
  if (!::webauth::mojom::internal::PublicKeyCredentialType_Data
...
bool PublicKeyCredentialRequestOptions_Data::Validate(
  ...
  if (!::webauth::mojom::internal::UserVerificationRequirement_Data
...
bool PublicKeyCredentialCreationOptions_Data::Validate(
  ...
  if (!::webauth::mojom::internal::AttestationConveyancePreference_Data
...
bool Authenticator_MakeCredential_ResponseParams_Data::Validate(
  ...
  if (!::webauth::mojom::internal::AuthenticatorStatus_Data
