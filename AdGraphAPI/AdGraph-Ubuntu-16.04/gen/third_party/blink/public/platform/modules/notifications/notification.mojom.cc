...
#include "third_party/blink/public/platform/modules/notifications/notification.mojom-shared-message-ids.h"
...
NotificationData::NotificationData(
    const base::string16& title_in,
    content::PlatformNotificationData::Direction direction_in,
    ...
    const base::Optional<std::vector<int8_t>>& data_in,
