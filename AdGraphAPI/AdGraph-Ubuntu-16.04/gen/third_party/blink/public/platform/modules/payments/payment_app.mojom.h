...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_PAYMENTS_PAYMENT_APP_MOJOM_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_PAYMENTS_PAYMENT_APP_MOJOM_H_
...
class CONTENT_EXPORT PaymentManagerInterceptorForTesting : public PaymentManager {
...
class CONTENT_EXPORT PaymentManagerAsyncWaiter {
 public:
...
class CONTENT_EXPORT PaymentHandlerResponseCallback
 ...
 public:
  ...
  virtual void OnResponseForAbortPayment(bool payment_aborted, base::Time dispatch_event_time) = 0;

  virtual void OnResponseForCanMakePayment(bool can_make_payment, base::Time dispatch_event_time) = 0;

  virtual void OnResponseForPaymentRequest(PaymentHandlerResponsePtr response, base::Time dispatch_event_time) = 0;
};
class CONTENT_EXPORT PaymentHandlerResponseCallbackInterceptorForTesting : public PaymentHandlerResponseCallback {
  virtual PaymentHandlerResponseCallback* GetForwardingInterface() = 0;
  void OnResponseForAbortPayment(bool payment_aborted, base::Time dispatch_event_time) override;
  void OnResponseForCanMakePayment(bool can_make_payment, base::Time dispatch_event_time) override;
  void OnResponseForPaymentRequest(PaymentHandlerResponsePtr response, base::Time dispatch_event_time) override;
};
class CONTENT_EXPORT PaymentHandlerResponseCallbackAsyncWaiter {
 public:
...
class CONTENT_EXPORT PaymentManagerProxy
...
class CONTENT_EXPORT PaymentHandlerResponseCallbackProxy
 ...
 public:
  ...
  void OnResponseForAbortPayment(bool payment_aborted, base::Time dispatch_event_time) final;
  void OnResponseForCanMakePayment(bool can_make_payment, base::Time dispatch_event_time) final;
  void OnResponseForPaymentRequest(PaymentHandlerResponsePtr response, base::Time dispatch_event_time) final;

 private:
  mojo::MessageReceiverWithResponder* receiver_;
};
class CONTENT_EXPORT PaymentManagerStubDispatch {
 public:
...
class CONTENT_EXPORT PaymentHandlerResponseCallbackStubDispatch {
 public:
...
class CONTENT_EXPORT PaymentManagerRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class CONTENT_EXPORT PaymentHandlerResponseCallbackRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class CONTENT_EXPORT PaymentManagerResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
class CONTENT_EXPORT PaymentHandlerResponse {
 public:
...
class CONTENT_EXPORT PaymentInstrument {
 public:
...
class CONTENT_EXPORT CanMakePaymentEventData {
 public:
...
class CONTENT_EXPORT PaymentRequestEventData {
 public:
...
template <>
struct CONTENT_EXPORT StructTraits<::payments::mojom::PaymentInstrument::DataView,
...
template <>
struct CONTENT_EXPORT StructTraits<::payments::mojom::CanMakePaymentEventData::DataView,
...
template <>
struct CONTENT_EXPORT StructTraits<::payments::mojom::PaymentRequestEventData::DataView,
...
template <>
struct CONTENT_EXPORT StructTraits<::payments::mojom::PaymentHandlerResponse::DataView,
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_PAYMENTS_PAYMENT_APP_MOJOM_H_