...
VirtualAuthenticatorOptions::VirtualAuthenticatorOptions(
    ...
    ::webauth::mojom::AuthenticatorTransport transport_in,
    ::webauth::mojom::AuthenticatorAttachment attachment_in,
...
size_t VirtualAuthenticatorOptions::Hash(size_t seed) const {
  ...
  seed = mojo::internal::Hash(seed, this->transport);
  seed = mojo::internal::Hash(seed, this->attachment);
  seed = mojo::internal::Hash(seed, this->has_resident_key);
  seed = mojo::internal::Hash(seed, this->has_user_verification);
  return seed;
}
...
RegisteredKey::RegisteredKey(
    const std::vector<uint8_t>& key_handle_in,
    const std::vector<uint8_t>& application_parameter_in,
    const std::vector<uint8_t>& private_key_in,
    int32_t counter_in)
...
class VirtualAuthenticatorManager_GetAuthenticators_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      std::vector<VirtualAuthenticatorPtrInfo> in_authenticators);
...
bool VirtualAuthenticatorManager_GetAuthenticators_ForwardToCallback::Accept(
  ...
  serialization_context.TakeHandlesFromMessage(message);
  bool success = true;
  std::vector<VirtualAuthenticatorPtrInfo> p_authenticators{};
  ...
  proxy_->GetAuthenticators(
      base::BindOnce(
          [](base::RunLoop* loop,
             std::vector<VirtualAuthenticatorPtrInfo>* out_authenticators
,
             std::vector<VirtualAuthenticatorPtrInfo> authenticators) {*out_authenticators = std::move(authenticators);
            loop->Quit();
          },
          &loop,
          out_authenticators));
...
// static
bool StructTraits<::webauth::test::mojom::VirtualAuthenticatorOptions::DataView, ::webauth::test::mojom::VirtualAuthenticatorOptionsPtr>::Read(
    ::webauth::test::mojom::VirtualAuthenticatorOptions::DataView input,
    ::webauth::test::mojom::VirtualAuthenticatorOptionsPtr* output) {
  bool success = true;
  ::webauth::test::mojom::VirtualAuthenticatorOptionsPtr result(::webauth::test::mojom::VirtualAuthenticatorOptions::New());
...
// static
bool StructTraits<::webauth::test::mojom::RegisteredKey::DataView, ::webauth::test::mojom::RegisteredKeyPtr>::Read(
    ::webauth::test::mojom::RegisteredKey::DataView input,
    ::webauth::test::mojom::RegisteredKeyPtr* output) {
  bool success = true;
  ::webauth::test::mojom::RegisteredKeyPtr result(::webauth::test::mojom::RegisteredKey::New());
