...
AndroidPayTokenizationParameter_Data::AndroidPayTokenizationParameter_Data()
    : header_({sizeof(*this), 0}) {}
...
bool PaymentMethodData_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->supported_methods, 1, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->allowed_card_networks, 6, validation_context)) {
    return false;
  }
  ...
  if (!::payments::mojom::internal::AndroidPayTokenization_Data
        ::Validate(object->tokenization_type, validation_context))
    return false;

  if (!mojo::internal::ValidatePointerNonNullable(
          object->parameters, 8, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->supported_networks, 11, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->supported_types, 12, validation_context)) {
    return false;
  }
...
bool PaymentDetails_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->display_items, 2, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->shipping_options, 3, validation_context)) {
    return false;
  }
