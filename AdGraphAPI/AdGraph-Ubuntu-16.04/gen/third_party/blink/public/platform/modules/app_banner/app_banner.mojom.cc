...
void AppBannerControllerProxy::BannerPromptRequest(
    AppBannerServicePtr in_service, AppBannerEventRequest in_event, const std::vector<std::string>& in_platform, BannerPromptRequestCallback callback) {
...
void AppBannerControllerInterceptorForTesting::BannerPromptRequest(AppBannerServicePtr service, AppBannerEventRequest event, const std::vector<std::string>& platform, BannerPromptRequestCallback callback) {
...
,
             std::string* out_referrer
,
             AppBannerPromptReply reply,
             const std::string& referrer) {*out_reply = std::move(reply);*out_referrer = std::move(referrer);
            loop->Quit();
          },
          &loop,
          out_reply,
