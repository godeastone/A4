...
void PresentationConnectionProxy::OnMessage(
    PresentationConnectionMessagePtr in_message, OnMessageCallback callback) {
...
void PresentationConnectionInterceptorForTesting::OnMessage(PresentationConnectionMessagePtr message, OnMessageCallback callback) {
