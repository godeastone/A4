...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_GEOLOCATION_GEOLOCATION_SERVICE_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_GEOLOCATION_GEOLOCATION_SERVICE_MOJOM_BLINK_H_
...
using RevocableGeolocationServicePtr = ::blink::RevocableInterfacePtr<GeolocationService>;
...
class BLINK_PLATFORM_EXPORT GeolocationService
 ...
 public:
  ...
  virtual void CreateGeolocation(::device::mojom::blink::GeolocationRequest request, bool user_gesture) = 0;
};
class BLINK_PLATFORM_EXPORT GeolocationServiceInterceptorForTesting : public GeolocationService {
  virtual GeolocationService* GetForwardingInterface() = 0;
  void CreateGeolocation(::device::mojom::blink::GeolocationRequest request, bool user_gesture) override;
};
class BLINK_PLATFORM_EXPORT GeolocationServiceAsyncWaiter {
 public:
...
class BLINK_PLATFORM_EXPORT GeolocationServiceProxy
    : public GeolocationService {
 public:
  explicit GeolocationServiceProxy(mojo::MessageReceiverWithResponder* receiver);
  void CreateGeolocation(::device::mojom::blink::GeolocationRequest request, bool user_gesture) final;

 private:
  mojo::MessageReceiverWithResponder* receiver_;
};
class BLINK_PLATFORM_EXPORT GeolocationServiceStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT GeolocationServiceRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_GEOLOCATION_GEOLOCATION_SERVICE_MOJOM_BLINK_H_