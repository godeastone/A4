...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_DOCUMENT_METADATA_COPYLESS_PASTE_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_DOCUMENT_METADATA_COPYLESS_PASTE_MOJOM_BLINK_H_
...
#include "third_party/blink/public/platform/modules/document_metadata/copyless_paste.mojom-shared.h"
...
namespace blink {
class CopylessPaste;
using CopylessPastePtr = mojo::InterfacePtr<CopylessPaste>;
using RevocableCopylessPastePtr = ::blink::RevocableInterfacePtr<CopylessPaste>;
using CopylessPastePtrInfo = mojo::InterfacePtrInfo<CopylessPaste>;
using ThreadSafeCopylessPastePtr =
    mojo::ThreadSafeInterfacePtr<CopylessPaste>;
using CopylessPasteRequest = mojo::InterfaceRequest<CopylessPaste>;
using CopylessPasteAssociatedPtr =
    mojo::AssociatedInterfacePtr<CopylessPaste>;
using ThreadSafeCopylessPasteAssociatedPtr =
    mojo::ThreadSafeAssociatedInterfacePtr<CopylessPaste>;
using CopylessPasteAssociatedPtrInfo =
    mojo::AssociatedInterfacePtrInfo<CopylessPaste>;
using CopylessPasteAssociatedRequest =
    mojo::AssociatedInterfaceRequest<CopylessPaste>;
...
class BLINK_PLATFORM_EXPORT CopylessPaste
...
class BLINK_PLATFORM_EXPORT CopylessPasteInterceptorForTesting : public CopylessPaste {
  virtual CopylessPaste* GetForwardingInterface() = 0;
  void GetEntities(GetEntitiesCallback callback) override;
};
class BLINK_PLATFORM_EXPORT CopylessPasteAsyncWaiter {
 public:
...
class BLINK_PLATFORM_EXPORT CopylessPasteProxy
...
class BLINK_PLATFORM_EXPORT CopylessPasteStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT CopylessPasteRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class BLINK_PLATFORM_EXPORT CopylessPasteResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
class BLINK_PLATFORM_EXPORT Values {
 public:
...
class BLINK_PLATFORM_EXPORT Property {
 public:
...
class BLINK_PLATFORM_EXPORT Entity {
 public:
...
class BLINK_PLATFORM_EXPORT WebPage {
 public:
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::document_metadata::blink::Property::DataView,
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::document_metadata::blink::Entity::DataView,
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::document_metadata::blink::WebPage::DataView,
...
template <>
struct BLINK_PLATFORM_EXPORT UnionTraits<::blink::mojom::document_metadata::blink::Values::DataView,
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_DOCUMENT_METADATA_COPYLESS_PASTE_MOJOM_BLINK_H_