...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_PERMISSIONS_PERMISSION_MOJOM_SHARED_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_PERMISSIONS_PERMISSION_MOJOM_SHARED_H_
...
#include "third_party/blink/public/platform/modules/permissions/permission.mojom-shared-internal.h"
...
struct Serializer<::blink::mojom::MidiPermissionDescriptorDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    (*output)->sysex = CallWithContext(Traits::sysex, input, custom_context);
...
struct Serializer<::blink::mojom::ClipboardPermissionDescriptorDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    void* custom_context = CustomContextHelper<Traits>::SetUp(input, context);
    (*output).Allocate(buffer);
    (*output)->allowWithoutGesture = CallWithContext(Traits::allowWithoutGesture, input, custom_context);
    CustomContextHelper<Traits>::TearDown(input, custom_context);
  }
...
struct Serializer<::blink::mojom::PermissionDescriptorDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    mojo::internal::Serialize<::blink::mojom::PermissionName>(
        CallWithContext(Traits::name, input, custom_context), &(*output)->name);
    ...
    switch (result->tag) {
      case ::blink::mojom::PermissionDescriptorExtensionDataView::Tag::MIDI: {
        decltype(CallWithContext(Traits::midi, input, custom_context))
            in_midi = CallWithContext(Traits::midi, input,
                                          custom_context);
      ...
      case ::blink::mojom::PermissionDescriptorExtensionDataView::Tag::CLIPBOARD: {
        decltype(CallWithContext(Traits::clipboard, input, custom_context))
            in_clipboard = CallWithContext(Traits::clipboard, input,
                                          custom_context);
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_PERMISSIONS_PERMISSION_MOJOM_SHARED_H_
