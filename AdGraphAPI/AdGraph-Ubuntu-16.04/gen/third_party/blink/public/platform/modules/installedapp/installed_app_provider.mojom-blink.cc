...
#include "third_party/blink/public/platform/modules/installedapp/installed_app_provider.mojom-shared-message-ids.h"
...
void InstalledAppProviderProxy::FilterInstalledApps(
    WTF::Vector<::blink::mojom::blink::RelatedApplicationPtr> in_related_apps, FilterInstalledAppsCallback callback) {
...
class InstalledAppProvider_FilterInstalledApps_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      WTF::Vector<::blink::mojom::blink::RelatedApplicationPtr> in_installedApps);
...
bool InstalledAppProvider_FilterInstalledApps_ForwardToCallback::Accept(
  ...
  bool success = true;
  WTF::Vector<::blink::mojom::blink::RelatedApplicationPtr> p_installedApps{};
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        ...
        "InstalledAppProvider::FilterInstalledApps response deserializer");
    return false;
  }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::InstalledAppProvider::FilterInstalledApps",
               "message", message->name());
#endif
      break;
    }
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::InstalledAppProvider::FilterInstalledApps",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "InstalledAppProvider::FilterInstalledApps deserializer");
        return false;
      }
      InstalledAppProvider::FilterInstalledAppsCallback callback =
