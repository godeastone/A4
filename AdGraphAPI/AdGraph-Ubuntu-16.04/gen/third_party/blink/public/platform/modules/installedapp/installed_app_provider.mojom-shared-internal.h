...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_INSTALLEDAPP_INSTALLED_APP_PROVIDER_MOJOM_SHARED_INTERNAL_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_INSTALLEDAPP_INSTALLED_APP_PROVIDER_MOJOM_SHARED_INTERNAL_H_
...
#pragma pack(push, 1)
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) InstalledAppProvider_FilterInstalledApps_Params_Data {
 public:
  class BufferWriter {
   public:
...
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) InstalledAppProvider_FilterInstalledApps_ResponseParams_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_INSTALLEDAPP_INSTALLED_APP_PROVIDER_MOJOM_SHARED_INTERNAL_H_