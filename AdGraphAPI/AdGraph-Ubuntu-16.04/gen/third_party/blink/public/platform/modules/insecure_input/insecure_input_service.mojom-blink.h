...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_INSECURE_INPUT_INSECURE_INPUT_SERVICE_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_INSECURE_INPUT_INSECURE_INPUT_SERVICE_MOJOM_BLINK_H_
...
using RevocableInsecureInputServicePtr = ::blink::RevocableInterfacePtr<InsecureInputService>;
...
class BLINK_PLATFORM_EXPORT InsecureInputService
...
class BLINK_PLATFORM_EXPORT InsecureInputServiceInterceptorForTesting : public InsecureInputService {
...
class BLINK_PLATFORM_EXPORT InsecureInputServiceAsyncWaiter {
 public:
...
class BLINK_PLATFORM_EXPORT InsecureInputServiceProxy
...
class BLINK_PLATFORM_EXPORT InsecureInputServiceStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT InsecureInputServiceRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MODULES_INSECURE_INPUT_INSECURE_INPUT_SERVICE_MOJOM_BLINK_H_