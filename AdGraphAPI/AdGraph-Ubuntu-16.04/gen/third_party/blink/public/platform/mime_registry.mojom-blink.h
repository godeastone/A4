...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MIME_REGISTRY_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MIME_REGISTRY_MOJOM_BLINK_H_
...
#include "third_party/blink/public/platform/mime_registry.mojom-shared.h"
...
using RevocableMimeRegistryPtr = ::blink::RevocableInterfacePtr<MimeRegistry>;
...
class BLINK_PLATFORM_EXPORT MimeRegistryInterceptorForTesting : public MimeRegistry {
...
class BLINK_PLATFORM_EXPORT MimeRegistryAsyncWaiter {
 public:
...
class BLINK_PLATFORM_EXPORT MimeRegistryRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class BLINK_PLATFORM_EXPORT MimeRegistryResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MIME_REGISTRY_MOJOM_BLINK_H_