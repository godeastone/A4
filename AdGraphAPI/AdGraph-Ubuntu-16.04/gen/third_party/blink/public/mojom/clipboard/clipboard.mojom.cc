...
bool ClipboardHost::GetSequenceNumber(ui::ClipboardType buffer, uint64_t* out_result) {
  NOTREACHED();
  return false;
}
bool ClipboardHost::IsFormatAvailable(ClipboardFormat format, ui::ClipboardType buffer, bool* out_result) {
  NOTREACHED();
  return false;
}
bool ClipboardHost::ReadAvailableTypes(ui::ClipboardType buffer, std::vector<base::string16>* out_types, bool* out_result) {
  NOTREACHED();
  return false;
}
bool ClipboardHost::ReadText(ui::ClipboardType buffer, base::string16* out_result) {
  NOTREACHED();
  return false;
}
bool ClipboardHost::ReadHtml(ui::ClipboardType buffer, base::string16* out_markup, GURL* out_url, uint32_t* out_fragment_start, uint32_t* out_fragment_end) {
  NOTREACHED();
  return false;
}
bool ClipboardHost::ReadRtf(ui::ClipboardType buffer, std::string* out_result) {
  NOTREACHED();
  return false;
}
bool ClipboardHost::ReadImage(ui::ClipboardType buffer, ::blink::mojom::SerializedBlobPtr* out_blob) {
  NOTREACHED();
  return false;
}
bool ClipboardHost::ReadCustomData(ui::ClipboardType buffer, const base::string16& type, base::string16* out_result) {
  NOTREACHED();
  return false;
}
...
class ClipboardHost_ReadAvailableTypes_HandleSyncResponse
 ...
 public:
  ClipboardHost_ReadAvailableTypes_HandleSyncResponse(
      bool* result, std::vector<base::string16>* out_types, bool* out_result)
...
class ClipboardHost_ReadImage_HandleSyncResponse
 ...
 private:
  bool* result_;
  ::blink::mojom::SerializedBlobPtr* out_blob_;DISALLOW_COPY_AND_ASSIGN(ClipboardHost_ReadImage_HandleSyncResponse);
};
...
bool ClipboardHostProxy::GetSequenceNumber(
    ui::ClipboardType param_buffer, uint64_t* out_param_result) {
...
void ClipboardHostProxy::GetSequenceNumber(
    ui::ClipboardType in_buffer, GetSequenceNumberCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::ClipboardHost::GetSequenceNumber");
#endif
  const bool kExpectsResponse = true;
...
bool ClipboardHostProxy::IsFormatAvailable(
    ClipboardFormat param_format, ui::ClipboardType param_buffer, bool* out_param_result) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ClipboardHostProxy::IsFormatAvailable(
    ClipboardFormat in_format, ui::ClipboardType in_buffer, IsFormatAvailableCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::ClipboardHost::IsFormatAvailable");
#endif
  const bool kExpectsResponse = true;
...
bool ClipboardHostProxy::ReadAvailableTypes(
    ui::ClipboardType param_buffer, std::vector<base::string16>* out_param_types, bool* out_param_result) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ClipboardHostProxy::ReadAvailableTypes(
    ui::ClipboardType in_buffer, ReadAvailableTypesCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::ClipboardHost::ReadAvailableTypes");
#endif
  const bool kExpectsResponse = true;
...
bool ClipboardHostProxy::ReadText(
    ui::ClipboardType param_buffer, base::string16* out_param_result) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ClipboardHostProxy::ReadText(
    ui::ClipboardType in_buffer, ReadTextCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::ClipboardHost::ReadText");
#endif
  const bool kExpectsResponse = true;
...
bool ClipboardHostProxy::ReadHtml(
    ui::ClipboardType param_buffer, base::string16* out_param_markup, GURL* out_param_url, uint32_t* out_param_fragment_start, uint32_t* out_param_fragment_end) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ClipboardHostProxy::ReadHtml(
    ui::ClipboardType in_buffer, ReadHtmlCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::ClipboardHost::ReadHtml");
#endif
  const bool kExpectsResponse = true;
...
bool ClipboardHostProxy::ReadRtf(
    ui::ClipboardType param_buffer, std::string* out_param_result) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ClipboardHostProxy::ReadRtf(
    ui::ClipboardType in_buffer, ReadRtfCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::ClipboardHost::ReadRtf");
#endif
  const bool kExpectsResponse = true;
...
bool ClipboardHostProxy::ReadImage(
    ui::ClipboardType param_buffer, ::blink::mojom::SerializedBlobPtr* out_param_blob) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ClipboardHostProxy::ReadImage(
    ui::ClipboardType in_buffer, ReadImageCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::ClipboardHost::ReadImage");
#endif
  const bool kExpectsResponse = true;
...
bool ClipboardHostProxy::ReadCustomData(
    ui::ClipboardType param_buffer, const base::string16& param_type, base::string16* out_param_result) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ClipboardHostProxy::ReadCustomData(
    ui::ClipboardType in_buffer, const base::string16& in_type, ReadCustomDataCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::ClipboardHost::ReadCustomData");
#endif
  const bool kExpectsResponse = true;
...
void ClipboardHostProxy::WriteText(
    ui::ClipboardType in_buffer, const base::string16& in_text) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ClipboardHostProxy::WriteHtml(
    ui::ClipboardType in_buffer, const base::string16& in_markup, const GURL& in_url) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ClipboardHostProxy::WriteCustomData(
    ui::ClipboardType in_buffer, const base::flat_map<base::string16, base::string16>& in_data) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ClipboardHostProxy::WriteBookmark(
    ui::ClipboardType in_buffer, const std::string& in_url, const base::string16& in_title) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ClipboardHostProxy::WriteImage(
    ui::ClipboardType in_buffer, const gfx::Size& in_size_in_pixels, mojo::ScopedSharedBufferHandle in_shared_buffer_handle) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class ClipboardHost_ReadAvailableTypes_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      const std::vector<base::string16>& in_types, bool in_result);
...
void ClipboardHostInterceptorForTesting::WriteText(ui::ClipboardType buffer, const base::string16& text) {
  GetForwardingInterface()->WriteText(std::move(buffer), std::move(text));
}
void ClipboardHostInterceptorForTesting::WriteHtml(ui::ClipboardType buffer, const base::string16& markup, const GURL& url) {
  GetForwardingInterface()->WriteHtml(std::move(buffer), std::move(markup), std::move(url));
}
void ClipboardHostInterceptorForTesting::WriteSmartPasteMarker(ui::ClipboardType buffer) {
  GetForwardingInterface()->WriteSmartPasteMarker(std::move(buffer));
}
void ClipboardHostInterceptorForTesting::WriteCustomData(ui::ClipboardType buffer, const base::flat_map<base::string16, base::string16>& data) {
  GetForwardingInterface()->WriteCustomData(std::move(buffer), std::move(data));
}
void ClipboardHostInterceptorForTesting::WriteBookmark(ui::ClipboardType buffer, const std::string& url, const base::string16& title) {
  GetForwardingInterface()->WriteBookmark(std::move(buffer), std::move(url), std::move(title));
}
void ClipboardHostInterceptorForTesting::WriteImage(ui::ClipboardType buffer, const gfx::Size& size_in_pixels, mojo::ScopedSharedBufferHandle shared_buffer_handle) {
  GetForwardingInterface()->WriteImage(std::move(buffer), std::move(size_in_pixels), std::move(shared_buffer_handle));
}
void ClipboardHostInterceptorForTesting::CommitWrite(ui::ClipboardType buffer) {
