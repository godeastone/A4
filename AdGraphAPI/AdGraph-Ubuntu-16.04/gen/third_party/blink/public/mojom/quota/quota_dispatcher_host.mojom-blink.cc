...
void QuotaDispatcherHostProxy::QueryStorageUsageAndQuota(
    const scoped_refptr<const ::blink::SecurityOrigin>& in_origin, ::blink::mojom::blink::StorageType in_storage_type, QueryStorageUsageAndQuotaCallback callback) {
...
void QuotaDispatcherHostProxy::RequestStorageQuota(
    const scoped_refptr<const ::blink::SecurityOrigin>& in_origin, ::blink::mojom::blink::StorageType in_storage_type, uint64_t in_requested_size, RequestStorageQuotaCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class QuotaDispatcherHost_QueryStorageUsageAndQuota_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::blink::mojom::blink::QuotaStatusCode in_error, int64_t in_current_usage, int64_t in_current_quota);
...
void QuotaDispatcherHostAsyncWaiter::QueryStorageUsageAndQuota(
    const scoped_refptr<const ::blink::SecurityOrigin>& origin, ::blink::mojom::blink::StorageType storage_type, ::blink::mojom::blink::QuotaStatusCode* out_error, int64_t* out_current_usage, int64_t* out_current_quota) {
  base::RunLoop loop;
