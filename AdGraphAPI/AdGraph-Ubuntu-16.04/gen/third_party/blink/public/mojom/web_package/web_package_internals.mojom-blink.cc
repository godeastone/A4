...
#include "third_party/blink/public/mojom/web_package/web_package_internals.mojom-blink.h"
...
void WebPackageInternalsProxy::SetSignedExchangeVerificationTime(
    WTF::Time in_time, SetSignedExchangeVerificationTimeCallback callback) {
...
void WebPackageInternalsInterceptorForTesting::SetSignedExchangeVerificationTime(WTF::Time time, SetSignedExchangeVerificationTimeCallback callback) {
