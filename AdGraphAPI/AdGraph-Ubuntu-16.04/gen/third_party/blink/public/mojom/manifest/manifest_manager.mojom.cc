...
bool ManifestManager_RequestManifest_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        ...
        "ManifestManager::RequestManifest response deserializer");
    return false;
  }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::ManifestManager::RequestManifestCallback",
               "message", message.name());
#endif
...
class ManifestManager_RequestManifestDebugInfo_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      const GURL& in_url, ::blink::mojom::ManifestDebugInfoPtr in_debug_info);
...
bool ManifestManager_RequestManifestDebugInfo_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "ManifestManager::RequestManifestDebugInfo response deserializer");
    return false;
  }
  if (!callback_.is_null())
    std::move(callback_).Run(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::ManifestManager::RequestManifestDebugInfoCallback",
               "message", message.name());
#endif
  message.set_request_id(request_id_);
  ignore_result(responder_->Accept(&message));
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::ManifestManager::RequestManifest",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::ManifestManager::RequestManifestDebugInfo",
               "message", message->name());
#endif
      break;
    }
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::ManifestManager::RequestManifest",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "ManifestManager::RequestManifest deserializer");
        return false;
      }
      ManifestManager::RequestManifestCallback callback =
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::ManifestManager::RequestManifestDebugInfo",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "ManifestManager::RequestManifestDebugInfo deserializer");
        return false;
      }
      ManifestManager::RequestManifestDebugInfoCallback callback =
