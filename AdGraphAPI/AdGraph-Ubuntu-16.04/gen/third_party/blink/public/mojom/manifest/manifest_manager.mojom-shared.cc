...
bool ManifestManager_RequestManifest_Params_Data::Validate(
  ...
  const ManifestManager_RequestManifest_Params_Data* object = static_cast<const ManifestManager_RequestManifest_Params_Data*>(data);
...
bool ManifestManager_RequestManifest_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ManifestManager_RequestManifest_ResponseParams_Data* object = static_cast<const ManifestManager_RequestManifest_ResponseParams_Data*>(data);
...
bool ManifestManager_RequestManifestDebugInfo_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ManifestManager_RequestManifestDebugInfo_Params_Data* object = static_cast<const ManifestManager_RequestManifestDebugInfo_Params_Data*>(data);
...
bool ManifestManager_RequestManifestDebugInfo_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ManifestManager_RequestManifestDebugInfo_ResponseParams_Data* object = static_cast<const ManifestManager_RequestManifestDebugInfo_ResponseParams_Data*>(data);
