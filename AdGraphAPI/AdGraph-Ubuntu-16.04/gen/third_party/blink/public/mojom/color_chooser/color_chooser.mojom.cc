...
#include "third_party/blink/public/mojom/color_chooser/color_chooser.mojom-shared-message-ids.h"
namespace blink {
namespace mojom {
...
void ColorChooserFactoryProxy::OpenColorChooser(
    ColorChooserRequest in_chooser, ColorChooserClientPtr in_client, uint32_t in_color, std::vector<ColorSuggestionPtr> in_suggestions) {
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::ColorChooserFactory::OpenColorChooser",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            ...
            "ColorChooserFactory::OpenColorChooser deserializer");
        return false;
      }
...
void ColorChooserFactoryInterceptorForTesting::OpenColorChooser(ColorChooserRequest chooser, ColorChooserClientPtr client, uint32_t color, std::vector<ColorSuggestionPtr> suggestions) {
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::ColorChooser::SetSelectedColor",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "ColorChooser::SetSelectedColor deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::ColorChooserClient::DidChooseColor",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "ColorChooserClient::DidChooseColor deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
