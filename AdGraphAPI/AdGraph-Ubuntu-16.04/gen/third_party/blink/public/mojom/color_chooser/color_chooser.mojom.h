...
#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_COLOR_CHOOSER_COLOR_CHOOSER_MOJOM_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_COLOR_CHOOSER_COLOR_CHOOSER_MOJOM_H_
...
#include "third_party/blink/public/mojom/color_chooser/color_chooser.mojom-shared.h"
#include <string>
#include <vector>
...
class BLINK_COMMON_EXPORT ColorChooserFactory
 ...
 public:
  ...
  virtual void OpenColorChooser(ColorChooserRequest chooser, ColorChooserClientPtr client, uint32_t color, std::vector<ColorSuggestionPtr> suggestions) = 0;
};
...
class BLINK_COMMON_EXPORT ColorChooser
...
class BLINK_COMMON_EXPORT ColorChooserClient
...
class BLINK_COMMON_EXPORT ColorChooserFactoryProxy
 ...
 public:
  ...
  void OpenColorChooser(ColorChooserRequest chooser, ColorChooserClientPtr client, uint32_t color, std::vector<ColorSuggestionPtr> suggestions) final;
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ColorSuggestion::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::ColorSuggestion::DataView,
                                         ::blink::mojom::ColorSuggestionPtr> {
  ...
  static decltype(::blink::mojom::ColorSuggestion::color) color(
      const ::blink::mojom::ColorSuggestionPtr& input) {
    return input->color;
  }

  static const decltype(::blink::mojom::ColorSuggestion::label)& label(
      const ::blink::mojom::ColorSuggestionPtr& input) {
    return input->label;
  }
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_MOJOM_COLOR_CHOOSER_COLOR_CHOOSER_MOJOM_H_