...
void ProgressClientProxy::OnProgress(
  ...
  TRACE_EVENT0("mojom", "blink::mojom::ProgressClient::OnProgress");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::ProgressClient::OnProgress",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            ...
            "ProgressClient::OnProgress deserializer");
        return false;
      }
...
bool BlobRegistry::Register(::blink::mojom::BlobRequest blob, const std::string& uuid, const std::string& content_type, const std::string& content_disposition, std::vector<::blink::mojom::DataElementPtr> elements) {
  NOTREACHED();
  return false;
}
bool BlobRegistry::GetBlobFromUUID(::blink::mojom::BlobRequest blob, const std::string& uuid) {
  NOTREACHED();
  return false;
}
...
bool BlobRegistryProxy::Register(
    ::blink::mojom::BlobRequest param_blob, const std::string& param_uuid, const std::string& param_content_type, const std::string& param_content_disposition, std::vector<::blink::mojom::DataElementPtr> param_elements) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::BlobRegistry::Register");
#endif
...
void BlobRegistryProxy::Register(
    ::blink::mojom::BlobRequest in_blob, const std::string& in_uuid, const std::string& in_content_type, const std::string& in_content_disposition, std::vector<::blink::mojom::DataElementPtr> in_elements, RegisterCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::BlobRegistry::Register");
#endif
  const bool kExpectsResponse = true;
...
void BlobRegistryProxy::RegisterFromStream(
    const std::string& in_content_type, const std::string& in_content_disposition, uint64_t in_length_hint, mojo::ScopedDataPipeConsumerHandle in_data, ProgressClientAssociatedPtrInfo in_progress_client, RegisterFromStreamCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::BlobRegistry::RegisterFromStream");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
bool BlobRegistryProxy::GetBlobFromUUID(
    ::blink::mojom::BlobRequest param_blob, const std::string& param_uuid) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::BlobRegistry::GetBlobFromUUID");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = true;
...
void BlobRegistryProxy::GetBlobFromUUID(
    ::blink::mojom::BlobRequest in_blob, const std::string& in_uuid, GetBlobFromUUIDCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::BlobRegistry::GetBlobFromUUID");
#endif
  const bool kExpectsResponse = true;
...
void BlobRegistryProxy::URLStoreForOrigin(
    const url::Origin& in_origin, ::blink::mojom::BlobURLStoreAssociatedRequest in_url_store) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::BlobRegistry::URLStoreForOrigin");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
bool BlobRegistry_Register_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "BlobRegistry::Register response deserializer");
    return false;
  }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::BlobRegistry::RegisterCallback",
               "message", message.name());
#endif
...
bool BlobRegistry_RegisterFromStream_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "BlobRegistry::RegisterFromStream response deserializer");
    return false;
  }
  if (!callback_.is_null())
    std::move(callback_).Run(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::BlobRegistry::RegisterFromStreamCallback",
               "message", message.name());
#endif
  message.set_request_id(request_id_);
  ignore_result(responder_->Accept(&message));
...
bool BlobRegistry_GetBlobFromUUID_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "BlobRegistry::GetBlobFromUUID response deserializer");
    return false;
  }
  if (!callback_.is_null())
    std::move(callback_).Run();
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::BlobRegistry::GetBlobFromUUIDCallback",
               "message", message.name());
#endif
  message.set_request_id(request_id_);
  ignore_result(responder_->Accept(&message));
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::BlobRegistry::Register",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::BlobRegistry::RegisterFromStream",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::BlobRegistry::GetBlobFromUUID",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::BlobRegistry::URLStoreForOrigin",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      bool success = true;
      url::Origin p_origin{};
      ::blink::mojom::BlobURLStoreAssociatedRequest p_url_store{};
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "BlobRegistry::URLStoreForOrigin deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
bool BlobRegistryStubDispatch::AcceptWithResponder(
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::BlobRegistry::Register",
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::blink::mojom::BlobRequest p_blob{};
      std::string p_uuid{};
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "BlobRegistry::Register deserializer");
        return false;
      }
      BlobRegistry::RegisterCallback callback =
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::BlobRegistry::RegisterFromStream",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "BlobRegistry::RegisterFromStream deserializer");
        return false;
      }
      BlobRegistry::RegisterFromStreamCallback callback =
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::BlobRegistry::GetBlobFromUUID",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "BlobRegistry::GetBlobFromUUID deserializer");
        return false;
      }
      BlobRegistry::GetBlobFromUUIDCallback callback =
