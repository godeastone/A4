...
using RevocableBytesProviderPtr = ::blink::RevocableInterfacePtr<BytesProvider>;
...
class PLATFORM_EXPORT BytesProvider
 ...
 public:
  ...
  using RequestAsFileCallback = base::OnceCallback<void(base::Optional<WTF::Time>)>;
...
class PLATFORM_EXPORT DataElementFile {
 public:
  ...
  DataElementFile(
      ...
      uint64_t offset,
      uint64_t length,
      base::Optional<WTF::Time> expected_modification_time);
