...
using RevocableBlobReaderClientPtr = ::blink::RevocableInterfacePtr<BlobReaderClient>;
...
using RevocableBlobPtr = ::blink::RevocableInterfacePtr<Blob>;
...
class PLATFORM_EXPORT Blob
 ...
 public:
  ...
  using ReadSideDataCallback = base::OnceCallback<void(const base::Optional<WTF::Vector<uint8_t>>&)>;
