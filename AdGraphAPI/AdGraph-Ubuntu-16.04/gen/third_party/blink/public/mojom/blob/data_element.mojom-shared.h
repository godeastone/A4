...
struct Serializer<::blink::mojom::DataElementBytesDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    decltype(CallWithContext(Traits::embedded_data, input, custom_context)) in_embedded_data = CallWithContext(Traits::embedded_data, input, custom_context);
...
struct Serializer<::blink::mojom::DataElementFileDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    (*output)->length = CallWithContext(Traits::length, input, custom_context);
    decltype(CallWithContext(Traits::expected_modification_time, input, custom_context)) in_expected_modification_time = CallWithContext(Traits::expected_modification_time, input, custom_context);
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    switch (result->tag) {
      ...
      case ::blink::mojom::DataElementDataView::Tag::FILE_FILESYSTEM: {
        decltype(CallWithContext(Traits::file_filesystem, input, custom_context))
            in_file_filesystem = CallWithContext(Traits::file_filesystem, input,
                                          custom_context);
      ...
      case ::blink::mojom::DataElementDataView::Tag::BLOB: {
        decltype(CallWithContext(Traits::blob, input, custom_context))
            in_blob = CallWithContext(Traits::blob, input,
                                          custom_context);
