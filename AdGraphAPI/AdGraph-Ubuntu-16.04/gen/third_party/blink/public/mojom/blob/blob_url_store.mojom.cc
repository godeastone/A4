...
bool BlobURLStore::Register(::blink::mojom::BlobPtr blob, const GURL& url) {
  NOTREACHED();
  return false;
}
...
bool BlobURLStoreProxy::Register(
    ::blink::mojom::BlobPtr param_blob, const GURL& param_url) {
...
void BlobURLStoreProxy::Register(
    ::blink::mojom::BlobPtr in_blob, const GURL& in_url, RegisterCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::BlobURLStore::Register");
#endif
  const bool kExpectsResponse = true;
...
void BlobURLStoreProxy::ResolveAsURLLoaderFactory(
    const GURL& in_url, ::network::mojom::URLLoaderFactoryRequest in_factory) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void BlobURLStoreProxy::ResolveForNavigation(
    const GURL& in_url, BlobURLTokenRequest in_token) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
std::move(p_url));
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::BlobURLStore::ResolveAsURLLoaderFactory",
      ...
      bool success = true;
      GURL p_url{};
      ::network::mojom::URLLoaderFactoryRequest p_factory{};
