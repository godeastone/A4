...
DataElementBytes::DataElementBytes(
    uint64_t length_in,
    const base::Optional<WTF::Vector<uint8_t>>& embedded_data_in,
...
DataElementFile::DataElementFile(
    ...
    uint64_t offset_in,
    uint64_t length_in,
    base::Optional<WTF::Time> expected_modification_time_in)
...
void BytesProviderProxy::RequestAsReply(
  ...
  TRACE_EVENT0("mojom", "blink::mojom::BytesProvider::RequestAsReply");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::BytesProvider::RequestAsStream");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::BytesProvider::RequestAsFile");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
bool BytesProvider_RequestAsReply_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "blink::mojom::BytesProvider::RequestAsReplyCallback",
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        ...
        "BytesProvider::RequestAsReply response deserializer");
    return false;
  }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::BytesProvider::RequestAsReplyCallback",
               "message", message.name());
#endif
...
class BytesProvider_RequestAsFile_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      base::Optional<WTF::Time> in_time_file_modified);
...
bool BytesProvider_RequestAsFile_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "blink::mojom::BytesProvider::RequestAsFileCallback",
               "message", message->name());
#endif
  mojo::internal::MessageDispatchContext dispatch_context(message);
  ...
  serialization_context.TakeHandlesFromMessage(message);
  bool success = true;
  base::Optional<WTF::Time> p_time_file_modified{};
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "BytesProvider::RequestAsFile response deserializer");
    return false;
  }
  if (!callback_.is_null())
    std::move(callback_).Run(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::BytesProvider::RequestAsFileCallback",
               "message", message.name());
#endif
  message.set_request_id(request_id_);
  ignore_result(responder_->Accept(&message));
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::BytesProvider::RequestAsReply",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::BytesProvider::RequestAsStream",
               "message", message->name());
#endif
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "BytesProvider::RequestAsStream deserializer");
        return false;
      }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::BytesProvider::RequestAsFile",
               "message", message->name());
#endif
      break;
    }
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::BytesProvider::RequestAsReply",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "BytesProvider::RequestAsReply deserializer");
        return false;
      }
      BytesProvider::RequestAsReplyCallback callback =
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::BytesProvider::RequestAsFile",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "BytesProvider::RequestAsFile deserializer");
        return false;
      }
      BytesProvider::RequestAsFileCallback callback =
...
void BytesProviderAsyncWaiter::RequestAsFile(
    uint64_t source_offset, uint64_t source_size, base::File file, uint64_t file_offset, base::Optional<WTF::Time>* out_time_file_modified) {
  base::RunLoop loop;
  proxy_->RequestAsFile(std::move(source_offset),std::move(source_size),std::move(file),std::move(file_offset),
      base::BindOnce(
          [](base::RunLoop* loop,
             base::Optional<WTF::Time>* out_time_file_modified
,
             base::Optional<WTF::Time> time_file_modified) {*out_time_file_modified = std::move(time_file_modified);
            loop->Quit();
          },
          &loop,
...
// static
bool StructTraits<::blink::mojom::blink::DataElementFilesystemURL::DataView, ::blink::mojom::blink::DataElementFilesystemURLPtr>::Read(
    ::blink::mojom::blink::DataElementFilesystemURL::DataView input,
    ::blink::mojom::blink::DataElementFilesystemURLPtr* output) {
  bool success = true;
  ::blink::mojom::blink::DataElementFilesystemURLPtr result(::blink::mojom::blink::DataElementFilesystemURL::New());
...
bool UnionTraits<::blink::mojom::blink::DataElement::DataView, ::blink::mojom::blink::DataElementPtr>::Read(
  ...
  switch (input.tag()) {
    ...
    case Tag::FILE_FILESYSTEM: {
      ::blink::mojom::blink::DataElementFilesystemURLPtr result_file_filesystem;
