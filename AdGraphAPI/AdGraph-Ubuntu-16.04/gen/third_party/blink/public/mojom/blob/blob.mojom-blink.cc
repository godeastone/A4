...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::BlobReaderClient::OnCalculatedSize",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            ...
            "BlobReaderClient::OnCalculatedSize deserializer");
        return false;
      }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::BlobReaderClient::OnComplete",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "BlobReaderClient::OnComplete deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
void BlobProxy::AsDataPipeGetter(
    ::network::mojom::blink::DataPipeGetterRequest in_data_pipe_getter) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class Blob_ReadSideData_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      const base::Optional<WTF::Vector<uint8_t>>& in_data);
...
bool Blob_ReadSideData_ForwardToCallback::Accept(
  ...
  serialization_context.TakeHandlesFromMessage(message);
  bool success = true;
  base::Optional<WTF::Vector<uint8_t>> p_data{};
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "Blob::ReadSideData response deserializer");
    return false;
  }
...
bool Blob_GetInternalUUID_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "Blob::GetInternalUUID response deserializer");
    return false;
  }
  if (!callback_.is_null())
    std::move(callback_).Run(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::Blob::Clone",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::Blob::AsDataPipeGetter",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::network::mojom::blink::DataPipeGetterRequest p_data_pipe_getter{};
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "Blob::AsDataPipeGetter deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::Blob::ReadAll",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::Blob::ReadRange",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::Blob::ReadSideData",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::Blob::GetInternalUUID",
               "message", message->name());
#endif
      break;
    }
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::Blob::ReadSideData",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "Blob::ReadSideData deserializer");
        return false;
      }
      Blob::ReadSideDataCallback callback =
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::Blob::GetInternalUUID",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "Blob::GetInternalUUID deserializer");
        return false;
      }
      Blob::GetInternalUUIDCallback callback =
...
void BlobAsyncWaiter::ReadSideData(
    base::Optional<WTF::Vector<uint8_t>>* out_data) {
  base::RunLoop loop;
  proxy_->ReadSideData(
      base::BindOnce(
          [](base::RunLoop* loop,
             base::Optional<WTF::Vector<uint8_t>>* out_data
,
             const base::Optional<WTF::Vector<uint8_t>>& data) {*out_data = std::move(data);
            loop->Quit();
          },
          &loop,
          out_data));
