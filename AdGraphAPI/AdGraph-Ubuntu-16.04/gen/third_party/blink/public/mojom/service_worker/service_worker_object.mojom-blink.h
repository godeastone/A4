...
using RevocableServiceWorkerObjectHostPtr = ::blink::RevocableInterfacePtr<ServiceWorkerObjectHost>;
...
using RevocableServiceWorkerObjectPtr = ::blink::RevocableInterfacePtr<ServiceWorkerObject>;
