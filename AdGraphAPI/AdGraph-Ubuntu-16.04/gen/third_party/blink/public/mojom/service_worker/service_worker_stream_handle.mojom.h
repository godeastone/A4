...
class BLINK_COMMON_EXPORT ServiceWorkerStreamCallback
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ServiceWorkerStreamHandle::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::ServiceWorkerStreamHandle::DataView,
  ...
  static  decltype(::blink::mojom::ServiceWorkerStreamHandle::stream)& stream(
       ::blink::mojom::ServiceWorkerStreamHandlePtr& input) {
    return input->stream;
  }

  static  decltype(::blink::mojom::ServiceWorkerStreamHandle::callback_request)& callback_request(
       ::blink::mojom::ServiceWorkerStreamHandlePtr& input) {
