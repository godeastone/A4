...
bool ServiceWorkerRegistrationObjectInfo_Data::Validate(
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->host_ptr_info, 3, validation_context)) {
    return false;
  }
...
// static
bool ServiceWorkerRegistrationObject_SetVersionAttributes_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ServiceWorkerRegistrationObject_SetVersionAttributes_Params_Data* object = static_cast<const ServiceWorkerRegistrationObject_SetVersionAttributes_Params_Data*>(data);
...
ServiceWorkerRegistrationObject_SetVersionAttributes_Params_Data::ServiceWorkerRegistrationObject_SetVersionAttributes_Params_Data()
    : header_({sizeof(*this), 0}) {}
