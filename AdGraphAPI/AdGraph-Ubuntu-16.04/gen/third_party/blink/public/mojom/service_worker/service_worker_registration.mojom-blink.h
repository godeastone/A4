...
using RevocableServiceWorkerRegistrationObjectHostPtr = ::blink::RevocableInterfacePtr<ServiceWorkerRegistrationObjectHost>;
...
using RevocableServiceWorkerRegistrationObjectPtr = ::blink::RevocableInterfacePtr<ServiceWorkerRegistrationObject>;
...
class CORE_EXPORT ServiceWorkerRegistrationObject
 ...
 public:
  ...
  virtual void SetVersionAttributes(int32_t changed_mask, ::blink::mojom::blink::ServiceWorkerObjectInfoPtr installing, ::blink::mojom::blink::ServiceWorkerObjectInfoPtr waiting, ::blink::mojom::blink::ServiceWorkerObjectInfoPtr active) = 0;
...
class CORE_EXPORT ServiceWorkerRegistrationObjectInterceptorForTesting : public ServiceWorkerRegistrationObject {
  ...
  void SetVersionAttributes(int32_t changed_mask, ::blink::mojom::blink::ServiceWorkerObjectInfoPtr installing, ::blink::mojom::blink::ServiceWorkerObjectInfoPtr waiting, ::blink::mojom::blink::ServiceWorkerObjectInfoPtr active) override;
...
class CORE_EXPORT ServiceWorkerRegistrationObjectProxy
 ...
 public:
  ...
  void SetVersionAttributes(int32_t changed_mask, ::blink::mojom::blink::ServiceWorkerObjectInfoPtr installing, ::blink::mojom::blink::ServiceWorkerObjectInfoPtr waiting, ::blink::mojom::blink::ServiceWorkerObjectInfoPtr active) final;
...
struct CORE_EXPORT StructTraits<::blink::mojom::blink::ServiceWorkerRegistrationObjectInfo::DataView,
  ...
  static const decltype(::blink::mojom::blink::ServiceWorkerRegistrationObjectInfo::options)& options(
      const ::blink::mojom::blink::ServiceWorkerRegistrationObjectInfoPtr& input) {
