...
ServiceWorkerObjectInfo::ServiceWorkerObjectInfo()
    : version_id(kInvalidServiceWorkerVersionId),
      state(::blink::mojom::blink::ServiceWorkerState::kUnknown),
      url(),
      host_ptr_info(),
      request() {}
...
void ServiceWorkerObjectHostProxy::PostMessageToServiceWorker(
  ...
  TRACE_EVENT0("mojom", "blink::mojom::ServiceWorkerObjectHost::PostMessageToServiceWorker");
#endif
...
bool ServiceWorkerObjectHost_TerminateForTesting_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        ...
        "ServiceWorkerObjectHost::TerminateForTesting response deserializer");
    return false;
  }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::ServiceWorkerObjectHost::TerminateForTestingCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::ServiceWorkerObjectHost::PostMessageToServiceWorker",
               "message", message->name());
#endif
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "ServiceWorkerObjectHost::PostMessageToServiceWorker deserializer");
        return false;
      }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::ServiceWorkerObjectHost::TerminateForTesting",
               "message", message->name());
#endif
      break;
    }
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::ServiceWorkerObjectHost::TerminateForTesting",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "ServiceWorkerObjectHost::TerminateForTesting deserializer");
        return false;
      }
      ServiceWorkerObjectHost::TerminateForTestingCallback callback =
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::ServiceWorkerObject::StateChanged");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::ServiceWorkerObject::StateChanged",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "ServiceWorkerObject::StateChanged deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
