...
class COMPONENT_EXPORT(MOJOM_SHARED_BLINK_COMMON_EXPORT) ServiceWorkerStreamHandle_Data {
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      ...
      index_ = serialization_buffer_->Allocate(sizeof(ServiceWorkerStreamHandle_Data));
      new (data()) ServiceWorkerStreamHandle_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    ServiceWorkerStreamHandle_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<ServiceWorkerStreamHandle_Data>(index_);
    }
    ServiceWorkerStreamHandle_Data* operator->() { return data(); }
  ...
  mojo::internal::Handle_Data callback_request;

 private:
  ServiceWorkerStreamHandle_Data();
  ~ServiceWorkerStreamHandle_Data() = delete;
};
static_assert(sizeof(ServiceWorkerStreamHandle_Data) == 16,
              "Bad sizeof(ServiceWorkerStreamHandle_Data)");
// Used by ServiceWorkerStreamHandle::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct ServiceWorkerStreamHandle_UnserializedMessageContext
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  ServiceWorkerStreamHandle_UnserializedMessageContext(
 ...
 private:
  ...
  void Serialize(mojo::internal::SerializationContext* context,
    ...
    ServiceWorkerStreamHandle_Data::BufferWriter writer;
...
const mojo::internal::UnserializedMessageContext::Tag
    ServiceWorkerStreamHandle_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
