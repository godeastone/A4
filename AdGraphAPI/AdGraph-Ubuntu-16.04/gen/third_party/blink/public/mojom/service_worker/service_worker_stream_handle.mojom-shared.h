...
struct Serializer<::blink::mojom::ServiceWorkerStreamHandleDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    decltype(CallWithContext(Traits::callback_request, input, custom_context)) in_callback_request = CallWithContext(Traits::callback_request, input, custom_context);
