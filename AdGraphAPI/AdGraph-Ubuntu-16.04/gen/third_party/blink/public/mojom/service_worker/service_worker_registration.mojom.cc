...
void ServiceWorkerRegistrationObjectProxy::SetVersionAttributes(
    int32_t in_changed_mask, ::blink::mojom::ServiceWorkerObjectInfoPtr in_installing, ::blink::mojom::ServiceWorkerObjectInfoPtr in_waiting, ::blink::mojom::ServiceWorkerObjectInfoPtr in_active) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ServiceWorkerRegistrationObjectInterceptorForTesting::SetVersionAttributes(int32_t changed_mask, ::blink::mojom::ServiceWorkerObjectInfoPtr installing, ::blink::mojom::ServiceWorkerObjectInfoPtr waiting, ::blink::mojom::ServiceWorkerObjectInfoPtr active) {
...
bool StructTraits<::blink::mojom::ServiceWorkerRegistrationOptions::DataView, ::blink::mojom::ServiceWorkerRegistrationOptionsPtr>::Read(
    ::blink::mojom::ServiceWorkerRegistrationOptions::DataView input,
    ::blink::mojom::ServiceWorkerRegistrationOptionsPtr* output) {
  bool success = true;
