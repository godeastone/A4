...
class PLATFORM_EXPORT ServiceWorkerClientInfo {
 public:
  ...
  ServiceWorkerClientInfo(
      ...
      ServiceWorkerClientType client_type,
      ::blink::mojom::blink::PageVisibilityState page_visibility_state,
      bool is_focused,
      ::network::mojom::blink::RequestContextFrameType frame_type,
      ::mojo_base::mojom::blink::TimeTicksPtr last_focus_time,
      ::mojo_base::mojom::blink::TimeTicksPtr creation_time);
 ...
 private:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
  DISALLOW_COPY_AND_ASSIGN(ServiceWorkerClientInfo);
};
...
ServiceWorkerClientInfoPtr ServiceWorkerClientInfo::Clone() const {
  return New(
      ...
      mojo::Clone(client_type),
      mojo::Clone(page_visibility_state),
...
bool ServiceWorkerClientInfo::Equals(const T& other_struct) const {
  ...
  if (!mojo::Equals(this->client_type, other_struct.client_type))
    return false;
  if (!mojo::Equals(this->page_visibility_state, other_struct.page_visibility_state))
    return false;
...
struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::ServiceWorkerClientInfo::DataView,
  ...
  static decltype(::blink::mojom::blink::ServiceWorkerClientInfo::page_visibility_state) page_visibility_state(
      const ::blink::mojom::blink::ServiceWorkerClientInfoPtr& input) {
    return input->page_visibility_state;
  }
