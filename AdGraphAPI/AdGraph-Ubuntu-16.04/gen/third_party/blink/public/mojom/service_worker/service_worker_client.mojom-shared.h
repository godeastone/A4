...
inline std::ostream& operator<<(std::ostream& os, ServiceWorkerClientType value) {
  switch(value) {
...
class ServiceWorkerClientInfoDataView {
 public:
  ...
  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadPageVisibilityState(UserType* output) const {
    auto data_value = data_->page_visibility_state;
    return mojo::internal::Deserialize<::blink::mojom::PageVisibilityState>(
        data_value, output);
  }

  ::blink::mojom::PageVisibilityState page_visibility_state() const {
    return static_cast<::blink::mojom::PageVisibilityState>(data_->page_visibility_state);
  }
...
struct Serializer<::blink::mojom::ServiceWorkerClientQueryOptionsDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    (*output)->include_uncontrolled = CallWithContext(Traits::include_uncontrolled, input, custom_context);
    mojo::internal::Serialize<::blink::mojom::ServiceWorkerClientType>(
        CallWithContext(Traits::client_type, input, custom_context), &(*output)->client_type);
...
struct Serializer<::blink::mojom::ServiceWorkerClientInfoDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    decltype(CallWithContext(Traits::client_uuid, input, custom_context)) in_client_uuid = CallWithContext(Traits::client_uuid, input, custom_context);
    ...
    mojo::internal::Serialize<::blink::mojom::PageVisibilityState>(
        CallWithContext(Traits::page_visibility_state, input, custom_context), &(*output)->page_visibility_state);
    (*output)->is_focused = CallWithContext(Traits::is_focused, input, custom_context);
    ...
    decltype(CallWithContext(Traits::last_focus_time, input, custom_context)) in_last_focus_time = CallWithContext(Traits::last_focus_time, input, custom_context);
