...
void PrefetchURLLoaderServiceProxy::GetFactory(
    ::network::mojom::URLLoaderFactoryRequest in_factory) {
...
void PrefetchURLLoaderServiceInterceptorForTesting::GetFactory(::network::mojom::URLLoaderFactoryRequest factory) {
