...
bool FindInPage_StopFinding_Params_Data::Validate(
  ...
  const FindInPage_StopFinding_Params_Data* object = static_cast<const FindInPage_StopFinding_Params_Data*>(data);
...
bool FindInPage_ClearActiveFindMatch_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const FindInPage_ClearActiveFindMatch_Params_Data* object = static_cast<const FindInPage_ClearActiveFindMatch_Params_Data*>(data);
...
bool FindInPage_GetNearestFindResult_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const FindInPage_GetNearestFindResult_Params_Data* object = static_cast<const FindInPage_GetNearestFindResult_Params_Data*>(data);
...
bool FindInPage_GetNearestFindResult_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const FindInPage_GetNearestFindResult_ResponseParams_Data* object = static_cast<const FindInPage_GetNearestFindResult_ResponseParams_Data*>(data);
...
bool FindInPage_ActivateNearestFindResult_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const FindInPage_ActivateNearestFindResult_Params_Data* object = static_cast<const FindInPage_ActivateNearestFindResult_Params_Data*>(data);
...
// static
bool FindInPage_ActivateNearestFindResult_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const FindInPage_ActivateNearestFindResult_ResponseParams_Data* object = static_cast<const FindInPage_ActivateNearestFindResult_ResponseParams_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->active_match_rect, 1, validation_context)) {
    return false;
  }
...
FindInPage_ActivateNearestFindResult_ResponseParams_Data::FindInPage_ActivateNearestFindResult_ResponseParams_Data()
    : header_({sizeof(*this), 0}) {}
...
bool FindInPage_FindMatchRects_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const FindInPage_FindMatchRects_Params_Data* object = static_cast<const FindInPage_FindMatchRects_Params_Data*>(data);
...
bool FindInPage_FindMatchRects_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const FindInPage_FindMatchRects_ResponseParams_Data* object = static_cast<const FindInPage_FindMatchRects_ResponseParams_Data*>(data);
