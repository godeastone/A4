...
void CookieStoreProxy::AppendSubscriptions(
    int64_t in_service_worker_registration_id, WTF::Vector<CookieChangeSubscriptionPtr> in_subscriptions, AppendSubscriptionsCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "blink::mojom::CookieStore::AppendSubscriptions");
#endif
...
bool CookieStore_AppendSubscriptions_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "blink::mojom::CookieStore::AppendSubscriptionsCallback",
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        ...
        "CookieStore::AppendSubscriptions response deserializer");
    return false;
  }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::CookieStore::AppendSubscriptionsCallback",
               "message", message.name());
#endif
...
bool CookieStore_GetSubscriptions_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "CookieStore::GetSubscriptions response deserializer");
    return false;
  }
  if (!callback_.is_null())
    std::move(callback_).Run(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::CookieStore::AppendSubscriptions",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::CookieStore::GetSubscriptions",
               "message", message->name());
#endif
      break;
    }
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::CookieStore::AppendSubscriptions",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "CookieStore::AppendSubscriptions deserializer");
        return false;
      }
      CookieStore::AppendSubscriptionsCallback callback =
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::CookieStore::GetSubscriptions",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "CookieStore::GetSubscriptions deserializer");
        return false;
      }
      CookieStore::GetSubscriptionsCallback callback =
