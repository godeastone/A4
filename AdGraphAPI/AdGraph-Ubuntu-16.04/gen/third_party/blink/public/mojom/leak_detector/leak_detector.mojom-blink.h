...
using RevocableLeakDetectorPtr = ::blink::RevocableInterfacePtr<LeakDetector>;
...
class PLATFORM_EXPORT LeakDetectionResult {
 public:
  ...
  LeakDetectionResult(
      ...
      uint32_t number_of_live_pausable_objects,
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        LeakDetectionResult::DataView, WTF::Vector<uint8_t>>(input);
  }
...
LeakDetectionResultPtr LeakDetectionResult::Clone() const {
  return New(
      ...
      mojo::Clone(number_of_live_pausable_objects),
...
bool LeakDetectionResult::Equals(const T& other_struct) const {
  ...
  if (!mojo::Equals(this->number_of_live_resources, other_struct.number_of_live_resources))
    return false;
  if (!mojo::Equals(this->number_of_live_pausable_objects, other_struct.number_of_live_pausable_objects))
    return false;
...
struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::LeakDetectionResult::DataView,
  ...
  static decltype(::blink::mojom::blink::LeakDetectionResult::number_of_live_pausable_objects) number_of_live_pausable_objects(
      const ::blink::mojom::blink::LeakDetectionResultPtr& input) {
    return input->number_of_live_pausable_objects;
  }

  static decltype(::blink::mojom::blink::LeakDetectionResult::number_of_live_script_promises) number_of_live_script_promises(
      const ::blink::mojom::blink::LeakDetectionResultPtr& input) {
