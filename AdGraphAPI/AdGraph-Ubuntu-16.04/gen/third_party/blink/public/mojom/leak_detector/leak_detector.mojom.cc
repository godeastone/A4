...
LeakDetectionResult::LeakDetectionResult()
    : number_of_live_audio_nodes(),
      ...
      number_of_live_pausable_objects(),
...
LeakDetectionResult::LeakDetectionResult(
    ...
    uint32_t number_of_live_pausable_objects_in,
    ...
    : number_of_live_audio_nodes(std::move(number_of_live_audio_nodes_in)),
      ...
      number_of_live_pausable_objects(std::move(number_of_live_pausable_objects_in)),
...
size_t LeakDetectionResult::Hash(size_t seed) const {
  ...
  seed = mojo::internal::Hash(seed, this->number_of_live_pausable_objects);
  seed = mojo::internal::Hash(seed, this->number_of_live_script_promises);
...
bool LeakDetector_PerformLeakDetection_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        ...
        "LeakDetector::PerformLeakDetection response deserializer");
    return false;
  }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::LeakDetector::PerformLeakDetectionCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::LeakDetector::PerformLeakDetection",
               "message", message->name());
#endif
      break;
    }
  ...
  TRACE_EVENT1("mojom", "(Impl)blink::mojom::LeakDetector::PerformLeakDetection",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "LeakDetector::PerformLeakDetection deserializer");
        return false;
      }
      LeakDetector::PerformLeakDetectionCallback callback =
...
bool StructTraits<::blink::mojom::LeakDetectionResult::DataView, ::blink::mojom::LeakDetectionResultPtr>::Read(
    ::blink::mojom::LeakDetectionResult::DataView input,
    ::blink::mojom::LeakDetectionResultPtr* output) {
  bool success = true;
  ::blink::mojom::LeakDetectionResultPtr result(::blink::mojom::LeakDetectionResult::New());
      ...
      result->number_of_live_pausable_objects = input.number_of_live_pausable_objects();
