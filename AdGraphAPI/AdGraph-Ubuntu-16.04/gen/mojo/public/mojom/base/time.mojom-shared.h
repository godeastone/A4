...
struct Serializer<::mojo_base::mojom::TimeDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    (*output)->internal_value = CallWithContext(Traits::internal_value, input, custom_context);
...
struct Serializer<::mojo_base::mojom::TimeDeltaDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    void* custom_context = CustomContextHelper<Traits>::SetUp(input, context);
    (*output).Allocate(buffer);
    (*output)->microseconds = CallWithContext(Traits::microseconds, input, custom_context);
    CustomContextHelper<Traits>::TearDown(input, custom_context);
  }
