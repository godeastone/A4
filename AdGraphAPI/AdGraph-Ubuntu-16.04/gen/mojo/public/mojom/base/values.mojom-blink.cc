...
DictionaryValue::DictionaryValue(
    WTF::HashMap<WTF::String, ValuePtr> storage_in)
...
ListValue::ListValue(
    WTF::Vector<ValuePtr> storage_in)
    : storage(std::move(storage_in)) {}
...
bool UnionTraits<::mojo_base::mojom::blink::Value::DataView, ::mojo_base::mojom::blink::ValuePtr>::Read(
  ...
  switch (input.tag()) {
    ...
    case Tag::DICTIONARY_VALUE: {
      ::mojo_base::mojom::blink::DictionaryValuePtr result_dictionary_value;
    ...
    case Tag::LIST_VALUE: {
      ::mojo_base::mojom::blink::ListValuePtr result_list_value;
