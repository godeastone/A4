...
class COMPONENT_EXPORT(MOJO_BASE_MOJOM_BLINK) DictionaryValue {
 public:
  ...
  explicit DictionaryValue(
      WTF::HashMap<WTF::String, ValuePtr> storage);
...
struct COMPONENT_EXPORT(MOJO_BASE_MOJOM_BLINK) UnionTraits<::mojo_base::mojom::blink::Value::DataView,
  ...
  static const ::mojo_base::mojom::blink::DictionaryValuePtr& dictionary_value(const ::mojo_base::mojom::blink::ValuePtr& input) {
    return input->get_dictionary_value();
  }

  static const ::mojo_base::mojom::blink::ListValuePtr& list_value(const ::mojo_base::mojom::blink::ValuePtr& input) {
