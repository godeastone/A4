...
(function() {
  ...
  RunOrClosePipeMessageParams.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.input = mutator_.mutateUnion(mojo.pipeControl.RunOrClosePipeInput, false);
    }
    return this;
  };
  RunOrClosePipeMessageParams.prototype.getHandleDeps = function() {
  ...
  PeerAssociatedEndpointClosedEvent.prototype.mutate = function(mutator_) {
    ...
    if (mutator_.chooseMutateField()) {
      this.disconnectReason = mutator_.mutateStruct(mojo.pipeControl.DisconnectReason, true);
    }
    return this;
  };
    ...
    var mutators = [
      {
        ...
        mutator: function() { return mutator_.mutateStruct(mojo.pipeControl.PeerAssociatedEndpointClosedEvent, false); },
      },
    ];
