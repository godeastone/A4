...
class ClientGatewayMessage : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:ipc.invalidation.ClientGatewayMessage) */ {
 public:
  ...
  inline ClientGatewayMessage* New() const PROTOBUF_FINAL { return New(NULL); }

  ClientGatewayMessage* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  void set_has_is_client_to_server();
  void clear_has_is_client_to_server();
  void set_has_service_context();
  void clear_has_service_context();
  void set_has_rpc_scheduling_hash();
  void clear_has_rpc_scheduling_hash();
  void set_has_network_message();
  void clear_has_network_message();
  ...
  friend struct protobuf_client_5fgateway_2eproto::TableStruct;
};
// ===================================================================
