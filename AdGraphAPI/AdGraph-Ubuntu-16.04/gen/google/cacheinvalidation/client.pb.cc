...
class AckHandlePDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<AckHandleP> {
} _AckHandleP_default_instance_;
class PersistentTiclStateDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<PersistentTiclState> {
} _PersistentTiclState_default_instance_;
class PersistentStateBlobDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<PersistentStateBlob> {
} _PersistentStateBlob_default_instance_;
class RunStatePDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<RunStateP> {
...
void TableStruct::Shutdown() {
  _AckHandleP_default_instance_.Shutdown();
  _PersistentTiclState_default_instance_.Shutdown();
  _PersistentStateBlob_default_instance_.Shutdown();
  _RunStateP_default_instance_.Shutdown();
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _AckHandleP_default_instance_.DefaultConstruct();
  _PersistentTiclState_default_instance_.DefaultConstruct();
  _PersistentStateBlob_default_instance_.DefaultConstruct();
  _RunStateP_default_instance_.DefaultConstruct();
  _AckHandleP_default_instance_.get_mutable()->invalidation_ = const_cast< ::ipc::invalidation::InvalidationP*>(
      ::ipc::invalidation::InvalidationP::internal_default_instance());
  _PersistentStateBlob_default_instance_.get_mutable()->ticl_state_ = const_cast< ::ipc::invalidation::PersistentTiclState*>(
...
// @@protoc_insertion_point(message_clear_start:ipc.invalidation.AckHandleP)
  if (has_invalidation()) {
    GOOGLE_DCHECK(invalidation_ != NULL);
...
#if LANG_CXX11
void PersistentTiclState::set_client_token(::std::string&& value) {
  set_has_client_token();
...
// @@protoc_insertion_point(message_clear_start:ipc.invalidation.PersistentStateBlob)
  if (_has_bits_[0 / 32] & 3u) {
    if (has_authentication_code()) {
      GOOGLE_DCHECK(!authentication_code_.IsDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited()));
      (*authentication_code_.UnsafeRawStringPointer())->clear();
    }
    if (has_ticl_state()) {
      GOOGLE_DCHECK(ticl_state_ != NULL);
...
#if LANG_CXX11
void PersistentStateBlob::set_authentication_code(::std::string&& value) {
  set_has_authentication_code();
