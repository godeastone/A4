...
class GCM_EXPORT ChromeBuildProto : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:checkin_proto.ChromeBuildProto) */ {
public:
ChromeBuildProto();
...
GOOGLE_ATTRIBUTE_NOINLINE void Swap(ChromeBuildProto* other);
...
class GCM_EXPORT AndroidCheckinProto : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:checkin_proto.AndroidCheckinProto) */ {
public:
AndroidCheckinProto();
...
GOOGLE_ATTRIBUTE_NOINLINE void Swap(AndroidCheckinProto* other);
