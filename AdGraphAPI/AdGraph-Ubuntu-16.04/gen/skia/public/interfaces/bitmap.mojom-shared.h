...
struct Serializer<::skia::mojom::BitmapDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    decltype(CallWithContext(Traits::image_info, input, custom_context)) in_image_info = CallWithContext(Traits::image_info, input, custom_context);
    ...
    (*output)->row_bytes = CallWithContext(Traits::row_bytes, input, custom_context);
