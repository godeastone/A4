...
namespace WTF {
struct skia_mojom_internal_ColorProfileType_DataHashFn {
  static unsigned GetHash(const ::skia::mojom::ColorProfileType& value) {
    using utype = std::underlying_type<::skia::mojom::ColorProfileType>::type;
    return DefaultHash<utype>::Hash().GetHash(static_cast<utype>(value));
  }
  static bool Equal(const ::skia::mojom::ColorProfileType& left, const ::skia::mojom::ColorProfileType& right) {
    return left == right;
  }
  static const bool safe_to_compare_to_empty_or_deleted = true;
};
...
template <>
struct DefaultHash<::skia::mojom::ColorProfileType> {
  using Hash = skia_mojom_internal_ColorProfileType_DataHashFn;
};

template <>
struct HashTraits<::skia::mojom::ColorProfileType>
    : public GenericHashTraits<::skia::mojom::ColorProfileType> {
  static_assert(true,
                "-1000000 is a reserved enum value");
  static_assert(true,
                "-1000001 is a reserved enum value");
  static const bool hasIsEmptyValueFunction = true;
  static bool IsEmptyValue(const ::skia::mojom::ColorProfileType& value) {
    return value == static_cast<::skia::mojom::ColorProfileType>(-1000000);
  }
  static void ConstructDeletedValue(::skia::mojom::ColorProfileType& slot, bool) {
    slot = static_cast<::skia::mojom::ColorProfileType>(-1000001);
  }
  static bool IsDeletedValue(const ::skia::mojom::ColorProfileType& value) {
    return value == static_cast<::skia::mojom::ColorProfileType>(-1000001);
  }
};
}  // namespace WTF
...
bool ImageInfo::Equals(const T& other_struct) const {
  ...
  if (!mojo::Equals(this->alpha_type, other_struct.alpha_type))
    return false;
  if (!mojo::Equals(this->profile_type, other_struct.profile_type))
    return false;
...
struct  StructTraits<::skia::mojom::blink::ImageInfo::DataView,
  ...
  static decltype(::skia::mojom::blink::ImageInfo::profile_type) profile_type(
      const ::skia::mojom::blink::ImageInfoPtr& input) {
