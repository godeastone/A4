...
struct CellularProperties {
  ...
  std::unique_ptr<int> prl_version;
  ...
  std::unique_ptr<std::vector<std::string>> supported_carriers;
...
struct ManagedCellularProperties {
  ...
  std::unique_ptr<ManagedDOMString> carrier;
...
struct WiFiProperties {
  ...
  std::unique_ptr<int> roam_threshold;
...
struct ManagedWiFiProperties {
  ...
  std::unique_ptr<ManagedLong> roam_threshold;
...
struct WiMAXProperties {
  WiMAXProperties();
  ~WiMAXProperties();
  WiMAXProperties(WiMAXProperties&& rhs);
  WiMAXProperties& operator=(WiMAXProperties&& rhs);
  ...
  static std::unique_ptr<WiMAXProperties> FromValue(const base::Value& value);
...
struct ManagedWiMAXProperties {
  ...
  ~ManagedWiMAXProperties();
  ManagedWiMAXProperties(ManagedWiMAXProperties&& rhs);
  ManagedWiMAXProperties& operator=(ManagedWiMAXProperties&& rhs);
  ...
  // failure.
  static std::unique_ptr<ManagedWiMAXProperties> FromValue(const base::Value& value);
...
struct WiMAXStateProperties {
  ...
  ~WiMAXStateProperties();
  WiMAXStateProperties(WiMAXStateProperties&& rhs);
  WiMAXStateProperties& operator=(WiMAXStateProperties&& rhs);
  ...
  // failure.
  static std::unique_ptr<WiMAXStateProperties> FromValue(const base::Value& value);
...
struct NetworkConfigProperties {
  ...
  std::unique_ptr<WiMAXProperties> wi_max;
...
struct ManagedProperties {
  ...
  std::unique_ptr<ManagedWiMAXProperties> wi_max;
...
struct NetworkStateProperties {
  ...
  std::unique_ptr<WiMAXStateProperties> wi_max;
