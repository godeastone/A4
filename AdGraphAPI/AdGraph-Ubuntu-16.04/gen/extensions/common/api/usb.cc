...
std::unique_ptr<base::DictionaryValue> Device::ToValue() const {
  ...
  value->SetWithoutPathExpansion("device", std::make_unique<base::Value>(this->device));
  ...
  value->SetWithoutPathExpansion("productName", std::make_unique<base::Value>(this->product_name));

  value->SetWithoutPathExpansion("manufacturerName", std::make_unique<base::Value>(this->manufacturer_name));

  value->SetWithoutPathExpansion("serialNumber", std::make_unique<base::Value>(this->serial_number));
...
std::unique_ptr<base::DictionaryValue> ConnectionHandle::ToValue() const {
  ...
  value->SetWithoutPathExpansion("handle", std::make_unique<base::Value>(this->handle));
...
std::unique_ptr<base::DictionaryValue> EndpointDescriptor::ToValue() const {
  ...
  value->SetWithoutPathExpansion("type", std::make_unique<base::Value>(usb::ToString(this->type)));

  value->SetWithoutPathExpansion("direction", std::make_unique<base::Value>(usb::ToString(this->direction)));

  value->SetWithoutPathExpansion("maximumPacketSize", std::make_unique<base::Value>(this->maximum_packet_size));

  if (this->synchronization != SYNCHRONIZATION_TYPE_NONE) {
    value->SetWithoutPathExpansion("synchronization", std::make_unique<base::Value>(usb::ToString(this->synchronization)));

  }
  if (this->usage != USAGE_TYPE_NONE) {
    value->SetWithoutPathExpansion("usage", std::make_unique<base::Value>(usb::ToString(this->usage)));

  }
  if (this->polling_interval.get()) {
    value->SetWithoutPathExpansion("pollingInterval", std::make_unique<base::Value>(*this->polling_interval));

  }
  value->SetWithoutPathExpansion("extra_data", std::make_unique<base::Value>(this->extra_data));
...
std::unique_ptr<base::DictionaryValue> InterfaceDescriptor::ToValue() const {
  ...
  value->SetWithoutPathExpansion("interfaceNumber", std::make_unique<base::Value>(this->interface_number));

  value->SetWithoutPathExpansion("alternateSetting", std::make_unique<base::Value>(this->alternate_setting));

  value->SetWithoutPathExpansion("interfaceClass", std::make_unique<base::Value>(this->interface_class));

  value->SetWithoutPathExpansion("interfaceSubclass", std::make_unique<base::Value>(this->interface_subclass));

  value->SetWithoutPathExpansion("interfaceProtocol", std::make_unique<base::Value>(this->interface_protocol));

  if (this->description.get()) {
    value->SetWithoutPathExpansion("description", std::make_unique<base::Value>(*this->description));

  }
  value->SetWithoutPathExpansion("endpoints", json_schema_compiler::util::CreateValueFromArray(this->endpoints));
...
std::unique_ptr<base::DictionaryValue> ConfigDescriptor::ToValue() const {
  ...
  value->SetWithoutPathExpansion("configurationValue", std::make_unique<base::Value>(this->configuration_value));

  if (this->description.get()) {
    value->SetWithoutPathExpansion("description", std::make_unique<base::Value>(*this->description));

  }
  value->SetWithoutPathExpansion("selfPowered", std::make_unique<base::Value>(this->self_powered));

  value->SetWithoutPathExpansion("remoteWakeup", std::make_unique<base::Value>(this->remote_wakeup));

  value->SetWithoutPathExpansion("maxPower", std::make_unique<base::Value>(this->max_power));

  value->SetWithoutPathExpansion("interfaces", json_schema_compiler::util::CreateValueFromArray(this->interfaces));
...
std::unique_ptr<base::DictionaryValue> ControlTransferInfo::ToValue() const {
  ...
  value->SetWithoutPathExpansion("recipient", std::make_unique<base::Value>(usb::ToString(this->recipient)));

  value->SetWithoutPathExpansion("requestType", std::make_unique<base::Value>(usb::ToString(this->request_type)));

  value->SetWithoutPathExpansion("request", std::make_unique<base::Value>(this->request));
  ...
  if (this->timeout.get()) {
    value->SetWithoutPathExpansion("timeout", std::make_unique<base::Value>(*this->timeout));
...
std::unique_ptr<base::DictionaryValue> GenericTransferInfo::ToValue() const {
  ...
  value->SetWithoutPathExpansion("endpoint", std::make_unique<base::Value>(this->endpoint));
...
std::unique_ptr<base::DictionaryValue> IsochronousTransferInfo::ToValue() const {
  ...
  value->SetWithoutPathExpansion("transferInfo", (this->transfer_info).ToValue());

  value->SetWithoutPathExpansion("packets", std::make_unique<base::Value>(this->packets));

  value->SetWithoutPathExpansion("packetLength", std::make_unique<base::Value>(this->packet_length));
...
std::unique_ptr<base::DictionaryValue> TransferResultInfo::ToValue() const {
  ...
  if (this->result_code.get()) {
    value->SetWithoutPathExpansion("resultCode", std::make_unique<base::Value>(*this->result_code));
...
std::unique_ptr<base::DictionaryValue> EnumerateDevicesOptions::ToValue() const {
  ...
  if (this->filters.get()) {
    value->SetWithoutPathExpansion("filters", json_schema_compiler::util::CreateValueFromOptionalArray(this->filters));
...
std::unique_ptr<base::DictionaryValue> EnumerateDevicesAndRequestAccessOptions::ToValue() const {
  ...
  if (this->interface_id.get()) {
    value->SetWithoutPathExpansion("interfaceId", std::make_unique<base::Value>(*this->interface_id));
...
std::unique_ptr<base::DictionaryValue> DevicePromptOptions::ToValue() const {
  ...
  if (this->multiple.get()) {
    value->SetWithoutPathExpansion("multiple", std::make_unique<base::Value>(*this->multiple));
