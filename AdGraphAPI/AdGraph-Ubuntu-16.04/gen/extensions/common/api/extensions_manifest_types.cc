...
std::unique_ptr<base::DictionaryValue> Automation::Object::ToValue() const {
  ...
  if (this->desktop.get()) {
    value->SetWithoutPathExpansion("desktop", std::make_unique<base::Value>(*this->desktop));

  }
  if (this->matches.get()) {
    value->SetWithoutPathExpansion("matches", json_schema_compiler::util::CreateValueFromOptionalArray(this->matches));

  }
  if (this->interact.get()) {
    value->SetWithoutPathExpansion("interact", std::make_unique<base::Value>(*this->interact));
...
std::unique_ptr<base::DictionaryValue> ContentCapabilities::ToValue() const {
  ...
  value->SetWithoutPathExpansion("matches", json_schema_compiler::util::CreateValueFromArray(this->matches));
...
std::unique_ptr<base::DictionaryValue> ExternallyConnectable::ToValue() const {
  ...
  if (this->ids.get()) {
    value->SetWithoutPathExpansion("ids", json_schema_compiler::util::CreateValueFromOptionalArray(this->ids));
  ...
  if (this->accepts_tls_channel_id.get()) {
    value->SetWithoutPathExpansion("accepts_tls_channel_id", std::make_unique<base::Value>(*this->accepts_tls_channel_id));
...
std::unique_ptr<base::DictionaryValue> OptionsUI::ToValue() const {
  ...
  value->SetWithoutPathExpansion("page", std::make_unique<base::Value>(this->page));

  if (this->chrome_style.get()) {
    value->SetWithoutPathExpansion("chrome_style", std::make_unique<base::Value>(*this->chrome_style));

  }
  if (this->open_in_tab.get()) {
    value->SetWithoutPathExpansion("open_in_tab", std::make_unique<base::Value>(*this->open_in_tab));
...
std::unique_ptr<base::DictionaryValue> Sockets::Udp::ToValue() const {
  ...
  if (this->bind.get()) {
    value->SetWithoutPathExpansion("bind", (this->bind)->ToValue());

  }
  if (this->send.get()) {
    value->SetWithoutPathExpansion("send", (this->send)->ToValue());

  }
  if (this->multicast_membership.get()) {
    value->SetWithoutPathExpansion("multicastMembership", (this->multicast_membership)->ToValue());
...
std::unique_ptr<base::DictionaryValue> Sockets::Tcp::ToValue() const {
  ...
  if (this->connect.get()) {
    value->SetWithoutPathExpansion("connect", (this->connect)->ToValue());
...
std::unique_ptr<base::DictionaryValue> Sockets::TcpServer::ToValue() const {
  ...
  if (this->listen.get()) {
    value->SetWithoutPathExpansion("listen", (this->listen)->ToValue());
...
std::unique_ptr<base::DictionaryValue> Sockets::ToValue() const {
  ...
  if (this->udp.get()) {
    value->SetWithoutPathExpansion("udp", (this->udp)->ToValue());

  }
  if (this->tcp.get()) {
    value->SetWithoutPathExpansion("tcp", (this->tcp)->ToValue());

  }
  if (this->tcp_server.get()) {
    value->SetWithoutPathExpansion("tcpServer", (this->tcp_server)->ToValue());
...
std::unique_ptr<base::DictionaryValue> Bluetooth::ToValue() const {
  ...
  if (this->uuids.get()) {
    value->SetWithoutPathExpansion("uuids", json_schema_compiler::util::CreateValueFromOptionalArray(this->uuids));

  }
  if (this->socket.get()) {
    value->SetWithoutPathExpansion("socket", std::make_unique<base::Value>(*this->socket));

  }
  if (this->low_energy.get()) {
    value->SetWithoutPathExpansion("low_energy", std::make_unique<base::Value>(*this->low_energy));

  }
  if (this->peripheral.get()) {
    value->SetWithoutPathExpansion("peripheral", std::make_unique<base::Value>(*this->peripheral));
...
std::unique_ptr<base::DictionaryValue> UsbPrinters::ToValue() const {
  ...
  value->SetWithoutPathExpansion("filters", json_schema_compiler::util::CreateValueFromArray(this->filters));
...
std::unique_ptr<base::DictionaryValue> KioskSecondaryAppsType::ToValue() const {
  ...
  if (this->enabled_on_launch.get()) {
    value->SetWithoutPathExpansion("enabled_on_launch", std::make_unique<base::Value>(*this->enabled_on_launch));
