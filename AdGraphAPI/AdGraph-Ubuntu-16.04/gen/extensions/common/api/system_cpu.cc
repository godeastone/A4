...
std::unique_ptr<base::DictionaryValue> CpuTime::ToValue() const {
  ...
  value->SetWithoutPathExpansion("user", std::make_unique<base::Value>(this->user));

  value->SetWithoutPathExpansion("kernel", std::make_unique<base::Value>(this->kernel));

  value->SetWithoutPathExpansion("idle", std::make_unique<base::Value>(this->idle));

  value->SetWithoutPathExpansion("total", std::make_unique<base::Value>(this->total));
...
std::unique_ptr<base::DictionaryValue> ProcessorInfo::ToValue() const {
  ...
  value->SetWithoutPathExpansion("usage", (this->usage).ToValue());
...
std::unique_ptr<base::DictionaryValue> CpuInfo::ToValue() const {
  ...
  value->SetWithoutPathExpansion("numOfProcessors", std::make_unique<base::Value>(this->num_of_processors));

  value->SetWithoutPathExpansion("archName", std::make_unique<base::Value>(this->arch_name));

  value->SetWithoutPathExpansion("modelName", std::make_unique<base::Value>(this->model_name));

  value->SetWithoutPathExpansion("features", json_schema_compiler::util::CreateValueFromArray(this->features));

  value->SetWithoutPathExpansion("processors", json_schema_compiler::util::CreateValueFromArray(this->processors));

  value->SetWithoutPathExpansion("temperatures", json_schema_compiler::util::CreateValueFromArray(this->temperatures));
