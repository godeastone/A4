...
std::unique_ptr<base::DictionaryValue> SizeChangedOptions::ToValue() const {
  ...
  value->SetWithoutPathExpansion("oldWidth", std::make_unique<base::Value>(this->old_width));

  value->SetWithoutPathExpansion("oldHeight", std::make_unique<base::Value>(this->old_height));

  value->SetWithoutPathExpansion("newWidth", std::make_unique<base::Value>(this->new_width));

  value->SetWithoutPathExpansion("newHeight", std::make_unique<base::Value>(this->new_height));
