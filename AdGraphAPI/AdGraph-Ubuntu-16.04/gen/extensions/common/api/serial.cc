...
std::unique_ptr<base::DictionaryValue> DeviceInfo::ToValue() const {
  ...
  if (this->display_name.get()) {
    value->SetWithoutPathExpansion("displayName", std::make_unique<base::Value>(*this->display_name));
...
std::unique_ptr<base::DictionaryValue> ConnectionOptions::ToValue() const {
  ...
  if (this->persistent.get()) {
    value->SetWithoutPathExpansion("persistent", std::make_unique<base::Value>(*this->persistent));
  ...
  if (this->buffer_size.get()) {
    value->SetWithoutPathExpansion("bufferSize", std::make_unique<base::Value>(*this->buffer_size));

  }
  if (this->bitrate.get()) {
    value->SetWithoutPathExpansion("bitrate", std::make_unique<base::Value>(*this->bitrate));

  }
  if (this->data_bits != DATA_BITS_NONE) {
    value->SetWithoutPathExpansion("dataBits", std::make_unique<base::Value>(serial::ToString(this->data_bits)));

  }
  if (this->parity_bit != PARITY_BIT_NONE) {
    value->SetWithoutPathExpansion("parityBit", std::make_unique<base::Value>(serial::ToString(this->parity_bit)));

  }
  if (this->stop_bits != STOP_BITS_NONE) {
    value->SetWithoutPathExpansion("stopBits", std::make_unique<base::Value>(serial::ToString(this->stop_bits)));

  }
  if (this->cts_flow_control.get()) {
    value->SetWithoutPathExpansion("ctsFlowControl", std::make_unique<base::Value>(*this->cts_flow_control));

  }
  if (this->receive_timeout.get()) {
    value->SetWithoutPathExpansion("receiveTimeout", std::make_unique<base::Value>(*this->receive_timeout));

  }
  if (this->send_timeout.get()) {
    value->SetWithoutPathExpansion("sendTimeout", std::make_unique<base::Value>(*this->send_timeout));
...
std::unique_ptr<base::DictionaryValue> ConnectionInfo::ToValue() const {
  ...
  value->SetWithoutPathExpansion("connectionId", std::make_unique<base::Value>(this->connection_id));
...
std::unique_ptr<base::DictionaryValue> SendInfo::ToValue() const {
  ...
  value->SetWithoutPathExpansion("bytesSent", std::make_unique<base::Value>(this->bytes_sent));

  if (this->error != SEND_ERROR_NONE) {
    value->SetWithoutPathExpansion("error", std::make_unique<base::Value>(serial::ToString(this->error)));
...
std::unique_ptr<base::DictionaryValue> HostControlSignals::ToValue() const {
  ...
  if (this->dtr.get()) {
    value->SetWithoutPathExpansion("dtr", std::make_unique<base::Value>(*this->dtr));

  }
  if (this->rts.get()) {
    value->SetWithoutPathExpansion("rts", std::make_unique<base::Value>(*this->rts));
...
std::unique_ptr<base::DictionaryValue> DeviceControlSignals::ToValue() const {
  ...
  value->SetWithoutPathExpansion("dcd", std::make_unique<base::Value>(this->dcd));

  value->SetWithoutPathExpansion("cts", std::make_unique<base::Value>(this->cts));

  value->SetWithoutPathExpansion("ri", std::make_unique<base::Value>(this->ri));

  value->SetWithoutPathExpansion("dsr", std::make_unique<base::Value>(this->dsr));
