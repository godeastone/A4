...
std::unique_ptr<base::DictionaryValue> PlatformInfo::ToValue() const {
  ...
  value->SetWithoutPathExpansion("os", std::make_unique<base::Value>(runtime::ToString(this->os)));

  value->SetWithoutPathExpansion("arch", std::make_unique<base::Value>(runtime::ToString(this->arch)));

  value->SetWithoutPathExpansion("nacl_arch", std::make_unique<base::Value>(runtime::ToString(this->nacl_arch)));
...
std::unique_ptr<base::DictionaryValue> Details::ToValue() const {
  ...
  value->SetWithoutPathExpansion("reason", std::make_unique<base::Value>(runtime::ToString(this->reason)));

  if (this->previous_version.get()) {
    value->SetWithoutPathExpansion("previousVersion", std::make_unique<base::Value>(*this->previous_version));
