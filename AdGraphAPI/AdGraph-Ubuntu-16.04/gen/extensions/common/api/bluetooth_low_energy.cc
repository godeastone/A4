...
std::unique_ptr<base::DictionaryValue> Device::ToValue() const {
  ...
  if (this->device_class.get()) {
    value->SetWithoutPathExpansion("deviceClass", std::make_unique<base::Value>(*this->device_class));
...
std::unique_ptr<base::DictionaryValue> Service::ToValue() const {
  ...
  value->SetWithoutPathExpansion("uuid", std::make_unique<base::Value>(this->uuid));

  value->SetWithoutPathExpansion("isPrimary", std::make_unique<base::Value>(this->is_primary));

  if (this->instance_id.get()) {
    value->SetWithoutPathExpansion("instanceId", std::make_unique<base::Value>(*this->instance_id));

  }
  if (this->device_address.get()) {
    value->SetWithoutPathExpansion("deviceAddress", std::make_unique<base::Value>(*this->device_address));
  ...
  if (dict->GetWithoutPathExpansion("value", &value_value)) {
    {
      if (!value_value->is_blob()) {
        ...
        out->value.reset(new std::vector<char>(value_value->GetBlob()));
      }
    }
  }
...
std::unique_ptr<base::DictionaryValue> Characteristic::ToValue() const {
  ...
  if (this->service.get()) {
    value->SetWithoutPathExpansion("service", (this->service)->ToValue());
  ...
  value->SetWithoutPathExpansion("properties", json_schema_compiler::util::CreateValueFromArray(properties_list));
  }
...
std::unique_ptr<base::DictionaryValue> Descriptor::ToValue() const {
  ...
  if (this->characteristic.get()) {
    value->SetWithoutPathExpansion("characteristic", (this->characteristic)->ToValue());
  ...
  value->SetWithoutPathExpansion("permissions", json_schema_compiler::util::CreateValueFromArray(permissions_list));
  }
...
std::unique_ptr<base::DictionaryValue> ManufacturerData::ToValue() const {
  ...
  value->SetWithoutPathExpansion("data", json_schema_compiler::util::CreateValueFromArray(this->data));
...
std::unique_ptr<base::DictionaryValue> Advertisement::ToValue() const {
  ...
  value->SetWithoutPathExpansion("type", std::make_unique<base::Value>(bluetooth_low_energy::ToString(this->type)));

  if (this->service_uuids.get()) {
    value->SetWithoutPathExpansion("serviceUuids", json_schema_compiler::util::CreateValueFromOptionalArray(this->service_uuids));

  }
  if (this->manufacturer_data.get()) {
    value->SetWithoutPathExpansion("manufacturerData", json_schema_compiler::util::CreateValueFromOptionalArray(this->manufacturer_data));

  }
  if (this->solicit_uuids.get()) {
    value->SetWithoutPathExpansion("solicitUuids", json_schema_compiler::util::CreateValueFromOptionalArray(this->solicit_uuids));

  }
  if (this->service_data.get()) {
    value->SetWithoutPathExpansion("serviceData", json_schema_compiler::util::CreateValueFromOptionalArray(this->service_data));
...
std::unique_ptr<base::DictionaryValue> Request::ToValue() const {
  ...
  value->SetWithoutPathExpansion("device", (this->device).ToValue());
...
std::unique_ptr<base::DictionaryValue> Response::ToValue() const {
  ...
  value->SetWithoutPathExpansion("isError", std::make_unique<base::Value>(this->is_error));
...
std::unique_ptr<base::DictionaryValue> Notification::ToValue() const {
  ...
  if (this->should_indicate.get()) {
    value->SetWithoutPathExpansion("shouldIndicate", std::make_unique<base::Value>(*this->should_indicate));
