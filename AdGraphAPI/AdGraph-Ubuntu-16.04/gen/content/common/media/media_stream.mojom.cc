...
#include "content/common/media/media_stream.mojom-shared-message-ids.h"
...
TrackControls::TrackControls(
    bool requested_in,
    const std::string& stream_source_in,
    const std::string& device_id_in)
    : requested(std::move(requested_in)),
      stream_source(std::move(stream_source_in)),
...
StreamControls::StreamControls(
    const content::TrackControls& audio_in,
    const content::TrackControls& video_in,
...
const char MediaStreamDeviceObserver::Name_[] = "content.mojom.MediaStreamDeviceObserver";
...
void MediaStreamDeviceObserverProxy::OnDeviceStopped(
    const std::string& in_label, const content::MediaStreamDevice& in_device) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "content::mojom::MediaStreamDeviceObserver::OnDeviceStopped");
#endif
  ...
  ::content::mojom::internal::MediaStreamDeviceObserver_OnDeviceStopped_Params_Data::BufferWriter
      params;
  ...
  typename decltype(params->device)::BaseType::BufferWriter
      device_writer;
  mojo::internal::Serialize<::content::mojom::MediaStreamDeviceDataView>(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)content::mojom::MediaStreamDeviceObserver::OnDeviceStopped",
      ...
      bool success = true;
      std::string p_label{};
      content::MediaStreamDevice p_device{};
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            ...
            "MediaStreamDeviceObserver::OnDeviceStopped deserializer");
        return false;
      }
...
void MediaStreamDeviceObserverInterceptorForTesting::OnDeviceStopped(const std::string& label, const content::MediaStreamDevice& device) {
...
const char MediaStreamDispatcherHost::Name_[] = "content.mojom.MediaStreamDispatcherHost";
...
void MediaStreamDispatcherHostProxy::GenerateStream(
    int32_t in_request_id, const content::StreamControls& in_controls, bool in_user_gesture, GenerateStreamCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "content::mojom::MediaStreamDispatcherHost::GenerateStream");
#endif
  ...
  auto* buffer = message.payload_buffer();
  ::content::mojom::internal::MediaStreamDispatcherHost_GenerateStream_Params_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  ...
  typename decltype(params->controls)::BaseType::BufferWriter
      controls_writer;
  mojo::internal::Serialize<::content::mojom::StreamControlsDataView>(
...
void MediaStreamDispatcherHostProxy::CancelRequest(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "content::mojom::MediaStreamDispatcherHost::CancelRequest");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
  ...
  auto* buffer = message.payload_buffer();
  ::content::mojom::internal::MediaStreamDispatcherHost_CancelRequest_Params_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  params->request_id = in_request_id;
...
void MediaStreamDispatcherHostProxy::StopStreamDevice(
    const std::string& in_device_id, int32_t in_session_id) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "content::mojom::MediaStreamDispatcherHost::StopStreamDevice");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
  ...
  auto* buffer = message.payload_buffer();
  ::content::mojom::internal::MediaStreamDispatcherHost_StopStreamDevice_Params_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
...
void MediaStreamDispatcherHostProxy::OpenDevice(
    int32_t in_request_id, const std::string& in_device_id, content::MediaStreamType in_type, OpenDeviceCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "content::mojom::MediaStreamDispatcherHost::OpenDevice");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
  ...
  auto* buffer = message.payload_buffer();
  ::content::mojom::internal::MediaStreamDispatcherHost_OpenDevice_Params_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  params->request_id = in_request_id;
  ...
  mojo::internal::Serialize<::content::mojom::MediaStreamType>(
      in_type, &params->type);
  message.AttachHandlesFromSerializationContext(
      &serialization_context);
  std::unique_ptr<mojo::MessageReceiver> responder(
...
void MediaStreamDispatcherHostProxy::CloseDevice(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "content::mojom::MediaStreamDispatcherHost::CloseDevice");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
  ...
  auto* buffer = message.payload_buffer();
  ::content::mojom::internal::MediaStreamDispatcherHost_CloseDevice_Params_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  typename decltype(params->label)::BaseType::BufferWriter
...
void MediaStreamDispatcherHostProxy::SetCapturingLinkSecured(
    int32_t in_session_id, content::MediaStreamType in_type, bool in_is_secure) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "content::mojom::MediaStreamDispatcherHost::SetCapturingLinkSecured");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
  ...
  auto* buffer = message.payload_buffer();
  ::content::mojom::internal::MediaStreamDispatcherHost_SetCapturingLinkSecured_Params_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  params->session_id = in_session_id;
...
void MediaStreamDispatcherHostProxy::OnStreamStarted(
    const std::string& in_label) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "content::mojom::MediaStreamDispatcherHost::OnStreamStarted");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
  ...
  auto* buffer = message.payload_buffer();
  ::content::mojom::internal::MediaStreamDispatcherHost_OnStreamStarted_Params_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  typename decltype(params->label)::BaseType::BufferWriter
...
class MediaStreamDispatcherHost_GenerateStream_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      content::MediaStreamRequestResult in_result, const std::string& in_label, const std::vector<content::MediaStreamDevice>& in_audio_devices, const std::vector<content::MediaStreamDevice>& in_video_devices);
...
bool MediaStreamDispatcherHost_GenerateStream_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "content::mojom::MediaStreamDispatcherHost::GenerateStreamCallback",
               "message", message->name());
#endif
  ...
  serialization_context.TakeHandlesFromMessage(message);
  bool success = true;
  content::MediaStreamRequestResult p_result{};
  std::string p_label{};
  std::vector<content::MediaStreamDevice> p_audio_devices{};
  std::vector<content::MediaStreamDevice> p_video_devices{};
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "MediaStreamDispatcherHost::GenerateStream response deserializer");
    return false;
  }
...
void MediaStreamDispatcherHost_GenerateStream_ProxyToResponder::Run(
  ...
  mojo::Message message(
      internal::kMediaStreamDispatcherHost_GenerateStream_Name, kFlags, 0, 0, nullptr);
  auto* buffer = message.payload_buffer();
  ::content::mojom::internal::MediaStreamDispatcherHost_GenerateStream_ResponseParams_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  mojo::internal::Serialize<::content::mojom::MediaStreamRequestResult>(
  ...
  const mojo::internal::ContainerValidateParams audio_devices_validate_params(
      0, false, nullptr);
  mojo::internal::Serialize<mojo::ArrayDataView<::content::mojom::MediaStreamDeviceDataView>>(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)content::mojom::MediaStreamDispatcherHost::GenerateStreamCallback",
               "message", message.name());
#endif
...
class MediaStreamDispatcherHost_OpenDevice_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      bool in_success, const std::string& in_label, const content::MediaStreamDevice& in_device);
...
bool MediaStreamDispatcherHost_OpenDevice_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "content::mojom::MediaStreamDispatcherHost::OpenDeviceCallback",
               "message", message->name());
#endif
  mojo::internal::MessageDispatchContext dispatch_context(message);
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "MediaStreamDispatcherHost::OpenDevice response deserializer");
    return false;
  }
  if (!callback_.is_null())
    std::move(callback_).Run(
...
void MediaStreamDispatcherHost_OpenDevice_ProxyToResponder::Run(
  ...
  mojo::Message message(
      internal::kMediaStreamDispatcherHost_OpenDevice_Name, kFlags, 0, 0, nullptr);
  auto* buffer = message.payload_buffer();
  ::content::mojom::internal::MediaStreamDispatcherHost_OpenDevice_ResponseParams_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)content::mojom::MediaStreamDispatcherHost::OpenDeviceCallback",
               "message", message.name());
#endif
  message.set_request_id(request_id_);
  ignore_result(responder_->Accept(&message));
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)content::mojom::MediaStreamDispatcherHost::GenerateStream",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)content::mojom::MediaStreamDispatcherHost::CancelRequest",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "MediaStreamDispatcherHost::CancelRequest deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)content::mojom::MediaStreamDispatcherHost::StopStreamDevice",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "MediaStreamDispatcherHost::StopStreamDevice deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)content::mojom::MediaStreamDispatcherHost::OpenDevice",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)content::mojom::MediaStreamDispatcherHost::CloseDevice",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "MediaStreamDispatcherHost::CloseDevice deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)content::mojom::MediaStreamDispatcherHost::SetCapturingLinkSecured",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      bool success = true;
      int32_t p_session_id{};
      content::MediaStreamType p_type{};
      bool p_is_secure{};
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "MediaStreamDispatcherHost::SetCapturingLinkSecured deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)content::mojom::MediaStreamDispatcherHost::OnStreamStarted",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "MediaStreamDispatcherHost::OnStreamStarted deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
bool MediaStreamDispatcherHostStubDispatch::AcceptWithResponder(
  ...
  TRACE_EVENT1("mojom", "(Impl)content::mojom::MediaStreamDispatcherHost::GenerateStream",
      ...
      bool success = true;
      int32_t p_request_id{};
      content::StreamControls p_controls{};
      bool p_user_gesture{};
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "MediaStreamDispatcherHost::GenerateStream deserializer");
        return false;
      }
      MediaStreamDispatcherHost::GenerateStreamCallback callback =
  ...
  TRACE_EVENT1("mojom", "(Impl)content::mojom::MediaStreamDispatcherHost::OpenDevice",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "MediaStreamDispatcherHost::OpenDevice deserializer");
        return false;
      }
      MediaStreamDispatcherHost::OpenDeviceCallback callback =
...
void MediaStreamDispatcherHostInterceptorForTesting::GenerateStream(int32_t request_id, const content::StreamControls& controls, bool user_gesture, GenerateStreamCallback callback) {
...
void MediaStreamDispatcherHostInterceptorForTesting::OpenDevice(int32_t request_id, const std::string& device_id, content::MediaStreamType type, OpenDeviceCallback callback) {
...
void MediaStreamDispatcherHostInterceptorForTesting::SetCapturingLinkSecured(int32_t session_id, content::MediaStreamType type, bool is_secure) {
...
void MediaStreamDispatcherHostAsyncWaiter::GenerateStream(
  ...
  proxy_->GenerateStream(std::move(request_id),std::move(controls),std::move(user_gesture),
      base::BindOnce(
          [](base::RunLoop* loop,
             content::MediaStreamRequestResult* out_result
,
             std::string* out_label
,
             std::vector<content::MediaStreamDevice>* out_audio_devices
,
             std::vector<content::MediaStreamDevice>* out_video_devices
,
             content::MediaStreamRequestResult result,
             const std::string& label,
             const std::vector<content::MediaStreamDevice>& audio_devices,
             const std::vector<content::MediaStreamDevice>& video_devices) {*out_result = std::move(result);*out_label = std::move(label);*out_audio_devices = std::move(audio_devices);*out_video_devices = std::move(video_devices);
            loop->Quit();
          },
          &loop,
          out_result,
...
,
             std::string* out_label
,
             content::MediaStreamDevice* out_device
,
             bool success,
             const std::string& label,
             const content::MediaStreamDevice& device) {*out_success = std::move(success);*out_label = std::move(label);*out_device = std::move(device);
            loop->Quit();
          },
          &loop,
          out_success,
...
const char MediaStreamTrackMetricsHost::Name_[] = "content.mojom.MediaStreamTrackMetricsHost";
...
void MediaStreamTrackMetricsHostProxy::AddTrack(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "content::mojom::MediaStreamTrackMetricsHost::AddTrack");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
  ...
  auto* buffer = message.payload_buffer();
  ::content::mojom::internal::MediaStreamTrackMetricsHost_AddTrack_Params_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  params->id = in_id;
...
void MediaStreamTrackMetricsHostProxy::RemoveTrack(
    uint64_t in_id) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "content::mojom::MediaStreamTrackMetricsHost::RemoveTrack");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
  ...
  auto* buffer = message.payload_buffer();
  ::content::mojom::internal::MediaStreamTrackMetricsHost_RemoveTrack_Params_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  params->id = in_id;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)content::mojom::MediaStreamTrackMetricsHost::AddTrack",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "MediaStreamTrackMetricsHost::AddTrack deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)content::mojom::MediaStreamTrackMetricsHost::RemoveTrack",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "MediaStreamTrackMetricsHost::RemoveTrack deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
// static
bool StructTraits<::content::mojom::TrackControls::DataView, ::content::mojom::TrackControlsPtr>::Read(
    ::content::mojom::TrackControls::DataView input,
    ::content::mojom::TrackControlsPtr* output) {
  bool success = true;
  ::content::mojom::TrackControlsPtr result(::content::mojom::TrackControls::New());
  
      result->requested = input.requested();
      if (!input.ReadStreamSource(&result->stream_source))
        success = false;
...
// static
bool StructTraits<::content::mojom::StreamControls::DataView, ::content::mojom::StreamControlsPtr>::Read(
    ::content::mojom::StreamControls::DataView input,
    ::content::mojom::StreamControlsPtr* output) {
  bool success = true;
  ::content::mojom::StreamControlsPtr result(::content::mojom::StreamControls::New());
