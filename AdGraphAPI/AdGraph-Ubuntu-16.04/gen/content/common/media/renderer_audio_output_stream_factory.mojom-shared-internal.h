...
#ifndef CONTENT_COMMON_MEDIA_RENDERER_AUDIO_OUTPUT_STREAM_FACTORY_MOJOM_SHARED_INTERNAL_H_
#define CONTENT_COMMON_MEDIA_RENDERER_AUDIO_OUTPUT_STREAM_FACTORY_MOJOM_SHARED_INTERNAL_H_
...
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) RendererAudioOutputStreamFactory_RequestDeviceAuthorization_Params_Data {
 public:
  ...
  mojo::internal::Handle_Data stream_provider_request;
  int32_t session_id;
...
static_assert(sizeof(RendererAudioOutputStreamFactory_RequestDeviceAuthorization_Params_Data) == 24,
...
#endif  // CONTENT_COMMON_MEDIA_RENDERER_AUDIO_OUTPUT_STREAM_FACTORY_MOJOM_SHARED_INTERNAL_H_