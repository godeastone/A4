...
class AssociatedInterfaceProvider_GetAssociatedInterface_ParamsDataView {
 public:
  ...
  UserType TakeRequest() {
    UserType result;
    bool ret =
        mojo::internal::Deserialize<::content::mojom::AssociatedInterfaceAssociatedRequestDataView>(
...
class RouteProvider_GetRoute_ParamsDataView {
 public:
  ...
  UserType TakeRequest() {
    UserType result;
    bool ret =
        mojo::internal::Deserialize<::content::mojom::AssociatedInterfaceProviderAssociatedRequestDataView>(
            &data_->request, &result, context_);
    DCHECK(ret);
    return result;
  }
