...
using LevelDBObserverPtrDataView =
    mojo::InterfacePtrDataView<LevelDBObserverInterfaceBase>;
using LevelDBObserverRequestDataView =
    mojo::InterfaceRequestDataView<LevelDBObserverInterfaceBase>;
using LevelDBObserverAssociatedPtrInfoDataView =
    mojo::AssociatedInterfacePtrInfoDataView<LevelDBObserverInterfaceBase>;
using LevelDBObserverAssociatedRequestDataView =
    mojo::AssociatedInterfaceRequestDataView<LevelDBObserverInterfaceBase>;
class LevelDBWrapperGetAllCallbackInterfaceBase {};

using LevelDBWrapperGetAllCallbackPtrDataView =
    mojo::InterfacePtrDataView<LevelDBWrapperGetAllCallbackInterfaceBase>;
using LevelDBWrapperGetAllCallbackRequestDataView =
    mojo::InterfaceRequestDataView<LevelDBWrapperGetAllCallbackInterfaceBase>;
using LevelDBWrapperGetAllCallbackAssociatedPtrInfoDataView =
    mojo::AssociatedInterfacePtrInfoDataView<LevelDBWrapperGetAllCallbackInterfaceBase>;
using LevelDBWrapperGetAllCallbackAssociatedRequestDataView =
    mojo::AssociatedInterfaceRequestDataView<LevelDBWrapperGetAllCallbackInterfaceBase>;
class LevelDBWrapperInterfaceBase {};

using LevelDBWrapperPtrDataView =
    mojo::InterfacePtrDataView<LevelDBWrapperInterfaceBase>;
using LevelDBWrapperRequestDataView =
    mojo::InterfaceRequestDataView<LevelDBWrapperInterfaceBase>;
using LevelDBWrapperAssociatedPtrInfoDataView =
    mojo::AssociatedInterfacePtrInfoDataView<LevelDBWrapperInterfaceBase>;
using LevelDBWrapperAssociatedRequestDataView =
    mojo::AssociatedInterfaceRequestDataView<LevelDBWrapperInterfaceBase>;
class KeyValueDataView {
 public:
  KeyValueDataView() {}
...
class LevelDBObserver_ShouldSendOldValueOnMutations_ParamsDataView {
 public:
  LevelDBObserver_ShouldSendOldValueOnMutations_ParamsDataView() {}

  LevelDBObserver_ShouldSendOldValueOnMutations_ParamsDataView(
      internal::LevelDBObserver_ShouldSendOldValueOnMutations_Params_Data* data,
      mojo::internal::SerializationContext* context)
      : data_(data) {}
 ...
 private:
  internal::LevelDBObserver_ShouldSendOldValueOnMutations_Params_Data* data_ = nullptr;
};
...
class LevelDBWrapper_AddObserver_ParamsDataView {
 public:
  ...
  UserType TakeObserver() {
    UserType result;
    bool ret =
        mojo::internal::Deserialize<::content::mojom::LevelDBObserverAssociatedPtrInfoDataView>(
...
class LevelDBWrapper_GetAll_ParamsDataView {
 public:
  ...
  UserType TakeCompleteCallback() {
    UserType result;
    bool ret =
        mojo::internal::Deserialize<::content::mojom::LevelDBWrapperGetAllCallbackAssociatedPtrInfoDataView>(
...
struct Serializer<::content::mojom::KeyValueDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
                        Buffer* buffer,
                        ::content::mojom::internal::KeyValue_Data::BufferWriter* output,
...
inline void LevelDBWrapper_Put_ParamsDataView::GetClientOldValueDataView(
    mojo::ArrayDataView<uint8_t>* output) {
  auto pointer = data_->client_old_value.Get();
  *output = mojo::ArrayDataView<uint8_t>(pointer, context_);
}
...
inline void LevelDBWrapper_Delete_ParamsDataView::GetClientOldValueDataView(
    mojo::ArrayDataView<uint8_t>* output) {
  auto pointer = data_->client_old_value.Get();
  *output = mojo::ArrayDataView<uint8_t>(pointer, context_);
}
