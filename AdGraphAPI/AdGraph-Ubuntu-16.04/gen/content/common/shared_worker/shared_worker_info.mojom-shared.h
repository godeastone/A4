...
#ifndef CONTENT_COMMON_SHARED_WORKER_SHARED_WORKER_INFO_MOJOM_SHARED_H_
#define CONTENT_COMMON_SHARED_WORKER_SHARED_WORKER_INFO_MOJOM_SHARED_H_
...
template <>
struct MojomTypeTraits<::content::mojom::SharedWorkerInfoDataView> {
  using Data = ::content::mojom::internal::SharedWorkerInfo_Data;
...
struct Serializer<::content::mojom::SharedWorkerInfoDataView, MaybeConstUserType> {
  using UserType = typename std::remove_const<MaybeConstUserType>::type;
  using Traits = StructTraits<::content::mojom::SharedWorkerInfoDataView, UserType>;

  static void Serialize(MaybeConstUserType& input,
                        Buffer* buffer,
                        ::content::mojom::internal::SharedWorkerInfo_Data::BufferWriter* output,
    ...
    decltype(CallWithContext(Traits::content_security_policy, input, custom_context)) in_content_security_policy = CallWithContext(Traits::content_security_policy, input, custom_context);
    ...
    mojo::internal::Serialize<::blink::mojom::ContentSecurityPolicyType>(
        CallWithContext(Traits::content_security_policy_type, input, custom_context), &(*output)->content_security_policy_type);
    mojo::internal::Serialize<::blink::mojom::IPAddressSpace>(
        CallWithContext(Traits::creation_address_space, input, custom_context), &(*output)->creation_address_space);
    CustomContextHelper<Traits>::TearDown(input, custom_context);
  }

  static bool Deserialize(::content::mojom::internal::SharedWorkerInfo_Data* input,
                          UserType* output,
                          SerializationContext* context) {
    if (!input)
      return CallSetToNullIfExists<Traits>(output);

    ::content::mojom::SharedWorkerInfoDataView data_view(input, context);
...
#endif  // CONTENT_COMMON_SHARED_WORKER_SHARED_WORKER_INFO_MOJOM_SHARED_H_
