...
#ifndef CONTENT_COMMON_SHARED_WORKER_SHARED_WORKER_INFO_MOJOM_SHARED_INTERNAL_H_
#define CONTENT_COMMON_SHARED_WORKER_SHARED_WORKER_INFO_MOJOM_SHARED_INTERNAL_H_
...
#pragma pack(push, 1)
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) SharedWorkerInfo_Data {
 public:
  class BufferWriter {
   public:
...
#endif  // CONTENT_COMMON_SHARED_WORKER_SHARED_WORKER_INFO_MOJOM_SHARED_INTERNAL_H_