...
bool SharedWorkerInfo_Data::Validate(
  ...
  const SharedWorkerInfo_Data* object = static_cast<const SharedWorkerInfo_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->content_security_policy, 3, validation_context)) {
    return false;
  }
  ...
  if (!::blink::mojom::internal::ContentSecurityPolicyType_Data
        ::Validate(object->content_security_policy_type, validation_context))
    return false;


  if (!::blink::mojom::internal::IPAddressSpace_Data
        ::Validate(object->creation_address_space, validation_context))
    return false;
