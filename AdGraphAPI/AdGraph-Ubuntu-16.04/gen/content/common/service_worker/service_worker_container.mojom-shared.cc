...
bool ServiceWorkerContainerHost_Register_Params_Data::Validate(
  ...
  const ServiceWorkerContainerHost_Register_Params_Data* object = static_cast<const ServiceWorkerContainerHost_Register_Params_Data*>(data);
...
bool ServiceWorkerContainerHost_Register_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ServiceWorkerContainerHost_Register_ResponseParams_Data* object = static_cast<const ServiceWorkerContainerHost_Register_ResponseParams_Data*>(data);
...
bool ServiceWorkerContainerHost_GetRegistration_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ServiceWorkerContainerHost_GetRegistration_Params_Data* object = static_cast<const ServiceWorkerContainerHost_GetRegistration_Params_Data*>(data);
...
bool ServiceWorkerContainerHost_GetRegistration_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ServiceWorkerContainerHost_GetRegistration_ResponseParams_Data* object = static_cast<const ServiceWorkerContainerHost_GetRegistration_ResponseParams_Data*>(data);
...
bool ServiceWorkerContainerHost_GetRegistrations_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ServiceWorkerContainerHost_GetRegistrations_Params_Data* object = static_cast<const ServiceWorkerContainerHost_GetRegistrations_Params_Data*>(data);
...
bool ServiceWorkerContainerHost_GetRegistrations_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ServiceWorkerContainerHost_GetRegistrations_ResponseParams_Data* object = static_cast<const ServiceWorkerContainerHost_GetRegistrations_ResponseParams_Data*>(data);
...
bool ServiceWorkerContainerHost_GetRegistrationForReady_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ServiceWorkerContainerHost_GetRegistrationForReady_Params_Data* object = static_cast<const ServiceWorkerContainerHost_GetRegistrationForReady_Params_Data*>(data);
...
bool ServiceWorkerContainerHost_GetRegistrationForReady_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ServiceWorkerContainerHost_GetRegistrationForReady_ResponseParams_Data* object = static_cast<const ServiceWorkerContainerHost_GetRegistrationForReady_ResponseParams_Data*>(data);
...
bool ServiceWorkerContainerHost_EnsureControllerServiceWorker_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ServiceWorkerContainerHost_EnsureControllerServiceWorker_Params_Data* object = static_cast<const ServiceWorkerContainerHost_EnsureControllerServiceWorker_Params_Data*>(data);
  ...
  if (!::content::mojom::internal::ControllerServiceWorkerPurpose_Data
...
// static
bool ServiceWorkerContainerHost_CloneForWorker_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ServiceWorkerContainerHost_CloneForWorker_Params_Data* object = static_cast<const ServiceWorkerContainerHost_CloneForWorker_Params_Data*>(data);
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->container_host_for_worker, 1, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateHandleOrInterface(object->container_host_for_worker,
                                                 validation_context)) {
    return false;
  }
...
ServiceWorkerContainerHost_CloneForWorker_Params_Data::ServiceWorkerContainerHost_CloneForWorker_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool ServiceWorkerContainerHost_Ping_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ServiceWorkerContainerHost_Ping_Params_Data* object = static_cast<const ServiceWorkerContainerHost_Ping_Params_Data*>(data);
...
ServiceWorkerContainerHost_Ping_Params_Data::ServiceWorkerContainerHost_Ping_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool ServiceWorkerContainerHost_Ping_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ServiceWorkerContainerHost_Ping_ResponseParams_Data* object = static_cast<const ServiceWorkerContainerHost_Ping_ResponseParams_Data*>(data);
...
ServiceWorkerContainerHost_Ping_ResponseParams_Data::ServiceWorkerContainerHost_Ping_ResponseParams_Data()
    : header_({sizeof(*this), 0}) {}
...
bool ServiceWorkerContainer_SetController_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ServiceWorkerContainer_SetController_Params_Data* object = static_cast<const ServiceWorkerContainer_SetController_Params_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->used_features, 2, validation_context)) {
    return false;
  }
...
bool ServiceWorkerContainer_PostMessageToClient_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ServiceWorkerContainer_PostMessageToClient_Params_Data* object = static_cast<const ServiceWorkerContainer_PostMessageToClient_Params_Data*>(data);
...
bool ServiceWorkerContainer_CountFeature_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ServiceWorkerContainer_CountFeature_Params_Data* object = static_cast<const ServiceWorkerContainer_CountFeature_Params_Data*>(data);
