...
#ifndef CONTENT_COMMON_SERVICE_WORKER_DISPATCH_FETCH_EVENT_PARAMS_MOJOM_SHARED_INTERNAL_H_
#define CONTENT_COMMON_SERVICE_WORKER_DISPATCH_FETCH_EVENT_PARAMS_MOJOM_SHARED_INTERNAL_H_
...
#pragma pack(push, 1)
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) FetchEventPreloadHandle_Data {
 public:
  class BufferWriter {
   public:
...
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) DispatchFetchEventParams_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
  ...
  mojo::internal::Pointer<mojo::internal::Array_Data<mojo::internal::Interface_Data>> request_body_blob_ptrs;
  mojo::internal::Pointer<mojo::internal::String_Data> request_body_blob_uuid;
  uint64_t request_body_blob_size;
  mojo::internal::Interface_Data request_body_blob;
...
static_assert(sizeof(DispatchFetchEventParams_Data) == 64,
...
#endif  // CONTENT_COMMON_SERVICE_WORKER_DISPATCH_FETCH_EVENT_PARAMS_MOJOM_SHARED_INTERNAL_H_