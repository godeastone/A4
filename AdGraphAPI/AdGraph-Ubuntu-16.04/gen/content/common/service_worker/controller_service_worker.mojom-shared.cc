...
bool ControllerServiceWorkerInfo_Data::Validate(
  ...
  const ControllerServiceWorkerInfo_Data* object = static_cast<const ControllerServiceWorkerInfo_Data*>(data);
  ...
  if (!mojo::internal::ValidateHandleOrInterface(object->endpoint,
                                                 validation_context)) {
    return false;
  }
...
// static
bool ControllerServiceWorker_DispatchFetchEvent_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ControllerServiceWorker_DispatchFetchEvent_Params_Data* object = static_cast<const ControllerServiceWorker_DispatchFetchEvent_Params_Data*>(data);
...
ControllerServiceWorker_DispatchFetchEvent_Params_Data::ControllerServiceWorker_DispatchFetchEvent_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool ControllerServiceWorker_DispatchFetchEvent_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ControllerServiceWorker_DispatchFetchEvent_ResponseParams_Data* object = static_cast<const ControllerServiceWorker_DispatchFetchEvent_ResponseParams_Data*>(data);
...
ControllerServiceWorker_DispatchFetchEvent_ResponseParams_Data::ControllerServiceWorker_DispatchFetchEvent_ResponseParams_Data()
    : header_({sizeof(*this), 0}) {}
...
bool ControllerServiceWorker_Clone_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ControllerServiceWorker_Clone_Params_Data* object = static_cast<const ControllerServiceWorker_Clone_Params_Data*>(data);
