...
using ChildMemoryCoordinatorPtrDataView =
    mojo::InterfacePtrDataView<ChildMemoryCoordinatorInterfaceBase>;
using ChildMemoryCoordinatorRequestDataView =
    mojo::InterfaceRequestDataView<ChildMemoryCoordinatorInterfaceBase>;
using ChildMemoryCoordinatorAssociatedPtrInfoDataView =
    mojo::AssociatedInterfacePtrInfoDataView<ChildMemoryCoordinatorInterfaceBase>;
using ChildMemoryCoordinatorAssociatedRequestDataView =
    mojo::AssociatedInterfaceRequestDataView<ChildMemoryCoordinatorInterfaceBase>;
...
class ChildMemoryCoordinator_PurgeMemory_ParamsDataView {
 public:
  ChildMemoryCoordinator_PurgeMemory_ParamsDataView() {}

  ChildMemoryCoordinator_PurgeMemory_ParamsDataView(
      internal::ChildMemoryCoordinator_PurgeMemory_Params_Data* data,
      mojo::internal::SerializationContext* context)
      : data_(data) {}

  bool is_null() const { return !data_; }
 private:
  internal::ChildMemoryCoordinator_PurgeMemory_Params_Data* data_ = nullptr;
};
