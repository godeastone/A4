...
#ifndef CONTENT_COMMON_URL_LOADER_FACTORY_BUNDLE_MOJOM_SHARED_INTERNAL_H_
#define CONTENT_COMMON_URL_LOADER_FACTORY_BUNDLE_MOJOM_SHARED_INTERNAL_H_
...
#pragma pack(push, 1)
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) URLLoaderFactoryBundle_Data {
 public:
  class BufferWriter {
   public:
  ...
  mojo::internal::Pointer<mojo::internal::Map_Data<mojo::internal::Pointer<mojo::internal::String_Data>, mojo::internal::Interface_Data>> factories;

 private:
  URLLoaderFactoryBundle_Data();
  ~URLLoaderFactoryBundle_Data() = delete;
};
static_assert(sizeof(URLLoaderFactoryBundle_Data) == 24,
...
#endif  // CONTENT_COMMON_URL_LOADER_FACTORY_BUNDLE_MOJOM_SHARED_INTERNAL_H_