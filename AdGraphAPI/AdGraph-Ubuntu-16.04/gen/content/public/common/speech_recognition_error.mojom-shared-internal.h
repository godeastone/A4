...
#ifndef CONTENT_PUBLIC_COMMON_SPEECH_RECOGNITION_ERROR_MOJOM_SHARED_INTERNAL_H_
#define CONTENT_PUBLIC_COMMON_SPEECH_RECOGNITION_ERROR_MOJOM_SHARED_INTERNAL_H_
...
#pragma pack(push, 1)
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) SpeechRecognitionError_Data {
 public:
  class BufferWriter {
   public:
...
#endif  // CONTENT_PUBLIC_COMMON_SPEECH_RECOGNITION_ERROR_MOJOM_SHARED_INTERNAL_H_