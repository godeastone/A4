...
#ifndef CONTENT_PUBLIC_COMMON_APPCACHE_INFO_MOJOM_SHARED_INTERNAL_H_
#define CONTENT_PUBLIC_COMMON_APPCACHE_INFO_MOJOM_SHARED_INTERNAL_H_
...
#pragma pack(push, 1)
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) AppCacheInfo_Data {
 public:
  class BufferWriter {
   public:
...
static_assert(sizeof(AppCacheInfo_Data) == 72,
...
#endif  // CONTENT_PUBLIC_COMMON_APPCACHE_INFO_MOJOM_SHARED_INTERNAL_H_