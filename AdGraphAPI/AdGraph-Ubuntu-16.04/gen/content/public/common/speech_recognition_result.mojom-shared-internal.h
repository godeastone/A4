...
#ifndef CONTENT_PUBLIC_COMMON_SPEECH_RECOGNITION_RESULT_MOJOM_SHARED_INTERNAL_H_
#define CONTENT_PUBLIC_COMMON_SPEECH_RECOGNITION_RESULT_MOJOM_SHARED_INTERNAL_H_
...
#pragma pack(push, 1)
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) SpeechRecognitionHypothesis_Data {
 public:
  class BufferWriter {
   public:
...
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) SpeechRecognitionResult_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
...
#endif  // CONTENT_PUBLIC_COMMON_SPEECH_RECOGNITION_RESULT_MOJOM_SHARED_INTERNAL_H_