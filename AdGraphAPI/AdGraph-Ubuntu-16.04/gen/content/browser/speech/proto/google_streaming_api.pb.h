...
class SpeechRecognitionEvent : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:content.proto.SpeechRecognitionEvent) */ {
 public:
  ...
  inline SpeechRecognitionEvent* New() const PROTOBUF_FINAL { return New(NULL); }

  SpeechRecognitionEvent* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  int status_;
  int endpoint_;
  friend struct protobuf_google_5fstreaming_5fapi_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class SpeechRecognitionResult : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:content.proto.SpeechRecognitionResult) */ {
 public:
...
class SpeechRecognitionAlternative : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:content.proto.SpeechRecognitionAlternative) */ {
 public:
