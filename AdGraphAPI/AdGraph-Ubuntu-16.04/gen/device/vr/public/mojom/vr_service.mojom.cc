...
XRInputSourceDescription::XRInputSourceDescription(
    ...
    const base::Optional<gfx::Transform>& pointer_offset_in)
...
XRInputSourceState::XRInputSourceState(
    ...
    const base::Optional<gfx::Transform>& grip_in,
...
VRPose::VRPose(
    const base::Optional<std::vector<float>>& orientation_in,
    const base::Optional<std::vector<float>>& position_in,
    const base::Optional<std::vector<float>>& angularVelocity_in,
    const base::Optional<std::vector<float>>& linearVelocity_in,
    const base::Optional<std::vector<float>>& angularAcceleration_in,
    const base::Optional<std::vector<float>>& linearAcceleration_in,
...
size_t VRDisplayCapabilities::Hash(size_t seed) const {
  ...
  seed = mojo::internal::Hash(seed, this->can_provide_pass_through_images);
  return seed;
}
...
VREyeParameters::VREyeParameters(
    ...
    const std::vector<float>& offset_in,
...
VRStageParameters::VRStageParameters(
    const std::vector<float>& standingTransform_in,
    float sizeX_in,
    float sizeZ_in)
...
VRDisplayInfo::VRDisplayInfo(
    uint32_t index_in,
    const std::string& displayName_in,
...
size_t VRRequestPresentOptions::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->preserve_drawing_buffer);
  seed = mojo::internal::Hash(seed, this->webxr_input);
  seed = mojo::internal::Hash(seed, this->shared_buffer_draw_supported);
  return seed;
}
...
VRMagicWindowFrameData::VRMagicWindowFrameData(
    ...
    const gfx::Size& buffer_size_in,
    base::TimeDelta time_delta_in,
    const std::vector<float>& projection_matrix_in)
...
void VRMagicWindowProviderProxy::GetFrameData(
    const gfx::Size& in_frame_size, display::Display::Rotation in_display_rotation, GetFrameDataCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void VRMagicWindowProviderInterceptorForTesting::GetFrameData(const gfx::Size& frame_size, display::Display::Rotation display_rotation, GetFrameDataCallback callback) {
...
class VRPresentationProvider_GetVSync_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      VRPosePtr in_pose, base::TimeDelta in_time, int16_t in_frame_id, VRPresentationProvider::VSyncStatus in_status, const base::Optional<::gpu::MailboxHolder>& in_buffer_holder);
...
void VRPresentationProviderInterceptorForTesting::UpdateLayerBounds(int16_t frame_id, const gfx::RectF& left_bounds, const gfx::RectF& right_bounds, const gfx::Size& source_size) {
...
void VRPresentationProviderInterceptorForTesting::SubmitFrame(int16_t frame_id, const ::gpu::MailboxHolder& mailbox_holder, base::TimeDelta time_waited) {
...
void VRPresentationProviderInterceptorForTesting::SubmitFrameDrawnIntoTexture(int16_t frameId, const ::gpu::SyncToken& sync_token, base::TimeDelta time_waited) {
...
// static
bool StructTraits<::device::mojom::VRRequestPresentOptions::DataView, ::device::mojom::VRRequestPresentOptionsPtr>::Read(
    ::device::mojom::VRRequestPresentOptions::DataView input,
    ::device::mojom::VRRequestPresentOptionsPtr* output) {
  bool success = true;
  ::device::mojom::VRRequestPresentOptionsPtr result(::device::mojom::VRRequestPresentOptions::New());
...
// static
bool StructTraits<::device::mojom::VRDisplayFrameTransportOptions::DataView, ::device::mojom::VRDisplayFrameTransportOptionsPtr>::Read(
    ::device::mojom::VRDisplayFrameTransportOptions::DataView input,
    ::device::mojom::VRDisplayFrameTransportOptionsPtr* output) {
  bool success = true;
  ::device::mojom::VRDisplayFrameTransportOptionsPtr result(::device::mojom::VRDisplayFrameTransportOptions::New());
...
// static
bool StructTraits<::device::mojom::VRMagicWindowFrameData::DataView, ::device::mojom::VRMagicWindowFrameDataPtr>::Read(
    ::device::mojom::VRMagicWindowFrameData::DataView input,
    ::device::mojom::VRMagicWindowFrameDataPtr* output) {
  bool success = true;
  ::device::mojom::VRMagicWindowFrameDataPtr result(::device::mojom::VRMagicWindowFrameData::New());
