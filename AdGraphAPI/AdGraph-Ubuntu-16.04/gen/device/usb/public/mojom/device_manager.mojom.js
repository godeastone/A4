...
(function() {
  ...
  UsbDeviceFilter.generate = function(generator_) {
    var generated = new UsbDeviceFilter;
    ...
    generated.hasClassCode = generator_.generateBool();
    generated.classCode = generator_.generateUint8();
    generated.hasSubclassCode = generator_.generateBool();
    generated.subclassCode = generator_.generateUint8();
    generated.hasProtocolCode = generator_.generateBool();
  ...
  UsbDeviceFilter.prototype.mutate = function(mutator_) {
    ...
    if (mutator_.chooseMutateField()) {
      this.hasClassCode = mutator_.mutateBool(this.hasClassCode);
    }
    if (mutator_.chooseMutateField()) {
      this.classCode = mutator_.mutateUint8(this.classCode);
    }
    if (mutator_.chooseMutateField()) {
      this.hasSubclassCode = mutator_.mutateBool(this.hasSubclassCode);
    }
    if (mutator_.chooseMutateField()) {
      this.subclassCode = mutator_.mutateUint8(this.subclassCode);
    }
    if (mutator_.chooseMutateField()) {
      this.hasProtocolCode = mutator_.mutateBool(this.hasProtocolCode);
    }
    if (mutator_.chooseMutateField()) {
  ...
  UsbDeviceFilter.prototype.getHandleDeps = function() {
    var handles = [];
    return handles;
  };

  UsbDeviceFilter.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  UsbDeviceFilter.prototype.setHandlesInternal_ = function(handles, idx) {
    return idx;
  };
  ...
  UsbEnumerationOptions.generate = function(generator_) {
    var generated = new UsbEnumerationOptions;
  ...
  UsbEnumerationOptions.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.filters = mutator_.mutateArray(this.filters, function(val) {
        return mutator_.mutateStruct(device.mojom.UsbDeviceFilter, false);
      });
    }
    return this;
  };
  UsbEnumerationOptions.prototype.getHandleDeps = function() {
    var handles = [];
    return handles;
  };

  UsbEnumerationOptions.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  UsbEnumerationOptions.prototype.setHandlesInternal_ = function(handles, idx) {
    return idx;
  };
  ...
  UsbDeviceManager_GetDevices_Params.generate = function(generator_) {
    var generated = new UsbDeviceManager_GetDevices_Params;
    generated.options = generator_.generateStruct(device.mojom.UsbEnumerationOptions, true);
    return generated;
  };

  UsbDeviceManager_GetDevices_Params.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.options = mutator_.mutateStruct(device.mojom.UsbEnumerationOptions, true);
    }
    return this;
  };
  UsbDeviceManager_GetDevices_Params.prototype.getHandleDeps = function() {
    var handles = [];
    return handles;
  };

  UsbDeviceManager_GetDevices_Params.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  UsbDeviceManager_GetDevices_Params.prototype.setHandlesInternal_ = function(handles, idx) {
    return idx;
  };
  ...
  UsbDeviceManager_GetDevices_ResponseParams.generate = function(generator_) {
    var generated = new UsbDeviceManager_GetDevices_ResponseParams;
  ...
  UsbDeviceManager_GetDevices_ResponseParams.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.results = mutator_.mutateArray(this.results, function(val) {
        return mutator_.mutateStruct(device.mojom.UsbDeviceInfo, false);
      });
    }
    return this;
  };
  UsbDeviceManager_GetDevices_ResponseParams.prototype.getHandleDeps = function() {
    var handles = [];
    return handles;
  };

  UsbDeviceManager_GetDevices_ResponseParams.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  UsbDeviceManager_GetDevices_ResponseParams.prototype.setHandlesInternal_ = function(handles, idx) {
    return idx;
  };
  ...
  UsbDeviceManager_GetDevice_Params.generate = function(generator_) {
    var generated = new UsbDeviceManager_GetDevice_Params;
    generated.guid = generator_.generateString(false);
    generated.deviceRequest = generator_.generateInterfaceRequest("device.mojom.UsbDevice", false);
    return generated;
  };

  UsbDeviceManager_GetDevice_Params.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.guid = mutator_.mutateString(this.guid, false);
    }
    if (mutator_.chooseMutateField()) {
      this.deviceRequest = mutator_.mutateInterfaceRequest(this.deviceRequest, "device.mojom.UsbDevice", false);
    }
    return this;
  };
  UsbDeviceManager_GetDevice_Params.prototype.getHandleDeps = function() {
    var handles = [];
  ...
  UsbDeviceManager_GetDevice_Params.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  UsbDeviceManager_GetDevice_Params.prototype.setHandlesInternal_ = function(handles, idx) {
  ...
  UsbDeviceManager_SetClient_Params.generate = function(generator_) {
    var generated = new UsbDeviceManager_SetClient_Params;
    generated.client = generator_.generateInterface("device.mojom.UsbDeviceManagerClient", false);
    return generated;
  };

  UsbDeviceManager_SetClient_Params.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.client = mutator_.mutateInterface(this.client, "device.mojom.UsbDeviceManagerClient", false);
    }
    return this;
  };
  UsbDeviceManager_SetClient_Params.prototype.getHandleDeps = function() {
    var handles = [];
    if (this.client !== null) {
  ...
  UsbDeviceManager_SetClient_Params.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  UsbDeviceManager_SetClient_Params.prototype.setHandlesInternal_ = function(handles, idx) {
  ...
  UsbDeviceManagerClient_OnDeviceAdded_Params.generate = function(generator_) {
    var generated = new UsbDeviceManagerClient_OnDeviceAdded_Params;
    generated.deviceInfo = generator_.generateStruct(device.mojom.UsbDeviceInfo, false);
    return generated;
  };

  UsbDeviceManagerClient_OnDeviceAdded_Params.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.deviceInfo = mutator_.mutateStruct(device.mojom.UsbDeviceInfo, false);
    }
    return this;
  };
  UsbDeviceManagerClient_OnDeviceAdded_Params.prototype.getHandleDeps = function() {
    var handles = [];
    return handles;
  };

  UsbDeviceManagerClient_OnDeviceAdded_Params.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  UsbDeviceManagerClient_OnDeviceAdded_Params.prototype.setHandlesInternal_ = function(handles, idx) {
    return idx;
  };
  ...
  UsbDeviceManagerClient_OnDeviceRemoved_Params.generate = function(generator_) {
    var generated = new UsbDeviceManagerClient_OnDeviceRemoved_Params;
    generated.deviceInfo = generator_.generateStruct(device.mojom.UsbDeviceInfo, false);
    return generated;
  };

  UsbDeviceManagerClient_OnDeviceRemoved_Params.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.deviceInfo = mutator_.mutateStruct(device.mojom.UsbDeviceInfo, false);
    }
    return this;
  };
  UsbDeviceManagerClient_OnDeviceRemoved_Params.prototype.getHandleDeps = function() {
    var handles = [];
    return handles;
  };

  UsbDeviceManagerClient_OnDeviceRemoved_Params.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  UsbDeviceManagerClient_OnDeviceRemoved_Params.prototype.setHandlesInternal_ = function(handles, idx) {
    return idx;
  };
  ...
  UsbDeviceManagerProxy.prototype.setClient = function(client) {
    ...
    builder.encodeStruct(UsbDeviceManager_SetClient_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  var UsbDeviceManager = {
    ...
    mojomId: 'device/usb/public/mojom/device_manager.mojom',
    fuzzMethods: {
      getDevices: {
        params: UsbDeviceManager_GetDevices_Params,
      },
      getDevice: {
        params: UsbDeviceManager_GetDevice_Params,
      },
      setClient: {
        params: UsbDeviceManager_SetClient_Params,
      },
    },
  };
  ...
  var UsbDeviceManagerClient = {
    ...
    fuzzMethods: {
      onDeviceAdded: {
        params: UsbDeviceManagerClient_OnDeviceAdded_Params,
      },
      onDeviceRemoved: {
        params: UsbDeviceManagerClient_OnDeviceRemoved_Params,
      },
    },
  };
