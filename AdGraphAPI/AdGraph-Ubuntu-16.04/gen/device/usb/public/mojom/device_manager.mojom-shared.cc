...
bool UsbDeviceFilter_Data::Validate(
  ...
  const UsbDeviceFilter_Data* object = static_cast<const UsbDeviceFilter_Data*>(data);
...
bool UsbEnumerationOptions_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const UsbEnumerationOptions_Data* object = static_cast<const UsbEnumerationOptions_Data*>(data);
...
bool UsbDeviceManager_GetDevices_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const UsbDeviceManager_GetDevices_Params_Data* object = static_cast<const UsbDeviceManager_GetDevices_Params_Data*>(data);
...
bool UsbDeviceManager_GetDevices_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const UsbDeviceManager_GetDevices_ResponseParams_Data* object = static_cast<const UsbDeviceManager_GetDevices_ResponseParams_Data*>(data);
...
bool UsbDeviceManager_GetDevice_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const UsbDeviceManager_GetDevice_Params_Data* object = static_cast<const UsbDeviceManager_GetDevice_Params_Data*>(data);
...
bool UsbDeviceManager_SetClient_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const UsbDeviceManager_SetClient_Params_Data* object = static_cast<const UsbDeviceManager_SetClient_Params_Data*>(data);
...
// static
bool UsbDeviceManagerClient_OnDeviceAdded_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const UsbDeviceManagerClient_OnDeviceAdded_Params_Data* object = static_cast<const UsbDeviceManagerClient_OnDeviceAdded_Params_Data*>(data);
...
// static
bool UsbDeviceManagerClient_OnDeviceRemoved_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const UsbDeviceManagerClient_OnDeviceRemoved_Params_Data* object = static_cast<const UsbDeviceManagerClient_OnDeviceRemoved_Params_Data*>(data);
