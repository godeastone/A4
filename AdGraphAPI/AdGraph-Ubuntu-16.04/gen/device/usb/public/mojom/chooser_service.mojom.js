...
(function() {
  ...
  UsbChooserService_GetPermission_Params.generate = function(generator_) {
    var generated = new UsbChooserService_GetPermission_Params;
  ...
  UsbChooserService_GetPermission_Params.prototype.mutate = function(mutator_) {
  ...
  UsbChooserService_GetPermission_Params.prototype.getHandleDeps = function() {
    var handles = [];
    return handles;
  };

  UsbChooserService_GetPermission_Params.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  UsbChooserService_GetPermission_Params.prototype.setHandlesInternal_ = function(handles, idx) {
    return idx;
  };
  ...
  UsbChooserService_GetPermission_ResponseParams.generate = function(generator_) {
    var generated = new UsbChooserService_GetPermission_ResponseParams;
    generated.result = generator_.generateStruct(device.mojom.UsbDeviceInfo, true);
    return generated;
  };

  UsbChooserService_GetPermission_ResponseParams.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.result = mutator_.mutateStruct(device.mojom.UsbDeviceInfo, true);
    }
    return this;
  };
  UsbChooserService_GetPermission_ResponseParams.prototype.getHandleDeps = function() {
    var handles = [];
    return handles;
  };

  UsbChooserService_GetPermission_ResponseParams.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  UsbChooserService_GetPermission_ResponseParams.prototype.setHandlesInternal_ = function(handles, idx) {
    return idx;
  };
  ...
  UsbChooserServiceProxy.prototype.getPermission = function(deviceFilters) {
    var params_ = new UsbChooserService_GetPermission_Params();
    ...
    return new Promise(function(resolve, reject) {
      ...
      builder.encodeStruct(UsbChooserService_GetPermission_Params, params_);
  ...
  var UsbChooserService = {
    ...
    mojomId: 'device/usb/public/mojom/chooser_service.mojom',
    fuzzMethods: {
      getPermission: {
        params: UsbChooserService_GetPermission_Params,
      },
    },
  };
