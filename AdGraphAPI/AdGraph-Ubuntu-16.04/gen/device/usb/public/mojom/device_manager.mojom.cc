...
void UsbDeviceManagerProxy::GetDevice(
    const std::string& in_guid, ::device::mojom::UsbDeviceRequest in_device_request) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void UsbDeviceManagerInterceptorForTesting::GetDevice(const std::string& guid, ::device::mojom::UsbDeviceRequest device_request) {
