...
class  GamepadObserver
 ...
 public:
  ...
  virtual void GamepadConnected(int32_t index, const device::Gamepad& gamepad) = 0;

  virtual void GamepadDisconnected(int32_t index, const device::Gamepad& gamepad) = 0;
};
class  GamepadObserverInterceptorForTesting : public GamepadObserver {
  virtual GamepadObserver* GetForwardingInterface() = 0;
  void GamepadConnected(int32_t index, const device::Gamepad& gamepad) override;
  void GamepadDisconnected(int32_t index, const device::Gamepad& gamepad) override;
};
...
class  GamepadObserverProxy
 ...
 public:
  ...
  void GamepadConnected(int32_t index, const device::Gamepad& gamepad) final;
  void GamepadDisconnected(int32_t index, const device::Gamepad& gamepad) final;
...
template <>
struct  StructTraits<::device::mojom::GamepadHapticActuator::DataView,
...
template <>
struct  StructTraits<::device::mojom::GamepadEffectParameters::DataView,
