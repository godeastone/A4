...
(function() {
  ...
  UUID.generate = function(generator_) {
    var generated = new UUID;
    generated.uuid = generator_.generateString(false);
    return generated;
  };

  UUID.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.uuid = mutator_.mutateString(this.uuid, false);
    }
    return this;
  };
  UUID.prototype.getHandleDeps = function() {
    var handles = [];
    return handles;
  };

  UUID.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  UUID.prototype.setHandlesInternal_ = function(handles, idx) {
    return idx;
  };
