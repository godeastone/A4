...
class CrxFileHeader : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:crx_file.CrxFileHeader) */ {
 public:
  ...
  inline CrxFileHeader* New() const PROTOBUF_FINAL { return New(NULL); }

  CrxFileHeader* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
...
class AsymmetricKeyProof : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:crx_file.AsymmetricKeyProof) */ {
 public:
  ...
  inline AsymmetricKeyProof* New() const PROTOBUF_FINAL { return New(NULL); }

  AsymmetricKeyProof* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
