...
class ExtensionSpecifics : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:sync_pb.ExtensionSpecifics) */ {
 public:
  ExtensionSpecifics();
  ...
  inline ExtensionSpecifics* New() const PROTOBUF_FINAL { return New(NULL); }

  ExtensionSpecifics* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  ...
  GOOGLE_PROTOBUF_DEPRECATED_ATTR bool has_all_urls_enabled() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void clear_all_urls_enabled();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR static const int kAllUrlsEnabledFieldNumber = 9;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR bool all_urls_enabled() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_all_urls_enabled(bool value);
 ...
 private:
  ...
  void set_has_incognito_enabled();
  void clear_has_incognito_enabled();
  void set_has_name();
  void clear_has_name();
  void set_has_remote_install();
  void clear_has_remote_install();
  void set_has_installed_by_custodian();
  void clear_has_installed_by_custodian();
  void set_has_all_urls_enabled();
  void clear_has_all_urls_enabled();
  void set_has_disable_reasons();
  void clear_has_disable_reasons();
  ...
  friend struct protobuf_extension_5fspecifics_2eproto::TableStruct;
};
// ===================================================================
