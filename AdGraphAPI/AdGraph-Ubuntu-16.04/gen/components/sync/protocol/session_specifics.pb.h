...
class SessionSpecifics : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:sync_pb.SessionSpecifics) */ {
 public:
  SessionSpecifics();
  ...
  inline SessionSpecifics* New() const PROTOBUF_FINAL { return New(NULL); }

  SessionSpecifics* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  void set_has_session_tag();
  void clear_has_session_tag();
  void set_has_header();
  void clear_has_header();
  void set_has_tab();
  void clear_has_tab();
  void set_has_tab_node_id();
  void clear_has_tab_node_id();
  ...
  friend struct protobuf_session_5fspecifics_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class SessionHeader : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:sync_pb.SessionHeader) */ {
 public:
  SessionHeader();
  ...
  inline SessionHeader* New() const PROTOBUF_FINAL { return New(NULL); }

  SessionHeader* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
...
class SessionWindow : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:sync_pb.SessionWindow) */ {
 public:
  SessionWindow();
  ...
  inline SessionWindow* New() const PROTOBUF_FINAL { return New(NULL); }

  SessionWindow* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
 ...
 private:
  ...
  void clear_has_window_id();
  void set_has_selected_tab_index();
  void clear_has_selected_tab_index();
...
class SessionTab : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:sync_pb.SessionTab) */ {
 public:
  SessionTab();
  virtual ~SessionTab();
  ...
  inline SessionTab* New() const PROTOBUF_FINAL { return New(NULL); }

  SessionTab* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
  ...
  GOOGLE_PROTOBUF_DEPRECATED_ATTR int variation_id_size() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void clear_variation_id();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR static const int kVariationIdFieldNumber = 12;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR ::google::protobuf::uint64 variation_id(int index) const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_variation_id(int index, ::google::protobuf::uint64 value);
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void add_variation_id(::google::protobuf::uint64 value);
  GOOGLE_PROTOBUF_DEPRECATED_ATTR const ::google::protobuf::RepeatedField< ::google::protobuf::uint64 >&
      variation_id() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR ::google::protobuf::RepeatedField< ::google::protobuf::uint64 >*
  ...
  GOOGLE_PROTOBUF_DEPRECATED_ATTR bool has_favicon() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void clear_favicon();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR static const int kFaviconFieldNumber = 8;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR const ::std::string& favicon() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_favicon(const ::std::string& value);
  #if LANG_CXX11
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_favicon(::std::string&& value);
  #endif
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_favicon(const char* value);
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_favicon(const void* value, size_t size);
  GOOGLE_PROTOBUF_DEPRECATED_ATTR ::std::string* mutable_favicon();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR ::std::string* release_favicon();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_allocated_favicon(::std::string* favicon);

  // optional string favicon_source = 11 [deprecated = true];
  GOOGLE_PROTOBUF_DEPRECATED_ATTR bool has_favicon_source() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void clear_favicon_source();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR static const int kFaviconSourceFieldNumber = 11;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR const ::std::string& favicon_source() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_favicon_source(const ::std::string& value);
  #if LANG_CXX11
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_favicon_source(::std::string&& value);
  #endif
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_favicon_source(const char* value);
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_favicon_source(const char* value, size_t size);
  GOOGLE_PROTOBUF_DEPRECATED_ATTR ::std::string* mutable_favicon_source();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR ::std::string* release_favicon_source();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_allocated_favicon_source(::std::string* favicon_source);
  ...
  GOOGLE_PROTOBUF_DEPRECATED_ATTR bool has_favicon_type() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void clear_favicon_type();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR static const int kFaviconTypeFieldNumber = 9;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR ::sync_pb::SessionTab_FaviconType favicon_type() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_favicon_type(::sync_pb::SessionTab_FaviconType value);
 ...
 private:
  ...
  void set_has_window_id();
  void clear_has_window_id();
  void set_has_tab_visual_index();
  void clear_has_tab_visual_index();
  void set_has_current_navigation_index();
  void clear_has_current_navigation_index();
  void set_has_pinned();
  void clear_has_pinned();
  void set_has_extension_app_id();
  void clear_has_extension_app_id();
  void set_has_favicon();
  void clear_has_favicon();
  void set_has_favicon_type();
  void clear_has_favicon_type();
  void set_has_favicon_source();
  void clear_has_favicon_source();
...
class TabNavigation : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:sync_pb.TabNavigation) */ {
 public:
  TabNavigation();
  ...
  inline TabNavigation* New() const PROTOBUF_FINAL { return New(NULL); }

  TabNavigation* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
  ...
  static const int kAncestorTaskIdFieldNumber = 28;
  ::google::protobuf::int64 ancestor_task_id(int index) const;
  void set_ancestor_task_id(int index, ::google::protobuf::int64 value);
  void add_ancestor_task_id(::google::protobuf::int64 value);
  ...
  GOOGLE_PROTOBUF_DEPRECATED_ATTR bool has_search_terms() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void clear_search_terms();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR static const int kSearchTermsFieldNumber = 16;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR const ::std::string& search_terms() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_search_terms(const ::std::string& value);
  #if LANG_CXX11
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_search_terms(::std::string&& value);
  #endif
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_search_terms(const char* value);
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_search_terms(const char* value, size_t size);
  GOOGLE_PROTOBUF_DEPRECATED_ATTR ::std::string* mutable_search_terms();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR ::std::string* release_search_terms();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_allocated_search_terms(::std::string* search_terms);
  ...
  static const int kReplacedNavigationFieldNumber = 29;
  ...
  GOOGLE_PROTOBUF_DEPRECATED_ATTR bool has_obsolete_referrer_policy() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void clear_obsolete_referrer_policy();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR static const int kObsoleteReferrerPolicyFieldNumber = 21;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR ::google::protobuf::int32 obsolete_referrer_policy() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_obsolete_referrer_policy(::google::protobuf::int32 value);

  // optional int64 task_id = 27;
  bool has_task_id() const;
  void clear_task_id();
  static const int kTaskIdFieldNumber = 27;
 ...
 private:
  void set_has_virtual_url();
  void clear_has_virtual_url();
  void set_has_referrer();
  void clear_has_referrer();
  void set_has_title();
  void clear_has_title();
  void set_has_page_transition();
  void clear_has_page_transition();
  ...
  void set_has_navigation_forward_back();
  void clear_has_navigation_forward_back();
  void set_has_navigation_from_address_bar();
  void clear_has_navigation_from_address_bar();
  void set_has_navigation_home_page();
  void clear_has_navigation_home_page();
  void set_has_navigation_chain_start();
  void clear_has_navigation_chain_start();
  void set_has_navigation_chain_end();
  void clear_has_navigation_chain_end();
  void set_has_global_id();
  void clear_has_global_id();
  void set_has_search_terms();
  void clear_has_search_terms();
  void set_has_favicon_url();
  void clear_has_favicon_url();
  void set_has_blocked_state();
  void clear_has_blocked_state();
  void set_has_http_status_code();
  void clear_has_http_status_code();
  void set_has_obsolete_referrer_policy();
  void clear_has_obsolete_referrer_policy();
  void set_has_is_restored();
  void clear_has_is_restored();
  void set_has_last_navigation_redirect_url();
  void clear_has_last_navigation_redirect_url();
  void set_has_correct_referrer_policy();
  void clear_has_correct_referrer_policy();
  void set_has_password_state();
  void clear_has_password_state();
  void set_has_task_id();
  void clear_has_task_id();
  void set_has_replaced_navigation();
  void clear_has_replaced_navigation();
  ...
  ::google::protobuf::RepeatedField< ::google::protobuf::int64 > ancestor_task_id_;
...
class NavigationRedirect : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:sync_pb.NavigationRedirect) */ {
 public:
  NavigationRedirect();
  ...
  inline NavigationRedirect* New() const PROTOBUF_FINAL { return New(NULL); }

  NavigationRedirect* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
...
class ReplacedNavigation : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:sync_pb.ReplacedNavigation) */ {
 public:
  ReplacedNavigation();
  ...
  GOOGLE_ATTRIBUTE_NOINLINE void Swap(ReplacedNavigation* other);

  // implements Message ----------------------------------------------

  inline ReplacedNavigation* New() const PROTOBUF_FINAL { return New(NULL); }

  ReplacedNavigation* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
  ...
  static const int kFirstCommittedUrlFieldNumber = 1;
  ...
  static const int kFirstTimestampMsecFieldNumber = 2;
  ::google::protobuf::int64 first_timestamp_msec() const;
  void set_first_timestamp_msec(::google::protobuf::int64 value);
  ...
  static const int kFirstPageTransitionFieldNumber = 3;
 ...
 private:
  void set_has_first_committed_url();
  void clear_has_first_committed_url();
  void set_has_first_timestamp_msec();
  void clear_has_first_timestamp_msec();
  void set_has_first_page_transition();
  void clear_has_first_page_transition();

  ::google::protobuf::internal::InternalMetadataWithArenaLite _internal_metadata_;
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable int _cached_size_;
  ::google::protobuf::internal::ArenaStringPtr first_committed_url_;
  ::google::protobuf::int64 first_timestamp_msec_;
...
inline void TabNavigation::set_has_task_id() {
  _has_bits_[0] |= 0x00080000u;
}
inline void TabNavigation::clear_has_task_id() {
  _has_bits_[0] &= ~0x00080000u;
}
...
inline ::google::protobuf::int64 TabNavigation::task_id() const {
  // @@protoc_insertion_point(field_get:sync_pb.TabNavigation.task_id)
  return task_id_;
}
inline void TabNavigation::set_task_id(::google::protobuf::int64 value) {
  set_has_task_id();
  task_id_ = value;
...
inline ::google::protobuf::int64 TabNavigation::ancestor_task_id(int index) const {
  // @@protoc_insertion_point(field_get:sync_pb.TabNavigation.ancestor_task_id)
  return ancestor_task_id_.Get(index);
}
inline void TabNavigation::set_ancestor_task_id(int index, ::google::protobuf::int64 value) {
  ancestor_task_id_.Set(index, value);
  // @@protoc_insertion_point(field_set:sync_pb.TabNavigation.ancestor_task_id)
}
inline void TabNavigation::add_ancestor_task_id(::google::protobuf::int64 value) {
...
inline void TabNavigation::set_has_replaced_navigation() {
  _has_bits_[0] |= 0x00000040u;
}
inline void TabNavigation::clear_has_replaced_navigation() {
  _has_bits_[0] &= ~0x00000040u;
}
...
inline void ReplacedNavigation::set_has_first_committed_url() {
  _has_bits_[0] |= 0x00000001u;
}
inline void ReplacedNavigation::clear_has_first_committed_url() {
  _has_bits_[0] &= ~0x00000001u;
}
...
inline void ReplacedNavigation::set_has_first_timestamp_msec() {
  _has_bits_[0] |= 0x00000002u;
}
inline void ReplacedNavigation::clear_has_first_timestamp_msec() {
  _has_bits_[0] &= ~0x00000002u;
}
...
inline ::google::protobuf::int64 ReplacedNavigation::first_timestamp_msec() const {
  // @@protoc_insertion_point(field_get:sync_pb.ReplacedNavigation.first_timestamp_msec)
  return first_timestamp_msec_;
}
inline void ReplacedNavigation::set_first_timestamp_msec(::google::protobuf::int64 value) {
...
inline void ReplacedNavigation::set_has_first_page_transition() {
  _has_bits_[0] |= 0x00000004u;
}
inline void ReplacedNavigation::clear_has_first_page_transition() {
  _has_bits_[0] &= ~0x00000004u;
}
