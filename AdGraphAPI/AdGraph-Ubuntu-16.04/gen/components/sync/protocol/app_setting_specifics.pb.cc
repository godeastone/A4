...
namespace sync_pb {
class AppSettingSpecificsDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<AppSettingSpecifics> {
...
void TableStruct::Shutdown() {
  _AppSettingSpecifics_default_instance_.Shutdown();
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _AppSettingSpecifics_default_instance_.DefaultConstruct();
  _AppSettingSpecifics_default_instance_.get_mutable()->extension_setting_ = const_cast< ::sync_pb::ExtensionSettingSpecifics*>(
...
AppSettingSpecifics::AppSettingSpecifics()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_app_5fsetting_5fspecifics_2eproto::InitDefaults();
  }
  SharedCtor();
