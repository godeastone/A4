...
class SearchEngineSpecifics : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:sync_pb.SearchEngineSpecifics) */ {
 public:
  ...
  inline SearchEngineSpecifics* New() const PROTOBUF_FINAL { return New(NULL); }

  SearchEngineSpecifics* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  ...
  GOOGLE_PROTOBUF_DEPRECATED_ATTR bool has_instant_url() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void clear_instant_url();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR static const int kInstantUrlFieldNumber = 15;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR const ::std::string& instant_url() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_instant_url(const ::std::string& value);
  #if LANG_CXX11
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_instant_url(::std::string&& value);
  #endif
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_instant_url(const char* value);
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_instant_url(const char* value, size_t size);
  GOOGLE_PROTOBUF_DEPRECATED_ATTR ::std::string* mutable_instant_url();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR ::std::string* release_instant_url();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_allocated_instant_url(::std::string* instant_url);
  ...
  GOOGLE_PROTOBUF_DEPRECATED_ATTR bool has_search_terms_replacement_key() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void clear_search_terms_replacement_key();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR static const int kSearchTermsReplacementKeyFieldNumber = 20;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR const ::std::string& search_terms_replacement_key() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_search_terms_replacement_key(const ::std::string& value);
  #if LANG_CXX11
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_search_terms_replacement_key(::std::string&& value);
  #endif
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_search_terms_replacement_key(const char* value);
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_search_terms_replacement_key(const char* value, size_t size);
  GOOGLE_PROTOBUF_DEPRECATED_ATTR ::std::string* mutable_search_terms_replacement_key();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR ::std::string* release_search_terms_replacement_key();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_allocated_search_terms_replacement_key(::std::string* search_terms_replacement_key);
  ...
  GOOGLE_PROTOBUF_DEPRECATED_ATTR bool has_instant_url_post_params() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void clear_instant_url_post_params();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR static const int kInstantUrlPostParamsFieldNumber = 24;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR const ::std::string& instant_url_post_params() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_instant_url_post_params(const ::std::string& value);
  #if LANG_CXX11
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_instant_url_post_params(::std::string&& value);
  #endif
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_instant_url_post_params(const char* value);
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_instant_url_post_params(const char* value, size_t size);
  GOOGLE_PROTOBUF_DEPRECATED_ATTR ::std::string* mutable_instant_url_post_params();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR ::std::string* release_instant_url_post_params();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_allocated_instant_url_post_params(::std::string* instant_url_post_params);
  ...
  GOOGLE_PROTOBUF_DEPRECATED_ATTR bool has_deprecated_show_in_default_list() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void clear_deprecated_show_in_default_list();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR static const int kDeprecatedShowInDefaultListFieldNumber = 9;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR bool deprecated_show_in_default_list() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_deprecated_show_in_default_list(bool value);
 ...
 private:
  ...
  void set_has_url();
  void clear_has_url();
  void set_has_safe_for_autoreplace();
  void clear_has_safe_for_autoreplace();
  void set_has_originating_url();
  void clear_has_originating_url();
  void set_has_date_created();
  void clear_has_date_created();
  void set_has_input_encodings();
  void clear_has_input_encodings();
  void set_has_deprecated_show_in_default_list();
  void clear_has_deprecated_show_in_default_list();
  void set_has_suggestions_url();
  void clear_has_suggestions_url();
  void set_has_prepopulate_id();
  void clear_has_prepopulate_id();
  void set_has_autogenerate_keyword();
  void clear_has_autogenerate_keyword();
  void set_has_instant_url();
  void clear_has_instant_url();
  void set_has_last_modified();
  void clear_has_last_modified();
  void set_has_sync_guid();
  void clear_has_sync_guid();
  void set_has_search_terms_replacement_key();
  void clear_has_search_terms_replacement_key();
  void set_has_image_url();
  void clear_has_image_url();
  void set_has_search_url_post_params();
  void clear_has_search_url_post_params();
  void set_has_suggestions_url_post_params();
  void clear_has_suggestions_url_post_params();
  void set_has_instant_url_post_params();
  void clear_has_instant_url_post_params();
  void set_has_image_url_post_params();
  void clear_has_image_url_post_params();
  void set_has_new_tab_url();
  void clear_has_new_tab_url();
  ...
  friend struct protobuf_search_5fengine_5fspecifics_2eproto::TableStruct;
};
// ===================================================================
