...
class HistoryDeleteDirectiveSpecifics : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:sync_pb.HistoryDeleteDirectiveSpecifics) */ {
 public:
  ...
  inline HistoryDeleteDirectiveSpecifics* New() const PROTOBUF_FINAL { return New(NULL); }

  HistoryDeleteDirectiveSpecifics* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  void set_has_global_id_directive();
  void clear_has_global_id_directive();
  void set_has_time_range_directive();
  void clear_has_time_range_directive();
  ...
  friend struct protobuf_history_5fdelete_5fdirective_5fspecifics_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class GlobalIdDirective : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:sync_pb.GlobalIdDirective) */ {
 public:
  GlobalIdDirective();
  ...
  inline GlobalIdDirective* New() const PROTOBUF_FINAL { return New(NULL); }

  GlobalIdDirective* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
 ...
 private:
  void set_has_start_time_usec();
  void clear_has_start_time_usec();
  void set_has_end_time_usec();
  void clear_has_end_time_usec();
...
class TimeRangeDirective : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:sync_pb.TimeRangeDirective) */ {
 public:
  TimeRangeDirective();
  ...
  inline TimeRangeDirective* New() const PROTOBUF_FINAL { return New(NULL); }

  TimeRangeDirective* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
