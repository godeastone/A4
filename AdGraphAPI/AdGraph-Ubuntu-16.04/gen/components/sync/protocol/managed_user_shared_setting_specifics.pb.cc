...
namespace sync_pb {
class ManagedUserSharedSettingSpecificsDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<ManagedUserSharedSettingSpecifics> {
...
void TableStruct::Shutdown() {
  _ManagedUserSharedSettingSpecifics_default_instance_.Shutdown();
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _ManagedUserSharedSettingSpecifics_default_instance_.DefaultConstruct();
}
...
ManagedUserSharedSettingSpecifics::ManagedUserSharedSettingSpecifics()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_managed_5fuser_5fshared_5fsetting_5fspecifics_2eproto::InitDefaults();
  }
  SharedCtor();
...
// @@protoc_insertion_point(message_clear_start:sync_pb.ManagedUserSharedSettingSpecifics)
  if (_has_bits_[0 / 32] & 7u) {
    if (has_mu_id()) {
      GOOGLE_DCHECK(!mu_id_.IsDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited()));
      (*mu_id_.UnsafeRawStringPointer())->clear();
    }
    if (has_key()) {
...
#if LANG_CXX11
void ManagedUserSharedSettingSpecifics::set_mu_id(::std::string&& value) {
  set_has_mu_id();
  mu_id_.SetNoArena(
...
#if LANG_CXX11
void ManagedUserSharedSettingSpecifics::set_key(::std::string&& value) {
  set_has_key();
  key_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
#if LANG_CXX11
void ManagedUserSharedSettingSpecifics::set_value(::std::string&& value) {
  set_has_value();
  value_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
