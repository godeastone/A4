...
class NigoriKey : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:sync_pb.NigoriKey) */ {
 public:
  NigoriKey();
  virtual ~NigoriKey();
  ...
  inline NigoriKey* New() const PROTOBUF_FINAL { return New(NULL); }

  NigoriKey* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  ...
  GOOGLE_PROTOBUF_DEPRECATED_ATTR bool has_user_key() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void clear_user_key();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR static const int kUserKeyFieldNumber = 2;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR const ::std::string& user_key() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_user_key(const ::std::string& value);
  #if LANG_CXX11
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_user_key(::std::string&& value);
  #endif
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_user_key(const char* value);
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_user_key(const void* value, size_t size);
  GOOGLE_PROTOBUF_DEPRECATED_ATTR ::std::string* mutable_user_key();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR ::std::string* release_user_key();
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_allocated_user_key(::std::string* user_key);
 ...
 private:
  ...
  friend struct protobuf_nigori_5fspecifics_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class NigoriKeyBag : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:sync_pb.NigoriKeyBag) */ {
 public:
  NigoriKeyBag();
  ...
  inline NigoriKeyBag* New() const PROTOBUF_FINAL { return New(NULL); }

  NigoriKeyBag* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
...
class NigoriSpecifics : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:sync_pb.NigoriSpecifics) */ {
 public:
  NigoriSpecifics();
  ...
  inline NigoriSpecifics* New() const PROTOBUF_FINAL { return New(NULL); }

  NigoriSpecifics* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
  ...
  bool has_encrypt_mountain_shares() const;
  void clear_encrypt_mountain_shares();
  static const int kEncryptMountainSharesFieldNumber = 44;
  bool encrypt_mountain_shares() const;
  void set_encrypt_mountain_shares(bool value);
 ...
 private:
  void set_has_encryption_keybag();
  void clear_has_encryption_keybag();
  void set_has_keybag_is_frozen();
  void clear_has_keybag_is_frozen();
  void set_has_encrypt_bookmarks();
  void clear_has_encrypt_bookmarks();
  void set_has_encrypt_preferences();
  void clear_has_encrypt_preferences();
  void set_has_encrypt_autofill_profile();
  void clear_has_encrypt_autofill_profile();
  void set_has_encrypt_autofill();
  void clear_has_encrypt_autofill();
  void set_has_encrypt_themes();
  void clear_has_encrypt_themes();
  void set_has_encrypt_typed_urls();
  void clear_has_encrypt_typed_urls();
  void set_has_encrypt_extensions();
  void clear_has_encrypt_extensions();
  void set_has_encrypt_sessions();
  void clear_has_encrypt_sessions();
  void set_has_encrypt_apps();
  void clear_has_encrypt_apps();
  void set_has_encrypt_search_engines();
  void clear_has_encrypt_search_engines();
  void set_has_encrypt_everything();
  void clear_has_encrypt_everything();
  void set_has_encrypt_extension_settings();
  void clear_has_encrypt_extension_settings();
  void set_has_encrypt_app_notifications();
  void clear_has_encrypt_app_notifications();
  void set_has_encrypt_app_settings();
  void clear_has_encrypt_app_settings();
  void set_has_sync_tab_favicons();
  void clear_has_sync_tab_favicons();
  void set_has_passphrase_type();
  void clear_has_passphrase_type();
  void set_has_keystore_decryptor_token();
  void clear_has_keystore_decryptor_token();
  void set_has_keystore_migration_time();
  void clear_has_keystore_migration_time();
  void set_has_custom_passphrase_time();
  void clear_has_custom_passphrase_time();
  void set_has_encrypt_dictionary();
  void clear_has_encrypt_dictionary();
  void set_has_encrypt_favicon_images();
  void clear_has_encrypt_favicon_images();
  void set_has_encrypt_favicon_tracking();
  void clear_has_encrypt_favicon_tracking();
  void set_has_encrypt_articles();
  void clear_has_encrypt_articles();
  void set_has_encrypt_app_list();
  void clear_has_encrypt_app_list();
  void set_has_encrypt_autofill_wallet_metadata();
  void clear_has_encrypt_autofill_wallet_metadata();
  void set_has_server_only_was_missing_keystore_migration_time();
  void clear_has_server_only_was_missing_keystore_migration_time();
  void set_has_encrypt_arc_package();
  void clear_has_encrypt_arc_package();
  void set_has_encrypt_printers();
  void clear_has_encrypt_printers();
  void set_has_encrypt_reading_list();
  void clear_has_encrypt_reading_list();
  void set_has_encrypt_mountain_shares();
  void clear_has_encrypt_mountain_shares();
...
#if LANG_CXX11
inline void NigoriKey::set_name(::std::string&& value) {
  set_has_name();
  name_.SetNoArena(
...
#if LANG_CXX11
inline void NigoriKey::set_user_key(::std::string&& value) {
  set_has_user_key();
...
// optional bool encrypt_mountain_shares = 44;
inline bool NigoriSpecifics::has_encrypt_mountain_shares() const {
  return (_has_bits_[0] & 0x00400000u) != 0;
}
inline void NigoriSpecifics::set_has_encrypt_mountain_shares() {
  _has_bits_[0] |= 0x00400000u;
}
inline void NigoriSpecifics::clear_has_encrypt_mountain_shares() {
  _has_bits_[0] &= ~0x00400000u;
}
inline void NigoriSpecifics::clear_encrypt_mountain_shares() {
  encrypt_mountain_shares_ = false;
  clear_has_encrypt_mountain_shares();
}
inline bool NigoriSpecifics::encrypt_mountain_shares() const {
  // @@protoc_insertion_point(field_get:sync_pb.NigoriSpecifics.encrypt_mountain_shares)
  return encrypt_mountain_shares_;
}
inline void NigoriSpecifics::set_encrypt_mountain_shares(bool value) {
