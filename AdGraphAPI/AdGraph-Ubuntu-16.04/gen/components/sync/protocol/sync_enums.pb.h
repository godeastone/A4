...
const SyncEnums_DeviceType SyncEnums_DeviceType_DeviceType_MIN = SyncEnums_DeviceType_TYPE_UNSET;
...
class SyncEnums : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:sync_pb.SyncEnums) */ {
 public:
  SyncEnums();
  virtual ~SyncEnums();
  ...
  inline SyncEnums* New() const PROTOBUF_FINAL { return New(NULL); }

  SyncEnums* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  ...
  static const DeviceType TYPE_UNSET =
 ...
 private:
  ...
  friend struct protobuf_sync_5fenums_2eproto::TableStruct;
};
// ===================================================================
