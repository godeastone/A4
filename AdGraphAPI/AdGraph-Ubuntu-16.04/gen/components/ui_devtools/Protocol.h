...
#ifndef ui_devtools_protocol_Collections_h
...
#endif // !defined(ui_devtools_protocol_Collections_h)
...
#ifndef ui_devtools_protocol_ErrorSupport_h
#define ui_devtools_protocol_ErrorSupport_h
...
class UI_DEVTOOLS_EXPORT ErrorSupport {
public:
    ErrorSupport();
    ~ErrorSupport();
...
#endif // !defined(ui_devtools_protocol_ErrorSupport_h)
...
#ifndef ui_devtools_protocol_Values_h
#define ui_devtools_protocol_Values_h
...
class UI_DEVTOOLS_EXPORT FundamentalValue : public Value {
public:
...
class UI_DEVTOOLS_EXPORT StringValue : public Value {
public:
...
class UI_DEVTOOLS_EXPORT SerializedValue : public Value {
public:
...
class UI_DEVTOOLS_EXPORT DictionaryValue : public Value {
public:
...
class UI_DEVTOOLS_EXPORT ListValue : public Value {
public:
...
#endif // ui_devtools_protocol_Values_h
...
#ifndef ui_devtools_protocol_Object_h
#define ui_devtools_protocol_Object_h
...
class UI_DEVTOOLS_EXPORT Object {
public:
...
#endif // !defined(ui_devtools_protocol_Object_h)
...
#ifndef ui_devtools_protocol_ValueConversions_h
#define ui_devtools_protocol_ValueConversions_h
...
#endif // !defined(ui_devtools_protocol_ValueConversions_h)
...
#ifndef ui_devtools_protocol_Maybe_h
#define ui_devtools_protocol_Maybe_h
...
#endif // !defined(ui_devtools_protocol_Maybe_h)
...
#ifndef ui_devtools_protocol_Array_h
#define ui_devtools_protocol_Array_h
...
#endif // !defined(ui_devtools_protocol_Array_h)
...
#ifndef ui_devtools_protocol_DispatcherBase_h
#define ui_devtools_protocol_DispatcherBase_h
...
class UI_DEVTOOLS_EXPORT DispatchResponse {
public:
    enum Status {
        kSuccess = 0,
        kError = 1,
...
class UI_DEVTOOLS_EXPORT DispatcherBase {
    PROTOCOL_DISALLOW_COPY(DispatcherBase);
public:
    static const char kInvalidParamsString[];
    class UI_DEVTOOLS_EXPORT WeakPtr {
    public:
    ...
    class UI_DEVTOOLS_EXPORT Callback {
    public:
...
class UI_DEVTOOLS_EXPORT UberDispatcher {
...
#endif // !defined(ui_devtools_protocol_DispatcherBase_h)
...
#ifndef ui_devtools_protocol_Parser_h
#define ui_devtools_protocol_Parser_h
...
UI_DEVTOOLS_EXPORT std::unique_ptr<Value> parseJSONCharacters(const uint8_t*, unsigned);
UI_DEVTOOLS_EXPORT std::unique_ptr<Value> parseJSONCharacters(const uint16_t*, unsigned);

} // namespace ui_devtools
} // namespace protocol

#endif // !defined(ui_devtools_protocol_Parser_h)
