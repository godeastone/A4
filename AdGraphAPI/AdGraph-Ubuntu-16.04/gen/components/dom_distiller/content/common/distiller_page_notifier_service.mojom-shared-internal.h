...
class  DistillerPageNotifierService_NotifyIsDistillerPage_Params_Data {
  ...
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      ...
      index_ = serialization_buffer_->Allocate(sizeof(DistillerPageNotifierService_NotifyIsDistillerPage_Params_Data));
      new (data()) DistillerPageNotifierService_NotifyIsDistillerPage_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    DistillerPageNotifierService_NotifyIsDistillerPage_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<DistillerPageNotifierService_NotifyIsDistillerPage_Params_Data>(index_);
    }
    DistillerPageNotifierService_NotifyIsDistillerPage_Params_Data* operator->() { return data(); }
 ...
 private:
  DistillerPageNotifierService_NotifyIsDistillerPage_Params_Data();
