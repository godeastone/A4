...
#include "components/dom_distiller/content/common/distiller_javascript_service.mojom-shared-message-ids.h"
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)dom_distiller::mojom::DistillerJavaScriptService::HandleDistillerOpenSettingsCall",
...
bool DistillerJavaScriptServiceRequestValidator::Accept(mojo::Message* message) {
  ...
  mojo::internal::ValidationContext validation_context(
    ...
    "DistillerJavaScriptService RequestValidator");
