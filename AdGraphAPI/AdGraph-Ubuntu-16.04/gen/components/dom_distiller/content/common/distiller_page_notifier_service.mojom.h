...
using ThreadSafeDistillerPageNotifierServicePtr =
    mojo::ThreadSafeInterfacePtr<DistillerPageNotifierService>;
...
using ThreadSafeDistillerPageNotifierServiceAssociatedPtr =
    mojo::ThreadSafeAssociatedInterfacePtr<DistillerPageNotifierService>;
...
class  DistillerPageNotifierService
    : public DistillerPageNotifierServiceInterfaceBase {
 public:
  ...
  template <typename ImplRefTraits>
  using Stub_ = DistillerPageNotifierServiceStub<ImplRefTraits>;

  using RequestValidator_ = DistillerPageNotifierServiceRequestValidator;
  using ResponseValidator_ = mojo::PassThroughFilter;
  enum MethodMinVersions : uint32_t {
    kNotifyIsDistillerPageMinVersion = 0,
  };
  virtual ~DistillerPageNotifierService() {}

  virtual void NotifyIsDistillerPage() = 0;
};
class  DistillerPageNotifierServiceInterceptorForTesting : public DistillerPageNotifierService {
  virtual DistillerPageNotifierService* GetForwardingInterface() = 0;
  void NotifyIsDistillerPage() override;
};
class  DistillerPageNotifierServiceAsyncWaiter {
 public:
  explicit DistillerPageNotifierServiceAsyncWaiter(DistillerPageNotifierService* proxy);
  ~DistillerPageNotifierServiceAsyncWaiter();

 private:
  DistillerPageNotifierService* const proxy_;

  DISALLOW_COPY_AND_ASSIGN(DistillerPageNotifierServiceAsyncWaiter);
};
...
class  DistillerPageNotifierServiceProxy
 ...
 public:
  ...
  void NotifyIsDistillerPage() final;

 private:
  mojo::MessageReceiverWithResponder* receiver_;
};
class  DistillerPageNotifierServiceStubDispatch {
 public:
  static bool Accept(DistillerPageNotifierService* impl, mojo::Message* message);
...
template <typename ImplRefTraits =
              mojo::RawPtrImplRefTraits<DistillerPageNotifierService>>
class DistillerPageNotifierServiceStub
 ...
 public:
  ...
  bool Accept(mojo::Message* message) override {
    if (ImplRefTraits::IsNull(sink_))
      return false;
    return DistillerPageNotifierServiceStubDispatch::Accept(
  ...
  bool AcceptWithResponder(
    ...
    if (ImplRefTraits::IsNull(sink_))
      return false;
    return DistillerPageNotifierServiceStubDispatch::AcceptWithResponder(
...
class  DistillerPageNotifierServiceRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
