...
// static
bool SafeBrowsingUrlChecker_CheckUrl_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const SafeBrowsingUrlChecker_CheckUrl_Params_Data* object = static_cast<const SafeBrowsingUrlChecker_CheckUrl_Params_Data*>(data);
...
// static
bool SafeBrowsingUrlChecker_CheckUrl_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const SafeBrowsingUrlChecker_CheckUrl_ResponseParams_Data* object = static_cast<const SafeBrowsingUrlChecker_CheckUrl_ResponseParams_Data*>(data);
...
// static
bool UrlCheckNotifier_OnCompleteCheck_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const UrlCheckNotifier_OnCompleteCheck_Params_Data* object = static_cast<const UrlCheckNotifier_OnCompleteCheck_Params_Data*>(data);
...
UrlCheckNotifier_OnCompleteCheck_Params_Data::UrlCheckNotifier_OnCompleteCheck_Params_Data()
    : header_({sizeof(*this), 0}) {}
...
bool PhishingDetector_StartPhishingDetection_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const PhishingDetector_StartPhishingDetection_Params_Data* object = static_cast<const PhishingDetector_StartPhishingDetection_Params_Data*>(data);
...
// static
bool PhishingDetectorClient_PhishingDetectionDone_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const PhishingDetectorClient_PhishingDetectionDone_Params_Data* object = static_cast<const PhishingDetectorClient_PhishingDetectionDone_Params_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->request_proto, 1, validation_context)) {
    return false;
  }
...
PhishingDetectorClient_PhishingDetectionDone_Params_Data::PhishingDetectorClient_PhishingDetectionDone_Params_Data()
    : header_({sizeof(*this), 0}) {}
