...
class MalwarePatternType : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:safe_browsing.MalwarePatternType) */ {
 public:
  MalwarePatternType();
  ...
  inline MalwarePatternType* New() const PROTOBUF_FINAL { return New(NULL); }

  MalwarePatternType* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  void set_has_pattern_type();
  void clear_has_pattern_type();
...
class SocialEngineeringPatternType : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:safe_browsing.SocialEngineeringPatternType) */ {
 public:
  ...
  inline SocialEngineeringPatternType* New() const PROTOBUF_FINAL { return New(NULL); }

  SocialEngineeringPatternType* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
