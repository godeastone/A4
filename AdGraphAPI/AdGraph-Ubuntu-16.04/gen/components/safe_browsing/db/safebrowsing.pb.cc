...
class ThreatInfoDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<ThreatInfo> {
} _ThreatInfo_default_instance_;
class ThreatMatchDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<ThreatMatch> {
} _ThreatMatch_default_instance_;
class FindThreatMatchesRequestDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<FindThreatMatchesRequest> {
} _FindThreatMatchesRequest_default_instance_;
class FindThreatMatchesResponseDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<FindThreatMatchesResponse> {
} _FindThreatMatchesResponse_default_instance_;
class FetchThreatListUpdatesRequest_ListUpdateRequest_ConstraintsDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<FetchThreatListUpdatesRequest_ListUpdateRequest_Constraints> {
} _FetchThreatListUpdatesRequest_ListUpdateRequest_Constraints_default_instance_;
class FetchThreatListUpdatesRequest_ListUpdateRequestDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<FetchThreatListUpdatesRequest_ListUpdateRequest> {
} _FetchThreatListUpdatesRequest_ListUpdateRequest_default_instance_;
class FetchThreatListUpdatesRequestDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<FetchThreatListUpdatesRequest> {
} _FetchThreatListUpdatesRequest_default_instance_;
class FetchThreatListUpdatesResponse_ListUpdateResponseDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<FetchThreatListUpdatesResponse_ListUpdateResponse> {
} _FetchThreatListUpdatesResponse_ListUpdateResponse_default_instance_;
class FetchThreatListUpdatesResponseDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<FetchThreatListUpdatesResponse> {
} _FetchThreatListUpdatesResponse_default_instance_;
class FindFullHashesRequestDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<FindFullHashesRequest> {
} _FindFullHashesRequest_default_instance_;
class FindFullHashesResponseDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<FindFullHashesResponse> {
} _FindFullHashesResponse_default_instance_;
class ThreatHit_ThreatSourceDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<ThreatHit_ThreatSource> {
} _ThreatHit_ThreatSource_default_instance_;
class ThreatHitDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<ThreatHit> {
...
class ChromeClientInfoDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<ChromeClientInfo> {
} _ChromeClientInfo_default_instance_;
class ChecksumDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<Checksum> {
} _Checksum_default_instance_;
class ThreatEntryDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<ThreatEntry> {
} _ThreatEntry_default_instance_;
class ThreatEntrySetDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<ThreatEntrySet> {
} _ThreatEntrySet_default_instance_;
class RawIndicesDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<RawIndices> {
} _RawIndices_default_instance_;
class RawHashesDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<RawHashes> {
} _RawHashes_default_instance_;
class RiceDeltaEncodingDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<RiceDeltaEncoding> {
} _RiceDeltaEncoding_default_instance_;
class ThreatEntryMetadata_MetadataEntryDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<ThreatEntryMetadata_MetadataEntry> {
} _ThreatEntryMetadata_MetadataEntry_default_instance_;
class ThreatEntryMetadataDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<ThreatEntryMetadata> {
} _ThreatEntryMetadata_default_instance_;
class ThreatListDescriptorDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<ThreatListDescriptor> {
} _ThreatListDescriptor_default_instance_;
class ListThreatListsResponseDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<ListThreatListsResponse> {
...
void TableStruct::Shutdown() {
  _ThreatInfo_default_instance_.Shutdown();
  _ThreatMatch_default_instance_.Shutdown();
  _FindThreatMatchesRequest_default_instance_.Shutdown();
  _FindThreatMatchesResponse_default_instance_.Shutdown();
  _FetchThreatListUpdatesRequest_ListUpdateRequest_Constraints_default_instance_.Shutdown();
  _FetchThreatListUpdatesRequest_ListUpdateRequest_default_instance_.Shutdown();
  _FetchThreatListUpdatesRequest_default_instance_.Shutdown();
  _FetchThreatListUpdatesResponse_ListUpdateResponse_default_instance_.Shutdown();
  _FetchThreatListUpdatesResponse_default_instance_.Shutdown();
  _FindFullHashesRequest_default_instance_.Shutdown();
  _FindFullHashesResponse_default_instance_.Shutdown();
  _ThreatHit_ThreatSource_default_instance_.Shutdown();
  _ThreatHit_default_instance_.Shutdown();
  _ClientInfo_default_instance_.Shutdown();
  _ChromeClientInfo_default_instance_.Shutdown();
  _Checksum_default_instance_.Shutdown();
  _ThreatEntry_default_instance_.Shutdown();
  _ThreatEntrySet_default_instance_.Shutdown();
  _RawIndices_default_instance_.Shutdown();
  _RawHashes_default_instance_.Shutdown();
  _RiceDeltaEncoding_default_instance_.Shutdown();
  _ThreatEntryMetadata_MetadataEntry_default_instance_.Shutdown();
  _ThreatEntryMetadata_default_instance_.Shutdown();
  _ThreatListDescriptor_default_instance_.Shutdown();
  _ListThreatListsResponse_default_instance_.Shutdown();
...
void TableStruct::InitDefaultsImpl() {
  ...
  _ThreatInfo_default_instance_.DefaultConstruct();
  _ThreatMatch_default_instance_.DefaultConstruct();
  _FindThreatMatchesRequest_default_instance_.DefaultConstruct();
  _FindThreatMatchesResponse_default_instance_.DefaultConstruct();
  _FetchThreatListUpdatesRequest_ListUpdateRequest_Constraints_default_instance_.DefaultConstruct();
  _FetchThreatListUpdatesRequest_ListUpdateRequest_default_instance_.DefaultConstruct();
  _FetchThreatListUpdatesRequest_default_instance_.DefaultConstruct();
  _FetchThreatListUpdatesResponse_ListUpdateResponse_default_instance_.DefaultConstruct();
  _FetchThreatListUpdatesResponse_default_instance_.DefaultConstruct();
  _FindFullHashesRequest_default_instance_.DefaultConstruct();
  _FindFullHashesResponse_default_instance_.DefaultConstruct();
  _ThreatHit_ThreatSource_default_instance_.DefaultConstruct();
  _ThreatHit_default_instance_.DefaultConstruct();
  _ClientInfo_default_instance_.DefaultConstruct();
  _ChromeClientInfo_default_instance_.DefaultConstruct();
  _Checksum_default_instance_.DefaultConstruct();
  _ThreatEntry_default_instance_.DefaultConstruct();
  _ThreatEntrySet_default_instance_.DefaultConstruct();
  _RawIndices_default_instance_.DefaultConstruct();
  _RawHashes_default_instance_.DefaultConstruct();
  _RiceDeltaEncoding_default_instance_.DefaultConstruct();
  _ThreatEntryMetadata_MetadataEntry_default_instance_.DefaultConstruct();
  _ThreatEntryMetadata_default_instance_.DefaultConstruct();
  _ThreatListDescriptor_default_instance_.DefaultConstruct();
  _ListThreatListsResponse_default_instance_.DefaultConstruct();
  _Duration_default_instance_.DefaultConstruct();
  _ThreatMatch_default_instance_.get_mutable()->threat_ = const_cast< ::safe_browsing::ThreatEntry*>(
      ::safe_browsing::ThreatEntry::internal_default_instance());
  _ThreatMatch_default_instance_.get_mutable()->threat_entry_metadata_ = const_cast< ::safe_browsing::ThreatEntryMetadata*>(
      ::safe_browsing::ThreatEntryMetadata::internal_default_instance());
  _ThreatMatch_default_instance_.get_mutable()->cache_duration_ = const_cast< ::safe_browsing::Duration*>(
      ::safe_browsing::Duration::internal_default_instance());
  _FindThreatMatchesRequest_default_instance_.get_mutable()->client_ = const_cast< ::safe_browsing::ClientInfo*>(
      ::safe_browsing::ClientInfo::internal_default_instance());
  _FindThreatMatchesRequest_default_instance_.get_mutable()->threat_info_ = const_cast< ::safe_browsing::ThreatInfo*>(
      ::safe_browsing::ThreatInfo::internal_default_instance());
  _FetchThreatListUpdatesRequest_ListUpdateRequest_default_instance_.get_mutable()->constraints_ = const_cast< ::safe_browsing::FetchThreatListUpdatesRequest_ListUpdateRequest_Constraints*>(
      ::safe_browsing::FetchThreatListUpdatesRequest_ListUpdateRequest_Constraints::internal_default_instance());
  _FetchThreatListUpdatesRequest_default_instance_.get_mutable()->client_ = const_cast< ::safe_browsing::ClientInfo*>(
      ::safe_browsing::ClientInfo::internal_default_instance());
  _FetchThreatListUpdatesRequest_default_instance_.get_mutable()->chrome_client_info_ = const_cast< ::safe_browsing::ChromeClientInfo*>(
      ::safe_browsing::ChromeClientInfo::internal_default_instance());
  _FetchThreatListUpdatesResponse_ListUpdateResponse_default_instance_.get_mutable()->checksum_ = const_cast< ::safe_browsing::Checksum*>(
      ::safe_browsing::Checksum::internal_default_instance());
  _FetchThreatListUpdatesResponse_default_instance_.get_mutable()->minimum_wait_duration_ = const_cast< ::safe_browsing::Duration*>(
      ::safe_browsing::Duration::internal_default_instance());
  _FindFullHashesRequest_default_instance_.get_mutable()->client_ = const_cast< ::safe_browsing::ClientInfo*>(
      ::safe_browsing::ClientInfo::internal_default_instance());
  _FindFullHashesRequest_default_instance_.get_mutable()->threat_info_ = const_cast< ::safe_browsing::ThreatInfo*>(
      ::safe_browsing::ThreatInfo::internal_default_instance());
  _FindFullHashesResponse_default_instance_.get_mutable()->minimum_wait_duration_ = const_cast< ::safe_browsing::Duration*>(
      ::safe_browsing::Duration::internal_default_instance());
  _FindFullHashesResponse_default_instance_.get_mutable()->negative_cache_duration_ = const_cast< ::safe_browsing::Duration*>(
      ::safe_browsing::Duration::internal_default_instance());
  _ThreatHit_default_instance_.get_mutable()->entry_ = const_cast< ::safe_browsing::ThreatEntry*>(
      ::safe_browsing::ThreatEntry::internal_default_instance());
  _ThreatEntrySet_default_instance_.get_mutable()->raw_hashes_ = const_cast< ::safe_browsing::RawHashes*>(
      ::safe_browsing::RawHashes::internal_default_instance());
  _ThreatEntrySet_default_instance_.get_mutable()->raw_indices_ = const_cast< ::safe_browsing::RawIndices*>(
      ::safe_browsing::RawIndices::internal_default_instance());
  _ThreatEntrySet_default_instance_.get_mutable()->rice_hashes_ = const_cast< ::safe_browsing::RiceDeltaEncoding*>(
      ::safe_browsing::RiceDeltaEncoding::internal_default_instance());
  _ThreatEntrySet_default_instance_.get_mutable()->rice_indices_ = const_cast< ::safe_browsing::RiceDeltaEncoding*>(
      ::safe_browsing::RiceDeltaEncoding::internal_default_instance());
}
...
const ::safe_browsing::Duration& ThreatMatch::cache_duration() const {
  ...
  return cache_duration_ != NULL ? *cache_duration_
                         : *::safe_browsing::Duration::internal_default_instance();
}
...
const ::safe_browsing::ThreatInfo& FindThreatMatchesRequest::threat_info() const {
  ...
  return threat_info_ != NULL ? *threat_info_
                         : *::safe_browsing::ThreatInfo::internal_default_instance();
}
...
void FetchThreatListUpdatesRequest::clear_chrome_client_info() {
  if (chrome_client_info_ != NULL) chrome_client_info_->::safe_browsing::ChromeClientInfo::Clear();
...
const ::safe_browsing::ChromeClientInfo& FetchThreatListUpdatesRequest::chrome_client_info() const {
  ...
  return chrome_client_info_ != NULL ? *chrome_client_info_
                         : *::safe_browsing::ChromeClientInfo::internal_default_instance();
}
...
const ::safe_browsing::Checksum& FetchThreatListUpdatesResponse_ListUpdateResponse::checksum() const {
  ...
  return checksum_ != NULL ? *checksum_
                         : *::safe_browsing::Checksum::internal_default_instance();
}
...
const ::safe_browsing::Duration& FetchThreatListUpdatesResponse::minimum_wait_duration() const {
  ...
  return minimum_wait_duration_ != NULL ? *minimum_wait_duration_
                         : *::safe_browsing::Duration::internal_default_instance();
}
...
const ::safe_browsing::Duration& FindFullHashesResponse::negative_cache_duration() const {
  ...
  return negative_cache_duration_ != NULL ? *negative_cache_duration_
                         : *::safe_browsing::Duration::internal_default_instance();
}
...
const ::safe_browsing::RawHashes& ThreatEntrySet::raw_hashes() const {
  ...
  return raw_hashes_ != NULL ? *raw_hashes_
                         : *::safe_browsing::RawHashes::internal_default_instance();
}
...
const ::safe_browsing::RawIndices& ThreatEntrySet::raw_indices() const {
  ...
  return raw_indices_ != NULL ? *raw_indices_
                         : *::safe_browsing::RawIndices::internal_default_instance();
}
...
const ::safe_browsing::RiceDeltaEncoding& ThreatEntrySet::rice_hashes() const {
  ...
  return rice_hashes_ != NULL ? *rice_hashes_
                         : *::safe_browsing::RiceDeltaEncoding::internal_default_instance();
}
...
const ::safe_browsing::RiceDeltaEncoding& ThreatEntrySet::rice_indices() const {
  ...
  return rice_indices_ != NULL ? *rice_indices_
                         : *::safe_browsing::RiceDeltaEncoding::internal_default_instance();
}
