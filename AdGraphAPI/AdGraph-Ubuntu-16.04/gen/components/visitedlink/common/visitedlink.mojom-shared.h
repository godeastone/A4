...
using VisitedLinkNotificationSinkPtrDataView =
    mojo::InterfacePtrDataView<VisitedLinkNotificationSinkInterfaceBase>;
using VisitedLinkNotificationSinkRequestDataView =
    mojo::InterfaceRequestDataView<VisitedLinkNotificationSinkInterfaceBase>;
using VisitedLinkNotificationSinkAssociatedPtrInfoDataView =
    mojo::AssociatedInterfacePtrInfoDataView<VisitedLinkNotificationSinkInterfaceBase>;
using VisitedLinkNotificationSinkAssociatedRequestDataView =
    mojo::AssociatedInterfaceRequestDataView<VisitedLinkNotificationSinkInterfaceBase>;
