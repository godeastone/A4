...
const int kCurrentDataVersion = 102;
...
const PrepopulatedEngine yahoo_jp = {
  ...
  "https://search.yahoo.co.jp/search?ei={inputEncoding}&fr=crmas&p={searchTerms}",
  "UTF-8",
...
const PrepopulatedEngine ask_br = {
  ...
  "https://br.ask.com/web?q={searchTerms}",
  "UTF-8",
  NULL,
  NULL,
  NULL,
...
const PrepopulatedEngine ask_uk = {
  ...
  "https://uk.ask.com/web?q={searchTerms}",
  "UTF-8",
...
const PrepopulatedEngine najdi = {
  ...
  "https://www.najdi.si/search.jsp?q={searchTerms}",
  "UTF-8",
  NULL,
  NULL,
  NULL,
...
const PrepopulatedEngine onet = {
  ...
  "https://szukaj.onet.pl/wyniki.html?qt={searchTerms}",
  "UTF-8",
  NULL,
  NULL,
  NULL,
...
const PrepopulatedEngine google = {
  ...
  "{google:baseURL}_/chrome/newtab?{google:RLZ}ie={inputEncoding}",
...
const PrepopulatedEngine vinden = {
  ...
  "https://www.vinden.nl/?q={searchTerms}",
  "UTF-8",
  NULL,
  NULL,
  NULL,
...
const PrepopulatedEngine seznam = {
  ...
  "UTF-8",
  "https://suggest.fulltext.seznam.cz/fulltext_ff?phrase={searchTerms}",
  NULL,
  NULL,
  NULL,
  NULL,
...
const PrepopulatedEngine kvasir = {
  ...
  "https://kvasir.no/alle?q={searchTerms}",
  "UTF-8",
  NULL,
  NULL,
  NULL,
...
const PrepopulatedEngine aol = {
  ...
  "https://search.aol.com/aol/search?q={searchTerms}",
  "UTF-8",
  "https://autosuggest.search.aol.com/autocomplete/get?output=json&it=&q={searchTerms}",
  NULL,
  NULL,
  NULL,
  NULL,
