...
#ifndef COMPONENTS_SERVICES_FILESYSTEM_PUBLIC_INTERFACES_FILE_SYSTEM_MOJOM_SHARED_H_
#define COMPONENTS_SERVICES_FILESYSTEM_PUBLIC_INTERFACES_FILE_SYSTEM_MOJOM_SHARED_H_
...
#include "components/services/filesystem/public/interfaces/file_system.mojom-shared-internal.h"
...
using FileSystemPtrDataView =
    mojo::InterfacePtrDataView<FileSystemInterfaceBase>;
using FileSystemRequestDataView =
    mojo::InterfaceRequestDataView<FileSystemInterfaceBase>;
using FileSystemAssociatedPtrInfoDataView =
    mojo::AssociatedInterfacePtrInfoDataView<FileSystemInterfaceBase>;
using FileSystemAssociatedRequestDataView =
    mojo::AssociatedInterfaceRequestDataView<FileSystemInterfaceBase>;
...
#endif  // COMPONENTS_SERVICES_FILESYSTEM_PUBLIC_INTERFACES_FILE_SYSTEM_MOJOM_SHARED_H_
