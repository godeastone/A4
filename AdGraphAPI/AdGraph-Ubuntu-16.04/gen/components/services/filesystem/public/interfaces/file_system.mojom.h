...
#ifndef COMPONENTS_SERVICES_FILESYSTEM_PUBLIC_INTERFACES_FILE_SYSTEM_MOJOM_H_
#define COMPONENTS_SERVICES_FILESYSTEM_PUBLIC_INTERFACES_FILE_SYSTEM_MOJOM_H_
...
class  FileSystem
 ...
 public:
  ...
  virtual bool OpenTempDirectory(::filesystem::mojom::DirectoryRequest directory, ::base::File::Error* out_error);

  using OpenTempDirectoryCallback = base::OnceCallback<void(::base::File::Error)>;
  virtual void OpenTempDirectory(::filesystem::mojom::DirectoryRequest directory, OpenTempDirectoryCallback callback) = 0;

  // Sync method. This signature is used by the client side; the service side
  // should implement the signature with callback below.
  virtual bool OpenPersistentFileSystem(::filesystem::mojom::DirectoryRequest directory, ::base::File::Error* out_error);

  using OpenPersistentFileSystemCallback = base::OnceCallback<void(::base::File::Error)>;
  virtual void OpenPersistentFileSystem(::filesystem::mojom::DirectoryRequest directory, OpenPersistentFileSystemCallback callback) = 0;
};
...
class  FileSystemProxy
 ...
 public:
  ...
  bool OpenTempDirectory(::filesystem::mojom::DirectoryRequest directory, ::base::File::Error* out_error) final;
  void OpenTempDirectory(::filesystem::mojom::DirectoryRequest directory, OpenTempDirectoryCallback callback) final;
  bool OpenPersistentFileSystem(::filesystem::mojom::DirectoryRequest directory, ::base::File::Error* out_error) final;
  void OpenPersistentFileSystem(::filesystem::mojom::DirectoryRequest directory, OpenPersistentFileSystemCallback callback) final;
...
#endif  // COMPONENTS_SERVICES_FILESYSTEM_PUBLIC_INTERFACES_FILE_SYSTEM_MOJOM_H_