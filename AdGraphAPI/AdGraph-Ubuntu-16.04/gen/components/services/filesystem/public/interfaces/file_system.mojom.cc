...
bool FileSystem::OpenTempDirectory(::filesystem::mojom::DirectoryRequest directory, ::base::File::Error* out_error) {
  NOTREACHED();
  return false;
}
bool FileSystem::OpenPersistentFileSystem(::filesystem::mojom::DirectoryRequest directory, ::base::File::Error* out_error) {
  NOTREACHED();
  return false;
}
...
bool FileSystemProxy::OpenTempDirectory(
    ::filesystem::mojom::DirectoryRequest param_directory, ::base::File::Error* out_param_error) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "filesystem::mojom::FileSystem::OpenTempDirectory");
#endif
...
void FileSystemProxy::OpenTempDirectory(
    ::filesystem::mojom::DirectoryRequest in_directory, OpenTempDirectoryCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "filesystem::mojom::FileSystem::OpenTempDirectory");
#endif
  const bool kExpectsResponse = true;
...
bool FileSystemProxy::OpenPersistentFileSystem(
    ::filesystem::mojom::DirectoryRequest param_directory, ::base::File::Error* out_param_error) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "filesystem::mojom::FileSystem::OpenPersistentFileSystem");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = true;
...
void FileSystemProxy::OpenPersistentFileSystem(
    ::filesystem::mojom::DirectoryRequest in_directory, OpenPersistentFileSystemCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "filesystem::mojom::FileSystem::OpenPersistentFileSystem");
#endif
  const bool kExpectsResponse = true;
...
bool FileSystem_OpenTempDirectory_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "filesystem::mojom::FileSystem::OpenTempDirectoryCallback",
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)filesystem::mojom::FileSystem::OpenTempDirectoryCallback",
               "message", message.name());
#endif
...
bool FileSystem_OpenPersistentFileSystem_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "filesystem::mojom::FileSystem::OpenPersistentFileSystemCallback",
               "message", message->name());
#endif
  mojo::internal::MessageDispatchContext dispatch_context(message);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)filesystem::mojom::FileSystem::OpenPersistentFileSystemCallback",
               "message", message.name());
#endif
  message.set_request_id(request_id_);
  ignore_result(responder_->Accept(&message));
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)filesystem::mojom::FileSystem::OpenTempDirectory",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)filesystem::mojom::FileSystem::OpenPersistentFileSystem",
               "message", message->name());
#endif
      break;
    }
