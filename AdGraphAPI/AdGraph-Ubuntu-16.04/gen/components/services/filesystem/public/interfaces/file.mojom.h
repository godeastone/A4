...
class  FileInterceptorForTesting : public File {
  ...
  void Read(uint32_t num_bytes_to_read, int64_t offset, ::filesystem::mojom::Whence whence, ReadCallback callback) override;
  void Write(const std::vector<uint8_t>& bytes_to_write, int64_t offset, ::filesystem::mojom::Whence whence, WriteCallback callback) override;
  void Tell(TellCallback callback) override;
  void Seek(int64_t offset, ::filesystem::mojom::Whence whence, SeekCallback callback) override;
  void Stat(StatCallback callback) override;
  void Truncate(int64_t size, TruncateCallback callback) override;
  void Touch(::filesystem::mojom::TimespecOrNowPtr atime, ::filesystem::mojom::TimespecOrNowPtr mtime, TouchCallback callback) override;
