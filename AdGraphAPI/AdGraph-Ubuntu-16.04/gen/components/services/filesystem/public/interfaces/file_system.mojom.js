...
(function() {
  ...
  FileSystem_OpenTempDirectory_Params.generate = function(generator_) {
    var generated = new FileSystem_OpenTempDirectory_Params;
    generated.directory = generator_.generateInterfaceRequest("filesystem.mojom.Directory", false);
    return generated;
  };

  FileSystem_OpenTempDirectory_Params.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.directory = mutator_.mutateInterfaceRequest(this.directory, "filesystem.mojom.Directory", false);
    }
    return this;
  };
  FileSystem_OpenTempDirectory_Params.prototype.getHandleDeps = function() {
    var handles = [];
  ...
  FileSystem_OpenTempDirectory_Params.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  FileSystem_OpenTempDirectory_Params.prototype.setHandlesInternal_ = function(handles, idx) {
  ...
  FileSystem_OpenTempDirectory_ResponseParams.generate = function(generator_) {
    var generated = new FileSystem_OpenTempDirectory_ResponseParams;
    generated.error = generator_.generateEnum(0, 0);
    return generated;
  };

  FileSystem_OpenTempDirectory_ResponseParams.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.error = mutator_.mutateEnum(this.error, 0, 0);
    }
    return this;
  };
  FileSystem_OpenTempDirectory_ResponseParams.prototype.getHandleDeps = function() {
    var handles = [];
    return handles;
  };

  FileSystem_OpenTempDirectory_ResponseParams.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  FileSystem_OpenTempDirectory_ResponseParams.prototype.setHandlesInternal_ = function(handles, idx) {
    return idx;
  };
  ...
  FileSystem_OpenPersistentFileSystem_Params.generate = function(generator_) {
    var generated = new FileSystem_OpenPersistentFileSystem_Params;
    generated.directory = generator_.generateInterfaceRequest("filesystem.mojom.Directory", false);
    return generated;
  };

  FileSystem_OpenPersistentFileSystem_Params.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.directory = mutator_.mutateInterfaceRequest(this.directory, "filesystem.mojom.Directory", false);
    }
    return this;
  };
  FileSystem_OpenPersistentFileSystem_Params.prototype.getHandleDeps = function() {
    var handles = [];
    if (this.directory !== null) {
      Array.prototype.push.apply(handles, ["filesystem.mojom.DirectoryRequest"]);
    }
  ...
  FileSystem_OpenPersistentFileSystem_Params.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  FileSystem_OpenPersistentFileSystem_Params.prototype.setHandlesInternal_ = function(handles, idx) {
    this.directory = handles[idx++];;
    return idx;
  };
  ...
  FileSystem_OpenPersistentFileSystem_ResponseParams.generate = function(generator_) {
    var generated = new FileSystem_OpenPersistentFileSystem_ResponseParams;
    generated.error = generator_.generateEnum(0, 0);
    return generated;
  };

  FileSystem_OpenPersistentFileSystem_ResponseParams.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.error = mutator_.mutateEnum(this.error, 0, 0);
    }
    return this;
  };
  FileSystem_OpenPersistentFileSystem_ResponseParams.prototype.getHandleDeps = function() {
    var handles = [];
    return handles;
  };

  FileSystem_OpenPersistentFileSystem_ResponseParams.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  FileSystem_OpenPersistentFileSystem_ResponseParams.prototype.setHandlesInternal_ = function(handles, idx) {
    return idx;
  };
  ...
  var kFileSystem_OpenTempDirectory_Name = 1260550802;
  var kFileSystem_OpenPersistentFileSystem_Name = 378302921;
  ...
  var FileSystem = {
    ...
    mojomId: 'components/services/filesystem/public/interfaces/file_system.mojom',
    fuzzMethods: {
      openTempDirectory: {
        params: FileSystem_OpenTempDirectory_Params,
      },
      openPersistentFileSystem: {
        params: FileSystem_OpenPersistentFileSystem_Params,
      },
    },
  };
