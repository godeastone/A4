...
inline std::ostream& operator<<(std::ostream& os, BatchOperationType value) {
  switch(value) {
    ...
    case BatchOperationType::COPY_PREFIXED_KEY:
      return os << "BatchOperationType::COPY_PREFIXED_KEY";
    default:
...
inline std::ostream& operator<<(std::ostream& os, SharedReadCache value) {
  switch(value) {
    case SharedReadCache::Default:
      return os << "SharedReadCache::Default";
    case SharedReadCache::Web:
      return os << "SharedReadCache::Web";
    default:
      return os << "Unknown SharedReadCache value: " << static_cast<int32_t>(value);
  }
}
...
struct Serializer<::leveldb::mojom::OpenOptionsDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    void* custom_context = CustomContextHelper<Traits>::SetUp(input, context);
    (*output).Allocate(buffer);
    (*output)->create_if_missing = CallWithContext(Traits::create_if_missing, input, custom_context);
    (*output)->error_if_exists = CallWithContext(Traits::error_if_exists, input, custom_context);
    (*output)->paranoid_checks = CallWithContext(Traits::paranoid_checks, input, custom_context);
    (*output)->write_buffer_size = CallWithContext(Traits::write_buffer_size, input, custom_context);
    (*output)->max_open_files = CallWithContext(Traits::max_open_files, input, custom_context);
    mojo::internal::Serialize<::leveldb::mojom::SharedReadCache>(
        CallWithContext(Traits::shared_block_read_cache, input, custom_context), &(*output)->shared_block_read_cache);
    CustomContextHelper<Traits>::TearDown(input, custom_context);
  }
