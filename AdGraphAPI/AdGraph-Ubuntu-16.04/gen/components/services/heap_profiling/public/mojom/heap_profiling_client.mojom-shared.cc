...
bool ProfilingParams_Data::Validate(
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->sender_pipe, 1, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateHandleOrInterface(object->sender_pipe,
                                                 validation_context)) {
    return false;
  }
...
// static
bool ProfilingClient_FlushMemlogPipe_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ProfilingClient_FlushMemlogPipe_Params_Data* object = static_cast<const ProfilingClient_FlushMemlogPipe_Params_Data*>(data);
...
ProfilingClient_FlushMemlogPipe_Params_Data::ProfilingClient_FlushMemlogPipe_Params_Data()
    : header_({sizeof(*this), 0}) {}
