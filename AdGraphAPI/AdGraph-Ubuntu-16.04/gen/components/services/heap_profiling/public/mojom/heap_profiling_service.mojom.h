...
class  ProfilingService
 ...
 public:
  ...
  enum MethodMinVersions : uint32_t {
    ...
    kSetKeepSmallAllocationsMinVersion = 0,
    kGetProfiledPidsMinVersion = 0,
  };
  virtual ~ProfilingService() {}

  virtual void AddProfilingClient(base::ProcessId pid, ::heap_profiling::mojom::ProfilingClientPtr client, mojo::ScopedHandle memlog_pipe_receiver, ProcessType process_type, ::heap_profiling::mojom::ProfilingParamsPtr params) = 0;

  virtual void SetKeepSmallAllocations(bool keep_small_allocations) = 0;
...
class  ProfilingServiceInterceptorForTesting : public ProfilingService {
  ...
  void AddProfilingClient(base::ProcessId pid, ::heap_profiling::mojom::ProfilingClientPtr client, mojo::ScopedHandle memlog_pipe_receiver, ProcessType process_type, ::heap_profiling::mojom::ProfilingParamsPtr params) override;
...
class  ProfilingServiceProxy
 ...
 public:
  ...
  void AddProfilingClient(base::ProcessId pid, ::heap_profiling::mojom::ProfilingClientPtr client, mojo::ScopedHandle memlog_pipe_receiver, ProcessType process_type, ::heap_profiling::mojom::ProfilingParamsPtr params) final;
  void SetKeepSmallAllocations(bool keep_small_allocations) final;
