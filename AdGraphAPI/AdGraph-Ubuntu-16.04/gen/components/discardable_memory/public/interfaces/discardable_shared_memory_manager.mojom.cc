...
void DiscardableSharedMemoryManagerProxy::AllocateLockedDiscardableSharedMemory(
  ...
  TRACE_EVENT0("mojom", "discardable_memory::mojom::DiscardableSharedMemoryManager::AllocateLockedDiscardableSharedMemory");
#endif
...
void DiscardableSharedMemoryManagerProxy::DeletedDiscardableSharedMemory(
    int32_t in_id) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "discardable_memory::mojom::DiscardableSharedMemoryManager::DeletedDiscardableSharedMemory");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)discardable_memory::mojom::DiscardableSharedMemoryManager::AllocateLockedDiscardableSharedMemoryCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)discardable_memory::mojom::DiscardableSharedMemoryManager::AllocateLockedDiscardableSharedMemory",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)discardable_memory::mojom::DiscardableSharedMemoryManager::DeletedDiscardableSharedMemory",
               "message", message->name());
#endif
