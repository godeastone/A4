...
class PasswordAutofillAgent_BlacklistedFormFound_ParamsDataView {
 public:
  PasswordAutofillAgent_BlacklistedFormFound_ParamsDataView() {}

  PasswordAutofillAgent_BlacklistedFormFound_ParamsDataView(
      internal::PasswordAutofillAgent_BlacklistedFormFound_Params_Data* data,
      mojo::internal::SerializationContext* context)
      : data_(data) {}

  bool is_null() const { return !data_; }
 private:
  internal::PasswordAutofillAgent_BlacklistedFormFound_Params_Data* data_ = nullptr;
};
...
class PasswordGenerationAgent_UserSelectedManualGenerationOption_ParamsDataView {
 public:
  PasswordGenerationAgent_UserSelectedManualGenerationOption_ParamsDataView() {}

  PasswordGenerationAgent_UserSelectedManualGenerationOption_ParamsDataView(
      internal::PasswordGenerationAgent_UserSelectedManualGenerationOption_Params_Data* data,
      mojo::internal::SerializationContext* context)
      : data_(data) {}

  bool is_null() const { return !data_; }
 private:
  internal::PasswordGenerationAgent_UserSelectedManualGenerationOption_Params_Data* data_ = nullptr;
};
