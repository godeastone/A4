...
#ifndef NET_INTERFACES_IP_ADDRESS_MOJOM_H_
#define NET_INTERFACES_IP_ADDRESS_MOJOM_H_
...
template <>
struct  StructTraits<::net::interfaces::IPAddress::DataView,
                                         ::net::interfaces::IPAddressPtr> {
  static bool IsNull(const ::net::interfaces::IPAddressPtr& input) { return !input; }
  static void SetToNull(::net::interfaces::IPAddressPtr* output) { output->reset(); }

  static const decltype(::net::interfaces::IPAddress::address_bytes)& address_bytes(
      const ::net::interfaces::IPAddressPtr& input) {
    return input->address_bytes;
  }

  static bool Read(::net::interfaces::IPAddress::DataView input, ::net::interfaces::IPAddressPtr* output);
};

}  // namespace mojo

#endif  // NET_INTERFACES_IP_ADDRESS_MOJOM_H_