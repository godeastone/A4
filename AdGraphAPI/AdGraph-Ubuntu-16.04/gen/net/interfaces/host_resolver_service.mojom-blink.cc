...
HostResolverRequestInfo::HostResolverRequestInfo(
    ...
    uint16_t port_in,
    ::net::interfaces::blink::AddressFamily address_family_in,
...
size_t HostResolverRequestInfo::Hash(size_t seed) const {
  seed = mojo::internal::WTFHash(seed, this->host);
  seed = mojo::internal::WTFHash(seed, this->port);
  seed = mojo::internal::WTFHash(seed, this->address_family);
  seed = mojo::internal::WTFHash(seed, this->is_my_ip_address);
  return seed;
}
...
void HostResolverRequestClientProxy::ReportResult(
    int32_t in_error, ::net::interfaces::blink::AddressListPtr in_result) {
...
bool HostResolverRequestClientStubDispatch::Accept(
  ...
  TRACE_EVENT1("mojom", "(Impl)net::interfaces::HostResolverRequestClient::ReportResult",
      ...
      bool success = true;
      int32_t p_error{};
      ::net::interfaces::blink::AddressListPtr p_result{};
...
void HostResolverRequestClientInterceptorForTesting::ReportResult(int32_t error, ::net::interfaces::blink::AddressListPtr result) {
...
// static
bool StructTraits<::net::interfaces::blink::HostResolverRequestInfo::DataView, ::net::interfaces::blink::HostResolverRequestInfoPtr>::Read(
    ::net::interfaces::blink::HostResolverRequestInfo::DataView input,
    ::net::interfaces::blink::HostResolverRequestInfoPtr* output) {
  bool success = true;
  ::net::interfaces::blink::HostResolverRequestInfoPtr result(::net::interfaces::blink::HostResolverRequestInfo::New());
