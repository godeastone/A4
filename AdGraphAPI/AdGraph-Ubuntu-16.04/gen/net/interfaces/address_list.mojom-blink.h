...
#ifndef NET_INTERFACES_ADDRESS_LIST_MOJOM_BLINK_H_
#define NET_INTERFACES_ADDRESS_LIST_MOJOM_BLINK_H_
...
class  AddressList {
 public:
  ...
  explicit AddressList(
      WTF::Vector<::net::interfaces::blink::IPEndPointPtr> addresses);
...
template <>
struct  StructTraits<::net::interfaces::blink::AddressList::DataView,
                                         ::net::interfaces::blink::AddressListPtr> {
  static bool IsNull(const ::net::interfaces::blink::AddressListPtr& input) { return !input; }
  static void SetToNull(::net::interfaces::blink::AddressListPtr* output) { output->reset(); }

  static const decltype(::net::interfaces::blink::AddressList::addresses)& addresses(
      const ::net::interfaces::blink::AddressListPtr& input) {
    return input->addresses;
  }

  static bool Read(::net::interfaces::blink::AddressList::DataView input, ::net::interfaces::blink::AddressListPtr* output);
};

}  // namespace mojo

#endif  // NET_INTERFACES_ADDRESS_LIST_MOJOM_BLINK_H_