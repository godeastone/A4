...
void InitializePulse(void* module) {
  pa_threaded_mainloop_get_api_ptr =
    ...
    VLOG_IF(1, !pa_threaded_mainloop_get_api_ptr) << "Couldn't load pa_threaded_mainloop_get_api, dlerror() says:\n"
        << dlerror();
  pa_threaded_mainloop_free_ptr =
    reinterpret_cast<void (*)(pa_threaded_mainloop* m)>(
      dlsym(module, "pa_threaded_mainloop_free"));
    VLOG_IF(1, !pa_threaded_mainloop_free_ptr) << "Couldn't load pa_threaded_mainloop_free, dlerror() says:\n"
        << dlerror();
  pa_threaded_mainloop_new_ptr =
    reinterpret_cast<pa_threaded_mainloop* (*)()>(
      dlsym(module, "pa_threaded_mainloop_new"));
    VLOG_IF(1, !pa_threaded_mainloop_new_ptr) << "Couldn't load pa_threaded_mainloop_new, dlerror() says:\n"
        << dlerror();
  pa_threaded_mainloop_lock_ptr =
    reinterpret_cast<void (*)(pa_threaded_mainloop* m)>(
      dlsym(module, "pa_threaded_mainloop_lock"));
    VLOG_IF(1, !pa_threaded_mainloop_lock_ptr) << "Couldn't load pa_threaded_mainloop_lock, dlerror() says:\n"
        << dlerror();
  pa_threaded_mainloop_in_thread_ptr =
    reinterpret_cast<int (*)(pa_threaded_mainloop* m)>(
      dlsym(module, "pa_threaded_mainloop_in_thread"));
    VLOG_IF(1, !pa_threaded_mainloop_in_thread_ptr) << "Couldn't load pa_threaded_mainloop_in_thread, dlerror() says:\n"
        << dlerror();
  pa_threaded_mainloop_signal_ptr =
    reinterpret_cast<void (*)(pa_threaded_mainloop* m, int wait_for_accept)>(
      dlsym(module, "pa_threaded_mainloop_signal"));
    VLOG_IF(1, !pa_threaded_mainloop_signal_ptr) << "Couldn't load pa_threaded_mainloop_signal, dlerror() says:\n"
        << dlerror();
  pa_threaded_mainloop_start_ptr =
    reinterpret_cast<int (*)(pa_threaded_mainloop* m)>(
      dlsym(module, "pa_threaded_mainloop_start"));
    VLOG_IF(1, !pa_threaded_mainloop_start_ptr) << "Couldn't load pa_threaded_mainloop_start, dlerror() says:\n"
        << dlerror();
  pa_threaded_mainloop_stop_ptr =
    reinterpret_cast<void (*)(pa_threaded_mainloop* m)>(
      dlsym(module, "pa_threaded_mainloop_stop"));
    VLOG_IF(1, !pa_threaded_mainloop_stop_ptr) << "Couldn't load pa_threaded_mainloop_stop, dlerror() says:\n"
        << dlerror();
  pa_threaded_mainloop_unlock_ptr =
    reinterpret_cast<void (*)(pa_threaded_mainloop* m)>(
      dlsym(module, "pa_threaded_mainloop_unlock"));
    VLOG_IF(1, !pa_threaded_mainloop_unlock_ptr) << "Couldn't load pa_threaded_mainloop_unlock, dlerror() says:\n"
        << dlerror();
  pa_threaded_mainloop_wait_ptr =
    reinterpret_cast<void (*)(pa_threaded_mainloop* m)>(
      dlsym(module, "pa_threaded_mainloop_wait"));
    VLOG_IF(1, !pa_threaded_mainloop_wait_ptr) << "Couldn't load pa_threaded_mainloop_wait, dlerror() says:\n"
        << dlerror();
  pa_channel_map_init_ptr =
    reinterpret_cast<pa_channel_map* (*)(pa_channel_map* m)>(
      dlsym(module, "pa_channel_map_init"));
    VLOG_IF(1, !pa_channel_map_init_ptr) << "Couldn't load pa_channel_map_init, dlerror() says:\n"
        << dlerror();
  pa_channel_map_init_mono_ptr =
    reinterpret_cast<pa_channel_map* (*)(pa_channel_map* m)>(
      dlsym(module, "pa_channel_map_init_mono"));
    VLOG_IF(1, !pa_channel_map_init_mono_ptr) << "Couldn't load pa_channel_map_init_mono, dlerror() says:\n"
        << dlerror();
  pa_context_connect_ptr =
    ...
    VLOG_IF(1, !pa_context_connect_ptr) << "Couldn't load pa_context_connect, dlerror() says:\n"
        << dlerror();
  pa_context_disconnect_ptr =
    reinterpret_cast<void (*)(pa_context* c)>(
      dlsym(module, "pa_context_disconnect"));
    VLOG_IF(1, !pa_context_disconnect_ptr) << "Couldn't load pa_context_disconnect, dlerror() says:\n"
        << dlerror();
  pa_context_get_server_info_ptr =
    reinterpret_cast<pa_operation* (*)(pa_context* c, pa_server_info_cb_t cb, void* userdata)>(
      dlsym(module, "pa_context_get_server_info"));
    VLOG_IF(1, !pa_context_get_server_info_ptr) << "Couldn't load pa_context_get_server_info, dlerror() says:\n"
        << dlerror();
  pa_context_get_source_info_by_index_ptr =
    ...
    VLOG_IF(1, !pa_context_get_source_info_by_index_ptr) << "Couldn't load pa_context_get_source_info_by_index, dlerror() says:\n"
        << dlerror();
  pa_context_get_source_info_list_ptr =
    ...
    VLOG_IF(1, !pa_context_get_source_info_list_ptr) << "Couldn't load pa_context_get_source_info_list, dlerror() says:\n"
        << dlerror();
  pa_context_get_sink_info_list_ptr =
  ...
  pa_context_new_ptr =
    ...
    VLOG_IF(1, !pa_context_new_ptr) << "Couldn't load pa_context_new, dlerror() says:\n"
        << dlerror();
  pa_context_set_source_volume_by_index_ptr =
    ...
    VLOG_IF(1, !pa_context_set_source_volume_by_index_ptr) << "Couldn't load pa_context_set_source_volume_by_index, dlerror() says:\n"
        << dlerror();
  pa_context_set_state_callback_ptr =
  ...
  pa_context_unref_ptr =
    ...
    VLOG_IF(1, !pa_context_unref_ptr) << "Couldn't load pa_context_unref, dlerror() says:\n"
        << dlerror();
  pa_operation_unref_ptr =
    reinterpret_cast<void (*)(pa_operation* o)>(
      dlsym(module, "pa_operation_unref"));
    VLOG_IF(1, !pa_operation_unref_ptr) << "Couldn't load pa_operation_unref, dlerror() says:\n"
        << dlerror();
  pa_stream_begin_write_ptr =
    reinterpret_cast<int (*)(pa_stream* p, void** data, size_t* nbytes)>(
      dlsym(module, "pa_stream_begin_write"));
    VLOG_IF(1, !pa_stream_begin_write_ptr) << "Couldn't load pa_stream_begin_write, dlerror() says:\n"
        << dlerror();
  pa_stream_connect_playback_ptr =
    ...
    VLOG_IF(1, !pa_stream_connect_playback_ptr) << "Couldn't load pa_stream_connect_playback, dlerror() says:\n"
        << dlerror();
  pa_stream_connect_record_ptr =
    ...
    VLOG_IF(1, !pa_stream_connect_record_ptr) << "Couldn't load pa_stream_connect_record, dlerror() says:\n"
        << dlerror();
  pa_stream_cork_ptr =
    reinterpret_cast<pa_operation* (*)(pa_stream* s, int b, pa_stream_success_cb_t cb, void* userdata)>(
      dlsym(module, "pa_stream_cork"));
    VLOG_IF(1, !pa_stream_cork_ptr) << "Couldn't load pa_stream_cork, dlerror() says:\n"
        << dlerror();
  pa_stream_disconnect_ptr =
    reinterpret_cast<int (*)(pa_stream* s)>(
      dlsym(module, "pa_stream_disconnect"));
    VLOG_IF(1, !pa_stream_disconnect_ptr) << "Couldn't load pa_stream_disconnect, dlerror() says:\n"
        << dlerror();
  pa_stream_drop_ptr =
    reinterpret_cast<int (*)(pa_stream *p)>(
      dlsym(module, "pa_stream_drop"));
    VLOG_IF(1, !pa_stream_drop_ptr) << "Couldn't load pa_stream_drop, dlerror() says:\n"
        << dlerror();
  pa_stream_flush_ptr =
  ...
  pa_stream_new_ptr =
    ...
    VLOG_IF(1, !pa_stream_new_ptr) << "Couldn't load pa_stream_new, dlerror() says:\n"
        << dlerror();
  pa_stream_new_with_proplist_ptr =
    ...
    VLOG_IF(1, !pa_stream_new_with_proplist_ptr) << "Couldn't load pa_stream_new_with_proplist, dlerror() says:\n"
        << dlerror();
  pa_proplist_new_ptr =
  ...
  pa_stream_peek_ptr =
    ...
    VLOG_IF(1, !pa_stream_peek_ptr) << "Couldn't load pa_stream_peek, dlerror() says:\n"
        << dlerror();
  pa_stream_set_read_callback_ptr =
    reinterpret_cast<void (*)(pa_stream* p, pa_stream_request_cb_t cb, void* userdata)>(
      dlsym(module, "pa_stream_set_read_callback"));
    VLOG_IF(1, !pa_stream_set_read_callback_ptr) << "Couldn't load pa_stream_set_read_callback, dlerror() says:\n"
        << dlerror();
  pa_stream_set_state_callback_ptr =
    reinterpret_cast<void (*)(pa_stream* s, pa_stream_notify_cb_t cb, void* userdata)>(
      dlsym(module, "pa_stream_set_state_callback"));
    VLOG_IF(1, !pa_stream_set_state_callback_ptr) << "Couldn't load pa_stream_set_state_callback, dlerror() says:\n"
        << dlerror();
  pa_stream_write_ptr =
    ...
    VLOG_IF(1, !pa_stream_write_ptr) << "Couldn't load pa_stream_write, dlerror() says:\n"
        << dlerror();
  pa_stream_set_write_callback_ptr =
    reinterpret_cast<void (*)(pa_stream *p, pa_stream_request_cb_t cb, void *userdata)>(
      dlsym(module, "pa_stream_set_write_callback"));
    VLOG_IF(1, !pa_stream_set_write_callback_ptr) << "Couldn't load pa_stream_set_write_callback, dlerror() says:\n"
        << dlerror();
  pa_stream_unref_ptr =
  ...
  pa_strerror_ptr =
    ...
    VLOG_IF(1, !pa_strerror_ptr) << "Couldn't load pa_strerror, dlerror() says:\n"
        << dlerror();
  pa_cvolume_set_ptr =
    reinterpret_cast<pa_cvolume* (*)(pa_cvolume* a, unsigned  channels, pa_volume_t v)>(
      dlsym(module, "pa_cvolume_set"));
    VLOG_IF(1, !pa_cvolume_set_ptr) << "Couldn't load pa_cvolume_set, dlerror() says:\n"
        << dlerror();
}
