...
#ifndef MEDIA_MOJO_INTERFACES_JPEG_DECODE_ACCELERATOR_MOJOM_H_
#define MEDIA_MOJO_INTERFACES_JPEG_DECODE_ACCELERATOR_MOJOM_H_
...
class  JpegDecodeAccelerator
 ...
 public:
  ...
  using DecodeCallback = base::OnceCallback<void(int32_t, media::JpegDecodeAccelerator::Error)>;
  virtual void Decode(const media::BitstreamBuffer& input_buffer, const gfx::Size& coded_size, mojo::ScopedSharedBufferHandle output_handle, uint32_t output_buffer_size, DecodeCallback callback) = 0;


  using DecodeWithFDCallback = base::OnceCallback<void(int32_t, media::JpegDecodeAccelerator::Error)>;
...
class  JpegDecodeAcceleratorInterceptorForTesting : public JpegDecodeAccelerator {
  ...
  void Decode(const media::BitstreamBuffer& input_buffer, const gfx::Size& coded_size, mojo::ScopedSharedBufferHandle output_handle, uint32_t output_buffer_size, DecodeCallback callback) override;
...
class  JpegDecodeAcceleratorProxy
 ...
 public:
  ...
  void Decode(const media::BitstreamBuffer& input_buffer, const gfx::Size& coded_size, mojo::ScopedSharedBufferHandle output_handle, uint32_t output_buffer_size, DecodeCallback callback) final;
...
template <>
struct  StructTraits<::media::mojom::BitstreamBuffer::DataView,
                                         ::media::mojom::BitstreamBufferPtr> {
  static bool IsNull(const ::media::mojom::BitstreamBufferPtr& input) { return !input; }
  static void SetToNull(::media::mojom::BitstreamBufferPtr* output) { output->reset(); }

  static decltype(::media::mojom::BitstreamBuffer::id) id(
      const ::media::mojom::BitstreamBufferPtr& input) {
    return input->id;
  }

  static  decltype(::media::mojom::BitstreamBuffer::memory_handle)& memory_handle(
       ::media::mojom::BitstreamBufferPtr& input) {
    return input->memory_handle;
  }

  static decltype(::media::mojom::BitstreamBuffer::size) size(
      const ::media::mojom::BitstreamBufferPtr& input) {
    return input->size;
  }

  static decltype(::media::mojom::BitstreamBuffer::offset) offset(
      const ::media::mojom::BitstreamBufferPtr& input) {
    return input->offset;
  }

  static const decltype(::media::mojom::BitstreamBuffer::timestamp)& timestamp(
      const ::media::mojom::BitstreamBufferPtr& input) {
    return input->timestamp;
  }

  static const decltype(::media::mojom::BitstreamBuffer::key_id)& key_id(
      const ::media::mojom::BitstreamBufferPtr& input) {
    return input->key_id;
  }

  static const decltype(::media::mojom::BitstreamBuffer::iv)& iv(
      const ::media::mojom::BitstreamBufferPtr& input) {
    return input->iv;
  }

  static const decltype(::media::mojom::BitstreamBuffer::subsamples)& subsamples(
      const ::media::mojom::BitstreamBufferPtr& input) {
    return input->subsamples;
  }

  static bool Read(::media::mojom::BitstreamBuffer::DataView input, ::media::mojom::BitstreamBufferPtr* output);
};

}  // namespace mojo

#endif  // MEDIA_MOJO_INTERFACES_JPEG_DECODE_ACCELERATOR_MOJOM_H_