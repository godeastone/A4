...
Renderer_InitiateScopedSurfaceRequest_Params_Data::Renderer_InitiateScopedSurfaceRequest_Params_Data()
    : header_({sizeof(*this), 0}) {}
...
Renderer_InitiateScopedSurfaceRequest_ResponseParams_Data::Renderer_InitiateScopedSurfaceRequest_ResponseParams_Data()
    : header_({sizeof(*this), 0}) {}
...
RendererClient_OnWaitingForDecryptionKey_Params_Data::RendererClient_OnWaitingForDecryptionKey_Params_Data()
    : header_({sizeof(*this), 0}) {}
...
RendererClient_OnDurationChange_Params_Data::RendererClient_OnDurationChange_Params_Data()
    : header_({sizeof(*this), 0}) {}
