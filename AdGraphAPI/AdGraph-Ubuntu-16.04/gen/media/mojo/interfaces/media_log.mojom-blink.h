...
#ifndef MEDIA_MOJO_INTERFACES_MEDIA_LOG_MOJOM_BLINK_H_
#define MEDIA_MOJO_INTERFACES_MEDIA_LOG_MOJOM_BLINK_H_
...
using RevocableMediaLogPtr = ::blink::RevocableInterfacePtr<MediaLog>;
...
class  MediaLog
 ...
 public:
  ...
  virtual void AddEvent(::media::mojom::blink::MediaLogEventPtr event) = 0;
};
...
class  MediaLogProxy
 ...
 public:
  ...
  void AddEvent(::media::mojom::blink::MediaLogEventPtr event) final;
...
#endif  // MEDIA_MOJO_INTERFACES_MEDIA_LOG_MOJOM_BLINK_H_