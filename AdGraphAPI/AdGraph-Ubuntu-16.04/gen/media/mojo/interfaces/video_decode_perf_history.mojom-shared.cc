...
bool VideoDecodePerfHistory_GetPerfInfo_Params_Data::Validate(
  ...
  const VideoDecodePerfHistory_GetPerfInfo_Params_Data* object = static_cast<const VideoDecodePerfHistory_GetPerfInfo_Params_Data*>(data);
...
bool VideoDecodePerfHistory_GetPerfInfo_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VideoDecodePerfHistory_GetPerfInfo_ResponseParams_Data* object = static_cast<const VideoDecodePerfHistory_GetPerfInfo_ResponseParams_Data*>(data);
