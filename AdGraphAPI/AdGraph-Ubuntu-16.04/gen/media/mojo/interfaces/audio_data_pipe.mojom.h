 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        AudioDataPipe::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::media::mojom::AudioDataPipe::DataView,
                                         ::media::mojom::AudioDataPipePtr> {
  static bool IsNull(const ::media::mojom::AudioDataPipePtr& input) { return !input; }
  static void SetToNull(::media::mojom::AudioDataPipePtr* output) { output->reset(); }

  static  decltype(::media::mojom::AudioDataPipe::shared_memory)& shared_memory(
       ::media::mojom::AudioDataPipePtr& input) {
    return input->shared_memory;
  }

  static  decltype(::media::mojom::AudioDataPipe::socket)& socket(
       ::media::mojom::AudioDataPipePtr& input) {
    return input->socket;
  }

  static bool Read(::media::mojom::AudioDataPipe::DataView input, ::media::mojom::AudioDataPipePtr* output);
};
