...
// static
bool StructTraits<::media::mojom::AudioDataPipe::DataView, ::media::mojom::AudioDataPipePtr>::Read(
    ::media::mojom::AudioDataPipe::DataView input,
    ::media::mojom::AudioDataPipePtr* output) {
  bool success = true;
  ::media::mojom::AudioDataPipePtr result(::media::mojom::AudioDataPipe::New());
