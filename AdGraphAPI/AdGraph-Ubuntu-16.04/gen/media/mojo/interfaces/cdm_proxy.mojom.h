...
class  CdmProxy
 ...
 public:
  ...
  virtual void SetKey(uint32_t crypto_session_id, const std::vector<uint8_t>& key_id, const std::vector<uint8_t>& key_blob) = 0;

  virtual void RemoveKey(uint32_t crypto_session_id, const std::vector<uint8_t>& key_id) = 0;
};
class  CdmProxyInterceptorForTesting : public CdmProxy {
  ...
  void SetKey(uint32_t crypto_session_id, const std::vector<uint8_t>& key_id, const std::vector<uint8_t>& key_blob) override;
  void RemoveKey(uint32_t crypto_session_id, const std::vector<uint8_t>& key_id) override;
};
...
class  CdmProxyProxy
 ...
 public:
  ...
  void SetKey(uint32_t crypto_session_id, const std::vector<uint8_t>& key_id, const std::vector<uint8_t>& key_blob) final;
  void RemoveKey(uint32_t crypto_session_id, const std::vector<uint8_t>& key_id) final;
