...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)media::mojom::VideoDecodeStatsRecorder::StartNewRecord",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            ...
            "VideoDecodeStatsRecorder::StartNewRecord deserializer");
        return false;
      }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)media::mojom::VideoDecodeStatsRecorder::UpdateRecord",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "VideoDecodeStatsRecorder::UpdateRecord deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
