...
void ProvisionFetcherProxy::Retrieve(
    const WTF::String& in_default_url, const WTF::String& in_request_data, RetrieveCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "media::mojom::ProvisionFetcher::Retrieve");
#endif
...
class ProvisionFetcher_Retrieve_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      bool in_result, const WTF::String& in_response);
...
bool ProvisionFetcher_Retrieve_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "media::mojom::ProvisionFetcher::RetrieveCallback",
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)media::mojom::ProvisionFetcher::RetrieveCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)media::mojom::ProvisionFetcher::Retrieve",
               "message", message->name());
#endif
      break;
    }
