...
void InterfaceFactoryProxy::CreateRenderer(
    HostedRendererType in_type, const std::string& in_type_specific_id, ::media::mojom::RendererRequest in_renderer) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void InterfaceFactoryProxy::CreateCdmProxy(
    const std::string& in_cdm_guid, ::media::mojom::CdmProxyRequest in_cdm_proxy) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void InterfaceFactoryInterceptorForTesting::CreateRenderer(HostedRendererType type, const std::string& type_specific_id, ::media::mojom::RendererRequest renderer) {
...
void InterfaceFactoryInterceptorForTesting::CreateCdmProxy(const std::string& cdm_guid, ::media::mojom::CdmProxyRequest cdm_proxy) {
