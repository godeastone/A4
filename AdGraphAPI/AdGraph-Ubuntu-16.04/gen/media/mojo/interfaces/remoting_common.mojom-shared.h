...
inline std::ostream& operator<<(std::ostream& os, RemotingSinkFeature value) {
  switch(value) {
...
inline std::ostream& operator<<(std::ostream& os, RemotingSinkAudioCapability value) {
  switch(value) {
...
inline std::ostream& operator<<(std::ostream& os, RemotingSinkVideoCapability value) {
  switch(value) {
...
struct Serializer<::media::mojom::RemotingSinkMetadataDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    decltype(CallWithContext(Traits::audio_capabilities, input, custom_context)) in_audio_capabilities = CallWithContext(Traits::audio_capabilities, input, custom_context);
    ...
    decltype(CallWithContext(Traits::video_capabilities, input, custom_context)) in_video_capabilities = CallWithContext(Traits::video_capabilities, input, custom_context);
    ...
    decltype(CallWithContext(Traits::friendly_name, input, custom_context)) in_friendly_name = CallWithContext(Traits::friendly_name, input, custom_context);
