...
bool PlaybackProperties_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->natural_size, 10, validation_context)) {
    return false;
  }
...
// static
bool WatchTimeRecorder_SetAudioDecoderName_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const WatchTimeRecorder_SetAudioDecoderName_Params_Data* object = static_cast<const WatchTimeRecorder_SetAudioDecoderName_Params_Data*>(data);
...
WatchTimeRecorder_SetAudioDecoderName_Params_Data::WatchTimeRecorder_SetAudioDecoderName_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool WatchTimeRecorder_SetVideoDecoderName_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const WatchTimeRecorder_SetVideoDecoderName_Params_Data* object = static_cast<const WatchTimeRecorder_SetVideoDecoderName_Params_Data*>(data);
...
WatchTimeRecorder_SetVideoDecoderName_Params_Data::WatchTimeRecorder_SetVideoDecoderName_Params_Data()
    : header_({sizeof(*this), 0}) {}
