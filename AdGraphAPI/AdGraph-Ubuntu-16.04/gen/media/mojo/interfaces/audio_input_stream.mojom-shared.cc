...
bool AudioInputStream_Record_Params_Data::Validate(
  ...
  const AudioInputStream_Record_Params_Data* object = static_cast<const AudioInputStream_Record_Params_Data*>(data);
...
bool AudioInputStream_SetVolume_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const AudioInputStream_SetVolume_Params_Data* object = static_cast<const AudioInputStream_SetVolume_Params_Data*>(data);
...
bool AudioInputStreamClient_OnError_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const AudioInputStreamClient_OnError_Params_Data* object = static_cast<const AudioInputStreamClient_OnError_Params_Data*>(data);
...
bool AudioInputStreamClient_OnMutedStateChanged_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const AudioInputStreamClient_OnMutedStateChanged_Params_Data* object = static_cast<const AudioInputStreamClient_OnMutedStateChanged_Params_Data*>(data);
...
bool AudioInputStreamObserver_DidStartRecording_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const AudioInputStreamObserver_DidStartRecording_Params_Data* object = static_cast<const AudioInputStreamObserver_DidStartRecording_Params_Data*>(data);
