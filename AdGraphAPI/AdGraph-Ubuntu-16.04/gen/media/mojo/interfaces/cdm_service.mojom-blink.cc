...
void CdmServiceProxy::LoadCdm(
  ...
  TRACE_EVENT0("mojom", "media::mojom::CdmService::LoadCdm");
#endif
...
void CdmServiceProxy::CreateCdmFactory(
    ::media::mojom::blink::CdmFactoryRequest in_factory, ::service_manager::mojom::blink::InterfaceProviderPtr in_host_interfaces) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "media::mojom::CdmService::CreateCdmFactory");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)media::mojom::CdmService::LoadCdm",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            ...
            "CdmService::LoadCdm deserializer");
        return false;
      }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)media::mojom::CdmService::CreateCdmFactory",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::media::mojom::blink::CdmFactoryRequest p_factory{};
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "CdmService::CreateCdmFactory deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
