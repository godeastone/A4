...
class  InterfaceFactory
 ...
 public:
  ...
  virtual void CreateRenderer(HostedRendererType type, const std::string& type_specific_id, ::media::mojom::RendererRequest renderer) = 0;
  ...
  virtual void CreateCdmProxy(const std::string& cdm_guid, ::media::mojom::CdmProxyRequest cdm_proxy) = 0;
};
class  InterfaceFactoryInterceptorForTesting : public InterfaceFactory {
  ...
  void CreateRenderer(HostedRendererType type, const std::string& type_specific_id, ::media::mojom::RendererRequest renderer) override;
  ...
  void CreateCdmProxy(const std::string& cdm_guid, ::media::mojom::CdmProxyRequest cdm_proxy) override;
};
...
class  InterfaceFactoryProxy
 ...
 public:
  ...
  void CreateRenderer(HostedRendererType type, const std::string& type_specific_id, ::media::mojom::RendererRequest renderer) final;
  ...
  void CreateCdmProxy(const std::string& cdm_guid, ::media::mojom::CdmProxyRequest cdm_proxy) final;
