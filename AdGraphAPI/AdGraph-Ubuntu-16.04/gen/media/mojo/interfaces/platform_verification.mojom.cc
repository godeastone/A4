...
void PlatformVerificationProxy::ChallengePlatform(
  ...
  TRACE_EVENT0("mojom", "media::mojom::PlatformVerification::ChallengePlatform");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "media::mojom::PlatformVerification::GetStorageId");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
bool PlatformVerification_ChallengePlatform_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        ...
        "PlatformVerification::ChallengePlatform response deserializer");
    return false;
  }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)media::mojom::PlatformVerification::ChallengePlatformCallback",
               "message", message.name());
#endif
...
bool PlatformVerification_GetStorageId_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "PlatformVerification::GetStorageId response deserializer");
    return false;
  }
  if (!callback_.is_null())
    std::move(callback_).Run(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)media::mojom::PlatformVerification::GetStorageIdCallback",
               "message", message.name());
#endif
  message.set_request_id(request_id_);
  ignore_result(responder_->Accept(&message));
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)media::mojom::PlatformVerification::ChallengePlatform",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)media::mojom::PlatformVerification::GetStorageId",
               "message", message->name());
#endif
      break;
    }
  ...
  TRACE_EVENT1("mojom", "(Impl)media::mojom::PlatformVerification::ChallengePlatform",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "PlatformVerification::ChallengePlatform deserializer");
        return false;
      }
      PlatformVerification::ChallengePlatformCallback callback =
  ...
  TRACE_EVENT1("mojom", "(Impl)media::mojom::PlatformVerification::GetStorageId",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "PlatformVerification::GetStorageId deserializer");
        return false;
      }
      PlatformVerification::GetStorageIdCallback callback =
