...
bool KeySystemSupport::IsKeySystemSupported(const WTF::String& key_system, bool* out_is_supported, WTF::Vector<::media::mojom::blink::VideoCodec>* out_supported_video_codecs, bool* out_supports_persistent_license, WTF::Vector<::media::mojom::blink::EncryptionMode>* out_supported_encryption_schemes) {
  NOTREACHED();
  return false;
}
class KeySystemSupport_IsKeySystemSupported_HandleSyncResponse
 ...
 public:
  KeySystemSupport_IsKeySystemSupported_HandleSyncResponse(
      bool* result, bool* out_is_supported, WTF::Vector<::media::mojom::blink::VideoCodec>* out_supported_video_codecs, bool* out_supports_persistent_license, WTF::Vector<::media::mojom::blink::EncryptionMode>* out_supported_encryption_schemes)
 ...
 private:
  ...
  WTF::Vector<::media::mojom::blink::VideoCodec>* out_supported_video_codecs_;
  bool* out_supports_persistent_license_;
  WTF::Vector<::media::mojom::blink::EncryptionMode>* out_supported_encryption_schemes_;DISALLOW_COPY_AND_ASSIGN(KeySystemSupport_IsKeySystemSupported_HandleSyncResponse);
};
...
bool KeySystemSupportProxy::IsKeySystemSupported(
    const WTF::String& param_key_system, bool* out_param_is_supported, WTF::Vector<::media::mojom::blink::VideoCodec>* out_param_supported_video_codecs, bool* out_param_supports_persistent_license, WTF::Vector<::media::mojom::blink::EncryptionMode>* out_param_supported_encryption_schemes) {
...
class KeySystemSupport_IsKeySystemSupported_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      bool in_is_supported, const WTF::Vector<::media::mojom::blink::VideoCodec>& in_supported_video_codecs, bool in_supports_persistent_license, const WTF::Vector<::media::mojom::blink::EncryptionMode>& in_supported_encryption_schemes);
...
bool KeySystemSupport_IsKeySystemSupported_ForwardToCallback::Accept(
  ...
  bool success = true;
  bool p_is_supported{};
  WTF::Vector<::media::mojom::blink::VideoCodec> p_supported_video_codecs{};
  bool p_supports_persistent_license{};
  WTF::Vector<::media::mojom::blink::EncryptionMode> p_supported_encryption_schemes{};
...
void KeySystemSupportAsyncWaiter::IsKeySystemSupported(
    const WTF::String& key_system, bool* out_is_supported, WTF::Vector<::media::mojom::blink::VideoCodec>* out_supported_video_codecs, bool* out_supports_persistent_license, WTF::Vector<::media::mojom::blink::EncryptionMode>* out_supported_encryption_schemes) {
  base::RunLoop loop;
...
,
             WTF::Vector<::media::mojom::blink::VideoCodec>* out_supported_video_codecs
,
             bool* out_supports_persistent_license
,
             WTF::Vector<::media::mojom::blink::EncryptionMode>* out_supported_encryption_schemes
,
             bool is_supported,
             const WTF::Vector<::media::mojom::blink::VideoCodec>& supported_video_codecs,
             bool supports_persistent_license,
             const WTF::Vector<::media::mojom::blink::EncryptionMode>& supported_encryption_schemes) {*out_is_supported = std::move(is_supported);*out_supported_video_codecs = std::move(supported_video_codecs);*out_supports_persistent_license = std::move(supports_persistent_license);*out_supported_encryption_schemes = std::move(supported_encryption_schemes);
            loop->Quit();
          },
          &loop,
          out_is_supported,
