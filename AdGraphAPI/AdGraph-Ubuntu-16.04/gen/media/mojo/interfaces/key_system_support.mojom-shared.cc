...
bool KeySystemSupport_IsKeySystemSupported_ResponseParams_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->supported_video_codecs, 2, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateContainer(object->supported_video_codecs, validation_context,
                                         &supported_video_codecs_validate_params)) {
    return false;
  }

  if (!mojo::internal::ValidatePointerNonNullable(
          object->supported_encryption_schemes, 4, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateContainer(object->supported_encryption_schemes, validation_context,
                                         &supported_encryption_schemes_validate_params)) {
    return false;
  }
