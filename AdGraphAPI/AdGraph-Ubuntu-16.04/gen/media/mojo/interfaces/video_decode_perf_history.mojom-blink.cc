...
void VideoDecodePerfHistoryProxy::GetPerfInfo(
  ...
  TRACE_EVENT0("mojom", "media::mojom::VideoDecodePerfHistory::GetPerfInfo");
#endif
...
bool VideoDecodePerfHistory_GetPerfInfo_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "media::mojom::VideoDecodePerfHistory::GetPerfInfoCallback",
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        ...
        "VideoDecodePerfHistory::GetPerfInfo response deserializer");
    return false;
  }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)media::mojom::VideoDecodePerfHistory::GetPerfInfoCallback",
               "message", message.name());
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)media::mojom::VideoDecodePerfHistory::GetPerfInfo",
               "message", message->name());
#endif
      break;
    }
  ...
  TRACE_EVENT1("mojom", "(Impl)media::mojom::VideoDecodePerfHistory::GetPerfInfo",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "VideoDecodePerfHistory::GetPerfInfo deserializer");
        return false;
      }
      VideoDecodePerfHistory::GetPerfInfoCallback callback =
