...
void WatchTimeRecorderProxy::RecordWatchTime(
    ::media::mojom::blink::WatchTimeKey in_key, WTF::TimeDelta in_watch_time) {
...
void WatchTimeRecorderInterceptorForTesting::RecordWatchTime(::media::mojom::blink::WatchTimeKey key, WTF::TimeDelta watch_time) {
...
void WatchTimeRecorderInterceptorForTesting::SetAudioDecoderName(const WTF::String& name) {
  GetForwardingInterface()->SetAudioDecoderName(std::move(name));
}
void WatchTimeRecorderInterceptorForTesting::SetVideoDecoderName(const WTF::String& name) {
