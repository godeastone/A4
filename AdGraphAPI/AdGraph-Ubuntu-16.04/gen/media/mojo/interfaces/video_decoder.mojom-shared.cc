...
bool VideoFrameHandleReleaser_ReleaseVideoFrame_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VideoFrameHandleReleaser_ReleaseVideoFrame_Params_Data* object = static_cast<const VideoFrameHandleReleaser_ReleaseVideoFrame_Params_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->release_sync_token, 2, validation_context)) {
    return false;
  }
...
bool VideoDecoder_OnOverlayInfoChanged_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VideoDecoder_OnOverlayInfoChanged_Params_Data* object = static_cast<const VideoDecoder_OnOverlayInfoChanged_Params_Data*>(data);
...
bool VideoDecoderClient_RequestOverlayInfo_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VideoDecoderClient_RequestOverlayInfo_Params_Data* object = static_cast<const VideoDecoderClient_RequestOverlayInfo_Params_Data*>(data);
