...
#include "media/mojo/interfaces/jpeg_decode_accelerator.mojom-blink.h"
...
BitstreamBuffer::BitstreamBuffer(
    ...
    WTF::Vector<::media::mojom::blink::SubsampleEntryPtr> subsamples_in)
    : id(std::move(id_in)),
...
void JpegDecodeAcceleratorProxy::Decode(
    BitstreamBufferPtr in_input_buffer, const ::blink::WebSize& in_coded_size, mojo::ScopedSharedBufferHandle in_output_handle, uint32_t in_output_buffer_size, DecodeCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
class JpegDecodeAccelerator_Decode_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      int32_t in_bitstream_buffer_id, DecodeError in_error);
...
class JpegDecodeAccelerator_DecodeWithFD_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      int32_t in_buffer_id, DecodeError in_error);
...
bool JpegDecodeAcceleratorStubDispatch::AcceptWithResponder(
  ...
  TRACE_EVENT1("mojom", "(Impl)media::mojom::JpegDecodeAccelerator::Decode",
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      BitstreamBufferPtr p_input_buffer{};
      ::blink::WebSize p_coded_size{};
...
void JpegDecodeAcceleratorInterceptorForTesting::Decode(BitstreamBufferPtr input_buffer, const ::blink::WebSize& coded_size, mojo::ScopedSharedBufferHandle output_handle, uint32_t output_buffer_size, DecodeCallback callback) {
...
,
             ...
             DecodeError error) {*out_bitstream_buffer_id = std::move(bitstream_buffer_id);*out_error = std::move(error);
            loop->Quit();
          },
          &loop,
...
,
             int32_t buffer_id,
             DecodeError error) {*out_buffer_id = std::move(buffer_id);*out_error = std::move(error);
            loop->Quit();
          },
          &loop,
          out_buffer_id,
...
// static
bool StructTraits<::media::mojom::blink::BitstreamBuffer::DataView, ::media::mojom::blink::BitstreamBufferPtr>::Read(
    ::media::mojom::blink::BitstreamBuffer::DataView input,
    ::media::mojom::blink::BitstreamBufferPtr* output) {
  bool success = true;
  ::media::mojom::blink::BitstreamBufferPtr result(::media::mojom::blink::BitstreamBuffer::New());
