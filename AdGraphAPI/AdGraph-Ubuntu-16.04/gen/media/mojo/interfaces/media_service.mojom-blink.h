...
#ifndef MEDIA_MOJO_INTERFACES_MEDIA_SERVICE_MOJOM_BLINK_H_
#define MEDIA_MOJO_INTERFACES_MEDIA_SERVICE_MOJOM_BLINK_H_
...
using RevocableMediaServicePtr = ::blink::RevocableInterfacePtr<MediaService>;
...
class  MediaService
 ...
 public:
  ...
  virtual void CreateInterfaceFactory(::media::mojom::blink::InterfaceFactoryRequest factory, ::service_manager::mojom::blink::InterfaceProviderPtr host_interfaces) = 0;
};
...
class  MediaServiceProxy
 ...
 public:
  ...
  void CreateInterfaceFactory(::media::mojom::blink::InterfaceFactoryRequest factory, ::service_manager::mojom::blink::InterfaceProviderPtr host_interfaces) final;
...
#endif  // MEDIA_MOJO_INTERFACES_MEDIA_SERVICE_MOJOM_BLINK_H_