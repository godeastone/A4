...
bool InterfaceFactory_CreateRenderer_Params_Data::Validate(
  ...
  if (!::media::mojom::internal::HostedRendererType_Data
        ::Validate(object->type, validation_context))
    return false;

  if (!mojo::internal::ValidatePointerNonNullable(
          object->type_specific_id, 2, validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams type_specific_id_validate_params(
      0, false, nullptr);
  if (!mojo::internal::ValidateContainer(object->type_specific_id, validation_context,
                                         &type_specific_id_validate_params)) {
    return false;
  }

  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->renderer, 3, validation_context)) {
    return false;
  }
...
InterfaceFactory_CreateRenderer_Params_Data::InterfaceFactory_CreateRenderer_Params_Data()
    : header_({sizeof(*this), 0}) {}
...
bool InterfaceFactory_CreateCdmProxy_Params_Data::Validate(
  ...
  const mojo::internal::ContainerValidateParams cdm_guid_validate_params(
      0, false, nullptr);
  if (!mojo::internal::ValidateContainer(object->cdm_guid, validation_context,
                                         &cdm_guid_validate_params)) {
    return false;
  }
