...
bool AudioLog_OnCreated_Params_Data::Validate(
  ...
  const AudioLog_OnCreated_Params_Data* object = static_cast<const AudioLog_OnCreated_Params_Data*>(data);
...
bool AudioLog_OnStarted_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const AudioLog_OnStarted_Params_Data* object = static_cast<const AudioLog_OnStarted_Params_Data*>(data);
...
bool AudioLog_OnStopped_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const AudioLog_OnStopped_Params_Data* object = static_cast<const AudioLog_OnStopped_Params_Data*>(data);
...
bool AudioLog_OnClosed_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const AudioLog_OnClosed_Params_Data* object = static_cast<const AudioLog_OnClosed_Params_Data*>(data);
...
bool AudioLog_OnError_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const AudioLog_OnError_Params_Data* object = static_cast<const AudioLog_OnError_Params_Data*>(data);
...
bool AudioLog_OnSetVolume_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const AudioLog_OnSetVolume_Params_Data* object = static_cast<const AudioLog_OnSetVolume_Params_Data*>(data);
...
bool AudioLog_OnLogMessage_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const AudioLog_OnLogMessage_Params_Data* object = static_cast<const AudioLog_OnLogMessage_Params_Data*>(data);
