...
(function() {
  ...
  CdmStorage_Open_Params.generate = function(generator_) {
    var generated = new CdmStorage_Open_Params;
    generated.fileName = generator_.generateString(false);
    return generated;
  };

  CdmStorage_Open_Params.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.fileName = mutator_.mutateString(this.fileName, false);
    }
    return this;
  };
  CdmStorage_Open_Params.prototype.getHandleDeps = function() {
    var handles = [];
    return handles;
  };

  CdmStorage_Open_Params.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  CdmStorage_Open_Params.prototype.setHandlesInternal_ = function(handles, idx) {
    return idx;
  };
  ...
  CdmStorage_Open_ResponseParams.generate = function(generator_) {
    var generated = new CdmStorage_Open_ResponseParams;
    generated.status = generator_.generateEnum(0, 2);
    generated.fileForReading = generator_.generateStruct(mojoBase.mojom.File, true);
    generated.cdmFile = generator_.generateAssociatedInterface("media.mojom.CdmFile", true);
    return generated;
  };

  CdmStorage_Open_ResponseParams.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.status = mutator_.mutateEnum(this.status, 0, 2);
    }
    if (mutator_.chooseMutateField()) {
      this.fileForReading = mutator_.mutateStruct(mojoBase.mojom.File, true);
    }
    if (mutator_.chooseMutateField()) {
      this.cdmFile = mutator_.mutateAssociatedInterface(this.cdmFile, "media.mojom.CdmFile", true);
    }
    return this;
  };
  CdmStorage_Open_ResponseParams.prototype.getHandleDeps = function() {
    var handles = [];
    if (this.fileForReading !== null) {
      Array.prototype.push.apply(handles, this.fileForReading.getHandleDeps());
    }
    if (this.cdmFile !== null) {
      Array.prototype.push.apply(handles, ["media.mojom.CdmFileAssociatedPtr"]);
    }
    return handles;
  };

  CdmStorage_Open_ResponseParams.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  CdmStorage_Open_ResponseParams.prototype.setHandlesInternal_ = function(handles, idx) {
    idx = this.fileForReading.setHandlesInternal_(handles, idx);
    this.cdmFile = handles[idx++];;
    return idx;
  };
  ...
  CdmFile_OpenFileForWriting_Params.generate = function(generator_) {
    var generated = new CdmFile_OpenFileForWriting_Params;
    return generated;
  };

  CdmFile_OpenFileForWriting_Params.prototype.mutate = function(mutator_) {
    return this;
  };
  CdmFile_OpenFileForWriting_Params.prototype.getHandleDeps = function() {
    var handles = [];
    return handles;
  };

  CdmFile_OpenFileForWriting_Params.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  CdmFile_OpenFileForWriting_Params.prototype.setHandlesInternal_ = function(handles, idx) {
    return idx;
  };
  ...
  CdmFile_OpenFileForWriting_ResponseParams.generate = function(generator_) {
    var generated = new CdmFile_OpenFileForWriting_ResponseParams;
    generated.fileForWriting = generator_.generateStruct(mojoBase.mojom.File, true);
    return generated;
  };

  CdmFile_OpenFileForWriting_ResponseParams.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.fileForWriting = mutator_.mutateStruct(mojoBase.mojom.File, true);
    }
    return this;
  };
  CdmFile_OpenFileForWriting_ResponseParams.prototype.getHandleDeps = function() {
    var handles = [];
    if (this.fileForWriting !== null) {
      Array.prototype.push.apply(handles, this.fileForWriting.getHandleDeps());
    }
    return handles;
  };

  CdmFile_OpenFileForWriting_ResponseParams.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  CdmFile_OpenFileForWriting_ResponseParams.prototype.setHandlesInternal_ = function(handles, idx) {
    idx = this.fileForWriting.setHandlesInternal_(handles, idx);
    return idx;
  };
  ...
  CdmFile_CommitWrite_Params.generate = function(generator_) {
    var generated = new CdmFile_CommitWrite_Params;
    return generated;
  };

  CdmFile_CommitWrite_Params.prototype.mutate = function(mutator_) {
    return this;
  };
  CdmFile_CommitWrite_Params.prototype.getHandleDeps = function() {
    var handles = [];
    return handles;
  };

  CdmFile_CommitWrite_Params.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  CdmFile_CommitWrite_Params.prototype.setHandlesInternal_ = function(handles, idx) {
    return idx;
  };
  ...
  CdmFile_CommitWrite_ResponseParams.generate = function(generator_) {
    var generated = new CdmFile_CommitWrite_ResponseParams;
    generated.updatedFileForReading = generator_.generateStruct(mojoBase.mojom.File, true);
    return generated;
  };

  CdmFile_CommitWrite_ResponseParams.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.updatedFileForReading = mutator_.mutateStruct(mojoBase.mojom.File, true);
    }
    return this;
  };
  CdmFile_CommitWrite_ResponseParams.prototype.getHandleDeps = function() {
    var handles = [];
    if (this.updatedFileForReading !== null) {
      Array.prototype.push.apply(handles, this.updatedFileForReading.getHandleDeps());
    }
    return handles;
  };

  CdmFile_CommitWrite_ResponseParams.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  CdmFile_CommitWrite_ResponseParams.prototype.setHandlesInternal_ = function(handles, idx) {
    idx = this.updatedFileForReading.setHandlesInternal_(handles, idx);
    return idx;
  };
  ...
  var kCdmStorage_Open_Name = 1174767610;
  ...
  var CdmStorage = {
    ...
    mojomId: 'media/mojo/interfaces/cdm_storage.mojom',
    fuzzMethods: {
      open: {
        params: CdmStorage_Open_Params,
      },
    },
  };
  CdmStorage.Status = {};
  ...
  var kCdmFile_OpenFileForWriting_Name = 527134635;
  var kCdmFile_CommitWrite_Name = 1377406668;
  ...
  var CdmFile = {
    ...
    fuzzMethods: {
      openFileForWriting: {
        params: CdmFile_OpenFileForWriting_Params,
      },
      commitWrite: {
        params: CdmFile_CommitWrite_Params,
      },
    },
  };
