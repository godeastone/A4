...
using DemuxerStreamPtrDataView =
    mojo::InterfacePtrDataView<DemuxerStreamInterfaceBase>;
using DemuxerStreamRequestDataView =
    mojo::InterfaceRequestDataView<DemuxerStreamInterfaceBase>;
using DemuxerStreamAssociatedPtrInfoDataView =
    mojo::AssociatedInterfacePtrInfoDataView<DemuxerStreamInterfaceBase>;
using DemuxerStreamAssociatedRequestDataView =
    mojo::AssociatedInterfaceRequestDataView<DemuxerStreamInterfaceBase>;
