...
class  WatchTimeRecorder
 ...
 public:
  ...
  virtual void SetAudioDecoderName(const std::string& name) = 0;

  virtual void SetVideoDecoderName(const std::string& name) = 0;
...
class  WatchTimeRecorderProxy
 ...
 public:
  ...
  void SetAudioDecoderName(const std::string& name) final;
  void SetVideoDecoderName(const std::string& name) final;
...
struct  StructTraits<::media::mojom::PlaybackProperties::DataView,
  ...
  static decltype(::media::mojom::PlaybackProperties::audio_codec) audio_codec(
      const ::media::mojom::PlaybackPropertiesPtr& input) {
    return input->audio_codec;
  }

  static decltype(::media::mojom::PlaybackProperties::video_codec) video_codec(
      const ::media::mojom::PlaybackPropertiesPtr& input) {
  ...
  static const decltype(::media::mojom::PlaybackProperties::natural_size)& natural_size(
      const ::media::mojom::PlaybackPropertiesPtr& input) {
