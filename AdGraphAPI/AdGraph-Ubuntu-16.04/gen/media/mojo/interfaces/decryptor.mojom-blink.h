...
using RevocableDecryptorPtr = ::blink::RevocableInterfacePtr<Decryptor>;
...
using RevocableFrameResourceReleaserPtr = ::blink::RevocableInterfacePtr<FrameResourceReleaser>;
