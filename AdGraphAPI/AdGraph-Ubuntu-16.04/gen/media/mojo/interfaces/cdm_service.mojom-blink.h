...
#ifndef MEDIA_MOJO_INTERFACES_CDM_SERVICE_MOJOM_BLINK_H_
#define MEDIA_MOJO_INTERFACES_CDM_SERVICE_MOJOM_BLINK_H_
...
using RevocableCdmServicePtr = ::blink::RevocableInterfacePtr<CdmService>;
...
class  CdmService
 ...
 public:
  ...
  virtual void CreateCdmFactory(::media::mojom::blink::CdmFactoryRequest factory, ::service_manager::mojom::blink::InterfaceProviderPtr host_interfaces) = 0;
};
...
class  CdmServiceProxy
 ...
 public:
  ...
  void CreateCdmFactory(::media::mojom::blink::CdmFactoryRequest factory, ::service_manager::mojom::blink::InterfaceProviderPtr host_interfaces) final;
...
#endif  // MEDIA_MOJO_INTERFACES_CDM_SERVICE_MOJOM_BLINK_H_