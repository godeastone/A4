...
using RevocableAudioDecoderPtr = ::blink::RevocableInterfacePtr<AudioDecoder>;
...
using RevocableAudioDecoderClientPtr = ::blink::RevocableInterfacePtr<AudioDecoderClient>;
