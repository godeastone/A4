...
using MediaServicePtrDataView =
    mojo::InterfacePtrDataView<MediaServiceInterfaceBase>;
using MediaServiceRequestDataView =
    mojo::InterfaceRequestDataView<MediaServiceInterfaceBase>;
using MediaServiceAssociatedPtrInfoDataView =
    mojo::AssociatedInterfacePtrInfoDataView<MediaServiceInterfaceBase>;
using MediaServiceAssociatedRequestDataView =
    mojo::AssociatedInterfaceRequestDataView<MediaServiceInterfaceBase>;
