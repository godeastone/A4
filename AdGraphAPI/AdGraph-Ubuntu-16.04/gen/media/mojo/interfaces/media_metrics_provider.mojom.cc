...
void MediaMetricsProviderProxy::Initialize(
    bool in_is_mse, bool in_is_top_frame, const url::Origin& in_untrusted_top_origin) {
...
void MediaMetricsProviderProxy::AcquireWatchTimeRecorder(
    ::media::mojom::PlaybackPropertiesPtr in_properties, ::media::mojom::WatchTimeRecorderRequest in_recorder) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void MediaMetricsProviderProxy::AcquireVideoDecodeStatsRecorder(
    ::media::mojom::VideoDecodeStatsRecorderRequest in_recorder) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool MediaMetricsProviderStubDispatch::Accept(
  ...
  TRACE_EVENT1("mojom", "(Impl)media::mojom::MediaMetricsProvider::Initialize",
      ...
      bool p_is_mse{};
      bool p_is_top_frame{};
      url::Origin p_untrusted_top_origin{};
...
std::move(p_elapsed));
  ...
  TRACE_EVENT1("mojom", "(Impl)media::mojom::MediaMetricsProvider::AcquireWatchTimeRecorder",
      ...
      ::media::mojom::WatchTimeRecorderRequest p_recorder{};
...
std::move(p_recorder));
  ...
  TRACE_EVENT1("mojom", "(Impl)media::mojom::MediaMetricsProvider::AcquireVideoDecodeStatsRecorder",
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::media::mojom::VideoDecodeStatsRecorderRequest p_recorder{};
...
void MediaMetricsProviderInterceptorForTesting::Initialize(bool is_mse, bool is_top_frame, const url::Origin& untrusted_top_origin) {
