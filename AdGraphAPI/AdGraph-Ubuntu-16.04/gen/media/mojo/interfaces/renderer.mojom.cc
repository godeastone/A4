...
void RendererProxy::Initialize(
    RendererClientAssociatedPtrInfo in_client, base::Optional<std::vector<::media::mojom::DemuxerStreamPtrInfo>> in_streams, const base::Optional<GURL>& in_media_url, const base::Optional<GURL>& in_first_party_for_cookies, InitializeCallback callback) {
...
void RendererInterceptorForTesting::Initialize(RendererClientAssociatedPtrInfo client, base::Optional<std::vector<::media::mojom::DemuxerStreamPtrInfo>> streams, const base::Optional<GURL>& media_url, const base::Optional<GURL>& first_party_for_cookies, InitializeCallback callback) {
...
void RendererClientInterceptorForTesting::OnDurationChange(base::TimeDelta duration) {
