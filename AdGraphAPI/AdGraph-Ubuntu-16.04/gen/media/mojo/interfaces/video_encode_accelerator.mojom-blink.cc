...
bool VideoEncodeAccelerator::Initialize(::media::mojom::blink::VideoPixelFormat input_format, const ::blink::WebSize& input_visible_size, ::media::mojom::blink::VideoCodecProfile output_profile, uint32_t initial_bitrate, VideoEncodeAcceleratorClientPtr client, bool* out_result) {
  NOTREACHED();
  return false;
}
...
bool VideoEncodeAcceleratorProxy::Initialize(
    ::media::mojom::blink::VideoPixelFormat param_input_format, const ::blink::WebSize& param_input_visible_size, ::media::mojom::blink::VideoCodecProfile param_output_profile, uint32_t param_initial_bitrate, VideoEncodeAcceleratorClientPtr param_client, bool* out_param_result) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void VideoEncodeAcceleratorProxy::Initialize(
    ::media::mojom::blink::VideoPixelFormat in_input_format, const ::blink::WebSize& in_input_visible_size, ::media::mojom::blink::VideoCodecProfile in_output_profile, uint32_t in_initial_bitrate, VideoEncodeAcceleratorClientPtr in_client, InitializeCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "media::mojom::VideoEncodeAccelerator::Initialize");
#endif
  const bool kExpectsResponse = true;
...
bool VideoEncodeAcceleratorStubDispatch::AcceptWithResponder(
  ...
  TRACE_EVENT1("mojom", "(Impl)media::mojom::VideoEncodeAccelerator::Initialize",
      ...
      serialization_context.TakeHandlesFromMessage(message);
      bool success = true;
      ::media::mojom::blink::VideoPixelFormat p_input_format{};
      ::blink::WebSize p_input_visible_size{};
      ::media::mojom::blink::VideoCodecProfile p_output_profile{};
...
void VideoEncodeAcceleratorInterceptorForTesting::Initialize(::media::mojom::blink::VideoPixelFormat input_format, const ::blink::WebSize& input_visible_size, ::media::mojom::blink::VideoCodecProfile output_profile, uint32_t initial_bitrate, VideoEncodeAcceleratorClientPtr client, InitializeCallback callback) {
...
void VideoEncodeAcceleratorClientProxy::BitstreamBufferReady(
    int32_t in_bitstream_buffer_id, uint32_t in_payload_size, bool in_key_frame, WTF::TimeDelta in_timestamp) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void VideoEncodeAcceleratorClientInterceptorForTesting::BitstreamBufferReady(int32_t bitstream_buffer_id, uint32_t payload_size, bool key_frame, WTF::TimeDelta timestamp) {
