...
using RevocableKeySystemSupportPtr = ::blink::RevocableInterfacePtr<KeySystemSupport>;
...
class  KeySystemSupport
 ...
 public:
  ...
  virtual bool IsKeySystemSupported(const WTF::String& key_system, bool* out_is_supported, WTF::Vector<::media::mojom::blink::VideoCodec>* out_supported_video_codecs, bool* out_supports_persistent_license, WTF::Vector<::media::mojom::blink::EncryptionMode>* out_supported_encryption_schemes);

  using IsKeySystemSupportedCallback = base::OnceCallback<void(bool, const WTF::Vector<::media::mojom::blink::VideoCodec>&, bool, const WTF::Vector<::media::mojom::blink::EncryptionMode>&)>;
...
class  KeySystemSupportProxy
 ...
 public:
  ...
  bool IsKeySystemSupported(const WTF::String& key_system, bool* out_is_supported, WTF::Vector<::media::mojom::blink::VideoCodec>* out_supported_video_codecs, bool* out_supports_persistent_license, WTF::Vector<::media::mojom::blink::EncryptionMode>* out_supported_encryption_schemes) final;
